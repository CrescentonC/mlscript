  ...
  (if (a_0 <= b_0) then
    (let rec _lh_listcomp_fun_ls_t_0 = ((enumFromTo_lh__d2 (a_0 + 1)) b_0) in
      (let rec _lh_listcomp_fun_ls_h_0 = a_0 in
        (fun _lh_listcomp_fun_1 _lh_simulate_arg2_0 _lh_simulate_arg3_0 -> 
          (let rec t_1 = (_lh_listcomp_fun_1 _lh_listcomp_fun_ls_t_0) in
            (let rec h_1 = (_lh_simulate_arg3_0 (infRand_lh__d1 _lh_simulate_arg2_0)) in
              (fun f_1 -> 
                (if (f_1 h_1) then
                  (let rec t_2 = ((filter_lh__d1 f_1) t_1) in
                    (let rec h_2 = h_1 in
                      (fun _lh_dummy_0 -> 
                        (1 + (length_lh__d1 t_2)))))
                else
                  ((filter_lh__d1 f_1) t_1))))))))
  else
    (fun _lh_listcomp_fun_2 _lh_simulate_arg2_1 _lh_simulate_arg3_1 f_2 _lh_dummy_1 -> 
      0));;
    ...
    (let rec _lh_listcomp_fun_ls_t_1 = ((enumFromTo_lh__d1 (a_1 + 1)) b_1) in
      (let rec _lh_listcomp_fun_ls_h_1 = a_1 in
        (fun _lh_listcomp_fun_3 -> 
          (`LH_C((sim_lh__d1 _lh_listcomp_fun_ls_h_1), (_lh_listcomp_fun_3 _lh_listcomp_fun_ls_t_1))))))
  else
