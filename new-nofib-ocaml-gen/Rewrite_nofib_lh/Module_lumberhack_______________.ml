...
let rec mappend_lh__d7 xs_5 ys_5 =
  (match xs_5 with
    | `LH_C(h_1_0, t_1_6) -> 
      (`LH_C(h_1_0, ((mappend_lh__d7 t_1_6) ys_5)))
    | `LH_N -> 
      ys_5);;
let rec map_lh__d1_d3 f_1_2 ls_5 =
  (match ls_5 with
    | `LH_C(h_9, t_1_5) -> 
      (`LH_C((f_1_2 h_9), ((map_lh__d1_d3 f_1_2) t_1_5)))
    | `LH_N -> 
      (`LH_N));;
...
let rec concat_lh__d1 lss_0 =
  (match lss_0 with
    | `LH_C(h_2_6, t_3_4) -> 
      ((mappend_lh__d7 h_2_6) (concat_lh__d1 t_3_4))
    | `LH_N -> 
      (`LH_N));;
...
let rec foldr_lh__d2 f_1_4 i_2 ls_7 =
  (match ls_7 with
    | `LH_C(h_1_2, t_1_8) -> 
      ((f_1_4 h_1_2) (((foldr_lh__d2 f_1_4) i_2) t_1_8))
    | `LH_N -> 
      i_2);;
...
let rec the_lh__d2 _lh_the_arg1_1 =
  (match _lh_the_arg1_1 with
    ...
    | _ -> 
      (failwith "lh_default_error"));;
let rec eqExpr_lh__d3 _lh_eqExpr_arg1_1 _lh_eqExpr_arg2_1 =
    ...
    | `LH_C(_lh_eqListExpr_LH_C_0_0, _lh_eqListExpr_LH_C_1_0) -> 
      (match _lh_eqListExpr_arg2_0 with
        | `LH_C(_lh_eqListExpr_LH_C_0_1, _lh_eqListExpr_LH_C_1_1) -> 
          (if ((eqExpr_lh__d3 _lh_eqListExpr_LH_C_0_0) _lh_eqListExpr_LH_C_0_1) then
...
univar_lh__d1 _lh_univar_arg1_0 _lh_univar_arg2_0 _lh_univar_arg3_0 =
  (let rec t_1_9 = ((assoc_lh__d1 _lh_univar_arg1_0) _lh_univar_arg2_0) in
    (if (exists_lh__d2 t_1_9) then
      ((unify'_lh__d1 _lh_univar_arg1_0) (`LH_P2((the_lh__d2 t_1_9), _lh_univar_arg3_0)))
    else
...
let rec eqExpr_lh__d1 _lh_eqExpr_arg1_0 _lh_eqExpr_arg2_0 =
  (match _lh_eqExpr_arg1_0 with
    | `Func(_lh_eqExpr_Func_0_0, _lh_eqExpr_Func_1_0) -> 
      (match _lh_eqExpr_arg2_0 with
        | `Func(_lh_eqExpr_Func_0_1, _lh_eqExpr_Func_1_1) -> 
          ((_lh_eqExpr_Func_0_0 = _lh_eqExpr_Func_0_1) && ((eqListExpr_lh__d2 _lh_eqExpr_Func_1_0) _lh_eqExpr_Func_1_1))
        | _ -> 
          false)
    ...
    | _ -> 
      false)
and
eqListExpr_lh__d2 _lh_eqListExpr_arg1_1 _lh_eqListExpr_arg2_1 =
    ...
    | `LH_C(_lh_eqListExpr_LH_C_0_2, _lh_eqListExpr_LH_C_1_2) -> 
      (match _lh_eqListExpr_arg2_1 with
        | `LH_C(_lh_eqListExpr_LH_C_0_3, _lh_eqListExpr_LH_C_1_3) -> 
          (if ((eqExpr_lh__d1 _lh_eqListExpr_LH_C_0_2) _lh_eqListExpr_LH_C_0_3) then
            ((eqListExpr_lh__d2 _lh_eqListExpr_LH_C_1_2) _lh_eqListExpr_LH_C_1_3)
          else
            false)
        | _ -> 
          false)
            ...
            (match _lh_listcomp_fun_ls_h_7 with
              | `LH_P2(_lh_subterms_LH_P2_0_0, _lh_subterms_LH_P2_1_0) -> 
                (let rec _lh_listcomp_fun_8 = (fun _lh_listcomp_fun_para_8 -> 
                  ...
                  (_lh_listcomp_fun_8 (subterms_lh__d2 _lh_subterms_LH_P2_1_0)))
              | _ -> 
...
let rec geRewrite_lh__d4 _lh_geRewrite_arg1_1 _lh_geRewrite_arg2_1 _lh_geRewrite_arg3_1 =
  ((inList_lh__d1 (_lh_geRewrite_arg1_1 (`LH_P2(_lh_geRewrite_arg2_1, _lh_geRewrite_arg3_1)))) (let rec _lh_inList_LH_C_1_1_0 = (let rec _lh_inList_LH_C_1_1_1 = (fun _lh_inList_arg1_1_2 -> 
    false) in
    (let rec _lh_inList_LH_C_0_1_0 = (`Equal) in
      (fun _lh_inList_arg1_1_3 -> 
        (if (_lh_inList_arg1_1_3 = _lh_inList_LH_C_0_1_0) then
          ...
          ((inList_lh__d1 _lh_inList_arg1_1_3) _lh_inList_LH_C_1_1_1))))) in
    (let rec _lh_inList_LH_C_0_1_1 = (`Greater) in
      (fun _lh_inList_arg1_1_4 -> 
        (if (_lh_inList_arg1_1_4 = _lh_inList_LH_C_0_1_1) then
          true
        else
          ((inList_lh__d1 _lh_inList_arg1_1_4) _lh_inList_LH_C_1_1_0))))));;
...
let rec foldr_lh__d1 f_1_3 i_1 ls_6 =
  ((ls_6 f_1_3) i_1);;
...
let rec mappend_lh__d2 xs_6 ys_6 =
  (match xs_6 with
    | `LH_C(h_1_1, t_1_7) -> 
      (`LH_C(h_1_1, ((mappend_lh__d2 t_1_7) ys_6)))
    | `LH_N -> 
      ys_6);;
...
let rec lift_lh__d5 _lh_lift_arg1_4 _lh_lift_arg2_4 =
  (match _lh_lift_arg2_4 with
    ...
    | `Just(_lh_lift_Just_0_4) -> 
      (let rec _lh_squash_Just_0_1 = (_lh_lift_arg1_4 _lh_lift_Just_0_4) in
        (fun _lh_dummy_4 -> 
          _lh_squash_Just_0_1)));;
...
let rec mappend_lh__d5 xs_7 ys_7 =
  (match xs_7 with
    | `LH_C(h_1_3, t_2_0) -> 
      (`LH_C(h_1_3, ((mappend_lh__d5 t_2_0) ys_7)))
    | `LH_N -> 
      ys_7);;
    ...
    (match ls_8 with
      | `LH_C(h_1_4, t_2_1) -> 
        (if (n_0 = 0) then
          ...
          ((atIndex_lh__d3 (n_0 - 1)) t_2_1))
      | `LH_N -> 
        (failwith "lh_default_error")));;
let rec map_lh__d6 f_1_5 ls_1_0 =
  (match ls_1_0 with
    | `LH_C(h_1_5, t_2_2) -> 
      (let rec _lh_inList_LH_C_1_1_2 = ((map_lh__d6 f_1_5) t_2_2) in
        (let rec _lh_inList_LH_C_0_1_2 = (f_1_5 h_1_5) in
          (fun _lh_inList_arg1_1_6 -> 
            (if (_lh_inList_arg1_1_6 = _lh_inList_LH_C_0_1_2) then
              true
            else
              ((inList_lh__d1 _lh_inList_arg1_1_6) _lh_inList_LH_C_1_1_2)))))
    | `LH_N -> 
      (fun _lh_inList_arg1_1_7 -> 
        false));;
let rec map_lh__d1_d2 f_1_6 ls_1_1 =
  (match ls_1_1 with
    | `LH_C(h_1_6, t_2_3) -> 
      (let rec t_2_4 = ((map_lh__d1_d2 f_1_6) t_2_3) in
        (let rec h_1_7 = (f_1_6 h_1_6) in
          (fun f_1_7 i_3 -> 
            ((f_1_7 h_1_7) (((foldr_lh__d1 f_1_7) i_3) t_2_4)))))
    | `LH_N -> 
      (fun f_1_8 i_4 -> 
        i_4));;
...
let rec mappend_lh__d4 xs_9 ys_9 =
  (xs_9 ys_9);;
let rec map_lh__d2 f_1_9 ls_1_2 =
  (match ls_1_2 with
    | `LH_C(h_1_8, t_2_5) -> 
      (let rec t_2_6 = ((map_lh__d2 f_1_9) t_2_5) in
        (let rec h_1_9 = (f_1_9 h_1_8) in
          (fun ys_1_0 -> 
            (`LH_C(h_1_9, ((mappend_lh__d6 t_2_6) ys_1_0))))))
    | `LH_N -> 
      (fun ys_1_1 -> 
        ys_1_1));;
...
let rec fst_lh__d3 _lh_fst_arg1_3 =
  (match _lh_fst_arg1_3 with
    | `LH_P2(_lh_fst_LH_P2_0_3, _lh_fst_LH_P2_1_3) -> 
      _lh_fst_LH_P2_0_3);;
let rec map_lh__d4 f_2_7 ls_1_9 =
  (ls_1_9 f_2_7);;
let rec map_lh__d1 f_2_0 ls_1_4 =
  (match ls_1_4 with
    | `LH_C(h_2_1, t_2_8) -> 
      (let rec t_2_9 = ((map_lh__d1 f_2_0) t_2_8) in
        (let rec h_2_2 = (f_2_0 h_2_1) in
          (fun f_2_1 -> 
            (`LH_C((f_2_1 h_2_2), ((map_lh__d4 f_2_1) t_2_9))))))
    | `LH_N -> 
      (fun f_2_2 -> 
        (`LH_N)));;
...
let rec simplify_lh__d2 _lh_simplify_arg1_4 =
  (let rec f_2_3 = (fun t_3_0 -> 
    ((getOrElse_lh__d2 ((lift_lh__d1_d0 f_2_3) (_lh_simplify_arg1_4 t_3_0))) t_3_0)) in
    f_2_3);;
...
let rec geRewrite_lh__d1 _lh_geRewrite_arg1_2 _lh_geRewrite_arg2_2 _lh_geRewrite_arg3_2 =
  ((inList_lh__d1 (_lh_geRewrite_arg1_2 (`LH_P2(_lh_geRewrite_arg2_2, _lh_geRewrite_arg3_2)))) (let rec _lh_inList_LH_C_1_1_3 = (let rec _lh_inList_LH_C_1_1_4 = (fun _lh_inList_arg1_1_8 -> 
    false) in
    (let rec _lh_inList_LH_C_0_1_3 = (`Equal) in
      (fun _lh_inList_arg1_1_9 -> 
        (if (_lh_inList_arg1_1_9 = _lh_inList_LH_C_0_1_3) then
          ...
          ((inList_lh__d1 _lh_inList_arg1_1_9) _lh_inList_LH_C_1_1_4))))) in
    (let rec _lh_inList_LH_C_0_1_4 = (`Greater) in
      (fun _lh_inList_arg1_2_0 -> 
        (if (_lh_inList_arg1_2_0 = _lh_inList_LH_C_0_1_4) then
          true
        else
          ((inList_lh__d1 _lh_inList_arg1_2_0) _lh_inList_LH_C_1_1_3))))));;
...
let rec map_lh__d5 f_2_4 ls_1_6 =
  (ls_1_6 f_2_4);;
...
let rec map_lh__d3 f_2_5 ls_1_7 =
  (match ls_1_7 with
    | `LH_C(h_2_4, t_3_2) -> 
      (`LH_C((f_2_5 h_2_4), ((map_lh__d3 f_2_5) t_3_2)))
    | `LH_N -> 
      (`LH_N));;
    ...
    | `Eqn(_lh_lhs_Eqn_0_6, _lh_lhs_Eqn_1_6) -> 
      (match _lh_lhs_Eqn_1_6 with
        | `LH_P2(_lh_lhs_LH_P2_0_6, _lh_lhs_LH_P2_1_6) -> 
          _lh_lhs_LH_P2_0_6));;
let rec filter_lh__d1 f_2_6 ls_1_8 =
  (match ls_1_8 with
    | `LH_C(h_2_5, t_3_3) -> 
      (if (f_2_6 h_2_5) then
        (`LH_C(h_2_5, ((filter_lh__d1 f_2_6) t_3_3)))
      else
        ((filter_lh__d1 f_2_6) t_3_3))
    | `LH_N -> 
      (`LH_N));;
...
let rec subterms_lh__d1 _lh_subterms_arg1_1 =
  (match _lh_subterms_arg1_1 with
    ...
    | `Func(_lh_subterms_Func_0_1, _lh_subterms_Func_1_1) -> 
      ((mappend_lh__d7 (`LH_C((`LH_P2((`LH_N), (`Func(_lh_subterms_Func_0_1, _lh_subterms_Func_1_1)))), (`LH_N)))) (let rec _lh_listcomp_fun_9 = (fun _lh_listcomp_fun_para_9 -> 
                    ...
                    | `LH_C(_lh_listcomp_fun_ls_h_1_0, _lh_listcomp_fun_ls_t_1_0) -> 
                      (match _lh_listcomp_fun_ls_h_1_0 with
                        | `LH_P2(_lh_subterms_LH_P2_0_3, _lh_subterms_LH_P2_1_3) -> 
                          (`LH_C((`LH_P2((`LH_C(_lh_subterms_LH_P2_0_2, _lh_subterms_LH_P2_0_3)), _lh_subterms_LH_P2_1_3)), (_lh_listcomp_fun_1_0 _lh_listcomp_fun_ls_t_1_0)))
                        | _ -> 
                          (_lh_listcomp_fun_1_0 _lh_listcomp_fun_ls_t_1_0))
                    | `LH_N -> 
                      (_lh_listcomp_fun_9 _lh_listcomp_fun_ls_t_9))) in
                  (_lh_listcomp_fun_1_0 (subterms_lh__d1 _lh_subterms_LH_P2_1_2)))
              | _ -> 
                (_lh_listcomp_fun_9 _lh_listcomp_fun_ls_t_9))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_9 ((zip_lz_nl_lh__d1 (enumFrom_lh__d1 0)) _lh_subterms_Func_1_1)))));;
...
let rec map_lh__d1_d0 f_2_8 ls_2_1 =
  (match ls_2_1 with
    | `LH_C(h_2_7, t_3_5) -> 
      (`LH_C((f_2_8 h_2_7), ((map_lh__d1_d0 f_2_8) t_3_5)))
    | `LH_N -> 
      (`LH_N));;
...
let rec map_lh__d8 f_2_9 ls_2_4 =
  (match ls_2_4 with
    | `LH_C(h_3_0, t_3_8) -> 
      (let rec t_3_9 = ((map_lh__d8 f_2_9) t_3_8) in
        (let rec h_3_1 = (f_2_9 h_3_0) in
          (fun ys_1_3 -> 
            (`LH_C(h_3_1, ((mappend_lh__d4 t_3_9) ys_1_3))))))
    | `LH_N -> 
      (fun ys_1_4 -> 
        ys_1_4));;
...
let rec eqExpr_lh__d2 _lh_eqExpr_arg1_2 _lh_eqExpr_arg2_2 =
    ...
    (let rec _lh_result_LH_P2_0_0 = (`LH_C('I', (`LH_C('(', (`LH_C('a', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('b', (`LH_C(')', (`LH_N))))))))))))))))) in
      (fun _lh_dummy_0 -> 
              ...
              | `LH_C(_lh_listcomp_fun_ls_h_2, _lh_listcomp_fun_ls_t_2) -> 
                (match _lh_listcomp_fun_ls_h_2 with
                  | `LH_P2(_lh_superpose_LH_P2_0_0, _lh_superpose_LH_P2_1_0) -> 
                    (`LH_C(((lift_lh__d8 (pair_lh__d2 _lh_superpose_LH_P2_0_0)) ((unify_lh__d1 _lh_superpose_arg1_0) _lh_superpose_LH_P2_1_0)), (_lh_listcomp_fun_2 _lh_listcomp_fun_ls_t_2)))
                  | _ -> 
              ...
              (match _lh_rem_eq_LH_P2_0_0 with
                ...
                | `LH_C(_lh_rem_eq_LH_C_0_0, _lh_rem_eq_LH_C_1_0) -> 
                  (let rec add_x_0 = (fun xsys_0 -> 
                    ...
                    ((getOrElse_lh__d1 ((lift_lh__d3 (fun _lh_funcomp_x_6 -> 
        ...
        and parse_eqn_0 = (fun _lh_parse_eqn_arg1_0 -> 
          (let rec _lh_matchIdent_1_1 = (fst_lh__d3 (the_lh__d2 (p_eqn_0 _lh_parse_eqn_arg1_0))) in
            ...
            (let rec _lh_matchIdent_5 = xs_4 in
              (match _lh_matchIdent_5 with
                | `LH_P2(_lh_seq2Lzq_LH_P2_0_0, _lh_seq2Lzq_LH_P2_1_0) -> 
                  ((lift_lh__d6 ((cross_lh__d1 (_lh_seq2Lzq_arg1_0 _lh_seq2Lzq_LH_P2_0_0)) (fun x_1_0 -> 
                    x_1_0))) ((Lazy.force _lh_seq2Lzq_arg3_0) _lh_seq2Lzq_LH_P2_1_0))))) in
            (fun _lh_funcomp_x_4 -> 
              ((fun _lh_funcomp_x_5 -> 
                (squash_lh__d2 ((lift_lh__d5 g_1) _lh_funcomp_x_5))) (_lh_seq2Lzq_arg2_0 _lh_funcomp_x_4)))))
            ...
            (let rec _lh_process2_LH_P2_1_0 = (let rec _lh_listcomp_fun_0 = (fun _lh_listcomp_fun_para_0 -> 
              ...
              (let rec _lh_process2_LH_P2_0_0 = (let rec _lh_listcomp_fun_1 = (fun _lh_listcomp_fun_para_1 -> 
                ...
                (fun _lh_process2_arg1_1 _lh_process2_arg2_1 _lh_process2_arg4_1 _lh_process2_arg5_1 _lh_process2_arg6_1 add_agenda_1 add_eqn_1 all_crit_pairs_1 process_1 resolve_1 super_reduce_1 -> 
                  (let rec net'_0 = ((add_eqn_1 ((delete_eqns_lh__d1 ((map_lh__d6 eqno_lh__d1) _lh_process2_LH_P2_0_0)) _lh_process2_arg4_1)) _lh_process2_arg6_1) in
                    (let rec deletions_0 = ((map_lh__d9 eqpr_lh__d1) _lh_process2_LH_P2_0_0) in
                      (let rec critical_0 = ((all_crit_pairs_1 _lh_process2_arg6_1) _lh_process2_LH_P2_1_0) in
                        (let rec new_agenda_0 = (sift_lh__d2 ((map_lh__d1_d3 (resolve_1 (super_reduce_1 net'_0))) ((mappend_lh__d7 deletions_0) critical_0))) in
                          (let rec todo'_0 = (((add_agenda_1 (snd_lh__d3 _lh_process2_arg1_1)) new_agenda_0) _lh_process2_arg5_1) in
                            (((((process_1 _lh_process2_arg1_1) _lh_process2_arg2_1) ((mappend_lh__d5 _lh_process2_LH_P2_1_0) (`LH_C(_lh_process2_arg6_1, (`LH_N))))) net'_0) todo'_0)))))))))))
        and build_0 = (fun _lh_build_arg1_0 _lh_build_arg2_0 _lh_funcomp_x_1 -> 
          ((lift_lh__d9 ((cross_lh__d3 _lh_build_arg1_0) (fun x_2 -> 
        ...
        and p_prim_0 = (fun _lh_p_prim_arg1_0 -> 
          (((orElseMap_lh__d1 p_name_0) ((seQ_0 (fun x_3 -> 
            ((atIndex_lh__d2 1) x_3))) (`LH_C((look_for_0 '('), (`LH_C(p_expr_0, (`LH_C((look_for_0 ')'), (`LH_N))))))))) _lh_p_prim_arg1_0))
        ...
        and opsym_0 = (fun _lh_opsym_arg1_0 -> 
          ((fun x_4 -> 
            ((inList_lh__d1 x_4) (let rec _lh_inList_LH_C_1_2 = (let rec _lh_inList_LH_C_1_3 = (let rec _lh_inList_LH_C_1_4 = (let rec _lh_inList_LH_C_1_5 = (let rec _lh_inList_LH_C_1_6 = (let rec _lh_inList_LH_C_1_7 = (let rec _lh_inList_LH_C_1_8 = (let rec _lh_inList_LH_C_1_9 = (fun _lh_inList_arg1_3 -> 
              false) in
        ...
        and list_of_0 = (fun _lh_list_of_arg1_0 _lh_list_of_arg2_0 -> 
          (let rec p'_0 = (lazy (((seq2_0 mk_cons_0) _lh_list_of_arg1_0) ((orElseMap_lh__d3 (((seq2Lzq_0 (fun x_1_1 y_0 -> 
        ...
        and seq2_0 = (fun _lh_seq2_arg1_0 _lh_seq2_arg2_0 _lh_seq2_arg3_0 -> 
          (let rec g_0 = (fun xs_3 -> 
            ...
            (fun _lh_funcomp_x_2 -> 
              ((fun _lh_funcomp_x_3 -> 
                (squash_lh__d1 ((lift_lh__d4 g_0) _lh_funcomp_x_3))) (_lh_seq2_arg2_0 _lh_funcomp_x_2)))))
        ...
        and parse_0 = (fun _lh_parse_arg1_0 -> 
          ((fun _lh_funcomp_x_7 -> 
            ((fun _lh_funcomp_x_8 -> 
              ((fun _lh_funcomp_x_9 -> 
                (unExpr_0 (fst_lh__d1 _lh_funcomp_x_9))) (the_lh__d1 _lh_funcomp_x_8))) (p_expr_0 _lh_funcomp_x_7))) _lh_parse_arg1_0))
        ...
        and preorder_0 = (fun _lh_preorder_arg1_0 -> 
          (if ((eqListExpr_lh__d1 _lh_preorder_arg1_0) (`LH_N)) then
            ...
            ((mappend_lh__d3 (let rec t_1_1 = (fun ys_3 -> 
              ys_3) in
              (let rec h_5 = (g_first_0 _lh_preorder_arg1_0) in
                (fun ys_4 -> 
                  (`LH_C(h_5, ((mappend_lh__d3 t_1_1) ys_4))))))) (preorder_0 (g_rest_0 _lh_preorder_arg1_0)))))
        ...
        in (let rec group_completion_0 = ((knuth_bendix_0 ((rpo_0 (rank_order_0 rank_0)) lex_ext_0)) ((map_lh__d5 parse_eqn_0) (let rec t_1_2 = (let rec t_1_3 = (let rec t_1_4 = (fun f_8 -> 
          (`LH_N)) in
          (let rec h_6 = (`LH_C('I', (`LH_C('(', (`LH_C('x', (`LH_C(')', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('x', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('E', (`LH_N))))))))))))))))))))))))) in
            (fun f_9 -> 
              (`LH_C((f_9 h_6), ((map_lh__d5 f_9) t_1_4)))))) in
          (let rec h_7 = (`LH_C('E', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('x', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('x', (`LH_N))))))))))))))))))) in
            (fun f_1_0 -> 
              (`LH_C((f_1_0 h_7), ((map_lh__d5 f_1_0) t_1_3)))))) in
          (let rec h_8 = (`LH_C('(', (`LH_C('a', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('b', (`LH_C(')', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('c', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('(', (`LH_C('b', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('c', (`LH_C(')', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))) in
            (fun f_1_1 -> 
              (`LH_C((f_1_1 h_8), ((map_lh__d5 f_1_1) t_1_2)))))))) in
