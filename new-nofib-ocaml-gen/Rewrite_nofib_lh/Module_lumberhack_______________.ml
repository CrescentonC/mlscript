...
let rec fst_lh__d4 _lh_fst_arg1_0 =
  (match _lh_fst_arg1_0 with
    | `LH_P2(_lh_fst_LH_P2_0_0, _lh_fst_LH_P2_1_0) -> 
      _lh_fst_LH_P2_0_0);;
let rec mappend_lh__d7 xs_5 ys_7 =
  (match xs_5 with
    | `LH_C(h_2_5, t_3_1) -> 
      (`LH_C(h_2_5, ((mappend_lh__d7 t_3_1) ys_7)))
    | `LH_N -> 
      ys_7);;
let rec map_lh__d1_d4 f_3_8 ls_1_7 =
  (match ls_1_7 with
    | `LH_C(h_3_7, t_4_5) -> 
      (`LH_C((f_3_8 h_3_7), ((map_lh__d1_d4 f_3_8) t_4_5)))
    | `LH_N -> 
      (`LH_N));;
let rec expr_fold_lh__d1 _lh_expr_fold_arg1_0 _lh_expr_fold_arg2_0 _lh_expr_fold_arg3_0 =
  (match _lh_expr_fold_arg3_0 with
    ...
    | `Func(_lh_expr_fold_Func_0_0, _lh_expr_fold_Func_1_0) -> 
      ((_lh_expr_fold_arg1_0 _lh_expr_fold_Func_0_0) ((map_lh__d1_d4 ((expr_fold_lh__d1 _lh_expr_fold_arg1_0) _lh_expr_fold_arg2_0)) _lh_expr_fold_Func_1_0)));;
...
let rec concat_lh__d2 lss_0 =
  (match lss_0 with
    | `LH_C(h_5, t_1_1) -> 
      ((mappend_lh__d7 h_5) (concat_lh__d2 t_1_1))
    | `LH_N -> 
      (`LH_N));;
let rec sift_lh__d2 _lh_sift_arg1_0 =
  ((fun _lh_funcomp_x_0 -> 
    (concat_lh__d2 ((map_lh__d1_d4 listify_lh__d1) _lh_funcomp_x_0))) _lh_sift_arg1_0);;
let rec simplify_lh__d4 _lh_simplify_arg1_1 =
  (let rec f_1 = (fun t_2 -> 
    ((getOrElse_lh__d2 ((lift_lh__d1_d0 f_1) (_lh_simplify_arg1_1 t_2))) t_2)) in
    f_1);;
...
let rec simplify_lh__d1 _lh_simplify_arg1_2 =
  (let rec f_2 = (fun t_3 -> 
    ((getOrElse_lh__d2 ((lift_lh__d1_d0 f_2) (_lh_simplify_arg1_2 t_3))) t_3)) in
    f_2);;
let rec map_lh__d9 f_3 ls_0 =
  (match ls_0 with
    | `LH_C(h_0, t_4) -> 
      (`LH_C((f_3 h_0), ((map_lh__d9 f_3) t_4)))
    | `LH_N -> 
      (`LH_N));;
...
let rec foldl_lh__d1 f_4 i_0 ls_1 =
  (match ls_1 with
    | `LH_C(h_1, t_5) -> 
      (((foldl_lh__d1 f_4) ((f_4 i_0) h_1)) t_5)
    | `LH_N -> 
      i_0);;
        ...
        | `Func(_lh_replace_Func_0_1, _lh_replace_Func_1_1) -> 
          (match _lh_replace_arg2_1 with
            | `LH_C(_lh_replace_LH_C_0_1, _lh_replace_LH_C_1_1) -> 
              (`Func(_lh_replace_Func_0_1, (((modify_lh__d1 _lh_replace_Func_1_1) _lh_replace_LH_C_0_1) (fun t_6 -> 
                (((replace_lh__d1 t_6) _lh_replace_LH_C_1_1) _lh_replace_arg3_1))))))));;
...
let rec map_lh__d7 f_5 ls_2 =
  (match ls_2 with
    | `LH_C(h_2, t_7) -> 
      (`LH_C((f_5 h_2), ((map_lh__d7 f_5) t_7)))
    | `LH_N -> 
      (`LH_N));;
let rec inList_lh__d1 _lh_inList_arg1_1_5 _lh_inList_arg2_0 =
  (_lh_inList_arg2_0 _lh_inList_arg1_1_5);;
let rec geRewrite_lh__d3 _lh_geRewrite_arg1_0 _lh_geRewrite_arg2_0 _lh_geRewrite_arg3_0 =
  ((inList_lh__d1 (_lh_geRewrite_arg1_0 (`LH_P2(_lh_geRewrite_arg2_0, _lh_geRewrite_arg3_0)))) (let rec _lh_inList_LH_C_1_0 = (let rec _lh_inList_LH_C_1_1 = (fun _lh_inList_arg1_0 -> 
    false) in
    (let rec _lh_inList_LH_C_0_0 = (`Equal) in
      (fun _lh_inList_arg1_1 -> 
        (if (_lh_inList_arg1_1 = _lh_inList_LH_C_0_0) then
          ...
          ((inList_lh__d1 _lh_inList_arg1_1) _lh_inList_LH_C_1_1))))) in
    (let rec _lh_inList_LH_C_0_1 = (`Greater) in
      (fun _lh_inList_arg1_2 -> 
        (if (_lh_inList_arg1_2 = _lh_inList_LH_C_0_1) then
          true
        else
          ((inList_lh__d1 _lh_inList_arg1_2) _lh_inList_LH_C_1_0))))));;
let rec sumAux_lh__d1 ls_1_5 a_1 =
  (match ls_1_5 with
    | `LH_N -> 
      a_1
    | `LH_C(h_3_5, t_4_3) -> 
      ((sumAux_lh__d1 t_4_3) (a_1 + h_3_5)));;
...
let rec foldr_lh__d2 f_3_1 i_1_9 ls_7 =
  (match ls_7 with
    | `LH_C(h_2_7, t_3_3) -> 
      ((f_3_1 h_2_7) (((foldr_lh__d2 f_3_1) i_1_9) t_3_3))
    | `LH_N -> 
      i_1_9);;
...
let rec assoc_lh__d1 _lh_assoc_arg1_0 _lh_assoc_arg2_0 =
  (let rec match_x_0 = (fun uv_0 -> 
    ...
    (first_ok_lh__d1 ((map_lh__d1_d4 match_x_0) _lh_assoc_arg1_0)));;
...
let rec sub_lh__d2 _lh_sub_arg1_1 _lh_sub_arg2_1 =
  (((expr_fold_lh__d1 (fun x_2_6 y_3 -> 
    (`Func(x_2_6, y_3)))) (apply_lh__d1 _lh_sub_arg2_1)) _lh_sub_arg1_1);;
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_6, _lh_listcomp_fun_ls_t_6) -> 
        (match _lh_listcomp_fun_ls_h_6 with
          | `LH_P2(_lh_comp_sub_LH_P2_0_0, _lh_comp_sub_LH_P2_1_0) -> 
            (`LH_C((`LH_P2(_lh_comp_sub_LH_P2_0_0, ((sub_lh__d2 _lh_comp_sub_LH_P2_1_0) _lh_comp_sub_arg1_0))), (_lh_listcomp_fun_6 _lh_listcomp_fun_ls_t_6)))
          | _ -> 
...
univar_lh__d1 _lh_univar_arg1_0 _lh_univar_arg2_0 _lh_univar_arg3_0 =
  (let rec t_3_4 = ((assoc_lh__d1 _lh_univar_arg1_0) _lh_univar_arg2_0) in
    (if (exists_lh__d2 t_3_4) then
      ((unify'_lh__d1 _lh_univar_arg1_0) (`LH_P2((the_lh__d2 t_3_4), _lh_univar_arg3_0)))
    else
...
let rec mappend_lh__d1 xs_2 ys_2 =
  (match xs_2 with
    | `LH_C(h_3, t_8) -> 
      (`LH_C(h_3, ((mappend_lh__d1 t_8) ys_2)))
    | `LH_N -> 
      ys_2);;
let rec map_lh__d1_d1 f_6 ls_3 =
  (match ls_3 with
    | `LH_C(h_4, t_9) -> 
      (`LH_C((f_6 h_4), ((map_lh__d1_d1 f_6) t_9)))
    | `LH_N -> 
      (`LH_N));;
let rec simplify_lh__d3 _lh_simplify_arg1_3 =
  (let rec f_7 = (fun t_1_0 -> 
    ((getOrElse_lh__d2 ((lift_lh__d1_d0 f_7) (_lh_simplify_arg1_3 t_1_0))) t_1_0)) in
    f_7);;
let rec eqExpr_lh__d1 _lh_eqExpr_arg1_0 _lh_eqExpr_arg2_0 =
  (match _lh_eqExpr_arg1_0 with
    ...
    | _ -> 
      false);;
let rec zip_lz_nl_lh__d1 xs_1_0 ys_1_4 =
  (match ys_1_4 with
    | `LH_C(hy_2, ty_2) -> 
...
let rec enumFrom_lh__d1 a_2 =
  (lazy (let rec tx_1 = (enumFrom_lh__d1 (a_2 + 1)) in
    (let rec hx_1 = a_2 in
      (fun hy_1 ty_1 -> 
    ...
    | `Func(_lh_subterms_Func_0_0, _lh_subterms_Func_1_0) -> 
      ((mappend_lh__d7 (`LH_C((`LH_P2((`LH_N), (`Func(_lh_subterms_Func_0_0, _lh_subterms_Func_1_0)))), (`LH_N)))) (let rec _lh_listcomp_fun_7 = (fun _lh_listcomp_fun_para_7 -> 
        (match _lh_listcomp_fun_para_7 with
          ...
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_7 ((zip_lz_nl_lh__d1 (enumFrom_lh__d1 0)) _lh_subterms_Func_1_0)))));;
        ...
        | `Func(_lh_replace_Func_0_0, _lh_replace_Func_1_0) -> 
          (match _lh_replace_arg2_0 with
            | `LH_C(_lh_replace_LH_C_0_0, _lh_replace_LH_C_1_0) -> 
              (`Func(_lh_replace_Func_0_0, (((modify_lh__d1 _lh_replace_Func_1_0) _lh_replace_LH_C_0_0) (fun t_1 -> 
                (((replace_lh__d2 t_1) _lh_replace_LH_C_1_0) _lh_replace_arg3_0))))))));;
      ...
      (match _lh_rewrite_Eqn_1_0 with
        | `LH_P2(_lh_rewrite_LH_P2_0_0, _lh_rewrite_LH_P2_1_0) -> 
          (fun _lh_funcomp_x_1_1 -> 
            ((lift_lh__d1_d0 (sub_lh__d2 _lh_rewrite_LH_P2_1_0)) ((match_lh__d1 _lh_rewrite_LH_P2_0_0) _lh_funcomp_x_1_1)))));;
...
let rec geRewrite_lh__d4 _lh_geRewrite_arg1_1 _lh_geRewrite_arg2_1 _lh_geRewrite_arg3_1 =
  ((inList_lh__d1 (_lh_geRewrite_arg1_1 (`LH_P2(_lh_geRewrite_arg2_1, _lh_geRewrite_arg3_1)))) (let rec _lh_inList_LH_C_1_2 = (let rec _lh_inList_LH_C_1_3 = (fun _lh_inList_arg1_3 -> 
    false) in
    (let rec _lh_inList_LH_C_0_2 = (`Equal) in
      (fun _lh_inList_arg1_4 -> 
        (if (_lh_inList_arg1_4 = _lh_inList_LH_C_0_2) then
          true
        else
          ((inList_lh__d1 _lh_inList_arg1_4) _lh_inList_LH_C_1_3))))) in
    (let rec _lh_inList_LH_C_0_3 = (`Greater) in
      (fun _lh_inList_arg1_5 -> 
        (if (_lh_inList_arg1_5 = _lh_inList_LH_C_0_3) then
          true
        else
          ((inList_lh__d1 _lh_inList_arg1_5) _lh_inList_LH_C_1_2))))));;
    ...
    | `Eqn(_lh_lhs_Eqn_0_2, _lh_lhs_Eqn_1_2) -> 
      (match _lh_lhs_Eqn_1_2 with
        | `LH_P2(_lh_lhs_LH_P2_0_2, _lh_lhs_LH_P2_1_2) -> 
          _lh_lhs_LH_P2_0_2));;
let rec mappend_lh__d4 xs_9 ys_1_1 =
  (xs_9 ys_1_1);;
let rec map_lh__d1_d3 f_2_9 ls_5 =
  (match ls_5 with
    | `LH_C(h_2_3, t_2_9) -> 
      (let rec t_3_0 = ((map_lh__d1_d3 f_2_9) t_2_9) in
        (let rec h_2_4 = (f_2_9 h_2_3) in
          (fun ys_5 -> 
            (`LH_C(h_2_4, ((mappend_lh__d4 t_3_0) ys_5))))))
    | `LH_N -> 
      (fun ys_6 -> 
        ys_6));;
let rec getOrElse_lh__d1 _lh_getOrElse_arg1_0 _lh_getOrElse_arg2_0 =
  (_lh_getOrElse_arg1_0 _lh_getOrElse_arg2_0);;
...
let rec foldr_lh__d1 f_3_0 i_1_8 ls_6 =
  ((ls_6 f_3_0) i_1_8);;
let rec lift_lh__d7 _lh_lift_arg1_3 _lh_lift_arg2_3 =
  (match _lh_lift_arg2_3 with
    ...
    | `Just(_lh_lift_Just_0_3) -> 
      (let rec _lh_squash_Just_0_1 = (_lh_lift_arg1_3 _lh_lift_Just_0_3) in
        (fun _lh_dummy_4 -> 
          _lh_squash_Just_0_1)));;
let rec succeed_lh__d1 _lh_succeed_arg1_1 =
  (`Just(_lh_succeed_arg1_1));;
let rec mappend_lh__d2 xs_6 ys_8 =
  (match xs_6 with
    | `LH_C(h_2_6, t_3_2) -> 
      (`LH_C(h_2_6, ((mappend_lh__d2 t_3_2) ys_8)))
    | `LH_N -> 
      ys_8);;
...
let rec lift_lh__d5 _lh_lift_arg1_4 _lh_lift_arg2_4 =
  (match _lh_lift_arg2_4 with
    ...
    | `Just(_lh_lift_Just_0_4) -> 
      (let rec _lh_getOrElse_Just_0_0 = (_lh_lift_arg1_4 _lh_lift_Just_0_4) in
...
let rec mappend_lh__d5 xs_7 ys_9 =
  (match xs_7 with
    | `LH_C(h_2_8, t_3_5) -> 
      (`LH_C(h_2_8, ((mappend_lh__d5 t_3_5) ys_9)))
    | `LH_N -> 
      ys_9);;
  ...
  (match _lh_dropWhile_arg2_1 with
    ...
    | `LH_C(_lh_dropWhile_LH_C_0_1, _lh_dropWhile_LH_C_1_1) -> 
      (if (_lh_dropWhile_arg1_1 _lh_dropWhile_LH_C_0_1) then
        ...
        (`LH_C(_lh_dropWhile_LH_C_0_1, _lh_dropWhile_LH_C_1_1))));;
let rec mappend_lh__d6 xs_8 ys_1_0 =
  (xs_8 ys_1_0);;
    ...
    (match ls_8 with
      | `LH_C(h_2_9, t_3_6) -> 
        (if (n_0 = 0) then
          ...
          ((atIndex_lh__d3 (n_0 - 1)) t_3_6))
      | `LH_N -> 
        (failwith "lh_default_error")));;
let rec map_lh__d6 f_3_2 ls_1_0 =
  (match ls_1_0 with
    | `LH_C(h_3_0, t_3_7) -> 
      (`LH_C((f_3_2 h_3_0), ((map_lh__d6 f_3_2) t_3_7)))
    | `LH_N -> 
      (`LH_N));;
let rec map_lh__d1_d2 f_3_3 ls_1_1 =
  (match ls_1_1 with
    | `LH_C(h_3_1, t_3_8) -> 
      (`LH_C((f_3_3 h_3_1), ((map_lh__d1_d2 f_3_3) t_3_8)))
    | `LH_N -> 
      (`LH_N));;
...
let rec map_lh__d2 f_3_4 ls_1_2 =
  (ls_1_2 f_3_4);;
...
let rec map_lh__d1 f_3_5 ls_1_4 =
  (match ls_1_4 with
    | `LH_C(h_3_3, t_4_0) -> 
      (let rec t_4_1 = ((map_lh__d1 f_3_5) t_4_0) in
        (let rec h_3_4 = (f_3_5 h_3_3) in
          (fun ys_1_2 -> 
            (`LH_C(h_3_4, ((mappend_lh__d3 t_4_1) ys_1_2))))))
    | `LH_N -> 
      (fun ys_1_3 -> 
        ys_1_3));;
...
let rec simplify_lh__d2 _lh_simplify_arg1_4 =
  (let rec f_3_6 = (fun t_4_2 -> 
    ((getOrElse_lh__d2 ((lift_lh__d1_d0 f_3_6) (_lh_simplify_arg1_4 t_4_2))) t_4_2)) in
    f_3_6);;
...
let rec occurs_lh__d1 _lh_occurs_arg1_1 =
  ((expr_fold_lh__d1 (fun dum_4 -> 
    or_lh__d1)) (fun x_2_1 -> 
    (x_2_1 = _lh_occurs_arg1_1)));;
let rec geRewrite_lh__d1 _lh_geRewrite_arg1_2 _lh_geRewrite_arg2_2 _lh_geRewrite_arg3_2 =
  ((inList_lh__d1 (_lh_geRewrite_arg1_2 (`LH_P2(_lh_geRewrite_arg2_2, _lh_geRewrite_arg3_2)))) (let rec _lh_inList_LH_C_1_1_2 = (let rec _lh_inList_LH_C_1_1_3 = (fun _lh_inList_arg1_1_6 -> 
    false) in
    (let rec _lh_inList_LH_C_0_1_2 = (`Equal) in
      (fun _lh_inList_arg1_1_7 -> 
        (if (_lh_inList_arg1_1_7 = _lh_inList_LH_C_0_1_2) then
          true
        else
          ((inList_lh__d1 _lh_inList_arg1_1_7) _lh_inList_LH_C_1_1_3))))) in
    (let rec _lh_inList_LH_C_0_1_3 = (`Greater) in
      (fun _lh_inList_arg1_1_8 -> 
        (if (_lh_inList_arg1_1_8 = _lh_inList_LH_C_0_1_3) then
          true
        else
          ((inList_lh__d1 _lh_inList_arg1_1_8) _lh_inList_LH_C_1_1_2))))));;
...
let rec quant_lh__d1 _lh_quant_arg1_5 _lh_quant_arg2_5 _lh_quant_arg3_5 _lh_quant_arg4_5 =
  (let rec p_5 = (fun x_2_2 -> 
    ((_lh_quant_arg2_5 x_2_2) _lh_quant_arg3_5)) in
    ((_lh_quant_arg1_5 p_5) _lh_quant_arg4_5));;
let rec map_lh__d5 f_3_7 ls_1_6 =
  (match ls_1_6 with
    | `LH_C(h_3_6, t_4_4) -> 
      (let rec _lh_inList_LH_C_1_1_4 = ((map_lh__d5 f_3_7) t_4_4) in
        (let rec _lh_inList_LH_C_0_1_4 = (f_3_7 h_3_6) in
          (fun _lh_inList_arg1_1_9 -> 
            (if (_lh_inList_arg1_1_9 = _lh_inList_LH_C_0_1_4) then
              true
            else
              ((inList_lh__d1 _lh_inList_arg1_1_9) _lh_inList_LH_C_1_1_4)))))
    | `LH_N -> 
...
let rec concat_lh__d1 lss_1 =
  (lss_1 99);;
let rec map_lh__d3 f_3_9 ls_1_8 =
  (match ls_1_8 with
    | `LH_C(h_3_8, t_4_6) -> 
      (let rec t_4_7 = ((map_lh__d3 f_3_9) t_4_6) in
        (let rec h_3_9 = (f_3_9 h_3_8) in
          (fun f_4_0 -> 
            (let rec t_4_8 = ((map_lh__d2 f_4_0) t_4_7) in
              (let rec h_4_0 = (f_4_0 h_3_9) in
                (fun _lh_dummy_5 -> 
                  ((mappend_lh__d7 h_4_0) (concat_lh__d1 t_4_8))))))))
    | `LH_N -> 
      (fun f_4_1 _lh_dummy_6 -> 
        (`LH_N)));;
let rec quant_lh__d6 _lh_quant_arg1_6 _lh_quant_arg2_6 _lh_quant_arg3_6 _lh_quant_arg4_6 =
  (let rec p_6 = (fun x_2_3 -> 
    ((_lh_quant_arg2_6 x_2_3) _lh_quant_arg3_6)) in
...
let rec map_dnet_lh__d1 _lh_map_dnet_arg1_0 _lh_map_dnet_arg2_0 =
  (match _lh_map_dnet_arg2_0 with
    | `Switch(_lh_map_dnet_Switch_0_0, _lh_map_dnet_Switch_1_0) -> 
      (`Switch(((map_lh__d1_d4 ((cross_lh__d3 (fun x_1_5 -> 
...
let rec filter_lh__d1 f_4_2 ls_1_9 =
  (match ls_1_9 with
    | `LH_C(h_4_1, t_4_9) -> 
      (if (f_4_2 h_4_1) then
        (`LH_C(h_4_1, ((filter_lh__d1 f_4_2) t_4_9)))
      else
        ((filter_lh__d1 f_4_2) t_4_9))
    | `LH_N -> 
      (`LH_N));;
...
let rec croak_lh__d3 =
  (`Nothing);;
let rec all_lh__d3 _lh_all_arg1_7 _lh_all_arg2_5 =
  (match _lh_all_arg2_5 with
    | `LH_N -> 
      true
    | `LH_C(_lh_all_LH_C_0_5, _lh_all_LH_C_1_5) -> 
      (if (_lh_all_arg1_7 _lh_all_LH_C_0_5) then
        ((all_lh__d3 _lh_all_arg1_7) _lh_all_LH_C_1_5)
      else
        false));;
let rec quant_lh__d8 _lh_quant_arg1_7 _lh_quant_arg2_7 _lh_quant_arg3_7 _lh_quant_arg4_7 =
  (let rec p_7 = (fun x_2_4 -> 
    ((_lh_quant_arg2_7 x_2_4) _lh_quant_arg3_7)) in
    ((_lh_quant_arg1_7 p_7) _lh_quant_arg4_7));;
let rec map_lh__d4 f_4_3 ls_2_0 =
  (match ls_2_0 with
    | `LH_C(h_4_2, t_5_0) -> 
      (`LH_C((f_4_3 h_4_2), ((map_lh__d4 f_4_3) t_5_0)))
    | `LH_N -> 
      (`LH_N));;
let rec geRewrite_lh__d2 _lh_geRewrite_arg1_3 _lh_geRewrite_arg2_3 _lh_geRewrite_arg3_3 =
  ((inList_lh__d1 (_lh_geRewrite_arg1_3 (`LH_P2(_lh_geRewrite_arg2_3, _lh_geRewrite_arg3_3)))) (let rec _lh_inList_LH_C_1_1_5 = (let rec _lh_inList_LH_C_1_1_6 = (fun _lh_inList_arg1_2_1 -> 
    false) in
    (let rec _lh_inList_LH_C_0_1_5 = (`Equal) in
      (fun _lh_inList_arg1_2_2 -> 
        (if (_lh_inList_arg1_2_2 = _lh_inList_LH_C_0_1_5) then
          ...
          ((inList_lh__d1 _lh_inList_arg1_2_2) _lh_inList_LH_C_1_1_6))))) in
    (let rec _lh_inList_LH_C_0_1_6 = (`Greater) in
      (fun _lh_inList_arg1_2_3 -> 
        (if (_lh_inList_arg1_2_3 = _lh_inList_LH_C_0_1_6) then
          true
        else
          ((inList_lh__d1 _lh_inList_arg1_2_3) _lh_inList_LH_C_1_1_5))))));;
...
let rec quant_lh__d3 _lh_quant_arg1_8 _lh_quant_arg2_8 _lh_quant_arg3_8 _lh_quant_arg4_8 =
  (let rec p_8 = (fun x_2_5 -> 
    ((_lh_quant_arg2_8 x_2_5) _lh_quant_arg3_8)) in
...
let rec update_alist_lh__d1 _lh_update_alist_arg1_0 _lh_update_alist_arg2_0 _lh_update_alist_arg3_0 =
  (let rec upd_0 = (fun ls_2_1 -> 
    (let rec _lh_matchIdent_1_3 = ls_2_1 in
...
let rec sift_lh__d1 _lh_sift_arg1_1 =
  ((fun _lh_funcomp_x_1_2 -> 
    (concat_lh__d2 ((map_lh__d1_d4 listify_lh__d1) _lh_funcomp_x_1_2))) _lh_sift_arg1_1);;
...
let rec map_lh__d1_d0 f_4_4 ls_2_2 =
  (ls_2_2 f_4_4);;
let rec atIndex_lh__d2 n_1 ls_2_3 =
  (if (n_1 < 0) then
    (failwith "lh_default_error")
  else
    (match ls_2_3 with
...
let rec atIndex_lh__d1 n_2 ls_2_4 =
  (if (n_2 < 0) then
    (failwith "lh_default_error")
  else
    (match ls_2_4 with
      | `LH_C(h_4_4, t_5_2) -> 
        (if (n_2 = 0) then
          ...
          ((atIndex_lh__d1 (n_2 - 1)) t_5_2))
      | `LH_N -> 
        (failwith "lh_default_error")));;
let rec quant_lh__d4 _lh_quant_arg1_9 _lh_quant_arg2_9 _lh_quant_arg3_9 _lh_quant_arg4_9 =
  (let rec p_9 = (fun x_2_7 -> 
    ((_lh_quant_arg2_9 x_2_7) _lh_quant_arg3_9)) in
    ((_lh_quant_arg1_9 p_9) _lh_quant_arg4_9));;
let rec map_lh__d8 f_4_5 ls_2_5 =
  (match ls_2_5 with
    | `LH_C(h_4_5, t_5_3) -> 
      (`LH_C((f_4_5 h_4_5), ((map_lh__d8 f_4_5) t_5_3)))
    | `LH_N -> 
      (`LH_N));;
    ...
    (let rec _lh_result_LH_P2_0_0 = (`LH_C('I', (`LH_C('(', (`LH_C('a', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('b', (`LH_C(')', (`LH_N))))))))))))))))) in
      (fun _lh_dummy_0 -> 
        ...
        and superpose_0 = (fun _lh_superpose_arg1_0 _lh_superpose_arg2_0 -> 
          (sift_lh__d1 (let rec _lh_listcomp_fun_2 = (fun _lh_listcomp_fun_para_2 -> 
            (match _lh_listcomp_fun_para_2 with
              | `LH_C(_lh_listcomp_fun_ls_h_2, _lh_listcomp_fun_ls_t_2) -> 
                (match _lh_listcomp_fun_ls_h_2 with
                  | `LH_P2(_lh_superpose_LH_P2_0_0, _lh_superpose_LH_P2_1_0) -> 
                    (`LH_C(((lift_lh__d6 (pair_lh__d2 _lh_superpose_LH_P2_0_0)) ((unify_lh__d1 _lh_superpose_arg1_0) _lh_superpose_LH_P2_1_0)), (_lh_listcomp_fun_2 _lh_listcomp_fun_ls_t_2)))
                  | _ -> 
                    (_lh_listcomp_fun_2 _lh_listcomp_fun_ls_t_2))
              | `LH_N -> 
                (`LH_N))) in
            (_lh_listcomp_fun_2 (subterms_lh__d1 _lh_superpose_arg2_0)))))
          ...
          (match _lh_delete_arg3_0 with
            ...
            | `LH_C(_lh_delete_LH_C_0_0, _lh_delete_LH_C_1_0) -> 
              (if ((_lh_delete_arg1_0 _lh_delete_arg2_0) _lh_delete_LH_C_0_0) then
                ...
                ((lift_lh__d1 (fun x_9 -> 
                  (`LH_C(_lh_delete_LH_C_0_0, x_9)))) (((delete_0 _lh_delete_arg1_0) _lh_delete_arg2_0) _lh_delete_LH_C_1_0)))))
              ...
              (match _lh_rem_eq_LH_P2_0_0 with
                ...
                | `LH_C(_lh_rem_eq_LH_C_0_0, _lh_rem_eq_LH_C_1_0) -> 
                  (let rec add_x_0 = (fun xsys_0 -> 
                    (let rec _lh_matchIdent_8 = xsys_0 in
                    ...
                    ((getOrElse_lh__d2 ((lift_lh__d9 (fun _lh_funcomp_x_6 -> 
                      ((rem_eq_0 _lh_rem_eq_arg1_0) ((pair_lh__d1 _lh_rem_eq_LH_C_1_0) _lh_funcomp_x_6)))) (((delete_0 _lh_rem_eq_arg1_0) _lh_rem_eq_LH_C_0_0) _lh_rem_eq_LH_P2_1_0))) (add_x_0 ((rem_eq_0 _lh_rem_eq_arg1_0) (`LH_P2(_lh_rem_eq_LH_C_1_0, _lh_rem_eq_LH_P2_1_0)))))))))
        ...
        and parse_eqn_0 = (fun _lh_parse_eqn_arg1_0 -> 
          (let rec _lh_matchIdent_1_1 = (fst_lh__d2 (the_lh__d1 (p_eqn_0 _lh_parse_eqn_arg1_0))) in
        ...
        and addby_0 = (fun _lh_addby_arg1_0 _lh_addby_arg2_0 _lh_addby_arg3_0 -> 
          (let rec insert_0 = (fun x_8 ls_4 -> 
            (let rec _lh_matchIdent_4 = ls_4 in
              (match _lh_matchIdent_4 with
                | `LH_N -> 
                  (`LH_C(x_8, (`LH_N)))
                | `LH_C(_lh_addby_LH_C_0_0, _lh_addby_LH_C_1_0) -> 
                  (if ((_lh_addby_arg1_0 x_8) <= (_lh_addby_arg1_0 _lh_addby_LH_C_0_0)) then
                    (`LH_C(x_8, (`LH_C(_lh_addby_LH_C_0_0, _lh_addby_LH_C_1_0))))
                  else
                    (`LH_C(_lh_addby_LH_C_0_0, ((insert_0 x_8) _lh_addby_LH_C_1_0))))))) in
        ...
        and seq2Lzq_0 = (fun _lh_seq2Lzq_arg1_0 _lh_seq2Lzq_arg2_0 _lh_seq2Lzq_arg3_0 -> 
          (let rec g_1 = (fun xs_4 -> 
            (let rec _lh_matchIdent_5 = xs_4 in
              (match _lh_matchIdent_5 with
                | `LH_P2(_lh_seq2Lzq_LH_P2_0_0, _lh_seq2Lzq_LH_P2_1_0) -> 
                  ((lift_lh__d3 ((cross_lh__d3 (_lh_seq2Lzq_arg1_0 _lh_seq2Lzq_LH_P2_0_0)) (fun x_1_0 -> 
                    x_1_0))) ((Lazy.force _lh_seq2Lzq_arg3_0) _lh_seq2Lzq_LH_P2_1_0))))) in
            (fun _lh_funcomp_x_4 -> 
              ((fun _lh_funcomp_x_5 -> 
                (squash_lh__d2 ((lift_lh__d4 g_1) _lh_funcomp_x_5))) (_lh_seq2Lzq_arg2_0 _lh_funcomp_x_4)))))
        and find_assoc_0 = (fun _lh_find_assoc_arg1_0 _lh_find_assoc_arg2_0 _lh_find_assoc_arg3_0 -> 
          (match _lh_find_assoc_arg1_0 with
            | `Afunc(_lh_find_assoc_Afunc_0_0) -> 
              ((getOrElse_lh__d1 ((lift_lh__d5 (find'_0 _lh_find_assoc_arg2_0)) ((assoc_lh__d1 _lh_find_assoc_arg3_0) _lh_find_assoc_Afunc_0_0))) (`LH_N))
            | `Avar -> 
              (`LH_N)))
                        ...
                        | `Func(_lh_rpo_Func_0_2, _lh_rpo_Func_1_2) -> 
                          (let rec _lh_matchIdent_7 = (_lh_rpo_arg1_0 (let rec _lh_rank_order_LH_P2_1_0 = _lh_rpo_Func_0_2 in
                            ...
                            (match _lh_matchIdent_7 with
                              ...
                              | `Greater -> 
                                (if ((((quant_lh__d8 all_lh__d4) (ltRewrite_lh__d4 rpo'_0)) (`Func(_lh_rpo_Func_0_1, _lh_rpo_Func_1_1))) _lh_rpo_Func_1_2) then
                                  (`Greater)
                                else
                                  (if ((((quant_lh__d2 any_lh__d5) (geRewrite_lh__d1 rpo'_0)) (`Func(_lh_rpo_Func_0_1, _lh_rpo_Func_1_1))) _lh_rpo_Func_1_2) then
                                    (`Less)
                                  else
                                    (`Unrelated)))
                              | `Less -> 
                                (if ((((quant_lh__d1_d0 all_lh__d2) (ltRewrite_lh__d1 rpo'_0)) (`Func(_lh_rpo_Func_0_2, _lh_rpo_Func_1_2))) _lh_rpo_Func_1_1) then
                                  (`Less)
                                else
                                  (if ((((quant_lh__d3 any_lh__d4) (geRewrite_lh__d3 rpo'_0)) (`Func(_lh_rpo_Func_0_2, _lh_rpo_Func_1_2))) _lh_rpo_Func_1_1) then
                                    (`Greater)
                                  else
                                    (`Unrelated)))
                              | `Unrelated -> 
        ...
        and split_0 = (fun _lh_split_arg1_0 _lh_split_arg2_0 -> 
          (let rec tmp_0 = ((zip_lh__d1 ((map_lh__d4 _lh_split_arg1_0) _lh_split_arg2_0)) _lh_split_arg2_0) in
            (let rec _lh_process2_LH_P2_1_0 = (let rec _lh_listcomp_fun_0 = (fun _lh_listcomp_fun_para_0 -> 
              ...
              (let rec _lh_process2_LH_P2_0_0 = (let rec _lh_listcomp_fun_1 = (fun _lh_listcomp_fun_para_1 -> 
                ...
                (fun _lh_process2_arg1_1 _lh_process2_arg2_1 _lh_process2_arg4_1 _lh_process2_arg5_1 _lh_process2_arg6_1 add_agenda_1 add_eqn_1 all_crit_pairs_1 process_1 resolve_1 super_reduce_1 -> 
                  (let rec net'_0 = ((add_eqn_1 ((delete_eqns_lh__d1 ((map_lh__d5 eqno_lh__d1) _lh_process2_LH_P2_0_0)) _lh_process2_arg4_1)) _lh_process2_arg6_1) in
                    (let rec deletions_0 = ((map_lh__d1 eqpr_lh__d1) _lh_process2_LH_P2_0_0) in
                      (let rec critical_0 = ((all_crit_pairs_1 _lh_process2_arg6_1) _lh_process2_LH_P2_1_0) in
                        (let rec new_agenda_0 = (sift_lh__d2 ((map_lh__d7 (resolve_1 (super_reduce_1 net'_0))) ((mappend_lh__d3 deletions_0) critical_0))) in
                          (let rec todo'_0 = (((add_agenda_1 (snd_lh__d1 _lh_process2_arg1_1)) new_agenda_0) _lh_process2_arg5_1) in
                            (((((process_1 _lh_process2_arg1_1) _lh_process2_arg2_1) ((mappend_lh__d1 _lh_process2_LH_P2_1_0) (`LH_C(_lh_process2_arg6_1, (`LH_N))))) net'_0) todo'_0)))))))))))
        and build_0 = (fun _lh_build_arg1_0 _lh_build_arg2_0 _lh_funcomp_x_1 -> 
          ((lift_lh__d8 ((cross_lh__d1 _lh_build_arg1_0) (fun x_2 -> 
            x_2))) (_lh_build_arg2_0 _lh_funcomp_x_1)))
        ...
        and p_prim_0 = (fun _lh_p_prim_arg1_0 -> 
          (((orElseMap_lh__d2 p_name_0) ((seQ_0 (fun x_3 -> 
            ((atIndex_lh__d3 1) x_3))) (let rec t_1_2 = (let rec t_1_3 = (let rec t_1_4 = (fun f_8 i_1 -> 
            i_1) in
            (let rec h_6 = (look_for_0 ')') in
              (fun f_9 i_2 -> 
                ((f_9 h_6) (((foldr_lh__d1 f_9) i_2) t_1_4))))) in
            (let rec h_7 = p_expr_0 in
              (fun f_1_0 i_3 -> 
                ((f_1_0 h_7) (((foldr_lh__d1 f_1_0) i_3) t_1_3))))) in
            (let rec h_8 = (look_for_0 '(') in
              (fun f_1_1 i_4 -> 
                ((f_1_1 h_8) (((foldr_lh__d1 f_1_1) i_4) t_1_2))))))) _lh_p_prim_arg1_0))
                              ...
                              (match _lh_q_func_LH_C_1_2 with
                                | `LH_C(_lh_q_func_LH_C_0_3, _lh_q_func_LH_C_1_3) -> 
                                  (match _lh_q_func_LH_C_1_3 with
                                    | `LH_N -> 
                                      (`Expr((`Func(_lh_q_func_MkString_0_0, ((map_lh__d1_d2 unExpr_0) _lh_q_func_List_0_0)))))))))))))
        ...
        and opsym_0 = (fun _lh_opsym_arg1_0 -> 
          ((fun x_4 -> 
            ((inList_lh__d1 x_4) (let rec _lh_inList_LH_C_1_4 = (let rec _lh_inList_LH_C_1_5 = (let rec _lh_inList_LH_C_1_6 = (let rec _lh_inList_LH_C_1_7 = (let rec _lh_inList_LH_C_1_8 = (let rec _lh_inList_LH_C_1_9 = (let rec _lh_inList_LH_C_1_1_0 = (let rec _lh_inList_LH_C_1_1_1 = (fun _lh_inList_arg1_6 -> 
              false) in
              (let rec _lh_inList_LH_C_0_4 = ':' in
                (fun _lh_inList_arg1_7 -> 
                  (if (_lh_inList_arg1_7 = _lh_inList_LH_C_0_4) then
                    true
                  else
                    ((inList_lh__d1 _lh_inList_arg1_7) _lh_inList_LH_C_1_1_1))))) in
              (let rec _lh_inList_LH_C_0_5 = '?' in
                (fun _lh_inList_arg1_8 -> 
                  (if (_lh_inList_arg1_8 = _lh_inList_LH_C_0_5) then
                    true
                  else
                    ((inList_lh__d1 _lh_inList_arg1_8) _lh_inList_LH_C_1_1_0))))) in
              (let rec _lh_inList_LH_C_0_6 = '/' in
                (fun _lh_inList_arg1_9 -> 
                  (if (_lh_inList_arg1_9 = _lh_inList_LH_C_0_6) then
                    true
                  else
                    ((inList_lh__d1 _lh_inList_arg1_9) _lh_inList_LH_C_1_9))))) in
              (let rec _lh_inList_LH_C_0_7 = '-' in
                (fun _lh_inList_arg1_1_0 -> 
                  (if (_lh_inList_arg1_1_0 = _lh_inList_LH_C_0_7) then
                    true
                  else
                    ((inList_lh__d1 _lh_inList_arg1_1_0) _lh_inList_LH_C_1_8))))) in
              (let rec _lh_inList_LH_C_0_8 = '@' in
                (fun _lh_inList_arg1_1_1 -> 
                  (if (_lh_inList_arg1_1_1 = _lh_inList_LH_C_0_8) then
                    true
                  else
                    ((inList_lh__d1 _lh_inList_arg1_1_1) _lh_inList_LH_C_1_7))))) in
              (let rec _lh_inList_LH_C_0_9 = '%' in
                (fun _lh_inList_arg1_1_2 -> 
                  (if (_lh_inList_arg1_1_2 = _lh_inList_LH_C_0_9) then
                    true
                  else
                    ((inList_lh__d1 _lh_inList_arg1_1_2) _lh_inList_LH_C_1_6))))) in
              (let rec _lh_inList_LH_C_0_1_0 = '+' in
                (fun _lh_inList_arg1_1_3 -> 
                  (if (_lh_inList_arg1_1_3 = _lh_inList_LH_C_0_1_0) then
                    true
                  else
                    ((inList_lh__d1 _lh_inList_arg1_1_3) _lh_inList_LH_C_1_5))))) in
              (let rec _lh_inList_LH_C_0_1_1 = '*' in
                (fun _lh_inList_arg1_1_4 -> 
                  (if (_lh_inList_arg1_1_4 = _lh_inList_LH_C_0_1_1) then
                    true
                  else
                    ((inList_lh__d1 _lh_inList_arg1_1_4) _lh_inList_LH_C_1_4))))))) _lh_opsym_arg1_0))
        and resolve_0 = (fun _lh_resolve_arg1_0 _lh_resolve_arg2_0 -> 
          (let rec lhs'_0 = ((simplify_lh__d5 _lh_resolve_arg1_0) (fst_lh__d4 _lh_resolve_arg2_0)) in
            (let rec rhs'_0 = ((simplify_lh__d4 _lh_resolve_arg1_0) (snd_lh__d3 _lh_resolve_arg2_0)) in
              (if ((eqExpr_lh__d1 lhs'_0) rhs'_0) then
                croak_lh__d2
              else
                (succeed_lh__d3 (`LH_P2(lhs'_0, rhs'_0)))))))
        and p_term_0 = (fun _lh_p_term_arg1_0 -> 
          (((orElseMap_lh__d3 ((seQ_0 q_func_0) (let rec t_1_5 = (let rec t_1_6 = (let rec t_1_7 = (let rec t_1_8 = (fun f_1_2 i_5 -> 
            i_5) in
            (let rec h_9 = (look_for_0 ')') in
              (fun f_1_3 i_6 -> 
                ((f_1_3 h_9) (((foldr_lh__d1 f_1_3) i_6) t_1_8))))) in
            (let rec h_1_0 = ((list_of_0 p_expr_0) ',') in
              (fun f_1_4 i_7 -> 
                ((f_1_4 h_1_0) (((foldr_lh__d1 f_1_4) i_7) t_1_7))))) in
            (let rec h_1_1 = (look_for_0 '(') in
              (fun f_1_5 i_8 -> 
                ((f_1_5 h_1_1) (((foldr_lh__d1 f_1_5) i_8) t_1_6))))) in
            (let rec h_1_2 = p_ident_0 in
              (fun f_1_6 i_9 -> 
                ((f_1_6 h_1_2) (((foldr_lh__d1 f_1_6) i_9) t_1_5))))))) p_prim_0) _lh_p_term_arg1_0))
        and add_eqn_0 = (fun _lh_add_eqn_arg1_0 _lh_add_eqn_arg2_0 -> 
          (((thread_0 (preorder_0 (g_init_0 (lhs_lh__d3 _lh_add_eqn_arg2_0)))) _lh_add_eqn_arg2_0) _lh_add_eqn_arg1_0))
            ...
            | `LH_C(_lh_g_rest_LH_C_0_0, _lh_g_rest_LH_C_1_0) -> 
              (match _lh_g_rest_LH_C_0_0 with
                | `Func(_lh_g_rest_Func_0_0, _lh_g_rest_Func_1_0) -> 
                  ((mappend_lh__d5 _lh_g_rest_Func_1_0) _lh_g_rest_LH_C_1_0)
                  ...
                  (match _lh_lex_ext_LH_P2_1_0 with
                    | `Func(_lh_lex_ext_Func_0_1, _lh_lex_ext_Func_1_1) -> 
                      (let rec estimate_0 = ((lexico_0 _lh_lex_ext_arg1_0) (`LH_P2(_lh_lex_ext_Func_1_0, _lh_lex_ext_Func_1_1))) in
                        (let rec confirm_0 = (fun x_6 -> 
                          (let rec _lh_matchIdent_2 = x_6 in
                            (match _lh_matchIdent_2 with
                              | `Equal -> 
                                true
                              | `Greater -> 
                                ((((quant_lh__d1 all_lh__d3) (ltRewrite_lh__d2 _lh_lex_ext_arg1_0)) (`Func(_lh_lex_ext_Func_0_0, _lh_lex_ext_Func_1_0))) _lh_lex_ext_Func_1_1)
                              | `Less -> 
                                ((((quant_lh__d4 all_lh__d5) (ltRewrite_lh__d3 _lh_lex_ext_arg1_0)) (`Func(_lh_lex_ext_Func_0_1, _lh_lex_ext_Func_1_1))) _lh_lex_ext_Func_1_0)
                              | `Unrelated -> 
                                false))) in
                          (if (confirm_0 estimate_0) then
                            estimate_0
                          else
                            (if ((((quant_lh__d7 any_lh__d1) (geRewrite_lh__d2 _lh_lex_ext_arg1_0)) (`Func(_lh_lex_ext_Func_0_1, _lh_lex_ext_Func_1_1))) _lh_lex_ext_Func_1_0) then
                              (`Greater)
                            else
        ...
        and empty_0 = (fun _lh_empty_arg1_0 -> 
          (succeed_lh__d2 (`LH_P2((`List((`LH_N))), _lh_empty_arg1_0))))
        ...
        and list_of_0 = (fun _lh_list_of_arg1_0 _lh_list_of_arg2_0 -> 
          (let rec p'_0 = (lazy (((seq2_0 mk_cons_0) _lh_list_of_arg1_0) ((orElseMap_lh__d4 (((seq2Lzq_0 (fun x_1_1 y_0 -> 
        ...
        and crit_pairs_0 = (fun _lh_crit_pairs_arg1_0 _lh_crit_pairs_arg2_0 -> 
          ((mappend_lh__d7 ((map_lh__d6 ((mk_crit_0 _lh_crit_pairs_arg1_0) _lh_crit_pairs_arg2_0)) ((superpose_0 (lhs_lh__d5 _lh_crit_pairs_arg1_0)) (lhs_lh__d7 _lh_crit_pairs_arg2_0)))) ((map_lh__d1_d1 ((mk_crit_0 _lh_crit_pairs_arg2_0) _lh_crit_pairs_arg1_0)) ((strict_super_0 (lhs_lh__d6 _lh_crit_pairs_arg2_0)) (lhs_lh__d1 _lh_crit_pairs_arg1_0)))))
            ...
            | `Func(_lh_strict_super_Func_0_0, _lh_strict_super_Func_1_0) -> 
              (let rec _lh_listcomp_fun_3 = (fun _lh_listcomp_fun_para_3 -> 
                (match _lh_listcomp_fun_para_3 with
                  ...
                  | `LH_N -> 
                    (`LH_N))) in
                (_lh_listcomp_fun_3 ((zip_lz_nl_lh__d1 (enumFrom_lh__d1 0)) _lh_strict_super_Func_1_0)))))
        and dominates_0 = (fun _lh_dominates_arg1_0 -> 
          ((quant_lh__d5 all_lh__d6) ((quant_lh__d9 any_lh__d2) (gtRewrite_lh__d1 _lh_dominates_arg1_0))))
        and knuth_bendix1_0 = (fun _lh_knuth_bendix1_arg1_0 _lh_knuth_bendix1_arg2_0 -> 
          (((((process_0 _lh_knuth_bendix1_arg1_0) 1) (`LH_N)) empty_net_0) (((add_agenda_0 (snd_lh__d2 _lh_knuth_bendix1_arg1_0)) _lh_knuth_bendix1_arg2_0) (`LH_N))))
        and mk_item_0 = (fun _lh_mk_item_arg1_0 _lh_mk_item_arg2_0 -> 
          (`Item((_lh_mk_item_arg1_0 _lh_mk_item_arg2_0), _lh_mk_item_arg2_0)))
        and sp_0 = (fun _lh_sp_arg1_0 _lh_funcomp_x_1_0 -> 
          (_lh_sp_arg1_0 ((dropWhile_lh__d2 (fun x_1_2 -> 
            (x_1_2 = ' '))) _lh_funcomp_x_1_0)))
        and p_eqn_0 = (fun _lh_p_eqn_arg1_0 -> 
          (((seQ_0 q_eqn_0) (let rec t_2_2 = (let rec t_2_3 = (let rec t_2_4 = (fun f_2_1 i_1_4 -> 
            i_1_4) in
            (let rec h_1_6 = p_expr_0 in
              (fun f_2_2 i_1_5 -> 
                ((f_2_2 h_1_6) (((foldr_lh__d1 f_2_2) i_1_5) t_2_4))))) in
            (let rec h_1_7 = (look_for_0 '=') in
              (fun f_2_3 i_1_6 -> 
                ((f_2_3 h_1_7) (((foldr_lh__d1 f_2_3) i_1_6) t_2_3))))) in
            (let rec h_1_8 = p_expr_0 in
              (fun f_2_4 i_1_7 -> 
                ((f_2_4 h_1_8) (((foldr_lh__d1 f_2_4) i_1_7) t_2_2)))))) _lh_p_eqn_arg1_0))
        ...
        and process2_0 = (fun _lh_process2_arg1_0 _lh_process2_arg2_0 _lh_process2_arg3_0 _lh_process2_arg4_0 _lh_process2_arg5_0 _lh_process2_arg6_0 -> 
          (let rec _lh_matchIdent_0 = ((split_0 (reducible_0 (reduce1_lh__d1 _lh_process2_arg6_0))) _lh_process2_arg3_0) in
            (((((((((((_lh_matchIdent_0 _lh_process2_arg1_0) _lh_process2_arg2_0) _lh_process2_arg4_0) _lh_process2_arg5_0) _lh_process2_arg6_0) add_agenda_0) add_eqn_0) all_crit_pairs_0) process_0) resolve_0) super_reduce_0)))
        and dnet_reduce_0 = (fun _lh_dnet_reduce_arg1_0 _lh_dnet_reduce_arg2_0 -> 
          ((try_all_lh__d1 ((map_lh__d8 rewrite_lh__d1) ((find_0 _lh_dnet_reduce_arg2_0) _lh_dnet_reduce_arg1_0))) _lh_dnet_reduce_arg2_0))
        and find'_0 = (fun _lh_find'_arg1_0 _lh_find'_arg2_0 -> 
          (match _lh_find'_arg2_0 with
            ...
            | `Switch(_lh_find'_Switch_0_0, _lh_find'_Switch_1_0) -> 
              ((mappend_lh__d2 (((find_assoc_0 (g_first_0 _lh_find'_arg1_0)) (g_rest_0 _lh_find'_arg1_0)) _lh_find'_Switch_0_0)) ((find'_0 (g_skip_0 _lh_find'_arg1_0)) _lh_find'_Switch_1_0))))
                      ...
                      ((multi_0 _lh_multi_ext_arg1_0) (let rec _lh_multi_LH_P2_1_0 = _lh_multi_ext_Func_1_1 in
                        (let rec _lh_multi_LH_P2_0_0 = _lh_multi_ext_Func_1_0 in
                          (fun _lh_multi_arg1_0 dominates_1 rem_eq_1 -> 
                            (let rec _lh_matchIdent_1 = ((rem_eq_1 (eqRewrite_lh__d1 _lh_multi_arg1_0)) (`LH_P2(_lh_multi_LH_P2_0_0, _lh_multi_LH_P2_1_0))) in
            ...
            (let rec _lh_matchIdent_3 = xs_3 in
              (match _lh_matchIdent_3 with
                | `LH_P2(_lh_seq2_LH_P2_0_0, _lh_seq2_LH_P2_1_0) -> 
                  ((lift_lh__d2 ((cross_lh__d2 (_lh_seq2_arg1_0 _lh_seq2_LH_P2_0_0)) (fun x_7 -> 
                    x_7))) (_lh_seq2_arg3_0 _lh_seq2_LH_P2_1_0))))) in
            (fun _lh_funcomp_x_2 -> 
              ((fun _lh_funcomp_x_3 -> 
                (squash_lh__d1 ((lift_lh__d7 g_0) _lh_funcomp_x_3))) (_lh_seq2_arg2_0 _lh_funcomp_x_2)))))
        ...
        and p_expr_0 = (fun _lh_p_expr_arg1_0 -> 
          (((orElseMap_lh__d1 ((seQ_0 q_op_0) (let rec t_1_9 = (let rec t_2_0 = (let rec t_2_1 = (fun f_1_7 i_1_0 -> 
            i_1_0) in
            (let rec h_1_3 = p_term_0 in
              (fun f_1_8 i_1_1 -> 
                ((f_1_8 h_1_3) (((foldr_lh__d1 f_1_8) i_1_1) t_2_1))))) in
            (let rec h_1_4 = p_op_0 in
              (fun f_1_9 i_1_2 -> 
                ((f_1_9 h_1_4) (((foldr_lh__d1 f_1_9) i_1_2) t_2_0))))) in
            (let rec h_1_5 = p_term_0 in
              (fun f_2_0 i_1_3 -> 
                ((f_2_0 h_1_5) (((foldr_lh__d1 f_2_0) i_1_3) t_1_9))))))) p_term_0) _lh_p_expr_arg1_0))
        and all_crit_pairs_0 = (fun _lh_all_crit_pairs_arg1_0 _lh_all_crit_pairs_arg2_0 -> 
          (let rec eqn'_0 = ((stand_eqn_lh__d1 (`LH_C('1', (`LH_N)))) _lh_all_crit_pairs_arg1_0) in
            (let rec eqn''_0 = ((stand_eqn_lh__d3 (`LH_C('2', (`LH_N)))) _lh_all_crit_pairs_arg1_0) in
              (let rec theory''_0 = ((map_lh__d3 (stand_eqn_lh__d2 (`LH_C('2', (`LH_N))))) _lh_all_crit_pairs_arg2_0) in
                ((mappend_lh__d4 ((map_lh__d1_d3 ((mk_crit_0 eqn'_0) eqn''_0)) ((strict_super_0 (lhs_lh__d4 eqn'_0)) (lhs_lh__d2 eqn''_0)))) (concat_lh__d1 ((map_lh__d2 (crit_pairs_0 eqn'_0)) theory''_0)))))))
        and parse_0 = (fun _lh_parse_arg1_0 -> 
          ((fun _lh_funcomp_x_7 -> 
            ((fun _lh_funcomp_x_8 -> 
              ((fun _lh_funcomp_x_9 -> 
                (unExpr_0 (fst_lh__d3 _lh_funcomp_x_9))) (the_lh__d2 _lh_funcomp_x_8))) (p_expr_0 _lh_funcomp_x_7))) _lh_parse_arg1_0))
        ...
        and preorder_0 = (fun _lh_preorder_arg1_0 -> 
          (if ((eqListExpr_lh__d1 _lh_preorder_arg1_0) (`LH_N)) then
            ...
            ((mappend_lh__d6 (let rec t_2_5 = (fun ys_3 -> 
              ys_3) in
              (let rec h_1_9 = (g_first_0 _lh_preorder_arg1_0) in
                (fun ys_4 -> 
                  (`LH_C(h_1_9, ((mappend_lh__d6 t_2_5) ys_4))))))) (preorder_0 (g_rest_0 _lh_preorder_arg1_0)))))
        ...
        and preprocess_0 = (fun _lh_preprocess_arg1_0 _lh_preprocess_arg2_0 -> 
          (match _lh_preprocess_arg2_0 with
            | `LH_P2(_lh_preprocess_LH_P2_0_0, _lh_preprocess_LH_P2_1_0) -> 
              (let rec _lh_process1_LH_P2_1_0 = ((simplify_lh__d1 (super_reduce_0 _lh_preprocess_arg1_0)) _lh_preprocess_LH_P2_1_0) in
                (let rec _lh_process1_LH_P2_0_0 = ((simplify_lh__d3 (super_reduce_0 _lh_preprocess_arg1_0)) _lh_preprocess_LH_P2_0_0) in
                  (fun _lh_process1_arg1_1 _lh_process1_arg2_1 _lh_process1_arg3_1 _lh_process1_arg4_1 _lh_process1_arg5_1 add_agenda_2 process2_1 process_2 -> 
                    (let rec o_0 = ((fst_lh__d1 _lh_process1_arg1_1) (`LH_P2(_lh_process1_LH_P2_0_0, _lh_process1_LH_P2_1_0))) in
        ...
        in (let rec group_completion_0 = ((knuth_bendix_0 ((rpo_0 (rank_order_0 rank_0)) lex_ext_0)) ((map_lh__d1_d0 parse_eqn_0) (let rec t_2_6 = (let rec t_2_7 = (let rec t_2_8 = (fun f_2_5 -> 
          (`LH_N)) in
          (let rec h_2_0 = (`LH_C('I', (`LH_C('(', (`LH_C('x', (`LH_C(')', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('x', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('E', (`LH_N))))))))))))))))))))))))) in
            (fun f_2_6 -> 
              (`LH_C((f_2_6 h_2_0), ((map_lh__d1_d0 f_2_6) t_2_8)))))) in
          (let rec h_2_1 = (`LH_C('E', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('x', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('x', (`LH_N))))))))))))))))))) in
            (fun f_2_7 -> 
              (`LH_C((f_2_7 h_2_1), ((map_lh__d1_d0 f_2_7) t_2_7)))))) in
          (let rec h_2_2 = (`LH_C('(', (`LH_C('a', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('b', (`LH_C(')', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('c', (`LH_C(' ', (`LH_C('=', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('(', (`LH_C('b', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('c', (`LH_C(')', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))) in
            (fun f_2_8 -> 
              (`LH_C((f_2_8 h_2_2), ((map_lh__d1_d0 f_2_8) t_2_6)))))))) in
          ((eqExpr_lh__d2 ((simplify_lh__d2 (super_reduce_0 group_completion_0)) (parse_0 _lh_result_LH_P2_0_0))) (parse_0 _lh_result_LH_P2_1_0))))))));;
