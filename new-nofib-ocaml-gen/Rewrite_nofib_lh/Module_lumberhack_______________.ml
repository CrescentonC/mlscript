...
let rec seq2_lh__d7 _lh_seq2_arg1_4 _lh_seq2_arg2_4 _lh_seq2_arg3_4 =
...
let rec seq2_lh__d6 _lh_seq2_arg1_2 _lh_seq2_arg2_2 _lh_seq2_arg3_2 =
...
let rec seq2_lh__d5 _lh_seq2_arg1_6 _lh_seq2_arg2_6 _lh_seq2_arg3_6 =
...
let rec mk_cons_lh__d4 _lh_mk_cons_arg1_1 _lh_mk_cons_arg2_1 =
  (match _lh_mk_cons_arg2_1 with
    ...
    | _ -> 
      (failwith "lh_default_error"));;
let rec seq2_lh__d4 _lh_seq2_arg1_1 _lh_seq2_arg2_1 _lh_seq2_arg3_1 =
...
let rec seq2_lh__d1 _lh_seq2_arg1_3 _lh_seq2_arg2_3 _lh_seq2_arg3_3 =
      ...
      (let rec _lh_all_LH_C_0_1 = _lh_copy_arg2_0 in
        (fun _lh_all_arg1_2 -> 
          (if (_lh_all_arg1_2 _lh_all_LH_C_0_1) then
            ((all_lh__d1 _lh_all_arg1_2) _lh_all_LH_C_1_1)
          else
            false)))));;
...
let rec or_lh__d2 _lh_or_arg1_1 =
  (_lh_or_arg1_1 99);;
let rec map_lh__d4 f_1_1_2 ls_1_7 =
  (match ls_1_7 with
    | `LH_C(h_8_6, t_8_9) -> 
...
let rec or_lh__d1 _lh_or_arg1_0 =
  (_lh_or_arg1_0 99);;
let rec map_lh__d3 f_1_1_0 ls_1_5 =
  (match ls_1_5 with
    | `LH_C(h_8_3, t_8_6) -> 
      ...
      (match _lh_rewrite_Eqn_1_0 with
        | `LH_P2(_lh_rewrite_LH_P2_0_0, _lh_rewrite_LH_P2_1_0) -> 
          (fun _lh_funcomp_x_2_7 -> 
            ((lift_lh__d3 (sub_lh__d1 _lh_rewrite_LH_P2_1_0)) ((match_lh__d1 _lh_rewrite_LH_P2_0_0) _lh_funcomp_x_2_7)))));;
...
let rec map_lh__d2 f_8_9 ls_1_0 =
  (match ls_1_0 with
    | `LH_C(h_6_7, t_7_0) -> 
      (let rec t_7_1 = ((map_lh__d2 f_8_9) t_7_0) in
        (let rec h_6_8 = (f_8_9 h_6_7) in
          (fun f_9_0 i_8_2 -> 
            ((f_9_0 h_6_8) (((foldr_lh__d1 f_9_0) i_8_2) t_7_1)))))
    | `LH_N -> 
      (fun f_9_1 i_8_3 -> 
        i_8_3));;
...
let rec map_lh__d5 f_1_0_7 ls_1_4 =
  (match ls_1_4 with
    | `LH_C(h_8_1, t_8_4) -> 
      (let rec t_8_5 = ((map_lh__d5 f_1_0_7) t_8_4) in
        (let rec h_8_2 = (f_1_0_7 h_8_1) in
          (fun f_1_0_8 i_9_8 -> 
            ((f_1_0_8 h_8_2) (((foldr_lh__d6 f_1_0_8) i_9_8) t_8_5)))))
    | `LH_N -> 
      (fun f_1_0_9 i_9_9 -> 
        i_9_9));;
    ...
    | `LH_P2(_lh_preprocess_LH_P2_0_0, _lh_preprocess_LH_P2_1_0) -> 
      (let rec _lh_process1_LH_P2_1_0 = ((simplify_lh__d1 (super_reduce_lh__d1 _lh_preprocess_arg1_0)) _lh_preprocess_LH_P2_1_0) in
        (let rec _lh_process1_LH_P2_0_0 = ((simplify_lh__d1 (super_reduce_lh__d1 _lh_preprocess_arg1_0)) _lh_preprocess_LH_P2_0_0) in
          (fun _lh_process1_arg1_1 _lh_process1_arg2_1 _lh_process1_arg3_1 _lh_process1_arg4_1 _lh_process1_arg5_1 -> 
            (let rec o_0 = ((fst_lh__d3 _lh_process1_arg1_1) (`LH_P2(_lh_process1_LH_P2_0_0, _lh_process1_LH_P2_1_0))) in
              (let rec _lh_matchIdent_6 = o_0 in
                (match _lh_matchIdent_6 with
                  | `Unrelated -> 
                    (((((process_lh__d1 _lh_process1_arg1_1) _lh_process1_arg2_1) _lh_process1_arg3_1) _lh_process1_arg4_1) (((add_agenda_lh__d1 (fun dum_2 -> 
                      1000)) (`LH_C((`LH_P2(_lh_process1_LH_P2_0_0, _lh_process1_LH_P2_1_0)), (`LH_N)))) _lh_process1_arg5_1))
                  | `Equal -> 
                    (((((process_lh__d1 _lh_process1_arg1_1) _lh_process1_arg2_1) _lh_process1_arg3_1) _lh_process1_arg4_1) _lh_process1_arg5_1)
                  | _ -> 
                    (let rec eqn_0 = (let rec _lh_matchIdent_7 = o_0 in
                      (match _lh_matchIdent_7 with
                        ...
                        | `Less -> 
                          (`Eqn(_lh_process1_arg2_1, (`LH_P2(_lh_process1_LH_P2_1_0, _lh_process1_LH_P2_0_0)))))) in
                      ((((((process2_lh__d1 _lh_process1_arg1_1) (_lh_process1_arg2_1 + 1)) _lh_process1_arg3_1) _lh_process1_arg4_1) _lh_process1_arg5_1) eqn_0)))))))))
and
...
and
split_lh__d1 _lh_split_arg1_0 _lh_split_arg2_0 =
  (let rec tmp_0 = ((zip_lh__d1 ((map_lh__d7 _lh_split_arg1_0) _lh_split_arg2_0)) _lh_split_arg2_0) in
    (let rec _lh_process2_LH_P2_1_0 = (let rec _lh_listcomp_fun_3 = (fun _lh_listcomp_fun_para_3 -> 
      ...
      (let rec _lh_process2_LH_P2_0_0 = (let rec _lh_listcomp_fun_4 = (fun _lh_listcomp_fun_para_4 -> 
        ...
        (fun _lh_process2_arg1_1 _lh_process2_arg2_1 _lh_process2_arg4_1 _lh_process2_arg5_1 _lh_process2_arg6_1 -> 
...
let rec seq2_lh__d3 _lh_seq2_arg1_0 _lh_seq2_arg2_0 _lh_seq2_arg3_0 =
