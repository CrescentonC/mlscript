...
let rec rewrite_lh__d1 _lh_rewrite_arg1_0 _lh_floatOutId_0_7 =
    ...
    | `Eqn(_lh_rewrite_Eqn_0_0, _lh_rewrite_Eqn_1_0) -> 
      (match _lh_rewrite_Eqn_1_0 with
        | `LH_P2(_lh_rewrite_LH_P2_0_0, _lh_rewrite_LH_P2_1_0) -> 
          ((lift_lh__d1_d0 (sub_lh__d2 _lh_rewrite_LH_P2_1_0)) ((match_lh__d1 _lh_rewrite_LH_P2_0_0) _lh_floatOutId_0_7))));;
...
let rec croak_lh__d2 =
  (`Nothing);;
let rec lift_lh__d4 _lh_lift_arg1_1 _lh_lift_arg2_1 _lh_floatOutId_0_0 =
...
let rec mappend_lh__d4 xs_9 ys_1_1 =
  (xs_9 ys_1_1);;
let rec map_lh__d1_d3 f_2_9 ls_5 _lh_floatOutId_0_1 =
  (match ls_5 with
    | `LH_C(h_2_3, t_2_9) -> 
      (let rec t_3_0 = ((map_lh__d1_d3 f_2_9) t_2_9) in
        (let rec h_2_4 = (f_2_9 h_2_3) in
          (`LH_C(h_2_4, ((mappend_lh__d4 t_3_0) _lh_floatOutId_0_1)))))
    | `LH_N -> 
      _lh_floatOutId_0_1);;
...
let rec foldr_lh__d1 f_3_0 i_1_8 ls_6 =
  ((ls_6 f_3_0) i_1_8);;
let rec lift_lh__d7 _lh_lift_arg1_3 _lh_lift_arg2_3 _lh_floatOutId_0_2 =
  ...
  (match _lh_all_arg2_0 with
    ...
    | `LH_C(_lh_all_LH_C_0_0, _lh_all_LH_C_1_0) -> 
      (if (_lh_all_arg1_0 _lh_all_LH_C_0_0) then
        ...
        false));;
let rec lift_lh__d5 _lh_lift_arg1_4 _lh_lift_arg2_4 _lh_floatOutId_0_3 =
...
let rec copy_lh__d1 _lh_copy_arg1_0 _lh_copy_arg2_0 _lh_floatOutId_0_4 =
  (if (_lh_copy_arg1_0 <= 0) then
    ...
    (let rec _lh_all_LH_C_1_1 = ((copy_lh__d1 (_lh_copy_arg1_0 - 1)) _lh_copy_arg2_0) in
      (let rec _lh_all_LH_C_0_1 = _lh_copy_arg2_0 in
        (if (_lh_floatOutId_0_4 _lh_all_LH_C_0_1) then
          ((all_lh__d1 _lh_floatOutId_0_4) _lh_all_LH_C_1_1)
        else
          false))));;
...
let rec fst_lh__d3 _lh_fst_arg1_3 =
  (match _lh_fst_arg1_3 with
    | `LH_P2(_lh_fst_LH_P2_0_3, _lh_fst_LH_P2_1_3) -> 
      _lh_fst_LH_P2_0_3);;
let rec map_lh__d1 f_3_5 ls_1_4 _lh_floatOutId_0_5 =
  (match ls_1_4 with
    | `LH_C(h_3_3, t_4_0) -> 
      (let rec t_4_1 = ((map_lh__d1 f_3_5) t_4_0) in
        (let rec h_3_4 = (f_3_5 h_3_3) in
          (`LH_C(h_3_4, ((mappend_lh__d3 t_4_1) _lh_floatOutId_0_5)))))
    | `LH_N -> 
      _lh_floatOutId_0_5);;
...
let rec map_lh__d5 f_3_7 ls_1_6 _lh_floatOutId_0_8 =
  (match ls_1_6 with
    | `LH_C(h_3_6, t_4_4) -> 
      (let rec _lh_inList_LH_C_1_1_4 = ((map_lh__d5 f_3_7) t_4_4) in
        (let rec _lh_inList_LH_C_0_1_4 = (f_3_7 h_3_6) in
          (if (_lh_floatOutId_0_8 = _lh_inList_LH_C_0_1_4) then
            true
          else
            ((inList_lh__d1 _lh_floatOutId_0_8) _lh_inList_LH_C_1_1_4))))
    | `LH_N -> 
      false);;
...
let rec concat_lh__d1 lss_1 =
  (lss_1 99);;
let rec map_lh__d3 f_3_9 ls_1_8 _lh_floatOutId_0_9 _lh_floatOutId_1_0 =
  (match ls_1_8 with
    | `LH_C(h_3_8, t_4_6) -> 
      (let rec t_4_7 = ((map_lh__d3 f_3_9) t_4_6) in
        (let rec h_3_9 = (f_3_9 h_3_8) in
          (let rec t_4_8 = ((map_lh__d2 _lh_floatOutId_0_9) t_4_7) in
            (let rec h_4_0 = (_lh_floatOutId_0_9 h_3_9) in
    ...
    (let rec _lh_result_LH_P2_0_0 = (`LH_C('I', (`LH_C('(', (`LH_C('a', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('b', (`LH_C(')', (`LH_N))))))))))))))))) in
      (fun _lh_dummy_0 -> 
              ...
              | `LH_C(_lh_listcomp_fun_ls_h_0, _lh_listcomp_fun_ls_t_0) -> 
                (match _lh_listcomp_fun_ls_h_0 with
                  | `LH_P2(_lh_superpose_LH_P2_0_0, _lh_superpose_LH_P2_1_0) -> 
                    (`LH_C(((lift_lh__d6 (pair_lh__d2 _lh_superpose_LH_P2_0_0)) ((unify_lh__d1 _lh_superpose_arg1_0) _lh_superpose_LH_P2_1_0)), (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_0)))
                  | _ -> 
              ...
              (match _lh_rem_eq_LH_P2_0_0 with
                ...
                | `LH_C(_lh_rem_eq_LH_C_0_0, _lh_rem_eq_LH_C_1_0) -> 
                  (let rec add_x_0 = (fun xsys_0 -> 
                    ...
                    ((getOrElse_lh__d2 ((lift_lh__d9 (fun _lh_funcomp_x_1 -> 
                      ((rem_eq_0 _lh_rem_eq_arg1_0) ((pair_lh__d1 _lh_rem_eq_LH_C_1_0) _lh_funcomp_x_1)))) (((delete_0 _lh_rem_eq_arg1_0) _lh_rem_eq_LH_C_0_0) _lh_rem_eq_LH_P2_1_0))) (add_x_0 ((rem_eq_0 _lh_rem_eq_arg1_0) (`LH_P2(_lh_rem_eq_LH_C_1_0, _lh_rem_eq_LH_P2_1_0)))))))))
        ...
        and parse_eqn_0 = (fun _lh_parse_eqn_arg1_0 -> 
          (let rec _lh_matchIdent_1 = (fst_lh__d2 (the_lh__d1 (p_eqn_0 _lh_parse_eqn_arg1_0))) in
              ...
              (match _lh_matchIdent_2 with
                ...
                | `LH_C(_lh_addby_LH_C_0_0, _lh_addby_LH_C_1_0) -> 
                  (if ((_lh_addby_arg1_0 x_3) <= (_lh_addby_arg1_0 _lh_addby_LH_C_0_0)) then
                    ...
                    (`LH_C(_lh_addby_LH_C_0_0, ((insert_0 x_3) _lh_addby_LH_C_1_0))))))) in
            ...
            (let rec _lh_matchIdent_3 = xs_3 in
              (match _lh_matchIdent_3 with
                | `LH_P2(_lh_seq2Lzq_LH_P2_0_0, _lh_seq2Lzq_LH_P2_1_0) -> 
                  ((lift_lh__d3 ((cross_lh__d3 (_lh_seq2Lzq_arg1_0 _lh_seq2Lzq_LH_P2_0_0)) (fun x_4 -> 
                    x_4))) ((Lazy.force _lh_seq2Lzq_arg3_0) _lh_seq2Lzq_LH_P2_1_0))))) in
            (fun _lh_funcomp_x_2 -> 
              ((fun _lh_funcomp_x_3 -> 
                (squash_lh__d2 ((lift_lh__d4 g_0) _lh_funcomp_x_3))) (_lh_seq2Lzq_arg2_0 _lh_funcomp_x_2)))))
            ...
            (let rec _lh_process2_LH_P2_1_0 = (let rec _lh_listcomp_fun_1 = (fun _lh_listcomp_fun_para_1 -> 
              ...
              (let rec _lh_process2_LH_P2_0_0 = (let rec _lh_listcomp_fun_2 = (fun _lh_listcomp_fun_para_2 -> 
                ...
                (fun _lh_process2_arg1_0 _lh_process2_arg2_0 _lh_process2_arg4_0 _lh_process2_arg5_0 _lh_process2_arg6_0 add_agenda_1 add_eqn_1 all_crit_pairs_1 process_1 resolve_1 super_reduce_1 -> 
                  (let rec net'_0 = ((add_eqn_1 ((delete_eqns_lh__d1 ((map_lh__d5 eqno_lh__d1) _lh_process2_LH_P2_0_0)) _lh_process2_arg4_0)) _lh_process2_arg6_0) in
                    (let rec deletions_0 = ((map_lh__d1 eqpr_lh__d1) _lh_process2_LH_P2_0_0) in
                      (let rec critical_0 = ((all_crit_pairs_1 _lh_process2_arg6_0) _lh_process2_LH_P2_1_0) in
                        (let rec new_agenda_0 = (sift_lh__d2 ((map_lh__d7 (resolve_1 (super_reduce_1 net'_0))) ((mappend_lh__d3 deletions_0) critical_0))) in
                          (let rec todo'_0 = (((add_agenda_1 (snd_lh__d1 _lh_process2_arg1_0)) new_agenda_0) _lh_process2_arg5_0) in
                            (((((process_1 _lh_process2_arg1_0) _lh_process2_arg2_0) ((mappend_lh__d1 _lh_process2_LH_P2_1_0) (`LH_C(_lh_process2_arg6_0, (`LH_N))))) net'_0) todo'_0)))))))))))
        and build_0 = (fun _lh_build_arg1_0 _lh_build_arg2_0 _lh_funcomp_x_4 -> 
          ((lift_lh__d8 ((cross_lh__d1 _lh_build_arg1_0) (fun x_5 -> 
        ...
        and p_prim_0 = (fun _lh_p_prim_arg1_0 -> 
          (((orElseMap_lh__d2 p_name_0) ((seQ_0 (fun x_6 -> 
            ((atIndex_lh__d3 1) x_6))) (let rec t_1_2 = (let rec t_1_3 = (let rec t_1_4 = (fun f_8 i_1 -> 
            i_1) in
        ...
        and opsym_0 = (fun _lh_opsym_arg1_0 -> 
          ((fun x_7 -> 
            ((inList_lh__d1 x_7) (let rec _lh_inList_LH_C_1_4 = (let rec _lh_inList_LH_C_1_5 = (let rec _lh_inList_LH_C_1_6 = (let rec _lh_inList_LH_C_1_7 = (let rec _lh_inList_LH_C_1_8 = (let rec _lh_inList_LH_C_1_9 = (let rec _lh_inList_LH_C_1_1_0 = (let rec _lh_inList_LH_C_1_1_1 = (fun _lh_inList_arg1_6 -> 
              false) in
        ...
        and list_of_0 = (fun _lh_list_of_arg1_0 _lh_list_of_arg2_0 -> 
          (let rec p'_0 = (lazy (((seq2_0 mk_cons_0) _lh_list_of_arg1_0) ((orElseMap_lh__d4 (((seq2Lzq_0 (fun x_1_0 y_0 -> 
        ...
        and sp_0 = (fun _lh_sp_arg1_0 _lh_funcomp_x_5 -> 
          (_lh_sp_arg1_0 ((dropWhile_lh__d2 (fun x_1_1 -> 
            (x_1_1 = ' '))) _lh_funcomp_x_5)))
        and p_eqn_0 = (fun _lh_p_eqn_arg1_0 -> 
          (((seQ_0 q_eqn_0) (let rec t_1_9 = (let rec t_2_0 = (let rec t_2_1 = (fun f_1_7 i_1_0 -> 
            i_1_0) in
            (let rec h_1_3 = p_expr_0 in
              (fun f_1_8 i_1_1 -> 
                ((f_1_8 h_1_3) (((foldr_lh__d1 f_1_8) i_1_1) t_2_1))))) in
            (let rec h_1_4 = (look_for_0 '=') in
              (fun f_1_9 i_1_2 -> 
                ((f_1_9 h_1_4) (((foldr_lh__d1 f_1_9) i_1_2) t_2_0))))) in
            (let rec h_1_5 = p_expr_0 in
              (fun f_2_0 i_1_3 -> 
                ((f_2_0 h_1_5) (((foldr_lh__d1 f_2_0) i_1_3) t_1_9)))))) _lh_p_eqn_arg1_0))
            ...
            (let rec _lh_matchIdent_9 = xs_4 in
              (match _lh_matchIdent_9 with
                | `LH_P2(_lh_seq2_LH_P2_0_0, _lh_seq2_LH_P2_1_0) -> 
                  ((lift_lh__d2 ((cross_lh__d2 (_lh_seq2_arg1_0 _lh_seq2_LH_P2_0_0)) (fun x_1_2 -> 
                    x_1_2))) (_lh_seq2_arg3_0 _lh_seq2_LH_P2_1_0))))) in
            (fun _lh_funcomp_x_6 -> 
              ((fun _lh_funcomp_x_7 -> 
                (squash_lh__d1 ((lift_lh__d7 g_1) _lh_funcomp_x_7))) (_lh_seq2_arg2_0 _lh_funcomp_x_6)))))
        ...
        and p_expr_0 = (fun _lh_p_expr_arg1_0 -> 
          (((orElseMap_lh__d1 ((seQ_0 q_op_0) (let rec t_2_2 = (let rec t_2_3 = (let rec t_2_4 = (fun f_2_1 i_1_4 -> 
            i_1_4) in
            (let rec h_1_6 = p_term_0 in
              (fun f_2_2 i_1_5 -> 
                ((f_2_2 h_1_6) (((foldr_lh__d1 f_2_2) i_1_5) t_2_4))))) in
            (let rec h_1_7 = p_op_0 in
              (fun f_2_3 i_1_6 -> 
                ((f_2_3 h_1_7) (((foldr_lh__d1 f_2_3) i_1_6) t_2_3))))) in
            (let rec h_1_8 = p_term_0 in
              (fun f_2_4 i_1_7 -> 
                ((f_2_4 h_1_8) (((foldr_lh__d1 f_2_4) i_1_7) t_2_2))))))) p_term_0) _lh_p_expr_arg1_0))
          ...
          ((fun _lh_funcomp_x_8 -> 
            ((fun _lh_funcomp_x_9 -> 
              ((fun _lh_funcomp_x_1_0 -> 
                (unExpr_0 (fst_lh__d3 _lh_funcomp_x_1_0))) (the_lh__d2 _lh_funcomp_x_9))) (p_expr_0 _lh_funcomp_x_8))) _lh_parse_arg1_0))
