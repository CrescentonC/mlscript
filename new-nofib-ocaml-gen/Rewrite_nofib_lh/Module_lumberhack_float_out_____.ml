...
let rec rewrite_lh__d1 _lh_rewrite_arg1_0 _lh_floatOutId_0_9 =
    ...
    | `Eqn(_lh_rewrite_Eqn_0_0, _lh_rewrite_Eqn_1_0) -> 
      (match _lh_rewrite_Eqn_1_0 with
        | `LH_P2(_lh_rewrite_LH_P2_0_0, _lh_rewrite_LH_P2_1_0) -> 
          ((lift_lh__d1_d0 (sub_lh__d2 _lh_rewrite_LH_P2_1_0)) ((match_lh__d1 _lh_rewrite_LH_P2_0_0) _lh_floatOutId_0_9))));;
  ...
  (match _lh_all_arg2_0 with
    ...
    | `LH_C(_lh_all_LH_C_0_0, _lh_all_LH_C_1_0) -> 
      (if (_lh_all_arg1_0 _lh_all_LH_C_0_0) then
        ...
        false));;
let rec lift_lh__d5 _lh_lift_arg1_4 _lh_lift_arg2_4 _lh_floatOutId_0_1 =
...
let rec fst_lh__d2 _lh_fst_arg1_1 =
  (match _lh_fst_arg1_1 with
    | `LH_P2(_lh_fst_LH_P2_0_1, _lh_fst_LH_P2_1_1) -> 
      _lh_fst_LH_P2_0_1);;
let rec lift_lh__d3 _lh_lift_arg1_6 _lh_lift_arg2_6 _lh_floatOutId_0_2 =
...
let rec copy_lh__d1 _lh_copy_arg1_0 _lh_copy_arg2_0 _lh_floatOutId_0_3 =
  (if (_lh_copy_arg1_0 <= 0) then
    ...
    (let rec _lh_all_LH_C_1_1 = ((copy_lh__d1 (_lh_copy_arg1_0 - 1)) _lh_copy_arg2_0) in
      (let rec _lh_all_LH_C_0_1 = _lh_copy_arg2_0 in
        (if (_lh_floatOutId_0_3 _lh_all_LH_C_0_1) then
          ((all_lh__d1 _lh_floatOutId_0_3) _lh_all_LH_C_1_1)
        else
          false))));;
...
let rec atIndex_lh__d3 n_0 ls_8 =
  (if (n_0 < 0) then
    ...
    (match ls_8 with
      ...
      | `LH_N -> 
        (failwith "lh_default_error")));;
let rec map_lh__d6 f_1_5 ls_1_0 _lh_floatOutId_0_4 =
  (match ls_1_0 with
    | `LH_C(h_1_5, t_2_2) -> 
      (let rec _lh_inList_LH_C_1_1_2 = ((map_lh__d6 f_1_5) t_2_2) in
        (let rec _lh_inList_LH_C_0_1_2 = (f_1_5 h_1_5) in
          (if (_lh_floatOutId_0_4 = _lh_inList_LH_C_0_1_2) then
            true
          else
            ((inList_lh__d1 _lh_floatOutId_0_4) _lh_inList_LH_C_1_1_2))))
    | `LH_N -> 
      false);;
let rec map_lh__d1_d2 f_1_6 ls_1_1 _lh_floatOutId_0_5 _lh_floatOutId_1_0 =
  (match ls_1_1 with
    | `LH_C(h_1_6, t_2_3) -> 
      (let rec t_2_4 = ((map_lh__d1_d2 f_1_6) t_2_3) in
        (let rec h_1_7 = (f_1_6 h_1_6) in
          ((_lh_floatOutId_0_5 h_1_7) (((foldr_lh__d1 _lh_floatOutId_0_5) _lh_floatOutId_1_0) t_2_4))))
    | `LH_N -> 
      _lh_floatOutId_1_0);;
...
let rec mappend_lh__d4 xs_9 ys_9 =
  (xs_9 ys_9);;
let rec map_lh__d2 f_1_9 ls_1_2 _lh_floatOutId_0_6 =
  (match ls_1_2 with
    | `LH_C(h_1_8, t_2_5) -> 
      (let rec t_2_6 = ((map_lh__d2 f_1_9) t_2_5) in
        (let rec h_1_9 = (f_1_9 h_1_8) in
          (`LH_C(h_1_9, ((mappend_lh__d6 t_2_6) _lh_floatOutId_0_6)))))
    | `LH_N -> 
      _lh_floatOutId_0_6);;
...
let rec map_lh__d4 f_2_7 ls_1_9 =
  (ls_1_9 f_2_7);;
let rec map_lh__d1 f_2_0 ls_1_4 _lh_floatOutId_0_7 =
  (match ls_1_4 with
    | `LH_C(h_2_1, t_2_8) -> 
      (let rec t_2_9 = ((map_lh__d1 f_2_0) t_2_8) in
        (let rec h_2_2 = (f_2_0 h_2_1) in
          (`LH_C((_lh_floatOutId_0_7 h_2_2), ((map_lh__d4 _lh_floatOutId_0_7) t_2_9)))))
    | `LH_N -> 
      (`LH_N));;
...
let rec map_lh__d8 f_2_9 ls_2_4 _lh_floatOutId_0_1_0 =
  (match ls_2_4 with
    | `LH_C(h_3_0, t_3_8) -> 
      (let rec t_3_9 = ((map_lh__d8 f_2_9) t_3_8) in
        (let rec h_3_1 = (f_2_9 h_3_0) in
          (`LH_C(h_3_1, ((mappend_lh__d4 t_3_9) _lh_floatOutId_0_1_0)))))
    | `LH_N -> 
    ...
    (let rec _lh_result_LH_P2_0_0 = (`LH_C('I', (`LH_C('(', (`LH_C('a', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('b', (`LH_C(')', (`LH_N))))))))))))))))) in
      (fun _lh_dummy_0 -> 
              ...
              | `LH_C(_lh_listcomp_fun_ls_h_0, _lh_listcomp_fun_ls_t_0) -> 
                (match _lh_listcomp_fun_ls_h_0 with
                  | `LH_P2(_lh_superpose_LH_P2_0_0, _lh_superpose_LH_P2_1_0) -> 
                    (`LH_C(((lift_lh__d8 (pair_lh__d2 _lh_superpose_LH_P2_0_0)) ((unify_lh__d1 _lh_superpose_arg1_0) _lh_superpose_LH_P2_1_0)), (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_0)))
                  | _ -> 
              ...
              (match _lh_rem_eq_LH_P2_0_0 with
                ...
                | `LH_C(_lh_rem_eq_LH_C_0_0, _lh_rem_eq_LH_C_1_0) -> 
                  (let rec add_x_0 = (fun xsys_0 -> 
                    ...
                    ((getOrElse_lh__d1 ((lift_lh__d3 (fun _lh_funcomp_x_1 -> 
            ...
            (let rec _lh_matchIdent_3 = xs_3 in
              (match _lh_matchIdent_3 with
                | `LH_P2(_lh_seq2Lzq_LH_P2_0_0, _lh_seq2Lzq_LH_P2_1_0) -> 
                  ((lift_lh__d6 ((cross_lh__d1 (_lh_seq2Lzq_arg1_0 _lh_seq2Lzq_LH_P2_0_0)) (fun x_4 -> 
                    x_4))) ((Lazy.force _lh_seq2Lzq_arg3_0) _lh_seq2Lzq_LH_P2_1_0))))) in
            (fun _lh_funcomp_x_2 -> 
              ((fun _lh_funcomp_x_3 -> 
                (squash_lh__d2 ((lift_lh__d5 g_0) _lh_funcomp_x_3))) (_lh_seq2Lzq_arg2_0 _lh_funcomp_x_2)))))
            ...
            (let rec _lh_process2_LH_P2_1_0 = (let rec _lh_listcomp_fun_1 = (fun _lh_listcomp_fun_para_1 -> 
              ...
              (let rec _lh_process2_LH_P2_0_0 = (let rec _lh_listcomp_fun_2 = (fun _lh_listcomp_fun_para_2 -> 
                ...
                (fun _lh_process2_arg1_0 _lh_process2_arg2_0 _lh_process2_arg4_0 _lh_process2_arg5_0 _lh_process2_arg6_0 add_agenda_1 add_eqn_1 all_crit_pairs_1 process_1 resolve_1 super_reduce_1 -> 
                  (let rec net'_0 = ((add_eqn_1 ((delete_eqns_lh__d1 ((map_lh__d6 eqno_lh__d1) _lh_process2_LH_P2_0_0)) _lh_process2_arg4_0)) _lh_process2_arg6_0) in
                    (let rec deletions_0 = ((map_lh__d9 eqpr_lh__d1) _lh_process2_LH_P2_0_0) in
                      (let rec critical_0 = ((all_crit_pairs_1 _lh_process2_arg6_0) _lh_process2_LH_P2_1_0) in
                        (let rec new_agenda_0 = (sift_lh__d2 ((map_lh__d1_d3 (resolve_1 (super_reduce_1 net'_0))) ((mappend_lh__d7 deletions_0) critical_0))) in
                          (let rec todo'_0 = (((add_agenda_1 (snd_lh__d3 _lh_process2_arg1_0)) new_agenda_0) _lh_process2_arg5_0) in
                            (((((process_1 _lh_process2_arg1_0) _lh_process2_arg2_0) ((mappend_lh__d5 _lh_process2_LH_P2_1_0) (`LH_C(_lh_process2_arg6_0, (`LH_N))))) net'_0) todo'_0)))))))))))
        and build_0 = (fun _lh_build_arg1_0 _lh_build_arg2_0 _lh_funcomp_x_4 -> 
          ((lift_lh__d9 ((cross_lh__d3 _lh_build_arg1_0) (fun x_5 -> 
        ...
        and p_prim_0 = (fun _lh_p_prim_arg1_0 -> 
          (((orElseMap_lh__d1 p_name_0) ((seQ_0 (fun x_6 -> 
            ((atIndex_lh__d2 1) x_6))) (`LH_C((look_for_0 '('), (`LH_C(p_expr_0, (`LH_C((look_for_0 ')'), (`LH_N))))))))) _lh_p_prim_arg1_0))
        ...
        and opsym_0 = (fun _lh_opsym_arg1_0 -> 
          ((fun x_7 -> 
            ((inList_lh__d1 x_7) (let rec _lh_inList_LH_C_1_2 = (let rec _lh_inList_LH_C_1_3 = (let rec _lh_inList_LH_C_1_4 = (let rec _lh_inList_LH_C_1_5 = (let rec _lh_inList_LH_C_1_6 = (let rec _lh_inList_LH_C_1_7 = (let rec _lh_inList_LH_C_1_8 = (let rec _lh_inList_LH_C_1_9 = (fun _lh_inList_arg1_3 -> 
              false) in
        ...
        and seq2_0 = (fun _lh_seq2_arg1_0 _lh_seq2_arg2_0 _lh_seq2_arg3_0 -> 
          (let rec g_1 = (fun xs_4 -> 
            ...
            (fun _lh_funcomp_x_6 -> 
              ((fun _lh_funcomp_x_7 -> 
                (squash_lh__d1 ((lift_lh__d4 g_1) _lh_funcomp_x_7))) (_lh_seq2_arg2_0 _lh_funcomp_x_6)))))
