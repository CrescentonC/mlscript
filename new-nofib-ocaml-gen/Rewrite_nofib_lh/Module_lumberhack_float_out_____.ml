    ...
    (let rec _lh_result_LH_P2_0_0 = (`LH_C('I', (`LH_C('(', (`LH_C('a', (`LH_C(' ', (`LH_C('*', (`LH_C(' ', (`LH_C('b', (`LH_C(')', (`LH_N))))))))))))))))) in
      (fun _lh_dummy_0 -> 
              ...
              | `LH_C(_lh_listcomp_fun_ls_h_0, _lh_listcomp_fun_ls_t_0) -> 
                (match _lh_listcomp_fun_ls_h_0 with
                  | `LH_P2(_lh_superpose_LH_P2_0_0, _lh_superpose_LH_P2_1_0) -> 
                    (`LH_C(((lift_lh__d5 (pair_lh__d1 _lh_superpose_LH_P2_0_0)) ((unify_lh__d1 _lh_superpose_arg1_0) _lh_superpose_LH_P2_1_0)), (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_0)))
                  | _ -> 
          ...
          (match _lh_delete_arg3_0 with
            ...
            | `LH_C(_lh_delete_LH_C_0_0, _lh_delete_LH_C_1_0) -> 
              (if ((_lh_delete_arg1_0 _lh_delete_arg2_0) _lh_delete_LH_C_0_0) then
                ...
                ((lift_lh__d7 (fun x_3 -> 
                  (`LH_C(_lh_delete_LH_C_0_0, x_3)))) (((delete_0 _lh_delete_arg1_0) _lh_delete_arg2_0) _lh_delete_LH_C_1_0)))
            | _ -> 
              (failwith "error")))
                  ...
                  (let rec add_x_0 = (fun xsys_0 -> 
                    (let rec _lh_matchIdent_0 = xsys_0 in
                      (match _lh_matchIdent_0 with
                        ...
                        | _ -> 
                          (failwith "error")))) in
                    ((getOrElse_lh__d1 ((lift_lh__d2 (fun _lh_funcomp_x_1 -> 
        ...
        and parse_eqn_0 = (fun _lh_parse_eqn_arg1_0 -> 
          (let rec _lh_matchIdent_1 = (fst_lh__d4 (the_lh__d2 (p_eqn_0 _lh_parse_eqn_arg1_0))) in
        ...
        and addby_0 = (fun _lh_addby_arg1_0 _lh_addby_arg2_0 _lh_addby_arg3_0 -> 
          (let rec insert_0 = (fun x_4 ls_4 -> 
            (let rec _lh_matchIdent_2 = ls_4 in
              (match _lh_matchIdent_2 with
                | `LH_N -> 
                  (`LH_C(x_4, (`LH_N)))
                | `LH_C(_lh_addby_LH_C_0_0, _lh_addby_LH_C_1_0) -> 
                  (if ((_lh_addby_arg1_0 x_4) <= (_lh_addby_arg1_0 _lh_addby_LH_C_0_0)) then
                    (`LH_C(x_4, (`LH_C(_lh_addby_LH_C_0_0, _lh_addby_LH_C_1_0))))
                  else
                    (`LH_C(_lh_addby_LH_C_0_0, ((insert_0 x_4) _lh_addby_LH_C_1_0))))
                | _ -> 
                  (failwith "error")))) in
            ...
            (let rec _lh_matchIdent_3 = xs_3 in
              (match _lh_matchIdent_3 with
                | `LH_P2(_lh_seq2Lzq_LH_P2_0_0, _lh_seq2Lzq_LH_P2_1_0) -> 
                  ((lift_lh__d6 ((cross_lh__d2 (_lh_seq2Lzq_arg1_0 _lh_seq2Lzq_LH_P2_0_0)) (fun x_5 -> 
                    x_5))) ((Lazy.force _lh_seq2Lzq_arg3_0) _lh_seq2Lzq_LH_P2_1_0))
                | _ -> 
                  (failwith "error")))) in
            (fun _lh_funcomp_x_2 -> 
              ((fun _lh_funcomp_x_3 -> 
            ...
            (let rec _lh_process2_LH_P2_1_0 = (let rec _lh_listcomp_fun_1 = (fun _lh_listcomp_fun_para_1 -> 
              ...
              (let rec _lh_process2_LH_P2_0_0 = (let rec _lh_listcomp_fun_2 = (fun _lh_listcomp_fun_para_2 -> 
                ...
                (fun _lh_process2_arg1_0 _lh_process2_arg2_0 _lh_process2_arg4_0 _lh_process2_arg5_0 _lh_process2_arg6_0 add_agenda_1 add_eqn_1 all_crit_pairs_1 process_1 resolve_1 super_reduce_1 -> 
                  (let rec net'_0 = ((add_eqn_1 ((delete_eqns_lh__d1 ((map_lh__d7 eqno_lh__d1) _lh_process2_LH_P2_0_0)) _lh_process2_arg4_0)) _lh_process2_arg6_0) in
                      ...
                      (let rec critical_0 = ((all_crit_pairs_1 _lh_process2_arg6_0) _lh_process2_LH_P2_1_0) in
                        (let rec new_agenda_0 = (sift_lh__d2 ((map_lh__d1_d0 (resolve_1 (super_reduce_1 net'_0))) ((mappend_lh__d4 deletions_0) critical_0))) in
                          (let rec todo'_0 = (((add_agenda_1 (snd_lh__d2 _lh_process2_arg1_0)) new_agenda_0) _lh_process2_arg5_0) in
                            (((((process_1 _lh_process2_arg1_0) _lh_process2_arg2_0) ((mappend_lh__d6 _lh_process2_LH_P2_1_0) (`LH_C(_lh_process2_arg6_0, (`LH_N))))) net'_0) todo'_0)))))))))))
        and build_0 = (fun _lh_build_arg1_0 _lh_build_arg2_0 _lh_funcomp_x_4 -> 
          ((lift_lh__d1 ((cross_lh__d1 _lh_build_arg1_0) (fun x_6 -> 
            x_6))) (_lh_build_arg2_0 _lh_funcomp_x_4)))
        ...
        and p_prim_0 = (fun _lh_p_prim_arg1_0 -> 
          (((orElseMap_lh__d3 p_name_0) ((seQ_0 (fun x_7 -> 
            ((atIndex_lh__d3 1) x_7))) (let rec t_1_2 = (let rec t_1_3 = (let rec t_1_4 = (fun f_1_0 i_1 -> 
            i_1) in
        ...
        and opsym_0 = (fun _lh_opsym_arg1_0 -> 
          ((fun x_8 -> 
            ((inList_lh__d1 x_8) (let rec _lh_inList_LH_C_1_3 = (let rec _lh_inList_LH_C_1_4 = (let rec _lh_inList_LH_C_1_5 = (let rec _lh_inList_LH_C_1_6 = (let rec _lh_inList_LH_C_1_7 = (let rec _lh_inList_LH_C_1_8 = (let rec _lh_inList_LH_C_1_9 = (let rec _lh_inList_LH_C_1_1_0 = (fun _lh_inList_arg1_5 -> 
              false) in
                    ...
                    | `Func(_lh_lex_ext_Func_0_1, _lh_lex_ext_Func_1_1) -> 
                      (let rec estimate_0 = ((lexico_0 _lh_lex_ext_arg1_0) (`LH_P2(_lh_lex_ext_Func_1_0, _lh_lex_ext_Func_1_1))) in
                        (let rec confirm_0 = (fun x_9 -> 
                          (let rec _lh_matchIdent_6 = x_9 in
        ...
        and look_for_0 = (fun _lh_look_for_arg1_0 -> 
          (sp_0 (pchar_0 (fun x_1_0 -> 
            (x_1_0 = _lh_look_for_arg1_0)))))
        ...
        and list_of_0 = (fun _lh_list_of_arg1_0 _lh_list_of_arg2_0 -> 
          (let rec p'_0 = (lazy (((seq2_0 mk_cons_0) _lh_list_of_arg1_0) ((orElseMap_lh__d4 (((seq2Lzq_0 (fun x_1_1 y_1 -> 
        ...
        and sp_0 = (fun _lh_sp_arg1_0 _lh_funcomp_x_5 -> 
          (_lh_sp_arg1_0 ((dropWhile_lh__d1 (fun x_1_2 -> 
            (x_1_2 = ' '))) _lh_funcomp_x_5)))
        and p_eqn_0 = (fun _lh_p_eqn_arg1_0 -> 
          (((seQ_0 q_eqn_0) (let rec t_1_9 = (let rec t_2_0 = (let rec t_2_1 = (fun f_1_9 i_1_0 -> 
            i_1_0) in
            ...
            (let rec h_1_5 = p_expr_0 in
              (fun f_2_2 i_1_3 -> 
                ((f_2_2 h_1_5) (((foldr_lh__d1 f_2_2) i_1_3) t_1_9)))))) _lh_p_eqn_arg1_0))
            ...
            (let rec _lh_matchIdent_9 = xs_4 in
              (match _lh_matchIdent_9 with
                | `LH_P2(_lh_seq2_LH_P2_0_0, _lh_seq2_LH_P2_1_0) -> 
                  ((lift_lh__d3 ((cross_lh__d3 (_lh_seq2_arg1_0 _lh_seq2_LH_P2_0_0)) (fun x_1_3 -> 
                    x_1_3))) (_lh_seq2_arg3_0 _lh_seq2_LH_P2_1_0))
                | _ -> 
                  (failwith "error")))) in
            (fun _lh_funcomp_x_6 -> 
              ((fun _lh_funcomp_x_7 -> 
                (squash_lh__d1 ((lift_lh__d9 g_1) _lh_funcomp_x_7))) (_lh_seq2_arg2_0 _lh_funcomp_x_6)))))
        ...
        and p_expr_0 = (fun _lh_p_expr_arg1_0 -> 
          (((orElseMap_lh__d2 ((seQ_0 q_op_0) (let rec t_2_2 = (let rec t_2_3 = (let rec t_2_4 = (fun f_2_3 i_1_4 -> 
            i_1_4) in
            ...
            (let rec h_1_8 = p_term_0 in
              (fun f_2_6 i_1_7 -> 
                ((f_2_6 h_1_8) (((foldr_lh__d1 f_2_6) i_1_7) t_2_2))))))) p_term_0) _lh_p_expr_arg1_0))
          ...
          ((fun _lh_funcomp_x_8 -> 
            ((fun _lh_funcomp_x_9 -> 
              ((fun _lh_funcomp_x_1_0 -> 
                (unExpr_0 (fst_lh__d2 _lh_funcomp_x_1_0))) (the_lh__d1 _lh_funcomp_x_9))) (p_expr_0 _lh_funcomp_x_8))) _lh_parse_arg1_0))
