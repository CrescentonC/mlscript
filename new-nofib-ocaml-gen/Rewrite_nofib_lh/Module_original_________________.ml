...
let rec map_dnet_lh _lh_map_dnet_arg1_0 _lh_map_dnet_arg2_0 =
  (match _lh_map_dnet_arg2_0 with
    | `Switch(_lh_map_dnet_Switch_0_0, _lh_map_dnet_Switch_1_0) -> 
      (`Switch(((map_lh ((cross_lh (fun x_1_2 -> 
        x_1_2)) (map_dnet_lh _lh_map_dnet_arg1_0))) _lh_map_dnet_Switch_0_0), ((map_dnet_lh _lh_map_dnet_arg1_0) _lh_map_dnet_Switch_1_0)))
      ...
      (match _lh_rewrite_Eqn_1_0 with
        | `LH_P2(_lh_rewrite_LH_P2_0_0, _lh_rewrite_LH_P2_1_0) -> 
          (fun _lh_funcomp_x_1_0 -> 
            ((lift_lh (sub_lh _lh_rewrite_LH_P2_1_0)) ((match_lh _lh_rewrite_LH_P2_0_0) _lh_funcomp_x_1_0)))));;
...
let rec mappend_lh xs_2 ys_2 =
  (match xs_2 with
    | `LH_C(h_5, t_5) -> 
      (`LH_C(h_5, ((mappend_lh t_5) ys_2)))
    | `LH_N -> 
      ys_2);;
let rec stand_lh _lh_stand_arg1_0 =
  ((expr_fold_lh (fun x_1_3 y_1 -> 
    (`Func(x_1_3, y_1)))) (fun v_0 -> 
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_7, _lh_listcomp_fun_ls_t_7) -> 
        (match _lh_listcomp_fun_ls_h_7 with
          | `LH_P2(_lh_comp_sub_LH_P2_0_0, _lh_comp_sub_LH_P2_1_0) -> 
            (`LH_C((`LH_P2(_lh_comp_sub_LH_P2_0_0, ((sub_lh _lh_comp_sub_LH_P2_1_0) _lh_comp_sub_arg1_0))), (_lh_listcomp_fun_7 _lh_listcomp_fun_ls_t_7)))
          | _ -> 
...
univar_lh _lh_univar_arg1_0 _lh_univar_arg2_0 _lh_univar_arg3_0 =
  (let rec t_1_1 = ((assoc_lh _lh_univar_arg1_0) _lh_univar_arg2_0) in
    (if (exists_lh t_1_1) then
      ((unify'_lh _lh_univar_arg1_0) (`LH_P2((the_lh t_1_1), _lh_univar_arg3_0)))
    else
...
let rec subterms_lh _lh_subterms_arg1_0 =
  (match _lh_subterms_arg1_0 with
    ...
    | `Func(_lh_subterms_Func_0_0, _lh_subterms_Func_1_0) -> 
      ((mappend_lh (`LH_C((`LH_P2((`LH_N), (`Func(_lh_subterms_Func_0_0, _lh_subterms_Func_1_0)))), (`LH_N)))) (let rec _lh_listcomp_fun_0 = (fun _lh_listcomp_fun_para_0 -> 
                    ...
                    | `LH_C(_lh_listcomp_fun_ls_h_1, _lh_listcomp_fun_ls_t_1) -> 
                      (match _lh_listcomp_fun_ls_h_1 with
                        | `LH_P2(_lh_subterms_LH_P2_0_1, _lh_subterms_LH_P2_1_1) -> 
                          (`LH_C((`LH_P2((`LH_C(_lh_subterms_LH_P2_0_0, _lh_subterms_LH_P2_0_1)), _lh_subterms_LH_P2_1_1)), (_lh_listcomp_fun_1 _lh_listcomp_fun_ls_t_1)))
                        | _ -> 
                          (_lh_listcomp_fun_1 _lh_listcomp_fun_ls_t_1))
                    | `LH_N -> 
                      (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_0))) in
                  (_lh_listcomp_fun_1 (subterms_lh _lh_subterms_LH_P2_1_0)))
              | _ -> 
                (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_0))
          | `LH_N -> 
            (`LH_N))) in
        (_lh_listcomp_fun_0 ((zip_lz_nl_lh (enumFrom_lh 0)) _lh_subterms_Func_1_0)))));;
  ...
  (match _lh_result_arg1_0 with
    | `LH_P2(_lh_result_LH_P2_0_0, _lh_result_LH_P2_1_0) -> 
      let rec multi_0 = (fun _lh_multi_arg1_0 _lh_multi_arg2_0 -> 
        (match _lh_multi_arg2_0 with
          | `LH_P2(_lh_multi_LH_P2_0_0, _lh_multi_LH_P2_1_0) -> 
            (let rec _lh_matchIdent_0 = ((rem_eq_0 (eqRewrite_lh _lh_multi_arg1_0)) (`LH_P2(_lh_multi_LH_P2_0_0, _lh_multi_LH_P2_1_0))) in
      ...
      and superpose_0 = (fun _lh_superpose_arg1_0 _lh_superpose_arg2_0 -> 
        (sift_lh (let rec _lh_listcomp_fun_2 = (fun _lh_listcomp_fun_para_2 -> 
          (match _lh_listcomp_fun_para_2 with
            | `LH_C(_lh_listcomp_fun_ls_h_2, _lh_listcomp_fun_ls_t_2) -> 
              (match _lh_listcomp_fun_ls_h_2 with
                | `LH_P2(_lh_superpose_LH_P2_0_0, _lh_superpose_LH_P2_1_0) -> 
                  (`LH_C(((lift_lh (pair_lh _lh_superpose_LH_P2_0_0)) ((unify_lh _lh_superpose_arg1_0) _lh_superpose_LH_P2_1_0)), (_lh_listcomp_fun_2 _lh_listcomp_fun_ls_t_2)))
                | _ -> 
                  (_lh_listcomp_fun_2 _lh_listcomp_fun_ls_t_2))
            | `LH_N -> 
              (`LH_N))) in
          (_lh_listcomp_fun_2 (subterms_lh _lh_superpose_arg2_0)))))
            ...
            (match _lh_rem_eq_LH_P2_0_0 with
              ...
              | `LH_C(_lh_rem_eq_LH_C_0_0, _lh_rem_eq_LH_C_1_0) -> 
                (let rec add_x_0 = (fun xsys_0 -> 
                  ...
                  ((getOrElse_lh ((lift_lh (fun _lh_funcomp_x_0 -> 
                    ((rem_eq_0 _lh_rem_eq_arg1_0) ((pair_lh _lh_rem_eq_LH_C_1_0) _lh_funcomp_x_0)))) (((delete_0 _lh_rem_eq_arg1_0) _lh_rem_eq_LH_C_0_0) _lh_rem_eq_LH_P2_1_0))) (add_x_0 ((rem_eq_0 _lh_rem_eq_arg1_0) (`LH_P2(_lh_rem_eq_LH_C_1_0, _lh_rem_eq_LH_P2_1_0)))))))))
            ...
            (match _lh_matchIdent_3 with
              ...
              | `LH_C(_lh_addby_LH_C_0_0, _lh_addby_LH_C_1_0) -> 
                (if ((_lh_addby_arg1_0 x_2) <= (_lh_addby_arg1_0 _lh_addby_LH_C_0_0)) then
                  ...
                  (`LH_C(_lh_addby_LH_C_0_0, ((insert_0 x_2) _lh_addby_LH_C_1_0))))))) in
      ...
      and seq2Lzq_0 = (fun _lh_seq2Lzq_arg1_0 _lh_seq2Lzq_arg2_0 _lh_seq2Lzq_arg3_0 -> 
        (let rec g_0 = (fun xs_3 -> 
          (let rec _lh_matchIdent_4 = xs_3 in
            (match _lh_matchIdent_4 with
              | `LH_P2(_lh_seq2Lzq_LH_P2_0_0, _lh_seq2Lzq_LH_P2_1_0) -> 
                ((lift_lh ((cross_lh (_lh_seq2Lzq_arg1_0 _lh_seq2Lzq_LH_P2_0_0)) (fun x_3 -> 
                  x_3))) ((Lazy.force _lh_seq2Lzq_arg3_0) _lh_seq2Lzq_LH_P2_1_0))))) in
          (fun _lh_funcomp_x_1 -> 
            ((fun _lh_funcomp_x_2 -> 
              (squash_lh ((lift_lh g_0) _lh_funcomp_x_2))) (_lh_seq2Lzq_arg2_0 _lh_funcomp_x_1)))))
                  ...
                  | `Func(_lh_rpo_Func_0_1, _lh_rpo_Func_1_1) -> 
                    (match _lh_rpo_LH_P2_1_0 with
                      ...
                      | `Func(_lh_rpo_Func_0_2, _lh_rpo_Func_1_2) -> 
                        (let rec _lh_matchIdent_6 = (_lh_rpo_arg1_0 (`LH_P2(_lh_rpo_Func_0_1, _lh_rpo_Func_0_2))) in
      ...
      and split_0 = (fun _lh_split_arg1_0 _lh_split_arg2_0 -> 
        (let rec tmp_0 = ((zip_lh ((map_lh _lh_split_arg1_0) _lh_split_arg2_0)) _lh_split_arg2_0) in
          (`LH_P2((let rec _lh_listcomp_fun_3 = (fun _lh_listcomp_fun_para_3 -> 
            (match _lh_listcomp_fun_para_3 with
              ...
              | `LH_N -> 
                (`LH_N))) in
            (_lh_listcomp_fun_3 tmp_0)), (let rec _lh_listcomp_fun_4 = (fun _lh_listcomp_fun_para_4 -> 
            (match _lh_listcomp_fun_para_4 with
              ...
              | `LH_N -> 
                (`LH_N))) in
            (_lh_listcomp_fun_4 tmp_0))))))
      and build_0 = (fun _lh_build_arg1_0 _lh_build_arg2_0 _lh_funcomp_x_3 -> 
        ((lift_lh ((cross_lh _lh_build_arg1_0) (fun x_4 -> 
        ...
        (match _lh_process1_arg6_0 with
          | `LH_P2(_lh_process1_LH_P2_0_0, _lh_process1_LH_P2_1_0) -> 
            (let rec o_0 = ((fst_lh _lh_process1_arg1_0) (`LH_P2(_lh_process1_LH_P2_0_0, _lh_process1_LH_P2_1_0))) in
              (let rec _lh_matchIdent_7 = o_0 in
                (match _lh_matchIdent_7 with
                  | `Unrelated -> 
                    (((((process_0 _lh_process1_arg1_0) _lh_process1_arg2_0) _lh_process1_arg3_0) _lh_process1_arg4_0) (((add_agenda_0 (fun dum_1 -> 
                  ...
                  | _ -> 
                    (let rec eqn_0 = (let rec _lh_matchIdent_8 = o_0 in
      ...
      and p_prim_0 = (fun _lh_p_prim_arg1_0 -> 
        (((orElseMap_lh p_name_0) ((seQ_0 (fun x_5 -> 
          ((atIndex_lh 1) x_5))) (`LH_C((look_for_0 '('), (`LH_C(p_expr_0, (`LH_C((look_for_0 ')'), (`LH_N))))))))) _lh_p_prim_arg1_0))
                  ...
                  | `Func(_lh_lex_ext_Func_0_1, _lh_lex_ext_Func_1_1) -> 
                    (let rec estimate_0 = ((lexico_0 _lh_lex_ext_arg1_0) (`LH_P2(_lh_lex_ext_Func_1_0, _lh_lex_ext_Func_1_1))) in
                      (let rec confirm_0 = (fun x_7 -> 
                        (let rec _lh_matchIdent_9 = x_7 in
      ...
      and list_of_0 = (fun _lh_list_of_arg1_0 _lh_list_of_arg2_0 -> 
        (let rec p'_0 = (lazy (((seq2_0 mk_cons_0) _lh_list_of_arg1_0) ((orElseMap_lh (((seq2Lzq_0 (fun x_9 y_0 -> 
                          ...
                          | `LH_C(_lh_listcomp_fun_ls_h_6, _lh_listcomp_fun_ls_t_6) -> 
                            (match _lh_listcomp_fun_ls_h_6 with
                              | `LH_P2(_lh_strict_super_LH_P2_0_1, _lh_strict_super_LH_P2_1_1) -> 
                                (`LH_C((`LH_P2((`LH_C(_lh_strict_super_LH_P2_0_0, _lh_strict_super_LH_P2_0_1)), _lh_strict_super_LH_P2_1_1)), (_lh_listcomp_fun_6 _lh_listcomp_fun_ls_t_6)))
                              | _ -> 
                                (_lh_listcomp_fun_6 _lh_listcomp_fun_ls_t_6))
                          | `LH_N -> 
                            (_lh_listcomp_fun_5 _lh_listcomp_fun_ls_t_5))) in
                        (_lh_listcomp_fun_6 ((superpose_0 _lh_strict_super_arg1_0) _lh_strict_super_LH_P2_1_0)))
                    | _ -> 
      ...
      and sp_0 = (fun _lh_sp_arg1_0 _lh_funcomp_x_4 -> 
        (_lh_sp_arg1_0 ((dropWhile_lh (fun x_1_0 -> 
      ...
      and process2_0 = (fun _lh_process2_arg1_0 _lh_process2_arg2_0 _lh_process2_arg3_0 _lh_process2_arg4_0 _lh_process2_arg5_0 _lh_process2_arg6_0 -> 
        (let rec _lh_matchIdent_1_0 = ((split_0 (reducible_0 (reduce1_lh _lh_process2_arg6_0))) _lh_process2_arg3_0) in
          (match _lh_matchIdent_1_0 with
            | `LH_P2(_lh_process2_LH_P2_0_0, _lh_process2_LH_P2_1_0) -> 
              (let rec net'_0 = ((add_eqn_0 ((delete_eqns_lh ((map_lh eqno_lh) _lh_process2_LH_P2_0_0)) _lh_process2_arg4_0)) _lh_process2_arg6_0) in
                (let rec deletions_0 = ((map_lh eqpr_lh) _lh_process2_LH_P2_0_0) in
                  (let rec critical_0 = ((all_crit_pairs_0 _lh_process2_arg6_0) _lh_process2_LH_P2_1_0) in
                    (let rec new_agenda_0 = (sift_lh ((map_lh (resolve_0 (super_reduce_0 net'_0))) ((mappend_lh deletions_0) critical_0))) in
                      (let rec todo'_0 = (((add_agenda_0 (snd_lh _lh_process2_arg1_0)) new_agenda_0) _lh_process2_arg5_0) in
                        (((((process_0 _lh_process2_arg1_0) _lh_process2_arg2_0) ((mappend_lh _lh_process2_LH_P2_1_0) (`LH_C(_lh_process2_arg6_0, (`LH_N))))) net'_0) todo'_0)))))))))
          ...
          (let rec _lh_matchIdent_1_1 = xs_4 in
            (match _lh_matchIdent_1_1 with
              | `LH_P2(_lh_seq2_LH_P2_0_0, _lh_seq2_LH_P2_1_0) -> 
                ((lift_lh ((cross_lh (_lh_seq2_arg1_0 _lh_seq2_LH_P2_0_0)) (fun x_1_1 -> 
                  x_1_1))) (_lh_seq2_arg3_0 _lh_seq2_LH_P2_1_0))))) in
          (fun _lh_funcomp_x_5 -> 
            ((fun _lh_funcomp_x_6 -> 
              (squash_lh ((lift_lh g_1) _lh_funcomp_x_6))) (_lh_seq2_arg2_0 _lh_funcomp_x_5)))))
      ...
      and parse_0 = (fun _lh_parse_arg1_0 -> 
        ((fun _lh_funcomp_x_7 -> 
          ((fun _lh_funcomp_x_8 -> 
            ((fun _lh_funcomp_x_9 -> 
              (unExpr_0 (fst_lh _lh_funcomp_x_9))) (the_lh _lh_funcomp_x_8))) (p_expr_0 _lh_funcomp_x_7))) _lh_parse_arg1_0))
      ...
      and preprocess_0 = (fun _lh_preprocess_arg1_0 _lh_preprocess_arg2_0 -> 
        (match _lh_preprocess_arg2_0 with
          | `LH_P2(_lh_preprocess_LH_P2_0_0, _lh_preprocess_LH_P2_1_0) -> 
            (`LH_P2(((simplify_lh (super_reduce_0 _lh_preprocess_arg1_0)) _lh_preprocess_LH_P2_0_0), ((simplify_lh (super_reduce_0 _lh_preprocess_arg1_0)) _lh_preprocess_LH_P2_1_0)))))
