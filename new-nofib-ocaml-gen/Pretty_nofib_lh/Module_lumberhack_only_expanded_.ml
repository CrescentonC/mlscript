...
let rec orL_lh__d3 _lh_orL_arg1_0 _lh_orL_arg2_0 =
  (match _lh_orL_arg1_0 with
    | true -> 
      true
    | false -> 
      _lh_orL_arg2_0);;
let rec cAppend_lh__d8 _lh_cAppend_arg1_0 _lh_cAppend_arg2_0 =
  (`CAppend(_lh_cAppend_arg1_0, _lh_cAppend_arg2_0));;
let rec cNL_lh__d2 =
  (`CNewline);;
let rec cAppend_lh__d7 _lh_cAppend_arg1_1 _lh_cAppend_arg2_1 =
  (`CAppend(_lh_cAppend_arg1_1, _lh_cAppend_arg2_1));;
let rec cNil_lh__d3 =
  (`CNil);;
let rec andL_lh__d5 _lh_andL_arg1_0 _lh_andL_arg2_0 =
        ...
        (let rec _lh_matchIdent_3 = ((_lh_ppAbove_arg2_0 _lh_ppAbove_arg3_0) true) in
          (match _lh_matchIdent_3 with
            | `MkPrettyRep(_lh_ppAbove_MkPrettyRep_0_1, _lh_ppAbove_MkPrettyRep_1_1, _lh_ppAbove_MkPrettyRep_2_1, _lh_ppAbove_MkPrettyRep_3_1) -> 
              (let rec nl_0 = (if ((orL_lh__d3 _lh_ppAbove_MkPrettyRep_2_0) _lh_ppAbove_MkPrettyRep_2_1) then
                cNil_lh__d3
              else
                cNL_lh__d2) in
                (`MkPrettyRep(((cAppend_lh__d7 _lh_ppAbove_MkPrettyRep_0_0) ((cAppend_lh__d8 nl_0) _lh_ppAbove_MkPrettyRep_0_1)), _lh_ppAbove_MkPrettyRep_1_1, ((andL_lh__d5 _lh_ppAbove_MkPrettyRep_2_0) _lh_ppAbove_MkPrettyRep_2_1), false)))))));;
let rec cNil_lh__d4 =
  (`CNil);;
...
let rec ppAboves_lh__d1 _lh_ppAboves_arg1_0 =
  (match _lh_ppAboves_arg1_0 with
    | `LH_N -> 
      ppNil_lh__d2
    | _ -> 
      ((foldr1_lh__d2 ppAbove_lh__d1) _lh_ppAboves_arg1_0));;
...
let rec pp'SP_lh__d1 _lh_pp'SP_arg1_0 =
  ((ppStr_lh__d5 (`LH_C(',', (`LH_C(' ', (`LH_N)))))) _lh_pp'SP_arg1_0);;
...
let rec ppStr_lh__d4 _lh_ppStr_arg1_1 _lh_ppStr_arg2_1 _lh_ppStr_arg3_1 =
  (let rec ls_5 = (length_lh__d4 _lh_ppStr_arg1_1) in
    (`MkPrettyRep((cStr_lh__d4 _lh_ppStr_arg1_1), ls_5, false, (_lh_ppStr_arg2_1 >= ls_5))));;
let rec ppInt_lh__d1 _lh_ppInt_arg1_0 =
  (ppStr_lh__d4 (string_of_int _lh_ppInt_arg1_0));;
let rec andL_lh__d2 _lh_andL_arg1_3 _lh_andL_arg2_3 =
  (match _lh_andL_arg1_3 with
    ...
    | true -> 
      _lh_andL_arg2_3);;
let rec cAppend_lh__d5 _lh_cAppend_arg1_3 _lh_cAppend_arg2_3 =
  (`CAppend(_lh_cAppend_arg1_3, _lh_cAppend_arg2_3));;
let rec andL_lh__d4 _lh_andL_arg1_1 _lh_andL_arg2_1 =
...
let rec cNil_lh__d1 =
  (`CNil);;
let rec cAppend_lh__d6 _lh_cAppend_arg1_2 _lh_cAppend_arg2_2 =
  (`CAppend(_lh_cAppend_arg1_2, _lh_cAppend_arg2_2));;
let rec cIndent_lh__d3 _lh_cIndent_arg1_0 _lh_cIndent_arg2_0 =
  (`CIndent(_lh_cIndent_arg1_0, _lh_cIndent_arg2_0));;
let rec andL_lh__d3 _lh_andL_arg1_2 _lh_andL_arg2_2 =
  (match _lh_andL_arg1_2 with
    | false -> 
      false
    | true -> 
      _lh_andL_arg2_2);;
let rec orL_lh__d2 _lh_orL_arg1_1 _lh_orL_arg2_1 =
              ...
              | `MkPrettyRep(_lh_ppBesideSP_MkPrettyRep_0_1, _lh_ppBesideSP_MkPrettyRep_1_1, _lh_ppBesideSP_MkPrettyRep_2_1, _lh_ppBesideSP_MkPrettyRep_3_1) -> 
                (let rec wi_0 = (if _lh_ppBesideSP_MkPrettyRep_2_0 then
                  ...
                  (let rec sp_0 = (if ((orL_lh__d2 _lh_ppBesideSP_MkPrettyRep_2_0) _lh_ppBesideSP_MkPrettyRep_2_1) then
                    ...
                    (cCh_lh__d3 ' ')) in
                    (`MkPrettyRep(((cAppend_lh__d6 _lh_ppBesideSP_MkPrettyRep_0_0) ((cAppend_lh__d5 sp_0) ((cIndent_lh__d3 li_0) _lh_ppBesideSP_MkPrettyRep_0_1))), (li_0 + _lh_ppBesideSP_MkPrettyRep_1_1), ((andL_lh__d3 _lh_ppBesideSP_MkPrettyRep_2_0) _lh_ppBesideSP_MkPrettyRep_2_1), ((andL_lh__d2 (_lh_ppBesideSP_arg3_0 >= wi_0)) ((andL_lh__d4 _lh_ppBesideSP_MkPrettyRep_3_0) _lh_ppBesideSP_MkPrettyRep_3_1)))))))))));;
...
let rec ppCat_lh__d1 _lh_ppCat_arg1_0 =
  (match _lh_ppCat_arg1_0 with
    | `LH_N -> 
      ppNil_lh__d1
    | _ -> 
      ((foldr1_lh__d1 ppBesideSP_lh__d1) _lh_ppCat_arg1_0));;
let rec cAppend_lh__d2 _lh_cAppend_arg1_6 _lh_cAppend_arg2_6 =
  (`CAppend(_lh_cAppend_arg1_6, _lh_cAppend_arg2_6));;
let rec cCh_lh__d2 _lh_cCh_arg1_1 =
  (`CCh(_lh_cCh_arg1_1));;
let rec cAppend_lh__d3 _lh_cAppend_arg1_5 _lh_cAppend_arg2_5 =
  (`CAppend(_lh_cAppend_arg1_5, _lh_cAppend_arg2_5));;
let rec cIndent_lh__d1 _lh_cIndent_arg1_2 _lh_cIndent_arg2_2 =
  (`CIndent(_lh_cIndent_arg1_2, _lh_cIndent_arg2_2));;
let rec cNL_lh__d1 =
  (`CNewline);;
let rec orL_lh__d1 _lh_orL_arg1_2 _lh_orL_arg2_2 =
  (match _lh_orL_arg1_2 with
    | true -> 
      true
    | false -> 
      _lh_orL_arg2_2);;
let rec cAppend_lh__d4 _lh_cAppend_arg1_4 _lh_cAppend_arg2_4 =
  (`CAppend(_lh_cAppend_arg1_4, _lh_cAppend_arg2_4));;
let rec andL_lh__d1 _lh_andL_arg1_4 _lh_andL_arg2_4 =
  (match _lh_andL_arg1_4 with
    | false -> 
      false
    | true -> 
      _lh_andL_arg2_4);;
let rec cIndent_lh__d2 _lh_cIndent_arg1_1 _lh_cIndent_arg2_1 =
  (`CIndent(_lh_cIndent_arg1_1, _lh_cIndent_arg2_1));;
let rec cAppend_lh__d1 _lh_cAppend_arg1_7 _lh_cAppend_arg2_7 =
                  ...
                  | `MkPrettyRep(_lh_ppHang_MkPrettyRep_0_2, _lh_ppHang_MkPrettyRep_1_2, _lh_ppHang_MkPrettyRep_2_2, _lh_ppHang_MkPrettyRep_3_2) -> 
                    (if _lh_ppHang_MkPrettyRep_2_0 then
                      ...
                      (if ((orL_lh__d1 (_lh_ppHang_MkPrettyRep_1_0 <= _lh_ppHang_arg2_0)) _lh_ppHang_MkPrettyRep_3_1) then
                        (`MkPrettyRep(((cAppend_lh__d4 ((cAppend_lh__d3 _lh_ppHang_MkPrettyRep_0_0) (cCh_lh__d2 ' '))) ((cIndent_lh__d2 (_lh_ppHang_MkPrettyRep_1_0 + 1)) _lh_ppHang_MkPrettyRep_0_1)), ((_lh_ppHang_MkPrettyRep_1_0 + 1) + _lh_ppHang_MkPrettyRep_1_1), false, ((andL_lh__d1 _lh_ppHang_MkPrettyRep_3_0) _lh_ppHang_MkPrettyRep_3_1)))
                      else
                        (`MkPrettyRep(((cAppend_lh__d1 _lh_ppHang_MkPrettyRep_0_0) ((cAppend_lh__d2 cNL_lh__d1) ((cIndent_lh__d1 _lh_ppHang_arg2_0) _lh_ppHang_MkPrettyRep_0_2))), _lh_ppHang_MkPrettyRep_1_2, false, false))))))))));;
let rec ppNil_lh__d3 _lh_ppNil_arg1_0 _lh_ppNil_arg2_0 =
  (`MkPrettyRep(cNil_lh__d4, 0, true, (_lh_ppNil_arg1_0 >= 0)));;
...
let rec ppBeside_lh__d1 _lh_ppBeside_arg1_0 _lh_ppBeside_arg2_0 _lh_ppBeside_arg3_0 _lh_ppBeside_arg4_0 =
  (let rec _lh_matchIdent_0 = ((_lh_ppBeside_arg1_0 _lh_ppBeside_arg3_0) false) in
    (match _lh_matchIdent_0 with
      | `MkPrettyRep(_lh_ppBeside_MkPrettyRep_0_0, _lh_ppBeside_MkPrettyRep_1_0, _lh_ppBeside_MkPrettyRep_2_0, _lh_ppBeside_MkPrettyRep_3_0) -> 
        (let rec _lh_matchIdent_1 = ((_lh_ppBeside_arg2_0 (_lh_ppBeside_arg3_0 - _lh_ppBeside_MkPrettyRep_1_0)) false) in
          (match _lh_matchIdent_1 with
            | `MkPrettyRep(_lh_ppBeside_MkPrettyRep_0_1, _lh_ppBeside_MkPrettyRep_1_1, _lh_ppBeside_MkPrettyRep_2_1, _lh_ppBeside_MkPrettyRep_3_1) -> 
              (`MkPrettyRep(((cAppend_lh__d8 _lh_ppBeside_MkPrettyRep_0_0) ((cIndent_lh__d3 _lh_ppBeside_MkPrettyRep_1_0) _lh_ppBeside_MkPrettyRep_0_1)), (_lh_ppBeside_MkPrettyRep_1_0 + _lh_ppBeside_MkPrettyRep_1_1), ((andL_lh__d5 _lh_ppBeside_MkPrettyRep_2_0) _lh_ppBeside_MkPrettyRep_2_1), ((andL_lh__d5 (_lh_ppBeside_arg3_0 >= 0)) ((andL_lh__d5 _lh_ppBeside_MkPrettyRep_3_0) _lh_ppBeside_MkPrettyRep_3_1))))))));;
let rec ppBesides_lh__d1 _lh_ppBesides_arg1_0 =
  (match _lh_ppBesides_arg1_0 with
    | `LH_N -> 
      ppNil_lh__d3
    | _ -> 
      ((foldr1_lh__d3 ppBeside_lh__d1) _lh_ppBesides_arg1_0));;
...
let rec testPretty_nofib_lh__d1 _lh_testPretty_nofib_arg1_0 =
  (let rec pretty_stuff_0 = (ppAboves_lh__d1 (`LH_C((ppBesides_lh__d1 (`LH_C((ppInt_lh__d1 (0 - 42)), (`LH_C((ppChar_lh__d1 '@'), (`LH_C((ppStr_lh__d2 (`LH_C('T', (`LH_C('h', (`LH_C('i', (`LH_C('s', (`LH_C(' ', (`LH_C('i', (`LH_C('s', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('s', (`LH_C('t', (`LH_C('r', (`LH_C('i', (`LH_C('n', (`LH_C('g', (`LH_N)))))))))))))))))))))))))))))))))), (`LH_N)))))))), (`LH_C(pp'SP_lh__d1, (`LH_C((((ppHang_lh__d1 (ppStr_lh__d1 (`LH_C('T', (`LH_C('h', (`LH_C('i', (`LH_C('s', (`LH_C(' ', (`LH_C('i', (`LH_C('s', (`LH_C(' ', (`LH_C('t', (`LH_C('h', (`LH_C('e', (`LH_C(' ', (`LH_C('l', (`LH_C('a', (`LH_C('b', (`LH_C('e', (`LH_C('l', (`LH_N))))))))))))))))))))))))))))))))))))) 8) (ppCat_lh__d1 ((copy_lh__d1 50) (ppStr_lh__d3 (`LH_C('x', (`LH_C('x', (`LH_C('x', (`LH_C('x', (`LH_C('x', (`LH_N))))))))))))))), (`LH_N)))))))) in
