...
let rec ppStr_lh__d3 _lh_ppStr_arg1_2 _lh_ppStr_arg2_2 _lh_ppStr_arg3_2 =
  (let rec ls_2 = (length_lh__d3 _lh_ppStr_arg1_2) in
    (`MkPrettyRep((cStr_lh__d3 _lh_ppStr_arg1_2), ls_2, false, (_lh_ppStr_arg2_2 >= ls_2))));;
...
let rec orL_lh__d3 _lh_orL_arg1_2 _lh_orL_arg2_2 =
  (match _lh_orL_arg1_2 with
    | true -> 
      true
    | false -> 
      _lh_orL_arg2_2);;
let rec cAppend_lh__d8 _lh_cAppend_arg1_3 _lh_cAppend_arg2_3 =
  (`CAppend(_lh_cAppend_arg1_3, _lh_cAppend_arg2_3));;
let rec cNL_lh__d2 =
  (`CNewline);;
let rec cAppend_lh__d7 _lh_cAppend_arg1_4 _lh_cAppend_arg2_4 =
  (`CAppend(_lh_cAppend_arg1_4, _lh_cAppend_arg2_4));;
let rec cNil_lh__d3 =
  (`CNil);;
let rec andL_lh__d5 _lh_andL_arg1_1 _lh_andL_arg2_1 =
...
let rec cNL_lh__d1 =
  (`CNewline);;
let rec orL_lh__d1 _lh_orL_arg1_0 _lh_orL_arg2_0 =
  (match _lh_orL_arg1_0 with
    | true -> 
      true
    | false -> 
      _lh_orL_arg2_0);;
let rec cAppend_lh__d4 _lh_cAppend_arg1_6 _lh_cAppend_arg2_6 =
...
let rec length_lh__d1 ls_5 =
  (match ls_5 with
    ...
    | `LH_N -> 
      0);;
let rec andL_lh__d1 _lh_andL_arg1_0 _lh_andL_arg2_0 =
...
let rec ppStr_lh__d1 _lh_ppStr_arg1_1 _lh_ppStr_arg2_1 _lh_ppStr_arg3_1 _lh_ppHang_arg2_0 _lh_ppHang_arg3_0 _lh_ppHang_arg4_0 _lh_ppHang_arg5_0 =
  (let rec ls_1 = (length_lh__d1 _lh_ppStr_arg1_1) in
    (let rec _lh_ppHang_MkPrettyRep_3_0 = (_lh_ppStr_arg2_1 >= ls_1) in
      (let rec _lh_ppHang_MkPrettyRep_2_0 = false in
        (let rec _lh_ppHang_MkPrettyRep_1_0 = ls_1 in
          (let rec _lh_ppHang_MkPrettyRep_0_0 = (cStr_lh__d1 _lh_ppStr_arg1_1) in
...
let rec andL_lh__d4 _lh_andL_arg1_4 _lh_andL_arg2_4 =
...
let rec cNil_lh__d1 =
  (`CNil);;
let rec cAppend_lh__d6 _lh_cAppend_arg1_5 _lh_cAppend_arg2_5 =
...
let rec ppNil_lh__d3 _lh_ppNil_arg1_2 _lh_ppNil_arg2_2 =
  (`MkPrettyRep(cNil_lh__d4, 0, true, (_lh_ppNil_arg1_2 >= 0)));;
