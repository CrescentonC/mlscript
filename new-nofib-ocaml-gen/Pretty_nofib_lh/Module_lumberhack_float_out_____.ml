...
let rec length_lh__d2 ls_8 =
  (match ls_8 with
    ...
    | `LH_N -> 
      0);;
let rec ppStr_lh__d2 _lh_ppStr_arg1_3 _lh_ppStr_arg2_3 _lh_ppStr_arg3_3 _lh_ppHang_arg2_1 _lh_ppHang_arg3_1 _lh_ppHang_arg4_1 _lh_ppHang_arg5_1 =
  (let rec ls_3 = (length_lh__d2 _lh_ppStr_arg1_3) in
    (let rec _lh_ppHang_MkPrettyRep_3_0 = (_lh_ppStr_arg2_3 >= ls_3) in
      (let rec _lh_ppHang_MkPrettyRep_2_0 = false in
        (let rec _lh_ppHang_MkPrettyRep_1_0 = ls_3 in
          (let rec _lh_ppHang_MkPrettyRep_0_0 = (cStr_lh__d2 _lh_ppStr_arg1_3) in
                    ...
                    (match _lh_matchIdent_4 with
                      | `MkPrettyRep(_lh_ppHang_MkPrettyRep_0_2, _lh_ppHang_MkPrettyRep_1_2, _lh_ppHang_MkPrettyRep_2_2, _lh_ppHang_MkPrettyRep_3_2) -> 
                        (if _lh_ppHang_MkPrettyRep_2_0 then
                          ...
                          (if ((orL_lh__d1 (_lh_ppHang_MkPrettyRep_1_0 <= _lh_ppHang_arg2_1)) _lh_ppHang_MkPrettyRep_3_1) then
                            ...
                            (`MkPrettyRep(((cAppend_lh__d3 _lh_ppHang_MkPrettyRep_0_0) ((cAppend_lh__d1 cNL_lh__d1) ((cIndent_lh__d2 _lh_ppHang_arg2_1) _lh_ppHang_MkPrettyRep_0_2))), _lh_ppHang_MkPrettyRep_1_2, false, false)))))))))))));;
...
let rec cStr_lh__d5 _lh_cStr_arg1_4 =
...
let rec ppStr_lh__d5 _lh_ppStr_arg1_0 _lh_ppStr_arg2_0 _lh_ppStr_arg3_0 =
  (let rec ls_0 = (length_lh__d4 _lh_ppStr_arg1_0) in
    (`MkPrettyRep((cStr_lh__d5 _lh_ppStr_arg1_0), ls_0, false, (_lh_ppStr_arg2_0 >= ls_0))));;
