...
let rec zipWith_lz_lz_lh__d1 f_2 xs_4 ys_1_6 =
  (lazy (((Lazy.force xs_4) f_2) ys_1_6));;
...
let rec mappend_lh__d3 xs_0 ys_0 =
  (xs_0 ys_0);;
let rec mappend_lh__d1 xs_1 ys_3 =
  (xs_1 ys_3);;
let rec concat_lh__d2 lss_0 =
  (lss_0 99);;
let rec mappend_lh__d4 xs_3 ys_1_5 =
  (xs_3 ys_1_5);;
let rec mappend_lh__d2 xs_2 ys_4 =
  (match xs_2 with
    | `LH_C(h_0, t_0) -> 
      (let rec t_1 = ((mappend_lh__d2 t_0) ys_4) in
        (let rec h_1 = h_0 in
          (fun ys_5 -> 
            (let rec t_2 = ((mappend_lh__d4 t_1) ys_5) in
              (let rec h_2 = h_1 in
                (fun ys_6 -> 
                  (let rec t_3 = ((mappend_lh__d1 t_2) ys_6) in
                    (let rec h_3 = h_2 in
                      (fun ys_7 -> 
                        (`LH_C(h_3, ((mappend_lh__d3 t_3) ys_7))))))))))))
    | `LH_N -> 
      ys_4);;
        ...
        (match _lh_listcomp_fun_para_0 with
          | `LH_C(_lh_listcomp_fun_ls_h_0, _lh_listcomp_fun_ls_t_0) -> 
            (let rec t_4 = (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_0) in
              (let rec h_4 = ((mappend_lh__d2 (string_of_float _lh_listcomp_fun_ls_h_0)) (let rec t_5 = (fun ys_8 -> 
                ys_8) in
                (let rec h_5 = 't' in
                  (fun ys_9 -> 
                    (let rec t_6 = ((mappend_lh__d4 t_5) ys_9) in
                      (let rec h_6 = h_5 in
                        (fun ys_1_0 -> 
                          (let rec t_7 = ((mappend_lh__d1 t_6) ys_1_0) in
                            (let rec h_7 = h_6 in
                              (fun ys_1_1 -> 
                                (`LH_C(h_7, ((mappend_lh__d3 t_7) ys_1_1))))))))))))) in
                (fun _lh_dummy_0 -> 
                  ((mappend_lh__d4 h_4) (concat_lh__d2 t_4)))))
          | `LH_N -> 
            (fun _lh_dummy_1 ys_1_2 -> 
              ys_1_2))) in
          ...
          (let rec _lh_listcomp_fun_ls_h_1 = h_8 in
            (fun _lh_listcomp_fun_1 -> 
              (let rec t_9 = (_lh_listcomp_fun_1 _lh_listcomp_fun_ls_t_1) in
                (let rec h_9 = ((mappend_lh__d1 (show_lh__d1 _lh_listcomp_fun_ls_h_1)) (let rec t_1_0 = (fun ys_1_3 -> 
                  ys_1_3) in
                  (let rec h_1_0 = 'n' in
                    (fun ys_1_4 -> 
                      (`LH_C(h_1_0, ((mappend_lh__d3 t_1_0) ys_1_4))))))) in
                  (fun _lh_dummy_2 -> 
