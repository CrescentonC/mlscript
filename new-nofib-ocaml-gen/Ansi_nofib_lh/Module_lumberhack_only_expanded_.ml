...
let rec cls_lh__d1 =
  (`LH_C('L', (`LH_N)));;
let rec mappend_lh__d8 xs_7 ys_7 =
  (match xs_7 with
    | `LH_C(h_9, t_9) -> 
      (`LH_C(h_9, ((mappend_lh__d8 t_9) ys_7)))
    | `LH_N -> 
      ys_7);;
let rec mappend_lh__d1_d5 xs_0 ys_0 =
  (match xs_0 with
    | `LH_C(h_2, t_2) -> 
      (`LH_C(h_2, ((mappend_lh__d1_d5 t_2) ys_0)))
    | `LH_N -> 
      ys_0);;
let rec goto_lh__d3 _lh_goto_arg1_5 _lh_goto_arg2_5 =
...
let rec at_lh__d2 _lh_at_arg1_4 _lh_at_arg2_4 =
  (match _lh_at_arg1_4 with
    | `LH_P2(_lh_at_LH_P2_0_4, _lh_at_LH_P2_1_4) -> 
      ((mappend_lh__d8 ((goto_lh__d3 _lh_at_LH_P2_0_4) _lh_at_LH_P2_1_4)) _lh_at_arg2_4));;
let rec mappend_lh__d7 xs_8 ys_8 =
  (match xs_8 with
    | `LH_C(h_1_0, t_1_0) -> 
      (`LH_C(h_1_0, ((mappend_lh__d7 t_1_0) ys_8)))
    | `LH_N -> 
      ys_8);;
let rec goto_lh__d2 _lh_goto_arg1_6 _lh_goto_arg2_6 =
...
let rec at_lh__d1 _lh_at_arg1_5 _lh_at_arg2_5 =
  (match _lh_at_arg1_5 with
    | `LH_P2(_lh_at_LH_P2_0_5, _lh_at_LH_P2_1_5) -> 
      ((mappend_lh__d7 ((goto_lh__d2 _lh_at_LH_P2_0_5) _lh_at_LH_P2_1_5)) _lh_at_arg2_5));;
let rec mappend_lh__d5 xs_1_0 ys_1_0 =
  (match xs_1_0 with
    | `LH_C(h_1_3, t_1_3) -> 
      (`LH_C(h_1_3, ((mappend_lh__d5 t_1_3) ys_1_0)))
    | `LH_N -> 
      ys_1_0);;
...
let rec mappend_lh__d2 xs_1_3 ys_1_3 =
  (match xs_1_3 with
    | `LH_C(h_1_7, t_1_7) -> 
      (`LH_C(h_1_7, ((mappend_lh__d2 t_1_7) ys_1_3)))
    | `LH_N -> 
      ys_1_3);;
let rec mappend_lh__d1_d2 xs_3 ys_3 =
  (match xs_3 with
    | `LH_C(h_5, t_5) -> 
      (`LH_C(h_5, ((mappend_lh__d1_d2 t_5) ys_3)))
    | `LH_N -> 
      ys_3);;
let rec goto_lh__d7 _lh_goto_arg1_1 _lh_goto_arg2_1 =
...
let rec at_lh__d6 _lh_at_arg1_0 _lh_at_arg2_0 =
  (match _lh_at_arg1_0 with
    | `LH_P2(_lh_at_LH_P2_0_0, _lh_at_LH_P2_1_0) -> 
      ((mappend_lh__d1_d2 ((goto_lh__d7 _lh_at_LH_P2_0_0) _lh_at_LH_P2_1_0)) _lh_at_arg2_0));;
...
let rec writeString_lh__d5 _lh_writeString_arg1_0 _lh_writeString_arg2_0 _lh_writeString_arg3_0 =
  ((mappend_lh__d1_d5 _lh_writeString_arg1_0) (_lh_writeString_arg2_0 _lh_writeString_arg3_0));;
let rec goto_lh__d8 _lh_goto_arg1_0 _lh_goto_arg2_0 =
...
let rec writeAt_lh__d2 _lh_writeAt_arg1_1 _lh_writeAt_arg2_1 =
  (match _lh_writeAt_arg1_1 with
    | `LH_P2(_lh_writeAt_LH_P2_0_1, _lh_writeAt_LH_P2_1_1) -> 
      (writeString_lh__d5 ((mappend_lh__d1_d5 ((goto_lh__d8 _lh_writeAt_LH_P2_0_1) _lh_writeAt_LH_P2_1_1)) _lh_writeAt_arg2_1)));;
let rec moveTo_lh__d2 _lh_moveTo_arg1_0 =
  (match _lh_moveTo_arg1_0 with
    | `LH_P2(_lh_moveTo_LH_P2_0_0, _lh_moveTo_LH_P2_1_0) -> 
      (writeString_lh__d5 ((goto_lh__d8 _lh_moveTo_LH_P2_0_0) _lh_moveTo_LH_P2_1_0)));;
let rec writeAt_lh__d3 _lh_writeAt_arg1_0 _lh_writeAt_arg2_0 =
  (match _lh_writeAt_arg1_0 with
    | `LH_P2(_lh_writeAt_LH_P2_0_0, _lh_writeAt_LH_P2_1_0) -> 
      (writeString_lh__d5 ((mappend_lh__d1_d5 ((goto_lh__d8 _lh_writeAt_LH_P2_0_0) _lh_writeAt_LH_P2_1_0)) _lh_writeAt_arg2_0)));;
...
let rec end_lh__d1 _lh_end_arg1_0 =
  (`LH_N);;
let rec mappend_lh__d6 xs_9 ys_9 =
  (match xs_9 with
    | `LH_C(h_1_1, t_1_1) -> 
      (`LH_C(h_1_1, ((mappend_lh__d6 t_1_1) ys_9)))
    | `LH_N -> 
      ys_9);;
let rec goto_lh__d1 _lh_goto_arg1_7 _lh_goto_arg2_7 =
...
let rec writeAt_lh__d1 _lh_writeAt_arg1_2 _lh_writeAt_arg2_2 =
  (match _lh_writeAt_arg1_2 with
    | `LH_P2(_lh_writeAt_LH_P2_0_2, _lh_writeAt_LH_P2_1_2) -> 
      (writeString_lh__d3 ((mappend_lh__d6 ((goto_lh__d1 _lh_writeAt_LH_P2_0_2) _lh_writeAt_LH_P2_1_2)) _lh_writeAt_arg2_2)));;
...
let rec mappend_lh__d1_d0 xs_5 ys_5 =
  (match xs_5 with
    | `LH_C(h_7, t_7) -> 
      (`LH_C(h_7, ((mappend_lh__d1_d0 t_7) ys_5)))
    | `LH_N -> 
      ys_5);;
let rec goto_lh__d5 _lh_goto_arg1_3 _lh_goto_arg2_3 =
...
let rec at_lh__d4 _lh_at_arg1_2 _lh_at_arg2_2 =
  (match _lh_at_arg1_2 with
    | `LH_P2(_lh_at_LH_P2_0_2, _lh_at_LH_P2_1_2) -> 
      ((mappend_lh__d1_d0 ((goto_lh__d5 _lh_at_LH_P2_0_2) _lh_at_LH_P2_1_2)) _lh_at_arg2_2));;
let rec mappend_lh__d1 xs_1_4 ys_1_4 =
  (match xs_1_4 with
    | `LH_C(h_1_8, t_1_8) -> 
      (`LH_C(h_1_8, ((mappend_lh__d1 t_1_8) ys_1_4)))
    | `LH_N -> 
      ys_1_4);;
let rec mappend_lh__d3 xs_1_2 ys_1_2 =
  (match xs_1_2 with
    | `LH_C(h_1_6, t_1_6) -> 
      (`LH_C(h_1_6, ((mappend_lh__d3 t_1_6) ys_1_2)))
    | `LH_N -> 
      ys_1_2);;
let rec mappend_lh__d4 xs_1_1 ys_1_1 =
  (match xs_1_1 with
    | `LH_C(h_1_5, t_1_5) -> 
      (`LH_C(h_1_5, ((mappend_lh__d4 t_1_5) ys_1_1)))
    | `LH_N -> 
      ys_1_1);;
let rec highlight_lh__d1 _lh_highlight_arg1_0 =
  ((mappend_lh__d3 (`LH_C('E', (`LH_C('S', (`LH_C('C', (`LH_C('[', (`LH_C('7', (`LH_C('m', (`LH_N)))))))))))))) ((mappend_lh__d4 _lh_highlight_arg1_0) (`LH_C('E', (`LH_C('S', (`LH_C('C', (`LH_C('[', (`LH_C('0', (`LH_C('m', (`LH_N)))))))))))))));;
let rec writeString_lh__d4 _lh_writeString_arg1_1 _lh_writeString_arg2_1 _lh_writeString_arg3_1 =
  ((mappend_lh__d1_d5 _lh_writeString_arg1_1) (_lh_writeString_arg2_1 _lh_writeString_arg3_1));;
let rec moveTo_lh__d1 _lh_moveTo_arg1_1 =
  (match _lh_moveTo_arg1_1 with
    | `LH_P2(_lh_moveTo_LH_P2_0_1, _lh_moveTo_LH_P2_1_1) -> 
      (writeString_lh__d4 ((goto_lh__d8 _lh_moveTo_LH_P2_0_1) _lh_moveTo_LH_P2_1_1)));;
let rec pressAnyKey_lh__d2 _lh_pressAnyKey_arg1_0 =
  ((readChar_lh__d2 _lh_pressAnyKey_arg1_0) (fun c_1 -> 
    _lh_pressAnyKey_arg1_0));;
let rec mappend_lh__d1_d3 xs_2 ys_2 =
  (match xs_2 with
    | `LH_C(h_4, t_4) -> 
      (`LH_C(h_4, ((mappend_lh__d1_d3 t_4) ys_2)))
    | `LH_N -> 
      ys_2);;
let rec concat_lh__d1 lss_0 =
  (match lss_0 with
    | `LH_C(h_1_4, t_1_4) -> 
      ((mappend_lh__d1_d3 h_1_4) (concat_lh__d1 t_1_4))
    | `LH_N -> 
      (`LH_N));;
let rec mappend_lh__d1_d4 xs_1 ys_1 =
  (match xs_1 with
    | `LH_C(h_3, t_3) -> 
      (`LH_C(h_3, ((mappend_lh__d1_d4 t_3) ys_1)))
    | `LH_N -> 
      ys_1);;
...
let rec goto_lh__d6 _lh_goto_arg1_2 _lh_goto_arg2_2 =
...
let rec mappend_lh__d1_d1 xs_4 ys_4 =
  (match xs_4 with
    | `LH_C(h_6, t_6) -> 
      (`LH_C(h_6, ((mappend_lh__d1_d1 t_6) ys_4)))
    | `LH_N -> 
      ys_4);;
let rec at_lh__d5 _lh_at_arg1_1 _lh_at_arg2_1 =
  (match _lh_at_arg1_1 with
    | `LH_P2(_lh_at_LH_P2_0_1, _lh_at_LH_P2_1_1) -> 
      ((mappend_lh__d1_d1 ((goto_lh__d6 _lh_at_LH_P2_0_1) _lh_at_LH_P2_1_1)) _lh_at_arg2_1));;
let rec mappend_lh__d9 xs_6 ys_6 =
  (match xs_6 with
    | `LH_C(h_8, t_8) -> 
      (`LH_C(h_8, ((mappend_lh__d9 t_8) ys_6)))
    | `LH_N -> 
      ys_6);;
let rec goto_lh__d4 _lh_goto_arg1_4 _lh_goto_arg2_4 =
...
let rec at_lh__d3 _lh_at_arg1_3 _lh_at_arg2_3 =
  (match _lh_at_arg1_3 with
    | `LH_P2(_lh_at_LH_P2_0_3, _lh_at_LH_P2_1_3) -> 
      ((mappend_lh__d9 ((goto_lh__d4 _lh_at_LH_P2_0_3) _lh_at_LH_P2_1_3)) _lh_at_arg2_3));;
let rec program_lh__d1 _lh_program_arg1_0 =
  (((writes_lh__d1 (`LH_C(cls_lh__d1, (`LH_C(((at_lh__d3 (`LH_P2(17, 5))) (highlight_lh__d1 (`LH_C('D', (`LH_C('e', (`LH_C('m', (`LH_C('o', (`LH_C('n', (`LH_C('s', (`LH_C('t', (`LH_C('r', (`LH_C('a', (`LH_C('t', (`LH_C('i', (`LH_C('o', (`LH_C('n', (`LH_C(' ', (`LH_C('p', (`LH_C('r', (`LH_C('o', (`LH_C('g', (`LH_C('r', (`LH_C('a', (`LH_C('m', (`LH_N))))))))))))))))))))))))))))))))))))))))))))), (`LH_C(((at_lh__d4 (`LH_P2(48, 5))) (`LH_C('V', (`LH_C('e', (`LH_C('r', (`LH_C('s', (`LH_C('i', (`LH_C('o', (`LH_C('n', (`LH_C(' ', (`LH_C('1', (`LH_C('.', (`LH_C('0', (`LH_N)))))))))))))))))))))))), (`LH_C(((at_lh__d1 (`LH_P2(17, 7))) (`LH_C('T', (`LH_C('h', (`LH_C('i', (`LH_C('s', (`LH_C(' ', (`LH_C('p', (`LH_C('r', (`LH_C('o', (`LH_C('g', (`LH_C('r', (`LH_C('a', (`LH_C('m', (`LH_C(' ', (`LH_C('i', (`LH_C('l', (`LH_C('l', (`LH_C('u', (`LH_C('s', (`LH_C('t', (`LH_C('r', (`LH_C('a', (`LH_C('t', (`LH_C('e', (`LH_C('s', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('s', (`LH_C('i', (`LH_C('m', (`LH_C('p', (`LH_C('l', (`LH_C('e', (`LH_C(' ', (`LH_C('a', (`LH_C('p', (`LH_C('p', (`LH_C('r', (`LH_C('o', (`LH_C('a', (`LH_C('c', (`LH_C('h', (`LH_N)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))), (`LH_C(((at_lh__d2 (`LH_P2(17, 8))) (`LH_C('t', (`LH_C('o', (`LH_C(' ', (`LH_C('s', (`LH_C('c', (`LH_C('r', (`LH_C('e', (`LH_C('e', (`LH_C('n', (`LH_C('-', (`LH_C('b', (`LH_C('a', (`LH_C('s', (`LH_C('e', (`LH_C('d', (`LH_C(' ', (`LH_C('i', (`LH_C('n', (`LH_C('t', (`LH_C('e', (`LH_C('r', (`LH_C('a', (`LH_C('c', (`LH_C('t', (`LH_C('i', (`LH_C('v', (`LH_C('e', (`LH_C(' ', (`LH_C('p', (`LH_C('r', (`LH_C('o', (`LH_C('g', (`LH_C('r', (`LH_C('a', (`LH_C('m', (`LH_C('s', (`LH_C(' ', (`LH_C('u', (`LH_C('s', (`LH_C('i', (`LH_C('n', (`LH_C('g', (`LH_N)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))), (`LH_C(((at_lh__d5 (`LH_P2(17, 9))) (`LH_C('t', (`LH_C('h', (`LH_C('e', (`LH_C(' ', (`LH_C('H', (`LH_C('u', (`LH_C('g', (`LH_C('s', (`LH_C(' ', (`LH_C('f', (`LH_C('u', (`LH_C('n', (`LH_C('c', (`LH_C('t', (`LH_C('i', (`LH_C('o', (`LH_C('n', (`LH_C('a', (`LH_C('l', (`LH_C(' ', (`LH_C('p', (`LH_C('r', (`LH_C('o', (`LH_C('g', (`LH_C('r', (`LH_C('a', (`LH_C('m', (`LH_C('m', (`LH_C('i', (`LH_C('n', (`LH_C('g', (`LH_C(' ', (`LH_C('s', (`LH_C('y', (`LH_C('s', (`LH_C('t', (`LH_C('e', (`LH_C('m', (`LH_C('.', (`LH_N)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))), (`LH_C(((at_lh__d6 (`LH_P2(17, 11))) (`LH_C('P', (`LH_C('l', (`LH_C('e', (`LH_C('a', (`LH_C('s', (`LH_C('e', (`LH_C(' ', (`LH_C('p', (`LH_C('r', (`LH_C('e', (`LH_C('s', (`LH_C('s', (`LH_C(' ', (`LH_C('a', (`LH_C('n', (`LH_C('y', (`LH_C(' ', (`LH_C('k', (`LH_C('e', (`LH_C('y', (`LH_C(' ', (`LH_C('t', (`LH_C('o', (`LH_C(' ', (`LH_C('c', (`LH_C('o', (`LH_C('n', (`LH_C('t', (`LH_C('i', (`LH_C('n', (`LH_C('u', (`LH_C('e', (`LH_C(' ', (`LH_C('.', (`LH_C('.', (`LH_C('.', (`LH_N)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))), (`LH_N)))))))))))))))) (pressAnyKey_lh__d1 ((((promptReadAt_lh__d1 (`LH_P2(17, 15))) 18) (`LH_C('P', (`LH_C('l', (`LH_C('e', (`LH_C('a', (`LH_C('s', (`LH_C('e', (`LH_C(' ', (`LH_C('e', (`LH_C('n', (`LH_C('t', (`LH_C('e', (`LH_C('r', (`LH_C(' ', (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C('r', (`LH_C(' ', (`LH_C('n', (`LH_C('a', (`LH_C('m', (`LH_C('e', (`LH_C(':', (`LH_C(' ', (`LH_N)))))))))))))))))))))))))))))))))))))))))))))))))) (fun name_0 -> 
    (let rec reply_0 = ((mappend_lh__d1 (`LH_C('H', (`LH_C('e', (`LH_C('l', (`LH_C('l', (`LH_C('o', (`LH_C(' ', (`LH_N)))))))))))))) ((mappend_lh__d2 name_0) (`LH_C('!', (`LH_N))))) in
...
let rec foldr_lh__d1 f_0 i_0 ls_5 =
  (match ls_5 with
    | `LH_C(h_2_0, t_2_0) -> 
      ((f_0 h_2_0) (((foldr_lh__d1 f_0) i_0) t_2_0))
    | `LH_N -> 
      i_0);;
