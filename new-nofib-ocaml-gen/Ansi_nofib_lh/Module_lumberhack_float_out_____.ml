...
let rec mappend_lh__d5 xs_7 ys_5_2 =
  (xs_7 ys_5_2);;
...
let rec mappend_lh__d1 xs_2 ys_4_6 =
  (xs_2 ys_4_6);;
...
let rec mappend_lh__d7 xs_5 ys_5_0 =
  (match xs_5 with
    ...
    | `LH_N -> 
      ys_5_0);;
let rec mappend_lh__d2 xs_6 ys_5_1 =
  (xs_6 ys_5_1);;
...
let rec mappend_lh__d6 xs_9 ys_5_4 =
  (match xs_9 with
    ...
    | `LH_N -> 
      ys_5_4);;
let rec mappend_lh__d1_d1 xs_1_0 ys_5_5 =
  (xs_1_0 ys_5_5);;
...
let rec mappend_lh__d1_d3 xs_1_2 ys_5_7 =
  (match xs_1_2 with
    ...
    | `LH_N -> 
      ys_5_7);;
let rec mappend_lh__d1_d2 xs_0 ys_4_4 =
  (xs_0 ys_4_4);;
let rec highlight_lh__d1 _lh_highlight_arg1_0 =
  ((mappend_lh__d1_d2 (let rec t_6_2 = (let rec t_6_3 = (let rec t_6_4 = (let rec t_6_5 = (let rec t_6_6 = (let rec t_6_7 = (fun ys_5_9 -> 
    ys_5_9) in
    (let rec h_6_2 = 'm' in
      (fun ys_6_0 -> 
        (`LH_C(h_6_2, ((mappend_lh__d1_d2 t_6_7) ys_6_0)))))) in
    (let rec h_6_3 = '7' in
      (fun ys_6_1 -> 
        (`LH_C(h_6_3, ((mappend_lh__d1_d2 t_6_6) ys_6_1)))))) in
    (let rec h_6_4 = '[' in
      (fun ys_6_2 -> 
        (`LH_C(h_6_4, ((mappend_lh__d1_d2 t_6_5) ys_6_2)))))) in
    (let rec h_6_5 = 'C' in
      (fun ys_6_3 -> 
        (`LH_C(h_6_5, ((mappend_lh__d1_d2 t_6_4) ys_6_3)))))) in
    (let rec h_6_6 = 'S' in
      (fun ys_6_4 -> 
        (`LH_C(h_6_6, ((mappend_lh__d1_d2 t_6_3) ys_6_4)))))) in
    (let rec h_6_7 = 'E' in
      (fun ys_6_5 -> 
        (`LH_C(h_6_7, ((mappend_lh__d1_d2 t_6_2) ys_6_5))))))) ((mappend_lh__d1_d1 _lh_highlight_arg1_0) (`LH_C('E', (`LH_C('S', (`LH_C('C', (`LH_C('[', (`LH_C('0', (`LH_C('m', (`LH_N)))))))))))))));;
    ...
    | `LH_C(h_5_1, t_5_1) -> 
      ((reverse_helper_lh__d1 t_5_1) (let rec t_5_2 = a_0 in
        (let rec h_5_2 = h_5_1 in
          (fun ys_4_8 -> 
            (`LH_C(h_5_2, ((mappend_lh__d1 t_5_2) ys_4_8)))))))
    | `LH_N -> 
      a_0);;
...
let rec program_lh__d1 _lh_program_arg1_0 =
  (((writes_lh__d1 (let rec t_1 = (let rec t_2 = (let rec t_3 = (let rec t_4 = (let rec t_5 = (let rec t_6 = (let rec t_7 = (fun _lh_dummy_0 -> 
    (`LH_N)) in
    (let rec h_1 = ((at_lh__d3 (let rec _lh_at_LH_P2_1_0 = 11 in
      ...
      (fun _lh_dummy_1 -> 
        ((mappend_lh__d1_d4 h_1) (concat_lh__d1 t_7))))) in
    (let rec h_2 = ((at_lh__d1 (let rec _lh_at_LH_P2_1_1 = 9 in
      ...
      (fun _lh_dummy_2 -> 
        ((mappend_lh__d1_d4 h_2) (concat_lh__d1 t_6))))) in
    (let rec h_3 = ((at_lh__d2 (let rec _lh_at_LH_P2_1_2 = 8 in
      ...
      (fun _lh_dummy_3 -> 
        ((mappend_lh__d1_d4 h_3) (concat_lh__d1 t_5))))) in
    (let rec h_4 = ((at_lh__d4 (let rec _lh_at_LH_P2_1_3 = 7 in
      ...
      (fun _lh_dummy_4 -> 
        ((mappend_lh__d1_d4 h_4) (concat_lh__d1 t_4))))) in
    (let rec h_5 = ((at_lh__d6 (let rec _lh_at_LH_P2_1_4 = 5 in
      ...
      (fun _lh_dummy_5 -> 
        ((mappend_lh__d1_d4 h_5) (concat_lh__d1 t_3))))) in
    (let rec h_6 = ((at_lh__d5 (let rec _lh_at_LH_P2_1_5 = 5 in
      ...
      (let rec h_7 = 'm' in
        (fun ys_1 -> 
          (`LH_C(h_7, ((mappend_lh__d1_d1 t_2_8) ys_1)))))) in
      (let rec h_8 = 'a' in
        (fun ys_2 -> 
          (`LH_C(h_8, ((mappend_lh__d1_d1 t_2_7) ys_2)))))) in
      (let rec h_9 = 'r' in
        (fun ys_3 -> 
          (`LH_C(h_9, ((mappend_lh__d1_d1 t_2_6) ys_3)))))) in
      (let rec h_1_0 = 'g' in
        (fun ys_4 -> 
          (`LH_C(h_1_0, ((mappend_lh__d1_d1 t_2_5) ys_4)))))) in
      (let rec h_1_1 = 'o' in
        (fun ys_5 -> 
          (`LH_C(h_1_1, ((mappend_lh__d1_d1 t_2_4) ys_5)))))) in
      (let rec h_1_2 = 'r' in
        (fun ys_6 -> 
          (`LH_C(h_1_2, ((mappend_lh__d1_d1 t_2_3) ys_6)))))) in
      (let rec h_1_3 = 'p' in
        (fun ys_7 -> 
          (`LH_C(h_1_3, ((mappend_lh__d1_d1 t_2_2) ys_7)))))) in
      (let rec h_1_4 = ' ' in
        (fun ys_8 -> 
          (`LH_C(h_1_4, ((mappend_lh__d1_d1 t_2_1) ys_8)))))) in
      (let rec h_1_5 = 'n' in
        (fun ys_9 -> 
          (`LH_C(h_1_5, ((mappend_lh__d1_d1 t_2_0) ys_9)))))) in
      (let rec h_1_6 = 'o' in
        (fun ys_1_0 -> 
          (`LH_C(h_1_6, ((mappend_lh__d1_d1 t_1_9) ys_1_0)))))) in
      (let rec h_1_7 = 'i' in
        (fun ys_1_1 -> 
          (`LH_C(h_1_7, ((mappend_lh__d1_d1 t_1_8) ys_1_1)))))) in
      (let rec h_1_8 = 't' in
        (fun ys_1_2 -> 
          (`LH_C(h_1_8, ((mappend_lh__d1_d1 t_1_7) ys_1_2)))))) in
      (let rec h_1_9 = 'a' in
        (fun ys_1_3 -> 
          (`LH_C(h_1_9, ((mappend_lh__d1_d1 t_1_6) ys_1_3)))))) in
      (let rec h_2_0 = 'r' in
        (fun ys_1_4 -> 
          (`LH_C(h_2_0, ((mappend_lh__d1_d1 t_1_5) ys_1_4)))))) in
      (let rec h_2_1 = 't' in
        (fun ys_1_5 -> 
          (`LH_C(h_2_1, ((mappend_lh__d1_d1 t_1_4) ys_1_5)))))) in
      (let rec h_2_2 = 's' in
        (fun ys_1_6 -> 
          (`LH_C(h_2_2, ((mappend_lh__d1_d1 t_1_3) ys_1_6)))))) in
      (let rec h_2_3 = 'n' in
        (fun ys_1_7 -> 
          (`LH_C(h_2_3, ((mappend_lh__d1_d1 t_1_2) ys_1_7)))))) in
      (let rec h_2_4 = 'o' in
        (fun ys_1_8 -> 
          (`LH_C(h_2_4, ((mappend_lh__d1_d1 t_1_1) ys_1_8)))))) in
      (let rec h_2_5 = 'm' in
        (fun ys_1_9 -> 
          (`LH_C(h_2_5, ((mappend_lh__d1_d1 t_1_0) ys_1_9)))))) in
      (let rec h_2_6 = 'e' in
        (fun ys_2_0 -> 
          (`LH_C(h_2_6, ((mappend_lh__d1_d1 t_9) ys_2_0)))))) in
      (let rec h_2_7 = 'D' in
        (fun ys_2_1 -> 
          (`LH_C(h_2_7, ((mappend_lh__d1_d1 t_8) ys_2_1)))))))) in
      (fun _lh_dummy_6 -> 
        ((mappend_lh__d1_d4 h_6) (concat_lh__d1 t_2))))) in
    (let rec h_2_8 = cls_lh__d1 in
      (fun _lh_dummy_7 -> 
        ((mappend_lh__d1_d4 h_2_8) (concat_lh__d1 t_1)))))) (pressAnyKey_lh__d1 ((((promptReadAt_lh__d1 (let rec _lh_promptReadAt_LH_P2_1_0 = 15 in
        ...
        (((writeAt_lh__d2 (let rec _lh_writeAt_LH_P2_1_0 = _lh_promptReadAt_LH_P2_1_0 in
          (let rec _lh_writeAt_LH_P2_0_0 = _lh_promptReadAt_LH_P2_0_0 in
            (fun _lh_writeAt_arg2_0 -> 
              (writeString_lh__d5 ((mappend_lh__d1_d3 ((goto_lh__d9 _lh_writeAt_LH_P2_0_0) _lh_writeAt_LH_P2_1_0)) _lh_writeAt_arg2_0)))))) _lh_promptReadAt_arg3_0) (((readAt_lh__d1 (let rec _lh_readAt_LH_P2_1_0 = _lh_promptReadAt_LH_P2_1_0 in
              ...
              (((writeAt_lh__d3 (let rec _lh_writeAt_LH_P2_1_1 = _lh_readAt_LH_P2_1_0 in
                (let rec _lh_writeAt_LH_P2_0_1 = _lh_readAt_LH_P2_0_0 in
                  (fun _lh_writeAt_arg2_1 -> 
                    (writeString_lh__d5 ((mappend_lh__d1_d4 ((goto_lh__d9 _lh_writeAt_LH_P2_0_1) _lh_writeAt_LH_P2_1_1)) _lh_writeAt_arg2_1)))))) ((copy_lh__d2 _lh_readAt_arg2_0) '_')) ((moveTo_lh__d2 (let rec _lh_moveTo_LH_P2_1_0 = _lh_readAt_LH_P2_1_0 in
                (let rec _lh_moveTo_LH_P2_0_0 = _lh_readAt_LH_P2_0_0 in
                  (fun _lh_dummy_8 -> 
                    (writeString_lh__d5 ((goto_lh__d9 _lh_moveTo_LH_P2_0_0) _lh_moveTo_LH_P2_1_0)))))) ((((loop_lh__d1 0) (`LH_N)) _lh_readAt_arg2_0) _lh_readAt_arg3_0))))))) _lh_promptReadAt_arg2_0) _lh_promptReadAt_arg4_0)))))) 18) (`LH_C('P', (`LH_C('l', (`LH_C('e', (`LH_C('a', (`LH_C('s', (`LH_C('e', (`LH_C(' ', (`LH_C('e', (`LH_C('n', (`LH_C('t', (`LH_C('e', (`LH_C('r', (`LH_C(' ', (`LH_C('y', (`LH_C('o', (`LH_C('u', (`LH_C('r', (`LH_C(' ', (`LH_C('n', (`LH_C('a', (`LH_C('m', (`LH_C('e', (`LH_C(':', (`LH_C(' ', (`LH_N)))))))))))))))))))))))))))))))))))))))))))))))))) (fun name_0 -> 
    (let rec reply_0 = ((mappend_lh__d2 (let rec t_2_9 = (let rec t_3_0 = (let rec t_3_1 = (let rec t_3_2 = (let rec t_3_3 = (let rec t_3_4 = (fun ys_2_2 -> 
      ys_2_2) in
      (let rec h_2_9 = ' ' in
        (fun ys_2_3 -> 
          (`LH_C(h_2_9, ((mappend_lh__d2 t_3_4) ys_2_3)))))) in
      (let rec h_3_0 = 'o' in
        (fun ys_2_4 -> 
          (`LH_C(h_3_0, ((mappend_lh__d2 t_3_3) ys_2_4)))))) in
      (let rec h_3_1 = 'l' in
        (fun ys_2_5 -> 
          (`LH_C(h_3_1, ((mappend_lh__d2 t_3_2) ys_2_5)))))) in
      (let rec h_3_2 = 'l' in
        (fun ys_2_6 -> 
          (`LH_C(h_3_2, ((mappend_lh__d2 t_3_1) ys_2_6)))))) in
      (let rec h_3_3 = 'e' in
        (fun ys_2_7 -> 
          (`LH_C(h_3_3, ((mappend_lh__d2 t_3_0) ys_2_7)))))) in
      (let rec h_3_4 = 'H' in
        (fun ys_2_8 -> 
          (`LH_C(h_3_4, ((mappend_lh__d2 t_2_9) ys_2_8))))))) ((mappend_lh__d1 name_0) (`LH_C('!', (`LH_N))))) in
      (((writeAt_lh__d1 (let rec _lh_writeAt_LH_P2_1_2 = 18 in
        (let rec _lh_writeAt_LH_P2_0_2 = (40 - ((length_lh__d1 reply_0) / 2)) in
          (fun _lh_writeAt_arg2_2 -> 
            (writeString_lh__d4 ((mappend_lh__d6 ((goto_lh__d4 _lh_writeAt_LH_P2_0_2) _lh_writeAt_LH_P2_1_2)) _lh_writeAt_arg2_2)))))) reply_0) ((moveTo_lh__d1 (let rec _lh_moveTo_LH_P2_1_1 = 23 in
        (let rec _lh_moveTo_LH_P2_0_1 = 1 in
          (fun _lh_dummy_9 -> 
            (writeString_lh__d2 ((goto_lh__d3 _lh_moveTo_LH_P2_0_1) _lh_moveTo_LH_P2_1_1)))))) ((writeString_lh__d1 (let rec t_3_5 = (let rec t_3_6 = (let rec t_3_7 = (let rec t_3_8 = (let rec t_3_9 = (let rec t_4_0 = (let rec t_4_1 = (let rec t_4_2 = (let rec t_4_3 = (let rec t_4_4 = (let rec t_4_5 = (let rec t_4_6 = (let rec t_4_7 = (let rec t_4_8 = (fun ys_2_9 -> 
        ys_2_9) in
        (let rec h_3_5 = '`' in
          (fun ys_3_0 -> 
            (`LH_C(h_3_5, ((mappend_lh__d5 t_4_8) ys_3_0)))))) in
        (let rec h_3_6 = '.' in
          (fun ys_3_1 -> 
            (`LH_C(h_3_6, ((mappend_lh__d5 t_4_7) ys_3_1)))))) in
        (let rec h_3_7 = '.' in
          (fun ys_3_2 -> 
            (`LH_C(h_3_7, ((mappend_lh__d5 t_4_6) ys_3_2)))))) in
        (let rec h_3_8 = '.' in
          (fun ys_3_3 -> 
            (`LH_C(h_3_8, ((mappend_lh__d5 t_4_5) ys_3_3)))))) in
        (let rec h_3_9 = 'g' in
          (fun ys_3_4 -> 
            (`LH_C(h_3_9, ((mappend_lh__d5 t_4_4) ys_3_4)))))) in
        (let rec h_4_0 = 'n' in
          (fun ys_3_5 -> 
            (`LH_C(h_4_0, ((mappend_lh__d5 t_4_3) ys_3_5)))))) in
        (let rec h_4_1 = 'i' in
          (fun ys_3_6 -> 
            (`LH_C(h_4_1, ((mappend_lh__d5 t_4_2) ys_3_6)))))) in
        (let rec h_4_2 = 't' in
          (fun ys_3_7 -> 
            (`LH_C(h_4_2, ((mappend_lh__d5 t_4_1) ys_3_7)))))) in
        (let rec h_4_3 = 'i' in
          (fun ys_3_8 -> 
            (`LH_C(h_4_3, ((mappend_lh__d5 t_4_0) ys_3_8)))))) in
        (let rec h_4_4 = 'a' in
          (fun ys_3_9 -> 
            (`LH_C(h_4_4, ((mappend_lh__d5 t_3_9) ys_3_9)))))) in
        (let rec h_4_5 = 'w' in
          (fun ys_4_0 -> 
            (`LH_C(h_4_5, ((mappend_lh__d5 t_3_8) ys_4_0)))))) in
        (let rec h_4_6 = ' ' in
          (fun ys_4_1 -> 
            (`LH_C(h_4_6, ((mappend_lh__d5 t_3_7) ys_4_1)))))) in
        (let rec h_4_7 = 'm' in
          (fun ys_4_2 -> 
            (`LH_C(h_4_7, ((mappend_lh__d5 t_3_6) ys_4_2)))))) in
        (let rec h_4_8 = 'I' in
          (fun ys_4_3 -> 
