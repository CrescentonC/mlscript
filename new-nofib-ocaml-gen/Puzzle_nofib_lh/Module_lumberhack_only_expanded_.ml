...
let rec mappend_lh__d1 xs_7 ys_7 =
  (match xs_7 with
    | `LH_C(h_9, t_9) -> 
      (`LH_C(h_9, ((mappend_lh__d1 t_9) ys_7)))
    | `LH_N -> 
      ys_7);;
...
let rec mappend_lh__d5 xs_3 ys_3 =
  (match xs_3 with
    | `LH_C(h_4, t_4) -> 
      (`LH_C(h_4, ((mappend_lh__d5 t_4) ys_3)))
    | `LH_N -> 
      ys_3);;
let rec concat_lh__d2 lss_0 =
  (match lss_0 with
    | `LH_C(h_1_0, t_1_0) -> 
      ((mappend_lh__d5 h_1_0) (concat_lh__d2 t_1_0))
    | `LH_N -> 
      (`LH_N));;
...
let rec mappend_lh__d4 xs_4 ys_4 =
  (match xs_4 with
    | `LH_C(h_5, t_5) -> 
      (`LH_C(h_5, ((mappend_lh__d4 t_5) ys_4)))
    | `LH_N -> 
      ys_4);;
let rec concat_lh__d1 lss_1 =
  (match lss_1 with
    | `LH_C(h_1_1, t_1_1) -> 
      ((mappend_lh__d4 h_1_1) (concat_lh__d1 t_1_1))
    | `LH_N -> 
      (`LH_N));;
          ...
          (match _lh_listcomp_fun_para_0 with
            | `LH_C(_lh_listcomp_fun_ls_h_0, _lh_listcomp_fun_ls_t_0) -> 
              (if (((position_lh__d3 _lh_listcomp_fun_ls_h_0) _lh_transfer_arg2_0) = _lh_transfer_arg3_0) then
                (let rec newDest_0 = (((updateState_lh__d3 _lh_transfer_arg2_0) _lh_listcomp_fun_ls_h_0) newLocation_0) in
            ...
            (match _lh_listcomp_fun_para_1 with
              | `LH_C(_lh_listcomp_fun_ls_h_1, _lh_listcomp_fun_ls_t_1) -> 
                (let rec _lh_listcomp_fun_2 = (fun _lh_listcomp_fun_para_2 -> 
                  (match _lh_listcomp_fun_para_2 with
                    | `LH_C(_lh_listcomp_fun_ls_h_2, _lh_listcomp_fun_ls_t_2) -> 
                      (if ((((position_lh__d2 _lh_listcomp_fun_ls_h_1) _lh_transfer_arg2_0) = _lh_transfer_arg3_0) && (((position_lh__d1 _lh_listcomp_fun_ls_h_2) _lh_transfer_arg2_0) = _lh_transfer_arg3_0)) then
                        (let rec newDest_1 = (((updateState_lh__d2 (((updateState_lh__d1 _lh_transfer_arg2_0) _lh_listcomp_fun_ls_h_1) newLocation_0)) _lh_listcomp_fun_ls_h_2) newLocation_0) in
                  ...
                  (_lh_listcomp_fun_2 ((itemFromTo_lh__d3 (succItem_lh__d1 _lh_listcomp_fun_ls_h_1)) (`Adam))))
              | `LH_N -> 
                (`LH_N))) in
...
let rec reverse_helper_lh__d1 ls_1 a_0 =
  (match ls_1 with
    | `LH_C(h_6, t_6) -> 
      ((reverse_helper_lh__d1 t_6) (`LH_C(h_6, a_0)))
    | `LH_N -> 
      a_0);;
  ...
  (match _lh_minSolutions_arg1_0 with
    ...
    | `LH_C(_lh_minSolutions_LH_C_0_0, _lh_minSolutions_LH_C_1_0) -> 
      (let rec minAcc_0 = (fun minSoFar_0 mins_0 ls_4 -> 
        ...
        (reverse_lh__d1 (((minAcc_0 (totalTime_lh__d2 _lh_minSolutions_LH_C_0_0)) (`LH_C(_lh_minSolutions_LH_C_0_0, (`LH_N)))) _lh_minSolutions_LH_C_1_0))));;
