...
let rec cal_lh _lh_cal_arg1_0 =
  ...
  and pad_0 = (fun _lh_pad_arg1_0 -> 
    ((mappend_lh (((zipWith_lh mappend_lh) (((zipWith_lh mappend_lh) side_0) _lh_pad_arg1_0)) side_0)) end_0))
  ...
  and side_0 = (emptyPic_lh (`LH_P2(8, 2)))
  ...
  and end_0 = (emptyPic_lh (`LH_P2(1, 25)))
  and title_0 = (fun _lh_title_arg1_0 -> 
    (`LH_C(((cjustify_lh 21) _lh_title_arg1_0), (`LH_N))))
  in (unlines_lh ((mappend_lh (banner_0 _lh_cal_arg1_0)) (body_0 _lh_cal_arg1_0)));;
let rec testCalendar_nofib_lh _lh_testCalendar_nofib_arg1_0 =
  ((map_lh (fun n_1 -> 
    (length_lh (cal_lh n_1)))) ((enumFromTo_lh 1993) (1993 + _lh_testCalendar_nofib_arg1_0)));;
let run () = 1 + (Obj.magic ((testCalendar_nofib_lh 100)));
end;;
