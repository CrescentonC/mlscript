...
let rec mappend_lh__d3 xs_1 ys_5 =
  (match xs_1 with
    | `LH_C(h_3, t_3) -> 
      (`LH_C(h_3, ((mappend_lh__d3 t_3) ys_5)))
    | `LH_N -> 
      ys_5);;
let rec mappend_lh__d1 xs_2 ys_6 =
  (match xs_2 with
    | `LH_C(h_4, t_4) -> 
      (`LH_C(h_4, ((mappend_lh__d1 t_4) ys_6)))
    | `LH_N -> 
      ys_6);;
let rec mappend_lh__d8 xs_3 ys_7 =
  (match xs_3 with
    | `LH_C(h_6, t_6) -> 
      (`LH_C(h_6, ((mappend_lh__d8 t_6) ys_7)))
    | `LH_N -> 
      ys_7);;
...
let rec maxw_lh__d1 =
  70;;
let rec null_lh__d3 _lh_null_arg1_4 =
...
let rec thd3_lh__d1 _lh_thd3_arg1_1 =
  (match _lh_thd3_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec null_lh__d6 _lh_null_arg1_1 =
...
let rec take_lh__d1 n_0 ls_8 =
  (if (n_0 > 0) then
    (match ls_8 with
      | `LH_C(h_2_5, t_2_5) -> 
        (`LH_C(h_2_5, ((take_lh__d1 (n_0 - 1)) t_2_5)))
      | `LH_N -> 
        (`LH_N))
  else
    (`LH_N));;
...
let rec tail_lh__d1 ls_7 =
  (match ls_7 with
    ...
    | `LH_N -> 
      (failwith "error"));;
let rec single_lh__d2 _lh_single_arg1_1 =
...
let rec null'_lh__d2 _lh_null'_arg1_0 =
  (match _lh_null'_arg1_0 with
    ...
    | _ -> 
      false);;
let rec null_lh__d5 _lh_null_arg1_5 =
...
let rec single'_lh__d1 _lh_single'_arg1_0 =
  (match _lh_single'_arg1_0 with
    | `LH_P2(_lh_single'_LH_P2_0_0, _lh_single'_LH_P2_1_0) -> 
      (((null_lh__d5 _lh_single'_LH_P2_0_0) && (single_lh__d2 _lh_single'_LH_P2_1_0)) || ((single_lh__d1 _lh_single'_LH_P2_0_0) && (null_lh__d4 _lh_single'_LH_P2_1_0)))
    | _ -> 
      (failwith "error"));;
...
let rec single'_lh__d2 _lh_single'_arg1_1 =
  (match _lh_single'_arg1_1 with
    | `LH_P2(_lh_single'_LH_P2_0_1, _lh_single'_LH_P2_1_1) -> 
      (((null_lh__d6 _lh_single'_LH_P2_0_1) && (single_lh__d2 _lh_single'_LH_P2_1_1)) || ((single_lh__d2 _lh_single'_LH_P2_0_1) && (null_lh__d6 _lh_single'_LH_P2_1_1)))
    | _ -> 
      (failwith "error"));;
            ...
            (let rec width_hd_0 = (fun p_1 -> 
              ...
              (let rec cost_0 = (fun p_2 -> 
                (if (single_0 p_2) then
                  ...
                  ((cost_tl_lh__d1 p_2) + (let rec a_1 = (optw_lh__d3 - (width_hd_0 p_2)) in
                    (a_1 * a_1))))) in
                (let rec old_width_hd_0 = (fun p_3 -> 
                  ...
                  (let rec new_0 = (fun p_4 -> 
                    (if (single_0 p_4) then
                      ...
                      (`LH_P3(_lh_stepr_LH_P3_1_0, ((cost_tl_lh__d3 p_4) + (let rec x_3 = (optw_lh__d1 - (old_width_hd_0 p_4)) in
  ...
  (match _lh_last'_arg1_2 with
    | `LH_P2(_lh_last'_LH_P2_0_2, _lh_last'_LH_P2_1_2) -> 
      (if (not (null_lh__d2 _lh_last'_LH_P2_1_2)) then
        (head_lh__d2 _lh_last'_LH_P2_1_2)
      else
        (head_lh__d3 _lh_last'_LH_P2_0_2))
    | _ -> 
      (failwith "error"));;
...
let rec map_lh__d5 f_8 ls_1_1 =
  (match ls_1_1 with
    | `LH_C(h_3_0, t_3_0) -> 
      (`LH_C((f_8 h_3_0), ((map_lh__d5 f_8) t_3_0)))
    | `LH_N -> 
      (`LH_N));;
...
let rec filter_lh__d1 f_1_0 ls_1_4 =
  (match ls_1_4 with
    | `LH_C(h_3_2, t_3_2) -> 
      (if (f_1_0 h_3_2) then
        (let rec t_3_3 = ((filter_lh__d1 f_1_0) t_3_2) in
          (let rec h_3_3 = h_3_2 in
            (fun f_1_1 -> 
              (`LH_C((f_1_1 h_3_3), ((map_lh__d1 f_1_1) t_3_3))))))
      else
        ((filter_lh__d1 f_1_0) t_3_2))
    | `LH_N -> 
      (fun f_1_2 -> 
        (`LH_N)));;
...
let rec break_lh__d2 _lh_break_arg1_0 _lh_break_arg2_0 =
  (match _lh_break_arg2_0 with
    | `LH_N -> 
      (`LH_P2((`LH_N), (fun _lh_dummy_0 f_1 -> 
        (`LH_N))))
      ...
      | `LH_P2(_lh_lines_LH_P2_0_0, _lh_lines_LH_P2_1_0) -> 
        (let rec t_1_2 = (let rec _lh_matchIdent_5 = _lh_lines_LH_P2_1_0 in
          ...
          (let rec h_1_2 = _lh_lines_LH_P2_0_0 in
            (fun f_2 -> 
              (`LH_C((f_2 h_1_2), ((map_lh__d3 f_2) t_1_2))))))
      | _ -> 
        (failwith "error")));;
let rec parse_lh__d1 _lh_parse_arg1_0 =
  ((fun _lh_funcomp_x_6 -> 
    ((fun _lh_funcomp_x_7 -> 
      (paras_lh__d1 ((map_lh__d3 words_lh__d1) _lh_funcomp_x_7))) (lines_lh__d1 _lh_funcomp_x_6))) _lh_parse_arg1_0);;
let rec mappend_lh__d1_d1 xs_1_0 ys_1_4 =
  (xs_1_0 ys_1_4);;
let rec mappend_lh__d1_d4 xs_8 ys_1_2 =
  (xs_8 ys_1_2);;
let rec mappend_lh__d1_d2 xs_1_6 ys_2_5 =
  (match xs_1_6 with
    | `LH_C(h_3_7, t_3_7) -> 
      (let rec t_3_8 = ((mappend_lh__d1_d2 t_3_7) ys_2_5) in
        (let rec h_3_8 = h_3_7 in
          (fun ys_2_6 -> 
            (let rec t_3_9 = ((mappend_lh__d1_d1 t_3_8) ys_2_6) in
              (let rec h_3_9 = h_3_8 in
                (fun ys_2_7 -> 
                  (`LH_C(h_3_9, ((mappend_lh__d1_d4 t_3_9) ys_2_7)))))))))
    | `LH_N -> 
      ys_2_5);;
let rec mappend_lh__d1_d3 xs_1_3 ys_1_9 =
  (match xs_1_3 with
    | `LH_C(h_2_2, t_2_2) -> 
      (let rec t_2_3 = ((mappend_lh__d1_d3 t_2_2) ys_1_9) in
        (let rec h_2_3 = h_2_2 in
          (fun ys_2_0 -> 
            (let rec t_2_4 = ((mappend_lh__d1_d1 t_2_3) ys_2_0) in
              (let rec h_2_4 = h_2_3 in
                (fun ys_2_1 -> 
                  (`LH_C(h_2_4, ((mappend_lh__d1_d4 t_2_4) ys_2_1)))))))))
    | `LH_N -> 
      ys_1_9);;
      ...
      (let rec go_0 = (fun _lh_go_arg1_0 -> 
        (match _lh_go_arg1_0 with
          ...
          | `LH_C(_lh_go_LH_C_0_0, _lh_go_LH_C_1_0) -> 
            (let rec t_1 = ((mappend_lh__d1_d3 _lh_go_LH_C_0_0) (go_0 _lh_go_LH_C_1_0)) in
              (let rec h_1 = ' ' in
                (fun ys_3 -> 
                  (let rec t_2 = ((mappend_lh__d1_d1 t_1) ys_3) in
                    (let rec h_2 = h_1 in
                      (fun ys_4 -> 
                        (`LH_C(h_2, ((mappend_lh__d1_d4 t_2) ys_4)))))))))
          | _ -> 
            (failwith "error"))) in
...
let rec mappend_lh__d1_d6 xs_0 ys_0 =
  (xs_0 ys_0);;
let rec mappend_lh__d1_d5 xs_1_5 ys_2_3 =
  (match xs_1_5 with
    | `LH_C(h_2_8, t_2_8) -> 
      (let rec t_2_9 = ((mappend_lh__d1_d5 t_2_8) ys_2_3) in
        (let rec h_2_9 = h_2_8 in
          (fun ys_2_4 -> 
            (`LH_C(h_2_9, ((mappend_lh__d1_d6 t_2_9) ys_2_4))))))
    | `LH_N -> 
      ys_2_3);;
let rec unformat_lh__d1 _lh_unformat_arg1_0 =
  ((fold1_lh__d2 (fun xs_1_2 ys_1_6 -> 
    ((mappend_lh__d1_d6 ((mappend_lh__d1_d5 xs_1_2) (let rec t_2_0 = (fun ys_1_7 -> 
      ys_1_7) in
      (let rec h_2_0 = _lh_unformat_arg1_0 in
        (fun ys_1_8 -> 
          (`LH_C(h_2_0, ((mappend_lh__d1_d6 t_2_0) ys_1_8)))))))) ys_1_6))) (fun x_2 -> 
    x_2));;
...
let rec unlines_lh__d1 _lh_unlines_arg1_0 =
  (concat_lh__d2 ((map_lh__d6 (fun l_1 -> 
    ((mappend_lh__d1_d1 l_1) (let rec t_4_0 = (fun ys_2_8 -> 
      ys_2_8) in
      (let rec h_4_0 = '|' in
        (fun ys_2_9 -> 
          (`LH_C(h_4_0, ((mappend_lh__d1_d4 t_4_0) ys_2_9))))))))) _lh_unlines_arg1_0));;
let rec unparse_lh__d1 _lh_unparse_arg1_0 =
  ((fun _lh_funcomp_x_8 -> 
    ((fun _lh_funcomp_x_9 -> 
      (unlines_lh__d1 ((map_lh__d2 unwords_lh__d1) _lh_funcomp_x_9))) (unparas_lh__d1 _lh_funcomp_x_8))) _lh_unparse_arg1_0);;
let rec mappend_lh__d1_d0 xs_4 ys_8 =
  (match xs_4 with
    | `LH_C(h_8, t_8) -> 
      (`LH_C(h_8, ((mappend_lh__d1_d0 t_8) ys_8)))
    | `LH_N -> 
      ys_8);;
let rec concat_lh__d1 lss_1 =
  (match lss_1 with
    | `LH_C(h_3_6, t_3_6) -> 
      ((mappend_lh__d1_d0 h_3_6) (concat_lh__d1 t_3_6))
    | `LH_N -> 
      (`LH_N));;
...
let rec mappend_lh__d5 xs_7 ys_1_1 =
  (match xs_7 with
    | `LH_C(h_1_1, t_1_1) -> 
      (`LH_C(h_1_1, ((mappend_lh__d5 t_1_1) ys_1_1)))
    | `LH_N -> 
      ys_1_1);;
let rec mappend_lh__d6 xs_9 ys_1_3 =
  (match xs_9 with
    | `LH_C(h_1_4, t_1_4) -> 
      (`LH_C(h_1_4, ((mappend_lh__d6 t_1_4) ys_1_3)))
    | `LH_N -> 
      ys_1_3);;
let rec mappend_lh__d4 xs_1_1 ys_1_5 =
  (match xs_1_1 with
    | `LH_C(h_1_6, t_1_6) -> 
      (`LH_C(h_1_6, ((mappend_lh__d4 t_1_6) ys_1_5)))
    | `LH_N -> 
      ys_1_5);;
let rec mappend_lh__d9 xs_1_4 ys_2_2 =
  (match xs_1_4 with
    | `LH_C(h_2_7, t_2_7) -> 
      (`LH_C(h_2_7, ((mappend_lh__d9 t_2_7) ys_2_2)))
    | `LH_N -> 
      ys_2_2);;
let rec null_lh__d1 _lh_null_arg1_0 =
  (match _lh_null_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec mappend_lh__d7 xs_5 ys_9 =
  (match xs_5 with
    | `LH_C(h_9, t_9) -> 
      (`LH_C(h_9, ((mappend_lh__d7 t_9) ys_9)))
    | `LH_N -> 
      ys_9);;
let rec mappend_lh__d2 xs_6 ys_1_0 =
  (match xs_6 with
    | `LH_C(h_1_0, t_1_0) -> 
      (`LH_C(h_1_0, ((mappend_lh__d2 t_1_0) ys_1_0)))
    | `LH_N -> 
      ys_1_0);;
