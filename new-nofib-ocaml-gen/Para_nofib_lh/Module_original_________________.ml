...
let rec testPara_nofib_lh _lh_testPara_nofib_arg1_0 =
  (let rec test_0 = ((mappend_lh ((mappend_lh ((mappend_lh ((mappend_lh ((mappend_lh ((mappend_lh ((mappend_lh ((mappend_lh ((mappend_lh lh_large_str_0) lh_large_str_1)) lh_large_str_2)) lh_large_str_3)) lh_large_str_4)) lh_large_str_5)) lh_large_str_6)) lh_large_str_7)) lh_large_str_8)) lh_large_str_9) in
    (if (null_lh test_0) then
      (`LH_N)
    else
      (fmt_lh test_0)));;
let run () = 1 + (Obj.magic ((testPara_nofib_lh 0)));
end;;
