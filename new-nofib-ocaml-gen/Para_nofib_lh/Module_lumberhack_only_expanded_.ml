...
let rec mappend_lh__d3 xs_1_1 ys_1_1 =
  (match xs_1_1 with
    | `LH_C(h_2_8, t_2_8) -> 
      (`LH_C(h_2_8, ((mappend_lh__d3 t_2_8) ys_1_1)))
    | `LH_N -> 
      ys_1_1);;
let rec mappend_lh__d1 xs_1_3 ys_1_3 =
  (match xs_1_3 with
    | `LH_C(h_3_0, t_3_0) -> 
      (`LH_C(h_3_0, ((mappend_lh__d1 t_3_0) ys_1_3)))
    | `LH_N -> 
      ys_1_3);;
let rec mappend_lh__d8 xs_6 ys_6 =
  (match xs_6 with
    | `LH_C(h_2_3, t_2_3) -> 
      (`LH_C(h_2_3, ((mappend_lh__d8 t_2_3) ys_6)))
    | `LH_N -> 
      ys_6);;
...
let rec cons'_lh__d2 _lh_cons'_arg1_1 _lh_cons'_arg2_1 =
  (match _lh_cons'_arg2_1 with
    | `LH_P2(_lh_cons'_LH_P2_0_1, _lh_cons'_LH_P2_1_1) -> 
      (if (not (null_lh__d4 _lh_cons'_LH_P2_1_1)) then
  ...
  (match _lh_last'_arg1_2 with
    | `LH_P2(_lh_last'_LH_P2_0_2, _lh_last'_LH_P2_1_2) -> 
      (if (not (null_lh__d6 _lh_last'_LH_P2_1_2)) then
        (head_lh__d4 _lh_last'_LH_P2_1_2)
      else
        (head_lh__d4 _lh_last'_LH_P2_0_2)));;
let rec fst3_lh__d3 _lh_fst3_arg1_0 =
...
let rec width_tl_lh__d2 _lh_width_tl_arg1_0 =
  (fst3_lh__d3 _lh_width_tl_arg1_0);;
let rec maxw_lh__d3 =
  70;;
...
let rec splitAt_lh__d3 _lh_splitAt_arg1_0 _lh_splitAt_arg2_0 =
    ...
    | `LH_P2(_lh_init'_LH_P2_0_2, _lh_init'_LH_P2_1_2) -> 
      (if (null_lh__d6 _lh_init'_LH_P2_1_2) then
        ...
        (if (single_lh__d1 _lh_init'_LH_P2_1_2) then
          (let rec _lh_matchIdent_3 = ((splitAt_lh__d3 ((length_lh__d2 _lh_init'_LH_P2_0_2) / 2)) _lh_init'_LH_P2_0_2) in
    ...
    | `LH_P2(_lh_tail'_LH_P2_0_0, _lh_tail'_LH_P2_1_0) -> 
      (if (null_lh__d5 _lh_tail'_LH_P2_0_0) then
        ...
        (if (single_lh__d1 _lh_tail'_LH_P2_0_0) then
          (let rec _lh_matchIdent_4 = ((splitAt_lh__d2 ((length_lh__d2 _lh_tail'_LH_P2_1_0) / 2)) _lh_tail'_LH_P2_1_0) in
    ...
    | `LH_P2(_lh_init'_LH_P2_0_0, _lh_init'_LH_P2_1_0) -> 
      (if (null_lh__d6 _lh_init'_LH_P2_1_0) then
        ...
        (if (single_lh__d1 _lh_init'_LH_P2_1_0) then
          (let rec _lh_matchIdent_2 = ((splitAt_lh__d3 ((length_lh__d2 _lh_init'_LH_P2_0_0) / 2)) _lh_init'_LH_P2_0_0) in
...
let rec thd3_lh__d3 _lh_thd3_arg1_0 =
            ...
            (let rec width_hd_0 = (fun p_1 -> 
              ...
              (let rec cost_0 = (fun p_2 -> 
                (if (single_0 p_2) then
                  ...
                  ((cost_tl_lh__d1 p_2) + (let rec a_3 = (optw_lh__d1 - (width_hd_0 p_2)) in
                    (a_3 * a_3))))) in
...
let rec length_lh__d1 ls_1_5 =
  (match ls_1_5 with
    | `LH_C(h_1_9, t_1_9) -> 
      (1 + (length_lh__d1 t_1_9))
    | `LH_N -> 
      0);;
let rec map_lh__d3 f_4 ls_1_2 =
  (match ls_1_2 with
    | `LH_C(h_1_6, t_1_6) -> 
      (`LH_C((f_4 h_1_6), ((map_lh__d3 f_4) t_1_6)))
    | `LH_N -> 
      (`LH_N));;
let rec thd3_lh__d2 _lh_thd3_arg1_1 =
  ...
  (match _lh_last'_arg1_4 with
    | `LH_P2(_lh_last'_LH_P2_0_4, _lh_last'_LH_P2_1_4) -> 
      (if (not (null_lh__d2 _lh_last'_LH_P2_1_4)) then
        ...
        (head_lh__d2 _lh_last'_LH_P2_0_4)));;
...
let rec splitAt_lh__d1 _lh_splitAt_arg1_2 _lh_splitAt_arg2_2 =
  (`LH_P2(((take_lh__d1 _lh_splitAt_arg1_2) _lh_splitAt_arg2_2), ((drop_lh__d2 _lh_splitAt_arg1_2) _lh_splitAt_arg2_2)));;
    ...
    | `LH_P2(_lh_tile_LH_P2_0_0, _lh_tile_LH_P2_1_0) -> 
      (match _lh_tile_LH_P2_0_0 with
        ...
        | `LH_C(_lh_tile_LH_C_0_0, _lh_tile_LH_C_1_0) -> 
          (let rec l_1 = (_lh_tile_LH_P2_1_0 - _lh_tile_LH_C_0_0) in
            (let rec _lh_matchIdent_9 = ((splitAt_lh__d1 l_1) _lh_tile_arg1_0) in
              (match _lh_matchIdent_9 with
                | `LH_P2(_lh_tile_LH_P2_0_1, _lh_tile_LH_P2_1_1) -> 
                  (`LH_C(_lh_tile_LH_P2_0_1, ((tile_lh__d1 _lh_tile_LH_P2_1_1) (`LH_P2(((drop_lh__d1 l_1) (`LH_C(_lh_tile_LH_C_0_0, _lh_tile_LH_C_1_0))), _lh_tile_LH_C_0_0))))))))));;
let rec map_lh__d2 f_5 ls_1_3 =
  (match ls_1_3 with
    | `LH_C(h_1_7, t_1_7) -> 
      (`LH_C((f_5 h_1_7), ((map_lh__d2 f_5) t_1_7)))
    | `LH_N -> 
      (`LH_N));;
let rec thd3_lh__d1 _lh_thd3_arg1_2 =
...
let rec par3_lh__d1 _lh_par3_arg1_0 =
  (let rec zs_0 = (((scan1_lh__d1 stepr_lh__d1) startr_lh__d1) ((map_lh__d3 length_lh__d1) _lh_par3_arg1_0)) in
    ((tile_lh__d1 _lh_par3_arg1_0) (`LH_P2(((map_lh__d2 (fun _lh_funcomp_x_5 -> 
      ((fun _lh_funcomp_x_6 -> 
        (len_tl_lh__d1 (last'_lh__d1 _lh_funcomp_x_6))) (fst3_lh__d1 _lh_funcomp_x_5)))) zs_0), (thd3_lh__d1 (head_lh__d1 zs_0))))));;
let rec filter_lh__d1 f_0 ls_5 =
  (match ls_5 with
    | `LH_C(h_4, t_4) -> 
      (if (f_0 h_4) then
        (`LH_C(h_4, ((filter_lh__d1 f_0) t_4)))
      else
        ((filter_lh__d1 f_0) t_4))
    | `LH_N -> 
      (`LH_N));;
    ...
    | _ -> 
      let rec break_0 = (fun _lh_break_arg1_0 _lh_break_arg2_0 _lh_break_arg3_0 -> 
        (if (_lh_break_arg1_0 = _lh_break_arg2_0) then
          ...
          (`LH_C((`LH_C(_lh_break_arg2_0, (head_lh__d4 _lh_break_arg3_0))), (tail_lh__d1 _lh_break_arg3_0)))))
...
let rec paras_lh__d1 _lh_paras_arg1_0 =
  ((fun _lh_funcomp_x_0 -> 
    ((filter_lh__d1 (fun x_1 -> 
      ((`LH_N) <> x_1))) ((format_lh__d1 (`LH_N)) _lh_funcomp_x_0))) _lh_paras_arg1_0);;
  ...
  (match _lh_break_arg2_1 with
    ...
    | `LH_C(_lh_break_LH_C_0_0, _lh_break_LH_C_1_0) -> 
      (if (_lh_break_arg1_1 _lh_break_LH_C_0_0) then
        ...
        (let rec _lh_matchIdent_0 = ((break_lh__d2 _lh_break_arg1_1) _lh_break_LH_C_1_0) in
...
let rec lines_lh__d1 _lh_lines_arg1_0 =
  (let rec _lh_matchIdent_5 = ((break_lh__d2 (fun x_2 -> 
    (x_2 = '|'))) _lh_lines_arg1_0) in
    (match _lh_matchIdent_5 with
      | `LH_P2(_lh_lines_LH_P2_0_0, _lh_lines_LH_P2_1_0) -> 
        (`LH_C(_lh_lines_LH_P2_0_0, (let rec _lh_matchIdent_6 = _lh_lines_LH_P2_1_0 in
  ...
  (match _lh_break_arg2_2 with
    ...
    | `LH_C(_lh_break_LH_C_0_1, _lh_break_LH_C_1_1) -> 
      (if (_lh_break_arg1_2 _lh_break_LH_C_0_1) then
        ...
        (let rec _lh_matchIdent_1 = ((break_lh__d1 _lh_break_arg1_2) _lh_break_LH_C_1_1) in
...
let rec words_lh__d1 _lh_words_arg1_0 =
  (let rec _lh_matchIdent_7 = ((dropWhile_lh__d1 isSpace_lh__d2) _lh_words_arg1_0) in
    (match _lh_matchIdent_7 with
      | `LH_N -> 
        (`LH_N)
      | `LH_C(_lh_words_LH_C_0_0, _lh_words_LH_C_1_0) -> 
        (let rec _lh_matchIdent_8 = ((break_lh__d1 isSpace_lh__d1) (`LH_C(_lh_words_LH_C_0_0, _lh_words_LH_C_1_0))) in
          (match _lh_matchIdent_8 with
            | `LH_P2(_lh_words_LH_P2_0_0, _lh_words_LH_P2_1_0) -> 
              (`LH_C(_lh_words_LH_P2_0_0, (words_lh__d1 _lh_words_LH_P2_1_0)))))));;
let rec map_lh__d5 f_2 ls_1_0 =
  (match ls_1_0 with
    | `LH_C(h_1_4, t_1_4) -> 
...
let rec parse_lh__d1 _lh_parse_arg1_0 =
  ((fun _lh_funcomp_x_1 -> 
    ((fun _lh_funcomp_x_2 -> 
      (paras_lh__d1 ((map_lh__d5 words_lh__d1) _lh_funcomp_x_2))) (lines_lh__d1 _lh_funcomp_x_1))) _lh_parse_arg1_0);;
let rec mappend_lh__d1_d2 xs_1 ys_1 =
  (match xs_1 with
    | `LH_C(h_8, t_8) -> 
      (`LH_C(h_8, ((mappend_lh__d1_d2 t_8) ys_1)))
    | `LH_N -> 
      ys_1);;
let rec mappend_lh__d1_d1 xs_2 ys_2 =
  (match xs_2 with
    | `LH_C(h_9, t_9) -> 
      (`LH_C(h_9, ((mappend_lh__d1_d1 t_9) ys_2)))
    | `LH_N -> 
      ys_2);;
...
let rec mappend_lh__d1_d3 xs_0 ys_0 =
  (match xs_0 with
    | `LH_C(h_7, t_7) -> 
      (`LH_C(h_7, ((mappend_lh__d1_d3 t_7) ys_0)))
    | `LH_N -> 
      ys_0);;
let rec unformat_lh__d1 _lh_unformat_arg1_0 =
  ((fold1_lh__d1 (fun xs_3 ys_3 -> 
    ((mappend_lh__d1_d3 ((mappend_lh__d1_d3 xs_3) (`LH_C(_lh_unformat_arg1_0, (`LH_N))))) ys_3))) (fun x_0 -> 
    x_0));;
let rec unparas_lh__d1 _lh_unparas_arg1_0 =
  ((unformat_lh__d1 (`LH_N)) _lh_unparas_arg1_0);;
let rec map_lh__d4 f_3 ls_1_1 =
  (match ls_1_1 with
    | `LH_C(h_1_5, t_1_5) -> 
...
let rec concat_lh__d2 lss_0 =
  (match lss_0 with
    | `LH_C(h_6, t_6) -> 
      ((mappend_lh__d1_d3 h_6) (concat_lh__d2 t_6))
    | `LH_N -> 
      (`LH_N));;
let rec map_lh__d6 f_1 ls_6 =
  (match ls_6 with
    | `LH_C(h_5, t_5) -> 
...
let rec unlines_lh__d1 _lh_unlines_arg1_0 =
  (concat_lh__d2 ((map_lh__d6 (fun l_0 -> 
    ((mappend_lh__d1_d3 l_0) (`LH_C('|', (`LH_N)))))) _lh_unlines_arg1_0));;
let rec unparse_lh__d1 _lh_unparse_arg1_0 =
  ((fun _lh_funcomp_x_3 -> 
    ((fun _lh_funcomp_x_4 -> 
      (unlines_lh__d1 ((map_lh__d4 unwords_lh__d1) _lh_funcomp_x_4))) (unparas_lh__d1 _lh_funcomp_x_3))) _lh_unparse_arg1_0);;
let rec map_lh__d1 f_6 ls_1_6 =
  (match ls_1_6 with
    | `LH_C(h_2_1, t_2_1) -> 
      (`LH_C((f_6 h_2_1), ((map_lh__d1 f_6) t_2_1)))
    | `LH_N -> 
      (`LH_N));;
let rec mappend_lh__d1_d0 xs_4 ys_4 =
  (match xs_4 with
    | `LH_C(h_1_3, t_1_3) -> 
      (`LH_C(h_1_3, ((mappend_lh__d1_d0 t_1_3) ys_4)))
    | `LH_N -> 
      ys_4);;
let rec concat_lh__d1 lss_1 =
  (match lss_1 with
    | `LH_C(h_2_0, t_2_0) -> 
      ((mappend_lh__d1_d0 h_2_0) (concat_lh__d1 t_2_0))
    | `LH_N -> 
      (`LH_N));;
...
let rec mappend_lh__d5 xs_9 ys_9 =
  (match xs_9 with
    | `LH_C(h_2_6, t_2_6) -> 
      (`LH_C(h_2_6, ((mappend_lh__d5 t_2_6) ys_9)))
    | `LH_N -> 
      ys_9);;
let rec mappend_lh__d6 xs_8 ys_8 =
  (match xs_8 with
    | `LH_C(h_2_5, t_2_5) -> 
      (`LH_C(h_2_5, ((mappend_lh__d6 t_2_5) ys_8)))
    | `LH_N -> 
      ys_8);;
let rec mappend_lh__d4 xs_1_0 ys_1_0 =
  (match xs_1_0 with
    | `LH_C(h_2_7, t_2_7) -> 
      (`LH_C(h_2_7, ((mappend_lh__d4 t_2_7) ys_1_0)))
    | `LH_N -> 
      ys_1_0);;
let rec mappend_lh__d9 xs_5 ys_5 =
  (match xs_5 with
    | `LH_C(h_2_2, t_2_2) -> 
      (`LH_C(h_2_2, ((mappend_lh__d9 t_2_2) ys_5)))
    | `LH_N -> 
      ys_5);;
...
let rec mappend_lh__d7 xs_7 ys_7 =
  (match xs_7 with
    | `LH_C(h_2_4, t_2_4) -> 
      (`LH_C(h_2_4, ((mappend_lh__d7 t_2_4) ys_7)))
    | `LH_N -> 
      ys_7);;
let rec mappend_lh__d2 xs_1_2 ys_1_2 =
  (match xs_1_2 with
    | `LH_C(h_2_9, t_2_9) -> 
      (`LH_C(h_2_9, ((mappend_lh__d2 t_2_9) ys_1_2)))
    | `LH_N -> 
      ys_1_2);;
