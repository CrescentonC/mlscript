...
let rec mappend_lh__d1_d6 xs_3 ys_3 =
  (match xs_3 with
    ...
    | `LH_N -> 
      ys_3);;
let rec mappend_lh__d2_d7 xs_2_6 ys_4_6 =
  (match xs_2_6 with
    | `LH_C(h_3_6, t_3_7) -> 
      (`LH_C(h_3_6, ((mappend_lh__d2_d7 t_3_7) ys_4_6)))
    | `LH_N -> 
      ys_4_6);;
let rec showTerm_lh__d3 _lh_showTerm_arg1_2 =
  (match _lh_showTerm_arg1_2 with
    | `Con(_lh_showTerm_Con_0_2) -> 
      ((mappend_lh__d2_d7 (`LH_C('C', (`LH_C('o', (`LH_C('n', (`LH_C(' ', (`LH_N)))))))))) (string_of_int _lh_showTerm_Con_0_2))
    | _ -> 
...
let rec mappend_lh__d8 xs_8 ys_8 =
  (match xs_8 with
    ...
    | `LH_N -> 
      ys_8);;
let rec mappend_lh__d1_d0 xs_1_0 ys_1_5 =
  (match xs_1_0 with
    | `LH_C(h_1_3, t_1_4) -> 
      (`LH_C(h_1_3, ((mappend_lh__d1_d0 t_1_4) ys_1_5)))
    | `LH_N -> 
      ys_1_5);;
let rec mappend_lh__d1_d4 xs_1_5 ys_2_5 =
  (match xs_1_5 with
    | `LH_C(h_2_1, t_2_2) -> 
      (`LH_C(h_2_1, ((mappend_lh__d1_d4 t_2_2) ys_2_5)))
    | `LH_N -> 
      ys_2_5);;
let rec mappend_lh__d1_d1 xs_1_7 ys_2_7 =
  (match xs_1_7 with
    | `LH_C(h_2_2, t_2_3) -> 
      (`LH_C(h_2_2, ((mappend_lh__d1_d1 t_2_3) ys_2_7)))
    | `LH_N -> 
      ys_2_7);;
...
let rec bracket_lh__d2 _lh_bracket_arg1_0 _lh_bracket_arg2_0 _lh_bracket_arg3_0 =
  (if (_lh_bracket_arg2_0 <= _lh_bracket_arg1_0) then
    ...
    _lh_bracket_arg3_0);;
let rec mappend_lh__d2_d3 xs_1_3 ys_1_8 =
  (match xs_1_3 with
    | `LH_C(h_1_6, t_1_7) -> 
      (`LH_C(h_1_6, ((mappend_lh__d2_d3 t_1_7) ys_1_8)))
    | `LH_N -> 
      ys_1_8);;
let rec mappend_lh__d2_d5 xs_2_1 ys_3_5 =
  (match xs_2_1 with
    | `LH_C(h_2_9, t_3_0) -> 
      (`LH_C(h_2_9, ((mappend_lh__d2_d5 t_3_0) ys_3_5)))
    | `LH_N -> 
      ys_3_5);;
...
let rec pp_lh__d1 _lh_pp_arg1_2 =
  ((ppn_lh__d1 0) _lh_pp_arg1_2)
and
ppenv_lh__d2 _lh_ppenv_arg1_1 =
  ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 (`LH_C('[', (`LH_N)))) ((flatMap_lh__d1 (fun vt_1 -> 
    (let rec _lh_matchIdent_7 = vt_1 in
      (match _lh_matchIdent_7 with
        | `LH_P2(_lh_ppenv_LH_P2_0_1, _lh_ppenv_LH_P2_1_1) -> 
          ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 _lh_ppenv_LH_P2_0_1) (`LH_C('=', (`LH_N))))) (pp_lh__d1 _lh_ppenv_LH_P2_1_1))) (`LH_C(',', (`LH_C(' ', (`LH_N)))))))))) _lh_ppenv_arg1_1))) (`LH_C(']', (`LH_N))))
and
ppn_lh__d1 _lh_ppn_arg1_1 _lh_ppn_arg2_1 =
  (match _lh_ppn_arg2_1 with
    ...
    | `Lam(_lh_ppn_Lam_0_1, _lh_ppn_Lam_1_1) -> 
      (((bracket_lh__d2 _lh_ppn_arg1_1) 0) ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 ((mappend_lh__d2_d4 (let rec t_3_1 = (fun ys_3_6 -> 
        ys_3_6) in
        (let rec h_3_0 = '@' in
          (fun ys_3_7 -> 
            (`LH_C(h_3_0, ((mappend_lh__d2_d4 t_3_1) ys_3_7))))))) _lh_ppn_Lam_0_1)) (`LH_C('.', (`LH_C(' ', (`LH_N))))))) ((ppn_lh__d1 (0 - 1)) _lh_ppn_Lam_1_1)))
    | `Add(_lh_ppn_Add_0_1, _lh_ppn_Add_1_1) -> 
      (((bracket_lh__d1 _lh_ppn_arg1_1) 1) ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 ((ppn_lh__d1 1) _lh_ppn_Add_0_1)) (`LH_C(' ', (`LH_C('+', (`LH_C(' ', (`LH_N))))))))) ((ppn_lh__d1 1) _lh_ppn_Add_1_1)))
    | `App(_lh_ppn_App_0_1, _lh_ppn_App_1_1) -> 
      (((bracket_lh__d2 _lh_ppn_arg1_1) 2) ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 ((ppn_lh__d1 2) _lh_ppn_App_0_1)) (`LH_C(' ', (`LH_N))))) ((ppn_lh__d1 2) _lh_ppn_App_1_1)))
    | `IfZero(_lh_ppn_IfZero_0_1, _lh_ppn_IfZero_1_1, _lh_ppn_IfZero_2_1) -> 
      (((bracket_lh__d2 _lh_ppn_arg1_1) 0) ((mappend_lh__d2_d6 ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 ((mappend_lh__d2_d5 ((mappend_lh__d2_d2 (let rec t_3_2 = (let rec t_3_3 = (let rec t_3_4 = (fun ys_3_8 -> 
        ys_3_8) in
        (let rec h_3_1 = ' ' in
          (fun ys_3_9 -> 
            (`LH_C(h_3_1, ((mappend_lh__d2_d2 t_3_4) ys_3_9)))))) in
        (let rec h_3_2 = 'F' in
          (fun ys_4_0 -> 
            (`LH_C(h_3_2, ((mappend_lh__d2_d2 t_3_3) ys_4_0)))))) in
        (let rec h_3_3 = 'I' in
          (fun ys_4_1 -> 
            (`LH_C(h_3_3, ((mappend_lh__d2_d2 t_3_2) ys_4_1))))))) ((ppn_lh__d1 0) _lh_ppn_IfZero_0_1))) (`LH_C(' ', (`LH_C('T', (`LH_C('H', (`LH_C('E', (`LH_C('N', (`LH_C(' ', (`LH_N))))))))))))))) ((ppn_lh__d1 0) _lh_ppn_IfZero_1_1))) (`LH_C(' ', (`LH_C('E', (`LH_C('L', (`LH_C('S', (`LH_C('E', (`LH_C(' ', (`LH_N))))))))))))))) ((ppn_lh__d1 0) _lh_ppn_IfZero_2_1)))
    | `Thunk(_lh_ppn_Thunk_0_1, _lh_ppn_Thunk_1_1) -> 
      (((bracket_lh__d2 _lh_ppn_arg1_1) 0) ((mappend_lh__d2_d7 ((mappend_lh__d2_d3 ((ppn_lh__d1 3) _lh_ppn_Thunk_0_1)) (`LH_C(':', (`LH_C(':', (`LH_N))))))) (ppenv_lh__d2 _lh_ppn_Thunk_1_1))));;
let rec ppn_lh__d3 _lh_ppn_arg1_2 _lh_ppn_arg2_2 =
  (match _lh_ppn_arg2_2 with
    ...
    | `Lam(_lh_ppn_Lam_0_2, _lh_ppn_Lam_1_2) -> 
      (((bracket_lh__d2 _lh_ppn_arg1_2) 0) ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 (`LH_C('@', (`LH_N)))) _lh_ppn_Lam_0_2)) (`LH_C('.', (`LH_C(' ', (`LH_N))))))) ((ppn_lh__d3 (0 - 1)) _lh_ppn_Lam_1_2)))
    | `Add(_lh_ppn_Add_0_2, _lh_ppn_Add_1_2) -> 
      (((bracket_lh__d2 _lh_ppn_arg1_2) 1) ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 ((ppn_lh__d3 1) _lh_ppn_Add_0_2)) (`LH_C(' ', (`LH_C('+', (`LH_C(' ', (`LH_N))))))))) ((ppn_lh__d3 1) _lh_ppn_Add_1_2)))
    | `App(_lh_ppn_App_0_2, _lh_ppn_App_1_2) -> 
      (((bracket_lh__d2 _lh_ppn_arg1_2) 2) ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 ((ppn_lh__d3 2) _lh_ppn_App_0_2)) (`LH_C(' ', (`LH_N))))) ((ppn_lh__d3 2) _lh_ppn_App_1_2)))
    | `IfZero(_lh_ppn_IfZero_0_2, _lh_ppn_IfZero_1_2, _lh_ppn_IfZero_2_2) -> 
      (((bracket_lh__d2 _lh_ppn_arg1_2) 0) ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 (`LH_C('I', (`LH_C('F', (`LH_C(' ', (`LH_N)))))))) ((ppn_lh__d3 0) _lh_ppn_IfZero_0_2))) (`LH_C(' ', (`LH_C('T', (`LH_C('H', (`LH_C('E', (`LH_C('N', (`LH_C(' ', (`LH_N))))))))))))))) ((ppn_lh__d3 0) _lh_ppn_IfZero_1_2))) (`LH_C(' ', (`LH_C('E', (`LH_C('L', (`LH_C('S', (`LH_C('E', (`LH_C(' ', (`LH_N))))))))))))))) ((ppn_lh__d3 0) _lh_ppn_IfZero_2_2)))
    | `Thunk(_lh_ppn_Thunk_0_2, _lh_ppn_Thunk_1_2) -> 
      (((bracket_lh__d2 _lh_ppn_arg1_2) 0) ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 ((ppn_lh__d3 3) _lh_ppn_Thunk_0_2)) (`LH_C(':', (`LH_C(':', (`LH_N))))))) (ppenv_lh__d2 _lh_ppn_Thunk_1_2))));;
let rec pp_lh__d4 _lh_pp_arg1_3 =
...
let rec mappend_lh__d1_d2 xs_2 ys_2 =
  (match xs_2 with
    ...
    | `LH_N -> 
      ys_2);;
let rec pp_lh__d5 _lh_pp_arg1_7 =
  ((ppn_lh__d3 0) _lh_pp_arg1_7);;
let rec pp_lh__d7 _lh_pp_arg1_5 =
  ((ppn_lh__d3 0) _lh_pp_arg1_5);;
let rec pp_lh__d6 _lh_pp_arg1_4 =
  ((ppn_lh__d3 0) _lh_pp_arg1_4);;
let rec mappend_lh__d2 xs_1_2 ys_1_7 =
  (match xs_1_2 with
    | `LH_C(h_1_5, t_1_6) -> 
      (`LH_C(h_1_5, ((mappend_lh__d2 t_1_6) ys_1_7)))
    | `LH_N -> 
      ys_1_7);;
...
eqTerm_lh__d1 _lh_eqTerm_arg1_0 _lh_eqTerm_arg2_0 =
  (match _lh_eqTerm_arg1_0 with
    ...
    | _ -> 
      false);;
let rec mappend_lh__d4 xs_1_8 ys_2_8 =
  (match xs_1_8 with
    | `LH_C(h_2_3, t_2_4) -> 
      (`LH_C(h_2_3, ((mappend_lh__d4 t_2_4) ys_2_8)))
    | `LH_N -> 
      ys_2_8);;
...
let rec ppn_lh__d2 _lh_ppn_arg1_0 _lh_ppn_arg2_0 =
  (match _lh_ppn_arg2_0 with
    ...
    | `Lam(_lh_ppn_Lam_0_0, _lh_ppn_Lam_1_0) -> 
      (((bracket_lh__d2 _lh_ppn_arg1_0) 0) ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 (`LH_C('@', (`LH_N)))) _lh_ppn_Lam_0_0)) (`LH_C('.', (`LH_C(' ', (`LH_N))))))) ((ppn_lh__d2 (0 - 1)) _lh_ppn_Lam_1_0)))
    | `Add(_lh_ppn_Add_0_0, _lh_ppn_Add_1_0) -> 
      (((bracket_lh__d2 _lh_ppn_arg1_0) 1) ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 ((ppn_lh__d2 1) _lh_ppn_Add_0_0)) (`LH_C(' ', (`LH_C('+', (`LH_C(' ', (`LH_N))))))))) ((ppn_lh__d2 1) _lh_ppn_Add_1_0)))
    | `App(_lh_ppn_App_0_0, _lh_ppn_App_1_0) -> 
      (((bracket_lh__d2 _lh_ppn_arg1_0) 2) ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 ((ppn_lh__d2 2) _lh_ppn_App_0_0)) (`LH_C(' ', (`LH_N))))) ((ppn_lh__d2 2) _lh_ppn_App_1_0)))
    | `IfZero(_lh_ppn_IfZero_0_0, _lh_ppn_IfZero_1_0, _lh_ppn_IfZero_2_0) -> 
      (((bracket_lh__d2 _lh_ppn_arg1_0) 0) ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 (`LH_C('I', (`LH_C('F', (`LH_C(' ', (`LH_N)))))))) ((ppn_lh__d2 0) _lh_ppn_IfZero_0_0))) (`LH_C(' ', (`LH_C('T', (`LH_C('H', (`LH_C('E', (`LH_C('N', (`LH_C(' ', (`LH_N))))))))))))))) ((ppn_lh__d2 0) _lh_ppn_IfZero_1_0))) (`LH_C(' ', (`LH_C('E', (`LH_C('L', (`LH_C('S', (`LH_C('E', (`LH_C(' ', (`LH_N))))))))))))))) ((ppn_lh__d2 0) _lh_ppn_IfZero_2_0)))
    | `Thunk(_lh_ppn_Thunk_0_0, _lh_ppn_Thunk_1_0) -> 
      (((bracket_lh__d2 _lh_ppn_arg1_0) 0) ((mappend_lh__d2_d7 ((mappend_lh__d2_d7 ((ppn_lh__d2 3) _lh_ppn_Thunk_0_0)) (`LH_C(':', (`LH_C(':', (`LH_N))))))) (ppenv_lh__d2 _lh_ppn_Thunk_1_0))));;
...
let rec showTerm_lh__d2 _lh_showTerm_arg1_1 =
  (match _lh_showTerm_arg1_1 with
    ...
    | _ -> 
      (failwith "msg"(`LH_C('u', (`LH_C('n', (`LH_C('i', (`LH_C('m', (`LH_C('p', (`LH_C('l', (`LH_C('e', (`LH_C('m', (`LH_C('e', (`LH_C('n', (`LH_C('t', (`LH_C('e', (`LH_C('d', (`LH_N)))))))))))))))))))))))))))));;
let rec mappend_lh__d7 xs_1_1 ys_1_6 =
  (match xs_1_1 with
    | `LH_C(h_1_4, t_1_5) -> 
      (`LH_C(h_1_4, ((mappend_lh__d7 t_1_5) ys_1_6)))
    | `LH_N -> 
      ys_1_6);;
  ...
  (match _lh_simpleEval_arg2_0 with
    ...
    | `Add(_lh_simpleEval_Add_0_0, _lh_simpleEval_Add_1_0) -> 
      (let rec addCons_0 = (fun _lh_addCons_arg1_0 _lh_addCons_arg2_0 -> 
        ...
        (let rec u'_0 = ((simpleEvalCon_lh__d1 _lh_simpleEval_arg1_0) _lh_simpleEval_Add_0_0) in
          (let rec v'_0 = ((simpleEvalCon_lh__d2 _lh_simpleEval_arg1_0) _lh_simpleEval_Add_1_0) in
            (`Con((u'_0 + v'_0))))))
...
let rec showTerm_lh__d1 _lh_showTerm_arg1_0 =
  (match _lh_showTerm_arg1_0 with
    | `Con(_lh_showTerm_Con_0_0) -> 
      ((mappend_lh__d1 (let rec t_9 = (let rec t_1_0 = (let rec t_1_1 = (let rec t_1_2 = (fun ys_1_0 -> 
        ys_1_0) in
        (let rec h_9 = ' ' in
          (fun ys_1_1 -> 
            (`LH_C(h_9, ((mappend_lh__d1 t_1_2) ys_1_1)))))) in
        (let rec h_1_0 = 'n' in
          (fun ys_1_2 -> 
            (`LH_C(h_1_0, ((mappend_lh__d1 t_1_1) ys_1_2)))))) in
        (let rec h_1_1 = 'o' in
          (fun ys_1_3 -> 
            (`LH_C(h_1_1, ((mappend_lh__d1 t_1_0) ys_1_3)))))) in
        (let rec h_1_2 = 'C' in
          (fun ys_1_4 -> 
            (`LH_C(h_1_2, ((mappend_lh__d1 t_9) ys_1_4))))))) (string_of_int _lh_showTerm_Con_0_0))
    | _ -> 
      (failwith "msg"(`LH_C('u', (`LH_C('n', (`LH_C('i', (`LH_C('m', (`LH_C('p', (`LH_C('l', (`LH_C('e', (`LH_C('m', (`LH_C('e', (`LH_C('n', (`LH_C('t', (`LH_C('e', (`LH_C('d', (`LH_N)))))))))))))))))))))))))))));;
let rec lfxx_lh__d1 =
...
let rec mappend_lh__d6 xs_1_6 ys_2_6 =
  (xs_1_6 ys_2_6);;
let rec mappend_lh__d5 xs_1_4 ys_1_9 =
  (match xs_1_4 with
    | `LH_C(h_1_7, t_1_8) -> 
      (let rec t_1_9 = ((mappend_lh__d5 t_1_8) ys_1_9) in
        (let rec h_1_8 = h_1_7 in
          (fun ys_2_0 -> 
            (`LH_C(h_1_8, ((mappend_lh__d6 t_1_9) ys_2_0))))))
    | `LH_N -> 
      ys_1_9);;
...
let rec mappend_lh__d1_d9 xs_9 ys_9 =
  (xs_9 ys_9);;
let rec mappend_lh__d2_d0 xs_1_9 ys_2_9 =
  (match xs_1_9 with
    | `LH_C(h_2_4, t_2_5) -> 
      (let rec t_2_6 = ((mappend_lh__d2_d0 t_2_5) ys_2_9) in
        (let rec h_2_5 = h_2_4 in
          (fun ys_3_0 -> 
            (`LH_C(h_2_5, ((mappend_lh__d1_d9 t_2_6) ys_3_0))))))
    | `LH_N -> 
      ys_2_9);;
let rec mappend_lh__d1_d7 xs_2_3 ys_4_3 =
  (xs_2_3 ys_4_3);;
let rec ppenv_lh__d1 _lh_ppenv_arg1_0 =
  ((mappend_lh__d2_d1 ((mappend_lh__d1_d7 (let rec t_2_0 = (fun ys_2_1 -> 
    ys_2_1) in
    (let rec h_1_9 = '[' in
      (fun ys_2_2 -> 
        (`LH_C(h_1_9, ((mappend_lh__d1_d7 t_2_0) ys_2_2))))))) ((flatMap_lh__d1 (fun vt_0 -> 
    (let rec _lh_matchIdent_3 = vt_0 in
      (match _lh_matchIdent_3 with
        | `LH_P2(_lh_ppenv_LH_P2_0_0, _lh_ppenv_LH_P2_1_0) -> 
          ((mappend_lh__d1_d8 ((mappend_lh__d1_d9 ((mappend_lh__d2_d0 _lh_ppenv_LH_P2_0_0) (let rec t_2_1 = (fun ys_2_3 -> 
            ys_2_3) in
            (let rec h_2_0 = '=' in
              (fun ys_2_4 -> 
                (`LH_C(h_2_0, ((mappend_lh__d1_d9 t_2_1) ys_2_4)))))))) (pp_lh__d8 _lh_ppenv_LH_P2_1_0))) (`LH_C(',', (`LH_C(' ', (`LH_N)))))))))) _lh_ppenv_arg1_0))) (`LH_C(']', (`LH_N))));;
    ...
    (let rec _lh_matchIdent_6 = ((myRunState_lh__d1 _lh_myBind_arg1_0) s_1) in
      (match _lh_matchIdent_6 with
        | `LH_P2(_lh_myBind_LH_P2_0_0, _lh_myBind_LH_P2_1_0) -> 
          ((myRunState_lh__d1 (_lh_myBind_arg2_0 _lh_myBind_LH_P2_1_0)) _lh_myBind_LH_P2_0_0)))) in
  ...
  (match _lh_eval_arg1_0 with
    | `Var(_lh_eval_Var_0_0) -> 
      ((myBind_lh__d1 myGet_lh__d1) (fun e_0 -> 
        ((myBind_lh__d1 (lookupVar_lh__d1 _lh_eval_Var_0_0)) (fun t_1_3 -> 
          (traverseTerm_lh__d1 t_1_3)))))
