...
let rec mappend_lh__d4 xs_2 ys_2 =
  (match xs_2 with
    | `LH_C(h_4, t_4) -> 
      (`LH_C(h_4, ((mappend_lh__d4 t_4) ys_2)))
    | `LH_N -> 
      ys_2);;
let rec mappend_lh__d5 xs_1 ys_1 =
  (match xs_1 with
    | `LH_C(h_3, t_3) -> 
      (`LH_C(h_3, ((mappend_lh__d5 t_3) ys_1)))
    | `LH_N -> 
      ys_1);;
...
let rec join_lh__d1 _lh_join_arg1_0 =
  ((foldr1_lh__d1 (fun xs_5 ys_5 -> 
    ((mappend_lh__d4 ((mappend_lh__d5 xs_5) (`LH_C(' ', (`LH_C(' ', (`LH_N))))))) ys_5))) _lh_join_arg1_0);;
...
let rec map_lh__d3 f_1 ls_2 =
  (match ls_2 with
    | `LH_C(h_5, t_5) -> 
      (`LH_C((f_1 h_5), ((map_lh__d3 f_1) t_5)))
    | `LH_N -> 
      (`LH_N));;
...
let rec concat_lh__d2 lss_0 =
  (match lss_0 with
    | `LH_C(h_7, t_7) -> 
      ((mappend_lh__d6 h_7) (concat_lh__d2 t_7))
    | `LH_N -> 
      (`LH_N));;
let rec mappend_lh__d3 xs_3 ys_3 =
  (match xs_3 with
    | `LH_C(h_6, t_6) -> 
      (`LH_C(h_6, ((mappend_lh__d3 t_6) ys_3)))
    | `LH_N -> 
      ys_3);;
let rec unlines_lh__d1 _lh_unlines_arg1_0 =
  (concat_lh__d2 ((map_lh__d3 (fun l_0 -> 
    ((mappend_lh__d3 l_0) (`LH_C('n', (`LH_N)))))) _lh_unlines_arg1_0));;
...
let rec isDigit_lh__d1 _lh_isDigit_arg1_0 =
  (let rec n_2 = (int_of_char _lh_isDigit_arg1_0) in
    ((n_2 >= 48) && (n_2 <= 57)));;
...
let rec mappend_lh__d2 xs_4 ys_4 =
  (match xs_4 with
    | `LH_C(h_1_1, t_1_1) -> 
      (`LH_C(h_1_1, ((mappend_lh__d2 t_1_1) ys_4)))
    | `LH_N -> 
      ys_4);;
...
let rec atIndex_lh__d1 n_5 ls_6 =
  (if (n_5 < 0) then
    (failwith "lh_default_error")
  else
    (match ls_6 with
...
let rec isUpper_lh__d1 _lh_isUpper_arg1_0 =
  (let rec n_6 = (int_of_char _lh_isUpper_arg1_0) in
    ((n_6 >= 65) && (n_6 <= 90)));;
...
let rec atIndex_lh__d3 n_1 ls_4 =
  (if (n_1 < 0) then
    (failwith "lh_default_error")
  else
    (match ls_4 with
      | `LH_C(h_8, t_8) -> 
        (if (n_1 = 0) then
          ...
          ((atIndex_lh__d3 (n_1 - 1)) t_8))
      | `LH_N -> 
        (failwith "lh_default_error")));;
let rec slant_lh__d2 =
  (`LH_C((`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_N))))))))), (`LH_C((`LH_C(' ', (`LH_C(' ', (`LH_C(' ', (`LH_N))))))), (`LH_C((`LH_C(' ', (`LH_C(' ', (`LH_N))))), (`LH_C((`LH_C(' ', (`LH_N))), (`LH_C((`LH_N), (`LH_N)))))))))));;
let rec atIndex_lh__d2 n_3 ls_5 =
  (if (n_3 < 0) then
    (failwith "lh_default_error")
  else
    (match ls_5 with
      | `LH_C(h_9, t_9) -> 
        (if (n_3 = 0) then
          ...
          ((atIndex_lh__d2 (n_3 - 1)) t_9))
      | `LH_N -> 
        (failwith "lh_default_error")));;
let rec picChar_lh__d1 _lh_picChar_arg1_0 =
  (if (isUpper_lh__d1 _lh_picChar_arg1_0) then
    ((atIndex_lh__d1 ((int_of_char _lh_picChar_arg1_0) - (int_of_char 'A'))) alphas_lh__d2)
  else
    (if (isLower_lh__d1 _lh_picChar_arg1_0) then
      ((atIndex_lh__d2 ((int_of_char _lh_picChar_arg1_0) - (int_of_char 'a'))) alphas_lh__d1)
    else
        ...
        (if (isDigit_lh__d1 _lh_picChar_arg1_0) then
          ...
          (if (_lh_picChar_arg1_0 = '/') then
            ...
            (if (_lh_picChar_arg1_0 = '=') then
              ...
              (head_lh__d1 ((mappend_lh__d2 (let rec _lh_listcomp_fun_1 = (fun _lh_listcomp_fun_para_1 -> 
