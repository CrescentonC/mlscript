  ...
  (if (_lh_copy_arg1_0 <= 0) then
    ...
    (let rec t_2_4 = ((copy_lh__d4 (_lh_copy_arg1_0 - 1)) _lh_copy_arg2_0) in
      (let rec h_2_4 = _lh_copy_arg2_0 in
        (fun ys_4 -> 
          (let rec t_2_5 = ((mappend_lh__d1_d7 t_2_4) ys_4) in
  ...
  (if (_lh_copy_arg1_2 <= 0) then
    ...
    (let rec t_1_3_5 = ((copy_lh__d2 (_lh_copy_arg1_2 - 1)) _lh_copy_arg2_2) in
      (let rec h_1_3_5 = _lh_copy_arg2_2 in
        (fun ys_1_0_0 -> 
          (let rec t_1_3_6 = ((mappend_lh__d1_d6 t_1_3_5) ys_1_0_0) in
  ...
  (if (_lh_copy_arg1_3 <= 0) then
    ...
    (let rec t_1_3_9 = ((copy_lh__d3 (_lh_copy_arg1_3 - 1)) _lh_copy_arg2_3) in
      (let rec h_1_3_9 = _lh_copy_arg2_3 in
        (fun ys_1_0_3 -> 
          (let rec t_1_4_0 = ((mappend_lh__d9 t_1_3_9) ys_1_0_3) in
...
let rec enumFromTo_lh__d2 a_1 b_1 =
  (if (a_1 <= b_1) then
    ...
    (fun _lh_listcomp_fun_3_6 _lh_root_arg1_1 f_1 ys_7_6 xs_6 ys_7_7 -> 
      ys_7_7));;
...
let rec copy_lh__d1 _lh_copy_arg1_1 _lh_copy_arg2_1 =
  (if (_lh_copy_arg1_1 <= 0) then
    (fun f_4 hx_3 tx_3 xs_1_1 ys_8_4 -> 
      ys_8_4)
  else
    (let rec ty_2 = ((copy_lh__d1 (_lh_copy_arg1_1 - 1)) _lh_copy_arg2_1) in
      (let rec hy_2 = _lh_copy_arg2_1 in
        (fun f_5 hx_4 tx_4 -> 
          (let rec ty_3 = (((zipWith_lh__d1 f_5) tx_4) ty_2) in
            (let rec hy_3 = ((f_5 hx_4) hy_2) in
              (fun xs_1_2 -> 
