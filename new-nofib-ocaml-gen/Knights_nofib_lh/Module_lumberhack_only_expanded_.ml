...
let rec foldr_lh__d1 f_5 i_1 ls_1_1 =
  (match ls_1_1 with
    ...
    | `LH_N -> 
      i_1);;
let rec foldr_lh__d2 f_4 i_0 ls_9 =
  (match ls_9 with
    | `LH_C(h_2_9, t_2_9) -> 
      ((f_4 h_2_9) (((foldr_lh__d2 f_4) i_0) t_2_9))
    | `LH_N -> 
      i_0);;
...
let rec mappend_lh__d1 xs_2_2 ys_2_2 =
  (match xs_2_2 with
    | `LH_C(h_2_6, t_2_6) -> 
      (`LH_C(h_2_6, ((mappend_lh__d1 t_2_6) ys_2_2)))
    | `LH_N -> 
      ys_2_2);;
...
let rec mappend_lh__d5 xs_1_5 ys_1_5 =
  (match xs_1_5 with
    | `LH_C(h_1_9, t_1_9) -> 
      (`LH_C(h_1_9, ((mappend_lh__d5 t_1_9) ys_1_5)))
    | `LH_N -> 
      ys_1_5);;
...
let rec depthSearch_lh__d1 _lh_depthSearch_arg1_0 _lh_depthSearch_arg2_0 _lh_depthSearch_arg3_0 =
  (if (let rec _lh_matchIdent_0 = _lh_depthSearch_arg1_0 in
    ...
    (if (_lh_depthSearch_arg3_0 (inquireFront_lh__d1 _lh_depthSearch_arg1_0)) then
      (lazy (`LH_C((inquireFront_lh__d2 _lh_depthSearch_arg1_0), (((depthSearch_lh__d1 (removeFront_lh__d1 _lh_depthSearch_arg1_0)) _lh_depthSearch_arg2_0) _lh_depthSearch_arg3_0))))
    else
...
let rec enumFromTo_lh__d1 a_1 b_1 =
  (if (a_1 <= b_1) then
    ...
    (`LH_N));;
let rec zipWith_lh__d1 f_2 xs_1_6 ys_1_6 =
  (match xs_1_6 with
    | `LH_C(hx_0, tx_0) -> 
      (match ys_1_6 with
        | `LH_C(hy_0, ty_0) -> 
          (`LH_C(((f_2 hx_0) hy_0), (((zipWith_lh__d1 f_2) tx_0) ty_0)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N));;
let rec zip_lz_nl_lh__d2 xs_1_7 ys_1_7 =
  (match ys_1_7 with
    | `LH_C(hy_1, ty_1) -> 
      (match (Lazy.force xs_1_7) with
        | `LH_C(hx_1, tx_1) -> 
          (`LH_C((`LH_P2(hx_1, hy_1)), ((zip_lz_nl_lh__d2 tx_1) ty_1)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N));;
...
let rec take_lz_lh__d1 n_0 ls_7 =
  (if (n_0 > 0) then
    (match (Lazy.force ls_7) with
      | `LH_C(h_2_7, t_2_7) -> 
        (`LH_C(h_2_7, ((take_lz_lh__d1 (n_0 - 1)) t_2_7)))
      | `LH_N -> 
        (`LH_N))
  else
    (`LH_N));;
  ...
  (let rec _lh_listcomp_fun_5 = (fun _lh_listcomp_fun_para_5 -> 
    (match _lh_listcomp_fun_para_5 with
      | `LH_C(_lh_listcomp_fun_ls_h_5, _lh_listcomp_fun_ls_t_5) -> 
        (`LH_C((`LH_P2((length_lh__d4 (possibleMoves_lh__d1 (deleteFirst_lh__d3 _lh_listcomp_fun_ls_h_5))), _lh_listcomp_fun_ls_h_5)), (_lh_listcomp_fun_5 _lh_listcomp_fun_ls_t_5)))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_5 (allDescend_lh__d1 _lh_descAndNo_arg1_1)));;
let rec map_lh__d2 f_1 ls_4 =
  (match ls_4 with
    | `LH_C(h_2_0, t_2_0) -> 
      ...
      ((mappend_lh__d1_d9 ((mappend_lh__d2_d0 (quickSortIntChessSet_lh__d1 (let rec _lh_listcomp_fun_7 = (fun _lh_listcomp_fun_para_7 -> 
        (match _lh_listcomp_fun_para_7 with
          | `LH_C(_lh_listcomp_fun_ls_h_7, _lh_listcomp_fun_ls_t_7) -> 
            (if ((intChessSetComp_lh__d1 _lh_listcomp_fun_ls_h_7) _lh_quickSortIntChessSet_LH_C_0_0) then
        ...
        (match _lh_listcomp_fun_para_8 with
          | `LH_C(_lh_listcomp_fun_ls_h_8, _lh_listcomp_fun_ls_t_8) -> 
            (if (not ((intChessSetComp_lh__d2 _lh_listcomp_fun_ls_h_8) _lh_quickSortIntChessSet_LH_C_0_0)) then
    ...
    | `LH_N -> 
      (if (_lh_printBoard_arg2_0 > (_lh_printBoard_arg1_0 * _lh_printBoard_arg1_0)) then
        ...
        (if ((_lh_printBoard_arg2_0 mod _lh_printBoard_arg1_0) <> 0) then
          ((mappend_lh__d9 ((mappend_lh__d1_d0 (`LH_C('*', (`LH_N)))) ((spaces_lh__d2 (_lh_printBoard_arg1_0 * _lh_printBoard_arg1_0)) 1))) (((printBoard_lh__d1 _lh_printBoard_arg1_0) (_lh_printBoard_arg2_0 + 1)) (`LH_N)))
        else
          (if ((_lh_printBoard_arg2_0 mod _lh_printBoard_arg1_0) = 0) then
      ...
      (match _lh_printBoard_LH_C_0_0 with
        | `LH_P2(_lh_printBoard_LH_P2_0_0, _lh_printBoard_LH_P2_1_0) -> 
          (if ((_lh_printBoard_LH_P2_0_0 = _lh_printBoard_arg2_0) && ((_lh_printBoard_arg2_0 mod _lh_printBoard_arg1_0) = 0)) then
            ((mappend_lh__d1_d3 ((mappend_lh__d1_d8 (string_of_int _lh_printBoard_LH_P2_1_0)) (`LH_C('|', (`LH_N))))) (((printBoard_lh__d1 _lh_printBoard_arg1_0) (_lh_printBoard_arg2_0 + 1)) _lh_printBoard_LH_C_1_0))
          else
            (if ((_lh_printBoard_LH_P2_0_0 = _lh_printBoard_arg2_0) && ((_lh_printBoard_arg2_0 mod _lh_printBoard_arg1_0) <> 0)) then
              ...
              (if ((_lh_printBoard_arg2_0 mod _lh_printBoard_arg1_0) <> 0) then
                ((mappend_lh__d1_d6 ((mappend_lh__d1_d1 (`LH_C('*', (`LH_N)))) ((spaces_lh__d1 (_lh_printBoard_arg1_0 * _lh_printBoard_arg1_0)) 1))) (((printBoard_lh__d1 _lh_printBoard_arg1_0) (_lh_printBoard_arg2_0 + 1)) (`LH_C((`LH_P2(_lh_printBoard_LH_P2_0_0, _lh_printBoard_LH_P2_1_0)), _lh_printBoard_LH_C_1_0))))
              else
                (if ((_lh_printBoard_arg2_0 mod _lh_printBoard_arg1_0) = 0) then
                  ((mappend_lh__d1_d4 (`LH_C('*', (`LH_C('|', (`LH_N)))))) (((printBoard_lh__d1 _lh_printBoard_arg1_0) (_lh_printBoard_arg2_0 + 1)) (`LH_C((`LH_P2(_lh_printBoard_LH_P2_0_0, _lh_printBoard_LH_P2_1_0)), _lh_printBoard_LH_C_1_0))))
                else
...
let rec quickSortIntInt_lh__d1 _lh_quickSortIntInt_arg1_0 =
  (match _lh_quickSortIntInt_arg1_0 with
    ...
    | `LH_C(_lh_quickSortIntInt_LH_C_0_0, _lh_quickSortIntInt_LH_C_1_0) -> 
      ((mappend_lh__d7 ((mappend_lh__d8 (quickSortIntInt_lh__d1 (let rec _lh_listcomp_fun_9 = (fun _lh_listcomp_fun_para_9 -> 
