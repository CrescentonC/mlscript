...
let rec snd_lh__d1 _lh_snd_arg1_0 =
  (match _lh_snd_arg1_0 with
    | `LH_P2(_lh_snd_LH_P2_0_0, _lh_snd_LH_P2_1_0) -> 
      _lh_snd_LH_P2_1_0);;
let rec algb1_lh__d3 _lh_algb1_arg1_1 _lh_algb1_arg2_5 =
  (match _lh_algb1_arg1_1 with
    | `LH_N -> 
      ((map_lh__d1 snd_lh__d1) _lh_algb1_arg2_5)
    | `LH_C(_lh_algb1_LH_C_0_2, _lh_algb1_LH_C_1_2) -> 
      ((algb1_lh__d3 _lh_algb1_LH_C_1_2) ((((algb2_lh__d1 _lh_algb1_LH_C_0_2) 0) 0) _lh_algb1_arg2_5)));;
...
let rec findk_lh__d1 _lh_findk_arg1_8 _lh_findk_arg2_8 _lh_findk_arg3_8 _lh_findk_arg4_1 =
  (((_lh_findk_arg4_1 _lh_findk_arg2_8) _lh_findk_arg1_8) _lh_findk_arg3_8);;
...
let rec reverse_helper_lh__d1 ls_9 a_4 =
  (match ls_9 with
    | `LH_C(h_6, t_7) -> 
      ((reverse_helper_lh__d1 t_7) (let rec ty_0 = a_4 in
        (let rec hy_0 = h_6 in
          (fun hx_2 tx_2 -> 
            (let rec _lh_findk_LH_C_1_0 = ((zip_lh__d2 tx_2) ty_0) in
              (let rec _lh_findk_LH_C_0_0 = (let rec _lh_findk_LH_P2_1_0 = hy_0 in
                (let rec _lh_findk_LH_P2_0_0 = hx_2 in
                  (fun _lh_findk_LH_C_1_1 _lh_findk_arg1_3 _lh_findk_arg2_3 _lh_findk_arg3_3 -> 
                    (if ((_lh_findk_LH_P2_0_0 + _lh_findk_LH_P2_1_0) >= _lh_findk_arg3_3) then
                      ((((findk_lh__d1 (_lh_findk_arg1_3 + 1)) _lh_findk_arg1_3) (_lh_findk_LH_P2_0_0 + _lh_findk_LH_P2_1_0)) _lh_findk_LH_C_1_1)
                    else
                      ((((findk_lh__d1 (_lh_findk_arg1_3 + 1)) _lh_findk_arg2_3) _lh_findk_arg3_3) _lh_findk_LH_C_1_1))))) in
                (fun _lh_findk_arg2_4 _lh_findk_arg1_4 _lh_findk_arg3_4 -> 
                  ((((_lh_findk_LH_C_0_0 _lh_findk_LH_C_1_0) _lh_findk_arg1_4) _lh_findk_arg2_4) _lh_findk_arg3_4))))))))
    | `LH_N -> 
      a_4);;
let rec reverse_lh__d1 ls_3 =
  ((reverse_helper_lh__d1 ls_3) (fun hx_0 tx_0 _lh_findk_arg2_1 _lh_findk_arg1_1 _lh_findk_arg3_1 -> 
    _lh_findk_arg2_1));;
let rec reverse_helper_lh__d2 ls_8 a_2 =
  (match ls_8 with
    | `LH_C(h_5, t_5) -> 
      ((reverse_helper_lh__d2 t_5) (let rec _lh_listcomp_fun_ls_t_1 = a_2 in
...
let rec reverse_lh__d2 ls_1_6 =
  ((reverse_helper_lh__d2 ls_1_6) (fun _lh_listcomp_fun_5 -> 
    (`LH_N)));;
      ...
      ((reverse_helper_lh__d5 t_0) (let rec _lh_algb1_LH_C_1_0 = a_0 in
        (let rec _lh_algb1_LH_C_0_0 = h_0 in
          (fun _lh_algb1_arg2_0 -> 
            ((algb1_lh__d2 _lh_algb1_LH_C_1_0) ((((algb2_lh__d1 _lh_algb1_LH_C_0_0) 0) 0) _lh_algb1_arg2_0))))))
    | `LH_N -> 
      a_0);;
let rec reverse_lh__d5 ls_4 =
  ((reverse_helper_lh__d5 ls_4) (fun _lh_algb1_arg2_2 -> 
    ((map_lh__d1 snd_lh__d1) _lh_algb1_arg2_2)));;
let rec algb1_lh__d1 _lh_algb1_arg1_2 _lh_algb1_arg2_6 =
  (_lh_algb1_arg1_2 _lh_algb1_arg2_6);;
let rec reverse_helper_lh__d3 ls_7 a_1 =
  (match ls_7 with
    | `LH_C(h_4, t_4) -> 
      ((reverse_helper_lh__d3 t_4) (let rec _lh_algb1_LH_C_1_1 = a_1 in
        (let rec _lh_algb1_LH_C_0_1 = h_4 in
          (fun _lh_algb1_arg2_4 -> 
            ((algb1_lh__d1 _lh_algb1_LH_C_1_1) ((((algb2_lh__d1 _lh_algb1_LH_C_0_1) 0) 0) _lh_algb1_arg2_4))))))
    | `LH_N -> 
      a_1);;
let rec reverse_lh__d3 ls_5 =
  ((reverse_helper_lh__d3 ls_5) (fun _lh_algb1_arg2_3 -> 
...
let rec reverse_helper_lh__d6 ls_1_1 a_5 =
  (match ls_1_1 with
    | `LH_C(h_7, t_8) -> 
      ((reverse_helper_lh__d6 t_8) (let rec ty_1 = a_5 in
        (let rec hy_1 = h_7 in
          (fun hx_4 tx_4 -> 
            (let rec _lh_findk_LH_C_1_2 = ((zip_lh__d1 tx_4) ty_1) in
...
let rec reverse_lh__d6 ls_1_0 =
  ((reverse_helper_lh__d6 ls_1_0) (fun hx_3 tx_3 _lh_findk_arg2_5 _lh_findk_arg1_5 _lh_findk_arg3_5 -> 
    _lh_findk_arg2_5));;
let rec algb_lh__d1 _lh_algb_arg1_1 _lh_algb_arg2_1 =
  (`LH_C(0, ((algb1_lh__d1 _lh_algb_arg1_1) (let rec _lh_listcomp_fun_2 = (fun _lh_listcomp_fun_para_1 -> 
    (_lh_listcomp_fun_para_1 _lh_listcomp_fun_2)) in
    (_lh_listcomp_fun_2 _lh_algb_arg2_1)))));;
let rec algb_lh__d4 _lh_algb_arg1_2 _lh_algb_arg2_2 =
  (`LH_C(0, ((algb1_lh__d3 _lh_algb_arg1_2) (let rec _lh_listcomp_fun_3 = (fun _lh_listcomp_fun_para_2 -> 
    (match _lh_listcomp_fun_para_2 with
      | `LH_C(_lh_listcomp_fun_ls_h_2, _lh_listcomp_fun_ls_t_2) -> 
        (`LH_C((`LH_P2(_lh_listcomp_fun_ls_h_2, 0)), (_lh_listcomp_fun_3 _lh_listcomp_fun_ls_t_2)))
      | `LH_N -> 
        (`LH_N))) in
    (_lh_listcomp_fun_3 _lh_algb_arg2_2)))));;
...
let rec reverse_helper_lh__d4 ls_1_5 a_7 =
  (match ls_1_5 with
    | `LH_C(h_1_1, t_1_3) -> 
      ((reverse_helper_lh__d4 t_1_3) (let rec _lh_listcomp_fun_ls_t_3 = a_7 in
        (let rec _lh_listcomp_fun_ls_h_3 = h_1_1 in
          (fun _lh_listcomp_fun_4 -> 
            (`LH_C((`LH_P2(_lh_listcomp_fun_ls_h_3, 0)), (_lh_listcomp_fun_4 _lh_listcomp_fun_ls_t_3)))))))
    | `LH_N -> 
      a_7);;
let rec reverse_lh__d4 ls_1_7 =
  ((reverse_helper_lh__d4 ls_1_7) (fun _lh_listcomp_fun_6 -> 
    (`LH_N)));;
          ...
          (match _lh_algc_LH_C_1_0 with
            ...
            | _ -> 
              (let rec m2_0 = (_lh_algc_arg1_0 / 2) in
                (let rec xs1_0 = ((take_lh__d4 m2_0) _lh_algc_arg3_0) in
                  (let rec xs2_0 = ((drop_lh__d1 m2_0) _lh_algc_arg3_0) in
                    (let rec l1_0 = ((algb_lh__d4 xs1_0) _lh_algc_arg4_0) in
                      (let rec l2_0 = (reverse_lh__d6 ((algb_lh__d2 (reverse_lh__d5 xs2_0)) (reverse_lh__d4 _lh_algc_arg4_0))) in
                        (let rec k_0 = ((((findk_lh__d2 0) 0) (0 - 1)) ((zip_lh__d1 l1_0) l2_0)) in
                          (((((algc_lh__d1 m2_0) k_0) xs1_0) ((take_lh__d2 k_0) _lh_algc_arg4_0)) (((((algc_lh__d1 (_lh_algc_arg1_0 - m2_0)) (_lh_algc_arg2_0 - k_0)) xs2_0) ((drop_lh__d4 k_0) _lh_algc_arg4_0)) _lh_floatOutId_0_3)))))))))
        | _ -> 
          (let rec m2_1 = (_lh_algc_arg1_0 / 2) in
            (let rec xs1_1 = ((take_lh__d1 m2_1) _lh_algc_arg3_0) in
              (let rec xs2_1 = ((drop_lh__d3 m2_1) _lh_algc_arg3_0) in
                (let rec l1_1 = ((algb_lh__d3 xs1_1) _lh_algc_arg4_0) in
                  (let rec l2_1 = (reverse_lh__d1 ((algb_lh__d1 (reverse_lh__d3 xs2_1)) (reverse_lh__d2 _lh_algc_arg4_0))) in
                    (let rec k_1 = ((((findk_lh__d1 0) 0) (0 - 1)) ((zip_lh__d2 l1_1) l2_1)) in
                      (((((algc_lh__d1 m2_1) k_1) xs1_1) ((take_lh__d3 k_1) _lh_algc_arg4_0)) (((((algc_lh__d1 (_lh_algc_arg1_0 - m2_1)) (_lh_algc_arg2_0 - k_1)) xs2_1) ((drop_lh__d2 k_1) _lh_algc_arg4_0)) _lh_floatOutId_0_3))))))))));;
...
let rec lcss_lh__d1 _lh_lcss_arg1_0 _lh_lcss_arg2_0 =
  (((((algc_lh__d1 (length_lh__d1 _lh_lcss_arg1_0)) (length_lh__d2 _lh_lcss_arg2_0)) _lh_lcss_arg1_0) _lh_lcss_arg2_0) (`LH_N));;
