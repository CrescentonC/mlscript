...
let rec algb_lh__d3 _lh_algb_arg1_0 _lh_algb_arg2_0 =
  (`LH_C(0, ((algb1_lh__d3 _lh_algb_arg1_0) (let rec _lh_listcomp_fun_1 = (fun _lh_listcomp_fun_para_0 -> 
    (_lh_listcomp_fun_para_0 _lh_listcomp_fun_1)) in
    (_lh_listcomp_fun_1 _lh_algb_arg2_0)))));;
...
let rec drop_lh__d1 _lh_drop_arg1_1 _lh_drop_arg2_1 =
  (if (_lh_drop_arg1_1 <= 0) then
    ...
    (let rec _lh_matchIdent_1 = _lh_drop_arg2_1 in
  ...
  (match xs_0 with
    ...
    | `LH_N -> 
      (fun _lh_findk_arg2_2 _lh_findk_arg1_2 _lh_findk_arg3_2 -> 
        _lh_findk_arg2_2));;
let rec findk_lh__d1 _lh_findk_arg1_5 _lh_findk_arg2_5 _lh_findk_arg3_5 _lh_findk_arg4_1 =
  (((_lh_findk_arg4_1 _lh_findk_arg2_5) _lh_findk_arg1_5) _lh_findk_arg3_5);;
  ...
  (match ls_9 with
    | `LH_C(h_6, t_7) -> 
      ((reverse_helper_lh__d1 t_7) (let rec ty_0 = a_4 in
        (let rec hy_0 = h_6 in
          (fun hx_2 tx_2 -> 
            (let rec _lh_findk_LH_C_1_0 = ((zip_lh__d1 tx_2) ty_0) in
...
let rec reverse_helper_lh__d5 ls_0 a_0 =
  (match ls_0 with
    | `LH_C(h_0, t_0) -> 
      ((reverse_helper_lh__d5 t_0) (let rec _lh_listcomp_fun_ls_t_0 = a_0 in
...
let rec reverse_lh__d5 ls_4 =
  ((reverse_helper_lh__d5 ls_4) (fun _lh_listcomp_fun_2 -> 
    (`LH_N)));;
      ...
      ((reverse_helper_lh__d3 t_4) (let rec _lh_algb1_LH_C_1_1 = a_1 in
        (let rec _lh_algb1_LH_C_0_1 = h_4 in
          (fun _lh_algb1_arg2_2 -> 
            ((algb1_lh__d1 _lh_algb1_LH_C_1_1) ((((algb2_lh__d1 _lh_algb1_LH_C_0_1) 0) 0) _lh_algb1_arg2_2))))))
    | `LH_N -> 
      a_1);;
let rec reverse_lh__d3 ls_5 =
  ((reverse_helper_lh__d3 ls_5) (fun _lh_algb1_arg2_1 -> 
...
let rec drop_lh__d2 _lh_drop_arg1_2 _lh_drop_arg2_2 =
  (if (_lh_drop_arg1_2 <= 0) then
    ...
    (let rec _lh_matchIdent_2 = _lh_drop_arg2_2 in
...
let rec reverse_helper_lh__d6 ls_1_1 a_5 =
  (match ls_1_1 with
    | `LH_C(h_7, t_8) -> 
      ((reverse_helper_lh__d6 t_8) (let rec _lh_listcomp_fun_ls_t_1 = a_5 in
        (let rec _lh_listcomp_fun_ls_h_1 = h_7 in
          (fun _lh_listcomp_fun_5 -> 
            (`LH_C((`LH_P2(_lh_listcomp_fun_ls_h_1, 0)), (_lh_listcomp_fun_5 _lh_listcomp_fun_ls_t_1)))))))
    | `LH_N -> 
      a_5);;
let rec reverse_lh__d6 ls_1_0 =
  ((reverse_helper_lh__d6 ls_1_0) (fun _lh_listcomp_fun_3 -> 
    (`LH_N)));;
let rec algb_lh__d1 _lh_algb_arg1_1 _lh_algb_arg2_1 =
  (`LH_C(0, ((algb1_lh__d1 _lh_algb_arg1_1) (let rec _lh_listcomp_fun_4 = (fun _lh_listcomp_fun_para_1 -> 
    (_lh_listcomp_fun_para_1 _lh_listcomp_fun_4)) in
    (_lh_listcomp_fun_4 _lh_algb_arg2_1)))));;
...
let rec drop_lh__d3 _lh_drop_arg1_3 _lh_drop_arg2_3 =
  (if (_lh_drop_arg1_3 <= 0) then
    ...
    (let rec _lh_matchIdent_3 = _lh_drop_arg2_3 in
    ...
    | `LH_C(h_1_1, t_1_3) -> 
      ((reverse_helper_lh__d4 t_1_3) (let rec ty_1 = a_7 in
        (let rec hy_1 = h_1_1 in
          (fun hx_4 tx_4 -> 
            (let rec _lh_findk_LH_C_1_2 = ((zip_lh__d2 tx_4) ty_1) in
              (let rec _lh_findk_LH_C_0_1 = (let rec _lh_findk_LH_P2_1_1 = hy_1 in
                (let rec _lh_findk_LH_P2_0_1 = hx_4 in
                  (fun _lh_findk_LH_C_1_3 _lh_findk_arg1_7 _lh_findk_arg2_7 _lh_findk_arg3_7 -> 
                    (if ((_lh_findk_LH_P2_0_1 + _lh_findk_LH_P2_1_1) >= _lh_findk_arg3_7) then
                      ((((findk_lh__d2 (_lh_findk_arg1_7 + 1)) _lh_findk_arg1_7) (_lh_findk_LH_P2_0_1 + _lh_findk_LH_P2_1_1)) _lh_findk_LH_C_1_3)
                    else
                      ((((findk_lh__d2 (_lh_findk_arg1_7 + 1)) _lh_findk_arg2_7) _lh_findk_arg3_7) _lh_findk_LH_C_1_3))))) in
                (fun _lh_findk_arg2_8 _lh_findk_arg1_8 _lh_findk_arg3_8 -> 
                  ((((_lh_findk_LH_C_0_1 _lh_findk_LH_C_1_2) _lh_findk_arg1_8) _lh_findk_arg2_8) _lh_findk_arg3_8))))))))
    | `LH_N -> 
      a_7);;
            ...
            | _ -> 
              (let rec m2_0 = (_lh_algc_arg1_0 / 2) in
                (let rec xs1_0 = ((take_lh__d4 m2_0) _lh_algc_arg3_0) in
                  (let rec xs2_0 = ((drop_lh__d4 m2_0) _lh_algc_arg3_0) in
                    (let rec l1_0 = ((algb_lh__d4 xs1_0) _lh_algc_arg4_0) in
                      (let rec l2_0 = (reverse_lh__d4 ((algb_lh__d1 (reverse_lh__d3 xs2_0)) (reverse_lh__d6 _lh_algc_arg4_0))) in
                        (let rec k_0 = ((((findk_lh__d2 0) 0) (0 - 1)) ((zip_lh__d2 l1_0) l2_0)) in
                          (((((algc_lh__d1 m2_0) k_0) xs1_0) ((take_lh__d2 k_0) _lh_algc_arg4_0)) (((((algc_lh__d1 (_lh_algc_arg1_0 - m2_0)) (_lh_algc_arg2_0 - k_0)) xs2_0) ((drop_lh__d2 k_0) _lh_algc_arg4_0)) _lh_floatOutId_0_3)))))))))
        | _ -> 
          (let rec m2_1 = (_lh_algc_arg1_0 / 2) in
            (let rec xs1_1 = ((take_lh__d3 m2_1) _lh_algc_arg3_0) in
              (let rec xs2_1 = ((drop_lh__d3 m2_1) _lh_algc_arg3_0) in
                (let rec l1_1 = ((algb_lh__d2 xs1_1) _lh_algc_arg4_0) in
                  (let rec l2_1 = (reverse_lh__d1 ((algb_lh__d3 (reverse_lh__d2 xs2_1)) (reverse_lh__d5 _lh_algc_arg4_0))) in
                    (let rec k_1 = ((((findk_lh__d1 0) 0) (0 - 1)) ((zip_lh__d1 l1_1) l2_1)) in
                      (((((algc_lh__d1 m2_1) k_1) xs1_1) ((take_lh__d1 k_1) _lh_algc_arg4_0)) (((((algc_lh__d1 (_lh_algc_arg1_0 - m2_1)) (_lh_algc_arg2_0 - k_1)) xs2_1) ((drop_lh__d1 k_1) _lh_algc_arg4_0)) _lh_floatOutId_0_3))))))))));;
