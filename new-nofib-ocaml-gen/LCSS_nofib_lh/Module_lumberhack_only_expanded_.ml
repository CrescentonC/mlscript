...
let rec inList_lh__d1 _lh_inList_arg1_0 _lh_inList_arg2_0 =
  (match _lh_inList_arg2_0 with
    ...
    | `LH_N -> 
      false);;
let rec take_lh__d2 n_2 ls_1_4 =
  (if (n_2 > 0) then
    (match ls_1_4 with
      | `LH_C(h_9, t_9) -> 
...
let rec take_lh__d3 n_1 ls_1_0 =
  (if (n_1 > 0) then
    (match ls_1_0 with
      | `LH_C(h_8, t_8) -> 
...
let rec reverse_lh__d2 ls_1_3 =
  ((reverse_helper_lh__d2 ls_1_3) (`LH_N));;
let rec reverse_helper_lh__d5 ls_2 a_1 =
  (match ls_2 with
    ...
    | `LH_N -> 
      a_1);;
let rec reverse_lh__d5 ls_9 =
  ((reverse_helper_lh__d5 ls_9) (`LH_N));;
let rec reverse_helper_lh__d3 ls_4 a_3 =
  (match ls_4 with
    ...
    | `LH_N -> 
      a_3);;
let rec reverse_lh__d3 ls_1_2 =
  ((reverse_helper_lh__d3 ls_1_2) (`LH_N));;
...
let rec reverse_helper_lh__d6 ls_1 a_0 =
  (match ls_1 with
    ...
    | `LH_N -> 
      a_0);;
let rec reverse_lh__d6 ls_8 =
  ((reverse_helper_lh__d6 ls_8) (`LH_N));;
...
let rec take_lh__d1 n_3 ls_1_5 =
  (if (n_3 > 0) then
    (match ls_1_5 with
      | `LH_C(h_1_0, t_1_0) -> 
...
let rec reverse_helper_lh__d4 ls_3 a_2 =
  (match ls_3 with
    ...
    | `LH_N -> 
      a_2);;
let rec reverse_lh__d4 ls_1_1 =
  ((reverse_helper_lh__d4 ls_1_1) (`LH_N));;
