...
let rec mappend_lh__d1 xs_3 ys_3 =
  (match xs_3 with
    | `LH_C(h_2_1, t_2_1) -> 
      (`LH_C(h_2_1, ((mappend_lh__d1 t_2_1) ys_3)))
    | `LH_N -> 
      ys_3);;
...
let rec foldr_lh__d1 f_7 i_0 ls_1_2 =
  (match ls_1_2 with
    | `LH_C(h_1_4, t_1_4) -> 
      ((f_7 h_1_4) (((foldr_lh__d1 f_7) i_0) t_1_4))
    | `LH_N -> 
      i_0);;
...
let rec mappend_lh__d4 xs_0 ys_0 =
  (match xs_0 with
    | `LH_C(h_1_5, t_1_5) -> 
      (`LH_C(h_1_5, ((mappend_lh__d4 t_1_5) ys_0)))
    | `LH_N -> 
      ys_0);;
...
let rec concat_lh__d2 lss_0 =
  (match lss_0 with
    | `LH_C(h_2, t_2) -> 
      ((mappend_lh__d4 h_2) (concat_lh__d2 t_2))
    | `LH_N -> 
      (`LH_N));;
...
let rec map_lh__d3 f_1 ls_1 =
  (match ls_1 with
    | `LH_C(h_1, t_1) -> 
      (`LH_C((f_1 h_1), ((map_lh__d3 f_1) t_1)))
    | `LH_N -> 
      (`LH_N));;
...
let rec map_lz_lh__d2 f_5 ls_7 =
  (lazy (match (Lazy.force ls_7) with
    | `LH_C(h_9, t_9) -> 
      (`LH_C((f_5 h_9), ((map_lz_lh__d2 f_5) t_9)))
    | `LH_N -> 
      (`LH_N)));;
              ...
              (let rec _lh_matchIdent_8 = ((hinsert_lh__d1 ((hash_lh__d1 newCharAssocs_0) (`K(_lh_findhash'_K_0_0, _lh_findhash'_K_1_0, _lh_findhash'_K_2_0, _lh_findhash'_K_3_0)))) _lh_findhash'_arg1_0) in
                (match _lh_matchIdent_8 with
                  ...
                  | `Just(_lh_findhash'_Just_0_0) -> 
                    (((findhash'_lh__d1 _lh_findhash'_Just_0_0) newCharAssocs_0) _lh_findhash'_LH_C_1_0))))) in
                              ...
                              (let rec _lh_matchIdent_1_0 = mn_0 in
                                (match _lh_matchIdent_1_0 with
                                  | `LH_P2(_lh_findhash'_LH_P2_0_1, _lh_findhash'_LH_P2_1_1) -> 
                                    (try_0 (`LH_C((`LH_P2(_lh_findhash'_K_1_0, _lh_findhash'_LH_P2_0_1)), (`LH_C((`LH_P2(_lh_findhash'_K_2_0, _lh_findhash'_LH_P2_1_1)), (`LH_N)))))))))) (let rec _lh_listcomp_fun_1 = (fun _lh_listcomp_fun_para_1 -> 
                              (match (Lazy.force _lh_listcomp_fun_para_1) with
                                | `LH_C(_lh_listcomp_fun_ls_h_1, _lh_listcomp_fun_ls_t_1) -> 
                                  (let rec _lh_listcomp_fun_2 = (fun _lh_listcomp_fun_para_2 -> 
                                    ...
                                    (_lh_listcomp_fun_2 ((enumFromTo_lz_lh__d1 0) maxval_lh__d2)))
                                | `LH_N -> 
                                  (lazy (`LH_N)))) in
                              (_lh_listcomp_fun_1 ((enumFromTo_lz_lh__d3 0) maxval_lh__d4)))))
                      ...
                      (match _lh_findhash'_LH_P2_1_0 with
                        | `Nothing -> 
                          ((firstSuccess_lh__d1 (fun n_0 -> 
                            (try_0 (`LH_C((`LH_P2(_lh_findhash'_K_2_0, n_0)), (`LH_N)))))) ((enumFromTo_lz_lh__d5 0) maxval_lh__d3))
...
let rec take_lh__d1 n_1 ls_1_6 =
  (if (n_1 > 0) then
    (match ls_1_6 with
      | `LH_C(h_2_2, t_2_2) -> 
        (`LH_C(h_2_2, ((take_lh__d1 (n_1 - 1)) t_2_2)))
      | `LH_N -> 
        (`LH_N))
  else
    (`LH_N));;
  ...
  ((mappend_lh__d4 _lh_union_arg1_0) (let rec _lh_listcomp_fun_0 = (fun _lh_listcomp_fun_para_0 -> 
    (match _lh_listcomp_fun_para_0 with
      | `LH_C(_lh_listcomp_fun_ls_h_0, _lh_listcomp_fun_ls_t_0) -> 
        (if (not ((member_lh__d1 _lh_listcomp_fun_ls_h_0) _lh_union_arg1_0)) then
