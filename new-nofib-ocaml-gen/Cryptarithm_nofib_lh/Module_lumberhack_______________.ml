...
let rec enumFromTo_lh__d2 a_0 b_0 =
  (if (a_0 <= b_0) then
    (let rec t_0 = ((enumFromTo_lh__d2 (a_0 + 1)) b_0) in
      (let rec h_0 = a_0 in
        (fun n_0 -> 
          (let rec _lh_permutations_LH_C_1_0 = ((take_lh__d1 (n_0 - 1)) t_0) in
              ...
              (fun _lh_dummy_0 -> 
                (let rec _lh_listcomp_fun_0 = (fun _lh_listcomp_fun_para_0 -> 
                  (match _lh_listcomp_fun_para_0 with
                    ...
                    | `LH_N -> 
                      (`LH_N))) in
                  (_lh_listcomp_fun_0 (permutations_lh__d1 _lh_permutations_LH_C_1_0)))))))))
  else
    (fun n_1 _lh_dummy_1 -> 
      (`LH_C((`LH_N), (`LH_N)))));;
