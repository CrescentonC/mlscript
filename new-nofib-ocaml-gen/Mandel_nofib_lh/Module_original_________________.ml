...
let rec map_lh f_0 ls_0 =
  (match ls_0 with
    ...
    | `LH_N -> 
      (`LH_N));;
let rec take_lz_lz_lh _lh_take_lz_lz_arg1_0 _lh_take_lz_lz_arg2_0 =
...
let rec mandelset_lh _lh_mandelset_arg1_0 _lh_mandelset_arg2_0 _lh_mandelset_arg3_0 _lh_mandelset_arg4_0 _lh_mandelset_arg5_0 _lh_mandelset_arg6_0 _lh_mandelset_arg7_0 =
  (let rec prettyRGB_0 = (fun s_0 -> 
    (let rec t_2 = (_lh_mandelset_arg7_0 - s_0) in
      (`LH_P3(s_0, t_2, t_2)))) in
    (let rec windowToViewport_0 = (fun s_1 t_3 -> 
      (`Complex((_lh_mandelset_arg1_0 +. (((float_of_int s_1) *. (_lh_mandelset_arg3_0 -. _lh_mandelset_arg1_0)) /. (float_of_int _lh_mandelset_arg5_0))), (_lh_mandelset_arg2_0 +. (((float_of_int t_3) *. (_lh_mandelset_arg4_0 -. _lh_mandelset_arg2_0)) /. (float_of_int _lh_mandelset_arg6_0)))))) in
