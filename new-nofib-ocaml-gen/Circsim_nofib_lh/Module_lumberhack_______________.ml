  ...
  (if (_lh_copy_arg1_0 > 0) then
    (let rec _lh_scanl_LH_C_1_0 = ((copy_lh__d1 (_lh_copy_arg1_0 - 1)) _lh_copy_arg2_0) in
      (let rec _lh_scanl_LH_C_0_0 = _lh_copy_arg2_0 in
        (fun _lh_scanl_arg1_0 _lh_scanl_arg2_0 -> 
  ...
  (if (_lh_copy_arg1_1 > 0) then
    (let rec ty_7 = ((copy_lh__d2 (_lh_copy_arg1_1 - 1)) _lh_copy_arg2_1) in
      (let rec hy_7 = _lh_copy_arg2_1 in
        (fun hx_6 tx_6 -> 
          (let rec _lh_listcomp_fun_ls_t_9 = ((zip_lh__d1 tx_6) ty_7) in
            (let rec _lh_listcomp_fun_ls_h_9 = (let rec _lh_store_inputs_LH_P2_1_0 = hy_7 in
              ...
              (fun _lh_listcomp_fun_1_3 _lh_store_inputs_PS_0_2 _lh_store_inputs_PS_2_2 _lh_store_inputs_PS_3_2 _lh_store_inputs_PS_4_2 -> 
                ((((((_lh_listcomp_fun_ls_h_9 _lh_listcomp_fun_ls_t_9) _lh_listcomp_fun_1_3) _lh_store_inputs_PS_0_2) _lh_store_inputs_PS_2_2) _lh_store_inputs_PS_3_2) _lh_store_inputs_PS_4_2)))))))
  else
...
let rec foldl_lh__d1 f_4 i_0 ls_2 =
  ((ls_2 f_4) i_0);;
let rec enumFromTo_lh__d4 a_2 b_0 =
  (if (a_2 <= b_0) then
    (let rec t_8 = ((enumFromTo_lh__d4 (a_2 + 1)) b_0) in
      (let rec h_8 = a_2 in
        (fun f_9 i_1 -> 
          (((foldl_lh__d1 f_9) ((f_9 i_1) h_8)) t_8))))
  else
    (fun f_1_0 i_2 -> 
      i_2));;
...
let rec map_lh__d1_d7 f_4_1 ls_2_6 =
  (match ls_2_6 with
    | `LH_C(h_2_9, t_2_9) -> 
      (let rec t_3_0 = ((map_lh__d1_d7 f_4_1) t_2_9) in
        (let rec h_3_0 = (f_4_1 h_2_9) in
          (fun f_4_2 -> 
            (`LH_C((f_4_2 h_3_0), ((map_lh__d1_d8 f_4_2) t_3_0))))))
    | `LH_N -> 
      (fun f_4_3 -> 
        (`LH_N)));;
...
let rec or_lh__d3 _lh_or_arg1_0 =
  (_lh_or_arg1_0 99);;
let rec map_lh__d1_d5 f_1 ls_1 =
  (match ls_1 with
    | `LH_C(h_1, t_1) -> 
      (let rec t_2 = ((map_lh__d1_d5 f_1) t_1) in
        (let rec h_2 = (f_1 h_1) in
          (fun f_2 -> 
            (let rec _lh_or_LH_C_1_0 = ((map_lh__d1_d4 f_2) t_2) in
              (let rec _lh_or_LH_C_0_0 = (f_2 h_2) in
                (fun _lh_dummy_0 -> 
...
let rec map_lh__d1_d6 f_4_8 ls_2_8 =
  (match ls_2_8 with
    | `LH_C(h_3_3, t_3_3) -> 
...
let rec map_lh__d1_d3 f_1_4 ls_9 =
  (ls_9 f_1_4);;
let rec map_lh__d1_d1 f_6 ls_5 =
  (match ls_5 with
    | `LH_C(h_6, t_6) -> 
      (let rec t_7 = ((map_lh__d1_d1 f_6) t_6) in
        (let rec h_7 = (f_6 h_6) in
          (fun f_7 -> 
            (`LH_C((f_7 h_7), ((map_lh__d1_d3 f_7) t_7))))))
    | `LH_N -> 
      (fun f_8 -> 
        (`LH_N)));;
...
let rec map_lh__d9 f_0 ls_0 =
  (ls_0 f_0);;
let rec map_lh__d1_d0 f_4_4 ls_2_7 =
  (match ls_2_7 with
    | `LH_C(h_3_1, t_3_1) -> 
...
let rec maximum_lh__d1 _lh_maximum_arg1_0 =
  (match _lh_maximum_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec enumFromTo_lh__d2 a_3 b_1 =
  (if (a_3 <= b_1) then
    (let rec _lh_listcomp_fun_ls_t_3 = ((enumFromTo_lh__d2 (a_3 + 1)) b_1) in
      (let rec _lh_listcomp_fun_ls_h_3 = a_3 in
        (fun _lh_listcomp_fun_4 -> 
          (let rec ty_1 = (_lh_listcomp_fun_4 _lh_listcomp_fun_ls_t_3) in
            (let rec hy_1 = ((7 * _lh_listcomp_fun_ls_h_3) + 7) in
              (fun f_1_6 xs_3 -> 
                ((((Lazy.force xs_3) f_1_6) hy_1) ty_1)))))))
  else
    (fun _lh_listcomp_fun_5 f_1_7 xs_4 -> 
      (`LH_N)));;
    ...
    (let rec _lh_listcomp_fun_ls_t_8 = ((enumFromTo_lh__d1 (a_5 + 1)) b_2) in
      (let rec _lh_listcomp_fun_ls_h_8 = a_5 in
        (fun _lh_listcomp_fun_1_0 -> 
          (let rec ty_4 = (_lh_listcomp_fun_1_0 _lh_listcomp_fun_ls_t_8) in
            (let rec hy_4 = ((7 * _lh_listcomp_fun_ls_h_8) + 1) in
              (fun f_2_7 xs_9 -> 
                ((((Lazy.force xs_9) f_2_7) hy_4) ty_4)))))))
  else
    (fun _lh_listcomp_fun_1_1 f_2_8 xs_1_0 -> 
      (`LH_N)));;
let rec concat_lh__d1 lss_0 =
  (lss_0 99);;
let rec enumFromTo_lh__d3 a_7 b_3 =
  (if (a_7 <= b_3) then
    (let rec _lh_listcomp_fun_ls_t_1_1 = ((enumFromTo_lh__d3 (a_7 + 1)) b_3) in
      (let rec _lh_listcomp_fun_ls_h_1_0 = a_7 in
        (fun _lh_listcomp_fun_1_5 -> 
          (let rec t_2_3 = (_lh_listcomp_fun_1_5 _lh_listcomp_fun_ls_t_1_1) in
            (let rec h_2_3 = ((7 * _lh_listcomp_fun_ls_h_1_0) + 1) in
              (fun f_3_5 -> 
                (let rec t_2_4 = ((map_lh__d1 f_3_5) t_2_3) in
                  (let rec h_2_4 = (f_3_5 h_2_3) in
                    (fun _lh_dummy_2 -> 
                      ((mappend_lh__d3 h_2_4) (concat_lh__d1 t_2_4)))))))))))
  else
    (fun _lh_listcomp_fun_1_6 f_3_6 _lh_dummy_3 -> 
      (`LH_N)));;
