  ...
  (if (_lh_copy_arg1_1 > 0) then
    (let rec ty_5 = ((copy_lh__d2 (_lh_copy_arg1_1 - 1)) _lh_copy_arg2_1) in
      (let rec hy_5 = _lh_copy_arg2_1 in
        (fun hx_5 tx_5 -> 
          (let rec _lh_listcomp_fun_ls_t_8 = ((zip_lh__d1 tx_5) ty_5) in
            (let rec _lh_listcomp_fun_ls_h_8 = (let rec _lh_store_inputs_LH_P2_1_0 = hy_5 in
              (let rec _lh_store_inputs_LH_P2_0_0 = hx_5 in
              ...
              (fun _lh_listcomp_fun_1_2 _lh_store_inputs_PS_0_2 _lh_store_inputs_PS_2_2 _lh_store_inputs_PS_3_2 _lh_store_inputs_PS_4_2 -> 
                ((((((_lh_listcomp_fun_ls_h_8 _lh_listcomp_fun_ls_t_8) _lh_listcomp_fun_1_2) _lh_store_inputs_PS_0_2) _lh_store_inputs_PS_2_2) _lh_store_inputs_PS_3_2) _lh_store_inputs_PS_4_2)))))))
  else
    (fun hx_6 tx_6 _lh_listcomp_fun_1_3 _lh_store_inputs_PS_0_3 _lh_store_inputs_PS_2_3 _lh_store_inputs_PS_3_3 _lh_store_inputs_PS_4_3 -> 
      (`LH_N)));;
...
let rec enumFromTo_lh__d4 a_2 b_0 =
  (if (a_2 <= b_0) then
    (let rec t_7 = ((enumFromTo_lh__d4 (a_2 + 1)) b_0) in
      (let rec h_7 = a_2 in
        (fun f_7 i_1 -> 
          (((foldl_lh__d1 f_7) ((f_7 i_1) h_7)) t_7))))
  else
    (fun f_8 i_2 -> 
      i_2));;
    ...
    | `LH_C(h_1, t_1) -> 
      (let rec t_2 = ((map_lh__d1_d5 f_1) t_1) in
        (let rec h_2 = (f_1 h_1) in
          (fun f_2 -> 
            (`LH_C((f_2 h_2), ((map_lh__d1_d6 f_2) t_2))))))
    | `LH_N -> 
      (fun f_3 -> 
        (`LH_N)));;
                              ...
                              (let rec _lh_matchIdent_1_4 = ((upsweep_lh__d1 _lh_upsweep_arg1_1) _lh_upsweep_Node_2_0) in
                                (match _lh_matchIdent_1_4 with
                                  | `LH_P2(_lh_upsweep_LH_P2_0_1, _lh_upsweep_LH_P2_1_1) -> 
                                    (`LH_P2(((_lh_upsweep_arg1_1 _lh_upsweep_LH_P2_0_0) _lh_upsweep_LH_P2_0_1), (let rec _lh_downsweep_Node_2_1 = _lh_upsweep_LH_P2_1_1 in
                          ...
                          (let rec _lh_matchIdent_1_8 = ((upsweep_lh__d1 _lh_upsweep_arg1_2) _lh_upsweep_Node_2_1) in
                            (match _lh_matchIdent_1_8 with
                              | `LH_P2(_lh_upsweep_LH_P2_0_3, _lh_upsweep_LH_P2_1_3) -> 
                                (`LH_P2(((_lh_upsweep_arg1_2 _lh_upsweep_LH_P2_0_2) _lh_upsweep_LH_P2_0_3), (let rec _lh_downsweep_Node_2_3 = _lh_upsweep_LH_P2_1_3 in
...
let rec or_lh__d4 _lh_or_arg1_2 =
  (_lh_or_arg1_2 99);;
let rec map_lh__d1_d8 f_2_8 ls_1_7 =
  (match ls_1_7 with
    | `LH_C(h_2_2, t_2_2) -> 
      (let rec t_2_3 = ((map_lh__d1_d8 f_2_8) t_2_2) in
        (let rec h_2_3 = (f_2_8 h_2_2) in
          (fun f_2_9 -> 
            (let rec _lh_or_LH_C_1_2 = ((map_lh__d1_d9 f_2_9) t_2_3) in
              (let rec _lh_or_LH_C_0_2 = (f_2_9 h_2_3) in
                (fun _lh_dummy_7 -> 
...
let rec map_lh__d1_d7 f_4_2 ls_2_6 =
  (match ls_2_6 with
    | `LH_C(h_3_2, t_3_2) -> 
...
let rec or_lh__d2 _lh_or_arg1_3 =
  (_lh_or_arg1_3 99);;
let rec map_lh__d1_d3 f_1_2 ls_9 =
  (match ls_9 with
    | `LH_C(h_1_0, t_1_0) -> 
      (let rec t_1_1 = ((map_lh__d1_d3 f_1_2) t_1_0) in
        (let rec h_1_1 = (f_1_2 h_1_0) in
          (fun f_1_3 -> 
            (let rec _lh_or_LH_C_1_1 = ((map_lh__d1_d2 f_1_3) t_1_1) in
              (let rec _lh_or_LH_C_0_1 = (f_1_3 h_1_1) in
                (fun _lh_dummy_2 -> 
...
let rec map_lh__d8 f_4_6 ls_2_9 =
  (match ls_2_9 with
    | `LH_C(h_3_3, t_3_3) -> 
      (let rec t_3_4 = ((map_lh__d8 f_4_6) t_3_3) in
        (let rec h_3_4 = (f_4_6 h_3_3) in
          (fun f_4_7 -> 
            (`LH_C((f_4_7 h_3_4), ((map_lh__d9 f_4_7) t_3_4))))))
    | `LH_N -> 
      (fun f_4_8 -> 
        (`LH_N)));;
    ...
    (let rec _lh_listcomp_fun_ls_t_3 = ((enumFromTo_lh__d2 (a_3 + 1)) b_1) in
      (let rec _lh_listcomp_fun_ls_h_3 = a_3 in
        (fun _lh_listcomp_fun_4 -> 
          (let rec ty_0 = (_lh_listcomp_fun_4 _lh_listcomp_fun_ls_t_3) in
            (let rec hy_0 = ((7 * _lh_listcomp_fun_ls_h_3) + 1) in
              (fun f_1_5 xs_3 -> 
                ((((Lazy.force xs_3) f_1_5) hy_0) ty_0)))))))
  else
    (fun _lh_listcomp_fun_5 f_1_6 xs_4 -> 
      (`LH_N)));;
    ...
    (let rec _lh_listcomp_fun_ls_t_7 = ((enumFromTo_lh__d1 (a_5 + 1)) b_2) in
      (let rec _lh_listcomp_fun_ls_h_7 = a_5 in
        (fun _lh_listcomp_fun_9 -> 
          (let rec t_2_0 = (_lh_listcomp_fun_9 _lh_listcomp_fun_ls_t_7) in
            (let rec h_2_0 = ((7 * _lh_listcomp_fun_ls_h_7) + 1) in
              (fun f_2_6 -> 
                (let rec t_2_1 = ((map_lh__d1 f_2_6) t_2_0) in
                  (let rec h_2_1 = (f_2_6 h_2_0) in
                    (fun _lh_dummy_5 -> 
                      ((mappend_lh__d3 h_2_1) (concat_lh__d1 t_2_1)))))))))))
  else
    (fun _lh_listcomp_fun_1_0 f_2_7 _lh_dummy_6 -> 
      (`LH_N)));;
    ...
    (let rec _lh_listcomp_fun_ls_t_1_0 = ((enumFromTo_lh__d3 (a_7 + 1)) b_3) in
      (let rec _lh_listcomp_fun_ls_h_9 = a_7 in
        (fun _lh_listcomp_fun_1_4 -> 
          (let rec ty_6 = (_lh_listcomp_fun_1_4 _lh_listcomp_fun_ls_t_1_0) in
            (let rec hy_6 = ((7 * _lh_listcomp_fun_ls_h_9) + 7) in
              (fun f_3_6 xs_1_1 -> 
                ((((Lazy.force xs_1_1) f_3_6) hy_6) ty_6)))))))
  else
    (fun _lh_listcomp_fun_1_5 f_3_7 xs_1_2 -> 
      (`LH_N)));;
