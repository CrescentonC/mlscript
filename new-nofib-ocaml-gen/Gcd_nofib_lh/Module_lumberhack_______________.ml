...
and
quotRem_lh__d1 _lh_quotRem_arg1_0 _lh_quotRem_arg2_0 =
  (let rec _lh_g_LH_P2_1_0 = ((Z.rem _lh_quotRem_arg1_0) _lh_quotRem_arg2_0) in
    (let rec _lh_g_LH_P2_0_0 = ((Z.div _lh_quotRem_arg1_0) _lh_quotRem_arg2_0) in
      (fun _lh_g_LH_P3_0_2 _lh_g_LH_P3_0_3 _lh_g_LH_P3_1_2 _lh_g_LH_P3_1_3 _lh_g_LH_P3_2_2 -> 
...
let rec gcdE_lh__d1 _lh_gcdE_arg1_0 _lh_gcdE_arg2_0 =
  (if ((Z.equal _lh_gcdE_arg1_0) const0_lh__d3) then
    (`LH_P3(_lh_gcdE_arg2_0, const0_lh__d5, const1_lh__d3))
  else
    ((g_lh__d1 (`LH_P3(const1_lh__d4, const0_lh__d6, _lh_gcdE_arg1_0))) (`LH_P3(const0_lh__d4, const1_lh__d5, _lh_gcdE_arg2_0))));;
...
let rec abs_lh__d1 _lh_abs_arg1_0 =
  (if ((Z.lt _lh_abs_arg1_0) const0_lh__d1) then
    ((Z.sub const0_lh__d2) _lh_abs_arg1_0)
  else
    _lh_abs_arg1_0);;
let rec z_enumFromTo_lh__d1 _lh_z_enumFromTo_arg1_0 _lh_z_enumFromTo_arg2_0 =
                        ...
                        (fun _lh_dummy_1 -> 
                          (match _lh_f2_LH_P3_2_0 with
                            | `LH_P3(_lh_f2_LH_P3_0_1, _lh_f2_LH_P3_1_1, _lh_f2_LH_P3_2_1) -> 
                              (abs_lh__d1 ((Z.add ((Z.add _lh_f2_LH_P3_0_1) _lh_f2_LH_P3_1_1)) _lh_f2_LH_P3_2_1)))))))))) in
              (fun f_0 -> 
...
let rec const1_lh__d2 =
  (Z.of_int 1);;
let rec z_enumFromTo_lh__d2 _lh_z_enumFromTo_arg1_1 _lh_z_enumFromTo_arg2_1 =
  (if ((Z.leq _lh_z_enumFromTo_arg1_1) _lh_z_enumFromTo_arg2_1) then
    ...
    (fun _lh_listcomp_fun_7 ms_2 f_2 f_3 -> 
      (`LH_N)));;
...
let rec test_lh__d1 _lh_test_arg1_0 =
  (let rec ns_0 = ((z_enumFromTo_lh__d2 const5000_lh__d1) ((Z.add const5000_lh__d2) _lh_test_arg1_0)) in
    (let rec ms_0 = ((z_enumFromTo_lh__d1 const10000_lh__d1) ((Z.add const10000_lh__d2) _lh_test_arg1_0)) in
      (let rec tripls_0 = ((map_lh__d1 f1_lh__d1) (let rec _lh_listcomp_fun_4 = (fun _lh_listcomp_fun_para_0 -> 
