...
let rec cadr_lh__d3 _lh_cadr_arg1_2 =
  ((fun _lh_funcomp_x_2 -> 
    (car_lh__d6 (cdr_lh__d3 _lh_funcomp_x_2))) _lh_cadr_arg1_2);;
let rec caddr_lh__d3 _lh_caddr_arg1_1 =
  ((fun _lh_funcomp_x_5 -> 
    ((fun _lh_funcomp_x_6 -> 
      (car_lh__d6 (cdr_lh__d3 _lh_funcomp_x_6))) (cdr_lh__d3 _lh_funcomp_x_5))) _lh_caddr_arg1_1);;
...
let rec onewayunify1_lh__d1 _lh_onewayunify1_arg1_0 _lh_onewayunify1_arg2_0 _lh_onewayunify1_arg3_0 =
  (if (atom_lh__d1 _lh_onewayunify1_arg2_0) then
    ...
    (if (atom_lh__d1 _lh_onewayunify1_arg1_0) then
      ...
      (if ((car_lh__d6 _lh_onewayunify1_arg1_0) = (car_lh__d6 _lh_onewayunify1_arg2_0)) then
        (((onewayunify1lst_lh__d1 (cdr_lh__d3 _lh_onewayunify1_arg1_0)) (cdr_lh__d3 _lh_onewayunify1_arg2_0)) _lh_onewayunify1_arg3_0)
      else
        (`LH_P2(false, _lh_onewayunify1_arg3_0)))))
and
onewayunify1lst_lh__d1 _lh_onewayunify1lst_arg1_0 _lh_onewayunify1lst_arg2_0 _lh_onewayunify1lst_arg3_0 =
  (match _lh_onewayunify1lst_arg1_0 with
    ...
    | _ -> 
      (let rec _lh_matchIdent_1_7 = (((onewayunify1_lh__d1 (car_lh__d6 _lh_onewayunify1lst_arg1_0)) (car_lh__d6 _lh_onewayunify1lst_arg2_0)) _lh_onewayunify1lst_arg3_0) in
        (match _lh_matchIdent_1_7 with
          | `LH_P2(_lh_onewayunify1lst_LH_P2_0_0, _lh_onewayunify1lst_LH_P2_1_0) -> 
            (if _lh_onewayunify1lst_LH_P2_0_0 then
              (((onewayunify1lst_lh__d1 (cdr_lh__d3 _lh_onewayunify1lst_arg1_0)) (cdr_lh__d3 _lh_onewayunify1lst_arg2_0)) _lh_onewayunify1lst_LH_P2_1_0)
            else
...
let rec applysubst_lh__d2 _lh_applysubst_arg1_1 _lh_applysubst_arg2_1 =
  (match _lh_applysubst_arg2_1 with
    ...
    | `Atom(_lh_applysubst_Atom_0_1) -> 
      (let rec _lh_matchIdent_2_7 = (assoc_lh__d1 (`LH_P2((`Atom(_lh_applysubst_Atom_0_1)), _lh_applysubst_arg1_1))) in
...
let rec lispmember_lh__d2_d2 _lh_lispmember_arg1_3 =
          ...
          (match _lh_lispmember_Cons_0_3 with
            | `LH_P2(_lh_lispmember_LH_P2_0_7, _lh_lispmember_LH_P2_1_7) -> 
              (if (_lh_lispmember_LH_P2_0_6 = _lh_lispmember_LH_P2_0_7) then
                ...
                (lispmember_lh__d2_d2 (`LH_P2(_lh_lispmember_LH_P2_0_6, _lh_lispmember_LH_P2_1_7))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d2_d4 _lh_lispmember_arg1_1_1 =
          ...
          (match _lh_lispmember_Cons_0_1_1 with
            | `LH_P2(_lh_lispmember_LH_P2_0_2_3, _lh_lispmember_LH_P2_1_2_3) -> 
              (if (_lh_lispmember_LH_P2_0_2_2 = _lh_lispmember_LH_P2_0_2_3) then
                ...
                (lispmember_lh__d2_d4 (`LH_P2(_lh_lispmember_LH_P2_0_2_2, _lh_lispmember_LH_P2_1_2_3))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d2_d3 _lh_lispmember_arg1_1_3 =
          ...
          (match _lh_lispmember_Cons_0_1_3 with
            | `LH_P2(_lh_lispmember_LH_P2_0_2_7, _lh_lispmember_LH_P2_1_2_7) -> 
              (if (_lh_lispmember_LH_P2_0_2_6 = _lh_lispmember_LH_P2_0_2_7) then
                ...
                (lispmember_lh__d2_d3 (`LH_P2(_lh_lispmember_LH_P2_0_2_6, _lh_lispmember_LH_P2_1_2_7))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d2_d5 _lh_lispmember_arg1_1_8 =
          ...
          (match _lh_lispmember_Cons_0_1_8 with
            | `LH_P2(_lh_lispmember_LH_P2_0_3_7, _lh_lispmember_LH_P2_1_3_7) -> 
              (if (_lh_lispmember_LH_P2_0_3_6 = _lh_lispmember_LH_P2_0_3_7) then
                ...
                (lispmember_lh__d2_d5 (`LH_P2(_lh_lispmember_LH_P2_0_3_6, _lh_lispmember_LH_P2_1_3_7))))
            | _ -> 
              false)
        | _ -> 
          false));;
  ...
  (match _lh_truep_arg1_0 with
    | `LH_P2(_lh_truep_LH_P2_0_0, _lh_truep_LH_P2_1_0) -> 
      (match _lh_truep_LH_P2_0_0 with
              ...
              (match _lh_truep_LH_P2_0_1 with
                | `Atom(_lh_truep_Atom_0_0) -> 
                  (match _lh_truep_Atom_0_0 with
                    ...
                    | _ -> 
                      (lispmember_lh__d2_d5 (`LH_P2(_lh_truep_LH_P2_0_0, _lh_truep_LH_P2_1_0))))
                | _ -> 
                  (lispmember_lh__d2_d5 (`LH_P2(_lh_truep_LH_P2_0_0, _lh_truep_LH_P2_1_0))))
            | _ -> 
              (lispmember_lh__d2_d5 (`LH_P2(_lh_truep_LH_P2_0_0, _lh_truep_LH_P2_1_0))))
        | _ -> 
          (lispmember_lh__d2_d5 (`LH_P2(_lh_truep_LH_P2_0_0, _lh_truep_LH_P2_1_0)))));;
let rec lispmember_lh__d1_d6 _lh_lispmember_arg1_4 =
          ...
          (match _lh_lispmember_Cons_0_4 with
            | `LH_P2(_lh_lispmember_LH_P2_0_9, _lh_lispmember_LH_P2_1_9) -> 
              (if (_lh_lispmember_LH_P2_0_8 = _lh_lispmember_LH_P2_0_9) then
                ...
                (lispmember_lh__d1_d6 (`LH_P2(_lh_lispmember_LH_P2_0_8, _lh_lispmember_LH_P2_1_9))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d1_d8 _lh_lispmember_arg1_7 =
          ...
          (match _lh_lispmember_Cons_0_7 with
            | `LH_P2(_lh_lispmember_LH_P2_0_1_5, _lh_lispmember_LH_P2_1_1_5) -> 
              (if (_lh_lispmember_LH_P2_0_1_4 = _lh_lispmember_LH_P2_0_1_5) then
                ...
                (lispmember_lh__d1_d8 (`LH_P2(_lh_lispmember_LH_P2_0_1_4, _lh_lispmember_LH_P2_1_1_5))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d2_d1 _lh_lispmember_arg1_1_0 =
          ...
          (match _lh_lispmember_Cons_0_1_0 with
            | `LH_P2(_lh_lispmember_LH_P2_0_2_1, _lh_lispmember_LH_P2_1_2_1) -> 
              (if (_lh_lispmember_LH_P2_0_2_0 = _lh_lispmember_LH_P2_0_2_1) then
                ...
                (lispmember_lh__d2_d1 (`LH_P2(_lh_lispmember_LH_P2_0_2_0, _lh_lispmember_LH_P2_1_2_1))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d1_d7 _lh_lispmember_arg1_1_4 =
          ...
          (match _lh_lispmember_Cons_0_1_4 with
            | `LH_P2(_lh_lispmember_LH_P2_0_2_9, _lh_lispmember_LH_P2_1_2_9) -> 
              (if (_lh_lispmember_LH_P2_0_2_8 = _lh_lispmember_LH_P2_0_2_9) then
                ...
                (lispmember_lh__d1_d7 (`LH_P2(_lh_lispmember_LH_P2_0_2_8, _lh_lispmember_LH_P2_1_2_9))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d1_d9 _lh_lispmember_arg1_1 =
          ...
          (match _lh_lispmember_Cons_0_1 with
            | `LH_P2(_lh_lispmember_LH_P2_0_3, _lh_lispmember_LH_P2_1_3) -> 
              (if (_lh_lispmember_LH_P2_0_2 = _lh_lispmember_LH_P2_0_3) then
                ...
                (lispmember_lh__d1_d9 (`LH_P2(_lh_lispmember_LH_P2_0_2, _lh_lispmember_LH_P2_1_3))))
            | _ -> 
              false)
        | _ -> 
          false));;
                            ...
                            | `LH_N -> 
                              (match _lh_truep_LH_P2_1_3 with
                                | `Nil -> 
                                  true
                                | _ -> 
                                  (lispmember_lh__d2_d1 (`LH_P2(_lh_truep_LH_P2_0_2, _lh_truep_LH_P2_1_2))))
                            | _ -> 
                              (lispmember_lh__d1_d6 (`LH_P2(_lh_truep_LH_P2_0_2, _lh_truep_LH_P2_1_2))))
                        | _ -> 
                          (lispmember_lh__d1_d5 (`LH_P2(_lh_truep_LH_P2_0_2, _lh_truep_LH_P2_1_2))))
                    | _ -> 
                      (lispmember_lh__d1_d9 (`LH_P2(_lh_truep_LH_P2_0_2, _lh_truep_LH_P2_1_2))))
                | _ -> 
                  (lispmember_lh__d2_d0 (`LH_P2(_lh_truep_LH_P2_0_2, _lh_truep_LH_P2_1_2))))
            | _ -> 
              (lispmember_lh__d1_d8 (`LH_P2(_lh_truep_LH_P2_0_2, _lh_truep_LH_P2_1_2))))
        | _ -> 
          (lispmember_lh__d1_d7 (`LH_P2(_lh_truep_LH_P2_0_2, _lh_truep_LH_P2_1_2)))));;
let rec lispmember_lh__d9 _lh_lispmember_arg1_8 =
          ...
          (match _lh_lispmember_Cons_0_8 with
            | `LH_P2(_lh_lispmember_LH_P2_0_1_7, _lh_lispmember_LH_P2_1_1_7) -> 
              (if (_lh_lispmember_LH_P2_0_1_6 = _lh_lispmember_LH_P2_0_1_7) then
                ...
                (lispmember_lh__d9 (`LH_P2(_lh_lispmember_LH_P2_0_1_6, _lh_lispmember_LH_P2_1_1_7))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d1_d0 _lh_lispmember_arg1_9 =
          ...
          (match _lh_lispmember_Cons_0_9 with
            | `LH_P2(_lh_lispmember_LH_P2_0_1_9, _lh_lispmember_LH_P2_1_1_9) -> 
              (if (_lh_lispmember_LH_P2_0_1_8 = _lh_lispmember_LH_P2_0_1_9) then
                ...
                (lispmember_lh__d1_d0 (`LH_P2(_lh_lispmember_LH_P2_0_1_8, _lh_lispmember_LH_P2_1_1_9))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d1_d4 _lh_lispmember_arg1_1_2 =
          ...
          (match _lh_lispmember_Cons_0_1_2 with
            | `LH_P2(_lh_lispmember_LH_P2_0_2_5, _lh_lispmember_LH_P2_1_2_5) -> 
              (if (_lh_lispmember_LH_P2_0_2_4 = _lh_lispmember_LH_P2_0_2_5) then
                ...
                (lispmember_lh__d1_d4 (`LH_P2(_lh_lispmember_LH_P2_0_2_4, _lh_lispmember_LH_P2_1_2_5))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d1_d3 _lh_lispmember_arg1_1_9 =
          ...
          (match _lh_lispmember_Cons_0_1_9 with
            | `LH_P2(_lh_lispmember_LH_P2_0_3_9, _lh_lispmember_LH_P2_1_3_9) -> 
              (if (_lh_lispmember_LH_P2_0_3_8 = _lh_lispmember_LH_P2_0_3_9) then
                ...
                (lispmember_lh__d1_d3 (`LH_P2(_lh_lispmember_LH_P2_0_3_8, _lh_lispmember_LH_P2_1_3_9))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d8 _lh_lispmember_arg1_2 =
          ...
          (match _lh_lispmember_Cons_0_2 with
            | `LH_P2(_lh_lispmember_LH_P2_0_5, _lh_lispmember_LH_P2_1_5) -> 
              (if (_lh_lispmember_LH_P2_0_4 = _lh_lispmember_LH_P2_0_5) then
                ...
                (lispmember_lh__d8 (`LH_P2(_lh_lispmember_LH_P2_0_4, _lh_lispmember_LH_P2_1_5))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d1_d1 _lh_lispmember_arg1_2_2 =
          ...
          (match _lh_lispmember_Cons_0_2_2 with
            | `LH_P2(_lh_lispmember_LH_P2_0_4_5, _lh_lispmember_LH_P2_1_4_5) -> 
              (if (_lh_lispmember_LH_P2_0_4_4 = _lh_lispmember_LH_P2_0_4_5) then
                ...
                (lispmember_lh__d1_d1 (`LH_P2(_lh_lispmember_LH_P2_0_4_4, _lh_lispmember_LH_P2_1_4_5))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d1_d2 _lh_lispmember_arg1_2_4 =
          ...
          (match _lh_lispmember_Cons_0_2_4 with
            | `LH_P2(_lh_lispmember_LH_P2_0_4_9, _lh_lispmember_LH_P2_1_4_9) -> 
              (if (_lh_lispmember_LH_P2_0_4_8 = _lh_lispmember_LH_P2_0_4_9) then
                ...
                (lispmember_lh__d1_d2 (`LH_P2(_lh_lispmember_LH_P2_0_4_8, _lh_lispmember_LH_P2_1_4_9))))
            | _ -> 
              false)
        | _ -> 
          false));;
                            ...
                            | `LH_N -> 
                              (match _lh_falsep_LH_P2_1_1 with
                                | `Nil -> 
                                  true
                                | _ -> 
                                  (lispmember_lh__d1_d0 (`LH_P2(_lh_falsep_LH_P2_0_0, _lh_falsep_LH_P2_1_0))))
                            | _ -> 
                              (lispmember_lh__d1_d4 (`LH_P2(_lh_falsep_LH_P2_0_0, _lh_falsep_LH_P2_1_0))))
                        | _ -> 
                          (lispmember_lh__d1_d1 (`LH_P2(_lh_falsep_LH_P2_0_0, _lh_falsep_LH_P2_1_0))))
                    | _ -> 
                      (lispmember_lh__d1_d3 (`LH_P2(_lh_falsep_LH_P2_0_0, _lh_falsep_LH_P2_1_0))))
                | _ -> 
                  (lispmember_lh__d1_d2 (`LH_P2(_lh_falsep_LH_P2_0_0, _lh_falsep_LH_P2_1_0))))
            | _ -> 
              (lispmember_lh__d9 (`LH_P2(_lh_falsep_LH_P2_0_0, _lh_falsep_LH_P2_1_0))))
        | _ -> 
          (lispmember_lh__d8 (`LH_P2(_lh_falsep_LH_P2_0_0, _lh_falsep_LH_P2_1_0)))));;
let rec car_lh__d2 _lh_car_arg1_1 =
  (match _lh_car_arg1_1 with
    ...
    | _ -> 
      (`Nil));;
let rec car_lh__d3 _lh_car_arg1_3 =
  (match _lh_car_arg1_3 with
    ...
    | _ -> 
      (`Nil));;
let rec car_lh__d1 _lh_car_arg1_4 =
  (match _lh_car_arg1_4 with
    ...
    | _ -> 
      (`Nil));;
let rec lispmember_lh__d6 _lh_lispmember_arg1_0 =
          ...
          (match _lh_lispmember_Cons_0_0 with
            | `LH_P2(_lh_lispmember_LH_P2_0_1, _lh_lispmember_LH_P2_1_1) -> 
              (if (_lh_lispmember_LH_P2_0_0 = _lh_lispmember_LH_P2_0_1) then
                ...
                (lispmember_lh__d6 (`LH_P2(_lh_lispmember_LH_P2_0_0, _lh_lispmember_LH_P2_1_1))))
            | _ -> 
              false)
        | _ -> 
          false));;
  ...
  (match _lh_lispmember_arg1_2_3 with
    | `LH_P2(_lh_lispmember_LH_P2_0_4_6, _lh_lispmember_LH_P2_1_4_6) -> 
      (match _lh_lispmember_LH_P2_1_4_6 with
        ...
        | _ -> 
          false));;
let rec lispmember_lh__d5 _lh_lispmember_arg1_5 =
          ...
          (match _lh_lispmember_Cons_0_5 with
            | `LH_P2(_lh_lispmember_LH_P2_0_1_1, _lh_lispmember_LH_P2_1_1_1) -> 
              (if (_lh_lispmember_LH_P2_0_1_0 = _lh_lispmember_LH_P2_0_1_1) then
                ...
                (lispmember_lh__d5 (`LH_P2(_lh_lispmember_LH_P2_0_1_0, _lh_lispmember_LH_P2_1_1_1))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d7 _lh_lispmember_arg1_6 =
          ...
          (match _lh_lispmember_Cons_0_6 with
            | `LH_P2(_lh_lispmember_LH_P2_0_1_3, _lh_lispmember_LH_P2_1_1_3) -> 
              (if (_lh_lispmember_LH_P2_0_1_2 = _lh_lispmember_LH_P2_0_1_3) then
                ...
                (lispmember_lh__d7 (`LH_P2(_lh_lispmember_LH_P2_0_1_2, _lh_lispmember_LH_P2_1_1_3))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d2 _lh_lispmember_arg1_2_0 =
          ...
          (match _lh_lispmember_Cons_0_2_0 with
            | `LH_P2(_lh_lispmember_LH_P2_0_4_1, _lh_lispmember_LH_P2_1_4_1) -> 
              (if (_lh_lispmember_LH_P2_0_4_0 = _lh_lispmember_LH_P2_0_4_1) then
                ...
                (lispmember_lh__d2 (`LH_P2(_lh_lispmember_LH_P2_0_4_0, _lh_lispmember_LH_P2_1_4_1))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d4 _lh_lispmember_arg1_2_1 =
          ...
          (match _lh_lispmember_Cons_0_2_1 with
            | `LH_P2(_lh_lispmember_LH_P2_0_4_3, _lh_lispmember_LH_P2_1_4_3) -> 
              (if (_lh_lispmember_LH_P2_0_4_2 = _lh_lispmember_LH_P2_0_4_3) then
                ...
                (lispmember_lh__d4 (`LH_P2(_lh_lispmember_LH_P2_0_4_2, _lh_lispmember_LH_P2_1_4_3))))
            | _ -> 
              false)
        | _ -> 
          false));;
                            ...
                            | `LH_N -> 
                              (match _lh_falsep_LH_P2_1_3 with
                                | `Nil -> 
                                  true
                                | _ -> 
                                  (lispmember_lh__d2_d5 (`LH_P2(_lh_falsep_LH_P2_0_2, _lh_falsep_LH_P2_1_2))))
                            | _ -> 
                              (lispmember_lh__d2_d5 (`LH_P2(_lh_falsep_LH_P2_0_2, _lh_falsep_LH_P2_1_2))))
                        | _ -> 
                          (lispmember_lh__d2_d5 (`LH_P2(_lh_falsep_LH_P2_0_2, _lh_falsep_LH_P2_1_2))))
...
let rec caddr_lh__d2 _lh_caddr_arg1_0 =
  ((fun _lh_funcomp_x_3 -> 
    ((fun _lh_funcomp_x_4 -> 
      (car_lh__d6 (cdr_lh__d3 _lh_funcomp_x_4))) (cdr_lh__d3 _lh_funcomp_x_3))) _lh_caddr_arg1_0);;
let rec cdr_lh__d2 _lh_cdr_arg1_2 =
...
let rec caddr_lh__d1 _lh_caddr_arg1_2 =
  ((fun _lh_funcomp_x_7 -> 
    ((fun _lh_funcomp_x_8 -> 
      (car_lh__d6 (cdr_lh__d2 _lh_funcomp_x_8))) (cdr_lh__d3 _lh_funcomp_x_7))) _lh_caddr_arg1_2);;
let rec car_lh__d4 _lh_car_arg1_5 =
...
let rec cdr_lh__d1 _lh_cdr_arg1_0 =
  (match _lh_cdr_arg1_0 with
    ...
    | _ -> 
      (`Nil));;
let rec car_lh__d5 _lh_car_arg1_0 =
...
let rec cadr_lh__d1 _lh_cadr_arg1_0 =
  ((fun _lh_funcomp_x_0 -> 
    (car_lh__d5 (cdr_lh__d1 _lh_funcomp_x_0))) _lh_cadr_arg1_0);;
let rec cadr_lh__d2 _lh_cadr_arg1_1 =
  ((fun _lh_funcomp_x_1 -> 
    (car_lh__d6 (cdr_lh__d3 _lh_funcomp_x_1))) _lh_cadr_arg1_1);;
        ...
        | `Cons(_lh_tautologyp_Cons_0_0) -> 
          (match _lh_tautologyp_Cons_0_0 with
            | `LH_P2(_lh_tautologyp_LH_P2_0_0, _lh_tautologyp_LH_P2_1_0) -> 
              (if (truep_lh__d3 (`LH_P2((`Cons((`LH_P2(_lh_tautologyp_LH_P2_0_0, _lh_tautologyp_LH_P2_1_0)))), _lh_tautologyp_LH_P3_1_0))) then
                true
              else
                                    ...
                                    (match _lh_tautologyp_LH_C_0_1 with
                                      | 'f' -> 
                                        (match _lh_tautologyp_LH_C_1_1 with
                                          | `LH_N -> 
                                            (if (truep_lh__d1 (`LH_P2((car_lh__d1 _lh_tautologyp_LH_P2_1_0), _lh_tautologyp_LH_P3_1_0))) then
                                              (tautologyp_lh__d1 (`LH_P3((cadr_lh__d2 _lh_tautologyp_LH_P2_1_0), _lh_tautologyp_LH_P3_1_0, _lh_tautologyp_LH_P3_2_0)))
                                            else
                                              (if (falsep_lh__d1 (`LH_P2((car_lh__d2 _lh_tautologyp_LH_P2_1_0), _lh_tautologyp_LH_P3_2_0))) then
                                                (tautologyp_lh__d1 (`LH_P3((caddr_lh__d2 _lh_tautologyp_LH_P2_1_0), _lh_tautologyp_LH_P3_1_0, _lh_tautologyp_LH_P3_2_0)))
                                              else
                                                ((tautologyp_lh__d1 (`LH_P3((cadr_lh__d1 _lh_tautologyp_LH_P2_1_0), (`Cons((`LH_P2((car_lh__d4 _lh_tautologyp_LH_P2_1_0), _lh_tautologyp_LH_P3_1_0)))), _lh_tautologyp_LH_P3_2_0))) && (tautologyp_lh__d1 (`LH_P3((caddr_lh__d1 _lh_tautologyp_LH_P2_1_0), _lh_tautologyp_LH_P3_1_0, (`Cons((`LH_P2((car_lh__d3 _lh_tautologyp_LH_P2_1_0), _lh_tautologyp_LH_P3_2_0))))))))))
                                          | _ -> 
                                            false)
                                      | _ -> 
                                        false)
...
let rec getToken_lh__d2 _lh_getToken_arg1_0 =
  (match _lh_getToken_arg1_0 with
    ...
    | `LH_C(_lh_getToken_LH_C_0_0, _lh_getToken_LH_C_1_0) -> 
      (if (_lh_getToken_LH_C_0_0 = ' ') then
        (getToken_lh__d2 _lh_getToken_LH_C_1_0)
      else
        (if ((_lh_getToken_LH_C_0_0 = '(') || (_lh_getToken_LH_C_0_0 = ')')) then
          (let rec _lh_strToToken_LH_P2_1_1 = _lh_getToken_LH_C_1_0 in
            (let rec _lh_strToToken_LH_P2_0_1 = (`LH_C(_lh_getToken_LH_C_0_0, (`LH_N))) in
              (fun _lh_dummy_1_0_8 -> 
                (`LH_C(_lh_strToToken_LH_P2_0_1, (strToToken_lh__d2 _lh_strToToken_LH_P2_1_1))))))
        else
          (let rec _lh_matchIdent_1_6 = (restOfToken_lh__d1 _lh_getToken_LH_C_1_0) in
              ...
              | `LH_P2(_lh_getToken_LH_P2_0_0, _lh_getToken_LH_P2_1_0) -> 
                (let rec _lh_strToToken_LH_P2_1_2 = _lh_getToken_LH_P2_1_0 in
                  (let rec _lh_strToToken_LH_P2_0_2 = (`LH_C(_lh_getToken_LH_C_0_0, _lh_getToken_LH_P2_0_0)) in
                    (fun _lh_dummy_1_0_9 -> 
                      (`LH_C(_lh_strToToken_LH_P2_0_2, (strToToken_lh__d2 _lh_strToToken_LH_P2_1_2)))))))))))
and
strToToken_lh__d2 _lh_strToToken_arg1_0 =
  (match _lh_strToToken_arg1_0 with
    | `LH_N -> 
      (`LH_N)
    | _ -> 
      (let rec _lh_matchIdent_1_0 = (getToken_lh__d2 _lh_strToToken_arg1_0) in
    ...
    | `Cons(_lh_addlemma_Cons_0_0) -> 
      (match _lh_addlemma_Cons_0_0 with
        | `LH_P2(_lh_addlemma_LH_P2_0_0, _lh_addlemma_LH_P2_1_0) -> 
          (let rec z_0 = (car_lh__d6 _lh_addlemma_LH_P2_1_0) in
            (if (((tv_lh__d1 _lh_addlemma_LH_P2_0_0) = (`LH_C('e', (`LH_C('q', (`LH_C('u', (`LH_C('a', (`LH_C('l', (`LH_N)))))))))))) && (not (atom_lh__d1 z_0))) then
              (addtoLUT_lh__d1 (`LH_P3((tv_lh__d1 (car_lh__d6 z_0)), (`Cons((`LH_P2(_lh_addlemma_LH_P2_0_0, _lh_addlemma_LH_P2_1_0)))), _lh_addlemma_arg2_0)))
            else
              (failwith "lh_default_error")))));;
let rec sublist_lh__d2 _lh_sublist_arg1_1 =
  (match _lh_sublist_arg1_1 with
    ...
    | `LH_C(_lh_sublist_LH_C_0_2, _lh_sublist_LH_C_1_2) -> 
      (match _lh_sublist_LH_C_0_2 with
          ...
          (match _lh_sublist_LH_C_0_3 with
            | '(' -> 
              (match _lh_sublist_LH_C_1_3 with
                | `LH_N -> 
                  (let rec _lh_matchIdent_2_1 = (sublist_lh__d2 _lh_sublist_LH_C_1_2) in
                    (match _lh_matchIdent_2_1 with
                      | `LH_P2(_lh_sublist_LH_P2_0_6, _lh_sublist_LH_P2_1_6) -> 
                        (let rec _lh_matchIdent_2_2 = (sublist_lh__d2 _lh_sublist_LH_P2_0_6) in
                ...
                | _ -> 
                  (let rec _lh_matchIdent_2_3 = (sublist_lh__d2 _lh_sublist_LH_C_1_2) in
            ...
            | ')' -> 
              (match _lh_sublist_LH_C_1_3 with
                ...
                | _ -> 
                  (let rec _lh_matchIdent_2_4 = (sublist_lh__d2 _lh_sublist_LH_C_1_2) in
            ...
            | _ -> 
              (let rec _lh_matchIdent_2_5 = (sublist_lh__d2 _lh_sublist_LH_C_1_2) in
        ...
        | _ -> 
          (let rec _lh_matchIdent_2_6 = (sublist_lh__d2 _lh_sublist_LH_C_1_2) in
          ...
          (match _lh_mkLisplist_LH_C_0_3 with
            | '(' -> 
              (match _lh_mkLisplist_LH_C_1_3 with
                | `LH_N -> 
                  (let rec _lh_matchIdent_1_9 = (sublist_lh__d2 _lh_mkLisplist_LH_C_1_2) in
                    (match _lh_matchIdent_1_9 with
                      | `LH_P2(_lh_mkLisplist_LH_P2_0_1, _lh_mkLisplist_LH_P2_1_1) -> 
                        (let rec _lh_matchIdent_2_0 = _lh_mkLisplist_LH_P2_0_1 in
...
let rec rules_lh__d1 _lh_dummy_1_0_6 _lh_addlemmalst_arg2_1_0_6 =
...
let rec lemmas_lh__d1 =
  ((addlemmalst_lh__d1 (makelemmas_lh__d1 rules_lh__d1)) (`Empty));;
let rec tautp_lh__d1 _lh_tautp_arg1_0 =
  (tautologyp_lh__d1 (`LH_P3(((rewrite_lh__d1 _lh_tautp_arg1_0) lemmas_lh__d1), (`Nil), (`Nil))));;
let rec mappend_lh__d4 xs_4 ys_9_2 =
  (xs_4 ys_9_2);;
let rec mappend_lh__d3 xs_2 ys_2 =
  (match xs_2 with
    | `LH_C(h_1, t_1) -> 
      (let rec t_2 = ((mappend_lh__d3 t_1) ys_2) in
        (let rec h_2 = h_1 in
          (fun ys_3 -> 
            (`LH_C(h_2, ((mappend_lh__d4 t_2) ys_3))))))
    | `LH_N -> 
      ys_2);;
let rec mappend_lh__d1 xs_0 ys_0 =
  (match xs_0 with
    ...
    | `LH_N -> 
      ys_0);;
let rec mappend_lh__d2 xs_3 ys_9_1 =
  (xs_3 ys_9_1);;
let rec mappend_lh__d5 xs_1 ys_1 =
  (xs_1 ys_1);;
let rec subterm_lh__d1 _lh_subterm_arg1_0 =
  (let rec c_0 = ((mappend_lh__d2 (let rec t_3 = (fun ys_4 -> 
    ys_4) in
    (let rec h_3 = 'c' in
      (fun ys_5 -> 
        (`LH_C(h_3, ((mappend_lh__d2 t_3) ys_5))))))) (string_of_int _lh_subterm_arg1_0)) in
    (let rec str_0 = ((mappend_lh__d1 ((mappend_lh__d4 ((mappend_lh__d3 ((mappend_lh__d5 (let rec t_4 = (let rec t_5 = (let rec t_6 = (let rec t_7 = (let rec t_8 = (let rec t_9 = (let rec t_1_0 = (let rec t_1_1 = (let rec t_1_2 = (let rec t_1_3 = (let rec t_1_4 = (let rec t_1_5 = (let rec t_1_6 = (let rec t_1_7 = (let rec t_1_8 = (let rec t_1_9 = (let rec t_2_0 = (let rec t_2_1 = (let rec t_2_2 = (let rec t_2_3 = (let rec t_2_4 = (let rec t_2_5 = (let rec t_2_6 = (let rec t_2_7 = (let rec t_2_8 = (let rec t_2_9 = (let rec t_3_0 = (let rec t_3_1 = (let rec t_3_2 = (let rec t_3_3 = (let rec t_3_4 = (let rec t_3_5 = (let rec t_3_6 = (let rec t_3_7 = (fun ys_6 -> 
      ys_6) in
      (let rec h_4 = ' ' in
        (fun ys_7 -> 
          (`LH_C(h_4, ((mappend_lh__d5 t_3_7) ys_7)))))) in
      (let rec h_5 = 's' in
        (fun ys_8 -> 
          (`LH_C(h_5, ((mappend_lh__d5 t_3_6) ys_8)))))) in
      (let rec h_6 = 'u' in
        (fun ys_9 -> 
          (`LH_C(h_6, ((mappend_lh__d5 t_3_5) ys_9)))))) in
      (let rec h_7 = 'l' in
        (fun ys_1_0 -> 
          (`LH_C(h_7, ((mappend_lh__d5 t_3_4) ys_1_0)))))) in
      (let rec h_8 = 'p' in
        (fun ys_1_1 -> 
          (`LH_C(h_8, ((mappend_lh__d5 t_3_3) ys_1_1)))))) in
      (let rec h_9 = ' ' in
        (fun ys_1_2 -> 
          (`LH_C(h_9, ((mappend_lh__d5 t_3_2) ys_1_2)))))) in
      (let rec h_1_0 = '(' in
        (fun ys_1_3 -> 
          (`LH_C(h_1_0, ((mappend_lh__d5 t_3_1) ys_1_3)))))) in
      (let rec h_1_1 = ')' in
        (fun ys_1_4 -> 
          (`LH_C(h_1_1, ((mappend_lh__d5 t_3_0) ys_1_4)))))) in
      (let rec h_1_2 = ' ' in
        (fun ys_1_5 -> 
          (`LH_C(h_1_2, ((mappend_lh__d5 t_2_9) ys_1_5)))))) in
      (let rec h_1_3 = 'b' in
        (fun ys_1_6 -> 
          (`LH_C(h_1_3, ((mappend_lh__d5 t_2_8) ys_1_6)))))) in
      (let rec h_1_4 = ' ' in
        (fun ys_1_7 -> 
          (`LH_C(h_1_4, ((mappend_lh__d5 t_2_7) ys_1_7)))))) in
      (let rec h_1_5 = 'a' in
        (fun ys_1_8 -> 
          (`LH_C(h_1_5, ((mappend_lh__d5 t_2_6) ys_1_8)))))) in
      (let rec h_1_6 = ' ' in
        (fun ys_1_9 -> 
          (`LH_C(h_1_6, ((mappend_lh__d5 t_2_5) ys_1_9)))))) in
      (let rec h_1_7 = 's' in
        (fun ys_2_0 -> 
          (`LH_C(h_1_7, ((mappend_lh__d5 t_2_4) ys_2_0)))))) in
      (let rec h_1_8 = 'u' in
        (fun ys_2_1 -> 
          (`LH_C(h_1_8, ((mappend_lh__d5 t_2_3) ys_2_1)))))) in
      (let rec h_1_9 = 'l' in
        (fun ys_2_2 -> 
          (`LH_C(h_1_9, ((mappend_lh__d5 t_2_2) ys_2_2)))))) in
      (let rec h_2_0 = 'p' in
        (fun ys_2_3 -> 
          (`LH_C(h_2_0, ((mappend_lh__d5 t_2_1) ys_2_3)))))) in
      (let rec h_2_1 = ' ' in
        (fun ys_2_4 -> 
          (`LH_C(h_2_1, ((mappend_lh__d5 t_2_0) ys_2_4)))))) in
      (let rec h_2_2 = '(' in
        (fun ys_2_5 -> 
          (`LH_C(h_2_2, ((mappend_lh__d5 t_1_9) ys_2_5)))))) in
      (let rec h_2_3 = ' ' in
        (fun ys_2_6 -> 
          (`LH_C(h_2_3, ((mappend_lh__d5 t_1_8) ys_2_6)))))) in
      (let rec h_2_4 = 's' in
        (fun ys_2_7 -> 
          (`LH_C(h_2_4, ((mappend_lh__d5 t_1_7) ys_2_7)))))) in
      (let rec h_2_5 = 'u' in
        (fun ys_2_8 -> 
          (`LH_C(h_2_5, ((mappend_lh__d5 t_1_6) ys_2_8)))))) in
      (let rec h_2_6 = 'l' in
        (fun ys_2_9 -> 
          (`LH_C(h_2_6, ((mappend_lh__d5 t_1_5) ys_2_9)))))) in
      (let rec h_2_7 = 'p' in
        (fun ys_3_0 -> 
          (`LH_C(h_2_7, ((mappend_lh__d5 t_1_4) ys_3_0)))))) in
      (let rec h_2_8 = ' ' in
        (fun ys_3_1 -> 
          (`LH_C(h_2_8, ((mappend_lh__d5 t_1_3) ys_3_1)))))) in
      (let rec h_2_9 = '(' in
        (fun ys_3_2 -> 
          (`LH_C(h_2_9, ((mappend_lh__d5 t_1_2) ys_3_2)))))) in
      (let rec h_3_0 = ' ' in
        (fun ys_3_3 -> 
          (`LH_C(h_3_0, ((mappend_lh__d5 t_1_1) ys_3_3)))))) in
      (let rec h_3_1 = 'f' in
        (fun ys_3_4 -> 
          (`LH_C(h_3_1, ((mappend_lh__d5 t_1_0) ys_3_4)))))) in
      (let rec h_3_2 = ' ' in
        (fun ys_3_5 -> 
          (`LH_C(h_3_2, ((mappend_lh__d5 t_9) ys_3_5)))))) in
      (let rec h_3_3 = 'x' in
        (fun ys_3_6 -> 
          (`LH_C(h_3_3, ((mappend_lh__d5 t_8) ys_3_6)))))) in
      (let rec h_3_4 = ' ' in
        (fun ys_3_7 -> 
          (`LH_C(h_3_4, ((mappend_lh__d5 t_7) ys_3_7)))))) in
      (let rec h_3_5 = '(' in
        (fun ys_3_8 -> 
          (`LH_C(h_3_5, ((mappend_lh__d5 t_6) ys_3_8)))))) in
      (let rec h_3_6 = ' ' in
        (fun ys_3_9 -> 
          (`LH_C(h_3_6, ((mappend_lh__d5 t_5) ys_3_9)))))) in
      (let rec h_3_7 = '(' in
        (fun ys_4_0 -> 
          (`LH_C(h_3_7, ((mappend_lh__d5 t_4) ys_4_0))))))) c_0)) (let rec t_3_8 = (let rec t_3_9 = (let rec t_4_0 = (let rec t_4_1 = (let rec t_4_2 = (let rec t_4_3 = (let rec t_4_4 = (let rec t_4_5 = (let rec t_4_6 = (let rec t_4_7 = (let rec t_4_8 = (let rec t_4_9 = (let rec t_5_0 = (let rec t_5_1 = (let rec t_5_2 = (let rec t_5_3 = (let rec t_5_4 = (let rec t_5_5 = (let rec t_5_6 = (let rec t_5_7 = (let rec t_5_8 = (let rec t_5_9 = (let rec t_6_0 = (let rec t_6_1 = (let rec t_6_2 = (let rec t_6_3 = (let rec t_6_4 = (let rec t_6_5 = (let rec t_6_6 = (let rec t_6_7 = (let rec t_6_8 = (let rec t_6_9 = (let rec t_7_0 = (let rec t_7_1 = (let rec t_7_2 = (let rec t_7_3 = (let rec t_7_4 = (let rec t_7_5 = (let rec t_7_6 = (let rec t_7_7 = (let rec t_7_8 = (let rec t_7_9 = (let rec t_8_0 = (let rec t_8_1 = (let rec t_8_2 = (let rec t_8_3 = (let rec t_8_4 = (let rec t_8_5 = (let rec t_8_6 = (fun ys_4_1 -> 
      ys_4_1) in
      (let rec h_3_8 = ' ' in
        (fun ys_4_2 -> 
          (`LH_C(h_3_8, ((mappend_lh__d4 t_8_6) ys_4_2)))))) in
      (let rec h_3_9 = 's' in
        (fun ys_4_3 -> 
          (`LH_C(h_3_9, ((mappend_lh__d4 t_8_5) ys_4_3)))))) in
      (let rec h_4_0 = 'u' in
        (fun ys_4_4 -> 
          (`LH_C(h_4_0, ((mappend_lh__d4 t_8_4) ys_4_4)))))) in
      (let rec h_4_1 = 'l' in
        (fun ys_4_5 -> 
          (`LH_C(h_4_1, ((mappend_lh__d4 t_8_3) ys_4_5)))))) in
      (let rec h_4_2 = 'p' in
        (fun ys_4_6 -> 
          (`LH_C(h_4_2, ((mappend_lh__d4 t_8_2) ys_4_6)))))) in
      (let rec h_4_3 = ' ' in
        (fun ys_4_7 -> 
          (`LH_C(h_4_3, ((mappend_lh__d4 t_8_1) ys_4_7)))))) in
      (let rec h_4_4 = '(' in
        (fun ys_4_8 -> 
          (`LH_C(h_4_4, ((mappend_lh__d4 t_8_0) ys_4_8)))))) in
      (let rec h_4_5 = ')' in
        (fun ys_4_9 -> 
          (`LH_C(h_4_5, ((mappend_lh__d4 t_7_9) ys_4_9)))))) in
      (let rec h_4_6 = ' ' in
        (fun ys_5_0 -> 
          (`LH_C(h_4_6, ((mappend_lh__d4 t_7_8) ys_5_0)))))) in
      (let rec h_4_7 = 'b' in
        (fun ys_5_1 -> 
          (`LH_C(h_4_7, ((mappend_lh__d4 t_7_7) ys_5_1)))))) in
      (let rec h_4_8 = ' ' in
        (fun ys_5_2 -> 
          (`LH_C(h_4_8, ((mappend_lh__d4 t_7_6) ys_5_2)))))) in
      (let rec h_4_9 = 'a' in
        (fun ys_5_3 -> 
          (`LH_C(h_4_9, ((mappend_lh__d4 t_7_5) ys_5_3)))))) in
      (let rec h_5_0 = ' ' in
        (fun ys_5_4 -> 
          (`LH_C(h_5_0, ((mappend_lh__d4 t_7_4) ys_5_4)))))) in
      (let rec h_5_1 = 's' in
        (fun ys_5_5 -> 
          (`LH_C(h_5_1, ((mappend_lh__d4 t_7_3) ys_5_5)))))) in
      (let rec h_5_2 = 'e' in
        (fun ys_5_6 -> 
          (`LH_C(h_5_2, ((mappend_lh__d4 t_7_2) ys_5_6)))))) in
      (let rec h_5_3 = 'm' in
        (fun ys_5_7 -> 
          (`LH_C(h_5_3, ((mappend_lh__d4 t_7_1) ys_5_7)))))) in
      (let rec h_5_4 = 'i' in
        (fun ys_5_8 -> 
          (`LH_C(h_5_4, ((mappend_lh__d4 t_7_0) ys_5_8)))))) in
      (let rec h_5_5 = 't' in
        (fun ys_5_9 -> 
          (`LH_C(h_5_5, ((mappend_lh__d4 t_6_9) ys_5_9)))))) in
      (let rec h_5_6 = ' ' in
        (fun ys_6_0 -> 
          (`LH_C(h_5_6, ((mappend_lh__d4 t_6_8) ys_6_0)))))) in
      (let rec h_5_7 = '(' in
        (fun ys_6_1 -> 
          (`LH_C(h_5_7, ((mappend_lh__d4 t_6_7) ys_6_1)))))) in
      (let rec h_5_8 = ' ' in
        (fun ys_6_2 -> 
          (`LH_C(h_5_8, ((mappend_lh__d4 t_6_6) ys_6_2)))))) in
      (let rec h_5_9 = 's' in
        (fun ys_6_3 -> 
          (`LH_C(h_5_9, ((mappend_lh__d4 t_6_5) ys_6_3)))))) in
      (let rec h_6_0 = 'e' in
        (fun ys_6_4 -> 
          (`LH_C(h_6_0, ((mappend_lh__d4 t_6_4) ys_6_4)))))) in
      (let rec h_6_1 = 'm' in
        (fun ys_6_5 -> 
          (`LH_C(h_6_1, ((mappend_lh__d4 t_6_3) ys_6_5)))))) in
      (let rec h_6_2 = 'i' in
        (fun ys_6_6 -> 
          (`LH_C(h_6_2, ((mappend_lh__d4 t_6_2) ys_6_6)))))) in
      (let rec h_6_3 = 't' in
        (fun ys_6_7 -> 
          (`LH_C(h_6_3, ((mappend_lh__d4 t_6_1) ys_6_7)))))) in
      (let rec h_6_4 = ' ' in
        (fun ys_6_8 -> 
          (`LH_C(h_6_4, ((mappend_lh__d4 t_6_0) ys_6_8)))))) in
      (let rec h_6_5 = '(' in
        (fun ys_6_9 -> 
          (`LH_C(h_6_5, ((mappend_lh__d4 t_5_9) ys_6_9)))))) in
      (let rec h_6_6 = ' ' in
        (fun ys_7_0 -> 
          (`LH_C(h_6_6, ((mappend_lh__d4 t_5_8) ys_7_0)))))) in
      (let rec h_6_7 = 'f' in
        (fun ys_7_1 -> 
          (`LH_C(h_6_7, ((mappend_lh__d4 t_5_7) ys_7_1)))))) in
      (let rec h_6_8 = ' ' in
        (fun ys_7_2 -> 
          (`LH_C(h_6_8, ((mappend_lh__d4 t_5_6) ys_7_2)))))) in
      (let rec h_6_9 = 'y' in
        (fun ys_7_3 -> 
          (`LH_C(h_6_9, ((mappend_lh__d4 t_5_5) ys_7_3)))))) in
      (let rec h_7_0 = ' ' in
        (fun ys_7_4 -> 
          (`LH_C(h_7_0, ((mappend_lh__d4 t_5_4) ys_7_4)))))) in
      (let rec h_7_1 = '(' in
        (fun ys_7_5 -> 
          (`LH_C(h_7_1, ((mappend_lh__d4 t_5_3) ys_7_5)))))) in
      (let rec h_7_2 = ')' in
        (fun ys_7_6 -> 
          (`LH_C(h_7_2, ((mappend_lh__d4 t_5_2) ys_7_6)))))) in
      (let rec h_7_3 = ' ' in
        (fun ys_7_7 -> 
          (`LH_C(h_7_3, ((mappend_lh__d4 t_5_1) ys_7_7)))))) in
      (let rec h_7_4 = ')' in
        (fun ys_7_8 -> 
          (`LH_C(h_7_4, ((mappend_lh__d4 t_5_0) ys_7_8)))))) in
      (let rec h_7_5 = ' ' in
        (fun ys_7_9 -> 
          (`LH_C(h_7_5, ((mappend_lh__d4 t_4_9) ys_7_9)))))) in
      (let rec h_7_6 = ')' in
        (fun ys_8_0 -> 
          (`LH_C(h_7_6, ((mappend_lh__d4 t_4_8) ys_8_0)))))) in
      (let rec h_7_7 = ' ' in
        (fun ys_8_1 -> 
          (`LH_C(h_7_7, ((mappend_lh__d4 t_4_7) ys_8_1)))))) in
      (let rec h_7_8 = ')' in
        (fun ys_8_2 -> 
          (`LH_C(h_7_8, ((mappend_lh__d4 t_4_6) ys_8_2)))))) in
      (let rec h_7_9 = ' ' in
        (fun ys_8_3 -> 
          (`LH_C(h_7_9, ((mappend_lh__d4 t_4_5) ys_8_3)))))) in
      (let rec h_8_0 = 'o' in
        (fun ys_8_4 -> 
          (`LH_C(h_8_0, ((mappend_lh__d4 t_4_4) ys_8_4)))))) in
      (let rec h_8_1 = 'r' in
        (fun ys_8_5 -> 
          (`LH_C(h_8_1, ((mappend_lh__d4 t_4_3) ys_8_5)))))) in
      (let rec h_8_2 = 'e' in
        (fun ys_8_6 -> 
          (`LH_C(h_8_2, ((mappend_lh__d4 t_4_2) ys_8_6)))))) in
      (let rec h_8_3 = 'z' in
        (fun ys_8_7 -> 
          (`LH_C(h_8_3, ((mappend_lh__d4 t_4_1) ys_8_7)))))) in
      (let rec h_8_4 = ' ' in
        (fun ys_8_8 -> 
          (`LH_C(h_8_4, ((mappend_lh__d4 t_4_0) ys_8_8)))))) in
      (let rec h_8_5 = '(' in
        (fun ys_8_9 -> 
          (`LH_C(h_8_5, ((mappend_lh__d4 t_3_9) ys_8_9)))))) in
      (let rec h_8_6 = ' ' in
        (fun ys_9_0 -> 
          (`LH_C(h_8_6, ((mappend_lh__d4 t_3_8) ys_9_0)))))))) c_0)) (`LH_C(' ', (`LH_C('d', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C('(', (`LH_C(' ', (`LH_C('z', (`LH_C(' ', (`LH_C('f', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('r', (`LH_C('e', (`LH_C('v', (`LH_C('e', (`LH_C('r', (`LH_C('s', (`LH_C('e', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('a', (`LH_C('p', (`LH_C('p', (`LH_C('e', (`LH_C('n', (`LH_C('d', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('a', (`LH_C('p', (`LH_C('p', (`LH_C('e', (`LH_C('n', (`LH_C('d', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('b', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('[', (`LH_C(']', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C('(', (`LH_C('u', (`LH_C(' ', (`LH_C('e', (`LH_C('q', (`LH_C('u', (`LH_C('a', (`LH_C('l', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('p', (`LH_C('l', (`LH_C('u', (`LH_C('s', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('b', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('d', (`LH_C('i', (`LH_C('f', (`LH_C('f', (`LH_C('e', (`LH_C('r', (`LH_C('e', (`LH_C('n', (`LH_C('c', (`LH_C('e', (`LH_C(' ', (`LH_C('x', (`LH_C(' ', (`LH_C('y', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C('(', (`LH_C('w', (`LH_C(' ', (`LH_C('l', (`LH_C('e', (`LH_C('s', (`LH_C('s', (`LH_C('p', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('r', (`LH_C('e', (`LH_C('m', (`LH_C('a', (`LH_C('i', (`LH_C('n', (`LH_C('d', (`LH_C('e', (`LH_C('r', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('b', (`LH_C(' ', (`LH_C(')', (`LH_C('(', (`LH_C(' ', (`LH_C('m', (`LH_C('e', (`LH_C('m', (`LH_C('b', (`LH_C('e', (`LH_C('r', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('l', (`LH_C('e', (`LH_C('n', (`LH_C('g', (`LH_C('t', (`LH_C('h', (`LH_C(' ', (`LH_C('b', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_N)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) in
      (mkLisplist_lh__d2 (strToToken_lh__d2 str_0))));;
let rec getToken_lh__d1 _lh_getToken_arg1_1 =
  (match _lh_getToken_arg1_1 with
    | `LH_N -> 
      (let rec _lh_strToToken_LH_P2_1_3 = (`LH_N) in
        (let rec _lh_strToToken_LH_P2_0_3 = (`LH_N) in
          (fun _lh_dummy_1_1_0 -> 
            (`LH_C(_lh_strToToken_LH_P2_0_3, (strToToken_lh__d1 _lh_strToToken_LH_P2_1_3))))))
    | `LH_C(_lh_getToken_LH_C_0_1, _lh_getToken_LH_C_1_1) -> 
      (if (_lh_getToken_LH_C_0_1 = ' ') then
        (getToken_lh__d1 _lh_getToken_LH_C_1_1)
      else
        (if ((_lh_getToken_LH_C_0_1 = '(') || (_lh_getToken_LH_C_0_1 = ')')) then
          (let rec _lh_strToToken_LH_P2_1_4 = _lh_getToken_LH_C_1_1 in
            (let rec _lh_strToToken_LH_P2_0_4 = (`LH_C(_lh_getToken_LH_C_0_1, (`LH_N))) in
              (fun _lh_dummy_1_1_1 -> 
                (`LH_C(_lh_strToToken_LH_P2_0_4, (strToToken_lh__d1 _lh_strToToken_LH_P2_1_4))))))
        else
          (let rec _lh_matchIdent_1_8 = (restOfToken_lh__d1 _lh_getToken_LH_C_1_1) in
              ...
              | `LH_P2(_lh_getToken_LH_P2_0_1, _lh_getToken_LH_P2_1_1) -> 
                (let rec _lh_strToToken_LH_P2_1_5 = _lh_getToken_LH_P2_1_1 in
                  (let rec _lh_strToToken_LH_P2_0_5 = (`LH_C(_lh_getToken_LH_C_0_1, _lh_getToken_LH_P2_0_1)) in
                    (fun _lh_dummy_1_1_2 -> 
                      (`LH_C(_lh_strToToken_LH_P2_0_5, (strToToken_lh__d1 _lh_strToToken_LH_P2_1_5)))))))))))
and
strToToken_lh__d1 _lh_strToToken_arg1_1 =
...
let run () = 1 + (Obj.magic ((testBoyer2_nofib_lh__d1 3)));
end;;
