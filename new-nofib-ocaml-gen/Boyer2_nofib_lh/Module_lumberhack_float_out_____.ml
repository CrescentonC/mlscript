...
let rec mappend_lh__d3 xs_2 ys_3 =
  (match xs_2 with
    | `LH_C(h_2, t_2) -> 
      (`LH_C(h_2, ((mappend_lh__d3 t_2) ys_3)))
    | `LH_N -> 
      ys_3);;
...
let rec mappend_lh__d1 xs_0 ys_0 =
  (match xs_0 with
    | `LH_C(h_0, t_0) -> 
      (let rec t_1 = ((mappend_lh__d1 t_0) ys_0) in
        (let rec h_1 = h_0 in
          (fun ys_1 -> 
            (`LH_C(h_1, ((mappend_lh__d4 t_1) ys_1))))))
    | `LH_N -> 
      ys_0);;
let rec mappend_lh__d5 xs_1 ys_2 =
  (xs_1 ys_2);;
...
let rec subterm_lh__d1 _lh_subterm_arg1_0 =
  (let rec c_0 = ((mappend_lh__d5 (let rec t_3 = (fun ys_4 -> 
    ys_4) in
    (let rec h_3 = 'c' in
      (fun ys_5 -> 
        (`LH_C(h_3, ((mappend_lh__d5 t_3) ys_5))))))) (string_of_int _lh_subterm_arg1_0)) in
    (let rec str_0 = ((mappend_lh__d3 ((mappend_lh__d4 ((mappend_lh__d1 ((mappend_lh__d2 (let rec t_4 = (let rec t_5 = (let rec t_6 = (let rec t_7 = (let rec t_8 = (let rec t_9 = (let rec t_1_0 = (let rec t_1_1 = (let rec t_1_2 = (let rec t_1_3 = (let rec t_1_4 = (let rec t_1_5 = (let rec t_1_6 = (let rec t_1_7 = (let rec t_1_8 = (let rec t_1_9 = (let rec t_2_0 = (let rec t_2_1 = (let rec t_2_2 = (let rec t_2_3 = (let rec t_2_4 = (let rec t_2_5 = (let rec t_2_6 = (let rec t_2_7 = (let rec t_2_8 = (let rec t_2_9 = (let rec t_3_0 = (let rec t_3_1 = (let rec t_3_2 = (let rec t_3_3 = (let rec t_3_4 = (let rec t_3_5 = (let rec t_3_6 = (let rec t_3_7 = (fun ys_6 -> 
      ys_6) in
      (let rec h_4 = ' ' in
        (fun ys_7 -> 
          (`LH_C(h_4, ((mappend_lh__d2 t_3_7) ys_7)))))) in
      (let rec h_5 = 's' in
        (fun ys_8 -> 
          (`LH_C(h_5, ((mappend_lh__d2 t_3_6) ys_8)))))) in
      (let rec h_6 = 'u' in
        (fun ys_9 -> 
          (`LH_C(h_6, ((mappend_lh__d2 t_3_5) ys_9)))))) in
      (let rec h_7 = 'l' in
        (fun ys_1_0 -> 
          (`LH_C(h_7, ((mappend_lh__d2 t_3_4) ys_1_0)))))) in
      (let rec h_8 = 'p' in
        (fun ys_1_1 -> 
          (`LH_C(h_8, ((mappend_lh__d2 t_3_3) ys_1_1)))))) in
      (let rec h_9 = ' ' in
        (fun ys_1_2 -> 
          (`LH_C(h_9, ((mappend_lh__d2 t_3_2) ys_1_2)))))) in
      (let rec h_1_0 = '(' in
        (fun ys_1_3 -> 
          (`LH_C(h_1_0, ((mappend_lh__d2 t_3_1) ys_1_3)))))) in
      (let rec h_1_1 = ')' in
        (fun ys_1_4 -> 
          (`LH_C(h_1_1, ((mappend_lh__d2 t_3_0) ys_1_4)))))) in
      (let rec h_1_2 = ' ' in
        (fun ys_1_5 -> 
          (`LH_C(h_1_2, ((mappend_lh__d2 t_2_9) ys_1_5)))))) in
      (let rec h_1_3 = 'b' in
        (fun ys_1_6 -> 
          (`LH_C(h_1_3, ((mappend_lh__d2 t_2_8) ys_1_6)))))) in
      (let rec h_1_4 = ' ' in
        (fun ys_1_7 -> 
          (`LH_C(h_1_4, ((mappend_lh__d2 t_2_7) ys_1_7)))))) in
      (let rec h_1_5 = 'a' in
        (fun ys_1_8 -> 
          (`LH_C(h_1_5, ((mappend_lh__d2 t_2_6) ys_1_8)))))) in
      (let rec h_1_6 = ' ' in
        (fun ys_1_9 -> 
          (`LH_C(h_1_6, ((mappend_lh__d2 t_2_5) ys_1_9)))))) in
      (let rec h_1_7 = 's' in
        (fun ys_2_0 -> 
          (`LH_C(h_1_7, ((mappend_lh__d2 t_2_4) ys_2_0)))))) in
      (let rec h_1_8 = 'u' in
        (fun ys_2_1 -> 
          (`LH_C(h_1_8, ((mappend_lh__d2 t_2_3) ys_2_1)))))) in
      (let rec h_1_9 = 'l' in
        (fun ys_2_2 -> 
          (`LH_C(h_1_9, ((mappend_lh__d2 t_2_2) ys_2_2)))))) in
      (let rec h_2_0 = 'p' in
        (fun ys_2_3 -> 
          (`LH_C(h_2_0, ((mappend_lh__d2 t_2_1) ys_2_3)))))) in
      (let rec h_2_1 = ' ' in
        (fun ys_2_4 -> 
          (`LH_C(h_2_1, ((mappend_lh__d2 t_2_0) ys_2_4)))))) in
      (let rec h_2_2 = '(' in
        (fun ys_2_5 -> 
          (`LH_C(h_2_2, ((mappend_lh__d2 t_1_9) ys_2_5)))))) in
      (let rec h_2_3 = ' ' in
        (fun ys_2_6 -> 
          (`LH_C(h_2_3, ((mappend_lh__d2 t_1_8) ys_2_6)))))) in
      (let rec h_2_4 = 's' in
        (fun ys_2_7 -> 
          (`LH_C(h_2_4, ((mappend_lh__d2 t_1_7) ys_2_7)))))) in
      (let rec h_2_5 = 'u' in
        (fun ys_2_8 -> 
          (`LH_C(h_2_5, ((mappend_lh__d2 t_1_6) ys_2_8)))))) in
      (let rec h_2_6 = 'l' in
        (fun ys_2_9 -> 
          (`LH_C(h_2_6, ((mappend_lh__d2 t_1_5) ys_2_9)))))) in
      (let rec h_2_7 = 'p' in
        (fun ys_3_0 -> 
          (`LH_C(h_2_7, ((mappend_lh__d2 t_1_4) ys_3_0)))))) in
      (let rec h_2_8 = ' ' in
        (fun ys_3_1 -> 
          (`LH_C(h_2_8, ((mappend_lh__d2 t_1_3) ys_3_1)))))) in
      (let rec h_2_9 = '(' in
        (fun ys_3_2 -> 
          (`LH_C(h_2_9, ((mappend_lh__d2 t_1_2) ys_3_2)))))) in
      (let rec h_3_0 = ' ' in
        (fun ys_3_3 -> 
          (`LH_C(h_3_0, ((mappend_lh__d2 t_1_1) ys_3_3)))))) in
      (let rec h_3_1 = 'f' in
        (fun ys_3_4 -> 
          (`LH_C(h_3_1, ((mappend_lh__d2 t_1_0) ys_3_4)))))) in
      (let rec h_3_2 = ' ' in
        (fun ys_3_5 -> 
          (`LH_C(h_3_2, ((mappend_lh__d2 t_9) ys_3_5)))))) in
      (let rec h_3_3 = 'x' in
        (fun ys_3_6 -> 
          (`LH_C(h_3_3, ((mappend_lh__d2 t_8) ys_3_6)))))) in
      (let rec h_3_4 = ' ' in
        (fun ys_3_7 -> 
          (`LH_C(h_3_4, ((mappend_lh__d2 t_7) ys_3_7)))))) in
      (let rec h_3_5 = '(' in
        (fun ys_3_8 -> 
          (`LH_C(h_3_5, ((mappend_lh__d2 t_6) ys_3_8)))))) in
      (let rec h_3_6 = ' ' in
        (fun ys_3_9 -> 
          (`LH_C(h_3_6, ((mappend_lh__d2 t_5) ys_3_9)))))) in
      (let rec h_3_7 = '(' in
        (fun ys_4_0 -> 
          (`LH_C(h_3_7, ((mappend_lh__d2 t_4) ys_4_0))))))) c_0)) (let rec t_3_8 = (let rec t_3_9 = (let rec t_4_0 = (let rec t_4_1 = (let rec t_4_2 = (let rec t_4_3 = (let rec t_4_4 = (let rec t_4_5 = (let rec t_4_6 = (let rec t_4_7 = (let rec t_4_8 = (let rec t_4_9 = (let rec t_5_0 = (let rec t_5_1 = (let rec t_5_2 = (let rec t_5_3 = (let rec t_5_4 = (let rec t_5_5 = (let rec t_5_6 = (let rec t_5_7 = (let rec t_5_8 = (let rec t_5_9 = (let rec t_6_0 = (let rec t_6_1 = (let rec t_6_2 = (let rec t_6_3 = (let rec t_6_4 = (let rec t_6_5 = (let rec t_6_6 = (let rec t_6_7 = (let rec t_6_8 = (let rec t_6_9 = (let rec t_7_0 = (let rec t_7_1 = (let rec t_7_2 = (let rec t_7_3 = (let rec t_7_4 = (let rec t_7_5 = (let rec t_7_6 = (let rec t_7_7 = (let rec t_7_8 = (let rec t_7_9 = (let rec t_8_0 = (let rec t_8_1 = (let rec t_8_2 = (let rec t_8_3 = (let rec t_8_4 = (let rec t_8_5 = (let rec t_8_6 = (fun ys_4_1 -> 
      ys_4_1) in
      (let rec h_3_8 = ' ' in
        (fun ys_4_2 -> 
                                          ...
                                          | `LH_N -> 
                                            (if (truep_lh__d3 (`LH_P2((car_lh__d1 _lh_tautologyp_LH_P2_1_0), _lh_tautologyp_LH_P3_1_0))) then
                                              ...
                                              (if (falsep_lh__d1 (`LH_P2((car_lh__d2 _lh_tautologyp_LH_P2_1_0), _lh_tautologyp_LH_P3_2_0))) then
                                                (tautologyp_lh__d1 (`LH_P3((caddr_lh__d1 _lh_tautologyp_LH_P2_1_0), _lh_tautologyp_LH_P3_1_0, _lh_tautologyp_LH_P3_2_0)))
                                              else
                                                ((tautologyp_lh__d1 (`LH_P3((cadr_lh__d2 _lh_tautologyp_LH_P2_1_0), (`Cons((`LH_P2((car_lh__d3 _lh_tautologyp_LH_P2_1_0), _lh_tautologyp_LH_P3_1_0)))), _lh_tautologyp_LH_P3_2_0))) && (tautologyp_lh__d1 (`LH_P3((caddr_lh__d2 _lh_tautologyp_LH_P2_1_0), _lh_tautologyp_LH_P3_1_0, (`Cons((`LH_P2((car_lh__d4 _lh_tautologyp_LH_P2_1_0), _lh_tautologyp_LH_P3_2_0))))))))))
                                          | _ -> 
                                            false)
                                      | _ -> 
                                        false)
