...
let rec cdr_lh__d3 _lh_cdr_arg1_0 =
  (match _lh_cdr_arg1_0 with
    ...
    | _ -> 
      (`Nil));;
let rec car_lh__d6 _lh_car_arg1_0 =
...
let rec caddr_lh__d3 _lh_caddr_arg1_0 =
  ((fun _lh_funcomp_x_0 -> 
    ((fun _lh_funcomp_x_1 -> 
      (car_lh__d6 (cdr_lh__d3 _lh_funcomp_x_1))) (cdr_lh__d3 _lh_funcomp_x_0))) _lh_caddr_arg1_0);;
        ...
        | `Cons(_lh_assoc_Cons_0_0) -> 
          (match _lh_assoc_Cons_0_0 with
            | `LH_P2(_lh_assoc_LH_P2_0_1, _lh_assoc_LH_P2_1_1) -> 
              (let rec _lh_matchIdent_2_5 = _lh_assoc_LH_P2_0_1 in
...
let rec onewayunify1_lh__d1 _lh_onewayunify1_arg1_0 _lh_onewayunify1_arg2_0 _lh_onewayunify1_arg3_0 =
  (if (atom_lh__d1 _lh_onewayunify1_arg2_0) then
    (let rec _lh_matchIdent_1 = (assoc_lh__d1 (`LH_P2(_lh_onewayunify1_arg2_0, _lh_onewayunify1_arg3_0))) in
...
onewayunify1lst_lh__d1 _lh_onewayunify1lst_arg1_0 _lh_onewayunify1lst_arg2_0 _lh_onewayunify1lst_arg3_0 =
  (match _lh_onewayunify1lst_arg1_0 with
    ...
    | _ -> 
      (let rec _lh_matchIdent_0 = (((onewayunify1_lh__d1 (car_lh__d6 _lh_onewayunify1lst_arg1_0)) (car_lh__d6 _lh_onewayunify1lst_arg2_0)) _lh_onewayunify1lst_arg3_0) in
...
let rec applysubst_lh__d2 _lh_applysubst_arg1_0 _lh_applysubst_arg2_0 =
  (match _lh_applysubst_arg2_0 with
    ...
    | `Atom(_lh_applysubst_Atom_0_0) -> 
      (let rec _lh_matchIdent_3 = (assoc_lh__d1 (`LH_P2((`Atom(_lh_applysubst_Atom_0_0)), _lh_applysubst_arg1_0))) in
  ...
  (match _lh_restOfToken_arg1_0 with
    ...
    | `LH_C(_lh_restOfToken_LH_C_0_0, _lh_restOfToken_LH_C_1_0) -> 
      (if (((_lh_restOfToken_LH_C_0_0 = '(') || (_lh_restOfToken_LH_C_0_0 = ')')) || (_lh_restOfToken_LH_C_0_0 = ' ')) then
        ...
        (let rec _lh_matchIdent_2 = (restOfToken_lh__d1 _lh_restOfToken_LH_C_1_0) in
    ...
    | `LH_C(_lh_getToken_LH_C_0_0, _lh_getToken_LH_C_1_0) -> 
      (if (_lh_getToken_LH_C_0_0 = ' ') then
        ...
        (if ((_lh_getToken_LH_C_0_0 = '(') || (_lh_getToken_LH_C_0_0 = ')')) then
          ...
          (let rec _lh_matchIdent_1_0 = (restOfToken_lh__d1 _lh_getToken_LH_C_1_0) in
...
let rec strToToken_lh__d2 _lh_strToToken_arg1_0 =
  (match _lh_strToToken_arg1_0 with
    | `LH_N -> 
      (`LH_N)
    | _ -> 
      (let rec _lh_matchIdent_2_1 = (getToken_lh__d2 _lh_strToToken_arg1_0) in
...
let rec sublist_lh__d2 _lh_sublist_arg1_0 =
  (match _lh_sublist_arg1_0 with
    ...
    | `LH_C(_lh_sublist_LH_C_0_0, _lh_sublist_LH_C_1_0) -> 
      (match _lh_sublist_LH_C_0_0 with
          ...
          (match _lh_sublist_LH_C_0_1 with
            | '(' -> 
              (match _lh_sublist_LH_C_1_1 with
                | `LH_N -> 
                  (let rec _lh_matchIdent_4 = (sublist_lh__d2 _lh_sublist_LH_C_1_0) in
                    (match _lh_matchIdent_4 with
                      | `LH_P2(_lh_sublist_LH_P2_0_0, _lh_sublist_LH_P2_1_0) -> 
                        (let rec _lh_matchIdent_5 = (sublist_lh__d2 _lh_sublist_LH_P2_0_0) in
                ...
                | _ -> 
                  (let rec _lh_matchIdent_6 = (sublist_lh__d2 _lh_sublist_LH_C_1_0) in
            ...
            | ')' -> 
              (match _lh_sublist_LH_C_1_1 with
                ...
                | _ -> 
                  (let rec _lh_matchIdent_7 = (sublist_lh__d2 _lh_sublist_LH_C_1_0) in
            ...
            | _ -> 
              (let rec _lh_matchIdent_8 = (sublist_lh__d2 _lh_sublist_LH_C_1_0) in
        ...
        | _ -> 
          (let rec _lh_matchIdent_9 = (sublist_lh__d2 _lh_sublist_LH_C_1_0) in
          ...
          (match _lh_mkLisplist_LH_C_0_1 with
            | '(' -> 
              (match _lh_mkLisplist_LH_C_1_1 with
                | `LH_N -> 
                  (let rec _lh_matchIdent_1_9 = (sublist_lh__d2 _lh_mkLisplist_LH_C_1_0) in
                    (match _lh_matchIdent_1_9 with
                      | `LH_P2(_lh_mkLisplist_LH_P2_0_0, _lh_mkLisplist_LH_P2_1_0) -> 
                        (let rec _lh_matchIdent_2_0 = _lh_mkLisplist_LH_P2_0_0 in
  ...
  (match _lh_lispmember_arg1_3 with
    | `LH_P2(_lh_lispmember_LH_P2_0_6, _lh_lispmember_LH_P2_1_6) -> 
      (match _lh_lispmember_LH_P2_1_6 with
        ...
        | _ -> 
          false));;
let rec lispmember_lh__d2_d4 _lh_lispmember_arg1_1 =
          ...
          (match _lh_lispmember_Cons_0_1 with
            | `LH_P2(_lh_lispmember_LH_P2_0_3, _lh_lispmember_LH_P2_1_3) -> 
              (if (_lh_lispmember_LH_P2_0_2 = _lh_lispmember_LH_P2_0_3) then
                ...
                (lispmember_lh__d2_d4 (`LH_P2(_lh_lispmember_LH_P2_0_2, _lh_lispmember_LH_P2_1_3))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d2_d3 _lh_lispmember_arg1_2 =
          ...
          (match _lh_lispmember_Cons_0_2 with
            | `LH_P2(_lh_lispmember_LH_P2_0_5, _lh_lispmember_LH_P2_1_5) -> 
              (if (_lh_lispmember_LH_P2_0_4 = _lh_lispmember_LH_P2_0_5) then
                ...
                (lispmember_lh__d2_d3 (`LH_P2(_lh_lispmember_LH_P2_0_4, _lh_lispmember_LH_P2_1_5))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d2_d5 _lh_lispmember_arg1_0 =
          ...
          (match _lh_lispmember_Cons_0_0 with
            | `LH_P2(_lh_lispmember_LH_P2_0_1, _lh_lispmember_LH_P2_1_1) -> 
              (if (_lh_lispmember_LH_P2_0_0 = _lh_lispmember_LH_P2_0_1) then
                ...
                (lispmember_lh__d2_d5 (`LH_P2(_lh_lispmember_LH_P2_0_0, _lh_lispmember_LH_P2_1_1))))
            | _ -> 
              false)
        | _ -> 
          false));;
  ...
  (match _lh_truep_arg1_0 with
    | `LH_P2(_lh_truep_LH_P2_0_0, _lh_truep_LH_P2_1_0) -> 
      (match _lh_truep_LH_P2_0_0 with
        ...
        | _ -> 
          (lispmember_lh__d2_d5 (`LH_P2(_lh_truep_LH_P2_0_0, _lh_truep_LH_P2_1_0)))));;
let rec lispmember_lh__d1_d6 _lh_lispmember_arg1_9 =
          ...
          (match _lh_lispmember_Cons_0_9 with
            | `LH_P2(_lh_lispmember_LH_P2_0_1_9, _lh_lispmember_LH_P2_1_1_9) -> 
              (if (_lh_lispmember_LH_P2_0_1_8 = _lh_lispmember_LH_P2_0_1_9) then
                ...
                (lispmember_lh__d1_d6 (`LH_P2(_lh_lispmember_LH_P2_0_1_8, _lh_lispmember_LH_P2_1_1_9))))
            | _ -> 
              false)
        | _ -> 
          false));;
  ...
  (match _lh_lispmember_arg1_7 with
    | `LH_P2(_lh_lispmember_LH_P2_0_1_4, _lh_lispmember_LH_P2_1_1_4) -> 
      (match _lh_lispmember_LH_P2_1_1_4 with
        ...
        | _ -> 
          false));;
let rec lispmember_lh__d2_d1 _lh_lispmember_arg1_4 =
          ...
          (match _lh_lispmember_Cons_0_4 with
            | `LH_P2(_lh_lispmember_LH_P2_0_9, _lh_lispmember_LH_P2_1_9) -> 
              (if (_lh_lispmember_LH_P2_0_8 = _lh_lispmember_LH_P2_0_9) then
                ...
                (lispmember_lh__d2_d1 (`LH_P2(_lh_lispmember_LH_P2_0_8, _lh_lispmember_LH_P2_1_9))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d1_d7 _lh_lispmember_arg1_8 =
          ...
          (match _lh_lispmember_Cons_0_8 with
            | `LH_P2(_lh_lispmember_LH_P2_0_1_7, _lh_lispmember_LH_P2_1_1_7) -> 
              (if (_lh_lispmember_LH_P2_0_1_6 = _lh_lispmember_LH_P2_0_1_7) then
                ...
                (lispmember_lh__d1_d7 (`LH_P2(_lh_lispmember_LH_P2_0_1_6, _lh_lispmember_LH_P2_1_1_7))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d1_d9 _lh_lispmember_arg1_6 =
          ...
          (match _lh_lispmember_Cons_0_6 with
            | `LH_P2(_lh_lispmember_LH_P2_0_1_3, _lh_lispmember_LH_P2_1_1_3) -> 
              (if (_lh_lispmember_LH_P2_0_1_2 = _lh_lispmember_LH_P2_0_1_3) then
                ...
                (lispmember_lh__d1_d9 (`LH_P2(_lh_lispmember_LH_P2_0_1_2, _lh_lispmember_LH_P2_1_1_3))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d2_d0 _lh_lispmember_arg1_5 =
          ...
          (match _lh_lispmember_Cons_0_5 with
            | `LH_P2(_lh_lispmember_LH_P2_0_1_1, _lh_lispmember_LH_P2_1_1_1) -> 
              (if (_lh_lispmember_LH_P2_0_1_0 = _lh_lispmember_LH_P2_0_1_1) then
                ...
                (lispmember_lh__d2_d0 (`LH_P2(_lh_lispmember_LH_P2_0_1_0, _lh_lispmember_LH_P2_1_1_1))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d1_d5 _lh_lispmember_arg1_1_0 =
          ...
          (match _lh_lispmember_Cons_0_1_0 with
            | `LH_P2(_lh_lispmember_LH_P2_0_2_1, _lh_lispmember_LH_P2_1_2_1) -> 
              (if (_lh_lispmember_LH_P2_0_2_0 = _lh_lispmember_LH_P2_0_2_1) then
                ...
                (lispmember_lh__d1_d5 (`LH_P2(_lh_lispmember_LH_P2_0_2_0, _lh_lispmember_LH_P2_1_2_1))))
            | _ -> 
              false)
        | _ -> 
          false));;
...
let rec lispmember_lh__d9 _lh_lispmember_arg1_1_6 =
          ...
          (match _lh_lispmember_Cons_0_1_6 with
            | `LH_P2(_lh_lispmember_LH_P2_0_3_3, _lh_lispmember_LH_P2_1_3_3) -> 
              (if (_lh_lispmember_LH_P2_0_3_2 = _lh_lispmember_LH_P2_0_3_3) then
                ...
                (lispmember_lh__d9 (`LH_P2(_lh_lispmember_LH_P2_0_3_2, _lh_lispmember_LH_P2_1_3_3))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d1_d0 _lh_lispmember_arg1_1_5 =
          ...
          (match _lh_lispmember_Cons_0_1_5 with
            | `LH_P2(_lh_lispmember_LH_P2_0_3_1, _lh_lispmember_LH_P2_1_3_1) -> 
              (if (_lh_lispmember_LH_P2_0_3_0 = _lh_lispmember_LH_P2_0_3_1) then
                ...
                (lispmember_lh__d1_d0 (`LH_P2(_lh_lispmember_LH_P2_0_3_0, _lh_lispmember_LH_P2_1_3_1))))
            | _ -> 
              false)
        | _ -> 
          false));;
  ...
  (match _lh_lispmember_arg1_1_1 with
    | `LH_P2(_lh_lispmember_LH_P2_0_2_2, _lh_lispmember_LH_P2_1_2_2) -> 
      (match _lh_lispmember_LH_P2_1_2_2 with
        ...
        | _ -> 
          false));;
let rec lispmember_lh__d1_d3 _lh_lispmember_arg1_1_2 =
          ...
          (match _lh_lispmember_Cons_0_1_2 with
            | `LH_P2(_lh_lispmember_LH_P2_0_2_5, _lh_lispmember_LH_P2_1_2_5) -> 
              (if (_lh_lispmember_LH_P2_0_2_4 = _lh_lispmember_LH_P2_0_2_5) then
                ...
                (lispmember_lh__d1_d3 (`LH_P2(_lh_lispmember_LH_P2_0_2_4, _lh_lispmember_LH_P2_1_2_5))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d8 _lh_lispmember_arg1_1_7 =
          ...
          (match _lh_lispmember_Cons_0_1_7 with
            | `LH_P2(_lh_lispmember_LH_P2_0_3_5, _lh_lispmember_LH_P2_1_3_5) -> 
              (if (_lh_lispmember_LH_P2_0_3_4 = _lh_lispmember_LH_P2_0_3_5) then
                ...
                (lispmember_lh__d8 (`LH_P2(_lh_lispmember_LH_P2_0_3_4, _lh_lispmember_LH_P2_1_3_5))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d1_d1 _lh_lispmember_arg1_1_4 =
          ...
          (match _lh_lispmember_Cons_0_1_4 with
            | `LH_P2(_lh_lispmember_LH_P2_0_2_9, _lh_lispmember_LH_P2_1_2_9) -> 
              (if (_lh_lispmember_LH_P2_0_2_8 = _lh_lispmember_LH_P2_0_2_9) then
                ...
                (lispmember_lh__d1_d1 (`LH_P2(_lh_lispmember_LH_P2_0_2_8, _lh_lispmember_LH_P2_1_2_9))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d1_d2 _lh_lispmember_arg1_1_3 =
          ...
          (match _lh_lispmember_Cons_0_1_3 with
            | `LH_P2(_lh_lispmember_LH_P2_0_2_7, _lh_lispmember_LH_P2_1_2_7) -> 
              (if (_lh_lispmember_LH_P2_0_2_6 = _lh_lispmember_LH_P2_0_2_7) then
                ...
                (lispmember_lh__d1_d2 (`LH_P2(_lh_lispmember_LH_P2_0_2_6, _lh_lispmember_LH_P2_1_2_7))))
            | _ -> 
              false)
        | _ -> 
          false));;
                            ...
                            | `LH_N -> 
                              (match _lh_falsep_LH_P2_1_3 with
                                | `Nil -> 
                                  true
                                | _ -> 
                                  (lispmember_lh__d1_d0 (`LH_P2(_lh_falsep_LH_P2_0_2, _lh_falsep_LH_P2_1_2))))
                            | _ -> 
                              (lispmember_lh__d1_d4 (`LH_P2(_lh_falsep_LH_P2_0_2, _lh_falsep_LH_P2_1_2))))
                        | _ -> 
                          (lispmember_lh__d1_d1 (`LH_P2(_lh_falsep_LH_P2_0_2, _lh_falsep_LH_P2_1_2))))
                    | _ -> 
                      (lispmember_lh__d1_d3 (`LH_P2(_lh_falsep_LH_P2_0_2, _lh_falsep_LH_P2_1_2))))
                | _ -> 
                  (lispmember_lh__d1_d2 (`LH_P2(_lh_falsep_LH_P2_0_2, _lh_falsep_LH_P2_1_2))))
            | _ -> 
              (lispmember_lh__d9 (`LH_P2(_lh_falsep_LH_P2_0_2, _lh_falsep_LH_P2_1_2))))
        | _ -> 
          (lispmember_lh__d8 (`LH_P2(_lh_falsep_LH_P2_0_2, _lh_falsep_LH_P2_1_2)))));;
let rec car_lh__d2 _lh_car_arg1_4 =
...
let rec car_lh__d3 _lh_car_arg1_3 =
  (match _lh_car_arg1_3 with
    ...
    | _ -> 
      (`Nil));;
let rec car_lh__d1 _lh_car_arg1_5 =
  (match _lh_car_arg1_5 with
    ...
    | _ -> 
      (`Nil));;
let rec lispmember_lh__d6 _lh_lispmember_arg1_1_9 =
          ...
          (match _lh_lispmember_Cons_0_1_9 with
            | `LH_P2(_lh_lispmember_LH_P2_0_3_9, _lh_lispmember_LH_P2_1_3_9) -> 
              (if (_lh_lispmember_LH_P2_0_3_8 = _lh_lispmember_LH_P2_0_3_9) then
                ...
                (lispmember_lh__d6 (`LH_P2(_lh_lispmember_LH_P2_0_3_8, _lh_lispmember_LH_P2_1_3_9))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d3 _lh_lispmember_arg1_2_2 =
          ...
          (match _lh_lispmember_Cons_0_2_2 with
            | `LH_P2(_lh_lispmember_LH_P2_0_4_5, _lh_lispmember_LH_P2_1_4_5) -> 
              (if (_lh_lispmember_LH_P2_0_4_4 = _lh_lispmember_LH_P2_0_4_5) then
                ...
                (lispmember_lh__d3 (`LH_P2(_lh_lispmember_LH_P2_0_4_4, _lh_lispmember_LH_P2_1_4_5))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d1 _lh_lispmember_arg1_2_4 =
          ...
          (match _lh_lispmember_Cons_0_2_4 with
            | `LH_P2(_lh_lispmember_LH_P2_0_4_9, _lh_lispmember_LH_P2_1_4_9) -> 
              (if (_lh_lispmember_LH_P2_0_4_8 = _lh_lispmember_LH_P2_0_4_9) then
                ...
                (lispmember_lh__d1 (`LH_P2(_lh_lispmember_LH_P2_0_4_8, _lh_lispmember_LH_P2_1_4_9))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d5 _lh_lispmember_arg1_2_0 =
          ...
          (match _lh_lispmember_Cons_0_2_0 with
            | `LH_P2(_lh_lispmember_LH_P2_0_4_1, _lh_lispmember_LH_P2_1_4_1) -> 
              (if (_lh_lispmember_LH_P2_0_4_0 = _lh_lispmember_LH_P2_0_4_1) then
                ...
                (lispmember_lh__d5 (`LH_P2(_lh_lispmember_LH_P2_0_4_0, _lh_lispmember_LH_P2_1_4_1))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d7 _lh_lispmember_arg1_1_8 =
          ...
          (match _lh_lispmember_Cons_0_1_8 with
            | `LH_P2(_lh_lispmember_LH_P2_0_3_7, _lh_lispmember_LH_P2_1_3_7) -> 
              (if (_lh_lispmember_LH_P2_0_3_6 = _lh_lispmember_LH_P2_0_3_7) then
                ...
                (lispmember_lh__d7 (`LH_P2(_lh_lispmember_LH_P2_0_3_6, _lh_lispmember_LH_P2_1_3_7))))
            | _ -> 
              false)
        | _ -> 
          false));;
let rec lispmember_lh__d2 _lh_lispmember_arg1_2_3 =
          ...
          (match _lh_lispmember_Cons_0_2_3 with
            | `LH_P2(_lh_lispmember_LH_P2_0_4_7, _lh_lispmember_LH_P2_1_4_7) -> 
              (if (_lh_lispmember_LH_P2_0_4_6 = _lh_lispmember_LH_P2_0_4_7) then
                ...
                (lispmember_lh__d2 (`LH_P2(_lh_lispmember_LH_P2_0_4_6, _lh_lispmember_LH_P2_1_4_7))))
            | _ -> 
              false)
        | _ -> 
          false));;
                            ...
                            | `LH_N -> 
                              (match _lh_falsep_LH_P2_1_1 with
                                | `Nil -> 
                                  true
                                | _ -> 
                                  (lispmember_lh__d2_d5 (`LH_P2(_lh_falsep_LH_P2_0_0, _lh_falsep_LH_P2_1_0))))
                            | _ -> 
                              (lispmember_lh__d2_d5 (`LH_P2(_lh_falsep_LH_P2_0_0, _lh_falsep_LH_P2_1_0))))
                        | _ -> 
                          (lispmember_lh__d2_d5 (`LH_P2(_lh_falsep_LH_P2_0_0, _lh_falsep_LH_P2_1_0))))
...
let rec caddr_lh__d2 _lh_caddr_arg1_1 =
  ((fun _lh_funcomp_x_4 -> 
    ((fun _lh_funcomp_x_5 -> 
      (car_lh__d6 (cdr_lh__d3 _lh_funcomp_x_5))) (cdr_lh__d3 _lh_funcomp_x_4))) _lh_caddr_arg1_1);;
let rec cdr_lh__d2 _lh_cdr_arg1_1 =
...
let rec caddr_lh__d1 _lh_caddr_arg1_2 =
  ((fun _lh_funcomp_x_6 -> 
    ((fun _lh_funcomp_x_7 -> 
      (car_lh__d6 (cdr_lh__d2 _lh_funcomp_x_7))) (cdr_lh__d3 _lh_funcomp_x_6))) _lh_caddr_arg1_2);;
let rec car_lh__d4 _lh_car_arg1_2 =
...
let rec car_lh__d5 _lh_car_arg1_1 =
  (match _lh_car_arg1_1 with
    ...
    | _ -> 
      (`Nil));;
let rec cdr_lh__d1 _lh_cdr_arg1_2 =
...
let rec cadr_lh__d1 _lh_cadr_arg1_2 =
  ((fun _lh_funcomp_x_8 -> 
    (car_lh__d5 (cdr_lh__d1 _lh_funcomp_x_8))) _lh_cadr_arg1_2);;
let rec cadr_lh__d2 _lh_cadr_arg1_1 =
  ((fun _lh_funcomp_x_3 -> 
    (car_lh__d6 (cdr_lh__d3 _lh_funcomp_x_3))) _lh_cadr_arg1_1);;
            ...
            | `LH_P2(_lh_tautologyp_LH_P2_0_0, _lh_tautologyp_LH_P2_1_0) -> 
              (if (truep_lh__d3 (`LH_P2((`Cons((`LH_P2(_lh_tautologyp_LH_P2_0_0, _lh_tautologyp_LH_P2_1_0)))), _lh_tautologyp_LH_P3_1_0))) then
                ...
                (if (falsep_lh__d2 (`LH_P2((`Cons((`LH_P2(_lh_tautologyp_LH_P2_0_0, _lh_tautologyp_LH_P2_1_0)))), _lh_tautologyp_LH_P3_2_0))) then
                  ...
                  (let rec _lh_matchIdent_2_6 = _lh_tautologyp_LH_P2_0_0 in
...
let rec sublist_lh__d1 _lh_sublist_arg1_1 =
  (match _lh_sublist_arg1_1 with
    ...
    | `LH_C(_lh_sublist_LH_C_0_2, _lh_sublist_LH_C_1_2) -> 
      (match _lh_sublist_LH_C_0_2 with
          ...
          (match _lh_sublist_LH_C_0_3 with
            | '(' -> 
              (match _lh_sublist_LH_C_1_3 with
                | `LH_N -> 
                  (let rec _lh_matchIdent_1_2 = (sublist_lh__d1 _lh_sublist_LH_C_1_2) in
                    (match _lh_matchIdent_1_2 with
                      | `LH_P2(_lh_sublist_LH_P2_0_6, _lh_sublist_LH_P2_1_6) -> 
                        (let rec _lh_matchIdent_1_3 = (sublist_lh__d1 _lh_sublist_LH_P2_0_6) in
                ...
                | _ -> 
                  (let rec _lh_matchIdent_1_4 = (sublist_lh__d1 _lh_sublist_LH_C_1_2) in
            ...
            | ')' -> 
              (match _lh_sublist_LH_C_1_3 with
                ...
                | _ -> 
                  (let rec _lh_matchIdent_1_5 = (sublist_lh__d1 _lh_sublist_LH_C_1_2) in
            ...
            | _ -> 
              (let rec _lh_matchIdent_1_6 = (sublist_lh__d1 _lh_sublist_LH_C_1_2) in
        ...
        | _ -> 
          (let rec _lh_matchIdent_1_7 = (sublist_lh__d1 _lh_sublist_LH_C_1_2) in
          ...
          (match _lh_mkLisplist_LH_C_0_3 with
            | '(' -> 
              (match _lh_mkLisplist_LH_C_1_3 with
                | `LH_N -> 
                  (let rec _lh_matchIdent_2_3 = (sublist_lh__d1 _lh_mkLisplist_LH_C_1_2) in
                    (match _lh_matchIdent_2_3 with
                      | `LH_P2(_lh_mkLisplist_LH_P2_0_1, _lh_mkLisplist_LH_P2_1_1) -> 
                        (let rec _lh_matchIdent_2_4 = _lh_mkLisplist_LH_P2_0_1 in
    ...
    | `LH_C(_lh_getToken_LH_C_0_1, _lh_getToken_LH_C_1_1) -> 
      (if (_lh_getToken_LH_C_0_1 = ' ') then
        ...
        (if ((_lh_getToken_LH_C_0_1 = '(') || (_lh_getToken_LH_C_0_1 = ')')) then
          ...
          (let rec _lh_matchIdent_1_1 = (restOfToken_lh__d1 _lh_getToken_LH_C_1_1) in
...
let rec strToToken_lh__d1 _lh_strToToken_arg1_1 =
  (match _lh_strToToken_arg1_1 with
    | `LH_N -> 
      (`LH_N)
    | _ -> 
      (let rec _lh_matchIdent_2_2 = (getToken_lh__d1 _lh_strToToken_arg1_1) in
...
let rec subterm_lh__d1 _lh_subterm_arg1_0 =
  (let rec c_0 = ((mappend_lh__d2 (`LH_C('c', (`LH_N)))) (string_of_int _lh_subterm_arg1_0)) in
    (let rec str_0 = ((mappend_lh__d1 ((mappend_lh__d4 ((mappend_lh__d3 ((mappend_lh__d5 (`LH_C('(', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('x', (`LH_C(' ', (`LH_C('f', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('p', (`LH_C('l', (`LH_C('u', (`LH_C('s', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('p', (`LH_C('l', (`LH_C('u', (`LH_C('s', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('b', (`LH_C(' ', (`LH_C(')', (`LH_C('(', (`LH_C(' ', (`LH_C('p', (`LH_C('l', (`LH_C('u', (`LH_C('s', (`LH_C(' ', (`LH_N)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) c_0)) (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('z', (`LH_C('e', (`LH_C('r', (`LH_C('o', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C('(', (`LH_C(' ', (`LH_C('y', (`LH_C(' ', (`LH_C('f', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('t', (`LH_C('i', (`LH_C('m', (`LH_C('e', (`LH_C('s', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('t', (`LH_C('i', (`LH_C('m', (`LH_C('e', (`LH_C('s', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('b', (`LH_C(' ', (`LH_C(')', (`LH_C('(', (`LH_C(' ', (`LH_C('p', (`LH_C('l', (`LH_C('u', (`LH_C('s', (`LH_C(' ', (`LH_N))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) c_0)) (`LH_C(' ', (`LH_C('d', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C('(', (`LH_C(' ', (`LH_C('z', (`LH_C(' ', (`LH_C('f', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('r', (`LH_C('e', (`LH_C('v', (`LH_C('e', (`LH_C('r', (`LH_C('s', (`LH_C('e', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('a', (`LH_C('p', (`LH_C('p', (`LH_C('e', (`LH_C('n', (`LH_C('d', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('a', (`LH_C('p', (`LH_C('p', (`LH_C('e', (`LH_C('n', (`LH_C('d', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('b', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('[', (`LH_C(']', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C('(', (`LH_C('u', (`LH_C(' ', (`LH_C('e', (`LH_C('q', (`LH_C('u', (`LH_C('a', (`LH_C('l', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('p', (`LH_C('l', (`LH_C('u', (`LH_C('s', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('b', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('d', (`LH_C('i', (`LH_C('f', (`LH_C('f', (`LH_C('e', (`LH_C('r', (`LH_C('e', (`LH_C('n', (`LH_C('c', (`LH_C('e', (`LH_C(' ', (`LH_C('x', (`LH_C(' ', (`LH_C('y', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C('(', (`LH_C('w', (`LH_C(' ', (`LH_C('l', (`LH_C('e', (`LH_C('s', (`LH_C('s', (`LH_C('p', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('r', (`LH_C('e', (`LH_C('m', (`LH_C('a', (`LH_C('i', (`LH_C('n', (`LH_C('d', (`LH_C('e', (`LH_C('r', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('b', (`LH_C(' ', (`LH_C(')', (`LH_C('(', (`LH_C(' ', (`LH_C('m', (`LH_C('e', (`LH_C('m', (`LH_C('b', (`LH_C('e', (`LH_C('r', (`LH_C(' ', (`LH_C('a', (`LH_C(' ', (`LH_C('(', (`LH_C(' ', (`LH_C('l', (`LH_C('e', (`LH_C('n', (`LH_C('g', (`LH_C('t', (`LH_C('h', (`LH_C(' ', (`LH_C('b', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_C(' ', (`LH_C(')', (`LH_N)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) in
