            ...
            | `Leaf(_lh_join_Leaf_0_0, _lh_join_Leaf_1_0) -> 
              (match _lh_join_Leaf_1_0 with
                | `LH_P3(_lh_join_LH_P3_0_4, _lh_join_LH_P3_1_4, _lh_join_LH_P3_2_4) -> 
                  (let rec _lh_matchIdent_4 = ((lookupT_lh__d1 _lh_join_LH_P3_2_4) _lh_join_arg2_0) in
                    ((((_lh_matchIdent_4 _lh_join_arg3_3) _lh_join_LH_P3_0_4) _lh_join_LH_P3_1_4) _lh_join_LH_P3_2_4))
                | _ -> 
                  (match _lh_join_arg1_0 with
  ...
  (match _lh_dropWhile_arg2_1 with
    ...
    | `LH_C(_lh_dropWhile_LH_C_0_1, _lh_dropWhile_LH_C_1_1) -> 
      (if (_lh_dropWhile_arg1_1 _lh_dropWhile_LH_C_0_1) then
        ...
        (`LH_C(_lh_dropWhile_LH_C_0_1, _lh_dropWhile_LH_C_1_1))));;
let rec dropWhile_lh__d2 _lh_dropWhile_arg1_2 _lh_dropWhile_arg2_2 =
  (match _lh_dropWhile_arg2_2 with
    ...
    | `LH_C(_lh_dropWhile_LH_C_0_2, _lh_dropWhile_LH_C_1_2) -> 
      (if (_lh_dropWhile_arg1_2 _lh_dropWhile_LH_C_0_2) then
        ((dropWhile_lh__d2 _lh_dropWhile_arg1_2) _lh_dropWhile_LH_C_1_2)
      else
        (`LH_C(_lh_dropWhile_LH_C_0_2, _lh_dropWhile_LH_C_1_2))));;
    ...
    (match _lh_readInt'_arg2_2 with
      | `LH_C(_lh_readInt'_LH_C_0_2, _lh_readInt'_LH_C_1_2) -> 
        (if (isDigit_lh__d1 _lh_readInt'_LH_C_0_2) then
          ...
          (let rec s'_4 = ((dropWhile_lh__d1 isSpace_lh__d2) (`LH_C(_lh_readInt'_LH_C_0_2, _lh_readInt'_LH_C_1_2))) in
            (let rec _lh_readTree_LH_P2_1_4 = s'_4 in
              (let rec _lh_readTree_LH_P2_0_1_2 = _lh_readInt'_arg1_2 in
                (fun _lh_readTree_LH_P2_0_1_3 _lh_readTree_arg1_6 _lh_readTree_arg3_6 -> 
                  (let rec _lh_matchIdent_5 = (readInt_lh__d2 _lh_readTree_LH_P2_1_4) in
                    ((((_lh_matchIdent_5 _lh_readTree_LH_P2_0_1_3) _lh_readTree_LH_P2_0_1_2) _lh_readTree_arg1_6) _lh_readTree_arg3_6)))))))
      | _ -> 
        (let rec s'_5 = ((dropWhile_lh__d2 isSpace_lh__d1) _lh_readInt'_arg2_2) in
          (let rec _lh_readTree_LH_P2_1_5 = s'_5 in
            (let rec _lh_readTree_LH_P2_0_1_4 = _lh_readInt'_arg1_2 in
              (fun _lh_readTree_LH_P2_0_1_5 _lh_readTree_arg1_7 _lh_readTree_arg3_7 -> 
                (let rec _lh_matchIdent_6 = (readInt_lh__d2 _lh_readTree_LH_P2_1_5) in
                  ((((_lh_matchIdent_6 _lh_readTree_LH_P2_0_1_5) _lh_readTree_LH_P2_0_1_4) _lh_readTree_arg1_7) _lh_readTree_arg3_7)))))))) in
    ...
    (match _lh_readInt'_arg2_0 with
      | `LH_C(_lh_readInt'_LH_C_0_0, _lh_readInt'_LH_C_1_0) -> 
        (if (isDigit_lh__d1 _lh_readInt'_LH_C_0_0) then
          ...
          (let rec s'_0 = ((dropWhile_lh__d3 isSpace_lh__d2) (`LH_C(_lh_readInt'_LH_C_0_0, _lh_readInt'_LH_C_1_0))) in
            (let rec _lh_readTree_LH_P2_1_0 = s'_0 in
              (let rec _lh_readTree_LH_P2_0_0 = _lh_readInt'_arg1_0 in
                (fun _lh_readTree_LH_P2_0_1 _lh_readTree_LH_P2_0_2 _lh_readTree_arg1_0 _lh_readTree_arg3_0 -> 
                  (let rec e_0 = (`LH_P3(_lh_readTree_LH_P2_0_1, _lh_readTree_LH_P2_0_2, _lh_readTree_LH_P2_0_0)) in
                    (let rec k_0 = (_lh_readTree_arg1_0 e_0) in
                      (((readTree_lh__d1 _lh_readTree_arg1_0) _lh_readTree_LH_P2_1_0) (((insertT_lh__d1 k_0) e_0) _lh_readTree_arg3_0)))))))))
      | _ -> 
        (let rec s'_1 = ((dropWhile_lh__d3 isSpace_lh__d2) _lh_readInt'_arg2_0) in
          (let rec _lh_readTree_LH_P2_1_1 = s'_1 in
            (let rec _lh_readTree_LH_P2_0_3 = _lh_readInt'_arg1_0 in
              (fun _lh_readTree_LH_P2_0_4 _lh_readTree_LH_P2_0_5 _lh_readTree_arg1_1 _lh_readTree_arg3_1 -> 
                (let rec e_1 = (`LH_P3(_lh_readTree_LH_P2_0_4, _lh_readTree_LH_P2_0_5, _lh_readTree_LH_P2_0_3)) in
                  (let rec k_1 = (_lh_readTree_arg1_1 e_1) in
                    (((readTree_lh__d1 _lh_readTree_arg1_1) _lh_readTree_LH_P2_1_1) (((insertT_lh__d1 k_1) e_1) _lh_readTree_arg3_1)))))))))) in
    ...
    (match _lh_readInt'_arg2_3 with
      | `LH_C(_lh_readInt'_LH_C_0_3, _lh_readInt'_LH_C_1_3) -> 
        (if (isDigit_lh__d1 _lh_readInt'_LH_C_0_3) then
          ...
          (let rec s'_6 = ((dropWhile_lh__d3 isSpace_lh__d2) (`LH_C(_lh_readInt'_LH_C_0_3, _lh_readInt'_LH_C_1_3))) in
            (let rec _lh_readTree_LH_P2_1_6 = s'_6 in
              (let rec _lh_readTree_LH_P2_0_1_6 = _lh_readInt'_arg1_3 in
                (fun _lh_readTree_arg1_8 _lh_readTree_arg3_8 -> 
                  (let rec _lh_matchIdent_7 = (readInt_lh__d1 _lh_readTree_LH_P2_1_6) in
                    (((_lh_matchIdent_7 _lh_readTree_LH_P2_0_1_6) _lh_readTree_arg1_8) _lh_readTree_arg3_8)))))))
      | _ -> 
        (let rec s'_7 = ((dropWhile_lh__d3 isSpace_lh__d2) _lh_readInt'_arg2_3) in
          (let rec _lh_readTree_LH_P2_1_7 = s'_7 in
            (let rec _lh_readTree_LH_P2_0_1_7 = _lh_readInt'_arg1_3 in
              (fun _lh_readTree_arg1_9 _lh_readTree_arg3_9 -> 
                (let rec _lh_matchIdent_8 = (readInt_lh__d1 _lh_readTree_LH_P2_1_7) in
                  (((_lh_matchIdent_8 _lh_readTree_LH_P2_0_1_7) _lh_readTree_arg1_9) _lh_readTree_arg3_9)))))))) in
...
readTree_lh__d1 _lh_readTree_arg1_2 _lh_readTree_arg2_0 _lh_readTree_arg3_2 =
  (match _lh_readTree_arg2_0 with
    | `LH_N -> 
      _lh_readTree_arg3_2
    | _ -> 
      (let rec _lh_matchIdent_2 = (readInt_lh__d3 _lh_readTree_arg2_0) in
        ((_lh_matchIdent_2 _lh_readTree_arg1_2) _lh_readTree_arg3_2)));;
    ...
    (match _lh_readInt'_arg2_1 with
      | `LH_C(_lh_readInt'_LH_C_0_1, _lh_readInt'_LH_C_1_1) -> 
        (if (isDigit_lh__d1 _lh_readInt'_LH_C_0_1) then
          ...
          (let rec s'_2 = ((dropWhile_lh__d3 isSpace_lh__d2) (`LH_C(_lh_readInt'_LH_C_0_1, _lh_readInt'_LH_C_1_1))) in
            (let rec _lh_readTree_LH_P2_1_2 = s'_2 in
              (let rec _lh_readTree_LH_P2_0_6 = _lh_readInt'_arg1_1 in
                (fun _lh_readTree_LH_P2_0_7 _lh_readTree_LH_P2_0_8 _lh_readTree_arg1_3 _lh_readTree_arg3_3 -> 
                  (let rec e_2 = (`LH_P3(_lh_readTree_LH_P2_0_8, _lh_readTree_LH_P2_0_7, _lh_readTree_LH_P2_0_6)) in
                    (let rec k_2 = (_lh_readTree_arg1_3 e_2) in
                      (((readTree_lh__d2 _lh_readTree_arg1_3) _lh_readTree_LH_P2_1_2) (((insertT_lh__d2 k_2) e_2) _lh_readTree_arg3_3)))))))))
      | _ -> 
        (let rec s'_3 = ((dropWhile_lh__d3 isSpace_lh__d2) _lh_readInt'_arg2_1) in
          (let rec _lh_readTree_LH_P2_1_3 = s'_3 in
            (let rec _lh_readTree_LH_P2_0_9 = _lh_readInt'_arg1_1 in
              (fun _lh_readTree_LH_P2_0_1_0 _lh_readTree_LH_P2_0_1_1 _lh_readTree_arg1_4 _lh_readTree_arg3_4 -> 
                (let rec e_3 = (`LH_P3(_lh_readTree_LH_P2_0_1_1, _lh_readTree_LH_P2_0_1_0, _lh_readTree_LH_P2_0_9)) in
                  (let rec k_3 = (_lh_readTree_arg1_4 e_3) in
                    (((readTree_lh__d2 _lh_readTree_arg1_4) _lh_readTree_LH_P2_1_3) (((insertT_lh__d2 k_3) e_3) _lh_readTree_arg3_4)))))))))) in
    ...
    (match _lh_readInt'_arg2_4 with
      | `LH_C(_lh_readInt'_LH_C_0_4, _lh_readInt'_LH_C_1_4) -> 
        (if (isDigit_lh__d1 _lh_readInt'_LH_C_0_4) then
          ...
          (let rec s'_8 = ((dropWhile_lh__d3 isSpace_lh__d2) (`LH_C(_lh_readInt'_LH_C_0_4, _lh_readInt'_LH_C_1_4))) in
            (let rec _lh_readTree_LH_P2_1_8 = s'_8 in
              (let rec _lh_readTree_LH_P2_0_1_8 = _lh_readInt'_arg1_4 in
                (fun _lh_readTree_arg1_1_0 _lh_readTree_arg3_1_0 -> 
                  (let rec _lh_matchIdent_9 = (readInt_lh__d6 _lh_readTree_LH_P2_1_8) in
                    (((_lh_matchIdent_9 _lh_readTree_LH_P2_0_1_8) _lh_readTree_arg1_1_0) _lh_readTree_arg3_1_0)))))))
      | _ -> 
        (let rec s'_9 = ((dropWhile_lh__d3 isSpace_lh__d2) _lh_readInt'_arg2_4) in
          (let rec _lh_readTree_LH_P2_1_9 = s'_9 in
            (let rec _lh_readTree_LH_P2_0_1_9 = _lh_readInt'_arg1_4 in
              (fun _lh_readTree_arg1_1_1 _lh_readTree_arg3_1_1 -> 
                (let rec _lh_matchIdent_1_0 = (readInt_lh__d6 _lh_readTree_LH_P2_1_9) in
                  (((_lh_matchIdent_1_0 _lh_readTree_LH_P2_0_1_9) _lh_readTree_arg1_1_1) _lh_readTree_arg3_1_1)))))))) in
    ...
    (match _lh_readInt'_arg2_5 with
      | `LH_C(_lh_readInt'_LH_C_0_5, _lh_readInt'_LH_C_1_5) -> 
        (if (isDigit_lh__d1 _lh_readInt'_LH_C_0_5) then
          ...
          (let rec s'_1_0 = ((dropWhile_lh__d3 isSpace_lh__d2) (`LH_C(_lh_readInt'_LH_C_0_5, _lh_readInt'_LH_C_1_5))) in
            (let rec _lh_readTree_LH_P2_1_1_0 = s'_1_0 in
              (let rec _lh_readTree_LH_P2_0_2_0 = _lh_readInt'_arg1_5 in
                (fun _lh_readTree_LH_P2_0_2_1 _lh_readTree_arg1_1_2 _lh_readTree_arg3_1_2 -> 
                  (let rec _lh_matchIdent_1_1 = (readInt_lh__d4 _lh_readTree_LH_P2_1_1_0) in
                    ((((_lh_matchIdent_1_1 _lh_readTree_LH_P2_0_2_0) _lh_readTree_LH_P2_0_2_1) _lh_readTree_arg1_1_2) _lh_readTree_arg3_1_2)))))))
      | _ -> 
        (let rec s'_1_1 = ((dropWhile_lh__d3 isSpace_lh__d2) _lh_readInt'_arg2_5) in
          (let rec _lh_readTree_LH_P2_1_1_1 = s'_1_1 in
            (let rec _lh_readTree_LH_P2_0_2_2 = _lh_readInt'_arg1_5 in
              (fun _lh_readTree_LH_P2_0_2_3 _lh_readTree_arg1_1_3 _lh_readTree_arg3_1_3 -> 
                (let rec _lh_matchIdent_1_2 = (readInt_lh__d4 _lh_readTree_LH_P2_1_1_1) in
                  ((((_lh_matchIdent_1_2 _lh_readTree_LH_P2_0_2_2) _lh_readTree_LH_P2_0_2_3) _lh_readTree_arg1_1_3) _lh_readTree_arg3_1_3)))))))) in
...
readTree_lh__d2 _lh_readTree_arg1_5 _lh_readTree_arg2_1 _lh_readTree_arg3_5 =
  (match _lh_readTree_arg2_1 with
    | `LH_N -> 
      _lh_readTree_arg3_5
    | _ -> 
      (let rec _lh_matchIdent_3 = (readInt_lh__d5 _lh_readTree_arg2_1) in
        ((_lh_matchIdent_3 _lh_readTree_arg1_5) _lh_readTree_arg3_5)));;
