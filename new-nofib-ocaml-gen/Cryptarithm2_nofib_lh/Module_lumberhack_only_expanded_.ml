...
let rec filter_lh__d1 f_7 ls_9 =
  (match ls_9 with
    | `LH_C(h_1_7, t_1_7) -> 
      (if (f_7 h_1_7) then
        (`LH_C(h_1_7, ((filter_lh__d1 f_7) t_1_7)))
      else
        ((filter_lh__d1 f_7) t_1_7))
    | `LH_N -> 
      (`LH_N));;
...
let rec map_lh__d7 f_0 ls_1 =
  (match ls_1 with
    | `LH_C(h_2, t_2) -> 
      (`LH_C((f_0 h_2), ((map_lh__d7 f_0) t_2)))
    | `LH_N -> 
      (`LH_N));;
...
let rec mappend_lh__d6 xs_2 ys_0 =
  (match xs_2 with
    | `LH_C(h_1_0, t_1_0) -> 
      (`LH_C(h_1_0, ((mappend_lh__d6 t_1_0) ys_0)))
    | `LH_N -> 
      ys_0);;
      ...
      (let rec _lh_matchIdent_1 = as_0 in
        (match _lh_matchIdent_1 with
          | `LH_P2(_lh_bind_LH_P2_0_0, _lh_bind_LH_P2_1_0) -> 
            ((runStateT_lh__d9 (_lh_bind_arg2_0 _lh_bind_LH_P2_0_0)) _lh_bind_LH_P2_1_0))))) ((runStateT_lh__d9 _lh_bind_arg1_0) s_3))))));;
...
let rec foldl_lh__d1 f_9 i_1 ls_1_4 =
  (match ls_1_4 with
    | `LH_C(h_2_2, t_2_2) -> 
      (((foldl_lh__d1 f_9) ((f_9 i_1) h_2_2)) t_2_2)
    | `LH_N -> 
      i_1);;
...
let rec select_lh__d2 _lh_select_arg1_0 =
  ((bind_lh__d7 get_lh__d1) (fun st_2 -> 
    (let rec _lh_matchIdent_7 = ((lookup_lh__d2 _lh_select_arg1_0) (digitEnv_lh__d3 st_2)) in
...
let rec return_lh__d4 _lh_return_arg1_2 =
  (`StateT((fun s_7 -> 
    (`LH_C((`LH_P2(_lh_return_arg1_2, s_7)), (`LH_N))))));;
      ...
      (let rec _lh_matchIdent_4 = as_2 in
        (match _lh_matchIdent_4 with
          | `LH_P2(_lh_bind_LH_P2_0_2, _lh_bind_LH_P2_1_2) -> 
            ((runStateT_lh__d9 (_lh_bind_arg2_2 _lh_bind_LH_P2_0_2)) _lh_bind_LH_P2_1_2))))) ((runStateT_lh__d9 _lh_bind_arg1_2) s_8))))));;
let rec select_lh__d1 _lh_select_arg1_1 =
  ((bind_lh__d5 get_lh__d1) (fun st_3 -> 
    (let rec _lh_matchIdent_1_2 = ((lookup_lh__d2 _lh_select_arg1_1) (digitEnv_lh__d3 st_3)) in
...
let rec map_lh__d6 f_1 ls_2 =
  (match ls_2 with
    | `LH_C(h_4, t_4) -> 
      (`LH_C((f_1 h_4), ((map_lh__d6 f_1) t_4)))
    | `LH_N -> 
      (`LH_N));;
...
let rec bind_lh__d3 _lh_bind_arg1_4 _lh_bind_arg2_4 =
  (`StateT((fun s_1_2 -> 
    (concat_lh__d6 ((map_lh__d6 (fun as_4 -> 
      (let rec _lh_matchIdent_9 = as_4 in
        (match _lh_matchIdent_9 with
          | `LH_P2(_lh_bind_LH_P2_0_4, _lh_bind_LH_P2_1_4) -> 
            ((runStateT_lh__d7 (_lh_bind_arg2_4 _lh_bind_LH_P2_0_4)) _lh_bind_LH_P2_1_4))))) ((runStateT_lh__d6 _lh_bind_arg1_4) s_1_2))))));;
...
let rec concat_lh__d4 lss_3 =
  (match lss_3 with
    ...
    | `LH_N -> 
      (`LH_N));;
let rec map_lh__d4 f_4 ls_5 =
  (match ls_5 with
    | `LH_C(h_9, t_9) -> 
      (`LH_C((f_4 h_9), ((map_lh__d4 f_4) t_9)))
    | `LH_N -> 
      (`LH_N));;
      ...
      (let rec _lh_matchIdent_1_1 = as_6 in
        (match _lh_matchIdent_1_1 with
          | `LH_P2(_lh_bind_LH_P2_0_6, _lh_bind_LH_P2_1_6) -> 
            ((runStateT_lh__d3 (_lh_bind_arg2_6 _lh_bind_LH_P2_0_6)) _lh_bind_LH_P2_1_6))))) ((runStateT_lh__d2 _lh_bind_arg1_6) s_1_6))))));;
let rec return_lh__d3 _lh_return_arg1_3 =
  (`StateT((fun s_1_3 -> 
    (`LH_C((`LH_P2(_lh_return_arg1_3, s_1_3)), (`LH_N))))));;
      ...
      (let rec _lh_matchIdent_8 = as_3 in
        (match _lh_matchIdent_8 with
          | `LH_P2(_lh_bind_LH_P2_0_3, _lh_bind_LH_P2_1_3) -> 
            ((runStateT_lh__d9 (_lh_bind_arg2_3 _lh_bind_LH_P2_0_3)) _lh_bind_LH_P2_1_3))))) ((runStateT_lh__d8 _lh_bind_arg1_3) s_9))))));;
let rec return_lh__d1 _lh_return_arg1_5 =
  (`StateT((fun s_1_7 -> 
    (`LH_C((`LH_P2(_lh_return_arg1_5, s_1_7)), (`LH_N))))));;
let rec return_lh__d5 _lh_return_arg1_1 =
  (`StateT((fun s_5 -> 
    (`LH_C((`LH_P2(_lh_return_arg1_1, s_5)), (`LH_N))))));;
let rec foldr_lh__d1 f_2 i_0 ls_3 =
  (match ls_3 with
    | `LH_C(h_5, t_5) -> 
      ...
      (let rec _lh_matchIdent_2 = as_1 in
        (match _lh_matchIdent_2 with
          | `LH_P2(_lh_bind_LH_P2_0_1, _lh_bind_LH_P2_1_1) -> 
            ((runStateT_lh__d9 (_lh_bind_arg2_1 _lh_bind_LH_P2_0_1)) _lh_bind_LH_P2_1_1))))) ((runStateT_lh__d9 _lh_bind_arg1_1) s_4))))));;
let rec mapM_lh__d1 _lh_mapM_arg1_0 _lh_mapM_arg2_0 =
  (((foldr_lh__d1 (fun a_2 r_0 -> 
    ((bind_lh__d7 (_lh_mapM_arg1_0 a_2)) (fun x_1 -> 
      ((bind_lh__d6 r_0) (fun xs_4 -> 
        (return_lh__d6 (`LH_C(x_1, xs_4))))))))) (return_lh__d5 (`LH_N))) _lh_mapM_arg2_0);;
let rec sumAux_lh__d2 ls_0 a_0 =
  (match ls_0 with
    | `LH_N -> 
      a_0
    | `LH_C(h_0, t_0) -> 
      ((sumAux_lh__d2 t_0) (a_0 + h_0)));;
let rec sum_lh__d2 ls_1_0 =
  ((sumAux_lh__d2 ls_1_0) 0);;
let rec concat_lh__d5 lss_2 =
  (match lss_2 with
    | `LH_C(h_6, t_6) -> 
      ((mappend_lh__d6 h_6) (concat_lh__d5 t_6))
    | `LH_N -> 
      (`LH_N));;
...
let rec map_lh__d5 f_3 ls_4 =
  (match ls_4 with
    | `LH_C(h_7, t_7) -> 
      (`LH_C((f_3 h_7), ((map_lh__d5 f_3) t_7)))
    | `LH_N -> 
      (`LH_N));;
      ...
      (let rec _lh_matchIdent_1_0 = as_5 in
        (match _lh_matchIdent_1_0 with
          | `LH_P2(_lh_bind_LH_P2_0_5, _lh_bind_LH_P2_1_5) -> 
            ((runStateT_lh__d5 (_lh_bind_arg2_5 _lh_bind_LH_P2_0_5)) _lh_bind_LH_P2_1_5))))) ((runStateT_lh__d4 _lh_bind_arg1_5) s_1_5))))));;
...
let rec mappend_lh__d2 xs_7 ys_4 =
  (match xs_7 with
    ...
    | `LH_N -> 
      ys_4);;
let rec sumAux_lh__d1 ls_1_1 a_3 =
  (match ls_1_1 with
    | `LH_N -> 
      a_3
    | `LH_C(h_1_8, t_1_8) -> 
      ((sumAux_lh__d1 t_1_8) (a_3 + h_1_8)));;
let rec sum_lh__d1 ls_1_7 =
  ((sumAux_lh__d1 ls_1_7) 0);;
let rec mappend_lh__d4 xs_5 ys_2 =
  (match xs_5 with
    | `LH_C(h_2_4, t_2_4) -> 
      (`LH_C(h_2_4, ((mappend_lh__d4 t_2_4) ys_2)))
    | `LH_N -> 
      ys_2);;
...
let rec map_lh__d2 f_6 ls_7 =
  (match ls_7 with
    | `LH_C(h_1_4, t_1_4) -> 
      (`LH_C((f_6 h_1_4), ((map_lh__d2 f_6) t_1_4)))
    | `LH_N -> 
      (`LH_N));;
    ...
    | `LH_C(_lh_transpose_LH_C_0_0, _lh_transpose_LH_C_1_0) -> 
      (match _lh_transpose_LH_C_0_0 with
        ...
        | `LH_C(_lh_transpose_LH_C_0_1, _lh_transpose_LH_C_1_1) -> 
          (let rec _lh_matchIdent_1_3 = (unzip_lh__d1 (let rec _lh_listcomp_fun_2 = (fun _lh_listcomp_fun_para_2 -> 
...
let rec reverse_helper_lh__d2 ls_8 a_1 =
  (match ls_8 with
    | `LH_C(h_1_6, t_1_6) -> 
      ((reverse_helper_lh__d2 t_1_6) (`LH_C(h_1_6, a_1)))
    | `LH_N -> 
      a_1);;
...
let rec concat_lh__d3 lss_4 =
  (match lss_4 with
    | `LH_C(h_1_2, t_1_2) -> 
      ((mappend_lh__d6 h_1_2) (concat_lh__d3 t_1_2))
    | `LH_N -> 
      (`LH_N));;
let rec map_lh__d3 f_5 ls_6 =
  (match ls_6 with
    | `LH_C(h_1_1, t_1_1) -> 
      (`LH_C((f_5 h_1_1), ((map_lh__d3 f_5) t_1_1)))
    | `LH_N -> 
      (`LH_N));;
...
let rec mappend_lh__d3 xs_6 ys_3 =
  (match xs_6 with
    | `LH_C(h_2_5, t_2_5) -> 
      (`LH_C(h_2_5, ((mappend_lh__d3 t_2_5) ys_3)))
    | `LH_N -> 
      ys_3);;
let rec mappend_lh__d5 xs_3 ys_1 =
  (match xs_3 with
    | `LH_C(h_1_3, t_1_3) -> 
      (`LH_C(h_1_3, ((mappend_lh__d5 t_1_3) ys_1)))
    | `LH_N -> 
      ys_1);;
let rec concat_lh__d1 lss_6 =
  (match lss_6 with
    | `LH_C(h_2_1, t_2_1) -> 
      ((mappend_lh__d5 h_2_1) (concat_lh__d1 t_2_1))
    | `LH_N -> 
      (`LH_N));;
let rec reverse_helper_lh__d1 ls_1_2 a_4 =
  (match ls_1_2 with
    | `LH_C(h_1_9, t_1_9) -> 
      ((reverse_helper_lh__d1 t_1_9) (`LH_C(h_1_9, a_4)))
    | `LH_N -> 
      a_4);;
let rec reverse_lh__d1 ls_1_8 =
  ((reverse_helper_lh__d1 ls_1_8) (`LH_N));;
                        ...
                        | `LH_C(_lh_listcomp_fun_ls_h_4, _lh_listcomp_fun_ls_t_4) -> 
                          (match _lh_listcomp_fun_ls_h_4 with
                            | `LH_P2(_lh_puzzle_LH_P2_0_0, _lh_puzzle_LH_P2_1_0) -> 
                              (`LH_C(((mappend_lh__d2 ((mappend_lh__d4 (`LH_C(_lh_puzzle_LH_P2_0_0, (`LH_N)))) (`LH_C(' ', (`LH_C('=', (`LH_C('>', (`LH_C(' ', (`LH_N))))))))))) (string_of_int _lh_puzzle_LH_P2_1_0)), (_lh_listcomp_fun_4 _lh_listcomp_fun_ls_t_4)))
                            | _ -> 
                              (_lh_listcomp_fun_4 _lh_listcomp_fun_ls_t_4))
                        | `LH_N -> 
                          (`LH_N))) in
                      (_lh_listcomp_fun_4 (digitEnv_lh__d2 answer_0)))))))))))));;
