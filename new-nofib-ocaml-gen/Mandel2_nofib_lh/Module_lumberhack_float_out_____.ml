...
let rec length_lh__d1 ls_0 =
  (match ls_0 with
    ...
    | `LH_N -> 
      0);;
let rec right_lh__d1 _lh_equalp_LH_P2_0_1 _lh_equalp_LH_P2_1_1 =
...
let rec num_cols_lh__d1 =
  26;;
let rec new_x_lh__d1 _lh_new_x_arg1_0 _lh_new_x_arg2_0 _lh_new_x_arg3_0 =
...
let rec check_radius_lh__d5 _lh_check_radius_arg1_0 _lh_check_radius_arg2_0 _lh_check_radius_arg3_0 _lh_check_radius_arg4_0 _lh_check_radius_arg5_0 =
  (let rec xn_0 = (((new_x_lh__d1 _lh_check_radius_arg4_0) _lh_check_radius_arg5_0) _lh_check_radius_arg1_0) in
...
let rec check_radius_lh__d3 _lh_check_radius_arg1_1 _lh_check_radius_arg2_1 _lh_check_radius_arg3_1 _lh_check_radius_arg4_1 _lh_check_radius_arg5_1 =
  (let rec xn_1 = (((new_x_lh__d1 _lh_check_radius_arg4_1) _lh_check_radius_arg5_1) _lh_check_radius_arg1_1) in
...
let rec point_colour_lh__d3 _lh_point_colour_arg1_2 =
  (match _lh_point_colour_arg1_2 with
    | `LH_P2(_lh_point_colour_LH_P2_0_2, _lh_point_colour_LH_P2_1_2) -> 
      (((((check_radius_lh__d3 (np_lh__d3 _lh_point_colour_LH_P2_0_2)) (nq_lh__d3 _lh_point_colour_LH_P2_1_2)) 0) 0.0) 0.0));;
...
let rec check_radius_lh__d4 _lh_check_radius_arg1_2 _lh_check_radius_arg2_2 _lh_check_radius_arg3_2 _lh_check_radius_arg4_2 _lh_check_radius_arg5_2 =
  (let rec xn_2 = (((new_x_lh__d1 _lh_check_radius_arg4_2) _lh_check_radius_arg5_2) _lh_check_radius_arg1_2) in
...
let rec point_colour_lh__d4 _lh_point_colour_arg1_0 =
...
let rec equalp_lh__d1 _lh_equalp_arg1_1 _lh_equalp_arg2_1 =
...
let rec down_lh__d2 _lh_equalp_LH_P2_0_1_0 _lh_equalp_LH_P2_1_1_0 =
  (let rec _lh_equalp_LH_P2_1_9 = 1 in
    (let rec _lh_equalp_LH_P2_0_9 = 0 in
...
let rec np_lh__d5 _lh_np_arg1_5 =
  (pmn_lh__d2 +. ((float_of_int _lh_np_arg1_5) *. delta_p_lh__d2));;
let rec down_lh__d1 =
  (`LH_P2(0, 1));;
let rec check_radius_lh__d2 _lh_check_radius_arg1_3 _lh_check_radius_arg2_3 _lh_check_radius_arg3_3 _lh_check_radius_arg4_3 _lh_check_radius_arg5_3 =
  (let rec xn_3 = (((new_x_lh__d1 _lh_check_radius_arg4_3) _lh_check_radius_arg5_3) _lh_check_radius_arg1_3) in
...
let rec point_colour_lh__d2 _lh_point_colour_arg1_1 =
  (match _lh_point_colour_arg1_1 with
    | `LH_P2(_lh_point_colour_LH_P2_0_1, _lh_point_colour_LH_P2_1_1) -> 
      (((((check_radius_lh__d2 (np_lh__d2 _lh_point_colour_LH_P2_0_1)) (nq_lh__d2 _lh_point_colour_LH_P2_1_1)) 0) 0.0) 0.0));;
let rec pmn_lh__d1 =
  (0.0 -. 2.25);;
...
let rec point_colour_lh__d1 _lh_point_colour_arg1_3 =
  (match _lh_point_colour_arg1_3 with
    | `LH_P2(_lh_point_colour_LH_P2_0_3, _lh_point_colour_LH_P2_1_3) -> 
      (((((check_radius_lh__d1 (np_lh__d1 _lh_point_colour_LH_P2_0_3)) (nq_lh__d1 _lh_point_colour_LH_P2_1_3)) 0) 0.0) 0.0));;
let rec nq_lh__d5 _lh_nq_arg1_2 =
  (qmn_lh__d1 +. ((float_of_int _lh_nq_arg1_2) *. delta_q_lh__d1));;
let rec point_colour_lh__d6 _lh_point_colour_arg1_4 =
  (_lh_point_colour_arg1_4 99);;
let rec left_lh__d2 _lh_equalp_LH_P2_0_3 _lh_equalp_LH_P2_1_3 =
  (let rec _lh_equalp_LH_P2_1_2 = 0 in
    (let rec _lh_equalp_LH_P2_0_2 = (0 - 1) in
      ((_lh_equalp_LH_P2_0_3 = _lh_equalp_LH_P2_0_2) && (_lh_equalp_LH_P2_1_3 = _lh_equalp_LH_P2_1_2))));;
let rec up_lh__d1 =
  (`LH_P2(0, (0 - 1)));;
let rec equalp_lh__d2 _lh_equalp_arg1_0 _lh_equalp_arg2_0 =
  (match _lh_equalp_arg1_0 with
    | `LH_P2(_lh_equalp_LH_P2_0_4, _lh_equalp_LH_P2_1_4) -> 
      ((_lh_equalp_arg2_0 _lh_equalp_LH_P2_0_4) _lh_equalp_LH_P2_1_4));;
let rec equalp_lh__d3 _lh_equalp_arg1_2 _lh_equalp_arg2_2 =
  (match _lh_equalp_arg1_2 with
    | `LH_P2(_lh_equalp_LH_P2_0_6, _lh_equalp_LH_P2_1_6) -> 
      ((_lh_equalp_arg2_2 _lh_equalp_LH_P2_0_6) _lh_equalp_LH_P2_1_6));;
let rec equalp_lh__d4 _lh_equalp_arg1_3 _lh_equalp_arg2_3 =
    ...
    | `LH_P2(_lh_equalp_LH_P2_0_7, _lh_equalp_LH_P2_1_7) -> 
      (match _lh_equalp_arg2_3 with
        | `LH_P2(_lh_equalp_LH_P2_0_8, _lh_equalp_LH_P2_1_8) -> 
          ((_lh_equalp_LH_P2_0_7 = _lh_equalp_LH_P2_0_8) && (_lh_equalp_LH_P2_1_7 = _lh_equalp_LH_P2_1_8))));;
let rec point_colour_lh__d5 _lh_point_colour_arg1_5 =
...
let rec check_perim_lh__d1 _lh_check_perim_arg1_0 _lh_check_perim_arg2_0 =
  (let rec _lh_matchIdent_2 = _lh_check_perim_arg1_0 in
    (match _lh_matchIdent_2 with
      | `LH_P2(_lh_check_perim_LH_P2_0_0, _lh_check_perim_LH_P2_1_0) -> 
        (let rec _lh_matchIdent_3 = _lh_check_perim_arg2_0 in
          (match _lh_matchIdent_3 with
            | `LH_P2(_lh_check_perim_LH_P2_0_1, _lh_check_perim_LH_P2_1_1) -> 
              (let rec col1_0 = (point_colour_lh__d1 _lh_check_perim_arg1_0) in
                (let rec col2_0 = (point_colour_lh__d6 (let rec _lh_point_colour_LH_P2_1_4 = _lh_check_perim_LH_P2_1_0 in
                  (let rec _lh_point_colour_LH_P2_0_4 = _lh_check_perim_LH_P2_0_1 in
                    (fun _lh_dummy_3 -> 
                      (((((check_radius_lh__d6 (np_lh__d6 _lh_point_colour_LH_P2_0_4)) (nq_lh__d6 _lh_point_colour_LH_P2_1_4)) 0) 0.0) 0.0))))) in
                  (let rec col3_0 = (point_colour_lh__d4 _lh_check_perim_arg2_0) in
                    (let rec col4_0 = (point_colour_lh__d5 (let rec _lh_point_colour_LH_P2_1_5 = _lh_check_perim_LH_P2_1_1 in
                      (let rec _lh_point_colour_LH_P2_0_5 = _lh_check_perim_LH_P2_0_0 in
                        (fun _lh_dummy_4 -> 
                          (((((check_radius_lh__d5 (np_lh__d5 _lh_point_colour_LH_P2_0_5)) (nq_lh__d5 _lh_point_colour_LH_P2_1_5)) 0) 0.0) 0.0))))) in
                      (let rec corners_diff_0 = (if (col1_0 = col2_0) then
                        ...
                        (let rec check_line_0 = (fun xcyc_0 xdyd_0 -> 
                          (let rec _lh_matchIdent_4 = xcyc_0 in
                            (match _lh_matchIdent_4 with
                              | `LH_P2(_lh_check_perim_LH_P2_0_2, _lh_check_perim_LH_P2_1_2) -> 
                                (let rec _lh_matchIdent_5 = xdyd_0 in
                                    ...
                                    | `LH_P2(_lh_check_perim_LH_P2_0_3, _lh_check_perim_LH_P2_1_3) -> 
                                      (let rec finished_0 = (if ((equalp_lh__d1 xdyd_0) right_lh__d1) then
                                        ...
                                        (if ((equalp_lh__d2 xdyd_0) down_lh__d2) then
                                          ...
                                          (if ((equalp_lh__d3 xdyd_0) left_lh__d2) then
                                        ...
                                        (if finished_0 then
                                          ...
                                          (if ((point_colour_lh__d2 xcyc_0) <> col1_0) then
                                            false
                                          else
                          ...
                          (let rec check_sides_0 = (if ((check_line_0 (`LH_P2((_lh_check_perim_LH_P2_0_0 + 1), _lh_check_perim_LH_P2_1_0))) right_lh__d2) then
                            ...
                            (0 - 1)) in
                            (if ((equalp_lh__d4 _lh_check_perim_arg1_0) _lh_check_perim_arg2_0) then
                              (point_colour_lh__d3 _lh_check_perim_arg1_0)
                            else
                              (if corners_diff_0 then
                                (0 - 1)
                              else
                                check_sides_0)))))))))))));;
let rec build_tree_lh__d1 _lh_build_tree_arg1_0 _lh_build_tree_arg2_0 _lh_floatOutId_0_3 =
  (let rec _lh_matchIdent_0 = _lh_build_tree_arg1_0 in
    (match _lh_matchIdent_0 with
      | `LH_P2(_lh_build_tree_LH_P2_0_0, _lh_build_tree_LH_P2_1_0) -> 
        (let rec _lh_matchIdent_1 = _lh_build_tree_arg2_0 in
                                  ...
                                  (let rec ewp3_0 = (`LH_P2(_lh_build_tree_LH_P2_0_0, (split_y_0 + 1))) in
                                    (let rec ewp4_0 = _lh_build_tree_arg2_0 in
                                      (if (rec_col_0 <> (0 - 1)) then
                                        (let rec _lh_finite_Leaf_0_0 = rec_col_0 in
                                          (_lh_finite_Leaf_0_0 = _lh_finite_Leaf_0_0))
                                      else
                                        (if (split_0 = (`LH_C('N', (`LH_C('S', (`LH_N)))))) then
                                          (let rec _lh_finite_NS_1_0 = ((build_tree_lh__d1 nsp3_0) nsp4_0) in
                                            (let rec _lh_finite_NS_0_0 = ((build_tree_lh__d1 nsp1_0) nsp2_0) in
                                              ((finite_lh__d1 _lh_finite_NS_0_0) && (finite_lh__d1 _lh_finite_NS_1_0))))
                                        else
                                          (let rec _lh_finite_EW_1_0 = ((build_tree_lh__d1 ewp3_0) ewp4_0) in
                                            (let rec _lh_finite_EW_0_0 = ((build_tree_lh__d1 ewp1_0) ewp2_0) in
