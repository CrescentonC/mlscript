...
let rec point_colour_lh__d3 _lh_point_colour_arg1_1 =
  (match _lh_point_colour_arg1_1 with
    | `LH_P2(_lh_point_colour_LH_P2_0_1, _lh_point_colour_LH_P2_1_1) -> 
      (((((check_radius_lh__d3 (np_lh__d3 _lh_point_colour_LH_P2_0_1)) (nq_lh__d3 _lh_point_colour_LH_P2_1_1)) 0) 0.0) 0.0)
    | _ -> 
      (failwith "error"));;
...
let rec point_colour_lh__d2 _lh_point_colour_arg1_0 =
  (match _lh_point_colour_arg1_0 with
    | `LH_P2(_lh_point_colour_LH_P2_0_0, _lh_point_colour_LH_P2_1_0) -> 
      (((((check_radius_lh__d2 (np_lh__d2 _lh_point_colour_LH_P2_0_0)) (nq_lh__d2 _lh_point_colour_LH_P2_1_0)) 0) 0.0) 0.0)
    | _ -> 
      (failwith "error"));;
let rec pmn_lh__d1 =
  (0.0 -. 2.25);;
...
let rec point_colour_lh__d1 _lh_point_colour_arg1_2 =
  (match _lh_point_colour_arg1_2 with
    | `LH_P2(_lh_point_colour_LH_P2_0_2, _lh_point_colour_LH_P2_1_2) -> 
      (((((check_radius_lh__d1 (np_lh__d1 _lh_point_colour_LH_P2_0_2)) (nq_lh__d1 _lh_point_colour_LH_P2_1_2)) 0) 0.0) 0.0)
    | _ -> 
      (failwith "error"));;
...
let rec point_colour_lh__d6 _lh_point_colour_arg1_3 =
  (match _lh_point_colour_arg1_3 with
    | `LH_P2(_lh_point_colour_LH_P2_0_3, _lh_point_colour_LH_P2_1_3) -> 
      (((((check_radius_lh__d6 (np_lh__d6 _lh_point_colour_LH_P2_0_3)) (nq_lh__d6 _lh_point_colour_LH_P2_1_3)) 0) 0.0) 0.0)
    | _ -> 
      (failwith "error"));;
          ...
          (match _lh_matchIdent_3 with
            | `LH_P2(_lh_check_perim_LH_P2_0_1, _lh_check_perim_LH_P2_1_1) -> 
              (let rec col1_0 = (point_colour_lh__d3 _lh_check_perim_arg1_0) in
                (let rec col2_0 = (point_colour_lh__d4 (let rec _lh_point_colour_LH_P2_1_4 = _lh_check_perim_LH_P2_1_0 in
                  (let rec _lh_point_colour_LH_P2_0_4 = _lh_check_perim_LH_P2_0_1 in
                    (fun _lh_dummy_3 -> 
                      (((((check_radius_lh__d4 (np_lh__d4 _lh_point_colour_LH_P2_0_4)) (nq_lh__d4 _lh_point_colour_LH_P2_1_4)) 0) 0.0) 0.0))))) in
