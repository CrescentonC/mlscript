    ...
    (fun f_3 _lh_dummy_1 -> 
      (let rec _lh_listcomp_fun_ls_t_0 = ((enumFromTo_lh__d2 (a_0 + 1)) b_0) in
        (let rec _lh_listcomp_fun_ls_h_0 = a_0 in
          (let rec t_7 = (_lh_floatOutId_1_0 _lh_listcomp_fun_ls_t_0) in
            (let rec h_7 = (`LH_P2(_lh_floatOutId_0_0, _lh_listcomp_fun_ls_h_0)) in
...
let rec map_lh__d4 f_0 ls_0 =
  (ls_0 f_0);;
let rec wins_lh__d1 f_2_3 _lh_interpret_arg1_9 =
...
let rec mappend_lh__d2 xs_4 ys_1_0 =
  (xs_4 ys_1_0);;
let rec testBoard_lh__d2_d8 ys_7 =
