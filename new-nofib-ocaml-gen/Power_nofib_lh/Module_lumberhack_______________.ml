...
let rec negatePs_lh__d4 _lh_negatePs_arg1_2 =
  (lazy (let rec _lh_matchIdent_5_5 = (Lazy.force _lh_negatePs_arg1_2) in
    (match _lh_matchIdent_5_5 with
      ...
      | `Pc(_lh_negatePs_Pc_0_2, _lh_negatePs_Pc_1_2) -> 
        (`Pc((0 - _lh_negatePs_Pc_0_2), (negatePs_lh__d4 _lh_negatePs_Pc_1_2))))));;
  ...
  (let rec int1_0 = (fun fss_0 n_0 -> 
    ...
    (lazy (let rec _lh_int1_Pc_1_2 = ((int1_0 _lh_integralLz_arg1_0) 1) in
      (let rec _lh_int1_Pc_0_2 = 0 in
        (fun int1_3 n_3 -> 
          (`Pc((_lh_int1_Pc_0_2 / n_3), ((int1_3 _lh_int1_Pc_1_2) (n_3 + 1)))))))));;
let rec integral_lh__d2 _lh_integral_arg1_0 =
  (let rec int1_9 = (fun fss_2 n_9 -> 
    (lazy (let rec _lh_matchIdent_2_2 = (Lazy.force fss_2) in
      ((_lh_matchIdent_2_2 int1_9) n_9)))) in
    (lazy (`Pc(0, ((int1_9 _lh_integral_arg1_0) 1)))));;
let rec cosx_lh__d1 _lh_cosx_arg1_0 =
  ((minusPs_lh__d4 (lazy (`Pc(1, (lazy (`Pz)))))) (integral_lh__d2 (integralLz_lh__d1 (lazy (cosx_lh__d1 0)))));;
let rec dotMult_lh__d2 _lh_dotMult_arg1_1 _lh_dotMult_arg2_1 =
  (lazy (let rec _lh_matchIdent_2_5 = (Lazy.force _lh_dotMult_arg2_1) in
    (match _lh_matchIdent_2_5 with
      | `Pz -> 
        (`Pz)
      | `Pc(_lh_dotMult_Pc_0_1, _lh_dotMult_Pc_1_1) -> 
        (`Pc((_lh_dotMult_arg1_1 * _lh_dotMult_Pc_0_1), ((dotMult_lh__d2 _lh_dotMult_arg1_1) _lh_dotMult_Pc_1_1))))));;
let rec divPs_lh__d2 _lh_divPs_arg1_1 _lh_divPs_arg2_1 =
  (lazy (let rec _lh_matchIdent_1_0 = (Lazy.force _lh_divPs_arg1_1) in
    (match _lh_matchIdent_1_0 with
      | `Pz -> 
        (let rec _lh_matchIdent_1_1 = (Lazy.force _lh_divPs_arg2_1) in
              ...
              (match _lh_matchIdent_1_2 with
                | `Pc(_lh_divPs_Pc_0_6, _lh_divPs_Pc_1_6) -> 
                  (match _lh_divPs_Pc_0_6 with
                    ...
                    | _ -> 
                      (let rec q_2 = 0 in
                        (let rec _lh_int1_Pc_1_3 = ((divPs_lh__d2 ((addPs_lh__d6 _lh_divPs_Pc_1_5) (negatePs_lh__d4 ((dotMult_lh__d2 q_2) _lh_divPs_Pc_1_6)))) (lazy (`Pc(_lh_divPs_Pc_0_6, _lh_divPs_Pc_1_6)))) in
                          (let rec _lh_int1_Pc_0_3 = q_2 in
                            (fun int1_6 n_6 -> 
                              (`Pc((_lh_int1_Pc_0_3 / n_6), ((int1_6 _lh_int1_Pc_1_3) (n_6 + 1)))))))))))
          | _ -> 
              ...
              (match _lh_matchIdent_1_3 with
                | `Pc(_lh_divPs_Pc_0_7, _lh_divPs_Pc_1_7) -> 
                  (let rec q_3 = (_lh_divPs_Pc_0_5 / _lh_divPs_Pc_0_7) in
                    (let rec _lh_int1_Pc_1_4 = ((divPs_lh__d2 ((addPs_lh__d6 _lh_divPs_Pc_1_5) (negatePs_lh__d4 ((dotMult_lh__d2 q_3) _lh_divPs_Pc_1_7)))) (lazy (`Pc(_lh_divPs_Pc_0_7, _lh_divPs_Pc_1_7)))) in
                      (let rec _lh_int1_Pc_0_4 = q_3 in
                        (fun int1_7 n_7 -> 
                          (`Pc((_lh_int1_Pc_0_4 / n_7), ((int1_7 _lh_int1_Pc_1_4) (n_7 + 1))))))))))))));;
let rec addPs_lh__d5 _lh_addPs_arg1_3 _lh_addPs_arg2_3 =
  (lazy (let rec _lh_matchIdent_4_4 = (Lazy.force _lh_addPs_arg1_3) in
    (match _lh_matchIdent_4_4 with
      | `Pz -> 
        (Lazy.force _lh_addPs_arg2_3)
      | `Pc(_lh_addPs_Pc_0_6, _lh_addPs_Pc_1_6) -> 
        (let rec _lh_matchIdent_4_5 = (Lazy.force _lh_addPs_arg2_3) in
...
let rec negatePs_lh__d3 _lh_negatePs_arg1_0 =
  (lazy (let rec _lh_matchIdent_1_8 = (Lazy.force _lh_negatePs_arg1_0) in
...
let rec minusPs_lh__d1 _lh_minusPs_arg1_1 _lh_minusPs_arg2_1 =
  ((addPs_lh__d5 _lh_minusPs_arg1_1) (negatePs_lh__d3 _lh_minusPs_arg2_1));;
let rec integral_lh__d4 _lh_integral_arg1_2 =
  (let rec int1_1_1 = (fun fss_4 n_1_1 -> 
    (lazy (let rec _lh_matchIdent_2_9 = (Lazy.force fss_4) in
      (match _lh_matchIdent_2_9 with
        | `Pz -> 
          (`Pz)
        | `Pc(_lh_int1_Pc_0_7, _lh_int1_Pc_1_7) -> 
          (`Pc((_lh_int1_Pc_0_7 / n_1_1), ((int1_1_1 _lh_int1_Pc_1_7) (n_1_1 + 1)))))))) in
    (lazy (`Pc(0, ((int1_1_1 _lh_integral_arg1_2) 1)))));;
let rec integralLz_lh__d2 _lh_integralLz_arg1_1 =
  (let rec int1_8 = (fun fss_1 n_8 -> 
    (lazy (let rec _lh_matchIdent_2_1 = (Lazy.force (Lazy.force fss_1)) in
      (match _lh_matchIdent_2_1 with
        | `Pz -> 
          (`Pz)
        | `Pc(_lh_int1_Pc_0_5, _lh_int1_Pc_1_5) -> 
          (`Pc((_lh_int1_Pc_0_5 / n_8), ((int1_8 (lazy _lh_int1_Pc_1_5)) (n_8 + 1)))))))) in
    (lazy (`Pc(0, ((int1_8 _lh_integralLz_arg1_1) 1)))));;
...
let rec multPs_lh__d1 _lh_multPs_arg1_0 _lh_multPs_arg2_0 =
  (lazy (let rec _lh_matchIdent_4_9 = (Lazy.force _lh_multPs_arg1_0) in
    (match _lh_matchIdent_4_9 with
      | `Pz -> 
        (`Pz)
      | `Pc(_lh_multPs_Pc_0_0, _lh_multPs_Pc_1_0) -> 
        (let rec _lh_matchIdent_5_0 = (Lazy.force _lh_multPs_arg2_0) in
...
let rec multPsLzLz_lh__d1 _lh_multPsLzLz_arg1_0 _lh_multPsLzLz_arg2_0 =
  (lazy (let rec _lh_matchIdent_5_6 = (Lazy.force (Lazy.force _lh_multPsLzLz_arg1_0)) in
    (match _lh_matchIdent_5_6 with
      | `Pz -> 
        (`Pz)
      | `Pc(_lh_multPsLzLz_Pc_0_0, _lh_multPsLzLz_Pc_1_0) -> 
        (let rec _lh_matchIdent_5_7 = (Lazy.force (Lazy.force _lh_multPsLzLz_arg2_0)) in
...
let rec extract_lh__d3 _lh_extract_arg1_0 _lh_extract_arg2_0 =
  (if (_lh_extract_arg1_0 = 0) then
    ...
    (let rec _lh_matchIdent_3_0 = (Lazy.force _lh_extract_arg2_0) in
...
let rec divPs_lh__d4 _lh_divPs_arg1_0 _lh_divPs_arg2_0 =
  (lazy (let rec _lh_matchIdent_3 = (Lazy.force _lh_divPs_arg1_0) in
...
let rec integral_lh__d1 _lh_integral_arg1_3 =
  (let rec int1_1_2 = (fun fss_5 n_1_2 -> 
    (lazy (let rec _lh_matchIdent_3_2 = (Lazy.force fss_5) in
      ((_lh_matchIdent_3_2 int1_1_2) n_1_2)))) in
    (lazy (let rec _lh_revert_Pc_1_0 = ((int1_1_2 _lh_integral_arg1_3) 1) in
          ...
          (match _lh_revert_Pc_0_0 with
            | 0 -> 
              (Lazy.force (let rec rs_0 = (lazy (`Pc(0, ((divPs_lh__d4 (fromIntegerPs_lh__d6 1)) ((compose_lh__d1 _lh_revert_Pc_1_0) rs_0))))) in
                rs_0))
            | _ -> 
              (let rec _lh_matchIdent_3_3 = (Lazy.force _lh_revert_Pc_1_0) in
                (match _lh_matchIdent_3_3 with
                  | `Pc(_lh_revert_Pc_0_1, _lh_revert_Pc_1_1) -> 
                    (let rec _lh_matchIdent_3_4 = (Lazy.force _lh_revert_Pc_1_1) in
...
let rec extract_lh__d1 _lh_extract_arg1_1 _lh_extract_arg2_1 =
  (if (_lh_extract_arg1_1 = 0) then
    ...
    (let rec _lh_matchIdent_3_5 = (Lazy.force _lh_extract_arg2_1) in
...
let rec extract_lh__d2 _lh_extract_arg1_2 _lh_extract_arg2_2 =
  (if (_lh_extract_arg1_2 = 0) then
    ...
    (let rec _lh_matchIdent_4_8 = (Lazy.force _lh_extract_arg2_2) in
...
let rec negatePs_lh__d2 _lh_negatePs_arg1_1 =
  (lazy (let rec _lh_matchIdent_3_6 = (Lazy.force _lh_negatePs_arg1_1) in
    (_lh_matchIdent_3_6 99)));;
let rec dotMult_lh__d1 _lh_dotMult_arg1_0 _lh_dotMult_arg2_0 =
  (lazy (let rec _lh_matchIdent_1_4 = (Lazy.force _lh_dotMult_arg2_0) in
    (match _lh_matchIdent_1_4 with
      | `Pz -> 
        (fun _lh_dummy_0 -> 
          (`Pz))
      | `Pc(_lh_dotMult_Pc_0_0, _lh_dotMult_Pc_1_0) -> 
        (let rec _lh_negatePs_Pc_1_0 = ((dotMult_lh__d1 _lh_dotMult_arg1_0) _lh_dotMult_Pc_1_0) in
          (let rec _lh_negatePs_Pc_0_0 = (_lh_dotMult_arg1_0 * _lh_dotMult_Pc_0_0) in
            (fun _lh_dummy_1 -> 
              (`Pc((0 - _lh_negatePs_Pc_0_0), (negatePs_lh__d2 _lh_negatePs_Pc_1_0)))))))));;
...
let rec divPs_lh__d1 _lh_divPs_arg1_3 _lh_divPs_arg2_3 =
  (lazy (let rec _lh_matchIdent_5_1 = (Lazy.force _lh_divPs_arg1_3) in
    (match _lh_matchIdent_5_1 with
      | `Pz -> 
        (let rec _lh_matchIdent_5_2 = (Lazy.force _lh_divPs_arg2_3) in
      ...
      | `Pc(_lh_divPs_Pc_0_1_3, _lh_divPs_Pc_1_1_3) -> 
        (match _lh_divPs_Pc_0_1_3 with
          | 0 -> 
            (let rec _lh_matchIdent_5_3 = (Lazy.force _lh_divPs_arg2_3) in
          ...
          | _ -> 
            (let rec _lh_matchIdent_5_4 = (Lazy.force _lh_divPs_arg2_3) in
...
let rec minusPs_lh__d2 _lh_minusPs_arg1_4 _lh_minusPs_arg2_4 =
  ((addPs_lh__d6 _lh_minusPs_arg1_4) (negatePs_lh__d4 _lh_minusPs_arg2_4));;
let rec dotMultSndLz_lh__d1 _lh_dotMultSndLz_arg1_0 _lh_dotMultSndLz_arg2_0 =
  (lazy (let rec _lh_matchIdent_1_5 = (Lazy.force (Lazy.force _lh_dotMultSndLz_arg2_0)) in
...
let rec deriv_lh__d1 _lh_deriv_arg1_0 =
  (lazy (let rec _lh_matchIdent_3_1 = (Lazy.force _lh_deriv_arg1_0) in
...
let rec divPs_lh__d3 _lh_divPs_arg1_2 _lh_divPs_arg2_2 =
  (lazy (let rec _lh_matchIdent_3_7 = (Lazy.force _lh_divPs_arg1_2) in
    (match _lh_matchIdent_3_7 with
      | `Pz -> 
        (let rec _lh_matchIdent_3_8 = (Lazy.force _lh_divPs_arg2_2) in
      ...
      | `Pc(_lh_divPs_Pc_0_9, _lh_divPs_Pc_1_9) -> 
        (match _lh_divPs_Pc_0_9 with
          | 0 -> 
            (let rec _lh_matchIdent_3_9 = (Lazy.force _lh_divPs_arg2_2) in
              (match _lh_matchIdent_3_9 with
                | `Pc(_lh_divPs_Pc_0_1_0, _lh_divPs_Pc_1_1_0) -> 
                  (match _lh_divPs_Pc_0_1_0 with
                    ...
                    | _ -> 
                      (let rec q_4 = 0 in
                        (`Pc(q_4, ((divPs_lh__d3 ((addPs_lh__d6 _lh_divPs_Pc_1_9) (negatePs_lh__d4 ((dotMult_lh__d2 q_4) _lh_divPs_Pc_1_1_0)))) (lazy (`Pc(_lh_divPs_Pc_0_1_0, _lh_divPs_Pc_1_1_0))))))))))
          | _ -> 
              ...
              (match _lh_matchIdent_4_0 with
                | `Pc(_lh_divPs_Pc_0_1_1, _lh_divPs_Pc_1_1_1) -> 
                  (let rec q_5 = (_lh_divPs_Pc_0_9 / _lh_divPs_Pc_0_1_1) in
                    (`Pc(q_5, ((divPs_lh__d3 ((addPs_lh__d6 _lh_divPs_Pc_1_9) (negatePs_lh__d4 ((dotMult_lh__d2 q_5) _lh_divPs_Pc_1_1_1)))) (lazy (`Pc(_lh_divPs_Pc_0_1_1, _lh_divPs_Pc_1_1_1)))))))))))));;
let rec sqrtPs_lh__d1 _lh_sqrtPs_arg1_0 =
  (lazy (let rec _lh_matchIdent_4_1 = (Lazy.force _lh_sqrtPs_arg1_0) in
    (match _lh_matchIdent_4_1 with
      ...
      | `Pc(_lh_sqrtPs_Pc_0_0, _lh_sqrtPs_Pc_1_0) -> 
        (match _lh_sqrtPs_Pc_0_0 with
          | 0 -> 
            (let rec _lh_matchIdent_4_2 = (Lazy.force _lh_sqrtPs_Pc_1_0) in
          ...
          | 1 -> 
            (let rec qs_0 = (lazy ((addPs_lh__d4 (fromIntegerPs_lh__d4 1)) (integral_lh__d4 ((divPs_lh__d3 (deriv_lh__d1 (lazy (let rec _lh_deriv_Pc_1_0 = _lh_sqrtPs_Pc_1_0 in
              (let rec _lh_deriv_Pc_0_0 = 1 in
                (fun _lh_dummy_3 -> 
                  (let rec deriv1_0 = (fun gss_0 n_1_3 -> 
                    (lazy (let rec _lh_matchIdent_4_3 = (Lazy.force gss_0) in
                      (match _lh_matchIdent_4_3 with
                        | `Pz -> 
                          (`Pz)
                        | `Pc(_lh_deriv_Pc_0_1, _lh_deriv_Pc_1_1) -> 
                          (`Pc((n_1_3 * _lh_deriv_Pc_0_1), ((deriv1_0 _lh_deriv_Pc_1_1) (n_1_3 + 1)))))))) in
...
let rec addPs_lh__d1 _lh_addPs_arg1_5 _lh_addPs_arg2_5 =
  (lazy (let rec _lh_matchIdent_5_9 = (Lazy.force _lh_addPs_arg1_5) in
    (match _lh_matchIdent_5_9 with
      | `Pz -> 
        (Lazy.force _lh_addPs_arg2_5)
      | `Pc(_lh_addPs_Pc_0_1_0, _lh_addPs_Pc_1_1_0) -> 
        (let rec _lh_matchIdent_6_0 = (Lazy.force _lh_addPs_arg2_5) in
...
let rec multPsFstLz_lh__d1 _lh_multPsFstLz_arg1_0 _lh_multPsFstLz_arg2_0 =
  (lazy (let rec _lh_matchIdent_1 = (Lazy.force (Lazy.force _lh_multPsFstLz_arg1_0)) in
    (match _lh_matchIdent_1 with
      | `Pz -> 
        (`Pz)
      | `Pc(_lh_multPsFstLz_Pc_0_0, _lh_multPsFstLz_Pc_1_0) -> 
        (let rec _lh_matchIdent_2 = (Lazy.force _lh_multPsFstLz_arg2_0) in
...
let rec composeSndLz_lh__d1 _lh_composeSndLz_arg1_0 _lh_composeSndLz_arg2_0 =
  (lazy (let rec _lh_matchIdent_1_6 = (Lazy.force _lh_composeSndLz_arg1_0) in
    (match _lh_matchIdent_1_6 with
      | `Pz -> 
        (`Pz)
      | `Pc(_lh_composeSndLz_Pc_0_0, _lh_composeSndLz_Pc_1_0) -> 
        (let rec _lh_matchIdent_1_7 = (Lazy.force (Lazy.force _lh_composeSndLz_arg2_0)) in
...
let rec integral_lh__d3 _lh_integral_arg1_1 =
  (let rec int1_1_0 = (fun fss_3 n_1_0 -> 
    (lazy (let rec _lh_matchIdent_2_6 = (Lazy.force fss_3) in
      (match _lh_matchIdent_2_6 with
        | `Pz -> 
          (`Pz)
        | `Pc(_lh_int1_Pc_0_6, _lh_int1_Pc_1_6) -> 
          (`Pc((_lh_int1_Pc_0_6 / n_1_0), ((int1_1_0 _lh_int1_Pc_1_6) (n_1_0 + 1)))))))) in
