...
let rec revert_lh__d1 _lh_revert_arg1_0 =
  (lazy (let rec _lh_matchIdent_7 = (Lazy.force _lh_revert_arg1_0) in
    (_lh_matchIdent_7 99)));;
let rec integral_lh__d3 _lh_integral_arg1_1 =
  (let rec int1_2 = (fun fss_2 n_2 -> 
    (lazy (let rec _lh_matchIdent_2_6 = (Lazy.force fss_2) in
      (match _lh_matchIdent_2_6 with
        | `Pz -> 
          (`Pz)
        | `Pc(_lh_int1_Pc_0_1, _lh_int1_Pc_1_1) -> 
          (`Pc((_lh_int1_Pc_0_1 / n_2), ((int1_2 _lh_int1_Pc_1_1) (n_2 + 1)))))))) in
    (lazy (`Pc(0, ((int1_2 _lh_integral_arg1_1) 1)))));;
let rec negatePs_lh__d5 _lh_negatePs_arg1_2 =
  (lazy (let rec _lh_matchIdent_3_8 = (Lazy.force _lh_negatePs_arg1_2) in
    (match _lh_matchIdent_3_8 with
      | `Pz -> 
        (`Pz)
      | `Pc(_lh_negatePs_Pc_0_3, _lh_negatePs_Pc_1_3) -> 
        (`Pc((0 - _lh_negatePs_Pc_0_3), (negatePs_lh__d5 _lh_negatePs_Pc_1_3))))));;
let rec addPs_lh__d7 _lh_addPs_arg1_3 _lh_addPs_arg2_3 =
        ...
        (let rec _lh_matchIdent_3_2 = (Lazy.force _lh_addPs_arg2_3) in
          (match _lh_matchIdent_3_2 with
            ...
            | `Pc(_lh_addPs_Pc_0_7, _lh_addPs_Pc_1_7) -> 
              (`Pc((_lh_addPs_Pc_0_6 + _lh_addPs_Pc_0_7), ((addPs_lh__d7 _lh_addPs_Pc_1_6) _lh_addPs_Pc_1_7))))))));;
let rec minusPs_lh__d4 _lh_minusPs_arg1_2 _lh_minusPs_arg2_2 =
...
let rec integralLz_lh__d1 _lh_integralLz_arg1_0 =
  (let rec int1_0 = (fun fss_0 n_0 -> 
    (lazy (let rec _lh_matchIdent_6 = (Lazy.force (Lazy.force fss_0)) in
...
let rec dotMult_lh__d4 _lh_dotMult_arg1_0 _lh_dotMult_arg2_0 =
  (lazy (let rec _lh_matchIdent_8 = (Lazy.force _lh_dotMult_arg2_0) in
...
let rec addPs_lh__d5 _lh_addPs_arg1_4 _lh_addPs_arg2_4 =
  (lazy (let rec _lh_matchIdent_4_6 = (Lazy.force _lh_addPs_arg1_4) in
    (match _lh_matchIdent_4_6 with
      | `Pz -> 
        (Lazy.force _lh_addPs_arg2_4)
      | `Pc(_lh_addPs_Pc_0_8, _lh_addPs_Pc_1_8) -> 
        (let rec _lh_matchIdent_4_7 = (Lazy.force _lh_addPs_arg2_4) in
          (match _lh_matchIdent_4_7 with
            | `Pz -> 
              (Lazy.force _lh_addPs_arg1_4)
            | `Pc(_lh_addPs_Pc_0_9, _lh_addPs_Pc_1_9) -> 
              (`Pc((_lh_addPs_Pc_0_8 + _lh_addPs_Pc_0_9), ((addPs_lh__d5 _lh_addPs_Pc_1_8) _lh_addPs_Pc_1_9))))))));;
let rec negatePs_lh__d3 _lh_negatePs_arg1_0 =
  (lazy (let rec _lh_matchIdent_1_9 = (Lazy.force _lh_negatePs_arg1_0) in
...
let rec addPs_lh__d4 _lh_addPs_arg1_0 _lh_addPs_arg2_0 =
  (lazy (let rec _lh_matchIdent_2_0 = (Lazy.force _lh_addPs_arg1_0) in
    (match _lh_matchIdent_2_0 with
      | `Pz -> 
        (Lazy.force _lh_addPs_arg2_0)
      | `Pc(_lh_addPs_Pc_0_0, _lh_addPs_Pc_1_0) -> 
        (let rec _lh_matchIdent_2_1 = (Lazy.force _lh_addPs_arg2_0) in
...
let rec negatePs_lh__d4 _lh_negatePs_arg1_3 =
  (lazy (let rec _lh_matchIdent_5_8 = (Lazy.force _lh_negatePs_arg1_3) in
    (_lh_matchIdent_5_8 99)));;
let rec dotMult_lh__d3 _lh_dotMult_arg1_3 _lh_dotMult_arg2_3 =
  (lazy (let rec _lh_matchIdent_5_1 = (Lazy.force _lh_dotMult_arg2_3) in
    (match _lh_matchIdent_5_1 with
      | `Pz -> 
        (fun _lh_dummy_6 -> 
          (`Pz))
      | `Pc(_lh_dotMult_Pc_0_3, _lh_dotMult_Pc_1_3) -> 
        (let rec _lh_negatePs_Pc_1_4 = ((dotMult_lh__d3 _lh_dotMult_arg1_3) _lh_dotMult_Pc_1_3) in
          (let rec _lh_negatePs_Pc_0_4 = (_lh_dotMult_arg1_3 * _lh_dotMult_Pc_0_3) in
            (fun _lh_dummy_7 -> 
              (`Pc((0 - _lh_negatePs_Pc_0_4), (negatePs_lh__d4 _lh_negatePs_Pc_1_4)))))))));;
let rec divPs_lh__d2 _lh_divPs_arg1_1 _lh_divPs_arg2_1 =
  (lazy (let rec _lh_matchIdent_1_1 = (Lazy.force _lh_divPs_arg1_1) in
    (match _lh_matchIdent_1_1 with
      | `Pz -> 
        (let rec _lh_matchIdent_1_2 = (Lazy.force _lh_divPs_arg2_1) in
          (match _lh_matchIdent_1_2 with
            ...
            | `Pc(_lh_divPs_Pc_0_4, _lh_divPs_Pc_1_4) -> 
              (match _lh_divPs_Pc_0_4 with
                | 0 -> 
                  (Lazy.force ((divPs_lh__d2 (lazy (`Pz))) _lh_divPs_Pc_1_4))
                | _ -> 
                  (`Pz))
            | _ -> 
              (`Pz)))
      | `Pc(_lh_divPs_Pc_0_5, _lh_divPs_Pc_1_5) -> 
        (match _lh_divPs_Pc_0_5 with
          | 0 -> 
            (let rec _lh_matchIdent_1_3 = (Lazy.force _lh_divPs_arg2_1) in
              (match _lh_matchIdent_1_3 with
                | `Pc(_lh_divPs_Pc_0_6, _lh_divPs_Pc_1_6) -> 
                  (match _lh_divPs_Pc_0_6 with
                    | 0 -> 
                      (Lazy.force ((divPs_lh__d2 _lh_divPs_Pc_1_5) _lh_divPs_Pc_1_6))
                    | _ -> 
                      (let rec q_2 = 0 in
                        (`Pc(q_2, ((divPs_lh__d2 ((addPs_lh__d4 _lh_divPs_Pc_1_5) (negatePs_lh__d4 ((dotMult_lh__d3 q_2) _lh_divPs_Pc_1_6)))) (lazy (`Pc(_lh_divPs_Pc_0_6, _lh_divPs_Pc_1_6))))))))
                | _ -> 
                  (failwith "lh_default_error")))
          | _ -> 
            (let rec _lh_matchIdent_1_4 = (Lazy.force _lh_divPs_arg2_1) in
              (match _lh_matchIdent_1_4 with
                | `Pc(_lh_divPs_Pc_0_7, _lh_divPs_Pc_1_7) -> 
                  (let rec q_3 = (_lh_divPs_Pc_0_5 / _lh_divPs_Pc_0_7) in
                    (`Pc(q_3, ((divPs_lh__d2 ((addPs_lh__d5 _lh_divPs_Pc_1_5) (negatePs_lh__d3 ((dotMult_lh__d4 q_3) _lh_divPs_Pc_1_7)))) (lazy (`Pc(_lh_divPs_Pc_0_7, _lh_divPs_Pc_1_7)))))))
                | _ -> 
                  (failwith "lh_default_error")))))));;
let rec minusPs_lh__d1 _lh_minusPs_arg1_0 _lh_minusPs_arg2_0 =
...
let rec multPsLzLz_lh__d1 _lh_multPsLzLz_arg1_0 _lh_multPsLzLz_arg2_0 =
  (lazy (let rec _lh_matchIdent_5_9 = (Lazy.force (Lazy.force _lh_multPsLzLz_arg1_0)) in
    (match _lh_matchIdent_5_9 with
      | `Pz -> 
        (`Pz)
      | `Pc(_lh_multPsLzLz_Pc_0_0, _lh_multPsLzLz_Pc_1_0) -> 
        (let rec _lh_matchIdent_6_0 = (Lazy.force (Lazy.force _lh_multPsLzLz_arg2_0)) in
...
let rec extract_lh__d3 _lh_extract_arg1_0 _lh_extract_arg2_0 =
  (if (_lh_extract_arg1_0 = 0) then
    ...
    (let rec _lh_matchIdent_2_9 = (Lazy.force _lh_extract_arg2_0) in
...
let rec divPs_lh__d4 _lh_divPs_arg1_0 _lh_divPs_arg2_0 =
  (lazy (let rec _lh_matchIdent_2 = (Lazy.force _lh_divPs_arg1_0) in
    (match _lh_matchIdent_2 with
      | `Pz -> 
        (let rec _lh_matchIdent_3 = (Lazy.force _lh_divPs_arg2_0) in
      ...
      | `Pc(_lh_divPs_Pc_0_1, _lh_divPs_Pc_1_1) -> 
        (match _lh_divPs_Pc_0_1 with
          | 0 -> 
            (let rec _lh_matchIdent_4 = (Lazy.force _lh_divPs_arg2_0) in
...
let rec compose_lh__d1 _lh_compose_arg1_0 _lh_compose_arg2_0 =
  (lazy (let rec _lh_matchIdent_9 = (Lazy.force _lh_compose_arg1_0) in
    (match _lh_matchIdent_9 with
      | `Pz -> 
        (`Pz)
      | `Pc(_lh_compose_Pc_0_0, _lh_compose_Pc_1_0) -> 
        (let rec _lh_matchIdent_1_0 = (Lazy.force _lh_compose_arg2_0) in
...
let rec integral_lh__d1 _lh_integral_arg1_2 =
  (let rec int1_3 = (fun fss_3 n_3 -> 
    (lazy (let rec _lh_matchIdent_3_3 = (Lazy.force fss_3) in
      ((_lh_matchIdent_3_3 int1_3) n_3)))) in
    (lazy (let rec _lh_revert_Pc_1_0 = ((int1_3 _lh_integral_arg1_2) 1) in
          ...
          (match _lh_revert_Pc_0_0 with
            | 0 -> 
              (Lazy.force (let rec rs_0 = (lazy (`Pc(0, ((divPs_lh__d4 (fromIntegerPs_lh__d6 1)) ((compose_lh__d1 _lh_revert_Pc_1_0) rs_0))))) in
                rs_0))
            | _ -> 
              (let rec _lh_matchIdent_3_4 = (Lazy.force _lh_revert_Pc_1_0) in
                (match _lh_matchIdent_3_4 with
                  | `Pc(_lh_revert_Pc_0_1, _lh_revert_Pc_1_1) -> 
                    (let rec _lh_matchIdent_3_5 = (Lazy.force _lh_revert_Pc_1_1) in
...
let rec extract_lh__d2 _lh_extract_arg1_2 _lh_extract_arg2_2 =
  (if (_lh_extract_arg1_2 = 0) then
    ...
    (let rec _lh_matchIdent_5_0 = (Lazy.force _lh_extract_arg2_2) in
...
let rec negatePs_lh__d1 _lh_negatePs_arg1_4 =
  (lazy (let rec _lh_matchIdent_6_1 = (Lazy.force _lh_negatePs_arg1_4) in
    (_lh_matchIdent_6_1 99)));;
let rec dotMult_lh__d1 _lh_dotMult_arg1_1 _lh_dotMult_arg2_1 =
  (lazy (let rec _lh_matchIdent_1_5 = (Lazy.force _lh_dotMult_arg2_1) in
    (match _lh_matchIdent_1_5 with
      | `Pz -> 
        (fun _lh_dummy_0 -> 
          (`Pz))
      | `Pc(_lh_dotMult_Pc_0_1, _lh_dotMult_Pc_1_1) -> 
        (let rec _lh_negatePs_Pc_1_0 = ((dotMult_lh__d1 _lh_dotMult_arg1_1) _lh_dotMult_Pc_1_1) in
          (let rec _lh_negatePs_Pc_0_0 = (_lh_dotMult_arg1_1 * _lh_dotMult_Pc_0_1) in
            (fun _lh_dummy_1 -> 
              (`Pc((0 - _lh_negatePs_Pc_0_0), (negatePs_lh__d1 _lh_negatePs_Pc_1_0)))))))));;
let rec addPs_lh__d2 _lh_addPs_arg1_2 _lh_addPs_arg2_2 =
  (lazy (let rec _lh_matchIdent_2_7 = (Lazy.force _lh_addPs_arg1_2) in
    (match _lh_matchIdent_2_7 with
      | `Pz -> 
        (Lazy.force _lh_addPs_arg2_2)
      | `Pc(_lh_addPs_Pc_0_4, _lh_addPs_Pc_1_4) -> 
        (let rec _lh_matchIdent_2_8 = (Lazy.force _lh_addPs_arg2_2) in
...
let rec addPs_lh__d3 _lh_addPs_arg1_1 _lh_addPs_arg2_1 =
  (lazy (let rec _lh_matchIdent_2_3 = (Lazy.force _lh_addPs_arg1_1) in
    (match _lh_matchIdent_2_3 with
      | `Pz -> 
        (Lazy.force _lh_addPs_arg2_1)
      | `Pc(_lh_addPs_Pc_0_2, _lh_addPs_Pc_1_2) -> 
        (let rec _lh_matchIdent_2_4 = (Lazy.force _lh_addPs_arg2_1) in
...
let rec dotMult_lh__d2 _lh_dotMult_arg1_2 _lh_dotMult_arg2_2 =
  (lazy (let rec _lh_matchIdent_2_5 = (Lazy.force _lh_dotMult_arg2_2) in
    (match _lh_matchIdent_2_5 with
      | `Pz -> 
        (fun _lh_dummy_2 -> 
          (`Pz))
      | `Pc(_lh_dotMult_Pc_0_2, _lh_dotMult_Pc_1_2) -> 
        (let rec _lh_negatePs_Pc_1_2 = ((dotMult_lh__d2 _lh_dotMult_arg1_2) _lh_dotMult_Pc_1_2) in
          (let rec _lh_negatePs_Pc_0_2 = (_lh_dotMult_arg1_2 * _lh_dotMult_Pc_0_2) in
            (fun _lh_dummy_3 -> 
              (`Pc((0 - _lh_negatePs_Pc_0_2), (negatePs_lh__d2 _lh_negatePs_Pc_1_2)))))))));;
let rec divPs_lh__d1 _lh_divPs_arg1_3 _lh_divPs_arg2_3 =
  (lazy (let rec _lh_matchIdent_5_4 = (Lazy.force _lh_divPs_arg1_3) in
    (match _lh_matchIdent_5_4 with
      | `Pz -> 
        (let rec _lh_matchIdent_5_5 = (Lazy.force _lh_divPs_arg2_3) in
      ...
      | `Pc(_lh_divPs_Pc_0_1_3, _lh_divPs_Pc_1_1_3) -> 
        (match _lh_divPs_Pc_0_1_3 with
          | 0 -> 
            (let rec _lh_matchIdent_5_6 = (Lazy.force _lh_divPs_arg2_3) in
              (match _lh_matchIdent_5_6 with
                | `Pc(_lh_divPs_Pc_0_1_4, _lh_divPs_Pc_1_1_4) -> 
                  (match _lh_divPs_Pc_0_1_4 with
                    ...
                    | _ -> 
                      (let rec q_6 = 0 in
                        (let rec _lh_int1_Pc_1_4 = ((divPs_lh__d1 ((addPs_lh__d3 _lh_divPs_Pc_1_1_3) (negatePs_lh__d1 ((dotMult_lh__d1 q_6) _lh_divPs_Pc_1_1_4)))) (lazy (`Pc(_lh_divPs_Pc_0_1_4, _lh_divPs_Pc_1_1_4)))) in
                          (let rec _lh_int1_Pc_0_4 = q_6 in
                            (fun int1_1_0 n_1_1 -> 
                              (`Pc((_lh_int1_Pc_0_4 / n_1_1), ((int1_1_0 _lh_int1_Pc_1_4) (n_1_1 + 1)))))))))
                | _ -> 
                  (failwith "lh_default_error")))
          | _ -> 
              ...
              (match _lh_matchIdent_5_7 with
                | `Pc(_lh_divPs_Pc_0_1_5, _lh_divPs_Pc_1_1_5) -> 
                  (let rec q_7 = (_lh_divPs_Pc_0_1_3 / _lh_divPs_Pc_0_1_5) in
                    (let rec _lh_int1_Pc_1_5 = ((divPs_lh__d1 ((addPs_lh__d2 _lh_divPs_Pc_1_1_3) (negatePs_lh__d2 ((dotMult_lh__d2 q_7) _lh_divPs_Pc_1_1_5)))) (lazy (`Pc(_lh_divPs_Pc_0_1_5, _lh_divPs_Pc_1_1_5)))) in
                      (let rec _lh_int1_Pc_0_5 = q_7 in
                        (fun int1_1_1 n_1_2 -> 
                          (`Pc((_lh_int1_Pc_0_5 / n_1_2), ((int1_1_1 _lh_int1_Pc_1_5) (n_1_2 + 1))))))))
                | _ -> 
                  (failwith "lh_default_error")))))));;
let rec fromIntegerPs_lh__d3 _lh_fromIntegerPs_arg1_1 =
...
let rec fromIntegerPs_lh__d1 _lh_fromIntegerPs_arg1_2 =
  (match _lh_fromIntegerPs_arg1_2 with
    | 0 -> 
      (lazy (`Pz))
    | _ -> 
      (lazy (`Pc(_lh_fromIntegerPs_arg1_2, (lazy (`Pz))))));;
let rec fromIntegerPs_lh__d2 _lh_fromIntegerPs_arg1_3 =
...
let rec dotMultSndLz_lh__d1 _lh_dotMultSndLz_arg1_0 _lh_dotMultSndLz_arg2_0 =
  (lazy (let rec _lh_matchIdent_1_6 = (Lazy.force (Lazy.force _lh_dotMultSndLz_arg2_0)) in
...
let rec integral_lh__d2 _lh_integral_arg1_0 =
  (let rec int1_1 = (fun fss_1 n_1 -> 
    (lazy (let rec _lh_matchIdent_2_2 = (Lazy.force fss_1) in
      ((_lh_matchIdent_2_2 int1_1) n_1)))) in
    (lazy (`Pc(0, ((int1_1 _lh_integral_arg1_0) 1)))));;
let rec deriv_lh__d1 _lh_deriv_arg1_0 =
  (lazy (let rec _lh_matchIdent_3_0 = (Lazy.force _lh_deriv_arg1_0) in
    (_lh_matchIdent_3_0 99)));;
let rec addPs_lh__d6 _lh_addPs_arg1_5 _lh_addPs_arg2_5 =
  (lazy (let rec _lh_matchIdent_4_8 = (Lazy.force _lh_addPs_arg1_5) in
    (match _lh_matchIdent_4_8 with
      | `Pz -> 
        (Lazy.force _lh_addPs_arg2_5)
      | `Pc(_lh_addPs_Pc_0_1_0, _lh_addPs_Pc_1_1_0) -> 
        (let rec _lh_matchIdent_4_9 = (Lazy.force _lh_addPs_arg2_5) in
          (match _lh_matchIdent_4_9 with
            | `Pz -> 
              (Lazy.force _lh_addPs_arg1_5)
            | `Pc(_lh_addPs_Pc_0_1_1, _lh_addPs_Pc_1_1_1) -> 
              (`Pc((_lh_addPs_Pc_0_1_0 + _lh_addPs_Pc_0_1_1), ((addPs_lh__d6 _lh_addPs_Pc_1_1_0) _lh_addPs_Pc_1_1_1))))))));;
let rec fromIntegerPs_lh__d4 _lh_fromIntegerPs_arg1_5 =
...
let rec divPs_lh__d3 _lh_divPs_arg1_2 _lh_divPs_arg2_2 =
  (lazy (let rec _lh_matchIdent_3_9 = (Lazy.force _lh_divPs_arg1_2) in
    (match _lh_matchIdent_3_9 with
      | `Pz -> 
        (let rec _lh_matchIdent_4_0 = (Lazy.force _lh_divPs_arg2_2) in
      ...
      | `Pc(_lh_divPs_Pc_0_9, _lh_divPs_Pc_1_9) -> 
        (match _lh_divPs_Pc_0_9 with
          | 0 -> 
            (let rec _lh_matchIdent_4_1 = (Lazy.force _lh_divPs_arg2_2) in
              (match _lh_matchIdent_4_1 with
                | `Pc(_lh_divPs_Pc_0_1_0, _lh_divPs_Pc_1_1_0) -> 
                  (match _lh_divPs_Pc_0_1_0 with
                    ...
                    | _ -> 
                      (let rec q_4 = 0 in
                        (let rec _lh_int1_Pc_1_2 = ((divPs_lh__d3 ((addPs_lh__d7 _lh_divPs_Pc_1_9) (negatePs_lh__d5 ((dotMult_lh__d4 q_4) _lh_divPs_Pc_1_1_0)))) (lazy (`Pc(_lh_divPs_Pc_0_1_0, _lh_divPs_Pc_1_1_0)))) in
                          (let rec _lh_int1_Pc_0_2 = q_4 in
                            (fun int1_6 n_6 -> 
                              (`Pc((_lh_int1_Pc_0_2 / n_6), ((int1_6 _lh_int1_Pc_1_2) (n_6 + 1)))))))))
                | _ -> 
                  (failwith "lh_default_error")))
          | _ -> 
            (let rec _lh_matchIdent_4_2 = (Lazy.force _lh_divPs_arg2_2) in
              (match _lh_matchIdent_4_2 with
                | `Pc(_lh_divPs_Pc_0_1_1, _lh_divPs_Pc_1_1_1) -> 
                  (let rec q_5 = (_lh_divPs_Pc_0_9 / _lh_divPs_Pc_0_1_1) in
                    (let rec _lh_int1_Pc_1_3 = ((divPs_lh__d3 ((addPs_lh__d7 _lh_divPs_Pc_1_9) (negatePs_lh__d5 ((dotMult_lh__d4 q_5) _lh_divPs_Pc_1_1_1)))) (lazy (`Pc(_lh_divPs_Pc_0_1_1, _lh_divPs_Pc_1_1_1)))) in
                      (let rec _lh_int1_Pc_0_3 = q_5 in
                        (fun int1_7 n_7 -> 
                          (`Pc((_lh_int1_Pc_0_3 / n_7), ((int1_7 _lh_int1_Pc_1_3) (n_7 + 1))))))))
                | _ -> 
                  (failwith "lh_default_error")))))));;
let rec sqrtPs_lh__d1 _lh_sqrtPs_arg1_0 =
  (lazy (let rec _lh_matchIdent_4_3 = (Lazy.force _lh_sqrtPs_arg1_0) in
    (match _lh_matchIdent_4_3 with
      ...
      | `Pc(_lh_sqrtPs_Pc_0_0, _lh_sqrtPs_Pc_1_0) -> 
        (match _lh_sqrtPs_Pc_0_0 with
          | 0 -> 
            (let rec _lh_matchIdent_4_4 = (Lazy.force _lh_sqrtPs_Pc_1_0) in
              (match _lh_matchIdent_4_4 with
                ...
                | _ -> 
                  (failwith "lh_default_error")))
          | 1 -> 
            (let rec qs_0 = (lazy ((addPs_lh__d6 (fromIntegerPs_lh__d4 1)) (integral_lh__d2 ((divPs_lh__d3 (deriv_lh__d1 (lazy (let rec _lh_deriv_Pc_1_0 = _lh_sqrtPs_Pc_1_0 in
              (let rec _lh_deriv_Pc_0_0 = 1 in
                (fun _lh_dummy_5 -> 
                  (let rec deriv1_0 = (fun gss_0 n_8 -> 
                    (lazy (let rec _lh_matchIdent_4_5 = (Lazy.force gss_0) in
                      (match _lh_matchIdent_4_5 with
                        | `Pz -> 
                          (`Pz)
                        | `Pc(_lh_deriv_Pc_0_1, _lh_deriv_Pc_1_1) -> 
                          (`Pc((n_8 * _lh_deriv_Pc_0_1), ((deriv1_0 _lh_deriv_Pc_1_1) (n_8 + 1)))))))) in
                    (Lazy.force ((deriv1_0 _lh_deriv_Pc_1_0) 1))))))))) ((dotMultSndLz_lh__d1 2) qs_0))))) in
              (Lazy.force (Lazy.force qs_0)))))));;
let rec fromIntegerPs_lh__d5 _lh_fromIntegerPs_arg1_4 =
...
let rec addPs_lh__d1 _lh_addPs_arg1_6 _lh_addPs_arg2_6 =
  (lazy (let rec _lh_matchIdent_6_2 = (Lazy.force _lh_addPs_arg1_6) in
    (match _lh_matchIdent_6_2 with
      | `Pz -> 
        (Lazy.force _lh_addPs_arg2_6)
      | `Pc(_lh_addPs_Pc_0_1_2, _lh_addPs_Pc_1_1_2) -> 
        (let rec _lh_matchIdent_6_3 = (Lazy.force _lh_addPs_arg2_6) in
