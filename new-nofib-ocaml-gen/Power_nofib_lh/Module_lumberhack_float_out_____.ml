...
let rec integral_lh__d4 _lh_integral_arg1_2 =
  (let rec int1_1_2 = (fun fss_5 n_1_2 -> 
    (lazy (let rec _lh_matchIdent_2_5 = (Lazy.force fss_5) in
      ((_lh_matchIdent_2_5 int1_1_2) n_1_2)))) in
    (lazy (`Pc(0, ((int1_1_2 _lh_integral_arg1_2) 1)))));;
let rec addPs_lh__d6 _lh_addPs_arg1_4 _lh_addPs_arg2_4 =
  (lazy (let rec _lh_matchIdent_4_3 = (Lazy.force _lh_addPs_arg1_4) in
    (match _lh_matchIdent_4_3 with
      | `Pz -> 
        (Lazy.force _lh_addPs_arg2_4)
      | `Pc(_lh_addPs_Pc_0_8, _lh_addPs_Pc_1_8) -> 
        (let rec _lh_matchIdent_4_4 = (Lazy.force _lh_addPs_arg2_4) in
...
let rec negatePs_lh__d3 _lh_negatePs_arg1_0 =
  (lazy (let rec _lh_matchIdent_1_5 = (Lazy.force _lh_negatePs_arg1_0) in
...
let rec integralLz_lh__d2 _lh_integralLz_arg1_2 =
  (let rec int1_6 = (fun fss_2 n_6 -> 
    (lazy (let rec _lh_matchIdent_1_8 = (Lazy.force (Lazy.force fss_2)) in
      (match _lh_matchIdent_1_8 with
        | `Pz -> 
          (fun int1_7 n_7 -> 
            (`Pz))
        | `Pc(_lh_int1_Pc_0_4, _lh_int1_Pc_1_4) -> 
          (let rec _lh_int1_Pc_1_5 = ((int1_6 (lazy _lh_int1_Pc_1_4)) (n_6 + 1)) in
            (let rec _lh_int1_Pc_0_5 = (_lh_int1_Pc_0_4 / n_6) in
              (fun int1_8 n_8 -> 
                (`Pc((_lh_int1_Pc_0_5 / n_8), ((int1_8 _lh_int1_Pc_1_5) (n_8 + 1)))))))
        | _ -> 
          (failwith "error"))))) in
    (lazy (let rec _lh_int1_Pc_1_6 = ((int1_6 _lh_integralLz_arg1_2) 1) in
      (let rec _lh_int1_Pc_0_6 = 0 in
        (fun int1_9 n_9 -> 
          (`Pc((_lh_int1_Pc_0_6 / n_9), ((int1_9 _lh_int1_Pc_1_6) (n_9 + 1)))))))));;
let rec cosx_lh__d1 _lh_cosx_arg1_0 =
  ((minusPs_lh__d5 (lazy (`Pc(1, (lazy (`Pz)))))) (integral_lh__d4 (integralLz_lh__d2 (lazy (cosx_lh__d1 0)))));;
let rec dotMult_lh__d1 _lh_dotMult_arg1_0 _lh_dotMult_arg2_0 =
  (lazy (let rec _lh_matchIdent_1_1 = (Lazy.force _lh_dotMult_arg2_0) in
...
let rec divPs_lh__d2 _lh_divPs_arg1_0 _lh_divPs_arg2_0 =
  (lazy (let rec _lh_matchIdent_7 = (Lazy.force _lh_divPs_arg1_0) in
                      ...
                      (let rec q_0 = 0 in
                        (let rec _lh_int1_Pc_1_2 = ((divPs_lh__d2 ((addPs_lh__d6 _lh_divPs_Pc_1_1) (negatePs_lh__d3 ((dotMult_lh__d1 q_0) _lh_divPs_Pc_1_2)))) (lazy (`Pc(_lh_divPs_Pc_0_2, _lh_divPs_Pc_1_2)))) in
                          (let rec _lh_int1_Pc_0_2 = q_0 in
                            (fun int1_4 n_4 -> 
                              (`Pc((_lh_int1_Pc_0_2 / n_4), ((int1_4 _lh_int1_Pc_1_2) (n_4 + 1)))))))))
                | _ -> 
                  (failwith "error")))
          | _ -> 
            (let rec _lh_matchIdent_1_0 = (Lazy.force _lh_divPs_arg2_0) in
                  ...
                  (let rec q_1 = (_lh_divPs_Pc_0_1 / _lh_divPs_Pc_0_3) in
                    (let rec _lh_int1_Pc_1_3 = ((divPs_lh__d2 ((addPs_lh__d6 _lh_divPs_Pc_1_1) (negatePs_lh__d3 ((dotMult_lh__d1 q_1) _lh_divPs_Pc_1_3)))) (lazy (`Pc(_lh_divPs_Pc_0_3, _lh_divPs_Pc_1_3)))) in
                      (let rec _lh_int1_Pc_0_3 = q_1 in
                        (fun int1_5 n_5 -> 
                          (`Pc((_lh_int1_Pc_0_3 / n_5), ((int1_5 _lh_int1_Pc_1_3) (n_5 + 1))))))))
                | _ -> 
                  (failwith "error"))))
      | _ -> 
        (failwith "error"))));;
let rec addPs_lh__d2 _lh_addPs_arg1_2 _lh_addPs_arg2_2 =
  (lazy (let rec _lh_matchIdent_2_3 = (Lazy.force _lh_addPs_arg1_2) in
    (match _lh_matchIdent_2_3 with
      | `Pz -> 
        (Lazy.force _lh_addPs_arg2_2)
      | `Pc(_lh_addPs_Pc_0_4, _lh_addPs_Pc_1_4) -> 
        (let rec _lh_matchIdent_2_4 = (Lazy.force _lh_addPs_arg2_2) in
...
let rec negatePs_lh__d1 _lh_negatePs_arg1_2 =
  (lazy (let rec _lh_matchIdent_5_4 = (Lazy.force _lh_negatePs_arg1_2) in
...
let rec integral_lh__d5 _lh_integral_arg1_4 =
  (let rec int1_1_4 = (fun fss_7 n_1_5 -> 
    (lazy (let rec _lh_matchIdent_4_0 = (Lazy.force fss_7) in
      (match _lh_matchIdent_4_0 with
        | `Pz -> 
          (`Pz)
        | `Pc(_lh_int1_Pc_0_9, _lh_int1_Pc_1_9) -> 
          (`Pc((_lh_int1_Pc_0_9 / n_1_5), ((int1_1_4 _lh_int1_Pc_1_9) (n_1_5 + 1))))
        | _ -> 
          (failwith "error"))))) in
    (lazy (`Pc(0, ((int1_1_4 _lh_integral_arg1_4) 1)))));;
    ...
    (lazy (let rec _lh_matchIdent_4 = (Lazy.force (Lazy.force fss_1)) in
      (match _lh_matchIdent_4 with
        ...
        | `Pc(_lh_int1_Pc_0_1, _lh_int1_Pc_1_1) -> 
          (`Pc((_lh_int1_Pc_0_1 / n_1), ((int1_1 (lazy _lh_int1_Pc_1_1)) (n_1 + 1))))
        | _ -> 
          (failwith "error"))))) in
    (lazy (`Pc(0, ((int1_1 _lh_integralLz_arg1_1) 1)))));;
...
let rec multPs_lh__d1 _lh_multPs_arg1_0 _lh_multPs_arg2_0 =
  (lazy (let rec _lh_matchIdent_4_6 = (Lazy.force _lh_multPs_arg1_0) in
    (match _lh_matchIdent_4_6 with
      | `Pz -> 
        (`Pz)
      | `Pc(_lh_multPs_Pc_0_0, _lh_multPs_Pc_1_0) -> 
        (let rec _lh_matchIdent_4_7 = (Lazy.force _lh_multPs_arg2_0) in
...
let rec multPsLzLz_lh__d1 _lh_multPsLzLz_arg1_0 _lh_multPsLzLz_arg2_0 =
  (lazy (let rec _lh_matchIdent_5_2 = (Lazy.force (Lazy.force _lh_multPsLzLz_arg1_0)) in
    (match _lh_matchIdent_5_2 with
      | `Pz -> 
        (`Pz)
      | `Pc(_lh_multPsLzLz_Pc_0_0, _lh_multPsLzLz_Pc_1_0) -> 
        (let rec _lh_matchIdent_5_3 = (Lazy.force (Lazy.force _lh_multPsLzLz_arg2_0)) in
...
let rec extract_lh__d3 _lh_extract_arg1_0 _lh_extract_arg2_0 =
  (if (_lh_extract_arg1_0 = 0) then
    ...
    (let rec _lh_matchIdent_2_6 = (Lazy.force _lh_extract_arg2_0) in
...
let rec divPs_lh__d3 _lh_divPs_arg1_1 _lh_divPs_arg2_1 =
  (lazy (let rec _lh_matchIdent_3_3 = (Lazy.force _lh_divPs_arg1_1) in
    (match _lh_matchIdent_3_3 with
      | `Pz -> 
        (let rec _lh_matchIdent_3_4 = (Lazy.force _lh_divPs_arg2_1) in
      ...
      | `Pc(_lh_divPs_Pc_0_5, _lh_divPs_Pc_1_5) -> 
        (match _lh_divPs_Pc_0_5 with
          | 0 -> 
            (let rec _lh_matchIdent_3_5 = (Lazy.force _lh_divPs_arg2_1) in
              (match _lh_matchIdent_3_5 with
                ...
                | _ -> 
                  (failwith "error")))
          | _ -> 
            (let rec _lh_matchIdent_3_6 = (Lazy.force _lh_divPs_arg2_1) in
...
let rec compose_lh__d1 _lh_compose_arg1_0 _lh_compose_arg2_0 =
  (lazy (let rec _lh_matchIdent_5 = (Lazy.force _lh_compose_arg1_0) in
    (match _lh_matchIdent_5 with
      | `Pz -> 
        (`Pz)
      | `Pc(_lh_compose_Pc_0_0, _lh_compose_Pc_1_0) -> 
        (let rec _lh_matchIdent_6 = (Lazy.force _lh_compose_arg2_0) in
...
let rec integral_lh__d1 _lh_integral_arg1_3 =
  (let rec int1_1_3 = (fun fss_6 n_1_3 -> 
    (lazy (let rec _lh_matchIdent_2_8 = (Lazy.force fss_6) in
      ((_lh_matchIdent_2_8 int1_1_3) n_1_3)))) in
    (lazy (let rec _lh_revert_Pc_1_0 = ((int1_1_3 _lh_integral_arg1_3) 1) in
          ...
          (match _lh_revert_Pc_0_0 with
            | 0 -> 
              (Lazy.force (let rec rs_0 = (lazy (`Pc(0, ((divPs_lh__d3 (fromIntegerPs_lh__d5 1)) ((compose_lh__d1 _lh_revert_Pc_1_0) rs_0))))) in
                rs_0))
            | _ -> 
              (let rec _lh_matchIdent_2_9 = (Lazy.force _lh_revert_Pc_1_0) in
                (match _lh_matchIdent_2_9 with
                  | `Pc(_lh_revert_Pc_0_1, _lh_revert_Pc_1_1) -> 
                    (let rec _lh_matchIdent_3_0 = (Lazy.force _lh_revert_Pc_1_1) in
...
let rec extract_lh__d1 _lh_extract_arg1_1 _lh_extract_arg2_1 =
  (if (_lh_extract_arg1_1 = 0) then
    ...
    (let rec _lh_matchIdent_3_1 = (Lazy.force _lh_extract_arg2_1) in
...
let rec integral_lh__d2 _lh_integral_arg1_0 =
  (let rec int1_1_0 = (fun fss_3 n_1_0 -> 
    (lazy (let rec _lh_matchIdent_1_9 = (Lazy.force fss_3) in
      (match _lh_matchIdent_1_9 with
        ...
        | _ -> 
          (failwith "error"))))) in
    (lazy (`Pc(0, ((int1_1_0 _lh_integral_arg1_0) 1)))));;
...
let rec integralLz_lh__d1 _lh_integralLz_arg1_0 =
  (let rec int1_0 = (fun fss_0 n_0 -> 
    (lazy (let rec _lh_matchIdent_3 = (Lazy.force (Lazy.force fss_0)) in
      (match _lh_matchIdent_3 with
        | `Pz -> 
          (`Pz)
        | `Pc(_lh_int1_Pc_0_0, _lh_int1_Pc_1_0) -> 
          (`Pc((_lh_int1_Pc_0_0 / n_0), ((int1_0 (lazy _lh_int1_Pc_1_0)) (n_0 + 1))))
        | _ -> 
          (failwith "error"))))) in
...
let rec extract_lh__d2 _lh_extract_arg1_2 _lh_extract_arg2_2 =
  (if (_lh_extract_arg1_2 = 0) then
    ...
    (let rec _lh_matchIdent_4_5 = (Lazy.force _lh_extract_arg2_2) in
...
let rec addPs_lh__d5 _lh_addPs_arg1_3 _lh_addPs_arg2_3 =
  (lazy (let rec _lh_matchIdent_4_1 = (Lazy.force _lh_addPs_arg1_3) in
    (match _lh_matchIdent_4_1 with
      | `Pz -> 
        (Lazy.force _lh_addPs_arg2_3)
      | `Pc(_lh_addPs_Pc_0_6, _lh_addPs_Pc_1_6) -> 
        (let rec _lh_matchIdent_4_2 = (Lazy.force _lh_addPs_arg2_3) in
...
let rec divPs_lh__d1 _lh_divPs_arg1_2 _lh_divPs_arg2_2 =
  (lazy (let rec _lh_matchIdent_4_8 = (Lazy.force _lh_divPs_arg1_2) in
    (match _lh_matchIdent_4_8 with
      | `Pz -> 
        (let rec _lh_matchIdent_4_9 = (Lazy.force _lh_divPs_arg2_2) in
      ...
      | `Pc(_lh_divPs_Pc_0_9, _lh_divPs_Pc_1_9) -> 
        (match _lh_divPs_Pc_0_9 with
          | 0 -> 
            (let rec _lh_matchIdent_5_0 = (Lazy.force _lh_divPs_arg2_2) in
              (match _lh_matchIdent_5_0 with
                ...
                | _ -> 
                  (failwith "error")))
          | _ -> 
            (let rec _lh_matchIdent_5_1 = (Lazy.force _lh_divPs_arg2_2) in
...
let rec negatePs_lh__d2 _lh_negatePs_arg1_1 =
  (lazy (let rec _lh_matchIdent_3_2 = (Lazy.force _lh_negatePs_arg1_1) in
...
let rec addPs_lh__d4 _lh_addPs_arg1_0 _lh_addPs_arg2_0 =
  (lazy (let rec _lh_matchIdent_1_6 = (Lazy.force _lh_addPs_arg1_0) in
    (match _lh_matchIdent_1_6 with
      | `Pz -> 
        (Lazy.force _lh_addPs_arg2_0)
      | `Pc(_lh_addPs_Pc_0_0, _lh_addPs_Pc_1_0) -> 
        (let rec _lh_matchIdent_1_7 = (Lazy.force _lh_addPs_arg2_0) in
...
let rec dotMultSndLz_lh__d1 _lh_dotMultSndLz_arg1_0 _lh_dotMultSndLz_arg2_0 =
  (lazy (let rec _lh_matchIdent_1_2 = (Lazy.force (Lazy.force _lh_dotMultSndLz_arg2_0)) in
...
let rec addPs_lh__d3 _lh_addPs_arg1_1 _lh_addPs_arg2_1 =
  (lazy (let rec _lh_matchIdent_2_0 = (Lazy.force _lh_addPs_arg1_1) in
    (match _lh_matchIdent_2_0 with
      | `Pz -> 
        (Lazy.force _lh_addPs_arg2_1)
      | `Pc(_lh_addPs_Pc_0_2, _lh_addPs_Pc_1_2) -> 
        (let rec _lh_matchIdent_2_1 = (Lazy.force _lh_addPs_arg2_1) in
...
let rec integral_lh__d3 _lh_integral_arg1_1 =
  (let rec int1_1_1 = (fun fss_4 n_1_1 -> 
    (lazy (let rec _lh_matchIdent_2_2 = (Lazy.force fss_4) in
      (match _lh_matchIdent_2_2 with
        | `Pz -> 
          (`Pz)
        | `Pc(_lh_int1_Pc_0_8, _lh_int1_Pc_1_8) -> 
          (`Pc((_lh_int1_Pc_0_8 / n_1_1), ((int1_1_1 _lh_int1_Pc_1_8) (n_1_1 + 1))))
        | _ -> 
          (failwith "error"))))) in
    (lazy (`Pc(0, ((int1_1_1 _lh_integral_arg1_1) 1)))));;
let rec deriv_lh__d1 _lh_deriv_arg1_0 =
  (lazy (let rec _lh_matchIdent_2_7 = (Lazy.force _lh_deriv_arg1_0) in
...
let rec sqrtPs_lh__d1 _lh_sqrtPs_arg1_0 =
  (lazy (let rec _lh_matchIdent_3_7 = (Lazy.force _lh_sqrtPs_arg1_0) in
    (match _lh_matchIdent_3_7 with
      ...
      | `Pc(_lh_sqrtPs_Pc_0_0, _lh_sqrtPs_Pc_1_0) -> 
        (match _lh_sqrtPs_Pc_0_0 with
          | 0 -> 
            (let rec _lh_matchIdent_3_8 = (Lazy.force _lh_sqrtPs_Pc_1_0) in
...
let rec addPs_lh__d1 _lh_addPs_arg1_5 _lh_addPs_arg2_5 =
  (lazy (let rec _lh_matchIdent_5_5 = (Lazy.force _lh_addPs_arg1_5) in
    (match _lh_matchIdent_5_5 with
      | `Pz -> 
        (Lazy.force _lh_addPs_arg2_5)
      | `Pc(_lh_addPs_Pc_0_1_0, _lh_addPs_Pc_1_1_0) -> 
        (let rec _lh_matchIdent_5_6 = (Lazy.force _lh_addPs_arg2_5) in
...
let rec composeSndLz_lh__d1 _lh_composeSndLz_arg1_0 _lh_composeSndLz_arg2_0 =
  (lazy (let rec _lh_matchIdent_1_3 = (Lazy.force _lh_composeSndLz_arg1_0) in
    (match _lh_matchIdent_1_3 with
      | `Pz -> 
        (`Pz)
      | `Pc(_lh_composeSndLz_Pc_0_0, _lh_composeSndLz_Pc_1_0) -> 
        (let rec _lh_matchIdent_1_4 = (Lazy.force (Lazy.force _lh_composeSndLz_arg2_0)) in
...
let rec extract_lh__d4 _lh_extract_arg1_3 _lh_extract_arg2_3 =
  (if (_lh_extract_arg1_3 = 0) then
    ...
    (let rec _lh_matchIdent_5_7 = (Lazy.force _lh_extract_arg2_3) in
