...
let rec example5_lh =
  (prod_lh (((scanr_lh plus__lh) zerO_lh) (`LH_C(a_lh, (`LH_C(b_lh, (`LH_C(c_lh, (`LH_C(d_lh, (`LH_N)))))))))));;
let rec example0_lh =
  a_lh;;
...
let rec testCse_nofib_lh _lh_testCse_nofib_arg1_0 =
  ((map_lh (fun i_1 -> 
    ((map_lh cse_lh) ((take_lh (i_1 mod 6)) (`LH_C(example0_lh, (`LH_C(example1_lh, (`LH_C(example2_lh, (`LH_C(example3_lh, (`LH_C(example4_lh, (`LH_C(example5_lh, (`LH_N))))))))))))))))) ((enumFromTo_lh 1) _lh_testCse_nofib_arg1_0));;
let run () = 1 + (Obj.magic ((testCse_nofib_lh 1000)));
end;;
