...
let rec scanr_lh__d1 _lh_scanr_arg1_0 _lh_scanr_arg2_0 _lh_scanr_arg3_0 =
  (match _lh_scanr_arg3_0 with
    ...
    | `LH_C(_lh_scanr_LH_C_0_0, _lh_scanr_LH_C_1_0) -> 
      (let rec _lh_matchIdent_7 = (((scanr_lh__d1 _lh_scanr_arg1_0) _lh_scanr_arg2_0) _lh_scanr_LH_C_1_0) in
...
let rec example5_lh__d1 =
  (prod_lh__d1 (((scanr_lh__d1 plus__lh__d1) zerO_lh__d1) (`LH_C(a_lh__d1, (`LH_C(b_lh__d1, (`LH_C(c_lh__d1, (`LH_C(d_lh__d1, (`LH_N)))))))))));;
...
let rec foldr_lh__d1 f_2 i_0 ls_3 =
  (match ls_3 with
    ...
    | `LH_N -> 
      i_0);;
let rec map_lh__d3 f_3 ls_4 =
  (match ls_4 with
    | `LH_C(h_7, t_7) -> 
      (`LH_C((f_3 h_7), ((map_lh__d3 f_3) t_7)))
    | `LH_N -> 
      (`LH_N));;
            ...
            (let rec rcs_0 = ((map_lh__d3 _lh_sim_LH_P2_0_0) _lh_sim_LH_P3_2_0) in
              (let rec ms_0 = (let rec _lh_listcomp_fun_0 = (fun _lh_listcomp_fun_para_0 -> 
                ...
                (if (null_lh__d1 ms_0) then
                  ...
                  (`LH_P2((((newlyDefined_lh__d1 _lh_sim_LH_P3_0_0) (head_lh__d1 ms_0)) _lh_sim_LH_P2_0_0), _lh_sim_LH_P2_1_0)))))))) in
    (let rec _lh_matchIdent_6 = (((foldr_lh__d1 sim_0) (`LH_P2(id_lh__d1, (`LH_N)))) _lh_findCommon_arg1_0) in
...
let rec retURN_lh__d2 _lh_retURN_arg1_1 s_2 =
  (`LH_P2(s_2, _lh_retURN_arg1_1));;
...
let rec retURN_lh__d3 _lh_retURN_arg1_0 s_0 =
  (`LH_P2(s_0, _lh_retURN_arg1_0));;
let rec bind_lh__d4 _lh_bind_arg1_0 _lh_bind_arg2_0 s_1 =
  (let rec _lh_matchIdent_0 = (_lh_bind_arg1_0 s_1) in
      ...
      | `Node(_lh_label_Node_0_0, _lh_label_Node_1_0) -> 
        ((bind_lh__d2 incr_lh__d1) (fun n_0 -> 
          ((bind_lh__d1 ((mmapl_lh__d1 label_0) _lh_label_Node_1_0)) (fun ts_0 -> 
            (retURN_lh__d1 (`Node((`LH_P2(n_0, _lh_label_Node_0_0)), ts_0))))))))) in
...
let rec example4_lh__d1 =
  (prod_lh__d2 (((scanl_lh__d1 plus__lh__d2) zerO_lh__d2) (`LH_C(a_lh__d2, (`LH_C(b_lh__d2, (`LH_C(c_lh__d2, (`LH_C(d_lh__d2, (`LH_N)))))))))));;
...
let rec testCse_nofib_lh__d1 _lh_testCse_nofib_arg1_0 =
  ((map_lh__d1 (fun i_1 -> 
    ((map_lh__d2 cse_lh__d1) ((take_lh__d1 (i_1 mod 6)) (`LH_C(example0_lh__d1, (`LH_C(example1_lh__d1, (`LH_C(example2_lh__d1, (`LH_C(example3_lh__d1, (`LH_C(example4_lh__d1, (`LH_C(example5_lh__d1, (`LH_N))))))))))))))))) ((enumFromTo_lh__d1 1) _lh_testCse_nofib_arg1_0));;
