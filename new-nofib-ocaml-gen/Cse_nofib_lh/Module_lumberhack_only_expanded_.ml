...
let rec example5_lh__d1 =
  (prod_lh__d2 (((scanr_lh__d1 plus__lh__d7) zerO_lh__d2) (`LH_C(a_lh__d9, (`LH_C(b_lh__d6, (`LH_C(c_lh__d3, (`LH_C(d_lh__d2, (`LH_N)))))))))));;
let rec a_lh__d4 =
  (`Node((`LH_C('a', (`LH_N))), (`LH_N)));;
...
let rec bind_lh__d3 _lh_bind_arg1_1 _lh_bind_arg2_1 s_4 =
  (let rec _lh_matchIdent_1 = (_lh_bind_arg1_1 s_4) in
...
let rec mappend_lh__d1 xs_1 ys_1 =
  (match xs_1 with
    ...
    | `LH_N -> 
      ys_1);;
let rec foldr_lh__d1 f_2 i_0 ls_2 =
  (match ls_2 with
    | `LH_C(h_4, t_4) -> 
      ((f_2 h_4) (((foldr_lh__d1 f_2) i_0) t_4))
    | `LH_N -> 
      i_0);;
let rec map_lh__d3 f_3 ls_4 =
  (match ls_4 with
    | `LH_C(h_6, t_6) -> 
      (`LH_C((f_3 h_6), ((map_lh__d3 f_3) t_6)))
    | `LH_N -> 
      (`LH_N));;
...
let rec findCommon_lh__d1 _lh_findCommon_arg1_0 =
  (let rec sim_0 = (fun _lh_sim_arg1_0 _lh_sim_arg2_0 -> 
    ...
    (let rec _lh_matchIdent_5 = (((foldr_lh__d1 sim_0) (`LH_P2(id_lh__d1, (`LH_N)))) _lh_findCommon_arg1_0) in
...
let rec scanl_lh__d1 _lh_scanl_arg1_0 _lh_scanl_arg2_0 _lh_scanl_arg3_0 =
  (`LH_C(_lh_scanl_arg2_0, (let rec _lh_matchIdent_7 = _lh_scanl_arg3_0 in
...
let rec example4_lh__d1 =
  (prod_lh__d1 (((scanl_lh__d1 plus__lh__d6) zerO_lh__d1) (`LH_C(a_lh__d8, (`LH_C(b_lh__d5, (`LH_C(c_lh__d2, (`LH_C(d_lh__d1, (`LH_N)))))))))));;
...
let rec testCse_nofib_lh__d1 _lh_testCse_nofib_arg1_0 =
  ((map_lh__d2 (fun i_1 -> 
    ((map_lh__d1 cse_lh__d1) ((take_lh__d1 (i_1 mod 6)) (`LH_C(example0_lh__d1, (`LH_C(example1_lh__d1, (`LH_C(example2_lh__d1, (`LH_C(example3_lh__d1, (`LH_C(example4_lh__d1, (`LH_C(example5_lh__d1, (`LH_N))))))))))))))))) ((enumFromTo_lh__d1 1) _lh_testCse_nofib_arg1_0));;
