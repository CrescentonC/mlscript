...
let rec bind_lh__d1 _lh_bind_arg1_3 _lh_bind_arg2_4 s_7 =
  (let rec _lh_matchIdent_9 = (_lh_bind_arg1_3 s_7) in
    (_lh_matchIdent_9 _lh_bind_arg2_4));;
let rec update_lh__d1 _lh_update_arg1_0 s_6 _lh_bind_arg2_3 =
  (let rec _lh_bind_LH_P2_1_3 = s_6 in
    (let rec _lh_bind_LH_P2_0_3 = (_lh_update_arg1_0 s_6) in
...
let rec zerO_lh__d2 label_2_8 =
  (let rec _lh_label_Node_1_2_7 = (`LH_N) in
    (let rec _lh_label_Node_0_2_7 = (`LH_C('0', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_2_8 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_2_8) _lh_label_Node_1_2_7)) (fun ts_2_7 -> 
          (retURN_lh__d1 (`Node((`LH_P2(n_2_8, _lh_label_Node_0_2_7)), ts_2_7)))))))));;
let rec d_lh__d2 label_2_6 =
  (let rec _lh_label_Node_1_2_5 = (`LH_N) in
    (let rec _lh_label_Node_0_2_5 = (`LH_C('d', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_2_6 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_2_6) _lh_label_Node_1_2_5)) (fun ts_2_5 -> 
          (retURN_lh__d1 (`Node((`LH_P2(n_2_6, _lh_label_Node_0_2_5)), ts_2_5)))))))));;
let rec plus__lh__d7 _lh_plus__arg1_6 _lh_plus__arg2_6 label_3_3 =
  (let rec _lh_label_Node_1_3_2 = (`LH_C(_lh_plus__arg1_6, (`LH_C(_lh_plus__arg2_6, (`LH_N))))) in
    (let rec _lh_label_Node_0_3_2 = (`LH_C('+', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_4_0 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_3_3) _lh_label_Node_1_3_2)) (fun ts_3_2 -> 
          (retURN_lh__d1 (`Node((`LH_P2(n_4_0, _lh_label_Node_0_3_2)), ts_3_2)))))))));;
let rec c_lh__d3 label_3_4 =
  (let rec _lh_label_Node_1_3_3 = (`LH_N) in
    (let rec _lh_label_Node_0_3_3 = (`LH_C('c', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_4_1 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_3_4) _lh_label_Node_1_3_3)) (fun ts_3_3 -> 
...
let rec plus__lh__d4 _lh_plus__arg1_5 _lh_plus__arg2_5 label_2_9 =
...
let rec plus__lh__d1 _lh_plus__arg1_1 _lh_plus__arg2_1 label_1_5 =
  (let rec _lh_label_Node_1_1_4 = (`LH_C(_lh_plus__arg1_1, (`LH_C(_lh_plus__arg2_1, (`LH_N))))) in
    (let rec _lh_label_Node_0_1_4 = (`LH_C('+', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_1_5 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_1_5) _lh_label_Node_1_1_4)) (fun ts_1_4 -> 
          (retURN_lh__d1 (`Node((`LH_P2(n_1_5, _lh_label_Node_0_1_4)), ts_1_4)))))))));;
let rec a_lh__d2 label_1_9 =
  (let rec _lh_label_Node_1_1_8 = (`LH_N) in
    (let rec _lh_label_Node_0_1_8 = (`LH_C('a', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_1_9 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_1_9) _lh_label_Node_1_1_8)) (fun ts_1_8 -> 
          (retURN_lh__d1 (`Node((`LH_P2(n_1_9, _lh_label_Node_0_1_8)), ts_1_8)))))))));;
let rec b_lh__d2 label_2_1 =
  (let rec _lh_label_Node_1_2_0 = (`LH_N) in
    (let rec _lh_label_Node_0_2_0 = (`LH_C('b', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_2_1 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_2_1) _lh_label_Node_1_2_0)) (fun ts_2_0 -> 
          (retURN_lh__d1 (`Node((`LH_P2(n_2_1, _lh_label_Node_0_2_0)), ts_2_0)))))))));;
let rec plus__lh__d3 _lh_plus__arg1_2 _lh_plus__arg2_2 label_2_2 =
  (let rec _lh_label_Node_1_2_1 = (`LH_C(_lh_plus__arg1_2, (`LH_C(_lh_plus__arg2_2, (`LH_N))))) in
    (let rec _lh_label_Node_0_2_1 = (`LH_C('+', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_2_2 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_2_2) _lh_label_Node_1_2_1)) (fun ts_2_1 -> 
          (retURN_lh__d1 (`Node((`LH_P2(n_2_2, _lh_label_Node_0_2_1)), ts_2_1)))))))));;
let rec plus__lh__d2 _lh_plus__arg1_4 _lh_plus__arg2_4 label_2_7 =
  (let rec _lh_label_Node_1_2_6 = (`LH_C(_lh_plus__arg1_4, (`LH_C(_lh_plus__arg2_4, (`LH_N))))) in
    (let rec _lh_label_Node_0_2_6 = (`LH_C('+', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_2_7 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_2_7) _lh_label_Node_1_2_6)) (fun ts_2_6 -> 
          (retURN_lh__d1 (`Node((`LH_P2(n_2_7, _lh_label_Node_0_2_6)), ts_2_6)))))))));;
let rec b_lh__d1 label_7 =
  (let rec _lh_label_Node_1_7 = (`LH_N) in
    (let rec _lh_label_Node_0_7 = (`LH_C('b', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_7 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_7) _lh_label_Node_1_7)) (fun ts_7 -> 
          (retURN_lh__d1 (`Node((`LH_P2(n_7, _lh_label_Node_0_7)), ts_7)))))))));;
let rec a_lh__d3 label_8 =
  (let rec _lh_label_Node_1_8 = (`LH_N) in
    (let rec _lh_label_Node_0_8 = (`LH_C('a', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_8 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_8) _lh_label_Node_1_8)) (fun ts_8 -> 
          (retURN_lh__d1 (`Node((`LH_P2(n_8, _lh_label_Node_0_8)), ts_8)))))))));;
let rec mult__lh__d1 _lh_mult__arg1_0 _lh_mult__arg2_0 label_9 =
  (let rec _lh_label_Node_1_9 = (`LH_C(_lh_mult__arg1_0, (`LH_C(_lh_mult__arg2_0, (`LH_N))))) in
    (let rec _lh_label_Node_0_9 = (`LH_C('*', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_9 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_9) _lh_label_Node_1_9)) (fun ts_9 -> 
          (retURN_lh__d1 (`Node((`LH_P2(n_9, _lh_label_Node_0_9)), ts_9)))))))));;
let rec example3_lh__d1 =
  ((plus__lh__d2 ((mult__lh__d1 ((plus__lh__d1 a_lh__d2) b_lh__d2)) c_lh__d1)) ((plus__lh__d3 a_lh__d3) b_lh__d1));;
let rec map_lh__d1 f_3 ls_4 =
  (ls_4 f_3);;
let rec a_lh__d1 label_1_3 =
  (let rec _lh_label_Node_1_1_2 = (`LH_N) in
    (let rec _lh_label_Node_0_1_2 = (`LH_C('a', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_1_2 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_1_3) _lh_label_Node_1_1_2)) (fun ts_1_2 -> 
    ...
    | `LH_C(h_5, t_5) -> 
      (let rec t_6 = ((map_lh__d5 f_4) t_5) in
        (let rec h_6 = (f_4 h_5) in
          ((mappend_lh__d2 h_6) (concat_lh__d1 t_6))))
    | `LH_N -> 
      (`LH_N));;
...
let rec null_lh__d1 _lh_null_arg1_0 =
  (match _lh_null_arg1_0 with
    ...
    | `LH_C(_lh_null_LH_C_0_0, _lh_null_LH_C_1_0) -> 
      false);;
let rec map_lh__d4 f_1_3 ls_7 _lh_floatOutId_0_1 =
  (match ls_7 with
    | `LH_C(h_1_9, t_1_9) -> 
      (let rec t_2_0 = ((map_lh__d4 f_1_3) t_1_9) in
        (let rec h_2_0 = (f_1_3 h_1_9) in
          (`LH_C((_lh_floatOutId_0_1 h_2_0), ((map_lh__d3 _lh_floatOutId_0_1) t_2_0)))))
    | `LH_N -> 
      (`LH_N));;
                        ...
                        (let rec rcs_0 = ((map_lh__d3 _lh_sim_LH_P2_0_0) _lh_sim_LH_P3_2_0) in
                          (let rec ms_0 = (let rec _lh_listcomp_fun_0 = (fun _lh_listcomp_fun_para_0 -> 
                            ...
                            (if (null_lh__d1 ms_0) then
                              ...
                              (`LH_P2((((newlyDefined_lh__d1 _lh_sim_LH_P3_0_0) (head_lh__d1 ms_0)) _lh_sim_LH_P2_0_0), _lh_sim_LH_P2_1_0)))))))))), (concat_lh__d1 ((map_lh__d5 ltGraph_lh__d1) _lh_ltGraph_Node_1_0)))))));;
...
let rec example4_lh__d1 =
  (prod_lh__d1 (((scanl_lh__d1 plus__lh__d6) zerO_lh__d1) (let rec _lh_scanl_LH_C_1_0 = (let rec _lh_scanl_LH_C_1_1 = (let rec _lh_scanl_LH_C_1_2 = (let rec _lh_scanl_LH_C_1_3 = (fun _lh_scanl_arg1_0 _lh_scanl_arg2_0 -> 
    (`LH_N)) in
    ...
    (let rec _lh_scanl_LH_C_0_2 = b_lh__d5 in
    ...
    (let rec _lh_scanl_LH_C_0_3 = a_lh__d8 in
...
let rec mult__lh__d3 _lh_mult__arg1_1 _lh_mult__arg2_1 label_1_1 =
  (let rec _lh_label_Node_1_1_1 = (`LH_C(_lh_mult__arg1_1, (`LH_C(_lh_mult__arg2_1, (`LH_N))))) in
    (let rec _lh_label_Node_0_1_1 = (`LH_C('*', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_1_1 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_1_1) _lh_label_Node_1_1_1)) (fun ts_1_1 -> 
          (retURN_lh__d1 (`Node((`LH_P2(n_1_1, _lh_label_Node_0_1_1)), ts_1_1)))))))));;
let rec b_lh__d4 label_1_8 =
  (let rec _lh_label_Node_1_1_7 = (`LH_N) in
    (let rec _lh_label_Node_0_1_7 = (`LH_C('b', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_1_8 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_1_8) _lh_label_Node_1_1_7)) (fun ts_1_7 -> 
          (retURN_lh__d1 (`Node((`LH_P2(n_1_8, _lh_label_Node_0_1_7)), ts_1_7)))))))));;
let rec b_lh__d3 label_2_0 =
  (let rec _lh_label_Node_1_1_9 = (`LH_N) in
    (let rec _lh_label_Node_0_1_9 = (`LH_C('b', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_2_0 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_2_0) _lh_label_Node_1_1_9)) (fun ts_1_9 -> 
          (retURN_lh__d1 (`Node((`LH_P2(n_2_0, _lh_label_Node_0_1_9)), ts_1_9)))))))));;
let rec mult__lh__d2 _lh_mult__arg1_2 _lh_mult__arg2_2 label_3_0 =
  (let rec _lh_label_Node_1_2_9 = (`LH_C(_lh_mult__arg1_2, (`LH_C(_lh_mult__arg2_2, (`LH_N))))) in
    (let rec _lh_label_Node_0_2_9 = (`LH_C('*', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_3_0 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_3_0) _lh_label_Node_1_2_9)) (fun ts_2_9 -> 
          (retURN_lh__d1 (`Node((`LH_P2(n_3_0, _lh_label_Node_0_2_9)), ts_2_9)))))))));;
let rec a_lh__d6 label_3_2 =
  (let rec _lh_label_Node_1_3_1 = (`LH_N) in
    (let rec _lh_label_Node_0_3_1 = (`LH_C('a', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_3_9 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_3_2) _lh_label_Node_1_3_1)) (fun ts_3_1 -> 
          (retURN_lh__d1 (`Node((`LH_P2(n_3_9, _lh_label_Node_0_3_1)), ts_3_1)))))))));;
let rec plus__lh__d5 _lh_plus__arg1_3 _lh_plus__arg2_3 label_2_4 =
  (let rec _lh_label_Node_1_2_3 = (`LH_C(_lh_plus__arg1_3, (`LH_C(_lh_plus__arg2_3, (`LH_N))))) in
    (let rec _lh_label_Node_0_2_3 = (`LH_C('+', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_2_4 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_2_4) _lh_label_Node_1_2_3)) (fun ts_2_3 -> 
          (retURN_lh__d1 (`Node((`LH_P2(n_2_4, _lh_label_Node_0_2_3)), ts_2_3)))))))));;
let rec a_lh__d7 label_2_5 =
  (let rec _lh_label_Node_1_2_4 = (`LH_N) in
    (let rec _lh_label_Node_0_2_4 = (`LH_C('a', (`LH_N))) in
      ((bind_lh__d1 incr_lh__d1) (fun n_2_5 -> 
        ((bind_lh__d2 ((mmapl_lh__d1 label_2_5) _lh_label_Node_1_2_4)) (fun ts_2_4 -> 
          (retURN_lh__d1 (`Node((`LH_P2(n_2_5, _lh_label_Node_0_2_4)), ts_2_4)))))))));;
let rec example2_lh__d1 =
  ((plus__lh__d5 ((mult__lh__d2 a_lh__d7) b_lh__d4)) ((mult__lh__d3 a_lh__d6) b_lh__d3));;
...
let rec testCse_nofib_lh__d1 _lh_testCse_nofib_arg1_0 =
  ((map_lh__d2 (fun i_1 -> 
    ((map_lh__d1 cse_lh__d1) ((take_lh__d1 (i_1 mod 6)) (let rec t_7 = (let rec t_8 = (let rec t_9 = (let rec t_1_0 = (let rec t_1_1 = (let rec t_1_2 = (fun n_3_1 f_6 -> 
      (`LH_N)) in
