        ...
        (let rec _lh_matchIdent_2 = name_threshold_0 in
          (match _lh_matchIdent_2 with
            | `LH_P2(_lh_awards_LH_P2_0_1, _lh_awards_LH_P2_1_1) -> 
              ((map_lh (fun ps_0 -> 
                (`LH_P2(_lh_awards_LH_P2_0_1, ps_0)))) (sort_lh (atleast_0 _lh_awards_LH_P2_1_1)))))) in
    ...
    (let rec _lh_matchIdent_0 = name_scores_0 in
      (match _lh_matchIdent_0 with
        | `LH_P2(_lh_findallawards_LH_P2_0_0, _lh_findallawards_LH_P2_1_0) -> 
          (`LH_P2(_lh_findallawards_LH_P2_0_0, (findawards_lh _lh_findallawards_LH_P2_1_0))))))) _lh_findallawards_arg1_0);;
...
let run () = 1 + (Obj.magic ((testAwards_nofib_lh 500)));
end;;
