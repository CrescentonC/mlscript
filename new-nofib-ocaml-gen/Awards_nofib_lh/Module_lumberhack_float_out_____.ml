    ...
    | `LH_N -> 
      (((rqsort_lh__d2 _lh_qpart_arg1_0) _lh_qpart_arg4_0) (let rec t_1_8 = (((rqsort_lh__d1 _lh_qpart_arg1_0) _lh_qpart_arg5_0) _lh_qpart_arg6_0) in
        (let rec h_1_8 = _lh_qpart_arg2_0 in
          (fun f_1_9 -> 
            (`LH_C((f_1_9 h_1_8), ((map_lh__d3 f_1_9) t_1_8)))))))
    ...
    | `LH_N -> 
      (((qsort_lh__d1 _lh_rqpart_arg1_1) _lh_rqpart_arg4_1) (let rec t_1_9 = (((qsort_lh__d1 _lh_rqpart_arg1_1) _lh_rqpart_arg5_1) _lh_rqpart_arg6_1) in
        (let rec h_1_9 = _lh_rqpart_arg2_1 in
          (fun f_2_1 -> 
            (`LH_C((f_2_1 h_1_9), ((map_lh__d3 f_2_1) t_1_9)))))))
    ...
    | `LH_N -> 
      (((qsort_lh__d1 _lh_rqpart_arg1_0) _lh_rqpart_arg4_0) (let rec t_7 = (((qsort_lh__d1 _lh_rqpart_arg1_0) _lh_rqpart_arg5_0) _lh_rqpart_arg6_0) in
        (let rec h_7 = _lh_rqpart_arg2_0 in
          (fun f_8 -> 
            (`LH_C((f_8 h_7), ((map_lh__d3 f_8) t_7)))))))
        ...
        | `LH_N -> 
          (let rec t_1_1 = _lh_rqsort_arg3_0 in
            (let rec h_1_1 = _lh_rqsort_LH_C_0_0 in
              (fun f_1_1 -> 
                (`LH_C((f_1_1 h_1_1), ((map_lh__d3 f_1_1) t_1_1))))))
        | _ -> 
        ...
        | `LH_N -> 
          (let rec t_1_2 = _lh_rqsort_arg3_1 in
            (let rec h_1_2 = _lh_rqsort_LH_C_0_1 in
              (fun f_1_2 -> 
                (`LH_C((f_1_2 h_1_2), ((map_lh__d3 f_1_2) t_1_2))))))
        | _ -> 
...
let rec mappend_lh__d3 xs_1 ys_1 =
  (xs_1 ys_1);;
let rec map_lh__d6 f_9 ls_6 _lh_floatOutId_0_1 =
  (match ls_6 with
    | `LH_C(h_8, t_8) -> 
      (let rec t_9 = ((map_lh__d6 f_9) t_8) in
        (let rec h_9 = (f_9 h_8) in
          (`LH_C(h_9, ((mappend_lh__d3 t_9) _lh_floatOutId_0_1)))))
    | `LH_N -> 
      _lh_floatOutId_0_1);;
let rec map_lh__d5 f_1_8 ls_8 =
  (match ls_8 with
    | `LH_C(h_1_7, t_1_7) -> 
      (`LH_C((f_1_8 h_1_7), ((map_lh__d5 f_1_8) t_1_7)))
    | `LH_N -> 
      (`LH_N));;
...
let rec filter_lh__d1 f_2_0 ls_9 =
  (ls_9 f_2_0);;
let rec map_lh__d4 f_3 ls_3 _lh_floatOutId_0_0 =
  (match ls_3 with
    | `LH_C(h_2, t_2) -> 
      (let rec t_3 = ((map_lh__d4 f_3) t_2) in
  ...
  (let rec sumscores_0 = ((map_lh__d4 (fun p_0 -> 
    ...
    (let rec atleast_0 = (fun threshold_0 -> 
      ...
      (let rec award_0 = (fun name_threshold_0 -> 
        ...
        ((mappend_lh__d1 ((mappend_lh__d2 (award_0 (let rec _lh_awards_LH_P2_1_1 = 70 in
...
let rec competitors_lh__d1 _lh_competitors_arg1_0 f_1_7 =
  (let rec t_1_3 = (let rec t_1_4 = (let rec t_1_5 = (let rec t_1_6 = (fun f_1_3 -> 
    (`LH_N)) in
    (let rec h_1_3 = (let rec _lh_findallawards_LH_P2_1_0 = (`LH_C(9, (`LH_C(23, (`LH_C(17, (`LH_C(54, (`LH_C(_lh_competitors_arg1_0, (`LH_C(41, (`LH_C(9, (`LH_C(18, (`LH_C(14, (`LH_N))))))))))))))))))) in
      ...
      (fun f_1_4 -> 
        (`LH_C((f_1_4 h_1_3), ((map_lh__d2 f_1_4) t_1_6)))))) in
    (let rec h_1_4 = (let rec _lh_findallawards_LH_P2_1_1 = (`LH_C(1, (`LH_C(18, (`LH_C(_lh_competitors_arg1_0, (`LH_C(20, (`LH_C(21, (`LH_C(19, (`LH_C(34, (`LH_C(8, (`LH_C(16, (`LH_C(21, (`LH_N))))))))))))))))))))) in
      ...
      (fun f_1_5 -> 
        (`LH_C((f_1_5 h_1_4), ((map_lh__d2 f_1_5) t_1_5)))))) in
    (let rec h_1_5 = (let rec _lh_findallawards_LH_P2_1_2 = (`LH_C(23, (`LH_C(19, (`LH_C(45, (`LH_C(_lh_competitors_arg1_0, (`LH_C(17, (`LH_C(10, (`LH_C(5, (`LH_C(8, (`LH_C(14, (`LH_N))))))))))))))))))) in
      ...
      (fun f_1_6 -> 
        (`LH_C((f_1_6 h_1_5), ((map_lh__d2 f_1_6) t_1_4)))))) in
    (let rec h_1_6 = (let rec _lh_findallawards_LH_P2_1_3 = (`LH_C(35, (`LH_C(27, (`LH_C(40, (`LH_C(_lh_competitors_arg1_0, (`LH_C(34, (`LH_C(21, (`LH_N))))))))))))) in
      ...
      (`LH_C((f_1_7 h_1_6), ((map_lh__d2 f_1_7) t_1_3)))));;
...
let rec map_lh__d1 f_1_0 ls_7 =
  (match ls_7 with
    | `LH_C(h_1_0, t_1_0) -> 
      (`LH_C((f_1_0 h_1_0), ((map_lh__d1 f_1_0) t_1_0)))
    | `LH_N -> 
      (`LH_N));;
