...
let rec concat_lh__d2 lss_1 =
  (lss_1 99);;
let rec map_lh__d2 f_4 ls_1 _lh_floatOutId_0_3 =
  (match ls_1 with
    | `LH_C(h_1_0, t_1_0) -> 
...
let rec splitHelper_lh__d1 _lh_splitHelper_arg1_0 _lh_splitHelper_arg2_0 =
  (match _lh_splitHelper_arg1_0 with
    ...
    | _ -> 
      (let rec t_6 = _lh_splitHelper_arg2_0 in
        (let rec h_6 = _lh_splitHelper_arg1_0 in
          (fun f_3 i_1 -> 
            ((f_3 h_6) (((foldr_lh__d1 f_3) i_1) t_6))))));;
let rec split_lh__d1 _lh_split_arg1_0 =
  ((splitHelper_lh__d1 _lh_split_arg1_0) (fun f_6 i_2 -> 
    i_2));;
let rec mappend_lh__d3 xs_1 ys_6 =
  (xs_1 ys_6);;
let rec mappend_lh__d5 xs_3 ys_1_2 =
  (xs_3 ys_1_2);;
let rec interleave_lh__d1 _lh_interleave_arg1_0 _lh_interleave_arg2_0 _lh_floatOutId_0_1 =
      ...
      (fun ys_2 ys_3 ys_4 -> 
        (let rec t_2 = ((interleave_lh__d1 _lh_interleave_arg2_0) _lh_interleave_LH_C_1_0) in
          (let rec h_2 = _lh_interleave_LH_C_0_0 in
            (let rec t_3 = ((mappend_lh__d5 t_2) _lh_floatOutId_0_1) in
              (let rec h_3 = h_2 in
                (let rec t_4 = ((mappend_lh__d3 t_3) ys_2) in
                  (let rec h_4 = h_3 in
                    (let rec t_5 = ((mappend_lh__d2 t_4) ys_3) in
                      (let rec h_5 = h_4 in
...
let rec length_lh__d1 ls_3 =
  (match ls_3 with
    ...
    | `LH_N -> 
      0);;
let rec interleave_lh__d2 _lh_interleave_arg1_1 _lh_interleave_arg2_1 _lh_floatOutId_0_2 =
  (match _lh_interleave_arg1_1 with
    | `LH_C(_lh_interleave_LH_C_0_1, _lh_interleave_LH_C_1_1) -> 
      (fun ys_8 ys_9 -> 
        (let rec t_7 = ((interleave_lh__d2 _lh_interleave_arg2_1) _lh_interleave_LH_C_1_1) in
          (let rec h_7 = _lh_interleave_LH_C_0_1 in
            (let rec t_8 = ((mappend_lh__d4 t_7) _lh_floatOutId_0_2) in
              (let rec h_8 = h_7 in
...
let rec disp_lh__d1 _lh_disp_arg1_0 =
  (match _lh_disp_arg1_0 with
    | `LH_P2(_lh_disp_LH_P2_0_0, _lh_disp_LH_P2_1_0) -> 
      ((mappend_lh__d3 ((mappend_lh__d5 ((interleave_lh__d1 _lh_disp_LH_P2_0_0) (spaces_lh__d1 (length_lh__d1 _lh_disp_LH_P2_0_0)))) (let rec t_1_3 = (let rec t_1_4 = (fun ys_1_5 -> 
        ys_1_5) in
        (let rec h_1_3 = '=' in
          (fun ys_1_6 -> 
            (let rec t_1_5 = ((mappend_lh__d3 t_1_4) ys_1_6) in
        ...
        (let rec h_1_6 = '<' in
          (fun ys_1_9 -> 
            (let rec t_1_7 = ((mappend_lh__d3 t_1_3) ys_1_9) in
              (let rec h_1_7 = h_1_6 in
                (fun ys_2_0 -> 
                  (let rec t_1_8 = ((mappend_lh__d2 t_1_7) ys_2_0) in
                    (let rec h_1_8 = h_1_7 in
                      (fun ys_2_1 -> 
                        (`LH_C(h_1_8, ((mappend_lh__d1 t_1_8) ys_2_1)))))))))))))) ((mappend_lh__d4 ((interleave_lh__d2 (spaces_lh__d2 (length_lh__d2 _lh_disp_LH_P2_1_0))) _lh_disp_LH_P2_1_0)) (let rec t_1_9 = (fun ys_2_2 -> 
        ys_2_2) in
        (let rec h_1_9 = 'n' in
          (fun ys_2_3 -> 
