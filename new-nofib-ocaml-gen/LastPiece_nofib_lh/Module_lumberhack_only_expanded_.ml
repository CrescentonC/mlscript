...
let rec enumFromTo_lh__d2 a_0 b_0 =
  (if (a_0 <= b_0) then
    ...
    (`LH_N));;
let rec foldr_lh__d1 f_4 i_1 ls_4 =
  (match ls_4 with
    | `LH_C(h_6, t_6) -> 
      ((f_4 h_6) (((foldr_lh__d1 f_4) i_1) t_6))
    | `LH_N -> 
      i_1);;
let rec foldr_lh__d2 f_2 i_0 ls_2 =
  (match ls_2 with
    | `LH_C(h_4, t_4) -> 
      ((f_2 h_4) (((foldr_lh__d2 f_2) i_0) t_4))
    | `LH_N -> 
      i_0);;
let rec mappend_lh__d2 xs_0 ys_0 =
  (match xs_0 with
    | `LH_C(h_2, t_2) -> 
      (`LH_C(h_2, ((mappend_lh__d2 t_2) ys_0)))
    | `LH_N -> 
      ys_0);;
...
let rec map_lh__d1 f_3 ls_3 =
  (match ls_3 with
    | `LH_C(h_5, t_5) -> 
      (`LH_C((f_3 h_5), ((map_lh__d1 f_3) t_5)))
    | `LH_N -> 
      (`LH_N));;
  ...
  (match _lh_extend_maybe_arg2_1 with
    | `LH_P2(_lh_extend_maybe_LH_P2_0_1, _lh_extend_maybe_LH_P2_1_1) -> 
      (if (((_lh_extend_maybe_LH_P2_0_1 > maxRow_lh__d2) || (_lh_extend_maybe_LH_P2_1_1 < 1)) || (_lh_extend_maybe_LH_P2_1_1 > maxCol_lh__d3)) then
        ...
        (let rec _lh_matchIdent_3_9 = ((check_lh__d3 _lh_extend_maybe_arg1_1) (`LH_P2(_lh_extend_maybe_LH_P2_0_1, _lh_extend_maybe_LH_P2_1_1))) in
    ...
    (match _lh_go_arg2_0 with
      ...
      | `LH_C(_lh_go_LH_C_0_0, _lh_go_LH_C_1_0) -> 
        (`LH_C((`LH_P2(_lh_go_LH_C_0_0, (_lh_go_arg1_0 _lh_go_LH_C_1_0))), ((go_0 (fun _lh_funcomp_x_0 -> 
          ((fun p_2_8 -> 
            (`LH_C(_lh_go_LH_C_0_0, p_2_8))) (_lh_go_arg1_0 _lh_funcomp_x_0)))) _lh_go_LH_C_1_0))))) in
    ((go_0 (fun x_1_6 -> 
...
let rec mapMaybe_lh__d1 _lh_mapMaybe_arg1_0 _lh_mapMaybe_arg2_0 =
  (match _lh_mapMaybe_arg2_0 with
    ...
    | `LH_C(_lh_mapMaybe_LH_C_0_0, _lh_mapMaybe_LH_C_1_0) -> 
      (let rec _lh_matchIdent_3_7 = (_lh_mapMaybe_arg1_0 _lh_mapMaybe_LH_C_0_0) in
      ...
      (match _lh_search_arg4_0 with
        ...
        | _ -> 
          (if (_lh_search_LH_P2_1_0 = (maxCol_lh__d2 + 1)) then
            ((((search_lh__d1 (`LH_P2((_lh_search_LH_P2_0_0 + 1), 1))) (flip_lh__d2 _lh_search_arg2_0)) _lh_search_arg3_0) _lh_search_arg4_0)
          else
            (if (isJust_lh__d1 ((check_lh__d2 _lh_search_arg3_0) (`LH_P2(_lh_search_LH_P2_0_0, _lh_search_LH_P2_1_0)))) then
              ((((search_lh__d1 (next_lh__d1 (`LH_P2(_lh_search_LH_P2_0_0, _lh_search_LH_P2_1_0)))) (flip_lh__d1 _lh_search_arg2_0)) _lh_search_arg3_0) _lh_search_arg4_0)
            else
...
let rec mapLookup_lh__d1 _lh_mapLookup_arg1_3 _lh_mapLookup_arg2_3 =
  (match _lh_mapLookup_arg2_3 with
    ...
    | `Bin(_lh_mapLookup_Bin_0_3, _lh_mapLookup_Bin_1_3, _lh_mapLookup_Bin_2_3, _lh_mapLookup_Bin_3_3, _lh_mapLookup_Bin_4_3) -> 
      (let rec _lh_matchIdent_4_0 = ((compareIntInt_lh__d1 _lh_mapLookup_arg1_3) _lh_mapLookup_Bin_1_3) in
...
let rec testLastPiece_nofib_lh__d1 _lh_testLastPiece_nofib_arg1_0 =
  ...
  and vcat_0 = (fun _lh_vcat_arg1_0 -> 
    ((fun _lh_funcomp_x_1 -> 
      ((fun _lh_funcomp_x_2 -> 
        (snd_lh__d1 (reduceVert_0 _lh_funcomp_x_2))) (((foldr_lh__d2 (fun p_2_9 q_0 -> 
  ...
  and hcat_0 = (fun _lh_hcat_arg1_0 -> 
    ((fun _lh_funcomp_x_3 -> 
      ((fun _lh_funcomp_x_4 -> 
        (snd_lh__d2 (reduceHoriz_0 _lh_funcomp_x_4))) (((foldr_lh__d1 (fun p_3_0 q_1 -> 
        ...
        (let rec lay_1 = (let rec lay2_0 = (fun k_1_6 param_0 -> 
          ...
          (let rec lay1_0 = (fun k_1_7 s_0 p_3_2 -> 
            (let rec r_1_6 = (k_1_7 + (annotSize_0 s_0)) in
              ((_lh_displayDoc_arg4_0 (`NoAnnot((`Str((indent_lh__d1 k_1_7))), k_1_7))) ((_lh_displayDoc_arg4_0 s_0) ((lay2_0 r_1_6) p_3_2))))) in
            (fun k_1_8 docc_0 -> 
