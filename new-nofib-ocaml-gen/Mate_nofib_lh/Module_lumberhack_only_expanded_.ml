...
let rec mappend_lh__d3 xs_2_9 ys_2_9 =
  (match xs_2_9 with
    | `LH_C(h_5_8, t_5_8) -> 
      (`LH_C(h_5_8, ((mappend_lh__d3 t_5_8) ys_2_9)))
    | `LH_N -> 
      ys_2_9);;
let rec mappend_lh__d1 xs_3_1 ys_3_1 =
  (match xs_3_1 with
    | `LH_C(h_6_0, t_6_0) -> 
      (`LH_C(h_6_0, ((mappend_lh__d1 t_6_0) ys_3_1)))
    | `LH_N -> 
      ys_3_1);;
...
let rec foldr_lh__d5 f_6 i_4 ls_1_5 =
  (match ls_1_5 with
    | `LH_C(h_3_6, t_3_6) -> 
      ((f_6 h_3_6) (((foldr_lh__d5 f_6) i_4) t_3_6))
    | `LH_N -> 
      i_4);;
...
let rec emptyAtAll_lh__d4 _lh_emptyAtAll_arg1_0 _lh_emptyAtAll_arg2_0 =
  (match _lh_emptyAtAll_arg1_0 with
    | `Board(_lh_emptyAtAll_Board_0_0, _lh_emptyAtAll_Board_1_0) -> 
      (let rec emptyAtAllAnd_0 = (fun b_5 ls_1_7 -> 
        (let rec _lh_matchIdent_3_3 = ls_1_7 in
            ...
            | `LH_C(_lh_emptyAtAll_LH_C_0_0, _lh_emptyAtAll_LH_C_1_0) -> 
              (match _lh_emptyAtAll_LH_C_0_0 with
                | `LH_P2(_lh_emptyAtAll_LH_P2_0_0, _lh_emptyAtAll_LH_P2_1_0) -> 
                  ((not (_lh_emptyAtAll_arg2_0 _lh_emptyAtAll_LH_P2_1_0)) && ((emptyAtAllAnd_0 b_5) _lh_emptyAtAll_LH_C_1_0)))))) in
              ...
              (let rec p'_1 = (((maybe_lh__d3 p_1) (fun x_4 -> 
                ...
                (let rec bd2_1 = (((maybe_lh__d2 (((putPieceAt_lh__d3 _lh_tryMove_Move_0_1) p'_1) bd1_1)) (fun _dummy_1 -> 
                  ...
                  (if (not ((kingincheck_lh__d2 _lh_tryMove_arg1_1) bd2_1)) then
                    ...
                    (`Nothing))))))));;
let rec foldr_lh__d4 f_7 i_5 ls_1_6 =
  (match ls_1_6 with
    | `LH_C(h_3_7, t_3_7) -> 
      ((f_7 h_3_7) (((foldr_lh__d4 f_7) i_5) t_3_7))
    | `LH_N -> 
      i_5);;
  ...
  (match _lh_pieceAt_arg1_0 with
    | `Board(_lh_pieceAt_Board_0_0, _lh_pieceAt_Board_1_0) -> 
      (let rec pieceAtWith_0 = (fun c_1 n_4 ls_3_0 -> 
        (let rec _lh_matchIdent_5_8 = ls_3_0 in
  ...
  (match _lh_sift_arg4_0 with
    ...
    | `LH_C(_lh_sift_LH_C_0_0, _lh_sift_LH_C_1_0) -> 
      (if (onboard_lh__d1 _lh_sift_LH_C_0_0) then
        (let rec _lh_matchIdent_1 = ((pieceAt_lh__d1 _lh_sift_arg2_0) _lh_sift_LH_C_0_0) in
  ...
  (let rec ml_0 = (fun sq_0 ms_0 -> 
    (let rec sq'_0 = (_lh_moveLine_arg4_0 sq_0) in
      (if (onboard_lh__d1 sq'_0) then
        (let rec _lh_matchIdent_2 = ((pieceAt_lh__d1 _lh_moveLine_arg1_0) sq'_0) in
    ...
    (let rec _lh_matchIdent_1_9 = xy_5 in
      (match _lh_matchIdent_1_9 with
        | `LH_P2(_lh_bishopmoves_LH_P2_0_0, _lh_bishopmoves_LH_P2_1_0) -> 
          (`LH_P2((_lh_bishopmoves_LH_P2_0_0 - 1), (_lh_bishopmoves_LH_P2_1_0 + 1))))))) (((((moveLine_lh__d1 _lh_bishopmoves_arg3_0) _lh_bishopmoves_arg1_0) _lh_bishopmoves_arg2_0) (fun xy_6 -> 
    (let rec _lh_matchIdent_2_0 = xy_6 in
      (match _lh_matchIdent_2_0 with
        | `LH_P2(_lh_bishopmoves_LH_P2_0_1, _lh_bishopmoves_LH_P2_1_1) -> 
          (`LH_P2((_lh_bishopmoves_LH_P2_0_1 + 1), (_lh_bishopmoves_LH_P2_1_1 + 1))))))) (((((moveLine_lh__d1 _lh_bishopmoves_arg3_0) _lh_bishopmoves_arg1_0) _lh_bishopmoves_arg2_0) (fun xy_7 -> 
    (let rec _lh_matchIdent_2_1 = xy_7 in
      (match _lh_matchIdent_2_1 with
        | `LH_P2(_lh_bishopmoves_LH_P2_0_2, _lh_bishopmoves_LH_P2_1_2) -> 
          (`LH_P2((_lh_bishopmoves_LH_P2_0_2 - 1), (_lh_bishopmoves_LH_P2_1_2 - 1))))))) (((((moveLine_lh__d1 _lh_bishopmoves_arg3_0) _lh_bishopmoves_arg1_0) _lh_bishopmoves_arg2_0) (fun xy_8 -> 
    (let rec _lh_matchIdent_2_2 = xy_8 in
      (match _lh_matchIdent_2_2 with
        | `LH_P2(_lh_bishopmoves_LH_P2_0_3, _lh_bishopmoves_LH_P2_1_3) -> 
          (`LH_P2((_lh_bishopmoves_LH_P2_0_3 + 1), (_lh_bishopmoves_LH_P2_1_3 - 1))))))) (fun x_2 -> 
    x_2))))) (`LH_N));;
let rec mappend_lh__d3_d0 xs_0 ys_0 =
  (match xs_0 with
    | `LH_C(h_1, t_1) -> 
      (`LH_C(h_1, ((mappend_lh__d3_d0 t_1) ys_0)))
    | `LH_N -> 
      ys_0);;
let rec concat_lh__d3 lss_0 =
  (match lss_0 with
    | `LH_C(h_2_2, t_2_2) -> 
      ((mappend_lh__d3_d0 h_2_2) (concat_lh__d3 t_2_2))
    | `LH_N -> 
      (`LH_N));;
let rec map_lh__d2 f_1_1 ls_2_8 =
  (match ls_2_8 with
    | `LH_C(h_4_8, t_4_8) -> 
      (`LH_C((f_1_1 h_4_8), ((map_lh__d2 f_1_1) t_4_8)))
    | `LH_N -> 
      (`LH_N));;
...
let rec rookmoves_lh__d1 _lh_rookmoves_arg1_0 _lh_rookmoves_arg2_0 _lh_rookmoves_arg3_0 =
  ((((((moveLine_lh__d1 _lh_rookmoves_arg3_0) _lh_rookmoves_arg1_0) _lh_rookmoves_arg2_0) (fun xy_1 -> 
    (let rec _lh_matchIdent_1_5 = xy_1 in
      (match _lh_matchIdent_1_5 with
        | `LH_P2(_lh_rookmoves_LH_P2_0_0, _lh_rookmoves_LH_P2_1_0) -> 
          (`LH_P2((_lh_rookmoves_LH_P2_0_0 - 1), _lh_rookmoves_LH_P2_1_0)))))) (((((moveLine_lh__d1 _lh_rookmoves_arg3_0) _lh_rookmoves_arg1_0) _lh_rookmoves_arg2_0) (fun xy_2 -> 
    (let rec _lh_matchIdent_1_6 = xy_2 in
      (match _lh_matchIdent_1_6 with
        | `LH_P2(_lh_rookmoves_LH_P2_0_1, _lh_rookmoves_LH_P2_1_1) -> 
          (`LH_P2((_lh_rookmoves_LH_P2_0_1 + 1), _lh_rookmoves_LH_P2_1_1)))))) (((((moveLine_lh__d1 _lh_rookmoves_arg3_0) _lh_rookmoves_arg1_0) _lh_rookmoves_arg2_0) (fun xy_3 -> 
    (let rec _lh_matchIdent_1_7 = xy_3 in
      (match _lh_matchIdent_1_7 with
        | `LH_P2(_lh_rookmoves_LH_P2_0_2, _lh_rookmoves_LH_P2_1_2) -> 
          (`LH_P2(_lh_rookmoves_LH_P2_0_2, (_lh_rookmoves_LH_P2_1_2 - 1))))))) (((((moveLine_lh__d1 _lh_rookmoves_arg3_0) _lh_rookmoves_arg1_0) _lh_rookmoves_arg2_0) (fun xy_4 -> 
    (let rec _lh_matchIdent_1_8 = xy_4 in
      (match _lh_matchIdent_1_8 with
        | `LH_P2(_lh_rookmoves_LH_P2_0_3, _lh_rookmoves_LH_P2_1_3) -> 
          (`LH_P2(_lh_rookmoves_LH_P2_0_3, (_lh_rookmoves_LH_P2_1_3 + 1))))))) (fun x_1 -> 
    x_1))))) (`LH_N));;
...
let rec rawmoves_lh__d1 _lh_rawmoves_arg1_1 _lh_rawmoves_arg2_1 _lh_rawmoves_arg3_1 =
  (match _lh_rawmoves_arg2_1 with
    | `LH_P2(_lh_rawmoves_LH_P2_0_1, _lh_rawmoves_LH_P2_1_1) -> 
      (let rec m_1 = (let rec _lh_matchIdent_3_2 = _lh_rawmoves_LH_P2_0_1 in
  ...
  (((foldr_lh__d5 (fun ksq_1 ms_2 -> 
    (((foldr_lh__d4 (fun rm_1 ms'_1 -> 
      ((((maybe_lh__d1 (fun x_8 -> 
        x_8)) (fun h_4_4 t_4_4 -> 
        (`LH_C(h_4_4, t_4_4)))) ((((tryMove_lh__d1 _lh_moveDetailsFor_arg1_1) ksq_1) rm_1) _lh_moveDetailsFor_arg2_1)) ms'_1))) ms_2) (((rawmoves_lh__d1 _lh_moveDetailsFor_arg1_1) ksq_1) _lh_moveDetailsFor_arg2_1)))) (`LH_N)) ((forcesColoured_lh__d2 _lh_moveDetailsFor_arg1_1) _lh_moveDetailsFor_arg2_1));;
let rec foldr_lh__d2 f_1_0 i_7 ls_2_6 =
  (match ls_2_6 with
    | `LH_C(h_4_5, t_4_5) -> 
      ((f_1_0 h_4_5) (((foldr_lh__d2 f_1_0) i_7) t_4_5))
    | `LH_N -> 
      i_7);;
...
let rec null_lh__d1 _lh_null_arg1_2 =
  (match _lh_null_arg1_2 with
    ...
    | `LH_C(_lh_null_LH_C_0_2, _lh_null_LH_C_1_2) -> 
      false);;
let rec foldr_lh__d8 f_1 i_1 ls_8 =
  (match ls_8 with
    | `LH_C(h_1_8, t_1_8) -> 
      ((f_1 h_1_8) (((foldr_lh__d8 f_1) i_1) t_1_8))
    | `LH_N -> 
      i_1);;
let rec rawmoves_lh__d2 _lh_rawmoves_arg1_0 _lh_rawmoves_arg2_0 _lh_rawmoves_arg3_0 =
  (match _lh_rawmoves_arg2_0 with
    | `LH_P2(_lh_rawmoves_LH_P2_0_0, _lh_rawmoves_LH_P2_1_0) -> 
      (let rec m_0 = (let rec _lh_matchIdent_4 = _lh_rawmoves_LH_P2_0_0 in
...
let rec foldr_lh__d9 f_0 i_0 ls_7 =
  (match ls_7 with
    | `LH_C(h_1_7, t_1_7) -> 
      ((f_0 h_1_7) (((foldr_lh__d9 f_0) i_0) t_1_7))
    | `LH_N -> 
      i_0);;
  ...
  (((foldr_lh__d8 (fun ksq_0 ms_1 -> 
    (((foldr_lh__d9 (fun rm_0 ms'_0 -> 
      ((((maybe_lh__d4 (fun x_3 -> 
        x_3)) (fun h_3_5 t_3_5 -> 
        (`LH_C(h_3_5, t_3_5)))) ((((tryMove_lh__d2 _lh_moveDetailsFor_arg1_0) ksq_0) rm_0) _lh_moveDetailsFor_arg2_0)) ms'_0))) ms_1) (((rawmoves_lh__d2 _lh_moveDetailsFor_arg1_0) ksq_0) _lh_moveDetailsFor_arg2_0)))) (`LH_N)) ((forcesColoured_lh__d3 _lh_moveDetailsFor_arg1_0) _lh_moveDetailsFor_arg2_0));;
let rec foldr_lh__d6 f_5 i_3 ls_1_4 =
  (match ls_1_4 with
    | `LH_C(h_3_4, t_3_4) -> 
      ((f_5 h_3_4) (((foldr_lh__d6 f_5) i_3) t_3_4))
    | `LH_N -> 
      i_3);;
...
let rec emptyAtAll_lh__d1 _lh_emptyAtAll_arg1_3 _lh_emptyAtAll_arg2_3 =
  (match _lh_emptyAtAll_arg1_3 with
    | `Board(_lh_emptyAtAll_Board_0_3, _lh_emptyAtAll_Board_1_3) -> 
      (let rec emptyAtAllAnd_3 = (fun b_8 ls_2_0 -> 
        (let rec _lh_matchIdent_3_6 = ls_2_0 in
            ...
            | `LH_C(_lh_emptyAtAll_LH_C_0_3, _lh_emptyAtAll_LH_C_1_3) -> 
              (match _lh_emptyAtAll_LH_C_0_3 with
                | `LH_P2(_lh_emptyAtAll_LH_P2_0_3, _lh_emptyAtAll_LH_P2_1_3) -> 
                  ((not (_lh_emptyAtAll_arg2_3 _lh_emptyAtAll_LH_P2_1_3)) && ((emptyAtAllAnd_3 b_8) _lh_emptyAtAll_LH_C_1_3)))))) in
...
let rec emptyAtAll_lh__d3 _lh_emptyAtAll_arg1_1 _lh_emptyAtAll_arg2_1 =
  (match _lh_emptyAtAll_arg1_1 with
    | `Board(_lh_emptyAtAll_Board_0_1, _lh_emptyAtAll_Board_1_1) -> 
      (let rec emptyAtAllAnd_1 = (fun b_6 ls_1_8 -> 
        (let rec _lh_matchIdent_3_4 = ls_1_8 in
            ...
            | `LH_C(_lh_emptyAtAll_LH_C_0_1, _lh_emptyAtAll_LH_C_1_1) -> 
              (match _lh_emptyAtAll_LH_C_0_1 with
                | `LH_P2(_lh_emptyAtAll_LH_P2_0_1, _lh_emptyAtAll_LH_P2_1_1) -> 
                  ((not (_lh_emptyAtAll_arg2_1 _lh_emptyAtAll_LH_P2_1_1)) && ((emptyAtAllAnd_1 b_6) _lh_emptyAtAll_LH_C_1_1)))))) in
...
let rec emptyAtAll_lh__d2 _lh_emptyAtAll_arg1_2 _lh_emptyAtAll_arg2_2 =
  (match _lh_emptyAtAll_arg1_2 with
    | `Board(_lh_emptyAtAll_Board_0_2, _lh_emptyAtAll_Board_1_2) -> 
      (let rec emptyAtAllAnd_2 = (fun b_7 ls_1_9 -> 
        (let rec _lh_matchIdent_3_5 = ls_1_9 in
            ...
            | `LH_C(_lh_emptyAtAll_LH_C_0_2, _lh_emptyAtAll_LH_C_1_2) -> 
              (match _lh_emptyAtAll_LH_C_0_2 with
                | `LH_P2(_lh_emptyAtAll_LH_P2_0_2, _lh_emptyAtAll_LH_P2_1_2) -> 
                  ((not (_lh_emptyAtAll_arg2_2 _lh_emptyAtAll_LH_P2_1_2)) && ((emptyAtAllAnd_2 b_7) _lh_emptyAtAll_LH_C_1_2)))))) in
...
let rec kingincheck_lh__d1 _lh_kingincheck_arg1_1 _lh_kingincheck_arg2_1 =
  (let rec givesCheck_1 = (fun kxy_1 -> 
    (let rec _lh_matchIdent_4_3 = kxy_1 in
                          ...
                          (match _lh_matchIdent_4_5 with
                            ...
                            | `Rook -> 
                              (((_lh_kingincheck_LH_P2_0_8 = _lh_kingincheck_LH_P2_0_9) && ((emptyAtAll_lh__d1 _lh_kingincheck_arg2_1) (fun xeye_4 -> 
                                (let rec _lh_matchIdent_4_6 = xeye_4 in
                                ...
                                (let rec _lh_matchIdent_4_7 = xeye_5 in
                            ...
                            | `Bishop -> 
                              ((((_lh_kingincheck_LH_P2_0_8 + _lh_kingincheck_LH_P2_1_8) = (_lh_kingincheck_LH_P2_0_9 + _lh_kingincheck_LH_P2_1_9)) && ((emptyAtAll_lh__d2 _lh_kingincheck_arg2_1) (fun xeye_6 -> 
                                (let rec _lh_matchIdent_4_8 = xeye_6 in
                                ...
                                (let rec _lh_matchIdent_4_9 = xeye_7 in
                            ...
                            | `Pawn -> 
                              (((abs_lh__d3 (_lh_kingincheck_LH_P2_0_8 - _lh_kingincheck_LH_P2_0_9)) = 1) && (let rec _lh_matchIdent_5_0 = _lh_kingincheck_arg1_1 in
...
let rec replies_lh__d1 _lh_replies_arg1_0 _lh_replies_arg2_0 _lh_replies_arg3_0 =
  (let rec mds_0 = ((moveDetailsFor_lh__d2 _lh_replies_arg2_0) _lh_replies_arg1_0) in
    (let rec solnAnd_0 = (fun mifb_0 rest_0 -> 
      (let rec _lh_matchIdent_4_0 = mifb_0 in
        (match _lh_matchIdent_4_0 with
          | `LH_P2(_lh_replies_LH_P2_0_0, _lh_replies_LH_P2_1_0) -> 
            (let rec sm_0 = (((solution_lh__d1 _lh_replies_LH_P2_1_0) (opponent_lh__d4 _lh_replies_arg2_0)) (_lh_replies_arg3_0 - 1)) in
              (let rec _lh_matchIdent_4_1 = sm_0 in
                (match _lh_matchIdent_4_1 with
                  | `Nothing -> 
                    (`Nothing)
                  | `Just(_lh_replies_Just_0_0) -> 
                    (let rec _lh_matchIdent_4_2 = rest_0 in
...
solution_lh__d1 _lh_solution_arg1_0 _lh_solution_arg2_0 _lh_solution_arg3_0 =
  (let rec solnOr_0 = (fun mifb_1 other_0 -> 
    (let rec _lh_matchIdent_5_6 = mifb_1 in
      (match _lh_matchIdent_5_6 with
        | `LH_P2(_lh_solution_LH_P2_0_0, _lh_solution_LH_P2_1_0) -> 
          (let rec rsm_0 = (((replies_lh__d1 _lh_solution_LH_P2_1_0) (opponent_lh__d1 _lh_solution_arg2_0)) (_lh_solution_arg3_0 - 1)) in
            (let rec _lh_matchIdent_5_7 = rsm_0 in
              (match _lh_matchIdent_5_7 with
                ...
                | `Just(_lh_solution_Just_0_0) -> 
                  (match _lh_solution_Just_0_0 with
                    | `LH_N -> 
                      (if ((kingincheck_lh__d1 (opponent_lh__d2 _lh_solution_arg2_0)) _lh_solution_LH_P2_1_0) then
...
let rec mappend_lh__d1_d6 xs_1_5 ys_1_5 =
  (match xs_1_5 with
    | `LH_C(h_2_8, t_2_8) -> 
      (`LH_C(h_2_8, ((mappend_lh__d1_d6 t_2_8) ys_1_5)))
    | `LH_N -> 
      ys_1_5);;
let rec mappend_lh__d1_d8 xs_1_3 ys_1_3 =
  (match xs_1_3 with
    | `LH_C(h_2_6, t_2_6) -> 
      (`LH_C(h_2_6, ((mappend_lh__d1_d8 t_2_6) ys_1_3)))
    | `LH_N -> 
      ys_1_3);;
...
let rec length_lh__d2 ls_6 =
  (match ls_6 with
    | `LH_C(h_1_6, t_1_6) -> 
      (1 + (length_lh__d2 t_1_6))
    | `LH_N -> 
      0);;
let rec length_lh__d3 ls_5 =
  (match ls_5 with
    | `LH_C(h_1_5, t_1_5) -> 
      (1 + (length_lh__d3 t_1_5))
    | `LH_N -> 
      0);;
let rec sort_lh__d1 _lh_sort_arg1_2 =
  (((qsort_lh__d1 (fun a_5 b_4 -> 
    (let rec _lh_matchIdent_3_0 = a_5 in
      (match _lh_matchIdent_3_0 with
        | `LH_P2(_lh_sort_LH_P2_0_4, _lh_sort_LH_P2_1_4) -> 
          (let rec _lh_matchIdent_3_1 = b_4 in
            (match _lh_matchIdent_3_1 with
              | `LH_P2(_lh_sort_LH_P2_0_5, _lh_sort_LH_P2_1_5) -> 
                ((length_lh__d3 _lh_sort_LH_P2_0_4) <= (length_lh__d2 _lh_sort_LH_P2_0_5)))))))) _lh_sort_arg1_2) (`LH_N));;
let rec mappend_lh__d1_d9 xs_1_2 ys_1_2 =
  (match xs_1_2 with
    | `LH_C(h_2_4, t_2_4) -> 
      (`LH_C(h_2_4, ((mappend_lh__d1_d9 t_2_4) ys_1_2)))
    | `LH_N -> 
      ys_1_2);;
let rec length_lh__d4 ls_4 =
  (match ls_4 with
    | `LH_C(h_1_4, t_1_4) -> 
      (1 + (length_lh__d4 t_1_4))
    | `LH_N -> 
      0);;
let rec length_lh__d5 ls_3 =
  (match ls_3 with
    | `LH_C(h_1_3, t_1_3) -> 
...
let rec sort_lh__d2 _lh_sort_arg1_1 =
  (((qsort_lh__d2 (fun a_4 b_3 -> 
    (let rec _lh_matchIdent_2_8 = a_4 in
      (match _lh_matchIdent_2_8 with
        | `LH_P2(_lh_sort_LH_P2_0_2, _lh_sort_LH_P2_1_2) -> 
          (let rec _lh_matchIdent_2_9 = b_3 in
...
let rec mappend_lh__d1_d3 xs_1_8 ys_1_8 =
  (match xs_1_8 with
    | `LH_C(h_3_1, t_3_1) -> 
      (`LH_C(h_3_1, ((mappend_lh__d1_d3 t_3_1) ys_1_8)))
    | `LH_N -> 
      ys_1_8);;
let rec kindToChar_lh__d2 _lh_kindToChar_arg1_0 =
  (let rec _lh_matchIdent_5_1 = _lh_kindToChar_arg1_0 in
...
let rec null_lh__d3 _lh_null_arg1_0 =
  (match _lh_null_arg1_0 with
    ...
    | `LH_C(_lh_null_LH_C_0_0, _lh_null_LH_C_1_0) -> 
      false);;
let rec mappend_lh__d2_d6 xs_4 ys_4 =
  (match xs_4 with
    | `LH_C(h_6, t_6) -> 
      (`LH_C(h_6, ((mappend_lh__d2_d6 t_6) ys_4)))
    | `LH_N -> 
      ys_4);;
let rec mappend_lh__d2_d7 xs_3 ys_3 =
  (match xs_3 with
    | `LH_C(h_4, t_4) -> 
      (`LH_C(h_4, ((mappend_lh__d2_d7 t_4) ys_3)))
    | `LH_N -> 
      ys_3);;
...
let rec mappend_lh__d2_d8 xs_2 ys_2 =
  (match xs_2 with
    | `LH_C(h_3, t_3) -> 
      (`LH_C(h_3, ((mappend_lh__d2_d8 t_3) ys_2)))
    | `LH_N -> 
      ys_2);;
let rec mappend_lh__d2_d9 xs_1 ys_1 =
  (match xs_1 with
    | `LH_C(h_2, t_2) -> 
      (`LH_C(h_2, ((mappend_lh__d2_d9 t_2) ys_1)))
    | `LH_N -> 
      ys_1);;
let rec mappend_lh__d1_d5 xs_1_6 ys_1_6 =
  (match xs_1_6 with
    | `LH_C(h_2_9, t_2_9) -> 
      (`LH_C(h_2_9, ((mappend_lh__d1_d5 t_2_9) ys_1_6)))
    | `LH_N -> 
      ys_1_6);;
let rec length_lh__d1 ls_1_3 =
  (match ls_1_3 with
    ...
    | `LH_N -> 
      0);;
let rec mappend_lh__d1_d7 xs_1_4 ys_1_4 =
  (match xs_1_4 with
    | `LH_C(h_2_7, t_2_7) -> 
      (`LH_C(h_2_7, ((mappend_lh__d1_d7 t_2_7) ys_1_4)))
    | `LH_N -> 
      ys_1_4);;
let rec mappend_lh__d1_d4 xs_1_7 ys_1_7 =
  (match xs_1_7 with
    | `LH_C(h_3_0, t_3_0) -> 
      (`LH_C(h_3_0, ((mappend_lh__d1_d4 t_3_0) ys_1_7)))
    | `LH_N -> 
      ys_1_7);;
let rec mappend_lh__d1_d1 xs_2_0 ys_2_0 =
  (match xs_2_0 with
    | `LH_C(h_3_3, t_3_3) -> 
      (`LH_C(h_3_3, ((mappend_lh__d1_d1 t_3_3) ys_2_0)))
    | `LH_N -> 
      ys_2_0);;
let rec mappend_lh__d2_d1 xs_9 ys_9 =
  (match xs_9 with
    | `LH_C(h_1_2, t_1_2) -> 
      (`LH_C(h_1_2, ((mappend_lh__d2_d1 t_1_2) ys_9)))
    | `LH_N -> 
      ys_9);;
...
let rec mappend_lh__d2_d3 xs_7 ys_7 =
  (match xs_7 with
    | `LH_C(h_1_0, t_1_0) -> 
      (`LH_C(h_1_0, ((mappend_lh__d2_d3 t_1_0) ys_7)))
    | `LH_N -> 
      ys_7);;
let rec null_lh__d2 _lh_null_arg1_1 =
  (match _lh_null_arg1_1 with
    ...
    | `LH_C(_lh_null_LH_C_0_1, _lh_null_LH_C_1_1) -> 
      false);;
let rec mappend_lh__d2_d5 xs_5 ys_5 =
  (match xs_5 with
    | `LH_C(h_7, t_7) -> 
      (`LH_C(h_7, ((mappend_lh__d2_d5 t_7) ys_5)))
    | `LH_N -> 
      ys_5);;
let rec mappend_lh__d2_d4 xs_6 ys_6 =
  (match xs_6 with
    | `LH_C(h_9, t_9) -> 
      (`LH_C(h_9, ((mappend_lh__d2_d4 t_9) ys_6)))
    | `LH_N -> 
      ys_6);;
let rec length_lh__d6 ls_2 =
  (match ls_2 with
    | `LH_C(h_8, t_8) -> 
      (1 + (length_lh__d6 t_8))
    | `LH_N -> 
      0);;
let rec mappend_lh__d2_d2 xs_8 ys_8 =
  (match xs_8 with
    | `LH_C(h_1_1, t_1_1) -> 
      (`LH_C(h_1_1, ((mappend_lh__d2_d2 t_1_1) ys_8)))
    | `LH_N -> 
      ys_8);;
...
let rec sort_lh__d3 _lh_sort_arg1_0 =
  (((qsort_lh__d3 (fun a_3 b_2 -> 
    (let rec _lh_matchIdent_2_6 = a_3 in
      (match _lh_matchIdent_2_6 with
        | `LH_P2(_lh_sort_LH_P2_0_0, _lh_sort_LH_P2_1_0) -> 
          (let rec _lh_matchIdent_2_7 = b_2 in
            (match _lh_matchIdent_2_7 with
              | `LH_P2(_lh_sort_LH_P2_0_1, _lh_sort_LH_P2_1_1) -> 
                ((length_lh__d7 _lh_sort_LH_P2_0_0) <= (length_lh__d7 _lh_sort_LH_P2_0_1)))))))) _lh_sort_arg1_0) (`LH_N));;
let rec mappend_lh__d1_d2 xs_1_9 ys_1_9 =
  (match xs_1_9 with
    | `LH_C(h_3_2, t_3_2) -> 
      (`LH_C(h_3_2, ((mappend_lh__d1_d2 t_3_2) ys_1_9)))
    | `LH_N -> 
      ys_1_9);;
    ...
    | `LH_C(_lh_showReplies_LH_C_0_2, _lh_showReplies_LH_C_1_2) -> 
      (match _lh_showReplies_LH_C_0_2 with
        | `LH_P2(_lh_showReplies_LH_P2_0_2, _lh_showReplies_LH_P2_1_2) -> 
          ((mappend_lh__d2_d5 ((mappend_lh__d2_d2 ((mappend_lh__d2_d3 ((mappend_lh__d2_d4 ((mappend_lh__d2_d1 (tab_lh__d1 _lh_showReplies_arg2_2)) (`LH_C('i', (`LH_C('f', (`LH_C(' ', (`LH_N))))))))) (if ((null_lh__d2 _lh_showReplies_LH_C_1_2) && ((length_lh__d6 _lh_showReplies_LH_P2_0_2) > 1)) then
    ...
    | `LH_C(_lh_showReplies_LH_C_0_1, _lh_showReplies_LH_C_1_1) -> 
      (match _lh_showReplies_LH_C_0_1 with
        | `LH_P2(_lh_showReplies_LH_P2_0_1, _lh_showReplies_LH_P2_1_1) -> 
          ((mappend_lh__d3_d0 ((mappend_lh__d2_d8 ((mappend_lh__d2_d9 ((mappend_lh__d2_d6 ((mappend_lh__d2_d7 (tab_lh__d2 _lh_showReplies_arg2_1)) (`LH_C('i', (`LH_C('f', (`LH_C(' ', (`LH_N))))))))) (if ((null_lh__d3 _lh_showReplies_LH_C_1_1) && ((length_lh__d7 _lh_showReplies_LH_P2_0_1) > 1)) then
            (`LH_C('o', (`LH_C('t', (`LH_C('h', (`LH_C('e', (`LH_C('r', (`LH_C('s', (`LH_N)))))))))))))
          else
    ...
    | `LH_C(_lh_showReplies_LH_C_0_0, _lh_showReplies_LH_C_1_0) -> 
      (match _lh_showReplies_LH_C_0_0 with
        | `LH_P2(_lh_showReplies_LH_P2_0_0, _lh_showReplies_LH_P2_1_0) -> 
          ((mappend_lh__d3_d0 ((mappend_lh__d3_d0 ((mappend_lh__d3_d0 ((mappend_lh__d3_d0 ((mappend_lh__d3_d0 (tab_lh__d2 _lh_showReplies_arg2_0)) (`LH_C('i', (`LH_C('f', (`LH_C(' ', (`LH_N))))))))) (if ((null_lh__d3 _lh_showReplies_LH_C_1_0) && ((length_lh__d7 _lh_showReplies_LH_P2_0_0) > 1)) then
            (`LH_C('o', (`LH_C('t', (`LH_C('h', (`LH_C('e', (`LH_C('r', (`LH_C('s', (`LH_N)))))))))))))
          else
            (showMoves_lh__d3 _lh_showReplies_LH_P2_0_0)))) (`LH_C(';', (`LH_C(' ', (`LH_N))))))) ((showSoln_lh__d1 _lh_showReplies_LH_P2_1_0) (_lh_showReplies_arg2_0 + 1)))) ((showReplies_lh__d3 _lh_showReplies_LH_C_1_0) _lh_showReplies_arg2_0))))
and
showSoln_lh__d1 _lh_showSoln_arg1_0 _lh_showSoln_arg2_0 =
  (match _lh_showSoln_arg1_0 with
    | `Soln(_lh_showSoln_Soln_0_0, _lh_showSoln_Soln_1_0) -> 
      ((mappend_lh__d1_d4 ((mappend_lh__d1_d8 ((mappend_lh__d1_d3 (string_of_int _lh_showSoln_arg2_0)) (`LH_C('.', (`LH_C(' ', (`LH_N))))))) (showMoveInFull_lh__d1 _lh_showSoln_Soln_0_0))) (let rec _lh_matchIdent_3_9 = _lh_showSoln_Soln_1_0 in
            ...
            (match _lh_showSoln_LH_C_0_0 with
              | `LH_P2(_lh_showSoln_LH_P2_0_0, _lh_showSoln_LH_P2_1_0) -> 
                (match _lh_showSoln_LH_C_1_0 with
                  | `LH_N -> 
                    ((mappend_lh__d1_d7 ((mappend_lh__d1_d1 ((mappend_lh__d1_d9 (`LH_C(',', (`LH_C(' ', (`LH_N)))))) (if ((length_lh__d1 _lh_showSoln_LH_P2_0_0) > 1) then
                      (`LH_C('.', (`LH_C('.', (`LH_C('.', (`LH_N)))))))
                    else
                      (showMoves_lh__d1 _lh_showSoln_LH_P2_0_0)))) (`LH_C(';', (`LH_C(' ', (`LH_N))))))) ((showSoln_lh__d1 _lh_showSoln_LH_P2_1_0) (_lh_showSoln_arg2_0 + 1)))
                  | _ -> 
                    ((mappend_lh__d1_d5 (`LH_C(',', (`LH_C('|', (`LH_N)))))) ((showReplies_lh__d3 (sort_lh__d1 _lh_showSoln_Soln_1_0)) _lh_showSoln_arg2_0)))
              | _ -> 
                ((mappend_lh__d1_d6 (`LH_C(',', (`LH_C('|', (`LH_N)))))) ((showReplies_lh__d1 (sort_lh__d3 _lh_showSoln_Soln_1_0)) _lh_showSoln_arg2_0)))
          | _ -> 
            ((mappend_lh__d1_d2 (`LH_C(',', (`LH_C('|', (`LH_N)))))) ((showReplies_lh__d2 (sort_lh__d2 _lh_showSoln_Soln_1_0)) _lh_showSoln_arg2_0))))));;
let rec foldr_lh__d7 f_4 i_2 ls_1_1 =
  (match ls_1_1 with
    | `LH_C(h_2_3, t_2_3) -> 
      ((f_4 h_2_3) (((foldr_lh__d7 f_4) i_2) t_2_3))
    | `LH_N -> 
      i_2);;
    ...
    | `LH_P2(_lh_insertCompact_LH_P2_0_0, _lh_insertCompact_LH_P2_1_0) -> 
      (let rec insert_0 = (fun _lh_insert_arg1_0 _lh_insert_arg2_0 -> 
        ...
        (let rec cs_0 = (compact_lh__d1 _lh_insertCompact_LH_P2_1_0) in
          (let rec ic_0 = (fun ls_1_2 -> 
            (let rec _lh_matchIdent_2_5 = ls_1_2 in
                ...
                | `LH_C(_lh_insertCompact_LH_C_0_0, _lh_insertCompact_LH_C_1_0) -> 
                  (match _lh_insertCompact_LH_C_0_0 with
                    | `LH_P2(_lh_insertCompact_LH_P2_0_1, _lh_insertCompact_LH_P2_1_1) -> 
                      (let rec a_2 = ((showSoln_lh__d1 cs_0) 1) in
                        (let rec b_1 = ((showSoln_lh__d1 _lh_insertCompact_LH_P2_1_1) 1) in
                          (if (a_2 < b_1) then
...
let rec mappend_lh__d5 xs_2_7 ys_2_7 =
  (match xs_2_7 with
    | `LH_C(h_5_6, t_5_6) -> 
      (`LH_C(h_5_6, ((mappend_lh__d5 t_5_6) ys_2_7)))
    | `LH_N -> 
      ys_2_7);;
let rec mappend_lh__d6 xs_2_6 ys_2_6 =
  (match xs_2_6 with
    | `LH_C(h_5_5, t_5_5) -> 
      (`LH_C(h_5_5, ((mappend_lh__d6 t_5_5) ys_2_6)))
    | `LH_N -> 
      ys_2_6);;
let rec mappend_lh__d4 xs_2_8 ys_2_8 =
  (match xs_2_8 with
    | `LH_C(h_5_7, t_5_7) -> 
      (`LH_C(h_5_7, ((mappend_lh__d4 t_5_7) ys_2_8)))
    | `LH_N -> 
      ys_2_8);;
let rec mappend_lh__d7 xs_2_5 ys_2_5 =
  (match xs_2_5 with
    | `LH_C(h_5_4, t_5_4) -> 
      (`LH_C(h_5_4, ((mappend_lh__d7 t_5_4) ys_2_5)))
    | `LH_N -> 
      ys_2_5);;
let rec mappend_lh__d2 xs_3_0 ys_3_0 =
  (match xs_3_0 with
    | `LH_C(h_5_9, t_5_9) -> 
      (`LH_C(h_5_9, ((mappend_lh__d2 t_5_9) ys_3_0)))
    | `LH_N -> 
      ys_3_0);;
let rec mappend_lh__d8 xs_2_4 ys_2_4 =
  (match xs_2_4 with
    | `LH_C(h_5_1, t_5_1) -> 
      (`LH_C(h_5_1, ((mappend_lh__d8 t_5_1) ys_2_4)))
    | `LH_N -> 
      ys_2_4);;
let rec map_lh__d1 f_1_4 ls_3_2 =
  (match ls_3_2 with
    | `LH_C(h_5_3, t_5_3) -> 
      (`LH_C((f_1_4 h_5_3), ((map_lh__d1 f_1_4) t_5_3)))
    | `LH_N -> 
      (`LH_N));;
let rec enumFromTo_lh__d1 a_9 b_1_1 =
  (if (a_9 <= b_1_1) then
    ...
    (`LH_N));;
let rec reverse_helper_lh__d1 ls_2_7 a_7 =
  (match ls_2_7 with
    | `LH_C(h_4_6, t_4_6) -> 
      ((reverse_helper_lh__d1 t_4_6) (`LH_C(h_4_6, a_7)))
    | `LH_N -> 
      a_7);;
let rec reverse_lh__d1 ls_3_3 =
  ((reverse_helper_lh__d1 ls_3_3) (`LH_N));;
let rec kindToChar_lh__d1 _lh_kindToChar_arg1_1 =
  (let rec _lh_matchIdent_5_2 = _lh_kindToChar_arg1_1 in
...
let rec toLower_lh__d1 _lh_toLower_arg1_0 =
  (let rec _lh_matchIdent_5_3 = _lh_toLower_arg1_0 in
...
let rec mappend_lh__d1_d0 xs_2_1 ys_2_1 =
  (match xs_2_1 with
    | `LH_C(h_3_8, t_3_8) -> 
      (`LH_C(h_3_8, ((mappend_lh__d1_d0 t_3_8) ys_2_1)))
    | `LH_N -> 
      ys_2_1);;
let rec concat_lh__d1 lss_2 =
  (match lss_2 with
    | `LH_C(h_4_9, t_4_9) -> 
      ((mappend_lh__d1_d0 h_4_9) (concat_lh__d1 t_4_9))
    | `LH_N -> 
      (`LH_N));;
let rec mappend_lh__d9 xs_2_3 ys_2_3 =
  (match xs_2_3 with
    | `LH_C(h_4_7, t_4_7) -> 
      (`LH_C(h_4_7, ((mappend_lh__d9 t_4_7) ys_2_3)))
    | `LH_N -> 
      ys_2_3);;
...
let rec enumFromTo_lh__d2 a_8 b_1_0 =
  (if (a_8 <= b_1_0) then
    ...
    (`LH_N));;
let rec foldr_lh__d1 f_1_3 i_8 ls_3_1 =
  (match ls_3_1 with
    | `LH_C(h_5_2, t_5_2) -> 
      ((f_1_3 h_5_2) (((foldr_lh__d1 f_1_3) i_8) t_5_2))
    | `LH_N -> 
      i_8);;
let rec showBoard_lh__d1 _lh_showBoard_arg1_0 =
  (let rec showRank_0 = (fun r_0 -> 
    (let rec consFile_0 = (fun f_1_5 s_0 -> 
      (let rec _lh_matchIdent_6_2 = ((pieceAt_lh__d1 _lh_showBoard_arg1_0) (`LH_P2(f_1_5, r_0))) in
  ...
  (match _lh_break_arg2_1 with
    ...
    | `LH_C(_lh_break_LH_C_0_1, _lh_break_LH_C_1_1) -> 
      (if (_lh_break_arg1_1 _lh_break_LH_C_0_1) then
        ...
        (let rec _lh_matchIdent_5_4 = ((break_lh__d1 _lh_break_arg1_1) _lh_break_LH_C_1_1) in
...
let rec lines_lh__d1 _lh_lines_arg1_0 =
  (let rec _lh_matchIdent_5_9 = ((break_lh__d1 (fun x_9 -> 
    (x_9 = '|'))) _lh_lines_arg1_0) in
    (match _lh_matchIdent_5_9 with
      | `LH_P2(_lh_lines_LH_P2_0_0, _lh_lines_LH_P2_1_0) -> 
        (`LH_C(_lh_lines_LH_P2_0_0, (let rec _lh_matchIdent_6_0 = _lh_lines_LH_P2_1_0 in
...
let rec enumFromTo_lh__d4 a_1 b_0 =
  (if (a_1 <= b_0) then
    ...
    (`LH_N));;
let rec zipWith_lh__d2 f_2 xs_1_1 ys_1_1 =
  (match xs_1_1 with
    | `LH_C(hx_0, tx_0) -> 
      (match ys_1_1 with
        | `LH_C(hy_0, ty_0) -> 
  ...
  (match _lh_parseSquare_arg3_0 with
    ...
    | _ -> 
      (let rec clr_0 = (if (isUpper_lh__d1 _lh_parseSquare_arg3_0) then
        ...
        (`White)) in
        (let rec kin_0 = (let rec _lh_matchIdent_2_4 = (toLower_lh__d1 _lh_parseSquare_arg3_0) in
...
let rec filter_lh__d2 f_3 ls_1_0 =
  (match ls_1_0 with
    | `LH_C(h_2_1, t_2_1) -> 
      (if (f_3 h_2_1) then
        (`LH_C(h_2_1, ((filter_lh__d2 f_3) t_2_1)))
      else
        ((filter_lh__d2 f_3) t_2_1))
    | `LH_N -> 
      (`LH_N));;
let rec parseRank_lh__d1 _lh_parseRank_arg1_0 _lh_parseRank_arg2_0 =
  ((fun _lh_funcomp_x_0 -> 
    ((fun _lh_funcomp_x_1 -> 
      (concat_lh__d3 (((zipWith_lh__d2 (parseSquare_lh__d1 _lh_parseRank_arg1_0)) ((enumFromTo_lh__d4 1) 8)) _lh_funcomp_x_1))) ((filter_lh__d2 (fun x_7 -> 
      (not (x_7 = ' ')))) _lh_funcomp_x_0))) _lh_parseRank_arg2_0);;
let rec mappend_lh__d2_d0 xs_1_0 ys_1_0 =
  (match xs_1_0 with
    | `LH_C(h_2_0, t_2_0) -> 
      (`LH_C(h_2_0, ((mappend_lh__d2_d0 t_2_0) ys_1_0)))
    | `LH_N -> 
      ys_1_0);;
let rec concat_lh__d2 lss_1 =
  (match lss_1 with
    | `LH_C(h_4_2, t_4_2) -> 
      ((mappend_lh__d2_d0 h_4_2) (concat_lh__d2 t_4_2))
    | `LH_N -> 
      (`LH_N));;
let rec foldr_lh__d3 f_8 i_6 ls_2_5 =
  (match ls_2_5 with
    | `LH_C(h_4_3, t_4_3) -> 
      ((f_8 h_4_3) (((foldr_lh__d3 f_8) i_6) t_4_3))
    | `LH_N -> 
      i_6);;
...
let rec zipWith_lh__d1 f_9 xs_2_2 ys_2_2 =
  (match xs_2_2 with
    | `LH_C(hx_1, tx_1) -> 
      (match ys_2_2 with
        | `LH_C(hy_1, ty_1) -> 
...
let rec emptyBoard_lh__d1 =
  (`Board((`LH_N), (`LH_N)));;
let rec reverse_helper_lh__d2 ls_9 a_0 =
  (match ls_9 with
    | `LH_C(h_1_9, t_1_9) -> 
      ((reverse_helper_lh__d2 t_1_9) (`LH_C(h_1_9, a_0)))
    | `LH_N -> 
      a_0);;
let rec reverse_lh__d2 ls_2_4 =
  ((reverse_helper_lh__d2 ls_2_4) (`LH_N));;
let rec parseBoard_lh__d1 _lh_parseBoard_arg1_0 =
  (let rec addPiece_0 = (fun p_sq_0 -> 
    (let rec _lh_matchIdent_5_5 = p_sq_0 in
  ...
  (match _lh_break_arg2_0 with
    ...
    | `LH_C(_lh_break_LH_C_0_0, _lh_break_LH_C_1_0) -> 
      (if (_lh_break_arg1_0 _lh_break_LH_C_0_0) then
        ...
        (let rec _lh_matchIdent_2_3 = ((break_lh__d2 _lh_break_arg1_0) _lh_break_LH_C_1_0) in
...
let rec words_lh__d1 _lh_words_arg1_0 =
  (let rec _lh_matchIdent_3_7 = ((dropWhile_lh__d1 (fun x_5 -> 
    (x_5 = ' '))) _lh_words_arg1_0) in
    (match _lh_matchIdent_3_7 with
      | `LH_N -> 
        (`LH_N)
      | _ -> 
        (let rec _lh_matchIdent_3_8 = ((break_lh__d2 (fun x_6 -> 
          (x_6 = ' '))) _lh_matchIdent_3_7) in
        ...
        | `LH_N -> 
          (let rec ws_0 = (words_lh__d1 _lh_parseGoal_LH_C_0_0) in
            (let rec c_0 = (if ((head_lh__d1 ws_0) = (`LH_C('B', (`LH_C('l', (`LH_C('a', (`LH_C('c', (`LH_C('k', (`LH_N)))))))))))) then
              ...
              (let rec n_3 = 2 in
                (`LH_P2(c_0, n_3)))))));;
let rec take_lh__d1 n_2 ls_2_3 =
  (if (n_2 > 0) then
    (match ls_2_3 with
      | `LH_C(h_4_1, t_4_1) -> 
        (`LH_C(h_4_1, ((take_lh__d1 (n_2 - 1)) t_4_1)))
      | `LH_N -> 
        (`LH_N))
  else
    (`LH_N));;
...
let rec take_lh__d2 n_1 ls_2_2 =
  (if (n_1 > 0) then
    (match ls_2_2 with
      | `LH_C(h_4_0, t_4_0) -> 
        (`LH_C(h_4_0, ((take_lh__d2 (n_1 - 1)) t_4_0)))
      | `LH_N -> 
        (`LH_N))
  else
    (`LH_N));;
...
let rec filter_lh__d1 f_1_2 ls_2_9 =
  (match ls_2_9 with
    | `LH_C(h_5_0, t_5_0) -> 
      (if (f_1_2 h_5_0) then
        (`LH_C(h_5_0, ((filter_lh__d1 f_1_2) t_5_0)))
      else
        ((filter_lh__d1 f_1_2) t_5_0))
    | `LH_N -> 
      (`LH_N));;
let rec parseProblem_lh__d1 _lh_parseProblem_arg1_0 =
  (let rec bdtxt_gltxt_0 = ((splitAt_lh__d1 8) ((filter_lh__d1 (fun _lh_funcomp_x_4 -> 
    ...
    (let rec _lh_matchIdent_6_1 = bdtxt_gltxt_0 in
          ...
          | `LH_P2(_lh_testMate_nofib_LH_P2_0_0, _lh_testMate_nofib_LH_P2_1_0) -> 
            (match _lh_testMate_nofib_LH_P2_1_0 with
              | `LH_P2(_lh_testMate_nofib_LH_P2_0_1, _lh_testMate_nofib_LH_P2_1_1) -> 
                ((mappend_lh__d4 ((mappend_lh__d2 ((mappend_lh__d6 ((mappend_lh__d7 ((mappend_lh__d5 ((mappend_lh__d3 ((mappend_lh__d1 (showBoard_lh__d1 _lh_testMate_nofib_LH_P2_0_0)) (`LH_C('|', (`LH_N))))) (showColour_lh__d1 _lh_testMate_nofib_LH_P2_0_1))) (`LH_C(' ', (`LH_C('t', (`LH_C('o', (`LH_C(' ', (`LH_C('m', (`LH_C('o', (`LH_C('v', (`LH_C('e', (`LH_C(' ', (`LH_C('a', (`LH_C('n', (`LH_C('d', (`LH_C(' ', (`LH_C('m', (`LH_C('a', (`LH_C('t', (`LH_C('e', (`LH_C(' ', (`LH_C('i', (`LH_C('n', (`LH_C(' ', (`LH_N))))))))))))))))))))))))))))))))))))))))))))) (string_of_int _lh_testMate_nofib_LH_P2_1_1))) (`LH_C('|', (`LH_N))))) (`LH_C('|', (`LH_N))))) (((solve_lh__d1 _lh_testMate_nofib_LH_P2_0_0) _lh_testMate_nofib_LH_P2_0_1) _lh_testMate_nofib_LH_P2_1_1)))))));;
