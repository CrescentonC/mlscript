                                ...
                                (let rec _lh_matchIdent_1_9 = xeye_0 in
                                  (match _lh_matchIdent_1_9 with
                                    | `LH_P2(_lh_kingincheck_LH_P2_0_3, _lh_kingincheck_LH_P2_1_3) -> 
                                      (((_lh_kingincheck_LH_P2_0_3 = _lh_kingincheck_LH_P2_0_2) && (((min_lh _lh_kingincheck_LH_P2_1_1) _lh_kingincheck_LH_P2_1_2) < _lh_kingincheck_LH_P2_1_3)) && (_lh_kingincheck_LH_P2_1_3 < ((max_lh _lh_kingincheck_LH_P2_1_1) _lh_kingincheck_LH_P2_1_2)))))))) || ((_lh_kingincheck_LH_P2_1_1 = _lh_kingincheck_LH_P2_1_2) && ((emptyAtAll_lh _lh_kingincheck_arg2_0) (fun xeye_1 -> 
                                ...
                                (let rec _lh_matchIdent_2_1 = xeye_2 in
                                  (match _lh_matchIdent_2_1 with
                                    | `LH_P2(_lh_kingincheck_LH_P2_0_5, _lh_kingincheck_LH_P2_1_5) -> 
                                      ((((_lh_kingincheck_LH_P2_0_5 + _lh_kingincheck_LH_P2_1_5) = (_lh_kingincheck_LH_P2_0_2 + _lh_kingincheck_LH_P2_1_2)) && (((min_lh _lh_kingincheck_LH_P2_0_1) _lh_kingincheck_LH_P2_0_2) < _lh_kingincheck_LH_P2_0_5)) && (_lh_kingincheck_LH_P2_0_5 < ((max_lh _lh_kingincheck_LH_P2_0_1) _lh_kingincheck_LH_P2_0_2)))))))) || (((_lh_kingincheck_LH_P2_0_1 - _lh_kingincheck_LH_P2_1_1) = (_lh_kingincheck_LH_P2_0_2 - _lh_kingincheck_LH_P2_1_2)) && ((emptyAtAll_lh _lh_kingincheck_arg2_0) (fun xeye_3 -> 
              ...
              (match _lh_pieceAt_LH_C_0_0 with
                | `LH_P2(_lh_pieceAt_LH_P2_0_0, _lh_pieceAt_LH_P2_1_0) -> 
                  (if (_lh_pieceAt_LH_P2_1_0 = _lh_pieceAt_arg2_0) then
                    ...
                    (((pieceAtWith_0 c_0) n_2) _lh_pieceAt_LH_C_1_0)))))) in
    ...
    (let rec _lh_matchIdent_4_2 = xy_5 in
      (match _lh_matchIdent_4_2 with
        | `LH_P2(_lh_bishopmoves_LH_P2_0_0, _lh_bishopmoves_LH_P2_1_0) -> 
          (`LH_P2((_lh_bishopmoves_LH_P2_0_0 - 1), (_lh_bishopmoves_LH_P2_1_0 + 1))))))) (((((moveLine_lh _lh_bishopmoves_arg3_0) _lh_bishopmoves_arg1_0) _lh_bishopmoves_arg2_0) (fun xy_6 -> 
    (let rec _lh_matchIdent_4_3 = xy_6 in
      (match _lh_matchIdent_4_3 with
        | `LH_P2(_lh_bishopmoves_LH_P2_0_1, _lh_bishopmoves_LH_P2_1_1) -> 
          (`LH_P2((_lh_bishopmoves_LH_P2_0_1 + 1), (_lh_bishopmoves_LH_P2_1_1 + 1))))))) (((((moveLine_lh _lh_bishopmoves_arg3_0) _lh_bishopmoves_arg1_0) _lh_bishopmoves_arg2_0) (fun xy_7 -> 
    (let rec _lh_matchIdent_4_4 = xy_7 in
      (match _lh_matchIdent_4_4 with
        | `LH_P2(_lh_bishopmoves_LH_P2_0_2, _lh_bishopmoves_LH_P2_1_2) -> 
          (`LH_P2((_lh_bishopmoves_LH_P2_0_2 - 1), (_lh_bishopmoves_LH_P2_1_2 - 1))))))) (((((moveLine_lh _lh_bishopmoves_arg3_0) _lh_bishopmoves_arg1_0) _lh_bishopmoves_arg2_0) (fun xy_8 -> 
    ...
    (let rec _lh_matchIdent_3_7 = xy_1 in
      (match _lh_matchIdent_3_7 with
        | `LH_P2(_lh_rookmoves_LH_P2_0_0, _lh_rookmoves_LH_P2_1_0) -> 
          (`LH_P2((_lh_rookmoves_LH_P2_0_0 - 1), _lh_rookmoves_LH_P2_1_0)))))) (((((moveLine_lh _lh_rookmoves_arg3_0) _lh_rookmoves_arg1_0) _lh_rookmoves_arg2_0) (fun xy_2 -> 
    (let rec _lh_matchIdent_3_8 = xy_2 in
      (match _lh_matchIdent_3_8 with
        | `LH_P2(_lh_rookmoves_LH_P2_0_1, _lh_rookmoves_LH_P2_1_1) -> 
          (`LH_P2((_lh_rookmoves_LH_P2_0_1 + 1), _lh_rookmoves_LH_P2_1_1)))))) (((((moveLine_lh _lh_rookmoves_arg3_0) _lh_rookmoves_arg1_0) _lh_rookmoves_arg2_0) (fun xy_3 -> 
    (let rec _lh_matchIdent_3_9 = xy_3 in
      (match _lh_matchIdent_3_9 with
        | `LH_P2(_lh_rookmoves_LH_P2_0_2, _lh_rookmoves_LH_P2_1_2) -> 
          (`LH_P2(_lh_rookmoves_LH_P2_0_2, (_lh_rookmoves_LH_P2_1_2 - 1))))))) (((((moveLine_lh _lh_rookmoves_arg3_0) _lh_rookmoves_arg1_0) _lh_rookmoves_arg2_0) (fun xy_4 -> 
    (let rec _lh_matchIdent_4_0 = xy_4 in
      (match _lh_matchIdent_4_0 with
        | `LH_P2(_lh_rookmoves_LH_P2_0_3, _lh_rookmoves_LH_P2_1_3) -> 
          (`LH_P2(_lh_rookmoves_LH_P2_0_3, (_lh_rookmoves_LH_P2_1_3 + 1))))))) (fun x_6 -> 
    x_6))))) (`LH_N));;
          ...
          (let rec _lh_matchIdent_3_2 = b_3 in
            (match _lh_matchIdent_3_2 with
              | `LH_P2(_lh_sort_LH_P2_0_1, _lh_sort_LH_P2_1_1) -> 
                ((length_lh _lh_sort_LH_P2_0_0) <= (length_lh _lh_sort_LH_P2_0_1)))))))) _lh_sort_arg1_0) (`LH_N));;
      ...
      (let rec _lh_matchIdent_3_6 = ((pieceAt_lh _lh_showBoard_arg1_0) (`LH_P2(f_4, r_0))) in
        (match _lh_matchIdent_3_6 with
          ...
          | `Just(_lh_showBoard_Just_0_0) -> 
            (`LH_C(' ', (`LH_C((pieceToChar_lh _lh_showBoard_Just_0_0), s_0))))))) in
    ...
    (let rec _lh_matchIdent_4_1 = p_sq_0 in
      (match _lh_matchIdent_4_1 with
        | `LH_P2(_lh_parseBoard_LH_P2_0_0, _lh_parseBoard_LH_P2_1_0) -> 
          ((putPieceAt_lh _lh_parseBoard_LH_P2_1_0) _lh_parseBoard_LH_P2_0_0)))) in
    ((fun _lh_funcomp_x_4 -> 
      ((fun _lh_funcomp_x_5 -> 
