...
let rec mappend_lh__d2_d0 xs_1_8 ys_7_1 =
  (match xs_1_8 with
    | `LH_C(h_6_4, t_6_4) -> 
      (let rec t_6_5 = ((mappend_lh__d2_d0 t_6_4) ys_7_1) in
...
let rec mappend_lh__d1 xs_3 ys_3 =
  (xs_3 ys_3);;
let rec mappend_lh__d5 xs_1_2 ys_4_1 =
  (xs_1_2 ys_4_1);;
        ...
        (let rec h_6 = 'k' in
          (fun ys_9 -> 
            (let rec t_1_1 = ((mappend_lh__d5 t_1_0) ys_9) in
              (let rec h_7 = h_6 in
                (fun ys_1_0 -> 
                  (`LH_C(h_7, ((mappend_lh__d3 t_1_1) ys_1_0))))))))) in
        (let rec h_8 = 'c' in
          (fun ys_1_1 -> 
            (let rec t_1_2 = ((mappend_lh__d5 t_9) ys_1_1) in
              (let rec h_9 = h_8 in
                (fun ys_1_2 -> 
                  (`LH_C(h_9, ((mappend_lh__d3 t_1_2) ys_1_2))))))))) in
        (let rec h_1_0 = 'a' in
          (fun ys_1_3 -> 
            (let rec t_1_3 = ((mappend_lh__d5 t_8) ys_1_3) in
              (let rec h_1_1 = h_1_0 in
                (fun ys_1_4 -> 
                  (`LH_C(h_1_1, ((mappend_lh__d3 t_1_3) ys_1_4))))))))) in
        (let rec h_1_2 = 'l' in
          (fun ys_1_5 -> 
            (let rec t_1_4 = ((mappend_lh__d5 t_7) ys_1_5) in
              (let rec h_1_3 = h_1_2 in
                (fun ys_1_6 -> 
                  (`LH_C(h_1_3, ((mappend_lh__d3 t_1_4) ys_1_6))))))))) in
        (let rec h_1_4 = 'B' in
          (fun ys_1_7 -> 
            (let rec t_1_5 = ((mappend_lh__d5 t_6) ys_1_7) in
              (let rec h_1_5 = h_1_4 in
                (fun ys_1_8 -> 
                  (`LH_C(h_1_5, ((mappend_lh__d3 t_1_5) ys_1_8)))))))))
    | `White -> 
          ...
          (fun ys_2_0 -> 
            (let rec t_2_1 = ((mappend_lh__d5 t_2_0) ys_2_0) in
              (let rec h_1_7 = h_1_6 in
                (fun ys_2_1 -> 
                  (`LH_C(h_1_7, ((mappend_lh__d3 t_2_1) ys_2_1))))))))) in
        (let rec h_1_8 = 't' in
          (fun ys_2_2 -> 
            (let rec t_2_2 = ((mappend_lh__d5 t_1_9) ys_2_2) in
              (let rec h_1_9 = h_1_8 in
                (fun ys_2_3 -> 
                  (`LH_C(h_1_9, ((mappend_lh__d3 t_2_2) ys_2_3))))))))) in
        (let rec h_2_0 = 'i' in
          (fun ys_2_4 -> 
            (let rec t_2_3 = ((mappend_lh__d5 t_1_8) ys_2_4) in
              (let rec h_2_1 = h_2_0 in
                (fun ys_2_5 -> 
                  (`LH_C(h_2_1, ((mappend_lh__d3 t_2_3) ys_2_5))))))))) in
        (let rec h_2_2 = 'h' in
          (fun ys_2_6 -> 
            (let rec t_2_4 = ((mappend_lh__d5 t_1_7) ys_2_6) in
              (let rec h_2_3 = h_2_2 in
                (fun ys_2_7 -> 
                  (`LH_C(h_2_3, ((mappend_lh__d3 t_2_4) ys_2_7))))))))) in
        (let rec h_2_4 = 'W' in
          (fun ys_2_8 -> 
            (let rec t_2_5 = ((mappend_lh__d5 t_1_6) ys_2_8) in
              (let rec h_2_5 = h_2_4 in
                (fun ys_2_9 -> 
                  (`LH_C(h_2_5, ((mappend_lh__d3 t_2_5) ys_2_9)))))))))
    | _ -> 
      (failwith "error"));;
let rec mappend_lh__d6 xs_1_5 ys_4_5 =
  (xs_1_5 ys_4_5);;
...
let rec mappend_lh__d8 xs_5 ys_7 =
  (xs_5 ys_7);;
let rec map_lh__d1 f_2_4 ls_1_6 =
  (ls_1_6 f_2_4);;
    ...
    | `LH_C(h_3_1, t_3_1) -> 
      (let rec t_3_2 = ((mappend_lh__d1_d0 t_3_1) ys_3_1) in
        (let rec h_3_2 = h_3_1 in
          (fun ys_3_2 -> 
            (let rec t_3_3 = ((mappend_lh__d2 t_3_2) ys_3_2) in
              (let rec h_3_3 = h_3_2 in
                (fun ys_3_3 -> 
                  (let rec t_3_4 = ((mappend_lh__d1 t_3_3) ys_3_3) in
                    (let rec h_3_4 = h_3_3 in
                      (fun ys_3_4 -> 
                        (let rec t_3_5 = ((mappend_lh__d5 t_3_4) ys_3_4) in
                          (let rec h_3_5 = h_3_4 in
                            (fun ys_3_5 -> 
                              (`LH_C(h_3_5, ((mappend_lh__d3 t_3_5) ys_3_5)))))))))))))))
    | `LH_N -> 
      ys_3_1);;
let rec concat_lh__d1 lss_2 =
  (match lss_2 with
    | `LH_C(h_1_2_2, t_1_2_2) -> 
      ((mappend_lh__d1_d0 h_1_2_2) (concat_lh__d1 t_1_2_2))
    | `LH_N -> 
      (fun ys_1_3_5 -> 
        ys_1_3_5));;
...
let rec showBoard_lh__d1 _lh_showBoard_arg1_0 =
  (let rec showRank_0 = (fun r_0 -> 
    (let rec consFile_0 = (fun f_1_5 s_0 -> 
      (let rec _lh_matchIdent_4_4 = ((pieceAt_lh__d1 _lh_showBoard_arg1_0) (`LH_P2(f_1_5, r_0))) in
        (match _lh_matchIdent_4_4 with
          | `Nothing -> 
            ((mappend_lh__d8 (let rec t_5_6 = (let rec t_5_7 = (fun ys_6_5 -> 
              ys_6_5) in
              (let rec h_5_6 = '-' in
                (fun ys_6_6 -> 
                  (`LH_C(h_5_6, ((mappend_lh__d8 t_5_7) ys_6_6)))))) in
              (let rec h_5_7 = ' ' in
                (fun ys_6_7 -> 
                  (`LH_C(h_5_7, ((mappend_lh__d8 t_5_6) ys_6_7))))))) s_0)
...
let rec mappend_lh__d4 xs_1_7 ys_6_8 =
  (match xs_1_7 with
    | `LH_C(h_6_0, t_6_0) -> 
      (let rec t_6_1 = ((mappend_lh__d4 t_6_0) ys_6_8) in
        (let rec h_6_1 = h_6_0 in
          (fun ys_6_9 -> 
            (let rec t_6_2 = ((mappend_lh__d7 t_6_1) ys_6_9) in
  ...
  (match _lh_break_arg2_0 with
    ...
    | `LH_C(_lh_break_LH_C_0_0, _lh_break_LH_C_1_0) -> 
      (if (_lh_break_arg1_0 _lh_break_LH_C_0_0) then
        ...
        (let rec _lh_matchIdent_2_7 = ((break_lh__d2 _lh_break_arg1_0) _lh_break_LH_C_1_0) in
  ...
  (let rec _lh_matchIdent_2_5 = ((dropWhile_lh__d1 (fun x_3 -> 
    ...
    (match _lh_matchIdent_2_5 with
      | `LH_N -> 
        (`LH_N)
      | _ -> 
        (let rec _lh_matchIdent_2_6 = ((break_lh__d2 (fun x_4 -> 
  ...
  (match _lh_emptyAtAll_arg1_1 with
    | `Board(_lh_emptyAtAll_Board_0_1, _lh_emptyAtAll_Board_1_1) -> 
      (let rec emptyAtAllAnd_1 = (fun b_4 ls_8 -> 
        (let rec _lh_matchIdent_2_9 = ls_8 in
  ...
  (match _lh_emptyAtAll_arg1_3 with
    | `Board(_lh_emptyAtAll_Board_0_3, _lh_emptyAtAll_Board_1_3) -> 
      (let rec emptyAtAllAnd_3 = (fun b_1_1 ls_2_4 -> 
        (let rec _lh_matchIdent_6_7 = ls_2_4 in
  ...
  (match _lh_emptyAtAll_arg1_2 with
    | `Board(_lh_emptyAtAll_Board_0_2, _lh_emptyAtAll_Board_1_2) -> 
      (let rec emptyAtAllAnd_2 = (fun b_6 ls_1_7 -> 
        (let rec _lh_matchIdent_4_5 = ls_1_7 in
...
let rec kingincheck_lh__d1 _lh_kingincheck_arg1_1 _lh_kingincheck_arg2_1 =
  (let rec givesCheck_1 = (fun kxy_1 -> 
    (let rec _lh_matchIdent_7_3 = kxy_1 in
                          ...
                          (match _lh_matchIdent_7_5 with
                            ...
                            | `Rook -> 
                              (((_lh_kingincheck_LH_P2_0_8 = _lh_kingincheck_LH_P2_0_9) && ((emptyAtAll_lh__d2 _lh_kingincheck_arg2_1) (fun xeye_4 -> 
                                (let rec _lh_matchIdent_7_6 = xeye_4 in
                                ...
                                (let rec _lh_matchIdent_7_7 = xeye_5 in
                            ...
                            | `Bishop -> 
                              ((((_lh_kingincheck_LH_P2_0_8 + _lh_kingincheck_LH_P2_1_8) = (_lh_kingincheck_LH_P2_0_9 + _lh_kingincheck_LH_P2_1_9)) && ((emptyAtAll_lh__d4 _lh_kingincheck_arg2_1) (fun xeye_6 -> 
                                (let rec _lh_matchIdent_7_8 = xeye_6 in
                                ...
                                (let rec _lh_matchIdent_7_9 = xeye_7 in
                            ...
                            | `Pawn -> 
                              (((abs_lh__d1 (_lh_kingincheck_LH_P2_0_8 - _lh_kingincheck_LH_P2_0_9)) = 1) && (let rec _lh_matchIdent_8_0 = _lh_kingincheck_arg1_1 in
...
let rec showPiece_lh__d1 _lh_showPiece_arg1_0 =
  (match _lh_showPiece_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec atIndex_lh__d1 n_1_3 ls_2_9 =
  (if (n_1_3 < 0) then
    (failwith "error")
  else
    (ls_2_9 n_1_3));;
let rec showSquare_lh__d1 _lh_showSquare_arg1_0 _lh_showSquare_arg2_0 =
  (match _lh_showSquare_arg2_0 with
    | `LH_P2(_lh_showSquare_LH_P2_0_0, _lh_showSquare_LH_P2_1_0) -> 
      ((mappend_lh__d3_d4 ((atIndex_lh__d1 (_lh_showSquare_LH_P2_0_0 - 1)) (let rec t_1_2_7 = (let rec t_1_2_8 = (let rec t_1_2_9 = (let rec t_1_3_0 = (let rec t_1_3_1 = (let rec t_1_3_2 = (let rec t_1_3_3 = (let rec t_1_3_4 = (fun n_4 -> 
        (failwith "error")) in
        (let rec h_1_2_7 = (`LH_C('K', (`LH_C('R', (`LH_N))))) in
          (fun n_5 -> 
            (if (n_5 = 0) then
              h_1_2_7
            else
              ((atIndex_lh__d1 (n_5 - 1)) t_1_3_4))))) in
        (let rec h_1_2_8 = (`LH_C('K', (`LH_C('N', (`LH_N))))) in
          (fun n_6 -> 
            (if (n_6 = 0) then
              h_1_2_8
            else
              ((atIndex_lh__d1 (n_6 - 1)) t_1_3_3))))) in
        (let rec h_1_2_9 = (`LH_C('K', (`LH_C('B', (`LH_N))))) in
          (fun n_7 -> 
            (if (n_7 = 0) then
              h_1_2_9
            else
              ((atIndex_lh__d1 (n_7 - 1)) t_1_3_2))))) in
        (let rec h_1_3_0 = (`LH_C('K', (`LH_N))) in
          (fun n_8 -> 
            (if (n_8 = 0) then
              h_1_3_0
            else
              ((atIndex_lh__d1 (n_8 - 1)) t_1_3_1))))) in
        (let rec h_1_3_1 = (`LH_C('Q', (`LH_N))) in
          (fun n_9 -> 
            (if (n_9 = 0) then
              h_1_3_1
            else
              ((atIndex_lh__d1 (n_9 - 1)) t_1_3_0))))) in
        (let rec h_1_3_2 = (`LH_C('Q', (`LH_C('B', (`LH_N))))) in
          (fun n_1_0 -> 
            (if (n_1_0 = 0) then
              h_1_3_2
            else
              ((atIndex_lh__d1 (n_1_0 - 1)) t_1_2_9))))) in
        (let rec h_1_3_3 = (`LH_C('Q', (`LH_C('N', (`LH_N))))) in
          (fun n_1_1 -> 
            (if (n_1_1 = 0) then
              h_1_3_3
            else
              ((atIndex_lh__d1 (n_1_1 - 1)) t_1_2_8))))) in
        (let rec h_1_3_4 = (`LH_C('Q', (`LH_C('R', (`LH_N))))) in
          (fun n_1_2 -> 
            (if (n_1_2 = 0) then
              h_1_3_4
            else
              ((atIndex_lh__d1 (n_1_2 - 1)) t_1_2_7))))))) (string_of_int (let rec _lh_matchIdent_7_2 = _lh_showSquare_arg1_0 in
...
let rec length_lh__d3 ls_2_0 =
  (match ls_2_0 with
    ...
    | `LH_N -> 
      0);;
let rec mappend_lh__d2_d9 xs_2_9 ys_1_3_3 =
  (xs_2_9 ys_1_3_3);;
let rec mappend_lh__d2_d6 xs_3_1 ys_1_3_6 =
  (match xs_3_1 with
    | `LH_C(h_1_2_3, t_1_2_3) -> 
      (let rec t_1_2_4 = ((mappend_lh__d2_d6 t_1_2_3) ys_1_3_6) in
        (let rec h_1_2_4 = h_1_2_3 in
          (fun ys_1_3_7 -> 
            (`LH_C(h_1_2_4, ((mappend_lh__d2_d9 t_1_2_4) ys_1_3_7))))))
    | `LH_N -> 
      ys_1_3_6);;
let rec mappend_lh__d3_d0 xs_3_3 ys_1_4_0 =
  (match xs_3_3 with
    | `LH_C(h_1_2_6, t_1_2_6) -> 
      (`LH_C(h_1_2_6, ((mappend_lh__d3_d0 t_1_2_6) ys_1_4_0)))
    | `LH_N -> 
      ys_1_4_0);;
let rec mappend_lh__d2_d8 xs_2_8 ys_1_3_2 =
  (xs_2_8 ys_1_3_2);;
let rec mappend_lh__d2_d7 xs_3_5 ys_1_4_5 =
  (match xs_3_5 with
    | `LH_C(h_1_3_8, t_1_3_8) -> 
      (let rec t_1_3_9 = ((mappend_lh__d2_d7 t_1_3_8) ys_1_4_5) in
        (let rec h_1_3_9 = h_1_3_8 in
          (fun ys_1_4_6 -> 
            (`LH_C(h_1_3_9, ((mappend_lh__d2_d8 t_1_3_9) ys_1_4_6))))))
    | `LH_N -> 
      ys_1_4_5);;
    ...
    | `LH_C(h_4_0, t_4_0) -> 
      (let rec t_4_1 = ((mappend_lh__d1_d4 t_4_0) ys_4_3) in
        (let rec h_4_1 = h_4_0 in
          (fun ys_4_4 -> 
            (`LH_C(h_4_1, ((mappend_lh__d1_d2 t_4_1) ys_4_4))))))
    | `LH_N -> 
      ys_4_3);;
let rec mappend_lh__d1_d1 xs_1_6 ys_6_4 =
  (xs_1_6 ys_6_4);;
...
let rec showMoves_lh__d2 _lh_showMoves_arg1_2 =
  (match _lh_showMoves_arg1_2 with
    ...
    | _ -> 
      (failwith "error"));;
let rec mappend_lh__d2_d5 xs_1_9 ys_7_2 =
  (xs_1_9 ys_7_2);;
    ...
    | `LH_C(h_3_7, t_3_7) -> 
      (let rec t_3_8 = ((mappend_lh__d2_d3 t_3_7) ys_3_9) in
        (let rec h_3_8 = h_3_7 in
          (fun ys_4_0 -> 
            (`LH_C(h_3_8, ((mappend_lh__d2_d5 t_3_8) ys_4_0))))))
    | `LH_N -> 
      ys_3_9);;
let rec null_lh__d2 _lh_null_arg1_0 =
  (match _lh_null_arg1_0 with
    ...
    | _ -> 
      (failwith "error"));;
let rec mappend_lh__d2_d4 xs_2_5 ys_9_7 =
  (xs_2_5 ys_9_7);;
let rec length_lh__d2 ls_3_0 =
  (match ls_3_0 with
    | `LH_C(h_1_4_0, t_1_4_0) -> 
      (1 + (length_lh__d2 t_1_4_0))
    | `LH_N -> 
      0);;
let rec mappend_lh__d2_d2 xs_3_4 ys_1_4_4 =
  (match xs_3_4 with
    ...
    | `LH_C(_lh_showReplies_LH_C_0_1, _lh_showReplies_LH_C_1_1) -> 
      (match _lh_showReplies_LH_C_0_1 with
        | `LH_P2(_lh_showReplies_LH_P2_0_1, _lh_showReplies_LH_P2_1_1) -> 
          ((mappend_lh__d2_d2 ((mappend_lh__d2_d5 ((mappend_lh__d2_d3 ((mappend_lh__d2_d4 ((mappend_lh__d2_d1 (tab_lh__d1 _lh_showReplies_arg2_1)) (let rec t_8_3 = (let rec t_8_4 = (let rec t_8_5 = (fun ys_8_6 -> 
            ys_8_6) in
            (let rec h_8_3 = ' ' in
              (fun ys_8_7 -> 
                (`LH_C(h_8_3, ((mappend_lh__d2_d4 t_8_5) ys_8_7)))))) in
            (let rec h_8_4 = 'f' in
              (fun ys_8_8 -> 
                (`LH_C(h_8_4, ((mappend_lh__d2_d4 t_8_4) ys_8_8)))))) in
            (let rec h_8_5 = 'i' in
              (fun ys_8_9 -> 
                (`LH_C(h_8_5, ((mappend_lh__d2_d4 t_8_3) ys_8_9)))))))) (if ((null_lh__d2 _lh_showReplies_LH_C_1_1) && ((length_lh__d2 _lh_showReplies_LH_P2_0_1) > 1)) then
            (`LH_C('o', (`LH_C('t', (`LH_C('h', (`LH_C('e', (`LH_C('r', (`LH_C('s', (`LH_N)))))))))))))
          else
            (showMoves_lh__d2 _lh_showReplies_LH_P2_0_1)))) (let rec t_8_6 = (let rec t_8_7 = (fun ys_9_0 -> 
            ys_9_0) in
            (let rec h_8_6 = ' ' in
              (fun ys_9_1 -> 
                (`LH_C(h_8_6, ((mappend_lh__d2_d5 t_8_7) ys_9_1)))))) in
            (let rec h_8_7 = ';' in
              (fun ys_9_2 -> 
                (`LH_C(h_8_7, ((mappend_lh__d2_d5 t_8_6) ys_9_2)))))))) ((showSoln_lh__d1 _lh_showReplies_LH_P2_1_1) (_lh_showReplies_arg2_1 + 1)))) ((showReplies_lh__d1 _lh_showReplies_LH_C_1_1) _lh_showReplies_arg2_1))
        | _ -> 
          (failwith "error"))
    | _ -> 
      (failwith "error"))
    ...
    | `LH_C(_lh_showReplies_LH_C_0_0, _lh_showReplies_LH_C_1_0) -> 
      (match _lh_showReplies_LH_C_0_0 with
        | `LH_P2(_lh_showReplies_LH_P2_0_0, _lh_showReplies_LH_P2_1_0) -> 
          ((mappend_lh__d3_d0 ((mappend_lh__d2_d8 ((mappend_lh__d2_d7 ((mappend_lh__d2_d9 ((mappend_lh__d2_d6 (tab_lh__d2 _lh_showReplies_arg2_0)) (let rec t_6_8 = (let rec t_6_9 = (let rec t_7_0 = (fun ys_7_5 -> 
            ys_7_5) in
            (let rec h_6_8 = ' ' in
              (fun ys_7_6 -> 
                (`LH_C(h_6_8, ((mappend_lh__d2_d9 t_7_0) ys_7_6)))))) in
            (let rec h_6_9 = 'f' in
              (fun ys_7_7 -> 
                (`LH_C(h_6_9, ((mappend_lh__d2_d9 t_6_9) ys_7_7)))))) in
            (let rec h_7_0 = 'i' in
              (fun ys_7_8 -> 
                (`LH_C(h_7_0, ((mappend_lh__d2_d9 t_6_8) ys_7_8)))))))) (if ((null_lh__d3 _lh_showReplies_LH_C_1_0) && ((length_lh__d3 _lh_showReplies_LH_P2_0_0) > 1)) then
            (`LH_C('o', (`LH_C('t', (`LH_C('h', (`LH_C('e', (`LH_C('r', (`LH_C('s', (`LH_N)))))))))))))
          else
            (showMoves_lh__d3 _lh_showReplies_LH_P2_0_0)))) (let rec t_7_1 = (let rec t_7_2 = (fun ys_7_9 -> 
            ys_7_9) in
            (let rec h_7_1 = ' ' in
              (fun ys_8_0 -> 
                (`LH_C(h_7_1, ((mappend_lh__d2_d8 t_7_2) ys_8_0)))))) in
            (let rec h_7_2 = ';' in
              (fun ys_8_1 -> 
                (`LH_C(h_7_2, ((mappend_lh__d2_d8 t_7_1) ys_8_1)))))))) ((showSoln_lh__d1 _lh_showReplies_LH_P2_1_0) (_lh_showReplies_arg2_0 + 1)))) ((showReplies_lh__d2 _lh_showReplies_LH_C_1_0) _lh_showReplies_arg2_0))
        | _ -> 
          (failwith "error"))
    | _ -> 
      (failwith "error"))
    ...
    | `LH_C(_lh_showReplies_LH_C_0_2, _lh_showReplies_LH_C_1_2) -> 
      (match _lh_showReplies_LH_C_0_2 with
        | `LH_P2(_lh_showReplies_LH_P2_0_2, _lh_showReplies_LH_P2_1_2) -> 
          ((mappend_lh__d3_d4 ((mappend_lh__d3_d2 ((mappend_lh__d3_d1 ((mappend_lh__d3_d4 ((mappend_lh__d3_d3 (tab_lh__d2 _lh_showReplies_arg2_2)) (`LH_C('i', (`LH_C('f', (`LH_C(' ', (`LH_N))))))))) (if ((null_lh__d3 _lh_showReplies_LH_C_1_2) && ((length_lh__d4 _lh_showReplies_LH_P2_0_2) > 1)) then
            (`LH_C('o', (`LH_C('t', (`LH_C('h', (`LH_C('e', (`LH_C('r', (`LH_C('s', (`LH_N)))))))))))))
          else
            (showMoves_lh__d4 _lh_showReplies_LH_P2_0_2)))) (let rec t_8_9 = (let rec t_9_0 = (fun ys_9_4 -> 
            ys_9_4) in
            (let rec h_8_9 = ' ' in
              (fun ys_9_5 -> 
                (`LH_C(h_8_9, ((mappend_lh__d3_d2 t_9_0) ys_9_5)))))) in
            (let rec h_9_0 = ';' in
              (fun ys_9_6 -> 
                (`LH_C(h_9_0, ((mappend_lh__d3_d2 t_8_9) ys_9_6)))))))) ((showSoln_lh__d1 _lh_showReplies_LH_P2_1_2) (_lh_showReplies_arg2_2 + 1)))) ((showReplies_lh__d3 _lh_showReplies_LH_C_1_2) _lh_showReplies_arg2_2))
        | _ -> 
          (failwith "error"))
    | _ -> 
      (failwith "error"))
...
showSoln_lh__d1 _lh_showSoln_arg1_2 _lh_showSoln_arg2_2 =
  (match _lh_showSoln_arg1_2 with
    | `Soln(_lh_showSoln_Soln_0_2, _lh_showSoln_Soln_1_2) -> 
      ((mappend_lh__d1_d6 ((mappend_lh__d1_d5 ((mappend_lh__d1_d3 (string_of_int _lh_showSoln_arg2_2)) (let rec t_4_4 = (let rec t_4_5 = (fun ys_4_6 -> 
        ys_4_6) in
        (let rec h_4_4 = ' ' in
          (fun ys_4_7 -> 
            (`LH_C(h_4_4, ((mappend_lh__d1_d5 t_4_5) ys_4_7)))))) in
        (let rec h_4_5 = '.' in
          (fun ys_4_8 -> 
            (`LH_C(h_4_5, ((mappend_lh__d1_d5 t_4_4) ys_4_8)))))))) (showMoveInFull_lh__d1 _lh_showSoln_Soln_0_2))) (let rec _lh_matchIdent_3_8 = _lh_showSoln_Soln_1_2 in
            ...
            (match _lh_showSoln_LH_C_0_2 with
              | `LH_P2(_lh_showSoln_LH_P2_0_2, _lh_showSoln_LH_P2_1_2) -> 
                (match _lh_showSoln_LH_C_1_2 with
                  | `LH_N -> 
                    ((mappend_lh__d1_d2 ((mappend_lh__d1_d4 ((mappend_lh__d1_d1 (let rec t_4_6 = (let rec t_4_7 = (fun ys_4_9 -> 
                      ys_4_9) in
                      (let rec h_4_6 = ' ' in
                        (fun ys_5_0 -> 
                          (`LH_C(h_4_6, ((mappend_lh__d1_d1 t_4_7) ys_5_0)))))) in
                      (let rec h_4_7 = ',' in
                        (fun ys_5_1 -> 
                          (`LH_C(h_4_7, ((mappend_lh__d1_d1 t_4_6) ys_5_1))))))) (if ((length_lh__d1 _lh_showSoln_LH_P2_0_2) > 1) then
                      (`LH_C('.', (`LH_C('.', (`LH_C('.', (`LH_N)))))))
                    else
                      ...
                      (let rec h_4_8 = ' ' in
                        (fun ys_5_3 -> 
                          (`LH_C(h_4_8, ((mappend_lh__d1_d2 t_4_9) ys_5_3)))))) in
                      (let rec h_4_9 = ';' in
                        (fun ys_5_4 -> 
                          (`LH_C(h_4_9, ((mappend_lh__d1_d2 t_4_8) ys_5_4)))))))) ((showSoln_lh__d1 _lh_showSoln_LH_P2_1_2) (_lh_showSoln_arg2_2 + 1)))
                  | _ -> 
                    ((mappend_lh__d1_d9 (let rec t_5_0 = (let rec t_5_1 = (fun ys_5_5 -> 
                      ys_5_5) in
                      (let rec h_5_0 = '|' in
                        (fun ys_5_6 -> 
                          (`LH_C(h_5_0, ((mappend_lh__d1_d9 t_5_1) ys_5_6)))))) in
                      (let rec h_5_1 = ',' in
                        (fun ys_5_7 -> 
                          (`LH_C(h_5_1, ((mappend_lh__d1_d9 t_5_0) ys_5_7))))))) ((showReplies_lh__d2 (sort_lh__d3 _lh_showSoln_Soln_1_2)) _lh_showSoln_arg2_2)))
              | _ -> 
                ((mappend_lh__d1_d8 (let rec t_5_2 = (let rec t_5_3 = (fun ys_5_8 -> 
                  ys_5_8) in
                  (let rec h_5_2 = '|' in
                    (fun ys_5_9 -> 
                      (`LH_C(h_5_2, ((mappend_lh__d1_d8 t_5_3) ys_5_9)))))) in
                  (let rec h_5_3 = ',' in
                    (fun ys_6_0 -> 
                      (`LH_C(h_5_3, ((mappend_lh__d1_d8 t_5_2) ys_6_0))))))) ((showReplies_lh__d3 (sort_lh__d2 _lh_showSoln_Soln_1_2)) _lh_showSoln_arg2_2)))
          | _ -> 
            ((mappend_lh__d1_d7 (let rec t_5_4 = (let rec t_5_5 = (fun ys_6_1 -> 
              ys_6_1) in
              (let rec h_5_4 = '|' in
                (fun ys_6_2 -> 
                  (`LH_C(h_5_4, ((mappend_lh__d1_d7 t_5_5) ys_6_2)))))) in
              (let rec h_5_5 = ',' in
                (fun ys_6_3 -> 
...
let rec showSoln_lh__d2 _lh_showSoln_arg1_0 _lh_showSoln_arg2_0 =
  (match _lh_showSoln_arg1_0 with
    | `Soln(_lh_showSoln_Soln_0_0, _lh_showSoln_Soln_1_0) -> 
      ((mappend_lh__d3_d4 ((mappend_lh__d3_d4 ((mappend_lh__d3_d4 (string_of_int _lh_showSoln_arg2_0)) (`LH_C('.', (`LH_C(' ', (`LH_N))))))) (showMoveInFull_lh__d1 _lh_showSoln_Soln_0_0))) (let rec _lh_matchIdent_2_2 = _lh_showSoln_Soln_1_0 in
...
let rec showSoln_lh__d3 _lh_showSoln_arg1_1 _lh_showSoln_arg2_1 =
  (match _lh_showSoln_arg1_1 with
    | `Soln(_lh_showSoln_Soln_0_1, _lh_showSoln_Soln_1_1) -> 
      ((mappend_lh__d3_d4 ((mappend_lh__d3_d4 ((mappend_lh__d3_d4 (string_of_int _lh_showSoln_arg2_1)) (`LH_C('.', (`LH_C(' ', (`LH_N))))))) (showMoveInFull_lh__d1 _lh_showSoln_Soln_0_1))) (let rec _lh_matchIdent_3_6 = _lh_showSoln_Soln_1_1 in
                        ...
                        (let rec _lh_testMate_nofib_LH_P2_1_1 = n_3 in
                          (let rec _lh_testMate_nofib_LH_P2_0_1 = c_1 in
                            (fun _lh_testMate_nofib_LH_P2_0_2 -> 
                              ((mappend_lh__d6 ((mappend_lh__d7 ((mappend_lh__d4 ((mappend_lh__d3 ((mappend_lh__d5 ((mappend_lh__d1 ((mappend_lh__d2 (showBoard_lh__d1 _lh_testMate_nofib_LH_P2_0_2)) (let rec t_9_5 = (fun ys_1_0_1 -> 
                                ys_1_0_1) in
                                (let rec h_9_5 = '|' in
                                  (fun ys_1_0_2 -> 
                                    (let rec t_9_6 = ((mappend_lh__d1 t_9_5) ys_1_0_2) in
                                      (let rec h_9_6 = h_9_5 in
                                        (fun ys_1_0_3 -> 
                                          (let rec t_9_7 = ((mappend_lh__d5 t_9_6) ys_1_0_3) in
                                            (let rec h_9_7 = h_9_6 in
                                              (fun ys_1_0_4 -> 
                                                (`LH_C(h_9_7, ((mappend_lh__d3 t_9_7) ys_1_0_4)))))))))))))) (showColour_lh__d1 _lh_testMate_nofib_LH_P2_0_1))) (let rec t_9_8 = (let rec t_9_9 = (let rec t_1_0_0 = (let rec t_1_0_1 = (let rec t_1_0_2 = (let rec t_1_0_3 = (let rec t_1_0_4 = (let rec t_1_0_5 = (let rec t_1_0_6 = (let rec t_1_0_7 = (let rec t_1_0_8 = (let rec t_1_0_9 = (let rec t_1_1_0 = (let rec t_1_1_1 = (let rec t_1_1_2 = (let rec t_1_1_3 = (let rec t_1_1_4 = (let rec t_1_1_5 = (let rec t_1_1_6 = (let rec t_1_1_7 = (let rec t_1_1_8 = (fun ys_1_0_5 -> 
                                ys_1_0_5) in
                                (let rec h_9_8 = ' ' in
                                  (fun ys_1_0_6 -> 
                                    (`LH_C(h_9_8, ((mappend_lh__d3 t_1_1_8) ys_1_0_6)))))) in
                                (let rec h_9_9 = 'n' in
                                  (fun ys_1_0_7 -> 
                                    (`LH_C(h_9_9, ((mappend_lh__d3 t_1_1_7) ys_1_0_7)))))) in
                                (let rec h_1_0_0 = 'i' in
                                  (fun ys_1_0_8 -> 
                                    (`LH_C(h_1_0_0, ((mappend_lh__d3 t_1_1_6) ys_1_0_8)))))) in
                                (let rec h_1_0_1 = ' ' in
                                  (fun ys_1_0_9 -> 
                                    (`LH_C(h_1_0_1, ((mappend_lh__d3 t_1_1_5) ys_1_0_9)))))) in
                                (let rec h_1_0_2 = 'e' in
                                  (fun ys_1_1_0 -> 
                                    (`LH_C(h_1_0_2, ((mappend_lh__d3 t_1_1_4) ys_1_1_0)))))) in
                                (let rec h_1_0_3 = 't' in
                                  (fun ys_1_1_1 -> 
                                    (`LH_C(h_1_0_3, ((mappend_lh__d3 t_1_1_3) ys_1_1_1)))))) in
                                (let rec h_1_0_4 = 'a' in
                                  (fun ys_1_1_2 -> 
                                    (`LH_C(h_1_0_4, ((mappend_lh__d3 t_1_1_2) ys_1_1_2)))))) in
                                (let rec h_1_0_5 = 'm' in
                                  (fun ys_1_1_3 -> 
                                    (`LH_C(h_1_0_5, ((mappend_lh__d3 t_1_1_1) ys_1_1_3)))))) in
                                (let rec h_1_0_6 = ' ' in
                                  (fun ys_1_1_4 -> 
                                    (`LH_C(h_1_0_6, ((mappend_lh__d3 t_1_1_0) ys_1_1_4)))))) in
                                (let rec h_1_0_7 = 'd' in
                                  (fun ys_1_1_5 -> 
                                    (`LH_C(h_1_0_7, ((mappend_lh__d3 t_1_0_9) ys_1_1_5)))))) in
                                (let rec h_1_0_8 = 'n' in
                                  (fun ys_1_1_6 -> 
                                    (`LH_C(h_1_0_8, ((mappend_lh__d3 t_1_0_8) ys_1_1_6)))))) in
                                (let rec h_1_0_9 = 'a' in
                                  (fun ys_1_1_7 -> 
                                    (`LH_C(h_1_0_9, ((mappend_lh__d3 t_1_0_7) ys_1_1_7)))))) in
                                (let rec h_1_1_0 = ' ' in
                                  (fun ys_1_1_8 -> 
                                    (`LH_C(h_1_1_0, ((mappend_lh__d3 t_1_0_6) ys_1_1_8)))))) in
                                (let rec h_1_1_1 = 'e' in
                                  (fun ys_1_1_9 -> 
                                    (`LH_C(h_1_1_1, ((mappend_lh__d3 t_1_0_5) ys_1_1_9)))))) in
                                (let rec h_1_1_2 = 'v' in
                                  (fun ys_1_2_0 -> 
                                    (`LH_C(h_1_1_2, ((mappend_lh__d3 t_1_0_4) ys_1_2_0)))))) in
                                (let rec h_1_1_3 = 'o' in
                                  (fun ys_1_2_1 -> 
                                    (`LH_C(h_1_1_3, ((mappend_lh__d3 t_1_0_3) ys_1_2_1)))))) in
                                (let rec h_1_1_4 = 'm' in
                                  (fun ys_1_2_2 -> 
                                    (`LH_C(h_1_1_4, ((mappend_lh__d3 t_1_0_2) ys_1_2_2)))))) in
                                (let rec h_1_1_5 = ' ' in
                                  (fun ys_1_2_3 -> 
                                    (`LH_C(h_1_1_5, ((mappend_lh__d3 t_1_0_1) ys_1_2_3)))))) in
                                (let rec h_1_1_6 = 'o' in
                                  (fun ys_1_2_4 -> 
                                    (`LH_C(h_1_1_6, ((mappend_lh__d3 t_1_0_0) ys_1_2_4)))))) in
                                (let rec h_1_1_7 = 't' in
                                  (fun ys_1_2_5 -> 
                                    (`LH_C(h_1_1_7, ((mappend_lh__d3 t_9_9) ys_1_2_5)))))) in
                                (let rec h_1_1_8 = ' ' in
                                  (fun ys_1_2_6 -> 
                                    (`LH_C(h_1_1_8, ((mappend_lh__d3 t_9_8) ys_1_2_6)))))))) (string_of_int _lh_testMate_nofib_LH_P2_1_1))) (let rec t_1_1_9 = (fun ys_1_2_7 -> 
                                ys_1_2_7) in
                                (let rec h_1_1_9 = '|' in
                                  (fun ys_1_2_8 -> 
                                    (let rec t_1_2_0 = ((mappend_lh__d7 t_1_1_9) ys_1_2_8) in
                                      (let rec h_1_2_0 = h_1_1_9 in
                                        (fun ys_1_2_9 -> 
                                          (`LH_C(h_1_2_0, ((mappend_lh__d6 t_1_2_0) ys_1_2_9))))))))))) (let rec t_1_2_1 = (fun ys_1_3_0 -> 
                                ys_1_3_0) in
                                (let rec h_1_2_1 = '|' in
                                  (fun ys_1_3_1 -> 
                                    (`LH_C(h_1_2_1, ((mappend_lh__d6 t_1_2_1) ys_1_3_1)))))))) (((solve_lh__d1 _lh_testMate_nofib_LH_P2_0_2) _lh_testMate_nofib_LH_P2_0_1) _lh_testMate_nofib_LH_P2_1_1))))))))
                | _ -> 
                  (failwith "error")))))
      else
