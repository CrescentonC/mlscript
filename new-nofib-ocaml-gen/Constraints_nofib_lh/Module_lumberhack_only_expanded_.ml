...
let rec reverse_helper_lh__d1 ls_2 a_3 =
  (match ls_2 with
    | `LH_C(h_3, t_3) -> 
      ((reverse_helper_lh__d1 t_3) (`LH_C(h_3, a_3)))
    | `LH_N -> 
      a_3);;
let rec reverse_lh__d1 ls_1_6 =
  ((reverse_helper_lh__d1 ls_1_6) (`LH_N));;
let rec filter_lh__d2 f_1_5 ls_1_5 =
  (match ls_1_5 with
    | `LH_C(h_1_6, t_1_6) -> 
      (if (f_1_5 h_1_6) then
        (`LH_C(h_1_6, ((filter_lh__d2 f_1_5) t_1_6)))
      else
        ((filter_lh__d2 f_1_5) t_1_6))
    | `LH_N -> 
      (`LH_N));;
    ...
    | `CSP(_lh_earliestInconsistency_CSP_0_2, _lh_earliestInconsistency_CSP_1_2, _lh_earliestInconsistency_CSP_2_2) -> 
      (match _lh_earliestInconsistency_arg2_2 with
        ...
        | `LH_C(_lh_earliestInconsistency_LH_C_0_4, _lh_earliestInconsistency_LH_C_1_4) -> 
          (let rec _lh_matchIdent_5 = ((filter_lh__d2 (fun _lh_funcomp_x_4 -> 
            (not ((_lh_earliestInconsistency_CSP_2_2 _lh_earliestInconsistency_LH_C_0_4) _lh_funcomp_x_4)))) (reverse_lh__d1 _lh_earliestInconsistency_LH_C_1_4)) in
            (match _lh_matchIdent_5 with
              | `LH_N -> 
                (`Nothing)
              | `LH_C(_lh_earliestInconsistency_LH_C_0_5, _lh_earliestInconsistency_LH_C_1_5) -> 
                (`Just((`LH_P2((level_lh__d2 _lh_earliestInconsistency_LH_C_0_4), (level_lh__d1 _lh_earliestInconsistency_LH_C_0_5)))))))));;
let rec map_lh__d6 f_1_6 ls_1_7 =
  (match ls_1_7 with
    | `LH_C(h_1_7, t_1_7) -> 
      (`LH_C((f_1_6 h_1_7), ((map_lh__d6 f_1_6) t_1_7)))
    | `LH_N -> 
      (`LH_N));;
let rec mapTree_lh__d2 _lh_mapTree_arg1_5 _lh_mapTree_arg2_5 =
  (match _lh_mapTree_arg2_5 with
    | `Node(_lh_mapTree_Node_0_5, _lh_mapTree_Node_1_5) -> 
      (`Node((_lh_mapTree_arg1_5 _lh_mapTree_Node_0_5), ((map_lh__d6 (mapTree_lh__d2 _lh_mapTree_arg1_5)) _lh_mapTree_Node_1_5))));;
...
let rec bt_lh__d1 _lh_bt_arg1_2 =
  (let rec f_3_1 = (fun s_2 -> 
    ...
    (mapTree_lh__d2 f_3_1));;
let rec map_lh__d1 f_3_0 ls_2_7 =
  (match ls_2_7 with
    | `LH_C(h_2_7, t_2_7) -> 
      (`LH_C((f_3_0 h_2_7), ((map_lh__d1 f_3_0) t_2_7)))
    | `LH_N -> 
      (`LH_N));;
...
let rec map_lh__d1_d3 f_3 ls_1 =
  (match ls_1 with
    | `LH_C(h_2, t_2) -> 
      (`LH_C((f_3 h_2), ((map_lh__d1_d3 f_3) t_2)))
    | `LH_N -> 
      (`LH_N));;
...
let rec head_lh__d3 ls_1_1 =
  (match ls_1_1 with
    | `LH_C(h_1_2, t_1_2) -> 
      h_1_2
    | `LH_N -> 
      (failwith "lh_default_error"));;
let rec atIndex_lh__d2 n_0 ls_1_0 =
  (if (n_0 < 0) then
    (failwith "lh_default_error")
  else
    (match ls_1_0 with
          ...
          | `LH_C(_lh_f_LH_C_0_0, _lh_f_LH_C_1_0) -> 
            (let rec tableEntry_0 = ((atIndex_lh__d2 ((value_lh__d2 _lh_f_LH_C_0_0) - 1)) (head_lh__d3 _lh_f_LH_P2_1_1)) in
              (let rec cs_3 = (if (tableEntry_0 = (`Unknown)) then
                ...
                tableEntry_0) in
                (`LH_P2((`LH_P2((`LH_C(_lh_f_LH_C_0_0, _lh_f_LH_C_1_0)), cs_3)), _lh_f_LH_P2_1_1))))))) in
    ((mapTree_lh__d6 (f_2_5 _lh_lookupCache_arg1_0)) _lh_lookupCache_arg2_0));;
let rec map_lh__d7 f_1_3 ls_1_2 =
  (match ls_1_2 with
    | `LH_C(h_1_3, t_1_3) -> 
      (`LH_C((f_1_3 h_1_3), ((map_lh__d7 f_1_3) t_1_3)))
    | `LH_N -> 
      (`LH_N));;
let rec enumFromTo_lh__d8 a_1 b_1 =
  (if (a_1 <= b_1) then
    (`LH_C(a_1, ((enumFromTo_lh__d8 (a_1 + 1)) b_1)))
  else
    (`LH_N));;
let rec enumFromTo_lh__d9 a_0 b_0 =
  (if (a_0 <= b_0) then
    ...
    (`LH_N));;
let rec zipWith_lh__d4 f_1 xs_1 ys_1 =
  (match xs_1 with
    | `LH_C(hx_0, tx_0) -> 
      (match ys_1 with
        | `LH_C(hy_0, ty_0) -> 
          (`LH_C(((f_1 hx_0) hy_0), (((zipWith_lh__d4 f_1) tx_0) ty_0)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N));;
let rec zipWith_lh__d3 f_2 xs_2 ys_2 =
  (match xs_2 with
    | `LH_C(hx_1, tx_1) -> 
      (match ys_2 with
        | `LH_C(hy_1, ty_1) -> 
          (`LH_C(((f_2 hx_1) hy_1), (((zipWith_lh__d3 f_2) tx_1) ty_1)))
        | `LH_N -> 
          (`LH_N))
    | `LH_N -> 
      (`LH_N));;
        ...
        | `Assign(_lh_fillTable_Assign_0_0, _lh_fillTable_Assign_1_0) -> 
          (match _lh_fillTable_arg2_0 with
            | `CSP(_lh_fillTable_CSP_0_0, _lh_fillTable_CSP_1_0, _lh_fillTable_CSP_2_0) -> 
              (let rec f_1_4 = (fun cs_1 varval_0 -> 
                  ...
                  (match _lh_matchIdent_1 with
                    | `LH_P2(_lh_fillTable_LH_P2_0_0, _lh_fillTable_LH_P2_1_0) -> 
                      (if ((cs_1 = (`Unknown)) && (not ((_lh_fillTable_CSP_2_0 (`Assign(_lh_fillTable_Assign_0_0, _lh_fillTable_Assign_1_0))) (`Assign(_lh_fillTable_LH_P2_0_0, _lh_fillTable_LH_P2_1_0))))) then
                        ...
                        cs_1)))) in
                (((zipWith_lh__d3 (zipWith_lh__d4 f_1_4)) _lh_fillTable_arg3_0) (let rec _lh_listcomp_fun_0 = (fun _lh_listcomp_fun_para_0 -> 
                    ...
                    | `LH_C(_lh_listcomp_fun_ls_h_0, _lh_listcomp_fun_ls_t_0) -> 
                      (`LH_C((let rec _lh_listcomp_fun_1 = (fun _lh_listcomp_fun_para_1 -> 
                        (match _lh_listcomp_fun_para_1 with
                          ...
                          | `LH_N -> 
                            (`LH_N))) in
                        (_lh_listcomp_fun_1 ((enumFromTo_lh__d8 1) _lh_fillTable_CSP_1_0))), (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_0)))
                    | `LH_N -> 
                      (`LH_N))) in
                  (_lh_listcomp_fun_0 ((enumFromTo_lh__d9 (_lh_fillTable_Assign_0_0 + 1)) _lh_fillTable_CSP_0_0))))))));;
let rec tail_lh__d2 ls_1_3 =
  (match ls_1_3 with
    | `LH_C(h_1_4, t_1_4) -> 
      t_1_4
    | `LH_N -> 
...
let rec mapTree_lh__d5 _lh_mapTree_arg1_2 _lh_mapTree_arg2_2 =
  (match _lh_mapTree_arg2_2 with
    | `Node(_lh_mapTree_Node_0_2, _lh_mapTree_Node_1_2) -> 
      (`Node((_lh_mapTree_arg1_2 _lh_mapTree_Node_0_2), ((map_lh__d1_d3 (mapTree_lh__d5 _lh_mapTree_arg1_2)) _lh_mapTree_Node_1_2))));;
let rec filter_lh__d3 f_4 ls_3 =
  (match ls_3 with
    | `LH_C(h_4, t_4) -> 
      (if (f_4 h_4) then
        (`LH_C(h_4, ((filter_lh__d3 f_4) t_4)))
      else
        ((filter_lh__d3 f_4) t_4))
    | `LH_N -> 
      (`LH_N));;
...
let rec union_lh__d2 _lh_union_arg1_0 _lh_union_arg2_0 =
  (((unionBy_lh__d1 (fun a_2 b_2 -> 
    (a_2 = b_2))) _lh_union_arg1_0) _lh_union_arg2_0);;
...
let rec domainWipeOut_lh__d1 _lh_domainWipeOut_arg1_0 _lh_domainWipeOut_arg2_0 =
  (match _lh_domainWipeOut_arg1_0 with
    | `CSP(_lh_domainWipeOut_CSP_0_0, _lh_domainWipeOut_CSP_1_0, _lh_domainWipeOut_CSP_2_0) -> 
      (let rec f_2_6 = (fun _lh_f_arg1_2 -> 
                ...
                (let rec wipedDomains_0 = (let rec _lh_listcomp_fun_7 = (fun _lh_listcomp_fun_para_7 -> 
                  (match _lh_listcomp_fun_para_7 with
                    | `LH_C(_lh_listcomp_fun_ls_h_7, _lh_listcomp_fun_ls_t_7) -> 
                      (if ((all_lh__d1 knownConflict_lh__d2) _lh_listcomp_fun_ls_h_7) then
        ...
        ((mapTree_lh__d5 f_2_6) _lh_domainWipeOut_arg2_0)));;
...
let rec foldTree_lh__d2 _lh_foldTree_arg1_0 _lh_foldTree_arg2_0 =
  (match _lh_foldTree_arg2_0 with
    | `Node(_lh_foldTree_Node_0_0, _lh_foldTree_Node_1_0) -> 
      ((_lh_foldTree_arg1_0 _lh_foldTree_Node_0_0) ((map_lh__d1_d3 (foldTree_lh__d2 _lh_foldTree_arg1_0)) _lh_foldTree_Node_1_0)));;
let rec filterTree_lh__d1 _lh_filterTree_arg1_0 =
  (let rec f_7 = (fun a_5 cs_0 -> 
    (`Node(a_5, ((filter_lh__d3 (fun _lh_funcomp_x_0 -> 
      (_lh_filterTree_arg1_0 (label_lh__d2 _lh_funcomp_x_0)))) cs_0)))) in
    (foldTree_lh__d2 f_7));;
let rec prune_lh__d1 _lh_prune_arg1_0 =
  (filterTree_lh__d1 (fun _lh_funcomp_x_3 -> 
    (not (_lh_prune_arg1_0 _lh_funcomp_x_3))));;
...
let rec knownConflict_lh__d1 _lh_knownConflict_arg1_2 =
  (match _lh_knownConflict_arg1_2 with
    ...
    | _ -> 
      false);;
let rec enumFromTo_lh__d7 a_6 b_4 =
  (if (a_6 <= b_4) then
    (`LH_C(a_6, ((enumFromTo_lh__d7 (a_6 + 1)) b_4)))
  else
    (`LH_N));;
          ...
          (let rec _lh_listcomp_fun_2 = (fun _lh_listcomp_fun_para_2 -> 
            (match _lh_listcomp_fun_para_2 with
              | `LH_C(_lh_listcomp_fun_ls_h_2, _lh_listcomp_fun_ls_t_2) -> 
                (`LH_C((`LH_C((`Assign(((maxLevel_lh__d1 ss_0) + 1), _lh_listcomp_fun_ls_h_2)), ss_0)), (_lh_listcomp_fun_2 _lh_listcomp_fun_ls_t_2)))
              | `LH_N -> 
                (`LH_N))) in
            (_lh_listcomp_fun_2 ((enumFromTo_lh__d7 1) _lh_mkTree_CSP_1_0)))
        else
          (`LH_N))) in
...
let rec snd_lh__d1 _lh_snd_arg1_1 =
  (match _lh_snd_arg1_1 with
    | `LH_P2(_lh_snd_LH_P2_0_1, _lh_snd_LH_P2_1_1) -> 
      _lh_snd_LH_P2_1_1);;
let rec filter_lh__d1 f_1_8 ls_1_9 =
  (match ls_1_9 with
    | `LH_C(h_1_9, t_1_9) -> 
      (if (f_1_8 h_1_9) then
        (`LH_C(h_1_9, ((filter_lh__d1 f_1_8) t_1_9)))
      else
        ((filter_lh__d1 f_1_8) t_1_9))
    | `LH_N -> 
      (`LH_N));;
let rec map_lh__d4 f_1_9 ls_2_0 =
  (match ls_2_0 with
    | `LH_C(h_2_0, t_2_0) -> 
...
let rec concat_lh__d1 lss_0 =
  (match lss_0 with
    | `LH_C(h_7, t_7) -> 
      ((mappend_lh__d1 h_7) (concat_lh__d1 t_7))
    | `LH_N -> 
      (`LH_N));;
let rec map_lh__d1_d0 f_8 ls_7 =
  (match ls_7 with
    | `LH_C(h_8, t_8) -> 
      (`LH_C((f_8 h_8), ((map_lh__d1_d0 f_8) t_8)))
    | `LH_N -> 
      (`LH_N));;
  ...
  ((fun _lh_funcomp_x_5 -> 
    ((fun _lh_funcomp_x_6 -> 
      ((fun _lh_funcomp_x_7 -> 
        ((fun _lh_funcomp_x_8 -> 
          ((fun _lh_funcomp_x_9 -> 
            ((map_lh__d4 fst_lh__d2) ((filter_lh__d1 (fun _lh_funcomp_x_1_0 -> 
              (knownSolution_lh__d1 (snd_lh__d2 _lh_funcomp_x_1_0)))) _lh_funcomp_x_9))) (leaves_lh__d1 _lh_funcomp_x_8))) ((prune_lh__d1 (fun _lh_funcomp_x_1_1 -> 
          (knownConflict_lh__d1 (snd_lh__d1 _lh_funcomp_x_1_1)))) _lh_funcomp_x_7))) ((_lh_search_arg1_0 _lh_search_arg2_0) _lh_funcomp_x_6))) (mkTree_lh__d1 _lh_funcomp_x_5))) _lh_search_arg2_0);;
...
let rec union_lh__d1 _lh_union_arg1_1 _lh_union_arg2_1 =
  (((unionBy_lh__d1 (fun a_4 b_3 -> 
    (a_4 = b_3))) _lh_union_arg1_1) _lh_union_arg2_1);;
...
let rec map_lh__d1_d1 f_6 ls_6 =
  (match ls_6 with
    | `LH_C(h_6, t_6) -> 
      (`LH_C((f_6 h_6), ((map_lh__d1_d1 f_6) t_6)))
    | `LH_N -> 
      (`LH_N));;
let rec foldTree_lh__d1 _lh_foldTree_arg1_1 _lh_foldTree_arg2_1 =
  (match _lh_foldTree_arg2_1 with
    | `Node(_lh_foldTree_Node_0_1, _lh_foldTree_Node_1_1) -> 
      ((_lh_foldTree_arg1_1 _lh_foldTree_Node_0_1) ((map_lh__d1_d1 (foldTree_lh__d1 _lh_foldTree_arg1_1)) _lh_foldTree_Node_1_1)));;
let rec map_lh__d5 f_1_7 ls_1_8 =
  (match ls_1_8 with
    | `LH_C(h_1_8, t_1_8) -> 
      (`LH_C((f_1_7 h_1_8), ((map_lh__d5 f_1_7) t_1_8)))
    | `LH_N -> 
      (`LH_N));;
  ...
  (let rec f_2_8 = (fun _lh_f_arg1_3 _lh_f_arg2_2 -> 
    (match _lh_f_arg1_3 with
      | `LH_P2(_lh_f_LH_P2_0_4, _lh_f_LH_P2_1_4) -> 
        (match _lh_f_LH_P2_1_4 with
          | `Known(_lh_f_Known_0_1) -> 
            (`Node((`LH_P2(_lh_f_LH_P2_0_4, (`Known(_lh_f_Known_0_1)))), _lh_f_arg2_2))
          | `Unknown -> 
            (`Node((`LH_P2(_lh_f_LH_P2_0_4, (`Known(((combine_lh__d1 ((map_lh__d5 label_lh__d1) _lh_f_arg2_2)) (`LH_N)))))), _lh_f_arg2_2))))) in
    (foldTree_lh__d1 f_2_8));;
    ...
    | `CSP(_lh_earliestInconsistency_CSP_0_1, _lh_earliestInconsistency_CSP_1_1, _lh_earliestInconsistency_CSP_2_1) -> 
      (match _lh_earliestInconsistency_arg2_1 with
        ...
        | `LH_C(_lh_earliestInconsistency_LH_C_0_2, _lh_earliestInconsistency_LH_C_1_2) -> 
          (let rec _lh_matchIdent_2 = ((filter_lh__d3 (fun _lh_funcomp_x_2 -> 
            (not ((_lh_earliestInconsistency_CSP_2_1 _lh_earliestInconsistency_LH_C_0_2) _lh_funcomp_x_2)))) (reverse_lh__d2 _lh_earliestInconsistency_LH_C_1_2)) in
            (match _lh_matchIdent_2 with
              | `LH_N -> 
                (`Nothing)
              | `LH_C(_lh_earliestInconsistency_LH_C_0_3, _lh_earliestInconsistency_LH_C_1_3) -> 
                (`Just((`LH_P2((level_lh__d4 _lh_earliestInconsistency_LH_C_0_2), (level_lh__d3 _lh_earliestInconsistency_LH_C_0_3)))))))));;
...
let rec checkComplete_lh__d3 _lh_checkComplete_arg1_2 _lh_checkComplete_arg2_2 =
  (if ((complete_lh__d3 _lh_checkComplete_arg1_2) _lh_checkComplete_arg2_2) then
    ...
    (`Unknown));;
let rec map_lh__d1_d2 f_5 ls_5 =
  (match ls_5 with
    | `LH_C(h_5, t_5) -> 
      (`LH_C((f_5 h_5), ((map_lh__d1_d2 f_5) t_5)))
    | `LH_N -> 
      (`LH_N));;
let rec mapTree_lh__d4 _lh_mapTree_arg1_3 _lh_mapTree_arg2_3 =
  (match _lh_mapTree_arg2_3 with
    | `Node(_lh_mapTree_Node_0_3, _lh_mapTree_Node_1_3) -> 
      (`Node((_lh_mapTree_arg1_3 _lh_mapTree_Node_0_3), ((map_lh__d1_d2 (mapTree_lh__d4 _lh_mapTree_arg1_3)) _lh_mapTree_Node_1_3))));;
let rec bt_lh__d2 _lh_bt_arg1_1 =
  (let rec f_2_7 = (fun s_1 -> 
    ...
    (mapTree_lh__d4 f_2_7));;
let rec bjbt_lh__d1 _lh_bjbt_arg1_0 _lh_funcomp_x_1_5 =
  ((bj_lh__d1 _lh_bjbt_arg1_0) ((bt_lh__d2 _lh_bjbt_arg1_0) _lh_funcomp_x_1_5));;
...
let rec knownConflict_lh__d3 _lh_knownConflict_arg1_0 =
  (match _lh_knownConflict_arg1_0 with
    ...
    | _ -> 
      false);;
let rec map_lh__d8 f_1_2 ls_9 =
  (match ls_9 with
    | `LH_C(h_1_0, t_1_0) -> 
      (`LH_C((f_1_2 h_1_0), ((map_lh__d8 f_1_2) t_1_0)))
    | `LH_N -> 
      (`LH_N));;
let rec bj'_lh__d1 _lh_bj'_arg1_0 =
  (let rec f_2_3 = (fun _lh_f_arg1_0 _lh_f_arg2_0 -> 
          ...
          | `Unknown -> 
            (let rec cs'_0 = (`Known(((combine_lh__d2 ((map_lh__d8 label_lh__d2) _lh_f_arg2_0)) (`LH_N)))) in
              (if (knownConflict_lh__d3 cs'_0) then
                ...
                (`Node((`LH_P2(_lh_f_LH_P2_0_0, cs'_0)), _lh_f_arg2_0))))))) in
    (foldTree_lh__d2 f_2_3));;
...
let rec mapTree_lh__d7 _lh_mapTree_arg1_0 _lh_mapTree_arg2_0 =
  (match _lh_mapTree_arg2_0 with
    | `Node(_lh_mapTree_Node_0_0, _lh_mapTree_Node_1_0) -> 
      (`Node((_lh_mapTree_arg1_0 _lh_mapTree_Node_0_0), ((map_lh__d1_d3 (mapTree_lh__d7 _lh_mapTree_arg1_0)) _lh_mapTree_Node_1_0))));;
...
let rec map_lh__d9 f_9 ls_8 =
  (match ls_8 with
    | `LH_C(h_9, t_9) -> 
      (`LH_C((f_9 h_9), ((map_lh__d9 f_9) t_9)))
    | `LH_N -> 
      (`LH_N));;
...
let rec head_lh__d1 ls_2_2 =
  (match ls_2_2 with
    ...
    | `LH_N -> 
      (failwith "lh_default_error"));;
let rec atIndex_lh__d1 n_1 ls_2_1 =
  (if (n_1 < 0) then
    (failwith "lh_default_error")
  else
    (match ls_2_1 with
...
let rec lookupCache_lh__d1 _lh_lookupCache_arg1_1 _lh_lookupCache_arg2_1 =
  (let rec f_2_9 = (fun _lh_f_arg1_4 _lh_f_arg2_3 -> 
    ...
    ((mapTree_lh__d3 (f_2_9 _lh_lookupCache_arg1_1)) _lh_lookupCache_arg2_1));;
let rec tail_lh__d1 ls_2_5 =
  (match ls_2_5 with
    | `LH_C(h_2_5, t_2_5) -> 
      t_2_5
    | `LH_N -> 
...
let rec zipWith_lh__d2 f_1_0 xs_3 ys_3 =
  (match xs_3 with
    ...
    | `LH_N -> 
      (`LH_N));;
let rec enumFromTo_lh__d6 a_7 b_5 =
  (if (a_7 <= b_5) then
    (`LH_C(a_7, ((enumFromTo_lh__d6 (a_7 + 1)) b_5)))
  else
    (`LH_N));;
let rec enumFromTo_lh__d5 a_8 b_6 =
  (if (a_8 <= b_6) then
    (`LH_C(a_8, ((enumFromTo_lh__d5 (a_8 + 1)) b_6)))
  else
    (`LH_N));;
        ...
        | `Assign(_lh_fillTable_Assign_0_1, _lh_fillTable_Assign_1_1) -> 
          (match _lh_fillTable_arg2_1 with
            | `CSP(_lh_fillTable_CSP_0_1, _lh_fillTable_CSP_1_1, _lh_fillTable_CSP_2_1) -> 
              (let rec f_2_2 = (fun cs_2 varval_1 -> 
                  ...
                  (match _lh_matchIdent_3 with
                    | `LH_P2(_lh_fillTable_LH_P2_0_1, _lh_fillTable_LH_P2_1_1) -> 
                      (if ((cs_2 = (`Unknown)) && (not ((_lh_fillTable_CSP_2_1 (`Assign(_lh_fillTable_Assign_0_1, _lh_fillTable_Assign_1_1))) (`Assign(_lh_fillTable_LH_P2_0_1, _lh_fillTable_LH_P2_1_1))))) then
                        ...
                        cs_2)))) in
                (((zipWith_lh__d1 (zipWith_lh__d2 f_2_2)) _lh_fillTable_arg3_1) (let rec _lh_listcomp_fun_3 = (fun _lh_listcomp_fun_para_3 -> 
...
let rec map_lh__d2 f_2_1 ls_2_4 =
  (match ls_2_4 with
    | `LH_C(h_2_4, t_2_4) -> 
      (`LH_C((f_2_1 h_2_4), ((map_lh__d2 f_2_1) t_2_4)))
    | `LH_N -> 
      (`LH_N));;
let rec cacheChecks_lh__d1 _lh_cacheChecks_arg1_1 _lh_cacheChecks_arg2_1 _lh_cacheChecks_arg3_1 =
  (match _lh_cacheChecks_arg3_1 with
    | `Node(_lh_cacheChecks_Node_0_1, _lh_cacheChecks_Node_1_1) -> 
      (`Node((`LH_P2(_lh_cacheChecks_Node_0_1, _lh_cacheChecks_arg2_1)), ((map_lh__d2 ((cacheChecks_lh__d1 _lh_cacheChecks_arg1_1) (((fillTable_lh__d1 _lh_cacheChecks_Node_0_1) _lh_cacheChecks_arg1_1) (tail_lh__d1 _lh_cacheChecks_arg2_1)))) _lh_cacheChecks_Node_1_1))));;
...
let rec map_lh__d3 f_2_0 ls_2_3 =
  (match ls_2_3 with
    | `LH_C(h_2_3, t_2_3) -> 
      (`LH_C((f_2_0 h_2_3), ((map_lh__d3 f_2_0) t_2_3)))
    | `LH_N -> 
      (`LH_N));;
let rec mapTree_lh__d1 _lh_mapTree_arg1_6 _lh_mapTree_arg2_6 =
  (match _lh_mapTree_arg2_6 with
    | `Node(_lh_mapTree_Node_0_6, _lh_mapTree_Node_1_6) -> 
      (`Node((_lh_mapTree_arg1_6 _lh_mapTree_Node_0_6), ((map_lh__d3 (mapTree_lh__d1 _lh_mapTree_arg1_6)) _lh_mapTree_Node_1_6))));;
let rec bm_lh__d1 _lh_bm_arg1_0 _lh_funcomp_x_1_6 =
  ((fun _lh_funcomp_x_1_7 -> 
    ((mapTree_lh__d1 fst_lh__d1) ((lookupCache_lh__d1 _lh_bm_arg1_0) _lh_funcomp_x_1_7))) (((cacheChecks_lh__d1 _lh_bm_arg1_0) (emptyTable_lh__d1 _lh_bm_arg1_0)) _lh_funcomp_x_1_6));;
