...
let rec map_lh__d6 f_1_6 ls_9 =
  (match ls_9 with
    | `LH_C(h_8, t_8) -> 
      (`LH_C((f_1_6 h_8), ((map_lh__d6 f_1_6) t_8)))
    | `LH_N -> 
      (`LH_N));;
let rec mapTree_lh__d2 _lh_mapTree_arg1_7 _lh_mapTree_arg2_5 =
  (match _lh_mapTree_arg2_5 with
    | `Node(_lh_mapTree_Node_0_6, _lh_mapTree_Node_1_6) -> 
      (`Node((_lh_mapTree_arg1_7 _lh_mapTree_Node_0_6), ((map_lh__d6 (mapTree_lh__d2 _lh_mapTree_arg1_7)) _lh_mapTree_Node_1_6))));;
...
let rec reverse_helper_lh__d1 ls_6 a_4 =
  (match ls_6 with
    | `LH_C(h_5, t_5) -> 
      ((reverse_helper_lh__d1 t_5) (`LH_C(h_5, a_4)))
    | `LH_N -> 
      a_4);;
let rec reverse_lh__d1 ls_2_1 =
  ((reverse_helper_lh__d1 ls_2_1) (`LH_N));;
let rec filter_lh__d2 f_5_0 ls_2_3 =
  (match ls_2_3 with
    | `LH_C(h_2_8, t_2_8) -> 
      (if (f_5_0 h_2_8) then
        (`LH_C(h_2_8, ((filter_lh__d2 f_5_0) t_2_8)))
      else
        ((filter_lh__d2 f_5_0) t_2_8))
    | `LH_N -> 
      (`LH_N));;
...
let rec earliestInconsistency_lh__d1 _lh_earliestInconsistency_arg1_2 _lh_earliestInconsistency_arg2_2 _lh_floatOutId_0_1_5 _lh_floatOutId_1_1_2 =
  (match _lh_earliestInconsistency_arg1_2 with
    | `CSP(_lh_earliestInconsistency_CSP_0_2, _lh_earliestInconsistency_CSP_1_2, _lh_earliestInconsistency_CSP_2_2) -> 
      (match _lh_earliestInconsistency_arg2_2 with
        | `LH_N -> 
          ((checkComplete_lh__d1 _lh_floatOutId_0_1_5) _lh_floatOutId_1_1_2)
        | `LH_C(_lh_earliestInconsistency_LH_C_0_4, _lh_earliestInconsistency_LH_C_1_4) -> 
          (let rec _lh_matchIdent_6 = ((filter_lh__d2 (fun _lh_funcomp_x_7 -> 
            ...
            (match _lh_matchIdent_6 with
              ...
              | `LH_C(_lh_earliestInconsistency_LH_C_0_5, _lh_earliestInconsistency_LH_C_1_5) -> 
                (let rec _lh_bt_Just_0_2 = (let rec _lh_bt_LH_P2_1_2 = (level_lh__d1 _lh_earliestInconsistency_LH_C_0_5) in
                  (let rec _lh_bt_LH_P2_0_2 = (level_lh__d2 _lh_earliestInconsistency_LH_C_0_4) in
                    (fun _lh_dummy_2 -> 
                      (`Known((`LH_C(_lh_bt_LH_P2_0_2, (`LH_C(_lh_bt_LH_P2_1_2, (`LH_N)))))))))) in
                  (_lh_bt_Just_0_2 99))))));;
let rec bt_lh__d1 _lh_bt_arg1_5 =
  (let rec f_1_5 = (fun s_5 -> 
    ...
    (mapTree_lh__d2 f_1_5));;
let rec map_lh__d1 f_3_3 ls_1_3 =
  (ls_1_3 f_3_3);;
...
let rec knownConflict_lh__d2 _lh_knownConflict_arg1_1 =
  (match _lh_knownConflict_arg1_1 with
    ...
    | _ -> 
      false);;
let rec map_lh__d1_d3 f_1_1 ls_7 =
  (match ls_7 with
    | `LH_C(h_6, t_6) -> 
      (`LH_C((f_1_1 h_6), ((map_lh__d1_d3 f_1_1) t_6)))
    | `LH_N -> 
      (`LH_N));;
let rec mapTree_lh__d5 _lh_mapTree_arg1_1 _lh_mapTree_arg2_1 =
  (match _lh_mapTree_arg2_1 with
    | `Node(_lh_mapTree_Node_0_1, _lh_mapTree_Node_1_1) -> 
      (`Node((_lh_mapTree_arg1_1 _lh_mapTree_Node_0_1), ((map_lh__d1_d3 (mapTree_lh__d5 _lh_mapTree_arg1_1)) _lh_mapTree_Node_1_1))));;
...
let rec foldl_lh__d1 f_5 i_0 ls_2 =
  (match ls_2 with
    | `LH_C(h_1, t_1) -> 
      (((foldl_lh__d1 f_5) ((f_5 i_0) h_1)) t_1)
    | `LH_N -> 
      i_0);;
let rec mappend_lh__d1 xs_0 ys_0 =
  (match xs_0 with
    | `LH_C(h_3, t_3) -> 
      (`LH_C(h_3, ((mappend_lh__d1 t_3) ys_0)))
    | `LH_N -> 
      ys_0);;
          ...
          | `LH_P2(_lh_f_LH_P2_0_0, _lh_f_LH_P2_1_0) -> 
            (match _lh_f_LH_P2_0_0 with
              | `LH_P2(_lh_f_LH_P2_0_1, _lh_f_LH_P2_1_1) -> 
                (let rec wipedDomains_0 = (let rec _lh_listcomp_fun_0 = (fun _lh_listcomp_fun_para_0 -> 
                  (match _lh_listcomp_fun_para_0 with
                    | `LH_C(_lh_listcomp_fun_ls_h_0, _lh_listcomp_fun_ls_t_0) -> 
                      (if ((all_lh__d1 knownConflict_lh__d2) _lh_listcomp_fun_ls_h_0) then
                        (`LH_C(_lh_listcomp_fun_ls_h_0, (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_0)))
                      else
                        (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_0))
                    | `LH_N -> 
                      (`LH_N))) in
                  (_lh_listcomp_fun_0 _lh_f_LH_P2_1_0)) in
                  (let rec cs'_0 = (if (null_lh__d1 wipedDomains_0) then
                    _lh_f_LH_P2_1_1
                  else
                    (`Known((collect_lh__d1 (head_lh__d2 wipedDomains_0))))) in
                    (`LH_P2(_lh_f_LH_P2_0_1, cs'_0))))))) in
...
let rec mapTree_lh__d6 _lh_mapTree_arg1_0 _lh_mapTree_arg2_0 =
  (match _lh_mapTree_arg2_0 with
    | `Node(_lh_mapTree_Node_0_0, _lh_mapTree_Node_1_0) -> 
      (`Node((_lh_mapTree_arg1_0 _lh_mapTree_Node_0_0), ((map_lh__d1_d3 (mapTree_lh__d6 _lh_mapTree_arg1_0)) _lh_mapTree_Node_1_0))));;
...
let rec head_lh__d3 ls_1_8 =
  (match ls_1_8 with
    | `LH_C(h_2_4, t_2_4) -> 
      h_2_4
    | `LH_N -> 
      (failwith "lh_default_error"));;
let rec atIndex_lh__d2 n_0 ls_2_4 =
  (if (n_0 < 0) then
    (failwith "lh_default_error")
  else
    (match ls_2_4 with
      | `LH_C(h_2_9, t_2_9) -> 
        (if (n_0 = 0) then
          ...
          ((atIndex_lh__d2 (n_0 - 1)) t_2_9))
      | `LH_N -> 
        (failwith "lh_default_error")));;
let rec lookupCache_lh__d2 _lh_lookupCache_arg1_1 _lh_lookupCache_arg2_1 =
  (let rec f_5_2 = (fun _lh_f_arg1_5 _lh_f_arg2_7 -> 
    (match _lh_f_arg2_7 with
      | `LH_P2(_lh_f_LH_P2_0_8, _lh_f_LH_P2_1_5) -> 
        (match _lh_f_LH_P2_0_8 with
          | `LH_N -> 
            (`LH_P2((`LH_P2((`LH_N), (`Unknown))), _lh_f_LH_P2_1_5))
          | `LH_C(_lh_f_LH_C_0_1, _lh_f_LH_C_1_1) -> 
            (let rec tableEntry_1 = ((atIndex_lh__d2 ((value_lh__d2 _lh_f_LH_C_0_1) - 1)) (head_lh__d3 _lh_f_LH_P2_1_5)) in
              (let rec cs_6 = (if (tableEntry_1 = (`Unknown)) then
                ((checkComplete_lh__d4 _lh_f_arg1_5) (`LH_C(_lh_f_LH_C_0_1, _lh_f_LH_C_1_1)))
              else
                tableEntry_1) in
                (`LH_P2((`LH_P2((`LH_C(_lh_f_LH_C_0_1, _lh_f_LH_C_1_1)), cs_6)), _lh_f_LH_P2_1_5))))))) in
    ((mapTree_lh__d6 (f_5_2 _lh_lookupCache_arg1_1)) _lh_lookupCache_arg2_1));;
let rec enumFromTo_lh__d4 a_2 b_1 _lh_floatOutId_0_3 =
  (if (a_2 <= b_1) then
    (let rec _lh_listcomp_fun_ls_t_1 = ((enumFromTo_lh__d4 (a_2 + 1)) b_1) in
      (let rec _lh_listcomp_fun_ls_h_1 = a_2 in
        (`LH_C((`Unknown), (_lh_floatOutId_0_3 _lh_listcomp_fun_ls_t_1)))))
  else
    (`LH_N));;
let rec enumFromTo_lh__d3 a_1_0 b_8 _lh_floatOutId_0_2_1 _lh_floatOutId_1_1_6 =
  (if (a_1_0 <= b_8) then
    (let rec _lh_listcomp_fun_ls_t_8 = ((enumFromTo_lh__d3 (a_1_0 + 1)) b_8) in
      (let rec _lh_listcomp_fun_ls_h_1_0 = a_1_0 in
        (`LH_C((let rec _lh_listcomp_fun_2_2 = (fun _lh_listcomp_fun_para_7 -> 
          (_lh_listcomp_fun_para_7 _lh_listcomp_fun_2_2)) in
          (_lh_listcomp_fun_2_2 ((enumFromTo_lh__d4 1) _lh_floatOutId_0_2_1))), (_lh_floatOutId_1_1_6 _lh_listcomp_fun_ls_t_8)))))
  else
    (`LH_N));;
let rec emptyTable_lh__d2 _lh_emptyTable_arg1_0 =
  (match _lh_emptyTable_arg1_0 with
    | `CSP(_lh_emptyTable_CSP_0_0, _lh_emptyTable_CSP_1_0, _lh_emptyTable_CSP_2_0) -> 
      (`LH_C((`LH_N), (let rec _lh_listcomp_fun_1_3 = (fun _lh_listcomp_fun_para_5 -> 
        ((_lh_listcomp_fun_para_5 _lh_emptyTable_CSP_1_0) _lh_listcomp_fun_1_3)) in
        (_lh_listcomp_fun_1_3 ((enumFromTo_lh__d3 1) _lh_emptyTable_CSP_0_0))))));;
let rec zipWith_lh__d4 f_5_1 xs_4 ys_4 =
  (match xs_4 with
    | `LH_C(hx_1_1, tx_1_1) -> 
      (((ys_4 f_5_1) hx_1_1) tx_1_1)
    | `LH_N -> 
      (`LH_N));;
let rec enumFromTo_lh__d8 a_1_1 b_9 _lh_floatOutId_0_2_3 _lh_floatOutId_1_1_8 _lh_floatOutId_2_3 _lh_floatOutId_3_3 _lh_floatOutId_4_3 =
  (if (a_1_1 <= b_9) then
    (let rec _lh_listcomp_fun_ls_t_9 = ((enumFromTo_lh__d8 (a_1_1 + 1)) b_9) in
      (let rec _lh_listcomp_fun_ls_h_1_1 = a_1_1 in
        (let rec ty_3 = (_lh_floatOutId_1_1_8 _lh_listcomp_fun_ls_t_9) in
          (let rec hy_3 = (let rec _lh_fillTable_LH_P2_1_1 = _lh_listcomp_fun_ls_h_1_1 in
            (let rec _lh_fillTable_LH_P2_0_1 = _lh_floatOutId_0_2_3 in
              (fun _lh_fillTable_Assign_0_2 _lh_fillTable_Assign_1_2 _lh_fillTable_CSP_2_2 cs_4 -> 
                (if ((cs_4 = (`Unknown)) && (not ((_lh_fillTable_CSP_2_2 (`Assign(_lh_fillTable_Assign_0_2, _lh_fillTable_Assign_1_2))) (`Assign(_lh_fillTable_LH_P2_0_1, _lh_fillTable_LH_P2_1_1))))) then
                  ...
                  cs_4)))) in
            (`LH_C(((_lh_floatOutId_2_3 _lh_floatOutId_3_3) hy_3), (((zipWith_lh__d4 _lh_floatOutId_2_3) _lh_floatOutId_4_3) ty_3)))))))
  else
    (`LH_N));;
let rec zipWith_lh__d3 f_4_5 xs_3 ys_3 =
  (match xs_3 with
    | `LH_C(hx_8, tx_8) -> 
      (((ys_3 f_4_5) hx_8) tx_8)
    | `LH_N -> 
      (`LH_N));;
let rec enumFromTo_lh__d9 a_6 b_4 _lh_floatOutId_0_1_1 _lh_floatOutId_1_8 _lh_floatOutId_2_1 _lh_floatOutId_3_1 _lh_floatOutId_4_1 =
  (if (a_6 <= b_4) then
    (let rec _lh_listcomp_fun_ls_t_4 = ((enumFromTo_lh__d9 (a_6 + 1)) b_4) in
      (let rec _lh_listcomp_fun_ls_h_4 = a_6 in
        (let rec ty_1 = (_lh_floatOutId_1_8 _lh_listcomp_fun_ls_t_4) in
          (let rec hy_1 = (let rec _lh_listcomp_fun_1_1 = (fun _lh_listcomp_fun_para_4 -> 
            ((_lh_listcomp_fun_para_4 _lh_listcomp_fun_ls_h_4) _lh_listcomp_fun_1_1)) in
            (_lh_listcomp_fun_1_1 ((enumFromTo_lh__d8 1) _lh_floatOutId_0_1_1))) in
            (`LH_C(((_lh_floatOutId_2_1 _lh_floatOutId_3_1) hy_1), (((zipWith_lh__d3 _lh_floatOutId_2_1) _lh_floatOutId_4_1) ty_1)))))))
  else
    (`LH_N));;
        ...
        | `Assign(_lh_fillTable_Assign_0_3, _lh_fillTable_Assign_1_3) -> 
          (match _lh_fillTable_arg2_1 with
            | `CSP(_lh_fillTable_CSP_0_1, _lh_fillTable_CSP_1_5, _lh_fillTable_CSP_2_3) -> 
              (let rec f_4_8 = (fun cs_5 varval_1 -> 
                ...
                (((zipWith_lh__d3 (zipWith_lh__d4 f_4_8)) _lh_fillTable_arg3_1) (let rec _lh_listcomp_fun_2_7 = (fun _lh_listcomp_fun_para_9 -> 
                  ((_lh_listcomp_fun_para_9 _lh_fillTable_CSP_1_5) _lh_listcomp_fun_2_7)) in
                  (_lh_listcomp_fun_2_7 ((enumFromTo_lh__d9 (_lh_fillTable_Assign_0_3 + 1)) _lh_fillTable_CSP_0_1))))))));;
let rec map_lh__d7 f_6 ls_3 =
  (match ls_3 with
    | `LH_C(h_2, t_2) -> 
      (`LH_C((f_6 h_2), ((map_lh__d7 f_6) t_2)))
    | `LH_N -> 
      (`LH_N));;
...
let rec cacheChecks_lh__d2 _lh_cacheChecks_arg1_0 _lh_cacheChecks_arg2_0 _lh_cacheChecks_arg3_0 =
  (match _lh_cacheChecks_arg3_0 with
    | `Node(_lh_cacheChecks_Node_0_0, _lh_cacheChecks_Node_1_0) -> 
      (`Node((`LH_P2(_lh_cacheChecks_Node_0_0, _lh_cacheChecks_arg2_0)), ((map_lh__d7 ((cacheChecks_lh__d2 _lh_cacheChecks_arg1_0) (((fillTable_lh__d2 _lh_cacheChecks_Node_0_0) _lh_cacheChecks_arg1_0) (tail_lh__d2 _lh_cacheChecks_arg2_0)))) _lh_cacheChecks_Node_1_0))));;
...
let rec foldTree_lh__d2 _lh_foldTree_arg1_1 _lh_foldTree_arg2_1 =
  (match _lh_foldTree_arg2_1 with
    | `Node(_lh_foldTree_Node_0_0, _lh_foldTree_Node_1_0) -> 
      ((_lh_foldTree_arg1_1 _lh_foldTree_Node_0_0) ((map_lh__d1_d3 (foldTree_lh__d2 _lh_foldTree_arg1_1)) _lh_foldTree_Node_1_0)));;
...
let rec enumFromTo_lh__d7 a_8 b_6 _lh_floatOutId_0_1_7 _lh_floatOutId_1_1_4 =
  (if (a_8 <= b_6) then
    (let rec _lh_listcomp_fun_ls_t_6 = ((enumFromTo_lh__d7 (a_8 + 1)) b_6) in
      (let rec _lh_listcomp_fun_ls_h_6 = a_8 in
        (`LH_C((`LH_C((`Assign(((maxLevel_lh__d1 _lh_floatOutId_1_1_4) + 1), _lh_listcomp_fun_ls_h_6)), _lh_floatOutId_1_1_4)), (_lh_floatOutId_0_1_7 _lh_listcomp_fun_ls_t_6)))))
  else
    (`LH_N));;
...
let rec initTree_lh__d1 _lh_initTree_arg1_0 _lh_initTree_arg2_0 =
  (`Node(_lh_initTree_arg2_0, ((map_lh__d1_d3 (initTree_lh__d1 _lh_initTree_arg1_0)) (_lh_initTree_arg1_0 _lh_initTree_arg2_0))));;
  ...
  (match _lh_mkTree_arg1_0 with
    | `CSP(_lh_mkTree_CSP_0_0, _lh_mkTree_CSP_1_0, _lh_mkTree_CSP_2_0) -> 
      (let rec next_0 = (fun ss_0 -> 
        (if ((maxLevel_lh__d2 ss_0) < _lh_mkTree_CSP_0_0) then
          (let rec _lh_listcomp_fun_7 = (fun _lh_listcomp_fun_para_3 -> 
            ((_lh_listcomp_fun_para_3 _lh_listcomp_fun_7) ss_0)) in
            (_lh_listcomp_fun_7 ((enumFromTo_lh__d7 1) _lh_mkTree_CSP_1_0)))
        else
          (`LH_N))) in
...
let rec length_lh__d1 ls_1_5 =
  (ls_1_5 99);;
let rec map_lh__d4 f_4_4 ls_1_9 =
  (ls_1_9 f_4_4);;
let rec filter_lh__d1 f_4_1 ls_1_7 =
  (match ls_1_7 with
    | `LH_C(h_2_1, t_2_1) -> 
      (if (f_4_1 h_2_1) then
        (let rec t_2_2 = ((filter_lh__d1 f_4_1) t_2_1) in
          (let rec h_2_2 = h_2_1 in
            (fun f_4_2 -> 
              (let rec t_2_3 = ((map_lh__d4 f_4_2) t_2_2) in
                (let rec h_2_3 = (f_4_2 h_2_2) in
                  (fun _lh_dummy_3 -> 
                    (1 + (length_lh__d1 t_2_3))))))))
      else
        ((filter_lh__d1 f_4_1) t_2_1))
    | `LH_N -> 
      (fun f_4_3 _lh_dummy_4 -> 
        0));;
let rec concat_lh__d1 lss_0 =
  (lss_0 99);;
let rec map_lh__d1_d0 f_4_9 ls_2_2 _lh_floatOutId_0_2_4 =
  (match ls_2_2 with
    | `LH_C(h_2_6, t_2_6) -> 
      (let rec t_2_7 = ((map_lh__d1_d0 f_4_9) t_2_6) in
        (let rec h_2_7 = (f_4_9 h_2_6) in
          ((mappend_lh__d1 h_2_7) (concat_lh__d1 t_2_7))))
    | `LH_N -> 
      (`LH_N));;
  ...
  (match _lh_leaves_arg1_0 with
    | `Node(_lh_leaves_Node_0_0, _lh_leaves_Node_1_0) -> 
      (match _lh_leaves_Node_1_0 with
        ...
        | _ -> 
          (concat_lh__d1 ((map_lh__d1_d0 leaves_lh__d1) _lh_leaves_Node_1_0))));;
      ...
      ((fun _lh_funcomp_x_1_2 -> 
        ((fun _lh_funcomp_x_1_3 -> 
          ((fun _lh_funcomp_x_1_4 -> 
            ((map_lh__d4 fst_lh__d2) ((filter_lh__d1 (fun _lh_funcomp_x_1_5 -> 
              (knownSolution_lh__d1 (snd_lh__d2 _lh_funcomp_x_1_5)))) _lh_funcomp_x_1_4))) (leaves_lh__d1 _lh_funcomp_x_1_3))) ((prune_lh__d1 (fun _lh_funcomp_x_1_6 -> 
          (knownConflict_lh__d1 (snd_lh__d1 _lh_funcomp_x_1_6)))) _lh_funcomp_x_1_2))) ((_lh_search_arg1_0 _lh_search_arg2_0) _lh_funcomp_x_1_1))) (mkTree_lh__d1 _lh_funcomp_x_1_0))) _lh_search_arg2_0);;
...
let rec map_lh__d5 f_3_7 ls_1_4 _lh_floatOutId_0_1_9 =
  (match ls_1_4 with
    | `LH_C(h_2_0, t_2_0) -> 
      (let rec _lh_combine_LH_C_1_0 = ((map_lh__d5 f_3_7) t_2_0) in
        (let rec _lh_combine_LH_C_0_0 = (f_3_7 h_2_0) in
            ...
            | `LH_P2(_lh_combine_LH_P2_0_0, _lh_combine_LH_P2_1_0) -> 
              (match _lh_combine_LH_P2_1_0 with
                | `Known(_lh_combine_Known_0_0) -> 
                  (if ((notElem_lh__d1 (maxLevel_lh__d3 _lh_combine_LH_P2_0_0)) _lh_combine_Known_0_0) then
                    _lh_combine_Known_0_0
                  else
                    ((combine_lh__d1 _lh_combine_LH_C_1_0) ((union_lh__d1 _lh_combine_Known_0_0) _lh_floatOutId_0_1_9)))))))
    | `LH_N -> 
      _lh_floatOutId_0_1_9);;
let rec label_lh__d1 _lh_label_arg1_1 =
  (match _lh_label_arg1_1 with
    | `Node(_lh_label_Node_0_1, _lh_label_Node_1_1) -> 
      _lh_label_Node_0_1);;
let rec checkComplete_lh__d3 _lh_checkComplete_arg1_0 _lh_checkComplete_arg2_0 _lh_floatOutId_0_5 _lh_floatOutId_1_4 =
  (if ((complete_lh__d3 _lh_checkComplete_arg1_0) _lh_checkComplete_arg2_0) then
    (let rec _lh_f_Known_0_1 = (`LH_N) in
      (`Node((`LH_P2(_lh_floatOutId_0_5, (`Known(_lh_f_Known_0_1)))), _lh_floatOutId_1_4)))
  else
    (`Node((`LH_P2(_lh_floatOutId_0_5, (`Known(((combine_lh__d1 ((map_lh__d5 label_lh__d1) _lh_floatOutId_1_4)) (`LH_N)))))), _lh_floatOutId_1_4)));;
...
let rec reverse_lh__d2 ls_2_5 =
  ((reverse_helper_lh__d1 ls_2_5) (`LH_N));;
let rec earliestInconsistency_lh__d2 _lh_earliestInconsistency_arg1_0 _lh_earliestInconsistency_arg2_0 _lh_floatOutId_0_2 _lh_floatOutId_1_2 =
  (match _lh_earliestInconsistency_arg1_0 with
    | `CSP(_lh_earliestInconsistency_CSP_0_0, _lh_earliestInconsistency_CSP_1_0, _lh_earliestInconsistency_CSP_2_0) -> 
      (match _lh_earliestInconsistency_arg2_0 with
        | `LH_N -> 
          ((checkComplete_lh__d3 _lh_floatOutId_0_2) _lh_floatOutId_1_2)
          ...
          (let rec _lh_matchIdent_1 = ((filter_lh__d3 (fun _lh_funcomp_x_2 -> 
            ...
            (match _lh_matchIdent_1 with
              ...
              | `LH_C(_lh_earliestInconsistency_LH_C_0_1, _lh_earliestInconsistency_LH_C_1_1) -> 
                (let rec _lh_bt_Just_0_0 = (let rec _lh_bt_LH_P2_1_0 = (level_lh__d3 _lh_earliestInconsistency_LH_C_0_1) in
                  (let rec _lh_bt_LH_P2_0_0 = (level_lh__d4 _lh_earliestInconsistency_LH_C_0_0) in
                    (fun _lh_dummy_0 -> 
                      (let rec _lh_f_Known_0_0 = (`LH_C(_lh_bt_LH_P2_0_0, (`LH_C(_lh_bt_LH_P2_1_0, (`LH_N))))) in
                        (fun _lh_f_LH_P2_0_2 _lh_f_arg2_0 -> 
                          (`Node((`LH_P2(_lh_f_LH_P2_0_2, (`Known(_lh_f_Known_0_0)))), _lh_f_arg2_0))))))) in
                  (_lh_bt_Just_0_0 99))))));;
let rec map_lh__d1_d1 f_7 ls_5 =
  (ls_5 f_7);;
let rec map_lh__d1_d2 f_1_7 ls_1_0 _lh_floatOutId_0_1_0 =
  (match ls_1_0 with
    | `LH_C(h_9, t_9) -> 
      (let rec t_1_0 = ((map_lh__d1_d2 f_1_7) t_9) in
        (let rec h_1_0 = (f_1_7 h_9) in
          (`LH_C((_lh_floatOutId_0_1_0 h_1_0), ((map_lh__d1_d1 _lh_floatOutId_0_1_0) t_1_0)))))
    | `LH_N -> 
      (`LH_N));;
let rec foldTree_lh__d1 _lh_foldTree_arg1_0 _lh_foldTree_arg2_0 =
  (_lh_foldTree_arg2_0 _lh_foldTree_arg1_0);;
let rec mapTree_lh__d4 _lh_mapTree_arg1_3 _lh_mapTree_arg2_3 _lh_floatOutId_0_2_0 =
  (match _lh_mapTree_arg2_3 with
    | `Node(_lh_mapTree_Node_0_2, _lh_mapTree_Node_1_2) -> 
      (let rec _lh_foldTree_Node_1_1 = ((map_lh__d1_d2 (mapTree_lh__d4 _lh_mapTree_arg1_3)) _lh_mapTree_Node_1_2) in
        (let rec _lh_foldTree_Node_0_1 = (_lh_mapTree_arg1_3 _lh_mapTree_Node_0_2) in
          ((_lh_floatOutId_0_2_0 _lh_foldTree_Node_0_1) ((map_lh__d1_d1 (foldTree_lh__d1 _lh_floatOutId_0_2_0)) _lh_foldTree_Node_1_1)))));;
let rec bt_lh__d2 _lh_bt_arg1_4 =
  (let rec f_1_3 = (fun s_4 -> 
    (let rec _lh_f_LH_P2_1_2 = (let rec _lh_matchIdent_3 = ((earliestInconsistency_lh__d2 _lh_bt_arg1_4) s_4) in
      ((_lh_matchIdent_3 _lh_bt_arg1_4) s_4)) in
      (let rec _lh_f_LH_P2_0_5 = s_4 in
        (fun _lh_f_arg2_4 -> 
          ((_lh_f_LH_P2_1_2 _lh_f_LH_P2_0_5) _lh_f_arg2_4))))) in
    (mapTree_lh__d4 f_1_3));;
let rec bj_lh__d1 _lh_bj_arg1_0 =
  (let rec f_1_2 = (fun _lh_f_arg1_1 _lh_f_arg2_3 -> 
    (_lh_f_arg1_1 _lh_f_arg2_3)) in
    (foldTree_lh__d1 f_1_2));;
...
let rec knownConflict_lh__d3 _lh_knownConflict_arg1_2 =
  (match _lh_knownConflict_arg1_2 with
    ...
    | _ -> 
      false);;
let rec map_lh__d8 f_5_3 ls_2_7 _lh_floatOutId_0_2_5 =
  (match ls_2_7 with
    | `LH_C(h_3_1, t_3_1) -> 
      (let rec _lh_combine_LH_C_1_1 = ((map_lh__d8 f_5_3) t_3_1) in
        (let rec _lh_combine_LH_C_0_1 = (f_5_3 h_3_1) in
              ...
              (match _lh_combine_LH_P2_1_1 with
                | `Known(_lh_combine_Known_0_1) -> 
                  (if ((notElem_lh__d1 (maxLevel_lh__d4 _lh_combine_LH_P2_0_1)) _lh_combine_Known_0_1) then
                    ...
                    ((combine_lh__d2 _lh_combine_LH_C_1_1) ((union_lh__d2 _lh_combine_Known_0_1) _lh_floatOutId_0_2_5)))))))
    | `LH_N -> 
      _lh_floatOutId_0_2_5);;
let rec bj'_lh__d1 _lh_bj'_arg1_0 =
  (let rec f_3_9 = (fun _lh_f_arg1_3 _lh_f_arg2_6 -> 
    (match _lh_f_arg1_3 with
      | `LH_P2(_lh_f_LH_P2_0_6, _lh_f_LH_P2_1_3) -> 
        (match _lh_f_LH_P2_1_3 with
          | `Known(_lh_f_Known_0_2) -> 
            (`Node((`LH_P2(_lh_f_LH_P2_0_6, (`Known(_lh_f_Known_0_2)))), _lh_f_arg2_6))
          | `Unknown -> 
            (let rec cs'_1 = (`Known(((combine_lh__d2 ((map_lh__d8 label_lh__d2) _lh_f_arg2_6)) (`LH_N)))) in
              (if (knownConflict_lh__d3 cs'_1) then
                (`Node((`LH_P2(_lh_f_LH_P2_0_6, cs'_1)), (`LH_N)))
              else
                (`Node((`LH_P2(_lh_f_LH_P2_0_6, cs'_1)), _lh_f_arg2_6))))))) in
...
let rec checkComplete_lh__d5 _lh_checkComplete_arg1_1 _lh_checkComplete_arg2_1 =
  (if ((complete_lh__d4 _lh_checkComplete_arg1_1) _lh_checkComplete_arg2_1) then
    ...
    (`Unknown));;
let rec earliestInconsistency_lh__d3 _lh_earliestInconsistency_arg1_1 _lh_earliestInconsistency_arg2_1 _lh_floatOutId_0_9 _lh_floatOutId_1_7 =
  (match _lh_earliestInconsistency_arg1_1 with
    | `CSP(_lh_earliestInconsistency_CSP_0_1, _lh_earliestInconsistency_CSP_1_1, _lh_earliestInconsistency_CSP_2_1) -> 
      (match _lh_earliestInconsistency_arg2_1 with
        | `LH_N -> 
          ((checkComplete_lh__d5 _lh_floatOutId_0_9) _lh_floatOutId_1_7)
            ...
            (match _lh_matchIdent_5 with
              ...
              | `LH_C(_lh_earliestInconsistency_LH_C_0_3, _lh_earliestInconsistency_LH_C_1_3) -> 
                (let rec _lh_bt_Just_0_1 = (let rec _lh_bt_LH_P2_1_1 = (level_lh__d4 _lh_earliestInconsistency_LH_C_0_3) in
                  ...
                  (_lh_bt_Just_0_1 99))))));;
let rec mapTree_lh__d7 _lh_mapTree_arg1_4 _lh_mapTree_arg2_4 =
  (match _lh_mapTree_arg2_4 with
    | `Node(_lh_mapTree_Node_0_3, _lh_mapTree_Node_1_3) -> 
      (`Node((_lh_mapTree_arg1_4 _lh_mapTree_Node_0_3), ((map_lh__d1_d3 (mapTree_lh__d7 _lh_mapTree_arg1_4)) _lh_mapTree_Node_1_3))));;
...
let rec lookupCache_lh__d1 _lh_lookupCache_arg1_0 _lh_lookupCache_arg2_0 =
  (let rec f_3_4 = (fun _lh_f_arg1_2 _lh_f_arg2_5 -> 
    (_lh_f_arg2_5 _lh_f_arg1_2)) in
    ((mapTree_lh__d3 (f_3_4 _lh_lookupCache_arg1_0)) _lh_lookupCache_arg2_0));;
let rec zipWith_lh__d2 f_1_4 xs_1 ys_1 =
  (match xs_1 with
    | `LH_C(hx_2, tx_2) -> 
      (((ys_1 f_1_4) hx_2) tx_2)
    | `LH_N -> 
      (`LH_N));;
let rec zipWith_lh__d1 f_3_8 xs_2 ys_2 =
  (match xs_2 with
    ...
    | `LH_N -> 
      (`LH_N));;
let rec enumFromTo_lh__d5 a_9 b_7 _lh_floatOutId_0_1_8 _lh_floatOutId_1_1_5 _lh_floatOutId_2_2 _lh_floatOutId_3_2 _lh_floatOutId_4_2 =
  (if (a_9 <= b_7) then
    (let rec _lh_listcomp_fun_ls_t_7 = ((enumFromTo_lh__d5 (a_9 + 1)) b_7) in
      (let rec _lh_listcomp_fun_ls_h_7 = a_9 in
        (let rec ty_2 = (_lh_floatOutId_1_1_5 _lh_listcomp_fun_ls_t_7) in
          (let rec hy_2 = (let rec _lh_fillTable_LH_P2_1_0 = _lh_listcomp_fun_ls_h_7 in
            (let rec _lh_fillTable_LH_P2_0_0 = _lh_floatOutId_0_1_8 in
              (fun _lh_fillTable_Assign_0_1 _lh_fillTable_Assign_1_1 _lh_fillTable_CSP_2_1 cs_2 -> 
                (if ((cs_2 = (`Unknown)) && (not ((_lh_fillTable_CSP_2_1 (`Assign(_lh_fillTable_Assign_0_1, _lh_fillTable_Assign_1_1))) (`Assign(_lh_fillTable_LH_P2_0_0, _lh_fillTable_LH_P2_1_0))))) then
                  ...
                  cs_2)))) in
            (`LH_C(((_lh_floatOutId_2_2 _lh_floatOutId_3_2) hy_2), (((zipWith_lh__d2 _lh_floatOutId_2_2) _lh_floatOutId_4_2) ty_2)))))))
  else
    (`LH_N));;
let rec enumFromTo_lh__d6 a_3 b_2 _lh_floatOutId_0_4 _lh_floatOutId_1_3 _lh_floatOutId_2_0 _lh_floatOutId_3_0 _lh_floatOutId_4_0 =
  (if (a_3 <= b_2) then
    (let rec _lh_listcomp_fun_ls_t_2 = ((enumFromTo_lh__d6 (a_3 + 1)) b_2) in
      (let rec _lh_listcomp_fun_ls_h_2 = a_3 in
        (let rec ty_0 = (_lh_floatOutId_1_3 _lh_listcomp_fun_ls_t_2) in
          (let rec hy_0 = (let rec _lh_listcomp_fun_5 = (fun _lh_listcomp_fun_para_2 -> 
            ((_lh_listcomp_fun_para_2 _lh_listcomp_fun_ls_h_2) _lh_listcomp_fun_5)) in
            (_lh_listcomp_fun_5 ((enumFromTo_lh__d5 1) _lh_floatOutId_0_4))) in
            (`LH_C(((_lh_floatOutId_2_0 _lh_floatOutId_3_0) hy_0), (((zipWith_lh__d1 _lh_floatOutId_2_0) _lh_floatOutId_4_0) ty_0)))))))
  else
    (`LH_N));;
          ...
          (match _lh_fillTable_arg2_0 with
            | `CSP(_lh_fillTable_CSP_0_0, _lh_fillTable_CSP_1_0, _lh_fillTable_CSP_2_0) -> 
              (let rec f_1 = (fun cs_0 varval_0 -> 
                ...
                (((zipWith_lh__d1 (zipWith_lh__d2 f_1)) _lh_fillTable_arg3_0) (let rec _lh_listcomp_fun_1 = (fun _lh_listcomp_fun_para_1 -> 
                  ((_lh_listcomp_fun_para_1 _lh_fillTable_CSP_1_0) _lh_listcomp_fun_1)) in
                  (_lh_listcomp_fun_1 ((enumFromTo_lh__d6 (_lh_fillTable_Assign_0_0 + 1)) _lh_fillTable_CSP_0_0))))))));;
...
let rec head_lh__d1 ls_2_0 =
  (match ls_2_0 with
    | `LH_C(h_2_5, t_2_5) -> 
      h_2_5
    | `LH_N -> 
      (failwith "lh_default_error"));;
let rec atIndex_lh__d1 n_1 ls_2_6 =
  (if (n_1 < 0) then
    (failwith "lh_default_error")
  else
    (match ls_2_6 with
      | `LH_C(h_3_0, t_3_0) -> 
        (if (n_1 = 0) then
          ...
          ((atIndex_lh__d1 (n_1 - 1)) t_3_0))
      | `LH_N -> 
        (failwith "lh_default_error")));;
let rec mapTree_lh__d1 _lh_mapTree_arg1_8 _lh_mapTree_arg2_6 =
  (_lh_mapTree_arg2_6 _lh_mapTree_arg1_8);;
let rec map_lh__d3 f_4_0 ls_1_6 =
  (ls_1_6 f_4_0);;
let rec map_lh__d2 f_2_2 ls_1_1 _lh_floatOutId_0_1_2 _lh_floatOutId_1_9 =
  (match ls_1_1 with
    | `LH_C(h_1_1, t_1_1) -> 
      (let rec t_1_2 = ((map_lh__d2 f_2_2) t_1_1) in
        (let rec h_1_2 = (f_2_2 h_1_1) in
          (let rec t_1_3 = ((map_lh__d9 _lh_floatOutId_0_1_2) t_1_2) in
            (let rec h_1_3 = (_lh_floatOutId_0_1_2 h_1_2) in
              (`LH_C((_lh_floatOutId_1_9 h_1_3), ((map_lh__d3 _lh_floatOutId_1_9) t_1_3)))))))
    | `LH_N -> 
      (`LH_N));;
...
let rec checkComplete_lh__d2 _lh_checkComplete_arg1_4 _lh_checkComplete_arg2_4 =
  (if ((complete_lh__d2 _lh_checkComplete_arg1_4) _lh_checkComplete_arg2_4) then
    ...
    (`Unknown));;
let rec cacheChecks_lh__d1 _lh_cacheChecks_arg1_1 _lh_cacheChecks_arg2_1 _lh_cacheChecks_arg3_1 _lh_floatOutId_0_2_2 _lh_floatOutId_1_1_7 =
  (match _lh_cacheChecks_arg3_1 with
    | `Node(_lh_cacheChecks_Node_0_1, _lh_cacheChecks_Node_1_1) -> 
      (let rec _lh_mapTree_Node_1_4 = ((map_lh__d2 ((cacheChecks_lh__d1 _lh_cacheChecks_arg1_1) (((fillTable_lh__d1 _lh_cacheChecks_Node_0_1) _lh_cacheChecks_arg1_1) (tail_lh__d1 _lh_cacheChecks_arg2_1)))) _lh_cacheChecks_Node_1_1) in
        (let rec _lh_mapTree_Node_0_4 = (let rec _lh_f_LH_P2_1_4 = _lh_cacheChecks_arg2_1 in
          (let rec _lh_f_LH_P2_0_7 = _lh_cacheChecks_Node_0_1 in
            (fun _lh_f_arg1_4 -> 
              (match _lh_f_LH_P2_0_7 with
                | `LH_N -> 
                  (let rec _lh_fst_LH_P2_1_1 = _lh_f_LH_P2_1_4 in
                    (let rec _lh_fst_LH_P2_0_1 = (`LH_P2((`LH_N), (`Unknown))) in
                      _lh_fst_LH_P2_0_1))
                | `LH_C(_lh_f_LH_C_0_0, _lh_f_LH_C_1_0) -> 
                  (let rec tableEntry_0 = ((atIndex_lh__d1 ((value_lh__d1 _lh_f_LH_C_0_0) - 1)) (head_lh__d1 _lh_f_LH_P2_1_4)) in
                    (let rec cs_3 = (if (tableEntry_0 = (`Unknown)) then
                      ((checkComplete_lh__d2 _lh_f_arg1_4) (`LH_C(_lh_f_LH_C_0_0, _lh_f_LH_C_1_0)))
                    else
                      tableEntry_0) in
                      (let rec _lh_fst_LH_P2_1_2 = _lh_f_LH_P2_1_4 in
                        (let rec _lh_fst_LH_P2_0_2 = (`LH_P2((`LH_C(_lh_f_LH_C_0_0, _lh_f_LH_C_1_0)), cs_3)) in
                          _lh_fst_LH_P2_0_2)))))))) in
          (let rec _lh_mapTree_Node_1_5 = ((map_lh__d9 (mapTree_lh__d3 _lh_floatOutId_0_2_2)) _lh_mapTree_Node_1_4) in
            (let rec _lh_mapTree_Node_0_5 = (_lh_floatOutId_0_2_2 _lh_mapTree_Node_0_4) in
              (`Node((_lh_floatOutId_1_1_7 _lh_mapTree_Node_0_5), ((map_lh__d3 (mapTree_lh__d1 _lh_floatOutId_1_1_7)) _lh_mapTree_Node_1_5))))))));;
let rec enumFromTo_lh__d2 a_5 b_3 _lh_floatOutId_0_6 =
  (if (a_5 <= b_3) then
    (let rec _lh_listcomp_fun_ls_t_3 = ((enumFromTo_lh__d2 (a_5 + 1)) b_3) in
      (let rec _lh_listcomp_fun_ls_h_3 = a_5 in
        (`LH_C((`Unknown), (_lh_floatOutId_0_6 _lh_listcomp_fun_ls_t_3)))))
  else
    (`LH_N));;
let rec enumFromTo_lh__d1 a_7 b_5 _lh_floatOutId_0_1_6 _lh_floatOutId_1_1_3 =
  (if (a_7 <= b_5) then
    (let rec _lh_listcomp_fun_ls_t_5 = ((enumFromTo_lh__d1 (a_7 + 1)) b_5) in
      (let rec _lh_listcomp_fun_ls_h_5 = a_7 in
        (`LH_C((let rec _lh_listcomp_fun_1_5 = (fun _lh_listcomp_fun_para_6 -> 
          (_lh_listcomp_fun_para_6 _lh_listcomp_fun_1_5)) in
          (_lh_listcomp_fun_1_5 ((enumFromTo_lh__d2 1) _lh_floatOutId_0_1_6))), (_lh_floatOutId_1_1_3 _lh_listcomp_fun_ls_t_5)))))
  else
    (`LH_N));;
...
let rec testConstraints_nofib_lh__d1 _lh_testConstraints_nofib_arg1_0 =
  ((map_lh__d1 (try_lh__d1 _lh_testConstraints_nofib_arg1_0)) (let rec t_1_4 = (let rec t_1_5 = (let rec t_1_6 = (let rec t_1_7 = (let rec t_1_8 = (fun f_2_7 -> 
    (`LH_N)) in
    (let rec h_1_4 = fc_lh__d1 in
      (fun f_2_8 -> 
        (`LH_C((f_2_8 h_1_4), ((map_lh__d1 f_2_8) t_1_8)))))) in
    (let rec h_1_5 = bjbt'_lh__d1 in
      (fun f_2_9 -> 
        (`LH_C((f_2_9 h_1_5), ((map_lh__d1 f_2_9) t_1_7)))))) in
    (let rec h_1_6 = bjbt_lh__d1 in
      (fun f_3_0 -> 
        (`LH_C((f_3_0 h_1_6), ((map_lh__d1 f_3_0) t_1_6)))))) in
    (let rec h_1_7 = bm_lh__d1 in
      (fun f_3_1 -> 
        (`LH_C((f_3_1 h_1_7), ((map_lh__d1 f_3_1) t_1_5)))))) in
    (let rec h_1_8 = bt_lh__d1 in
      (fun f_3_2 -> 
        (`LH_C((f_3_2 h_1_8), ((map_lh__d1 f_3_2) t_1_4)))))));;
