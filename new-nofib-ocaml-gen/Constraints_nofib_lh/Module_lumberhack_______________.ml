      ...
      (let rec _lh_listcomp_fun_ls_h_1_3 = a_1_0 in
        (fun _lh_emptyTable_CSP_1_3 _lh_listcomp_fun_2_1 -> 
          (`LH_C((let rec _lh_listcomp_fun_2_2 = (fun _lh_listcomp_fun_para_7 -> 
            ...
            (_lh_listcomp_fun_2_2 ((enumFromTo_lh__d4 1) _lh_emptyTable_CSP_1_3))), (_lh_listcomp_fun_2_1 _lh_listcomp_fun_ls_t_9))))))
  else
...
let rec map_lh__d1_d0 f_5_2 ls_2_3 =
  (ls_2_3 f_5_2);;
let rec map_lh__d5 f_3_3 ls_1_4 =
  (match ls_1_4 with
    | `LH_C(h_1_6, t_1_6) -> 
      (let rec t_1_7 = ((map_lh__d5 f_3_3) t_1_6) in
        (let rec h_1_7 = (f_3_3 h_1_6) in
          (fun f_3_4 -> 
            (let rec t_1_8 = ((map_lh__d1_d0 f_3_4) t_1_7) in
              (let rec h_1_8 = (f_3_4 h_1_7) in
                (fun f_3_5 -> 
                  (`LH_C((f_3_5 h_1_8), ((map_lh__d1_d1 f_3_5) t_1_8)))))))))
    | `LH_N -> 
      (fun f_3_6 f_3_7 -> 
        (`LH_N)));;
  ...
  (if (a_8 <= b_6) then
    (let rec _lh_listcomp_fun_ls_t_7 = ((enumFromTo_lh__d7 (a_8 + 1)) b_6) in
      (let rec _lh_listcomp_fun_ls_h_7 = a_8 in
        (fun _lh_listcomp_fun_ls_h_8 _lh_listcomp_fun_1_7 -> 
          (let rec ty_1 = (_lh_listcomp_fun_1_7 _lh_listcomp_fun_ls_t_7) in
              ...
              (let rec _lh_fillTable_LH_P2_0_0 = _lh_listcomp_fun_ls_h_8 in
                (fun _lh_fillTable_Assign_0_1 _lh_fillTable_Assign_1_1 _lh_fillTable_CSP_2_1 cs_3 -> 
                  (if ((cs_3 = (`Unknown)) && (not ((_lh_fillTable_CSP_2_1 (`Assign(_lh_fillTable_Assign_0_1, _lh_fillTable_Assign_1_1))) (`Assign(_lh_fillTable_LH_P2_0_0, _lh_fillTable_LH_P2_1_0))))) then
                    ...
                    cs_3)))) in
              (fun f_2_9 hx_3 tx_3 -> 
                (`LH_C(((f_2_9 hx_3) hy_1), (((zipWith_lh__d4 f_2_9) tx_3) ty_1)))))))))
  else
    (fun _lh_listcomp_fun_ls_h_9 _lh_listcomp_fun_1_8 f_3_0 hx_4 tx_4 -> 
      (`LH_N)));;
  ...
  (if (a_1_1 <= b_9) then
    (let rec _lh_listcomp_fun_ls_t_1_0 = ((enumFromTo_lh__d8 (a_1_1 + 1)) b_9) in
      (let rec _lh_listcomp_fun_ls_h_1_4 = a_1_1 in
        (fun _lh_fillTable_CSP_1_3 _lh_listcomp_fun_2_5 -> 
          (let rec ty_3 = (_lh_listcomp_fun_2_5 _lh_listcomp_fun_ls_t_1_0) in
            (let rec hy_3 = (let rec _lh_listcomp_fun_2_6 = (fun _lh_listcomp_fun_para_9 -> 
              ...
              (_lh_listcomp_fun_2_6 ((enumFromTo_lh__d7 1) _lh_fillTable_CSP_1_3))) in
              (fun f_4_9 hx_9 tx_9 -> 
                (`LH_C(((f_4_9 hx_9) hy_3), (((zipWith_lh__d3 f_4_9) tx_9) ty_3)))))))))
  else
    (fun _lh_fillTable_CSP_1_4 _lh_listcomp_fun_2_7 f_5_0 hx_1_0 tx_1_0 -> 
      (`LH_N)));;
      ...
      (let rec _lh_mapTree_Node_1_1 = ((map_lh__d5 ((cacheChecks_lh__d2 _lh_cacheChecks_arg1_0) (((fillTable_lh__d2 _lh_cacheChecks_Node_0_0) _lh_cacheChecks_arg1_0) (tail_lh__d2 _lh_cacheChecks_arg2_0)))) _lh_cacheChecks_Node_1_0) in
        (let rec _lh_mapTree_Node_0_1 = (let rec _lh_f_LH_P2_1_2 = _lh_cacheChecks_arg2_0 in
          ...
          (fun _lh_mapTree_arg1_3 -> 
            (let rec _lh_mapTree_Node_1_2 = ((map_lh__d1_d0 (mapTree_lh__d4 _lh_mapTree_arg1_3)) _lh_mapTree_Node_1_1) in
              (let rec _lh_mapTree_Node_0_2 = (_lh_mapTree_arg1_3 _lh_mapTree_Node_0_1) in
                (fun _lh_mapTree_arg1_4 -> 
                  (`Node((_lh_mapTree_arg1_4 _lh_mapTree_Node_0_2), ((map_lh__d1_d1 (mapTree_lh__d5 _lh_mapTree_arg1_4)) _lh_mapTree_Node_1_2))))))))));;
  ...
  (if (a_6 <= b_4) then
    (let rec _lh_listcomp_fun_ls_t_3 = ((enumFromTo_lh__d9 (a_6 + 1)) b_4) in
      (let rec _lh_listcomp_fun_ls_h_3 = a_6 in
        (fun _lh_listcomp_fun_9 ss_1 -> 
          (`LH_C((`LH_C((`Assign(((maxLevel_lh__d4 ss_1) + 1), _lh_listcomp_fun_ls_h_3)), ss_1)), (_lh_listcomp_fun_9 _lh_listcomp_fun_ls_t_3))))))
  else
    (fun _lh_listcomp_fun_1_0 ss_2 -> 
      (`LH_N)));;
...
let rec map_lh__d8 f_5_8 ls_2_8 =
  (match ls_2_8 with
    | `LH_C(h_3_2, t_3_2) -> 
    ...
    | `LH_C(h_7, t_7) -> 
      (let rec t_8 = ((map_lh__d1_d2 f_1_7) t_7) in
        (let rec h_8 = (f_1_7 h_7) in
          (fun f_1_8 -> 
            (`LH_C((f_1_8 h_8), ((map_lh__d1_d3 f_1_8) t_8))))))
    | `LH_N -> 
      (fun f_1_9 -> 
        (`LH_N)));;
      ...
      (let rec _lh_foldTree_Node_1_1 = ((map_lh__d1_d2 (mapTree_lh__d6 _lh_mapTree_arg1_0)) _lh_mapTree_Node_1_0) in
        (let rec _lh_foldTree_Node_0_1 = (_lh_mapTree_arg1_0 _lh_mapTree_Node_0_0) in
          (fun _lh_foldTree_arg1_2 -> 
            ((_lh_foldTree_arg1_2 _lh_foldTree_Node_0_1) ((map_lh__d1_d3 (foldTree_lh__d1 _lh_foldTree_arg1_2)) _lh_foldTree_Node_1_1))))));;
                ...
                (match _lh_combine_LH_P2_1_0 with
                  | `Known(_lh_combine_Known_0_0) -> 
                    (if ((notElem_lh__d1 (maxLevel_lh__d2 _lh_combine_LH_P2_0_0)) _lh_combine_Known_0_0) then
                      ...
                      ((combine_lh__d1 _lh_combine_LH_C_1_0) ((union_lh__d2 _lh_combine_Known_0_0) _lh_combine_arg2_2)))
                  | _ -> 
                    (failwith "lh_default_error"))))))
    | `LH_N -> 
  ...
  (if ((complete_lh__d4 _lh_checkComplete_arg1_3) _lh_checkComplete_arg2_3) then
    (let rec _lh_f_Known_0_2 = (`LH_N) in
      (fun _lh_f_LH_P2_0_3 _lh_f_arg2_3 -> 
        (`Node((`LH_P2(_lh_f_LH_P2_0_3, (`Known(_lh_f_Known_0_2)))), _lh_f_arg2_3))))
  else
    (fun _lh_f_LH_P2_0_4 _lh_f_arg2_4 -> 
      (let rec cs'_0 = (`Known(((combine_lh__d1 ((map_lh__d6 label_lh__d1) _lh_f_arg2_4)) (`LH_N)))) in
        (if (knownConflict_lh__d2 cs'_0) then
          (`Node((`LH_P2(_lh_f_LH_P2_0_4, cs'_0)), (`LH_N)))
        else
          (`Node((`LH_P2(_lh_f_LH_P2_0_4, cs'_0)), _lh_f_arg2_4))))));;
      ...
      (match _lh_earliestInconsistency_arg2_0 with
        | `LH_N -> 
          (fun _lh_bt_arg1_0 s_0 -> 
            ((checkComplete_lh__d4 _lh_bt_arg1_0) s_0))
  ...
  (if (a_9 <= b_7) then
    (let rec _lh_listcomp_fun_ls_t_8 = ((enumFromTo_lh__d5 (a_9 + 1)) b_7) in
      (let rec _lh_listcomp_fun_ls_h_1_0 = a_9 in
        (fun _lh_listcomp_fun_ls_h_1_1 _lh_listcomp_fun_1_9 -> 
          (let rec ty_2 = (_lh_listcomp_fun_1_9 _lh_listcomp_fun_ls_t_8) in
            (let rec hy_2 = (let rec _lh_fillTable_LH_P2_1_1 = _lh_listcomp_fun_ls_h_1_0 in
              (let rec _lh_fillTable_LH_P2_0_1 = _lh_listcomp_fun_ls_h_1_1 in
                (fun _lh_fillTable_Assign_0_2 _lh_fillTable_Assign_1_2 _lh_fillTable_CSP_2_2 cs_4 -> 
                  (if ((cs_4 = (`Unknown)) && (not ((_lh_fillTable_CSP_2_2 (`Assign(_lh_fillTable_Assign_0_2, _lh_fillTable_Assign_1_2))) (`Assign(_lh_fillTable_LH_P2_0_1, _lh_fillTable_LH_P2_1_1))))) then
                    ...
                    cs_4)))) in
              (fun f_3_1 hx_5 tx_5 -> 
                (`LH_C(((f_3_1 hx_5) hy_2), (((zipWith_lh__d2 f_3_1) tx_5) ty_2)))))))))
  else
    (fun _lh_listcomp_fun_ls_h_1_2 _lh_listcomp_fun_2_0 f_3_2 hx_6 tx_6 -> 
      (`LH_N)));;
  ...
  (if (a_3 <= b_2) then
    (let rec _lh_listcomp_fun_ls_t_1 = ((enumFromTo_lh__d6 (a_3 + 1)) b_2) in
      (let rec _lh_listcomp_fun_ls_h_1 = a_3 in
        (fun _lh_fillTable_CSP_1_1 _lh_listcomp_fun_3 -> 
          (let rec ty_0 = (_lh_listcomp_fun_3 _lh_listcomp_fun_ls_t_1) in
            (let rec hy_0 = (let rec _lh_listcomp_fun_4 = (fun _lh_listcomp_fun_para_1 -> 
              ...
              (_lh_listcomp_fun_4 ((enumFromTo_lh__d5 1) _lh_fillTable_CSP_1_1))) in
              (fun f_9 hx_0 tx_0 -> 
                (`LH_C(((f_9 hx_0) hy_0), (((zipWith_lh__d1 f_9) tx_0) ty_0)))))))))
  else
    (fun _lh_fillTable_CSP_1_2 _lh_listcomp_fun_5 f_1_0 hx_1 tx_1 -> 
      (`LH_N)));;
...
let rec map_lh__d4 f_4_7 ls_2_0 =
  (ls_2_0 f_4_7);;
let rec map_lh__d3 f_4_1 ls_1_7 =
  (match ls_1_7 with
    | `LH_C(h_2_0, t_2_0) -> 
      (let rec t_2_1 = ((map_lh__d3 f_4_1) t_2_0) in
        (let rec h_2_1 = (f_4_1 h_2_0) in
          (fun f_4_2 -> 
            (let rec t_2_2 = ((map_lh__d9 f_4_2) t_2_1) in
              (let rec h_2_2 = (f_4_2 h_2_1) in
                (fun f_4_3 -> 
                  (`LH_C((f_4_3 h_2_2), ((map_lh__d4 f_4_3) t_2_2)))))))))
    | `LH_N -> 
      (fun f_4_4 f_4_5 -> 
        (`LH_N)));;
      ...
      (let rec _lh_mapTree_Node_1_4 = ((map_lh__d3 ((cacheChecks_lh__d1 _lh_cacheChecks_arg1_1) (((fillTable_lh__d1 _lh_cacheChecks_Node_0_1) _lh_cacheChecks_arg1_1) (tail_lh__d1 _lh_cacheChecks_arg2_1)))) _lh_cacheChecks_Node_1_1) in
        (let rec _lh_mapTree_Node_0_4 = (let rec _lh_f_LH_P2_1_9 = _lh_cacheChecks_arg2_1 in
          ...
          (fun _lh_mapTree_arg1_7 -> 
            (let rec _lh_mapTree_Node_1_5 = ((map_lh__d9 (mapTree_lh__d3 _lh_mapTree_arg1_7)) _lh_mapTree_Node_1_4) in
              (let rec _lh_mapTree_Node_0_5 = (_lh_mapTree_arg1_7 _lh_mapTree_Node_0_4) in
                (fun _lh_mapTree_arg1_8 -> 
                  (`Node((_lh_mapTree_arg1_8 _lh_mapTree_Node_0_5), ((map_lh__d4 (mapTree_lh__d2 _lh_mapTree_arg1_8)) _lh_mapTree_Node_1_5))))))))));;
    ...
    (let rec _lh_listcomp_fun_ls_t_2 = ((enumFromTo_lh__d2 (a_5 + 1)) b_3) in
      (let rec _lh_listcomp_fun_ls_h_2 = a_5 in
        (fun _lh_listcomp_fun_7 -> 
          (`LH_C((`Unknown), (_lh_listcomp_fun_7 _lh_listcomp_fun_ls_t_2))))))
  else
  ...
  (if (a_7 <= b_5) then
    (let rec _lh_listcomp_fun_ls_t_4 = ((enumFromTo_lh__d1 (a_7 + 1)) b_5) in
      (let rec _lh_listcomp_fun_ls_h_4 = a_7 in
        (fun _lh_emptyTable_CSP_1_1 _lh_listcomp_fun_1_2 -> 
          (`LH_C((let rec _lh_listcomp_fun_1_3 = (fun _lh_listcomp_fun_para_4 -> 
            (_lh_listcomp_fun_para_4 _lh_listcomp_fun_1_3)) in
            (_lh_listcomp_fun_1_3 ((enumFromTo_lh__d2 1) _lh_emptyTable_CSP_1_1))), (_lh_listcomp_fun_1_2 _lh_listcomp_fun_ls_t_4))))))
  else
    (fun _lh_emptyTable_CSP_1_2 _lh_listcomp_fun_1_4 -> 
      (`LH_N)));;
