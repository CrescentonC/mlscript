    ...
    (let rec _lh_listcomp_fun_ls_t_1 = ((enumFromTo_lh__d4 (a_2 + 1)) b_1) in
      (let rec _lh_listcomp_fun_ls_h_1 = a_2 in
        (fun _lh_listcomp_fun_2 -> 
          (`LH_C((`Unknown), (_lh_listcomp_fun_2 _lh_listcomp_fun_ls_t_1))))))
  else
  ...
  (if (a_1_0 <= b_8) then
    (let rec _lh_listcomp_fun_ls_t_8 = ((enumFromTo_lh__d3 (a_1_0 + 1)) b_8) in
      (let rec _lh_listcomp_fun_ls_h_1_0 = a_1_0 in
        (fun _lh_emptyTable_CSP_1_3 _lh_listcomp_fun_2_1 -> 
          (`LH_C((let rec _lh_listcomp_fun_2_2 = (fun _lh_listcomp_fun_para_7 -> 
            (_lh_listcomp_fun_para_7 _lh_listcomp_fun_2_2)) in
            (_lh_listcomp_fun_2_2 ((enumFromTo_lh__d4 1) _lh_emptyTable_CSP_1_3))), (_lh_listcomp_fun_2_1 _lh_listcomp_fun_ls_t_8))))))
  else
    (fun _lh_emptyTable_CSP_1_4 _lh_listcomp_fun_2_3 -> 
      (`LH_N)));;
  ...
  (if (a_1_1 <= b_9) then
    (let rec _lh_listcomp_fun_ls_t_9 = ((enumFromTo_lh__d8 (a_1_1 + 1)) b_9) in
      (let rec _lh_listcomp_fun_ls_h_1_1 = a_1_1 in
        (fun _lh_listcomp_fun_ls_h_1_2 _lh_listcomp_fun_2_5 -> 
          (let rec ty_3 = (_lh_listcomp_fun_2_5 _lh_listcomp_fun_ls_t_9) in
            (let rec hy_3 = (let rec _lh_fillTable_LH_P2_1_1 = _lh_listcomp_fun_ls_h_1_1 in
              (let rec _lh_fillTable_LH_P2_0_1 = _lh_listcomp_fun_ls_h_1_2 in
                (fun _lh_fillTable_Assign_0_2 _lh_fillTable_Assign_1_2 _lh_fillTable_CSP_2_2 cs_4 -> 
                  (if ((cs_4 = (`Unknown)) && (not ((_lh_fillTable_CSP_2_2 (`Assign(_lh_fillTable_Assign_0_2, _lh_fillTable_Assign_1_2))) (`Assign(_lh_fillTable_LH_P2_0_1, _lh_fillTable_LH_P2_1_1))))) then
                    ...
                    cs_4)))) in
              (fun f_4_6 hx_9 tx_9 -> 
                (`LH_C(((f_4_6 hx_9) hy_3), (((zipWith_lh__d4 f_4_6) tx_9) ty_3)))))))))
  else
    (fun _lh_listcomp_fun_ls_h_1_3 _lh_listcomp_fun_2_6 f_4_7 hx_1_0 tx_1_0 -> 
      (`LH_N)));;
  ...
  (if (a_6 <= b_4) then
    (let rec _lh_listcomp_fun_ls_t_4 = ((enumFromTo_lh__d9 (a_6 + 1)) b_4) in
      (let rec _lh_listcomp_fun_ls_h_4 = a_6 in
        (fun _lh_fillTable_CSP_1_3 _lh_listcomp_fun_1_0 -> 
          (let rec ty_1 = (_lh_listcomp_fun_1_0 _lh_listcomp_fun_ls_t_4) in
            (let rec hy_1 = (let rec _lh_listcomp_fun_1_1 = (fun _lh_listcomp_fun_para_4 -> 
              ...
              (_lh_listcomp_fun_1_1 ((enumFromTo_lh__d8 1) _lh_fillTable_CSP_1_3))) in
              (fun f_2_0 hx_3 tx_3 -> 
                (`LH_C(((f_2_0 hx_3) hy_1), (((zipWith_lh__d3 f_2_0) tx_3) ty_1)))))))))
  else
    (fun _lh_fillTable_CSP_1_4 _lh_listcomp_fun_1_2 f_2_1 hx_4 tx_4 -> 
      (`LH_N)));;
  ...
  (if (a_8 <= b_6) then
    (let rec _lh_listcomp_fun_ls_t_6 = ((enumFromTo_lh__d7 (a_8 + 1)) b_6) in
      (let rec _lh_listcomp_fun_ls_h_6 = a_8 in
        (fun _lh_listcomp_fun_1_7 ss_1 -> 
          (`LH_C((`LH_C((`Assign(((maxLevel_lh__d1 ss_1) + 1), _lh_listcomp_fun_ls_h_6)), ss_1)), (_lh_listcomp_fun_1_7 _lh_listcomp_fun_ls_t_6))))))
  else
    (fun _lh_listcomp_fun_1_8 ss_2 -> 
      (`LH_N)));;
...
let rec concat_lh__d1 lss_0 =
  (lss_0 99);;
let rec map_lh__d1_d0 f_4_9 ls_2_2 =
  (match ls_2_2 with
    | `LH_C(h_2_6, t_2_6) -> 
                ...
                (match _lh_combine_LH_P2_1_0 with
                  | `Known(_lh_combine_Known_0_0) -> 
                    (if ((notElem_lh__d1 (maxLevel_lh__d3 _lh_combine_LH_P2_0_0)) _lh_combine_Known_0_0) then
                      ...
                      ((combine_lh__d1 _lh_combine_LH_C_1_0) ((union_lh__d1 _lh_combine_Known_0_0) _lh_combine_arg2_2))))))))
    | `LH_N -> 
      (fun _lh_combine_arg2_3 -> 
        _lh_combine_arg2_3));;
let rec checkComplete_lh__d3 _lh_checkComplete_arg1_0 _lh_checkComplete_arg2_0 =
  (if ((complete_lh__d3 _lh_checkComplete_arg1_0) _lh_checkComplete_arg2_0) then
    (let rec _lh_f_Known_0_1 = (`LH_N) in
      (fun _lh_f_LH_P2_0_3 _lh_f_arg2_1 -> 
        (`Node((`LH_P2(_lh_f_LH_P2_0_3, (`Known(_lh_f_Known_0_1)))), _lh_f_arg2_1))))
  else
    (fun _lh_f_LH_P2_0_4 _lh_f_arg2_2 -> 
      (`Node((`LH_P2(_lh_f_LH_P2_0_4, (`Known(((combine_lh__d1 ((map_lh__d5 label_lh__d1) _lh_f_arg2_2)) (`LH_N)))))), _lh_f_arg2_2))));;
      ...
      (match _lh_earliestInconsistency_arg2_0 with
        | `LH_N -> 
          (fun _lh_bt_arg1_0 s_0 -> 
            ((checkComplete_lh__d3 _lh_bt_arg1_0) s_0))
            ...
            (match _lh_matchIdent_1 with
              | `LH_N -> 
                (fun _lh_bt_arg1_1 s_1 -> 
                  ((checkComplete_lh__d3 _lh_bt_arg1_1) s_1))
...
let rec map_lh__d1_d1 f_7 ls_5 =
  (ls_5 f_7);;
let rec map_lh__d1_d2 f_1_7 ls_1_0 =
  (match ls_1_0 with
    | `LH_C(h_9, t_9) -> 
      (let rec t_1_0 = ((map_lh__d1_d2 f_1_7) t_9) in
        (let rec h_1_0 = (f_1_7 h_9) in
          (fun f_1_8 -> 
            (`LH_C((f_1_8 h_1_0), ((map_lh__d1_d1 f_1_8) t_1_0))))))
    | `LH_N -> 
      (fun f_1_9 -> 
        (`LH_N)));;
      ...
      (let rec _lh_foldTree_Node_1_1 = ((map_lh__d1_d2 (mapTree_lh__d4 _lh_mapTree_arg1_3)) _lh_mapTree_Node_1_2) in
        (let rec _lh_foldTree_Node_0_1 = (_lh_mapTree_arg1_3 _lh_mapTree_Node_0_2) in
          (fun _lh_foldTree_arg1_2 -> 
            ((_lh_foldTree_arg1_2 _lh_foldTree_Node_0_1) ((map_lh__d1_d1 (foldTree_lh__d1 _lh_foldTree_arg1_2)) _lh_foldTree_Node_1_1))))));;
...
let rec knownConflict_lh__d3 _lh_knownConflict_arg1_2 =
  (match _lh_knownConflict_arg1_2 with
    ...
    | _ -> 
      false);;
let rec map_lh__d8 f_5_3 ls_2_7 =
  (match ls_2_7 with
    | `LH_C(h_3_1, t_3_1) -> 
                ...
                (match _lh_combine_LH_P2_1_1 with
                  | `Known(_lh_combine_Known_0_1) -> 
                    (if ((notElem_lh__d1 (maxLevel_lh__d4 _lh_combine_LH_P2_0_1)) _lh_combine_Known_0_1) then
                      ...
                      ((combine_lh__d2 _lh_combine_LH_C_1_1) ((union_lh__d2 _lh_combine_Known_0_1) _lh_combine_arg2_4))))))))
    | `LH_N -> 
  ...
  (if (a_9 <= b_7) then
    (let rec _lh_listcomp_fun_ls_t_7 = ((enumFromTo_lh__d5 (a_9 + 1)) b_7) in
      (let rec _lh_listcomp_fun_ls_h_7 = a_9 in
        (fun _lh_listcomp_fun_ls_h_8 _lh_listcomp_fun_1_9 -> 
          (let rec ty_2 = (_lh_listcomp_fun_1_9 _lh_listcomp_fun_ls_t_7) in
            (let rec hy_2 = (let rec _lh_fillTable_LH_P2_1_0 = _lh_listcomp_fun_ls_h_7 in
              (let rec _lh_fillTable_LH_P2_0_0 = _lh_listcomp_fun_ls_h_8 in
                (fun _lh_fillTable_Assign_0_1 _lh_fillTable_Assign_1_1 _lh_fillTable_CSP_2_1 cs_2 -> 
                  (if ((cs_2 = (`Unknown)) && (not ((_lh_fillTable_CSP_2_1 (`Assign(_lh_fillTable_Assign_0_1, _lh_fillTable_Assign_1_1))) (`Assign(_lh_fillTable_LH_P2_0_0, _lh_fillTable_LH_P2_1_0))))) then
                    ...
                    cs_2)))) in
              (fun f_3_5 hx_5 tx_5 -> 
                (`LH_C(((f_3_5 hx_5) hy_2), (((zipWith_lh__d2 f_3_5) tx_5) ty_2)))))))))
  else
    (fun _lh_listcomp_fun_ls_h_9 _lh_listcomp_fun_2_0 f_3_6 hx_6 tx_6 -> 
      (`LH_N)));;
    ...
    (let rec _lh_listcomp_fun_ls_t_2 = ((enumFromTo_lh__d6 (a_3 + 1)) b_2) in
      (let rec _lh_listcomp_fun_ls_h_2 = a_3 in
        (fun _lh_fillTable_CSP_1_1 _lh_listcomp_fun_4 -> 
          (let rec ty_0 = (_lh_listcomp_fun_4 _lh_listcomp_fun_ls_t_2) in
            (let rec hy_0 = (let rec _lh_listcomp_fun_5 = (fun _lh_listcomp_fun_para_2 -> 
              ...
              (fun f_9 hx_0 tx_0 -> 
                (`LH_C(((f_9 hx_0) hy_0), (((zipWith_lh__d1 f_9) tx_0) ty_0)))))))))
  else
    (fun _lh_fillTable_CSP_1_2 _lh_listcomp_fun_6 f_1_0 hx_1 tx_1 -> 
      (`LH_N)));;
...
let rec map_lh__d3 f_4_0 ls_1_6 =
  (ls_1_6 f_4_0);;
let rec map_lh__d2 f_2_2 ls_1_1 =
  (match ls_1_1 with
    | `LH_C(h_1_1, t_1_1) -> 
      (let rec t_1_2 = ((map_lh__d2 f_2_2) t_1_1) in
        (let rec h_1_2 = (f_2_2 h_1_1) in
          (fun f_2_3 -> 
            (let rec t_1_3 = ((map_lh__d9 f_2_3) t_1_2) in
              (let rec h_1_3 = (f_2_3 h_1_2) in
                (fun f_2_4 -> 
                  (`LH_C((f_2_4 h_1_3), ((map_lh__d3 f_2_4) t_1_3)))))))))
    | `LH_N -> 
      (fun f_2_5 f_2_6 -> 
        (`LH_N)));;
      ...
      (let rec _lh_mapTree_Node_1_4 = ((map_lh__d2 ((cacheChecks_lh__d1 _lh_cacheChecks_arg1_1) (((fillTable_lh__d1 _lh_cacheChecks_Node_0_1) _lh_cacheChecks_arg1_1) (tail_lh__d1 _lh_cacheChecks_arg2_1)))) _lh_cacheChecks_Node_1_1) in
        (let rec _lh_mapTree_Node_0_4 = (let rec _lh_f_LH_P2_1_4 = _lh_cacheChecks_arg2_1 in
          ...
          (fun _lh_mapTree_arg1_5 -> 
            (let rec _lh_mapTree_Node_1_5 = ((map_lh__d9 (mapTree_lh__d3 _lh_mapTree_arg1_5)) _lh_mapTree_Node_1_4) in
              (let rec _lh_mapTree_Node_0_5 = (_lh_mapTree_arg1_5 _lh_mapTree_Node_0_4) in
                (fun _lh_mapTree_arg1_6 -> 
                  (`Node((_lh_mapTree_arg1_6 _lh_mapTree_Node_0_5), ((map_lh__d3 (mapTree_lh__d1 _lh_mapTree_arg1_6)) _lh_mapTree_Node_1_5))))))))));;
    ...
    (let rec _lh_listcomp_fun_ls_t_3 = ((enumFromTo_lh__d2 (a_5 + 1)) b_3) in
      (let rec _lh_listcomp_fun_ls_h_3 = a_5 in
        (fun _lh_listcomp_fun_8 -> 
          (`LH_C((`Unknown), (_lh_listcomp_fun_8 _lh_listcomp_fun_ls_t_3))))))
  else
      ...
      (let rec _lh_listcomp_fun_ls_h_5 = a_7 in
        (fun _lh_emptyTable_CSP_1_1 _lh_listcomp_fun_1_4 -> 
          (`LH_C((let rec _lh_listcomp_fun_1_5 = (fun _lh_listcomp_fun_para_6 -> 
            ...
            (_lh_listcomp_fun_1_5 ((enumFromTo_lh__d2 1) _lh_emptyTable_CSP_1_1))), (_lh_listcomp_fun_1_4 _lh_listcomp_fun_ls_t_5))))))
  else
