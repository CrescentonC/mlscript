...
let rec testspheres_lh__d1 =
  (`LH_C((`Sphere((`LH_P3(0.0, 0.0, 0.0)), 0.5, s2_lh__d1)), (`LH_C((`Sphere((`LH_P3(0.272166, 0.272166, 0.544331)), 0.166667, s2_lh__d5)), (`LH_C((`Sphere((`LH_P3(0.643951, 0.172546, 0.0)), 0.166667, s2_lh__d9)), (`LH_C((`Sphere((`LH_P3(0.172546, 0.643951, 0.0)), 0.166667, s2_lh__d6)), (`LH_C((`Sphere((`LH_P3((0.0 -. 0.371785), 0.0996195, 0.544331)), 0.166667, s2_lh__d7)), (`LH_C((`Sphere((`LH_P3((0.0 -. 0.471405), 0.471405, 0.0)), 0.166667, s2_lh__d4)), (`LH_C((`Sphere((`LH_P3((0.0 -. 0.643951), (0.0 -. 0.172546), 0.0)), 0.166667, s2_lh__d2)), (`LH_C((`Sphere((`LH_P3(0.0996195, (0.0 -. 0.371785), 0.544331)), 0.166667, s2_lh__d8)), (`LH_C((`Sphere((`LH_P3((0.0 -. 0.172546), (0.0 -. 0.643951), 0.0)), 0.166667, s2_lh__d1_d0)), (`LH_C((`Sphere((`LH_P3(0.471405, (0.0 -. 0.471405), 0.0)), 0.166667, s2_lh__d3)), (`LH_N)))))))))))))))))))));;
let rec vecscale_lh__d3 _lh_vecscale_arg1_3 _lh_vecscale_arg2_4 =
  (match _lh_vecscale_arg1_3 with
    | `LH_P3(_lh_vecscale_LH_P3_0_4, _lh_vecscale_LH_P3_1_4, _lh_vecscale_LH_P3_2_4) -> 
      (let rec _lh_vecadd_LH_P3_2_1_3 = (_lh_vecscale_arg2_4 *. _lh_vecscale_LH_P3_2_4) in
        (let rec _lh_vecadd_LH_P3_1_1_3 = (_lh_vecscale_arg2_4 *. _lh_vecscale_LH_P3_1_4) in
          (let rec _lh_vecadd_LH_P3_0_1_3 = (_lh_vecscale_arg2_4 *. _lh_vecscale_LH_P3_0_4) in
            (fun _lh_vecadd_LH_P3_0_1_4 _lh_vecadd_LH_P3_1_1_4 _lh_vecadd_LH_P3_2_1_4 -> 
              (let rec _lh_vecsub_LH_P3_2_0 = (_lh_vecadd_LH_P3_2_1_4 +. _lh_vecadd_LH_P3_2_1_3) in
                (let rec _lh_vecsub_LH_P3_1_0 = (_lh_vecadd_LH_P3_1_1_4 +. _lh_vecadd_LH_P3_1_1_3) in
                  (let rec _lh_vecsub_LH_P3_0_0 = (_lh_vecadd_LH_P3_0_1_4 +. _lh_vecadd_LH_P3_0_1_3) in
                    (fun _lh_vecsub_LH_P3_0_1 _lh_vecsub_LH_P3_1_1 _lh_vecsub_LH_P3_2_1 -> 
                      (let rec _lh_vecadd_LH_P3_2_1_5 = (_lh_vecsub_LH_P3_2_1 -. _lh_vecsub_LH_P3_2_0) in
                        (let rec _lh_vecadd_LH_P3_1_1_5 = (_lh_vecsub_LH_P3_1_1 -. _lh_vecsub_LH_P3_1_0) in
                          (let rec _lh_vecadd_LH_P3_0_1_5 = (_lh_vecsub_LH_P3_0_1 -. _lh_vecsub_LH_P3_0_0) in
                            (fun _lh_vecadd_arg2_2 -> 
                              (((_lh_vecadd_arg2_2 _lh_vecadd_LH_P3_0_1_5) _lh_vecadd_LH_P3_1_1_5) _lh_vecadd_LH_P3_2_1_5)))))))))))))
    | _ -> 
      (failwith "error"));;
let rec vecscale_lh__d4 _lh_vecscale_arg1_5 _lh_vecscale_arg2_6 =
  (_lh_vecscale_arg1_5 _lh_vecscale_arg2_6);;
let rec pi_lh__d2 =
  3.141592653589793;;
let rec dtor_lh__d2 _lh_dtor_arg1_0 =
  ((_lh_dtor_arg1_0 *. pi_lh__d2) /. 180.0);;
let rec vecadd_lh__d1 _lh_vecadd_arg1_6 _lh_vecadd_arg2_8 =
  (_lh_vecadd_arg1_6 _lh_vecadd_arg2_8);;
let rec vecscale_lh__d5 _lh_vecscale_arg1_2 _lh_vecscale_arg2_3 =
  (match _lh_vecscale_arg1_2 with
    | `LH_P3(_lh_vecscale_LH_P3_0_3, _lh_vecscale_LH_P3_1_3, _lh_vecscale_LH_P3_2_3) -> 
      (let rec _lh_vecadd_LH_P3_2_1_1 = (_lh_vecscale_arg2_3 *. _lh_vecscale_LH_P3_2_3) in
        (let rec _lh_vecadd_LH_P3_1_1_1 = (_lh_vecscale_arg2_3 *. _lh_vecscale_LH_P3_1_3) in
          (let rec _lh_vecadd_LH_P3_0_1_1 = (_lh_vecscale_arg2_3 *. _lh_vecscale_LH_P3_0_3) in
            (fun _lh_vecadd_LH_P3_0_1_2 _lh_vecadd_LH_P3_1_1_2 _lh_vecadd_LH_P3_2_1_2 -> 
              (`LH_P3((_lh_vecadd_LH_P3_0_1_2 +. _lh_vecadd_LH_P3_0_1_1), (_lh_vecadd_LH_P3_1_1_2 +. _lh_vecadd_LH_P3_1_1_1), (_lh_vecadd_LH_P3_2_1_2 +. _lh_vecadd_LH_P3_2_1_1)))))))
    | _ -> 
      (failwith "error"));;
let rec vecadd_lh__d3 _lh_vecadd_arg1_4 _lh_vecadd_arg2_5 =
  (_lh_vecadd_arg1_4 _lh_vecadd_arg2_5);;
...
let rec lightdirection_lh__d1 _lh_lightdirection_arg1_0 _lh_lightdirection_arg2_0 =
  (match _lh_lightdirection_arg1_0 with
    ...
    | `Point(_lh_lightdirection_Point_0_0, _lh_lightdirection_Point_1_0) -> 
      (vecnorm_lh__d4 ((vecsub_lh__d2 _lh_lightdirection_Point_0_0) _lh_lightdirection_arg2_0))
    | _ -> 
      (failwith "error"));;
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_1, _lh_listcomp_fun_ls_t_1) -> 
        (match _lh_listcomp_fun_ls_h_1 with
          | `Body(_lh_bodysurf_Body_0_0) -> 
            (let rec t_2 = (_lh_listcomp_fun_2 _lh_listcomp_fun_ls_t_1) in
      ...
      | `LH_C(_lh_listcomp_fun_ls_h_2, _lh_listcomp_fun_ls_t_2) -> 
        (match _lh_listcomp_fun_ls_h_2 with
          | `Specpow(_lh_specpowsurf_Specpow_0_0) -> 
            (let rec t_5 = (_lh_listcomp_fun_3 _lh_listcomp_fun_ls_t_2) in
...
let rec vecdot_lh__d2 _lh_vecdot_arg1_1 _lh_vecdot_arg2_1 =
  (match _lh_vecdot_arg1_1 with
    ...
    | _ -> 
      (failwith "error"));;
let rec vecscale_lh__d1_d4 _lh_vecscale_arg1_1_0 _lh_vecscale_arg2_1_1 =
  (match _lh_vecscale_arg1_1_0 with
    | `LH_P3(_lh_vecscale_LH_P3_0_1_0, _lh_vecscale_LH_P3_1_1_0, _lh_vecscale_LH_P3_2_1_0) -> 
      (let rec _lh_vecmult_LH_P3_2_8 = (_lh_vecscale_arg2_1_1 *. _lh_vecscale_LH_P3_2_1_0) in
        (let rec _lh_vecmult_LH_P3_1_8 = (_lh_vecscale_arg2_1_1 *. _lh_vecscale_LH_P3_1_1_0) in
          (let rec _lh_vecmult_LH_P3_0_8 = (_lh_vecscale_arg2_1_1 *. _lh_vecscale_LH_P3_0_1_0) in
            (fun _lh_vecmult_arg2_6 -> 
              (match _lh_vecmult_arg2_6 with
                | `LH_P3(_lh_vecmult_LH_P3_0_9, _lh_vecmult_LH_P3_1_9, _lh_vecmult_LH_P3_2_9) -> 
                  (let rec _lh_vecadd_LH_P3_2_2_7 = (_lh_vecmult_LH_P3_2_8 *. _lh_vecmult_LH_P3_2_9) in
                    (let rec _lh_vecadd_LH_P3_1_2_7 = (_lh_vecmult_LH_P3_1_8 *. _lh_vecmult_LH_P3_1_9) in
                      (let rec _lh_vecadd_LH_P3_0_2_7 = (_lh_vecmult_LH_P3_0_8 *. _lh_vecmult_LH_P3_0_9) in
                        (fun _lh_vecadd_arg2_9 -> 
                          (((_lh_vecadd_arg2_9 _lh_vecadd_LH_P3_0_2_7) _lh_vecadd_LH_P3_1_2_7) _lh_vecadd_LH_P3_2_2_7)))))
                | _ -> 
                  (failwith "error"))))))
    | _ -> 
      (failwith "error"));;
...
let rec vecmult_lh__d2 _lh_vecmult_arg1_3 _lh_vecmult_arg2_7 =
  (_lh_vecmult_arg1_3 _lh_vecmult_arg2_7);;
let rec epsilon_lh__d1 =
  0.000001;;
let rec vecadd_lh__d8 _lh_vecadd_arg1_9 _lh_vecadd_arg2_1_2 =
  (_lh_vecadd_arg1_9 _lh_vecadd_arg2_1_2);;
let rec vecscale_lh__d1_d1 _lh_vecscale_arg1_1_4 _lh_vecscale_arg2_1_5 =
  (match _lh_vecscale_arg1_1_4 with
    | `LH_P3(_lh_vecscale_LH_P3_0_1_4, _lh_vecscale_LH_P3_1_1_4, _lh_vecscale_LH_P3_2_1_4) -> 
      (`LH_P3((_lh_vecscale_arg2_1_5 *. _lh_vecscale_LH_P3_0_1_4), (_lh_vecscale_arg2_1_5 *. _lh_vecscale_LH_P3_1_1_4), (_lh_vecscale_arg2_1_5 *. _lh_vecscale_LH_P3_2_1_4)))
    | _ -> 
      (failwith "error"));;
let rec vecadd_lh__d9 _lh_vecadd_arg1_1 _lh_vecadd_arg2_1 =
  (match _lh_vecadd_arg1_1 with
    | `LH_P3(_lh_vecadd_LH_P3_0_1_0, _lh_vecadd_LH_P3_1_1_0, _lh_vecadd_LH_P3_2_1_0) -> 
      (((_lh_vecadd_arg2_1 _lh_vecadd_LH_P3_0_1_0) _lh_vecadd_LH_P3_1_1_0) _lh_vecadd_LH_P3_2_1_0)
    | _ -> 
      (failwith "error"));;
let rec vecscale_lh__d1_d3 _lh_vecscale_arg1_4 _lh_vecscale_arg2_5 =
  (match _lh_vecscale_arg1_4 with
    | `LH_P3(_lh_vecscale_LH_P3_0_5, _lh_vecscale_LH_P3_1_5, _lh_vecscale_LH_P3_2_5) -> 
      (let rec _lh_vecmult_LH_P3_2_2 = (_lh_vecscale_arg2_5 *. _lh_vecscale_LH_P3_2_5) in
        (let rec _lh_vecmult_LH_P3_1_2 = (_lh_vecscale_arg2_5 *. _lh_vecscale_LH_P3_1_5) in
          (let rec _lh_vecmult_LH_P3_0_2 = (_lh_vecscale_arg2_5 *. _lh_vecscale_LH_P3_0_5) in
            (fun _lh_vecmult_arg2_2 -> 
              (match _lh_vecmult_arg2_2 with
                | `LH_P3(_lh_vecmult_LH_P3_0_3, _lh_vecmult_LH_P3_1_3, _lh_vecmult_LH_P3_2_3) -> 
                  (let rec _lh_vecadd_LH_P3_2_1_6 = (_lh_vecmult_LH_P3_2_2 *. _lh_vecmult_LH_P3_2_3) in
                    (let rec _lh_vecadd_LH_P3_1_1_6 = (_lh_vecmult_LH_P3_1_2 *. _lh_vecmult_LH_P3_1_3) in
                      (let rec _lh_vecadd_LH_P3_0_1_6 = (_lh_vecmult_LH_P3_0_2 *. _lh_vecmult_LH_P3_0_3) in
...
let rec vecmult_lh__d4 _lh_vecmult_arg1_1 _lh_vecmult_arg2_1 =
  (_lh_vecmult_arg1_1 _lh_vecmult_arg2_1);;
            ...
            (fun _lh_vecmult_arg2_4 -> 
              (match _lh_vecmult_arg2_4 with
                | `LH_P3(_lh_vecmult_LH_P3_0_5, _lh_vecmult_LH_P3_1_5, _lh_vecmult_LH_P3_2_5) -> 
                  (let rec _lh_vecadd_LH_P3_2_1_8 = (_lh_vecmult_LH_P3_2_4 *. _lh_vecmult_LH_P3_2_5) in
                    (let rec _lh_vecadd_LH_P3_1_1_8 = (_lh_vecmult_LH_P3_1_4 *. _lh_vecmult_LH_P3_1_5) in
                      (let rec _lh_vecadd_LH_P3_0_1_8 = (_lh_vecmult_LH_P3_0_4 *. _lh_vecmult_LH_P3_0_5) in
                        (fun _lh_vecadd_LH_P3_0_1_9 _lh_vecadd_LH_P3_1_1_9 _lh_vecadd_LH_P3_2_1_9 -> 
                          (`LH_P3((_lh_vecadd_LH_P3_0_1_9 +. _lh_vecadd_LH_P3_0_1_8), (_lh_vecadd_LH_P3_1_1_9 +. _lh_vecadd_LH_P3_1_1_8), (_lh_vecadd_LH_P3_2_1_9 +. _lh_vecadd_LH_P3_2_1_8)))))))
                | _ -> 
                  (failwith "error"))))))
    | _ -> 
      (failwith "error"));;
let rec vecscale_lh__d1_d5 _lh_vecscale_arg1_9 _lh_vecscale_arg2_1_0 =
...
let rec tail_lh__d1 ls_7 =
  (match ls_7 with
    ...
    | `LH_N -> 
      (failwith "error"));;
let rec vecdot_lh__d4 _lh_vecdot_arg1_3 _lh_vecdot_arg2_3 =
...
let rec sphereintersect_lh__d1 _lh_sphereintersect_arg1_0 _lh_sphereintersect_arg2_0 _lh_sphereintersect_arg3_0 =
  (match _lh_sphereintersect_arg3_0 with
    | `Sphere(_lh_sphereintersect_Sphere_0_0, _lh_sphereintersect_Sphere_1_0, _lh_sphereintersect_Sphere_2_0) -> 
      (let rec m_0 = ((vecsub_lh__d2 _lh_sphereintersect_arg1_0) _lh_sphereintersect_Sphere_0_0) in
        (let rec bm_0 = ((vecdot_lh__d4 m_0) _lh_sphereintersect_arg2_0) in
          (let rec m2_0 = ((vecdot_lh__d4 m_0) m_0) in
                      ...
                      (let rec _lh_trace_LH_P2_0_3 = false in
                        (fun _lh_trace_LH_C_0_1 _lh_trace_LH_C_1_1 sphmap_1 -> 
                          (if _lh_trace_LH_P2_0_3 then
                            (`LH_C((`LH_P2(_lh_trace_LH_P2_1_3, _lh_trace_LH_C_0_1)), (sphmap_1 _lh_trace_LH_C_1_1)))
                          else
                          ...
                          (let rec _lh_trace_LH_P2_0_4 = false in
                            (fun _lh_trace_LH_C_0_2 _lh_trace_LH_C_1_2 sphmap_2 -> 
                              (if _lh_trace_LH_P2_0_4 then
                                (`LH_C((`LH_P2(_lh_trace_LH_P2_1_4, _lh_trace_LH_C_0_2)), (sphmap_2 _lh_trace_LH_C_1_2)))
                              else
                          ...
                          (let rec _lh_trace_LH_P2_0_5 = true in
                            (fun _lh_trace_LH_C_0_3 _lh_trace_LH_C_1_3 sphmap_3 -> 
                              (if _lh_trace_LH_P2_0_5 then
                                (`LH_C((`LH_P2(_lh_trace_LH_P2_1_5, _lh_trace_LH_C_0_3)), (sphmap_3 _lh_trace_LH_C_1_3)))
                              else
                        ...
                        (let rec _lh_trace_LH_P2_0_6 = true in
                          (fun _lh_trace_LH_C_0_4 _lh_trace_LH_C_1_4 sphmap_4 -> 
                            (if _lh_trace_LH_P2_0_6 then
                              (`LH_C((`LH_P2(_lh_trace_LH_P2_1_6, _lh_trace_LH_C_0_4)), (sphmap_4 _lh_trace_LH_C_1_4)))
                            else
...
let rec trace_lh__d1 _lh_trace_arg1_0 _lh_trace_arg2_0 _lh_trace_arg3_0 =
  (let rec f_1_4 = (fun d1s1_0 d2s2_0 -> 
    ...
    (let rec sphmap_0 = (fun xss_0 -> 
        ...
        (match _lh_matchIdent_1_8 with
          ...
          | `LH_C(_lh_trace_LH_C_0_0, _lh_trace_LH_C_1_0) -> 
            (let rec _lh_matchIdent_1_9 = (((sphereintersect_lh__d1 _lh_trace_arg2_0) _lh_trace_arg3_0) _lh_trace_LH_C_0_0) in
              (((_lh_matchIdent_1_9 _lh_trace_LH_C_0_0) _lh_trace_LH_C_1_0) sphmap_0))
          | _ -> 
            (failwith "error")))) in
      (let rec dists_0 = (sphmap_0 _lh_trace_arg1_0) in
        (if (null_lh__d1 dists_0) then
          ...
          (let rec _lh_matchIdent_2_0 = (((foldr_lh__d2 f_1_4) (head_lh__d1 dists_0)) (tail_lh__d1 dists_0)) in
...
let rec shadowed_lh__d1 _lh_shadowed_arg1_0 _lh_shadowed_arg2_0 _lh_shadowed_arg3_0 =
  (let rec _lh_matchIdent_0 = (((trace_lh__d1 testspheres_lh__d1) ((vecadd_lh__d1_d0 _lh_shadowed_arg1_0) ((vecscale_lh__d1_d5 _lh_shadowed_arg2_0) epsilon_lh__d1))) _lh_shadowed_arg2_0) in
                    ...
                    (let rec spow_0 = (specpowsurf_lh__d1 _lh_lightray_arg5_0) in
                      (if (cosangle_0 <= 0.0) then
                        (let rec bodycol_0 = (bodysurf_lh__d2 _lh_lightray_arg5_0) in
                          (let rec cosalpha_0 = (0.0 -. ((vecdot_lh__d3 _lh_lightray_arg4_0) _lh_lightray_LH_P2_0_1)) in
                            (let rec diffcont_0 = ((vecmult_lh__d5 ((vecscale_lh__d1_d1 diff_0) (0.0 -. cosangle_0))) _lh_lightray_LH_P2_1_0) in
                              (let rec speccont_0 = (if (cosalpha_0 <= 0.0) then
                                ...
                                ((vecmult_lh__d2 ((vecscale_lh__d1_d3 bodycol_0) (cosalpha_0 ** spow_0))) _lh_lightray_LH_P2_1_0)) in
                                ((vecadd_lh__d9 diffcont_0) speccont_0)))))
                      else
                        (let rec spec_0 = (specularsurf_lh__d2 _lh_lightray_arg5_0) in
                          (let rec cosalpha_1 = ((vecdot_lh__d2 _lh_lightray_arg4_0) _lh_lightray_LH_P2_0_1) in
                            (let rec diffcont_1 = ((vecmult_lh__d3 ((vecscale_lh__d1_d4 diff_0) cosangle_0)) _lh_lightray_LH_P2_1_0) in
                              (let rec speccont_1 = (if (cosalpha_1 <= 0.0) then
                                ...
                                ((vecmult_lh__d4 ((vecscale_lh__d1_d2 spec_0) (cosalpha_1 ** spow_0))) _lh_lightray_LH_P2_1_0)) in
                    ...
                    (let rec spow_1 = (specpowsurf_lh__d1 _lh_lightray_arg5_1) in
                      (if (cosangle_1 <= 0.0) then
                        (let rec bodycol_1 = (bodysurf_lh__d2 _lh_lightray_arg5_1) in
                          (let rec cosalpha_2 = (0.0 -. ((vecdot_lh__d3 _lh_lightray_arg4_1) _lh_lightray_LH_P2_0_3)) in
                            (let rec diffcont_2 = ((vecmult_lh__d5 ((vecscale_lh__d1_d1 diff_1) (0.0 -. cosangle_1))) _lh_lightray_LH_P2_1_1) in
                              (let rec speccont_2 = (if (cosalpha_2 <= 0.0) then
                                ...
                                ((vecmult_lh__d2 ((vecscale_lh__d1_d3 bodycol_1) (cosalpha_2 ** spow_1))) _lh_lightray_LH_P2_1_1)) in
                                ((vecadd_lh__d9 diffcont_2) speccont_2)))))
                      else
                        (let rec spec_1 = (specularsurf_lh__d2 _lh_lightray_arg5_1) in
                          (let rec cosalpha_3 = ((vecdot_lh__d2 _lh_lightray_arg4_1) _lh_lightray_LH_P2_0_3) in
                            (let rec diffcont_3 = ((vecmult_lh__d3 ((vecscale_lh__d1_d4 diff_1) cosangle_1)) _lh_lightray_LH_P2_1_1) in
                              (let rec speccont_3 = (if (cosalpha_3 <= 0.0) then
                                ...
                                ((vecmult_lh__d4 ((vecscale_lh__d1_d2 spec_1) (cosalpha_3 ** spow_1))) _lh_lightray_LH_P2_1_1)) in
  ...
  (let rec _lh_matchIdent_7 = ((lightdirection_lh__d1 _lh_lightray_arg1_0) _lh_lightray_arg2_0) in
    (match _lh_matchIdent_7 with
      | `LH_P2(_lh_lightray_LH_P2_0_4, _lh_lightray_LH_P2_1_2) -> 
        (let rec cosangle_2 = ((vecdot_lh__d4 _lh_lightray_LH_P2_0_4) _lh_lightray_arg3_0) in
      ...
      | _ -> 
        (failwith "error")));;
let rec vecadd_lh__d6 _lh_vecadd_arg1_2 _lh_vecadd_arg2_3 =
...
let rec ambientsurf_lh__d1 _lh_ambientsurf_arg1_0 =
  (head_lh__d4 ((mappend_lh__d2 (let rec _lh_listcomp_fun_1_0 = (fun _lh_listcomp_fun_para_6 -> 
          ...
          | `Ambient(_lh_ambientsurf_Ambient_0_0) -> 
            (let rec t_1_1 = (_lh_listcomp_fun_1_0 _lh_listcomp_fun_ls_t_8) in
              (let rec h_9 = _lh_ambientsurf_Ambient_0_0 in
                (fun ys_1_2 -> 
                  (`LH_C(h_9, ((mappend_lh__d2 t_1_1) ys_1_2))))))
          | _ -> 
...
let rec vecadd_lh__d4 _lh_vecadd_arg1_3 _lh_vecadd_arg2_4 =
  (_lh_vecadd_arg1_3 _lh_vecadd_arg2_4);;
let rec bodysurf_lh__d1 _lh_bodysurf_arg1_1 =
  (head_lh__d5 ((mappend_lh__d3 (let rec _lh_listcomp_fun_1_1 = (fun _lh_listcomp_fun_para_7 -> 
          ...
          | `Body(_lh_bodysurf_Body_0_1) -> 
            (let rec t_1_2 = (_lh_listcomp_fun_1_1 _lh_listcomp_fun_ls_t_9) in
              (let rec h_1_0 = _lh_bodysurf_Body_0_1 in
                (fun ys_1_4 -> 
                  (`LH_C(h_1_0, ((mappend_lh__d3 t_1_2) ys_1_4))))))
          | _ -> 
...
let rec spherenormal_lh__d1 _lh_spherenormal_arg1_0 _lh_spherenormal_arg2_0 =
  (match _lh_spherenormal_arg2_0 with
    | `Sphere(_lh_spherenormal_Sphere_0_0, _lh_spherenormal_Sphere_1_0, _lh_spherenormal_Sphere_2_0) -> 
      ((vecscale_lh__d1_d5 ((vecsub_lh__d2 _lh_spherenormal_arg1_0) _lh_spherenormal_Sphere_0_0)) (1.0 /. _lh_spherenormal_Sphere_1_0))
    | _ -> 
      (failwith "error"));;
...
let rec vecscale_lh__d8 _lh_vecscale_arg1_7 _lh_vecscale_arg2_8 =
  (match _lh_vecscale_arg1_7 with
    | `LH_P3(_lh_vecscale_LH_P3_0_7, _lh_vecscale_LH_P3_1_7, _lh_vecscale_LH_P3_2_7) -> 
      (`LH_P3((_lh_vecscale_arg2_8 *. _lh_vecscale_LH_P3_0_7), (_lh_vecscale_arg2_8 *. _lh_vecscale_LH_P3_1_7), (_lh_vecscale_arg2_8 *. _lh_vecscale_LH_P3_2_7)))
    | _ -> 
      (failwith "error"));;
let rec vecscale_lh__d9 _lh_vecscale_arg1_8 _lh_vecscale_arg2_9 =
  (match _lh_vecscale_arg1_8 with
    | `LH_P3(_lh_vecscale_LH_P3_0_8, _lh_vecscale_LH_P3_1_8, _lh_vecscale_LH_P3_2_8) -> 
      (let rec _lh_vecadd_LH_P3_2_2_4 = (_lh_vecscale_arg2_9 *. _lh_vecscale_LH_P3_2_8) in
        (let rec _lh_vecadd_LH_P3_1_2_4 = (_lh_vecscale_arg2_9 *. _lh_vecscale_LH_P3_1_8) in
          (let rec _lh_vecadd_LH_P3_0_2_4 = (_lh_vecscale_arg2_9 *. _lh_vecscale_LH_P3_0_8) in
            (fun _lh_vecadd_LH_P3_0_2_5 _lh_vecadd_LH_P3_1_2_5 _lh_vecadd_LH_P3_2_2_5 -> 
              (`LH_P3((_lh_vecadd_LH_P3_0_2_5 +. _lh_vecadd_LH_P3_0_2_4), (_lh_vecadd_LH_P3_1_2_5 +. _lh_vecadd_LH_P3_1_2_4), (_lh_vecadd_LH_P3_2_2_5 +. _lh_vecadd_LH_P3_2_2_4)))))))
    | _ -> 
      (failwith "error"));;
let rec map_lh__d2 f_8 ls_6 =
  (ls_6 f_8);;
let rec vecadd_lh__d7 _lh_vecadd_arg1_5 _lh_vecadd_arg2_7 =
  (match _lh_vecadd_arg1_5 with
    | `LH_P3(_lh_vecadd_LH_P3_0_2_6, _lh_vecadd_LH_P3_1_2_6, _lh_vecadd_LH_P3_2_2_6) -> 
      (((_lh_vecadd_arg2_7 _lh_vecadd_LH_P3_0_2_6) _lh_vecadd_LH_P3_1_2_6) _lh_vecadd_LH_P3_2_2_6)
    | _ -> 
      (failwith "error"));;
          ...
          | `Refract(_lh_refractsurf_Refract_0_0) -> 
            (let rec t_1_6 = (_lh_listcomp_fun_1_5 _lh_listcomp_fun_ls_t_1_1) in
              (let rec h_1_4 = _lh_refractsurf_Refract_0_0 in
                (fun ys_1_7 -> 
                  (`LH_C(h_1_4, ((mappend_lh__d1 t_1_6) ys_1_7))))))
          | _ -> 
...
let rec vecadd_lh__d5 _lh_vecadd_arg1_7 _lh_vecadd_arg2_1_0 =
  (match _lh_vecadd_arg1_7 with
    | `LH_P3(_lh_vecadd_LH_P3_0_2_8, _lh_vecadd_LH_P3_1_2_8, _lh_vecadd_LH_P3_2_2_8) -> 
      (((_lh_vecadd_arg2_1_0 _lh_vecadd_LH_P3_0_2_8) _lh_vecadd_LH_P3_1_2_8) _lh_vecadd_LH_P3_2_2_8)
    | _ -> 
      (failwith "error"));;
let rec vecscale_lh__d1_d0 _lh_vecscale_arg1_1_1 _lh_vecscale_arg2_1_2 =
  (match _lh_vecscale_arg1_1_1 with
    | `LH_P3(_lh_vecscale_LH_P3_0_1_1, _lh_vecscale_LH_P3_1_1_1, _lh_vecscale_LH_P3_2_1_1) -> 
      (let rec _lh_vecadd_LH_P3_2_2_9 = (_lh_vecscale_arg2_1_2 *. _lh_vecscale_LH_P3_2_1_1) in
        (let rec _lh_vecadd_LH_P3_1_2_9 = (_lh_vecscale_arg2_1_2 *. _lh_vecscale_LH_P3_1_1_1) in
          (let rec _lh_vecadd_LH_P3_0_2_9 = (_lh_vecscale_arg2_1_2 *. _lh_vecscale_LH_P3_0_1_1) in
    ...
    | _ -> 
      (failwith "error"));;
let rec vecmult_lh__d1 _lh_vecmult_arg1_4 _lh_vecmult_arg2_8 =
  (_lh_vecmult_arg1_4 _lh_vecmult_arg2_8);;
let rec foldr_lh__d3 f_7 i_4 ls_4 =
  ((ls_4 f_7) i_4);;
...
let rec transmitsurf_lh__d1 _lh_transmitsurf_arg1_0 =
  (head_lh__d5 ((mappend_lh__d3 (let rec _lh_listcomp_fun_1_7 = (fun _lh_listcomp_fun_para_1_1 -> 
          ...
          | `Transmit(_lh_transmitsurf_Transmit_0_0) -> 
            (let rec t_1_9 = (_lh_listcomp_fun_1_7 _lh_listcomp_fun_ls_t_1_3) in
              (let rec h_1_7 = _lh_transmitsurf_Transmit_0_0 in
                (fun ys_2_1 -> 
                  (`LH_C(h_1_7, ((mappend_lh__d3 t_1_9) ys_2_1))))))
          | _ -> 
...
let rec reflectray_lh__d1 _lh_reflectray_arg1_0 _lh_reflectray_arg2_0 _lh_reflectray_arg3_0 _lh_reflectray_arg4_0 _lh_reflectray_arg5_0 _lh_reflectray_arg6_0 =
  (let rec newcontrib_4 = ((vecmult_lh__d5 _lh_reflectray_arg4_0) _lh_reflectray_arg5_0) in
    (let rec nearpos_4 = ((vecadd_lh__d1_d0 _lh_reflectray_arg1_0) ((vecscale_lh__d1_d5 _lh_reflectray_arg2_0) epsilon_lh__d1)) in
      (let rec _lh_matchIdent_1_0 = (((trace_lh__d1 testspheres_lh__d1) nearpos_4) _lh_reflectray_arg2_0) in
          ...
          | `LH_P3(_lh_reflectray_LH_P3_0_0, _lh_reflectray_LH_P3_1_0, _lh_reflectray_LH_P3_2_0) -> 
            (let rec newcol_4 = (if _lh_reflectray_LH_P3_0_0 then
              ...
              (if (is_zerovector_lh__d1 newcontrib_4) then
                ...
                ((vecadd_lh__d1_d0 _lh_reflectray_arg6_0) ((vecmult_lh__d5 newcol_4) _lh_reflectray_arg4_0))))
          | _ -> 
            (failwith "error")))))
and
refractray_lh__d1 _lh_refractray_arg1_0 _lh_refractray_arg2_0 _lh_refractray_arg3_0 =
  (let rec dotp_0 = (0.0 -. ((vecdot_lh__d4 _lh_refractray_arg2_0) _lh_refractray_arg3_0)) in
    (let rec _lh_matchIdent_1 = (if (dotp_0 < 0.0) then
      (let rec _lh_refractray_LH_P3_2_0 = (1.0 /. _lh_refractray_arg1_0) in
        (let rec _lh_refractray_LH_P3_1_0 = (0.0 -. dotp_0) in
          (let rec _lh_refractray_LH_P3_0_0 = ((vecscale_lh__d1_d5 _lh_refractray_arg3_0) (0.0 -. 1.0)) in
              ...
              (let rec disc_0 = (((1.0 -. _lh_refractray_LH_P3_2_0) *. _lh_refractray_LH_P3_2_0) *. (1.0 -. (_lh_refractray_LH_P3_1_0 *. _lh_refractray_LH_P3_1_0))) in
                (let rec t_3 = ((_lh_refractray_LH_P3_2_0 *. _lh_refractray_LH_P3_1_0) -. (sqrt disc_0)) in
                  (if (disc_0 < 0.0) then
                    (let rec _lh_transmitray_LH_P2_1_0 = (`LH_P3(0.0, 0.0, 0.0)) in
                      (let rec _lh_transmitray_LH_P2_0_0 = true in
                        (fun _lh_transmitray_arg1_0 _lh_transmitray_arg2_0 _lh_transmitray_arg3_0 _lh_transmitray_arg6_0 newcontrib_0 -> 
                          (let rec nearpos_0 = ((vecadd_lh__d1_d0 _lh_transmitray_arg3_0) ((vecscale_lh__d1_d5 _lh_transmitray_LH_P2_1_0) epsilon_lh__d1)) in
                            (let rec _lh_matchIdent_2 = (((trace_lh__d1 testspheres_lh__d1) nearpos_0) _lh_transmitray_LH_P2_1_0) in
                                ...
                                | `LH_P3(_lh_transmitray_LH_P3_0_0, _lh_transmitray_LH_P3_1_0, _lh_transmitray_LH_P3_2_0) -> 
                                  (let rec newcol_0 = (if _lh_transmitray_LH_P3_0_0 then
                                    ...
                                    (if (is_zerovector_lh__d1 newcontrib_0) then
                                          ...
                                          (fun _lh_shade_arg1_0 _lh_shade_arg6_0 hitpos_0 refl_0 surf_0 trintensity_0 -> 
                                            (let rec reflsurf_0 = ((vecscale_lh__d7 (specularsurf_lh__d1 surf_0)) (reflectsurf_lh__d1 surf_0)) in
                                              (let rec reflectiv_0 = (if _lh_shade_LH_P2_0_0 then
                                                ((vecadd_lh__d6 trintensity_0) reflsurf_0)
                                              else
                                                reflsurf_0) in
                                      ...
                                      (let rec _lh_shade_LH_P2_1_1 = ((vecadd_lh__d1_d0 ((vecmult_lh__d5 newcol_0) _lh_transmitray_arg6_0)) _lh_transmitray_arg2_0) in
                                          ...
                                          (fun _lh_shade_arg1_1 _lh_shade_arg6_1 hitpos_1 refl_1 surf_1 trintensity_1 -> 
                                            (let rec reflsurf_1 = ((vecscale_lh__d7 (specularsurf_lh__d1 surf_1)) (reflectsurf_lh__d1 surf_1)) in
                                              (let rec reflectiv_1 = (if _lh_shade_LH_P2_0_1 then
                                                ((vecadd_lh__d6 trintensity_1) reflsurf_1)
                                              else
                                                reflsurf_1) in
                    ...
                    (let rec _lh_transmitray_LH_P2_1_1 = ((vecadd_lh__d1_d0 ((vecscale_lh__d1_d5 _lh_refractray_LH_P3_0_0) t_3)) ((vecscale_lh__d1_d5 _lh_refractray_arg2_1) _lh_refractray_LH_P3_2_0)) in
                      (let rec _lh_transmitray_LH_P2_0_1 = false in
                        (fun _lh_transmitray_arg1_1 _lh_transmitray_arg2_1 _lh_transmitray_arg3_1 _lh_transmitray_arg6_1 newcontrib_1 -> 
                          (let rec nearpos_1 = ((vecadd_lh__d1_d0 _lh_transmitray_arg3_1) ((vecscale_lh__d1_d5 _lh_transmitray_LH_P2_1_1) epsilon_lh__d1)) in
                            (let rec _lh_matchIdent_3 = (((trace_lh__d1 testspheres_lh__d1) nearpos_1) _lh_transmitray_LH_P2_1_1) in
                                ...
                                | `LH_P3(_lh_transmitray_LH_P3_0_1, _lh_transmitray_LH_P3_1_1, _lh_transmitray_LH_P3_2_1) -> 
                                  (let rec newcol_1 = (if _lh_transmitray_LH_P3_0_1 then
                                    ...
                                    (if (is_zerovector_lh__d1 newcontrib_1) then
                                          ...
                                          (fun _lh_shade_arg1_2 _lh_shade_arg6_2 hitpos_2 refl_2 surf_2 trintensity_2 -> 
                                            (let rec reflsurf_2 = ((vecscale_lh__d7 (specularsurf_lh__d1 surf_2)) (reflectsurf_lh__d1 surf_2)) in
                                              (let rec reflectiv_2 = (if _lh_shade_LH_P2_0_2 then
                                                ((vecadd_lh__d6 trintensity_2) reflsurf_2)
                                              else
                                                reflsurf_2) in
                                      ...
                                      (let rec _lh_shade_LH_P2_1_3 = ((vecadd_lh__d1_d0 ((vecmult_lh__d5 newcol_1) _lh_transmitray_arg6_1)) _lh_transmitray_arg2_1) in
                                          ...
                                          (fun _lh_shade_arg1_3 _lh_shade_arg6_3 hitpos_3 refl_3 surf_3 trintensity_3 -> 
                                            (let rec reflsurf_3 = ((vecscale_lh__d7 (specularsurf_lh__d1 surf_3)) (reflectsurf_lh__d1 surf_3)) in
                                              (let rec reflectiv_3 = (if _lh_shade_LH_P2_0_3 then
                                                ((vecadd_lh__d6 trintensity_3) reflsurf_3)
                                              else
                                                reflsurf_3) in
              ...
              (let rec disc_1 = (((1.0 -. _lh_refractray_LH_P3_2_1) *. _lh_refractray_LH_P3_2_1) *. (1.0 -. (_lh_refractray_LH_P3_1_1 *. _lh_refractray_LH_P3_1_1))) in
                (let rec t_4 = ((_lh_refractray_LH_P3_2_1 *. _lh_refractray_LH_P3_1_1) -. (sqrt disc_1)) in
                  (if (disc_1 < 0.0) then
                    (let rec _lh_transmitray_LH_P2_1_2 = (`LH_P3(0.0, 0.0, 0.0)) in
                      (let rec _lh_transmitray_LH_P2_0_2 = true in
                        (fun _lh_transmitray_arg1_2 _lh_transmitray_arg2_2 _lh_transmitray_arg3_2 _lh_transmitray_arg6_2 newcontrib_2 -> 
                          (let rec nearpos_2 = ((vecadd_lh__d1_d0 _lh_transmitray_arg3_2) ((vecscale_lh__d1_d5 _lh_transmitray_LH_P2_1_2) epsilon_lh__d1)) in
                            (let rec _lh_matchIdent_4 = (((trace_lh__d1 testspheres_lh__d1) nearpos_2) _lh_transmitray_LH_P2_1_2) in
                                ...
                                | `LH_P3(_lh_transmitray_LH_P3_0_2, _lh_transmitray_LH_P3_1_2, _lh_transmitray_LH_P3_2_2) -> 
                                  (let rec newcol_2 = (if _lh_transmitray_LH_P3_0_2 then
                                    ...
                                    (if (is_zerovector_lh__d1 newcontrib_2) then
                                          ...
                                          (fun _lh_shade_arg1_4 _lh_shade_arg6_4 hitpos_4 refl_4 surf_4 trintensity_4 -> 
                                            (let rec reflsurf_4 = ((vecscale_lh__d7 (specularsurf_lh__d1 surf_4)) (reflectsurf_lh__d1 surf_4)) in
                                              (let rec reflectiv_4 = (if _lh_shade_LH_P2_0_4 then
                                                ((vecadd_lh__d6 trintensity_4) reflsurf_4)
                                              else
                                                reflsurf_4) in
                                      ...
                                      (let rec _lh_shade_LH_P2_1_5 = ((vecadd_lh__d1_d0 ((vecmult_lh__d5 newcol_2) _lh_transmitray_arg6_2)) _lh_transmitray_arg2_2) in
                                          ...
                                          (fun _lh_shade_arg1_5 _lh_shade_arg6_5 hitpos_5 refl_5 surf_5 trintensity_5 -> 
                                            (let rec reflsurf_5 = ((vecscale_lh__d7 (specularsurf_lh__d1 surf_5)) (reflectsurf_lh__d1 surf_5)) in
                                              (let rec reflectiv_5 = (if _lh_shade_LH_P2_0_5 then
                                                ((vecadd_lh__d6 trintensity_5) reflsurf_5)
                                              else
                                                reflsurf_5) in
                    ...
                    (let rec _lh_transmitray_LH_P2_1_3 = ((vecadd_lh__d1_d0 ((vecscale_lh__d1_d5 _lh_refractray_LH_P3_0_1) t_4)) ((vecscale_lh__d1_d5 _lh_refractray_arg2_2) _lh_refractray_LH_P3_2_1)) in
                      (let rec _lh_transmitray_LH_P2_0_3 = false in
                        (fun _lh_transmitray_arg1_3 _lh_transmitray_arg2_3 _lh_transmitray_arg3_3 _lh_transmitray_arg6_3 newcontrib_3 -> 
                          (let rec nearpos_3 = ((vecadd_lh__d1_d0 _lh_transmitray_arg3_3) ((vecscale_lh__d1_d5 _lh_transmitray_LH_P2_1_3) epsilon_lh__d1)) in
                            (let rec _lh_matchIdent_5 = (((trace_lh__d1 testspheres_lh__d1) nearpos_3) _lh_transmitray_LH_P2_1_3) in
                                ...
                                | `LH_P3(_lh_transmitray_LH_P3_0_3, _lh_transmitray_LH_P3_1_3, _lh_transmitray_LH_P3_2_3) -> 
                                  (let rec newcol_3 = (if _lh_transmitray_LH_P3_0_3 then
                                    ...
                                    (if (is_zerovector_lh__d1 newcontrib_3) then
                                          ...
                                          (fun _lh_shade_arg1_6 _lh_shade_arg6_6 hitpos_6 refl_6 surf_6 trintensity_6 -> 
                                            (let rec reflsurf_6 = ((vecscale_lh__d7 (specularsurf_lh__d1 surf_6)) (reflectsurf_lh__d1 surf_6)) in
                                              (let rec reflectiv_6 = (if _lh_shade_LH_P2_0_6 then
                                                ((vecadd_lh__d6 trintensity_6) reflsurf_6)
                                              else
                                                reflsurf_6) in
                                      ...
                                      (let rec _lh_shade_LH_P2_1_7 = ((vecadd_lh__d1_d0 ((vecmult_lh__d5 newcol_3) _lh_transmitray_arg6_3)) _lh_transmitray_arg2_3) in
                                          ...
                                          (fun _lh_shade_arg1_7 _lh_shade_arg6_7 hitpos_7 refl_7 surf_7 trintensity_7 -> 
                                            (let rec reflsurf_7 = ((vecscale_lh__d7 (specularsurf_lh__d1 surf_7)) (reflectsurf_lh__d1 surf_7)) in
                                              (let rec reflectiv_7 = (if _lh_shade_LH_P2_0_7 then
                                                ((vecadd_lh__d6 trintensity_7) reflsurf_7)
                                              else
                                                reflsurf_7) in
...
shade_lh__d1 _lh_shade_arg1_8 _lh_shade_arg2_0 _lh_shade_arg3_0 _lh_shade_arg4_0 _lh_shade_arg5_0 _lh_shade_arg6_8 =
  (let rec hitpos_8 = ((vecadd_lh__d5 _lh_shade_arg3_0) ((vecscale_lh__d9 _lh_shade_arg4_0) _lh_shade_arg5_0)) in
          ...
          (fun _lh_vecmult_arg2_5 -> 
            (match _lh_vecmult_arg2_5 with
              | `LH_P3(_lh_vecmult_LH_P3_0_7, _lh_vecmult_LH_P3_1_7, _lh_vecmult_LH_P3_2_7) -> 
                (let rec _lh_vecadd_LH_P3_2_2_2 = (_lh_vecmult_LH_P3_2_6 *. _lh_vecmult_LH_P3_2_7) in
                  (let rec _lh_vecadd_LH_P3_1_2_2 = (_lh_vecmult_LH_P3_1_6 *. _lh_vecmult_LH_P3_1_7) in
                    (let rec _lh_vecadd_LH_P3_0_2_2 = (_lh_vecmult_LH_P3_0_6 *. _lh_vecmult_LH_P3_0_7) in
      ...
      (let rec surf_8 = (spheresurf_lh__d1 _lh_shade_arg2_0) in
        (let rec amb_0 = ((vecmult_lh__d1 ambientlight_0) (ambientsurf_lh__d1 surf_8)) in
          (let rec norm_0 = ((spherenormal_lh__d1 hitpos_8) _lh_shade_arg2_0) in
            (let rec refl_8 = ((vecadd_lh__d7 _lh_shade_arg4_0) ((vecscale_lh__d1_d0 norm_0) ((0.0 -. 2.0) *. ((vecdot_lh__d1 _lh_shade_arg4_0) norm_0)))) in
              (let rec diff_2 = (vecsum_lh__d1 ((map_lh__d2 (fun l_0 -> 
                ...
                (let rec transmitted_0 = (transmitsurf_lh__d1 surf_8) in
                  (let rec simple_0 = ((vecadd_lh__d4 amb_0) diff_2) in
                            ...
                            (fun _lh_shade_arg1_9 _lh_shade_arg6_9 hitpos_9 refl_9 surf_9 trintensity_9 -> 
                              (let rec reflsurf_8 = ((vecscale_lh__d7 (specularsurf_lh__d1 surf_9)) (reflectsurf_lh__d1 surf_9)) in
                                (let rec reflectiv_8 = (if _lh_shade_LH_P2_0_8 then
                                  ((vecadd_lh__d6 trintensity_9) reflsurf_8)
                                else
                                  reflsurf_8) in
...
let rec lookfrom_lh__d2 =
  (`LH_P3(2.1, 1.3, 1.7));;
let rec vecadd_lh__d2 _lh_vecadd_arg1_8 _lh_vecadd_arg2_1_1 =
  (_lh_vecadd_arg1_8 _lh_vecadd_arg2_1_1);;
let rec background_lh__d1 =
  (`LH_P3(0.078, 0.361, 0.753));;
let rec vecscale_lh__d6 _lh_vecscale_arg1_1_3 _lh_vecscale_arg2_1_4 =
  (match _lh_vecscale_arg1_1_3 with
    | `LH_P3(_lh_vecscale_LH_P3_0_1_3, _lh_vecscale_LH_P3_1_1_3, _lh_vecscale_LH_P3_2_1_3) -> 
      (let rec _lh_vecadd_LH_P3_2_3_2 = (_lh_vecscale_arg2_1_4 *. _lh_vecscale_LH_P3_2_1_3) in
        (let rec _lh_vecadd_LH_P3_1_3_2 = (_lh_vecscale_arg2_1_4 *. _lh_vecscale_LH_P3_1_1_3) in
          (let rec _lh_vecadd_LH_P3_0_3_2 = (_lh_vecscale_arg2_1_4 *. _lh_vecscale_LH_P3_0_1_3) in
            (fun _lh_vecadd_LH_P3_0_3_3 _lh_vecadd_LH_P3_1_3_3 _lh_vecadd_LH_P3_2_3_3 -> 
              (let rec _lh_vecadd_LH_P3_2_3_4 = (_lh_vecadd_LH_P3_2_3_3 +. _lh_vecadd_LH_P3_2_3_2) in
                (let rec _lh_vecadd_LH_P3_1_3_4 = (_lh_vecadd_LH_P3_1_3_3 +. _lh_vecadd_LH_P3_1_3_2) in
                  (let rec _lh_vecadd_LH_P3_0_3_4 = (_lh_vecadd_LH_P3_0_3_3 +. _lh_vecadd_LH_P3_0_3_2) in
                    (fun _lh_vecadd_arg2_1_4 -> 
                      (((_lh_vecadd_arg2_1_4 _lh_vecadd_LH_P3_0_3_4) _lh_vecadd_LH_P3_1_3_4) _lh_vecadd_LH_P3_2_3_4)))))))))
    | _ -> 
      (failwith "error"));;
let rec tracepixel_lh__d1 _lh_tracepixel_arg1_0 _lh_tracepixel_arg2_0 _lh_tracepixel_arg3_0 _lh_tracepixel_arg4_0 _lh_tracepixel_arg5_0 _lh_tracepixel_arg6_0 _lh_tracepixel_arg7_0 =
  (let rec pos_0 = lookfrom_lh__d2 in
    (let rec _lh_matchIdent_1_4 = (vecnorm_lh__d4 ((vecadd_lh__d2 ((vecadd_lh__d3 _lh_tracepixel_arg5_0) ((vecscale_lh__d6 _lh_tracepixel_arg6_0) _lh_tracepixel_arg3_0))) ((vecscale_lh__d5 _lh_tracepixel_arg7_0) _lh_tracepixel_arg4_0))) in
...
let rec vecscale_lh__d1 _lh_vecscale_arg1_1_2 _lh_vecscale_arg2_1_3 =
  (match _lh_vecscale_arg1_1_2 with
    | `LH_P3(_lh_vecscale_LH_P3_0_1_2, _lh_vecscale_LH_P3_1_1_2, _lh_vecscale_LH_P3_2_1_2) -> 
      (let rec _lh_vecadd_LH_P3_2_3_1 = (_lh_vecscale_arg2_1_3 *. _lh_vecscale_LH_P3_2_1_2) in
        (let rec _lh_vecadd_LH_P3_1_3_1 = (_lh_vecscale_arg2_1_3 *. _lh_vecscale_LH_P3_1_1_2) in
          (let rec _lh_vecadd_LH_P3_0_3_1 = (_lh_vecscale_arg2_1_3 *. _lh_vecscale_LH_P3_0_1_2) in
            (fun _lh_vecadd_arg2_1_3 -> 
              (((_lh_vecadd_arg2_1_3 _lh_vecadd_LH_P3_0_3_1) _lh_vecadd_LH_P3_1_3_1) _lh_vecadd_LH_P3_2_3_1)))))
    | _ -> 
      (failwith "error"));;
let rec vecsub_lh__d1 _lh_vecsub_arg1_1 _lh_vecsub_arg2_1 =
  ...
  (if (a_0 <= b_0) then
    (let rec _lh_listcomp_fun_ls_t_5 = ((enumFromTo_lh__d2 (a_0 + 1)) b_0) in
      (let rec _lh_listcomp_fun_ls_h_5 = a_0 in
        (fun _lh_listcomp_fun_ls_h_6 _lh_listcomp_fun_6 f_1 _lh_listcomp_fun_ls_t_6 _lh_listcomp_fun_7 -> 
    ...
    (fun _lh_listcomp_fun_ls_h_7 _lh_listcomp_fun_8 f_4 _lh_listcomp_fun_ls_t_7 _lh_listcomp_fun_9 -> 
  ...
  (if (a_1 <= b_1) then
    (let rec _lh_listcomp_fun_ls_t_1_0 = ((enumFromTo_lh__d1 (a_1 + 1)) b_1) in
      (let rec _lh_listcomp_fun_ls_h_1_0 = a_1 in
        (fun _lh_listcomp_fun_1_2 _lh_ray_arg1_2 f_1_0 -> 
          (let rec _lh_listcomp_fun_1_3 = (fun _lh_listcomp_fun_para_8 -> 
            (((((_lh_listcomp_fun_para_8 _lh_listcomp_fun_ls_h_1_0) _lh_listcomp_fun_1_3) f_1_0) _lh_listcomp_fun_ls_t_1_0) _lh_listcomp_fun_1_2)) in
            (_lh_listcomp_fun_1_3 ((enumFromTo_lh__d2 0) (_lh_ray_arg1_2 - 1)))))))
  else
    (fun _lh_listcomp_fun_1_4 _lh_ray_arg1_3 f_1_1 f_1_2 f_1_3 i_5 -> 
      i_5));;
                            ...
                            (let rec yfov_0 = _lh_camparams_arg4_0 in
                              (let rec xwinsize_0 = _lh_camparams_arg5_0 in
                                (let rec ywinsize_0 = _lh_camparams_arg5_0 in
                                  (let rec magx_0 = (((2.0 *. _lh_camparams_LH_P2_1_1) *. (tan (dtor_lh__d2 (xfov_0 /. 2.0)))) /. xwinsize_0) in
                                    (let rec magy_0 = (((2.0 *. _lh_camparams_LH_P2_1_1) *. (tan (dtor_lh__d1 (yfov_0 /. 2.0)))) /. ywinsize_0) in
                                      (let rec scrnx_0 = ((vecscale_lh__d2 _lh_camparams_LH_P2_0_1) magx_0) in
                                        (let rec scrny_0 = ((vecscale_lh__d4 _lh_camparams_LH_P2_0_0) magy_0) in
                                          (let rec firstray_0 = ((vecsub_lh__d1 initfirstray_0) ((vecadd_lh__d1 ((vecscale_lh__d1 scrnx_0) (0.5 *. xwinsize_0))) ((vecscale_lh__d3 scrny_0) (0.5 *. ywinsize_0)))) in
                                                  ...
                                                  (fun _lh_ray_arg1_0 lights_0 -> 
                                                    (let rec f_0 = (fun i_0 j_0 -> 
                                                      ...
                                                      (let rec _lh_listcomp_fun_1 = (fun _lh_listcomp_fun_para_1 -> 
                                                        ...
                                                        (_lh_listcomp_fun_1 ((enumFromTo_lh__d1 0) (_lh_ray_arg1_0 - 1))))))))))))))))))))))))))
        | _ -> 
          (failwith "error"))
    | _ -> 
      (failwith "error"));;
  ...
  (let rec _lh_veccross_LH_P3_2_2 = 1.0 in
    (let rec _lh_veccross_LH_P3_1_2 = 0.0 in
      (let rec _lh_veccross_LH_P3_0_2 = 0.0 in
        (fun _lh_veccross_LH_P3_0_3 _lh_veccross_LH_P3_1_3 _lh_veccross_LH_P3_2_3 -> 
                  ...
                  (let rec len_1 = (sqrt (((_lh_vecnorm_LH_P3_0_1 *. _lh_vecnorm_LH_P3_0_1) +. (_lh_vecnorm_LH_P3_1_1 *. _lh_vecnorm_LH_P3_1_1)) +. (_lh_vecnorm_LH_P3_2_1 *. _lh_vecnorm_LH_P3_2_1))) in
                    (let rec _lh_camparams_LH_P2_1_2 = len_1 in
                      (let rec _lh_camparams_LH_P2_0_2 = (`LH_P3((_lh_vecnorm_LH_P3_0_1 /. len_1), (_lh_vecnorm_LH_P3_1_1 /. len_1), (_lh_vecnorm_LH_P3_2_1 /. len_1))) in
                        (fun _lh_camparams_LH_P2_0_3 _lh_camparams_LH_P2_1_3 _lh_camparams_arg4_1 _lh_camparams_arg5_1 initfirstray_1 -> 
...
let rec testlights_lh__d1 =
  (let rec t_2_1 = (let rec t_2_2 = (let rec t_2_3 = (fun f_1_5 f_1_6 i_6 -> 
    i_6) in
    (let rec h_1_9 = (`Point((`LH_P3((0.0 -. 3.0), 1.0, 5.0)), (`LH_P3(0.288675, 0.288675, 0.288675)))) in
      (fun f_1_7 -> 
        (let rec t_2_4 = ((map_lh__d2 f_1_7) t_2_3) in
          (let rec h_2_0 = (f_1_7 h_1_9) in
            (fun f_1_8 i_7 -> 
              ((f_1_8 h_2_0) (((foldr_lh__d3 f_1_8) i_7) t_2_4)))))))) in
    (let rec h_2_1 = (`Point((`LH_P3(1.0, (0.0 -. 4.0), 4.0)), (`LH_P3(0.288675, 0.288675, 0.288675)))) in
      (fun f_1_9 -> 
        (let rec t_2_5 = ((map_lh__d2 f_1_9) t_2_2) in
          (let rec h_2_2 = (f_1_9 h_2_1) in
            (fun f_2_0 i_8 -> 
              ((f_2_0 h_2_2) (((foldr_lh__d3 f_2_0) i_8) t_2_5)))))))) in
    (let rec h_2_3 = (`Point((`LH_P3(4.0, 3.0, 2.0)), (`LH_P3(0.288675, 0.288675, 0.288675)))) in
      (fun f_2_1 -> 
        (let rec t_2_6 = ((map_lh__d2 f_2_1) t_2_1) in
          (let rec h_2_4 = (f_2_1 h_2_3) in
            (fun f_2_2 i_9 -> 
              ((f_2_2 h_2_4) (((foldr_lh__d3 f_2_2) i_9) t_2_6))))))));;
let rec ray_lh__d1 _lh_ray_arg1_1 =
  (let rec lights_1 = testlights_lh__d1 in
    (let rec _lh_matchIdent_1_3 = (((((camparams_lh__d1 lookfrom_lh__d1) lookat_lh__d1) vup_lh__d1) fov_lh__d1) (float_of_int _lh_ray_arg1_1)) in
      ((_lh_matchIdent_1_3 _lh_ray_arg1_1) lights_1)));;
