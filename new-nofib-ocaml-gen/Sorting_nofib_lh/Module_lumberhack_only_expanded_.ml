...
let rec mappend_lh__d9 xs_2 ys_2 =
  (match xs_2 with
    | `LH_C(h_4, t_4) -> 
      (`LH_C(h_4, ((mappend_lh__d9 t_4) ys_2)))
    | `LH_N -> 
      ys_2);;
...
let rec ltList_lh__d1 _lh_ltList_arg1_2 _lh_ltList_arg2_2 =
  (let rec _lh_matchIdent_8 = ((compareList_lh__d1 _lh_ltList_arg1_2) _lh_ltList_arg2_2) in
    (match _lh_matchIdent_8 with
      | `LT -> 
        true
      | _ -> 
        false));;
let rec mappend_lh__d3 xs_8 ys_8 =
  (match xs_8 with
    | `LH_C(h_1_2, t_1_2) -> 
      (`LH_C(h_1_2, ((mappend_lh__d3 t_1_2) ys_8)))
    | `LH_N -> 
      ys_8);;
let rec mappend_lh__d1 xs_1_0 ys_1_0 =
  (match xs_1_0 with
    | `LH_C(h_1_4, t_1_4) -> 
      (`LH_C(h_1_4, ((mappend_lh__d1 t_1_4) ys_1_0)))
    | `LH_N -> 
      ys_1_0);;
let rec mappend_lh__d2 xs_9 ys_9 =
  (match xs_9 with
    | `LH_C(h_1_3, t_1_3) -> 
      (`LH_C(h_1_3, ((mappend_lh__d2 t_1_3) ys_9)))
    | `LH_N -> 
      ys_9);;
let rec mappend_lh__d5 xs_6 ys_6 =
  (match xs_6 with
    | `LH_C(h_1_0, t_1_0) -> 
      (`LH_C(h_1_0, ((mappend_lh__d5 t_1_0) ys_6)))
    | `LH_N -> 
      ys_6);;
let rec reverse_helper_lh__d1 ls_2 a_0 =
  (match ls_2 with
    | `LH_C(h_8, t_8) -> 
      ((reverse_helper_lh__d1 t_8) (`LH_C(h_8, a_0)))
    | `LH_N -> 
      a_0);;
let rec reverse_lh__d6 ls_3 =
  ((reverse_helper_lh__d1 ls_3) (`LH_N));;
let rec mappend_lh__d4 xs_7 ys_7 =
  (match xs_7 with
    | `LH_C(h_1_1, t_1_1) -> 
      (`LH_C(h_1_1, ((mappend_lh__d4 t_1_1) ys_7)))
    | `LH_N -> 
      ys_7);;
let rec ltList_lh__d2 _lh_ltList_arg1_1 _lh_ltList_arg2_1 =
  (let rec _lh_matchIdent_7 = ((compareList_lh__d1 _lh_ltList_arg1_1) _lh_ltList_arg2_1) in
    (match _lh_matchIdent_7 with
      ...
      | _ -> 
        false));;
let rec reverse_lh__d2 ls_7 =
  ((reverse_helper_lh__d1 ls_7) (`LH_N));;
let rec reverse_lh__d4 ls_5 =
  ((reverse_helper_lh__d1 ls_5) (`LH_N));;
let rec reverse_lh__d3 ls_6 =
...
let rec foldr_lh__d1 f_2 i_1 ls_8 =
  (match ls_8 with
    | `LH_C(h_1_5, t_1_5) -> 
      ((f_2 h_1_5) (((foldr_lh__d1 f_2) i_1) t_1_5))
    | `LH_N -> 
      i_1);;
  ...
  (match _lh_break_arg2_0 with
    ...
    | `LH_C(_lh_break_LH_C_0_0, _lh_break_LH_C_1_0) -> 
      (if (_lh_break_arg1_0 _lh_break_LH_C_0_0) then
        ...
        (let rec _lh_matchIdent_0 = ((break_lh__d1 _lh_break_arg1_0) _lh_break_LH_C_1_0) in
...
let rec lines_lh__d1 _lh_lines_arg1_0 =
  (match _lh_lines_arg1_0 with
    | `LH_N -> 
      (`LH_N)
    | _ -> 
      (let rec _lh_matchIdent_1_0 = ((break_lh__d1 (fun x_1 -> 
...
let rec mappend_lh__d8 xs_3 ys_3 =
  (match xs_3 with
    | `LH_C(h_5, t_5) -> 
      (`LH_C(h_5, ((mappend_lh__d8 t_5) ys_3)))
    | `LH_N -> 
      ys_3);;
...
let rec foldr_lh__d2 f_1 i_0 ls_1 =
  (match ls_1 with
    | `LH_C(h_6, t_6) -> 
      ((f_1 h_6) (((foldr_lh__d2 f_1) i_0) t_6))
    | `LH_N -> 
      i_0);;
...
let rec ltList_lh__d3 _lh_ltList_arg1_0 _lh_ltList_arg2_0 =
  (let rec _lh_matchIdent_2 = ((compareList_lh__d1 _lh_ltList_arg1_0) _lh_ltList_arg2_0) in
...
let rec quickSort2_lh__d1 _lh_quickSort2_arg1_0 =
  (match _lh_quickSort2_arg1_0 with
    ...
    | `LH_C(_lh_quickSort2_LH_C_0_0, _lh_quickSort2_LH_C_1_0) -> 
      (let rec _lh_matchIdent_9 = ((partition_lh__d1 ((fun x_0 y_0 -> 
...
let rec mappend_lh__d7 xs_4 ys_4 =
  (match xs_4 with
    | `LH_C(h_7, t_7) -> 
      (`LH_C(h_7, ((mappend_lh__d7 t_7) ys_4)))
    | `LH_N -> 
      ys_4);;
let rec leList_lh__d1_d3 _lh_leList_arg1_1 _lh_leList_arg2_1 =
...
let rec leList_lh__d1 _lh_leList_arg1_1_3 _lh_leList_arg2_1_3 =
  (not ((gtList_lh__d5 _lh_leList_arg1_1_3) _lh_leList_arg2_1_3));;
let rec leList_lh__d2 _lh_leList_arg1_1_2 _lh_leList_arg2_1_2 =
  (not ((gtList_lh__d5 _lh_leList_arg1_1_2) _lh_leList_arg2_1_2));;
let rec leList_lh__d3 _lh_leList_arg1_1_1 _lh_leList_arg2_1_1 =
...
let rec mappend_lh__d1_d1 xs_0 ys_0 =
  (match xs_0 with
    | `LH_C(h_0, t_0) -> 
      (`LH_C(h_0, ((mappend_lh__d1_d1 t_0) ys_0)))
    | `LH_N -> 
      ys_0);;
...
let rec leList_lh__d7 _lh_leList_arg1_7 _lh_leList_arg2_7 =
  (not ((gtList_lh__d5 _lh_leList_arg1_7) _lh_leList_arg2_7));;
let rec leList_lh__d8 _lh_leList_arg1_6 _lh_leList_arg2_6 =
  (not ((gtList_lh__d5 _lh_leList_arg1_6) _lh_leList_arg2_6));;
let rec leList_lh__d1_d2 _lh_leList_arg1_2 _lh_leList_arg2_2 =
...
let rec gtList_lh__d4 _lh_gtList_arg1_1 _lh_gtList_arg2_1 =
  (let rec _lh_matchIdent_3 = ((compareList_lh__d1 _lh_gtList_arg1_1) _lh_gtList_arg2_1) in
    (match _lh_matchIdent_3 with
      ...
      | _ -> 
        false));;
let rec leList_lh__d1_d1 _lh_leList_arg1_3 _lh_leList_arg2_3 =
...
let rec leList_lh__d6 _lh_leList_arg1_8 _lh_leList_arg2_8 =
...
let rec gtList_lh__d2 _lh_gtList_arg1_3 _lh_gtList_arg2_3 =
  (let rec _lh_matchIdent_5 = ((compareList_lh__d1 _lh_gtList_arg1_3) _lh_gtList_arg2_3) in
    (match _lh_matchIdent_5 with
      ...
      | _ -> 
        false));;
let rec leList_lh__d9 _lh_leList_arg1_5 _lh_leList_arg2_5 =
  (not ((gtList_lh__d5 _lh_leList_arg1_5) _lh_leList_arg2_5));;
let rec leList_lh__d5 _lh_leList_arg1_9 _lh_leList_arg2_9 =
                          ...
                          | `LH_C(_lh_runsplit_LH_C_0_1, _lh_runsplit_LH_C_1_1) -> 
                            (match _lh_runsplit_arg2_0 with
                              | `LH_C(_lh_runsplit_LH_C_0_2, _lh_runsplit_LH_C_1_2) -> 
                                (let rec _lh_matchIdent_1_2 = _lh_runsplit_LH_C_1_1 in
                                  (match _lh_matchIdent_1_2 with
                                    ...
                                    | _ -> 
                                      (if ((leList_lh__d1_d0 _lh_runsplit_LH_C_0_2) _lh_runsplit_LH_C_0_1) then
                                        ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_2, (`LH_C(_lh_runsplit_LH_C_0_1, _lh_matchIdent_1_2))))) _lh_runsplit_LH_C_1_2)
                                      else
                                        (`LH_C((`LH_C(_lh_runsplit_LH_C_0_1, _lh_matchIdent_1_2)), ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_2, (`LH_N)))) _lh_runsplit_LH_C_1_2)))))))))
                  | _ -> 
                    (match _lh_runsplit_arg1_0 with
                      | `LH_C(_lh_runsplit_LH_C_0_3, _lh_runsplit_LH_C_1_3) -> 
                        (match _lh_runsplit_arg2_0 with
                          | `LH_C(_lh_runsplit_LH_C_0_4, _lh_runsplit_LH_C_1_4) -> 
                            (let rec _lh_matchIdent_1_3 = _lh_runsplit_LH_C_1_3 in
                              (match _lh_matchIdent_1_3 with
                                ...
                                | _ -> 
                                  (if ((leList_lh__d1_d1 _lh_runsplit_LH_C_0_4) _lh_runsplit_LH_C_0_3) then
                                    ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_4, (`LH_C(_lh_runsplit_LH_C_0_3, _lh_matchIdent_1_3))))) _lh_runsplit_LH_C_1_4)
                                  else
                                    (`LH_C((`LH_C(_lh_runsplit_LH_C_0_3, _lh_matchIdent_1_3)), ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_4, (`LH_N)))) _lh_runsplit_LH_C_1_4)))))))))))
      | _ -> 
        (match _lh_runsplit_arg2_0 with
          | `LH_N -> 
            (`LH_C(_lh_runsplit_arg1_0, (`LH_N)))
                      ...
                      | `LH_C(_lh_runsplit_LH_C_0_6, _lh_runsplit_LH_C_1_6) -> 
                        (match _lh_runsplit_arg2_0 with
                          | `LH_C(_lh_runsplit_LH_C_0_7, _lh_runsplit_LH_C_1_7) -> 
                            (let rec _lh_matchIdent_1_4 = _lh_runsplit_LH_C_1_6 in
                              (match _lh_matchIdent_1_4 with
                                ...
                                | _ -> 
                                  (if ((leList_lh__d1_d2 _lh_runsplit_LH_C_0_7) _lh_runsplit_LH_C_0_6) then
                                    ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_7, (`LH_C(_lh_runsplit_LH_C_0_6, _lh_matchIdent_1_4))))) _lh_runsplit_LH_C_1_7)
                                  else
                                    (`LH_C((`LH_C(_lh_runsplit_LH_C_0_6, _lh_matchIdent_1_4)), ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_7, (`LH_N)))) _lh_runsplit_LH_C_1_7)))))))))
              | _ -> 
                (match _lh_runsplit_arg1_0 with
                  | `LH_C(_lh_runsplit_LH_C_0_8, _lh_runsplit_LH_C_1_8) -> 
                    (match _lh_runsplit_arg2_0 with
                      | `LH_C(_lh_runsplit_LH_C_0_9, _lh_runsplit_LH_C_1_9) -> 
                        (let rec _lh_matchIdent_1_5 = _lh_runsplit_LH_C_1_8 in
                          (match _lh_matchIdent_1_5 with
                            ...
                            | _ -> 
                              (if ((leList_lh__d5 _lh_runsplit_LH_C_0_9) _lh_runsplit_LH_C_0_8) then
                                ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_9, (`LH_C(_lh_runsplit_LH_C_0_8, _lh_matchIdent_1_5))))) _lh_runsplit_LH_C_1_9)
                              else
                                (`LH_C((`LH_C(_lh_runsplit_LH_C_0_8, _lh_matchIdent_1_5)), ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_9, (`LH_N)))) _lh_runsplit_LH_C_1_9))))))))))))
...
let rec reverse_lh__d1 ls_9 =
  ((reverse_helper_lh__d1 ls_9) (`LH_N));;
let rec concat_lh__d1 lss_0 =
  (match lss_0 with
    | `LH_C(h_2, t_2) -> 
      ((mappend_lh__d1_d1 h_2) (concat_lh__d1 t_2))
    | `LH_N -> 
      (`LH_N));;
let rec mappend_lh__d1_d0 xs_1 ys_1 =
  (match xs_1 with
    | `LH_C(h_1, t_1) -> 
      (`LH_C(h_1, ((mappend_lh__d1_d0 t_1) ys_1)))
    | `LH_N -> 
      ys_1);;
let rec map_lh__d1 f_0 ls_0 =
  (match ls_0 with
    | `LH_C(h_3, t_3) -> 
      (`LH_C((f_0 h_3), ((map_lh__d1 f_0) t_3)))
    | `LH_N -> 
      (`LH_N));;
...
let rec mappend_lh__d6 xs_5 ys_5 =
  (match xs_5 with
    | `LH_C(h_9, t_9) -> 
      (`LH_C(h_9, ((mappend_lh__d6 t_9) ys_5)))
    | `LH_N -> 
      ys_5);;
let rec leList_lh__d4 _lh_leList_arg1_1_0 _lh_leList_arg2_1_0 =
...
let rec mangle_lh__d1 _lh_mangle_arg1_0 =
  (let rec sort_0 = (fun _lh_sort_arg1_0 -> 
    ((((foldr_lh__d1 (fun f_4 g_0 _lh_funcomp_x_3 -> 
      (f_4 (g_0 _lh_funcomp_x_3)))) (fun x_2 -> 
...
let rec foldl_lh__d1 f_3 i_2 ls_1_0 =
  (match ls_1_0 with
    | `LH_C(h_1_6, t_1_6) -> 
      (((foldl_lh__d1 f_3) ((f_3 i_2) h_1_6)) t_1_6)
    | `LH_N -> 
      i_2);;
