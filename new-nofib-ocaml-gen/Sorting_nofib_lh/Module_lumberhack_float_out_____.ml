...
let rec gtList_lh__d5 _lh_gtList_arg1_3 _lh_gtList_arg2_3 =
  (let rec _lh_matchIdent_1_0 = ((compareList_lh__d1 _lh_gtList_arg1_3) _lh_gtList_arg2_3) in
...
let rec mappend_lh__d9 xs_1_0 ys_1_0 =
  (match xs_1_0 with
    | `LH_C(h_1_5, t_1_5) -> 
      (`LH_C(h_1_5, ((mappend_lh__d9 t_1_5) ys_1_0)))
    | `LH_N -> 
      ys_1_0);;
        ...
        | _ -> 
          (let rec split_0 = (fun _lh_split_arg1_0 _lh_split_arg2_0 _lh_split_arg3_0 _lh_split_arg4_0 -> 
            (match _lh_split_arg4_0 with
              | `LH_N -> 
                ((mappend_lh__d9 (quickerSort_lh__d1 _lh_split_arg2_0)) (`LH_C(_lh_split_arg1_0, (quickerSort_lh__d1 _lh_split_arg3_0))))
...
let rec mappend_lh__d2 xs_6 ys_6 =
  (match xs_6 with
    | `LH_C(h_9, t_9) -> 
      (`LH_C(h_9, ((mappend_lh__d2 t_9) ys_6)))
    | `LH_N -> 
      ys_6);;
let rec mappend_lh__d5 xs_7 ys_7 =
  (match xs_7 with
    | `LH_C(h_1_0, t_1_0) -> 
      (`LH_C(h_1_0, ((mappend_lh__d5 t_1_0) ys_7)))
    | `LH_N -> 
      ys_7);;
let rec reverse_helper_lh__d1 ls_3 a_0 =
  (match ls_3 with
    | `LH_C(h_5, t_5) -> 
      ((reverse_helper_lh__d1 t_5) (`LH_C(h_5, a_0)))
    | `LH_N -> 
      a_0);;
let rec reverse_lh__d6 ls_6 =
  ((reverse_helper_lh__d1 ls_6) (`LH_N));;
let rec mappend_lh__d4 xs_9 ys_9 =
  (match xs_9 with
    | `LH_C(h_1_2, t_1_2) -> 
      (`LH_C(h_1_2, ((mappend_lh__d4 t_1_2) ys_9)))
    | `LH_N -> 
      ys_9);;
let rec ltList_lh__d2 _lh_ltList_arg1_2 _lh_ltList_arg2_2 =
  (let rec _lh_matchIdent_7 = ((compareList_lh__d1 _lh_ltList_arg1_2) _lh_ltList_arg2_2) in
          ...
          | `LH_N -> 
            (match _lh_trins_arg3_0 with
              | `LH_C(_lh_trins_LH_C_0_0, _lh_trins_LH_C_1_0) -> 
                (((trins_0 (`LH_N)) ((mappend_lh__d4 (reverse_lh__d3 _lh_trins_arg1_0)) (`LH_C(_lh_trins_LH_C_0_0, (`LH_N))))) _lh_trins_LH_C_1_0)
              | _ -> 
                (match _lh_trins_arg3_0 with
                  | `LH_N -> 
                    ((mappend_lh__d5 (reverse_lh__d2 _lh_trins_arg1_0)) _lh_trins_arg2_0)
                  | _ -> 
                    (match _lh_trins_arg2_0 with
                      | `LH_C(_lh_trins_LH_C_0_1, _lh_trins_LH_C_1_1) -> 
                        (match _lh_trins_arg3_0 with
                          | `LH_C(_lh_trins_LH_C_0_2, _lh_trins_LH_C_1_2) -> 
                            (if ((ltList_lh__d1 _lh_trins_LH_C_0_1) _lh_trins_LH_C_0_2) then
                              (((trins_0 (`LH_C(_lh_trins_LH_C_0_1, _lh_trins_arg1_0))) _lh_trins_LH_C_1_1) (`LH_C(_lh_trins_LH_C_0_2, _lh_trins_LH_C_1_2)))
                            else
                              (((trins_0 (`LH_N)) ((mappend_lh__d1 (reverse_lh__d6 _lh_trins_arg1_0)) (`LH_C(_lh_trins_LH_C_0_2, (`LH_C(_lh_trins_LH_C_0_1, _lh_trins_LH_C_1_1)))))) _lh_trins_LH_C_1_2))))))
          | _ -> 
            (match _lh_trins_arg3_0 with
              | `LH_N -> 
                ((mappend_lh__d2 (reverse_lh__d5 _lh_trins_arg1_0)) _lh_trins_arg2_0)
              | _ -> 
                (match _lh_trins_arg2_0 with
                    ...
                    (match _lh_trins_arg3_0 with
                      | `LH_C(_lh_trins_LH_C_0_4, _lh_trins_LH_C_1_4) -> 
                        (if ((ltList_lh__d2 _lh_trins_LH_C_0_3) _lh_trins_LH_C_0_4) then
                          ...
                          (((trins_0 (`LH_N)) ((mappend_lh__d3 (reverse_lh__d4 _lh_trins_arg1_0)) (`LH_C(_lh_trins_LH_C_0_4, (`LH_C(_lh_trins_LH_C_0_3, _lh_trins_LH_C_1_3)))))) _lh_trins_LH_C_1_4))))))) in
  ...
  (match _lh_break_arg2_0 with
    ...
    | `LH_C(_lh_break_LH_C_0_0, _lh_break_LH_C_1_0) -> 
      (if (_lh_break_arg1_0 _lh_break_LH_C_0_0) then
        ...
        (let rec _lh_matchIdent_8 = ((break_lh__d1 _lh_break_arg1_0) _lh_break_LH_C_1_0) in
...
lines_lh__d1 _lh_lines_arg1_0 =
  (match _lh_lines_arg1_0 with
    | `LH_N -> 
      (`LH_N)
    | _ -> 
      (let rec _lh_matchIdent_4 = ((break_lh__d1 (fun x_0 -> 
        (x_0 = '|'))) _lh_lines_arg1_0) in
        (match _lh_matchIdent_4 with
          | `LH_P2(_lh_lines_LH_P2_0_0, _lh_lines_LH_P2_1_0) -> 
            (`LH_C(_lh_lines_LH_P2_0_0, (let rec _lh_matchIdent_5 = _lh_lines_LH_P2_1_0 in
              (_lh_matchIdent_5 99)))))));;
let rec mappend_lh__d8 xs_3 ys_3 =
  (match xs_3 with
    | `LH_C(h_4, t_4) -> 
      (`LH_C(h_4, ((mappend_lh__d8 t_4) ys_3)))
    | `LH_N -> 
      ys_3);;
...
let rec foldr_lh__d2 f_2 i_2 ls_5 =
  (match ls_5 with
    | `LH_C(h_8, t_8) -> 
      ((f_2 h_8) (((foldr_lh__d2 f_2) i_2) t_8))
    | `LH_N -> 
      i_2);;
let rec partition_lh__d1 _lh_partition_arg1_0 _lh_partition_arg2_0 =
  (((foldr_lh__d2 (select_lh__d1 _lh_partition_arg1_0)) (`LH_P2((`LH_N), (`LH_N)))) _lh_partition_arg2_0);;
let rec ltList_lh__d3 _lh_ltList_arg1_1 _lh_ltList_arg2_1 =
  (let rec _lh_matchIdent_1 = ((compareList_lh__d1 _lh_ltList_arg1_1) _lh_ltList_arg2_1) in
...
let rec quickSort2_lh__d1 _lh_quickSort2_arg1_0 =
  (match _lh_quickSort2_arg1_0 with
    ...
    | `LH_C(_lh_quickSort2_LH_C_0_0, _lh_quickSort2_LH_C_1_0) -> 
      (let rec _lh_matchIdent_6 = ((partition_lh__d1 ((fun x_1 y_0 -> 
        ...
        (match _lh_matchIdent_6 with
          | `LH_P2(_lh_quickSort2_LH_P2_0_0, _lh_quickSort2_LH_P2_1_0) -> 
            ((mappend_lh__d8 (quickSort2_lh__d1 _lh_quickSort2_LH_P2_0_0)) (`LH_C(_lh_quickSort2_LH_C_0_0, (quickSort2_lh__d1 _lh_quickSort2_LH_P2_1_0)))))));;
let rec leList_lh__d1_d3 _lh_leList_arg1_7 _lh_leList_arg2_7 =
    ...
    (let rec to_tree_1 = (fun _lh_to_tree_arg1_1 _lh_to_tree_arg2_1 -> 
      (match _lh_to_tree_arg2_1 with
        ...
        | `Branch(_lh_to_tree_Branch_0_0, _lh_to_tree_Branch_1_0, _lh_to_tree_Branch_2_0) -> 
          (if ((leList_lh__d1_d3 _lh_to_tree_arg1_1) _lh_to_tree_Branch_0_0) then
  ...
  and readTree_1 = (fun _lh_readTree_arg1_1 -> 
    (match _lh_readTree_arg1_1 with
      ...
      | `Branch(_lh_readTree_Branch_0_0, _lh_readTree_Branch_1_0, _lh_readTree_Branch_2_0) -> 
        ((mappend_lh__d7 (readTree_1 _lh_readTree_Branch_1_0)) (`LH_C(_lh_readTree_Branch_0_0, (readTree_1 _lh_readTree_Branch_2_0))))))
...
let rec leList_lh__d1 _lh_leList_arg1_6 _lh_leList_arg2_6 =
  (not ((gtList_lh__d5 _lh_leList_arg1_6) _lh_leList_arg2_6));;
let rec leList_lh__d2 _lh_leList_arg1_8 _lh_leList_arg2_8 =
              ...
              | `Branch(_lh_mix_Branch_0_0, _lh_mix_Branch_1_0, _lh_mix_Branch_2_0) -> 
                (match _lh_mix_arg2_0 with
                  | `Branch(_lh_mix_Branch_0_1, _lh_mix_Branch_1_1, _lh_mix_Branch_2_1) -> 
                    (if ((leList_lh__d2 _lh_mix_Branch_0_0) _lh_mix_Branch_0_1) then
  ...
  and to_heap_0 = (fun _lh_to_heap_arg1_0 _lh_to_heap_arg2_0 _lh_to_heap_arg3_0 -> 
    (match _lh_to_heap_arg3_0 with
      ...
      | `Branch(_lh_to_heap_Branch_0_0, _lh_to_heap_Branch_1_0, _lh_to_heap_Branch_2_0) -> 
        (if (((leList_lh__d1 _lh_to_heap_arg2_0) _lh_to_heap_Branch_0_0) && (odd_lh__d1 _lh_to_heap_arg1_0)) then
          ...
          (if ((leList_lh__d3 _lh_to_heap_arg2_0) _lh_to_heap_Branch_0_0) then
...
let rec mappend_lh__d1_d1 xs_1 ys_1 =
  (match xs_1 with
    | `LH_C(h_1, t_1) -> 
      (`LH_C(h_1, ((mappend_lh__d1_d1 t_1) ys_1)))
    | `LH_N -> 
      ys_1);;
    ...
    (let rec to_tree_0 = (fun _lh_to_tree_arg1_0 _lh_to_tree_arg2_0 -> 
      (match _lh_to_tree_arg2_0 with
        ...
        | `Twig2(_lh_to_tree_Twig2_0_0) -> 
          (if ((leList_lh__d1_d4 _lh_to_tree_arg1_0) _lh_to_tree_Twig2_0_0) then
  ...
  and readTree_0 = (fun _lh_readTree_arg1_0 -> 
    (match _lh_readTree_arg1_0 with
      ...
      | `Branch2(_lh_readTree_Branch2_0_0, _lh_readTree_Branch2_1_0, _lh_readTree_Branch2_2_0) -> 
        ((mappend_lh__d1_d1 (readTree_0 _lh_readTree_Branch2_1_0)) (`LH_C(_lh_readTree_Branch2_0_0, (readTree_0 _lh_readTree_Branch2_2_0))))))
...
let rec leList_lh__d1_d0 _lh_leList_arg1_4 _lh_leList_arg2_4 =
...
let rec leList_lh__d6 _lh_leList_arg1_9 _lh_leList_arg2_9 =
  (not ((gtList_lh__d5 _lh_leList_arg1_9) _lh_leList_arg2_9));;
let rec gtList_lh__d2 _lh_gtList_arg1_4 _lh_gtList_arg2_4 =
  (let rec _lh_matchIdent_1_5 = ((compareList_lh__d1 _lh_gtList_arg1_4) _lh_gtList_arg2_4) in
    (match _lh_matchIdent_1_5 with
      | `GT -> 
        true
      | _ -> 
        false));;
let rec leList_lh__d9 _lh_leList_arg1_1_1 _lh_leList_arg2_1_1 =
  (not ((gtList_lh__d5 _lh_leList_arg1_1_1) _lh_leList_arg2_1_1));;
let rec leList_lh__d5 _lh_leList_arg1_1_0 _lh_leList_arg2_1_0 =
  (not ((gtList_lh__d5 _lh_leList_arg1_1_0) _lh_leList_arg2_1_0));;
let rec gtList_lh__d3 _lh_gtList_arg1_2 _lh_gtList_arg2_2 =
  (let rec _lh_matchIdent_9 = ((compareList_lh__d1 _lh_gtList_arg1_2) _lh_gtList_arg2_2) in
                              ...
                              | `LH_C(_lh_runsplit_LH_C_0_2, _lh_runsplit_LH_C_1_2) -> 
                                (let rec _lh_matchIdent_1_1 = _lh_runsplit_LH_C_1_1 in
                                  (match _lh_matchIdent_1_1 with
                                    | `LH_N -> 
                                      (if ((gtList_lh__d5 _lh_runsplit_LH_C_0_2) _lh_runsplit_LH_C_0_1) then
                                        ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_1, (`LH_C(_lh_runsplit_LH_C_0_2, (`LH_N)))))) _lh_runsplit_LH_C_1_2)
                                      else
                                        (if ((leList_lh__d7 _lh_runsplit_LH_C_0_2) _lh_runsplit_LH_C_0_1) then
                                    ...
                                    | _ -> 
                                      (if ((leList_lh__d1_d0 _lh_runsplit_LH_C_0_2) _lh_runsplit_LH_C_0_1) then
                                        ...
                                        (let rec _lh_merge_lists_LH_C_1_2 = ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_2, (`LH_N)))) _lh_runsplit_LH_C_1_2) in
                                          (let rec _lh_merge_lists_LH_C_0_2 = (`LH_C(_lh_runsplit_LH_C_0_1, _lh_matchIdent_1_1)) in
                          ...
                          | `LH_C(_lh_runsplit_LH_C_0_4, _lh_runsplit_LH_C_1_4) -> 
                            (let rec _lh_matchIdent_1_2 = _lh_runsplit_LH_C_1_3 in
                              (match _lh_matchIdent_1_2 with
                                | `LH_N -> 
                                  (if ((gtList_lh__d2 _lh_runsplit_LH_C_0_4) _lh_runsplit_LH_C_0_3) then
                                ...
                                | _ -> 
                                  (if ((leList_lh__d1_d1 _lh_runsplit_LH_C_0_4) _lh_runsplit_LH_C_0_3) then
                                    ...
                                    (let rec _lh_merge_lists_LH_C_1_4 = ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_4, (`LH_N)))) _lh_runsplit_LH_C_1_4) in
                                      (let rec _lh_merge_lists_LH_C_0_4 = (`LH_C(_lh_runsplit_LH_C_0_3, _lh_matchIdent_1_2)) in
                          ...
                          | `LH_C(_lh_runsplit_LH_C_0_7, _lh_runsplit_LH_C_1_7) -> 
                            (let rec _lh_matchIdent_1_3 = _lh_runsplit_LH_C_1_6 in
                              (match _lh_matchIdent_1_3 with
                                | `LH_N -> 
                                  (if ((gtList_lh__d4 _lh_runsplit_LH_C_0_7) _lh_runsplit_LH_C_0_6) then
                                    ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_6, (`LH_C(_lh_runsplit_LH_C_0_7, (`LH_N)))))) _lh_runsplit_LH_C_1_7)
                                  else
                                    (if ((leList_lh__d6 _lh_runsplit_LH_C_0_7) _lh_runsplit_LH_C_0_6) then
                                ...
                                | _ -> 
                                  (if ((leList_lh__d1_d2 _lh_runsplit_LH_C_0_7) _lh_runsplit_LH_C_0_6) then
                                    ...
                                    (let rec _lh_merge_lists_LH_C_1_7 = ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_7, (`LH_N)))) _lh_runsplit_LH_C_1_7) in
                                      (let rec _lh_merge_lists_LH_C_0_7 = (`LH_C(_lh_runsplit_LH_C_0_6, _lh_matchIdent_1_3)) in
                      ...
                      | `LH_C(_lh_runsplit_LH_C_0_9, _lh_runsplit_LH_C_1_9) -> 
                        (let rec _lh_matchIdent_1_4 = _lh_runsplit_LH_C_1_8 in
                          (match _lh_matchIdent_1_4 with
                            | `LH_N -> 
                              (if ((gtList_lh__d3 _lh_runsplit_LH_C_0_9) _lh_runsplit_LH_C_0_8) then
                            ...
                            | _ -> 
                              (if ((leList_lh__d5 _lh_runsplit_LH_C_0_9) _lh_runsplit_LH_C_0_8) then
                                ...
                                (let rec _lh_merge_lists_LH_C_1_9 = ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_9, (`LH_N)))) _lh_runsplit_LH_C_1_9) in
                                  (let rec _lh_merge_lists_LH_C_0_9 = (`LH_C(_lh_runsplit_LH_C_0_8, _lh_matchIdent_1_4)) in
                ...
                (match _lh_merge_arg2_0 with
                  | `LH_C(_lh_merge_LH_C_0_1, _lh_merge_LH_C_1_1) -> 
                    (if ((eqList_lh__d1 _lh_merge_LH_C_0_0) _lh_merge_LH_C_0_1) then
                      ...
                      (if ((ltList_lh__d3 _lh_merge_LH_C_0_0) _lh_merge_LH_C_0_1) then
...
let rec concat_lh__d1 lss_0 =
  (lss_0 99);;
let rec map_lh__d1 f_4 ls_7 _lh_floatOutId_0_0 =
  (match ls_7 with
    | `LH_C(h_1_3, t_1_3) -> 
      (let rec t_1_4 = ((map_lh__d1 f_4) t_1_3) in
        (let rec h_1_4 = (f_4 h_1_3) in
          ((mappend_lh__d1_d1 h_1_4) (concat_lh__d1 t_1_4))))
    | `LH_N -> 
      (`LH_N));;
...
let rec unlines_lh__d1 _lh_unlines_arg1_0 =
  (concat_lh__d1 ((map_lh__d1 (fun l_0 -> 
    ((mappend_lh__d1_d0 l_0) (`LH_C('|', (`LH_N)))))) _lh_unlines_arg1_0));;
let rec gtList_lh__d1 _lh_gtList_arg1_0 _lh_gtList_arg2_0 =
  (let rec _lh_matchIdent_2 = ((compareList_lh__d1 _lh_gtList_arg1_0) _lh_gtList_arg2_0) in
...
let rec mappend_lh__d6 xs_8 ys_8 =
  (match xs_8 with
    | `LH_C(h_1_1, t_1_1) -> 
      (`LH_C(h_1_1, ((mappend_lh__d6 t_1_1) ys_8)))
    | `LH_N -> 
      ys_8);;
...
let rec quickSort_lh__d1 _lh_quickSort_arg1_0 =
  (match _lh_quickSort_arg1_0 with
    ...
    | `LH_C(_lh_quickSort_LH_C_0_0, _lh_quickSort_LH_C_1_0) -> 
      ((mappend_lh__d6 (quickSort_lh__d1 (let rec _lh_listcomp_fun_0 = (fun _lh_listcomp_fun_para_0 -> 
        (match _lh_listcomp_fun_para_0 with
          | `LH_C(_lh_listcomp_fun_ls_h_0, _lh_listcomp_fun_ls_t_0) -> 
            (if ((leList_lh__d4 _lh_listcomp_fun_ls_h_0) _lh_quickSort_LH_C_0_0) then
        ...
        (match _lh_listcomp_fun_para_1 with
          | `LH_C(_lh_listcomp_fun_ls_h_1, _lh_listcomp_fun_ls_t_1) -> 
            (if ((gtList_lh__d1 _lh_listcomp_fun_ls_h_1) _lh_quickSort_LH_C_0_0) then
...
let rec foldr_lh__d1 f_1 i_1 ls_4 =
  ((ls_4 f_1) i_1);;
...
let rec mangle_lh__d1 _lh_mangle_arg1_0 =
  (let rec sort_0 = (fun _lh_sort_arg1_0 -> 
    ((((foldr_lh__d1 (fun f_5 g_0 _lh_funcomp_x_2 -> 
      (f_5 (g_0 _lh_funcomp_x_2)))) (fun x_2 -> 
      x_2)) ((intersperse_lh__d1 reverse_lh__d1) (let rec _lh_intersperse_LH_C_1_0 = (let rec _lh_prependToAll_LH_C_1_0 = (let rec _lh_prependToAll_LH_C_1_1 = (let rec _lh_prependToAll_LH_C_1_2 = (let rec _lh_prependToAll_LH_C_1_3 = (let rec _lh_prependToAll_LH_C_1_4 = (let rec _lh_prependToAll_LH_C_1_5 = (let rec _lh_prependToAll_LH_C_1_6 = (fun _lh_prependToAll_arg1_1 f_6 i_3 -> 
      i_3) in
      (let rec _lh_prependToAll_LH_C_0_0 = treeSort2_lh__d1 in
        (fun _lh_prependToAll_arg1_2 -> 
          (let rec t_1_6 = (let rec t_1_7 = ((prependToAll_lh__d1 _lh_prependToAll_arg1_2) _lh_prependToAll_LH_C_1_6) in
            (let rec h_1_6 = _lh_prependToAll_LH_C_0_0 in
              (fun f_7 i_4 -> 
                ((f_7 h_1_6) (((foldr_lh__d1 f_7) i_4) t_1_7))))) in
            (let rec h_1_7 = _lh_prependToAll_arg1_2 in
              (fun f_8 i_5 -> 
                ((f_8 h_1_7) (((foldr_lh__d1 f_8) i_5) t_1_6)))))))) in
      (let rec _lh_prependToAll_LH_C_0_1 = treeSort_lh__d1 in
        (fun _lh_prependToAll_arg1_3 -> 
          (let rec t_1_8 = (let rec t_1_9 = ((prependToAll_lh__d1 _lh_prependToAll_arg1_3) _lh_prependToAll_LH_C_1_5) in
            (let rec h_1_8 = _lh_prependToAll_LH_C_0_1 in
              (fun f_9 i_6 -> 
                ((f_9 h_1_8) (((foldr_lh__d1 f_9) i_6) t_1_9))))) in
            (let rec h_1_9 = _lh_prependToAll_arg1_3 in
              (fun f_1_0 i_7 -> 
                ((f_1_0 h_1_9) (((foldr_lh__d1 f_1_0) i_7) t_1_8)))))))) in
      (let rec _lh_prependToAll_LH_C_0_2 = quickerSort_lh__d1 in
        (fun _lh_prependToAll_arg1_4 -> 
          (let rec t_2_0 = (let rec t_2_1 = ((prependToAll_lh__d1 _lh_prependToAll_arg1_4) _lh_prependToAll_LH_C_1_4) in
            (let rec h_2_0 = _lh_prependToAll_LH_C_0_2 in
              (fun f_1_1 i_8 -> 
                ((f_1_1 h_2_0) (((foldr_lh__d1 f_1_1) i_8) t_2_1))))) in
            (let rec h_2_1 = _lh_prependToAll_arg1_4 in
              (fun f_1_2 i_9 -> 
                ((f_1_2 h_2_1) (((foldr_lh__d1 f_1_2) i_9) t_2_0)))))))) in
      (let rec _lh_prependToAll_LH_C_0_3 = quickSort2_lh__d1 in
        (fun _lh_prependToAll_arg1_5 -> 
          (let rec t_2_2 = (let rec t_2_3 = ((prependToAll_lh__d1 _lh_prependToAll_arg1_5) _lh_prependToAll_LH_C_1_3) in
            (let rec h_2_2 = _lh_prependToAll_LH_C_0_3 in
              (fun f_1_3 i_1_0 -> 
                ((f_1_3 h_2_2) (((foldr_lh__d1 f_1_3) i_1_0) t_2_3))))) in
            (let rec h_2_3 = _lh_prependToAll_arg1_5 in
              (fun f_1_4 i_1_1 -> 
                ((f_1_4 h_2_3) (((foldr_lh__d1 f_1_4) i_1_1) t_2_2)))))))) in
      (let rec _lh_prependToAll_LH_C_0_4 = quickSort_lh__d1 in
        (fun _lh_prependToAll_arg1_6 -> 
          (let rec t_2_4 = (let rec t_2_5 = ((prependToAll_lh__d1 _lh_prependToAll_arg1_6) _lh_prependToAll_LH_C_1_2) in
            (let rec h_2_4 = _lh_prependToAll_LH_C_0_4 in
              (fun f_1_5 i_1_2 -> 
                ((f_1_5 h_2_4) (((foldr_lh__d1 f_1_5) i_1_2) t_2_5))))) in
            (let rec h_2_5 = _lh_prependToAll_arg1_6 in
              (fun f_1_6 i_1_3 -> 
                ((f_1_6 h_2_5) (((foldr_lh__d1 f_1_6) i_1_3) t_2_4)))))))) in
      (let rec _lh_prependToAll_LH_C_0_5 = mergeSort_lh__d1 in
        (fun _lh_prependToAll_arg1_7 -> 
          (let rec t_2_6 = (let rec t_2_7 = ((prependToAll_lh__d1 _lh_prependToAll_arg1_7) _lh_prependToAll_LH_C_1_1) in
            (let rec h_2_6 = _lh_prependToAll_LH_C_0_5 in
              (fun f_1_7 i_1_4 -> 
                ((f_1_7 h_2_6) (((foldr_lh__d1 f_1_7) i_1_4) t_2_7))))) in
            (let rec h_2_7 = _lh_prependToAll_arg1_7 in
              (fun f_1_8 i_1_5 -> 
                ((f_1_8 h_2_7) (((foldr_lh__d1 f_1_8) i_1_5) t_2_6)))))))) in
      (let rec _lh_prependToAll_LH_C_0_6 = insertSort_lh__d1 in
        (fun _lh_prependToAll_arg1_8 -> 
          (let rec t_2_8 = (let rec t_2_9 = ((prependToAll_lh__d1 _lh_prependToAll_arg1_8) _lh_prependToAll_LH_C_1_0) in
            (let rec h_2_8 = _lh_prependToAll_LH_C_0_6 in
              (fun f_1_9 i_1_6 -> 
                ((f_1_9 h_2_8) (((foldr_lh__d1 f_1_9) i_1_6) t_2_9))))) in
            (let rec h_2_9 = _lh_prependToAll_arg1_8 in
              (fun f_2_0 i_1_7 -> 
                ((f_2_0 h_2_9) (((foldr_lh__d1 f_2_0) i_1_7) t_2_8)))))))) in
      (let rec _lh_intersperse_LH_C_0_0 = heapSort_lh__d1 in
        (fun _lh_intersperse_arg1_1 -> 
          (let rec t_3_0 = ((prependToAll_lh__d1 _lh_intersperse_arg1_1) _lh_intersperse_LH_C_1_0) in
            (let rec h_3_0 = _lh_intersperse_LH_C_0_0 in
              (fun f_2_1 i_1_8 -> 
                ((f_2_1 h_3_0) (((foldr_lh__d1 f_2_1) i_1_8) t_3_0)))))))))) _lh_sort_arg1_0)) in
    ((fun _lh_funcomp_x_3 -> 
      ((fun _lh_funcomp_x_4 -> 
        (unlines_lh__d1 (sort_0 _lh_funcomp_x_4))) (lines_lh__d1 _lh_funcomp_x_3))) _lh_mangle_arg1_0));;
let rec foldl_lh__d1 f_0 i_0 ls_2 =
  (match ls_2 with
    | `LH_C(h_3, t_3) -> 
      (((foldl_lh__d1 f_0) ((f_0 i_0) h_3)) t_3)
    | `LH_N -> 
      i_0);;
