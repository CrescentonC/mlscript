...
let rec gtList_lh__d5 _lh_gtList_arg1_3 _lh_gtList_arg2_3 =
  (let rec _lh_matchIdent_9 = ((compareList_lh__d1 _lh_gtList_arg1_3) _lh_gtList_arg2_3) in
...
lines_lh__d1 _lh_lines_arg1_0 =
  (match _lh_lines_arg1_0 with
    | `LH_N -> 
      (`LH_N)
    | _ -> 
      (let rec _lh_matchIdent_3 = ((break_lh__d1 (fun x_0 -> 
        (x_0 = '|'))) _lh_lines_arg1_0) in
        (match _lh_matchIdent_3 with
          | `LH_P2(_lh_lines_LH_P2_0_0, _lh_lines_LH_P2_1_0) -> 
            (`LH_C(_lh_lines_LH_P2_0_0, (let rec _lh_matchIdent_4 = _lh_lines_LH_P2_1_0 in
              (_lh_matchIdent_4 99))))
          | _ -> 
            (failwith "error"))));;
...
let rec gtList_lh__d2 _lh_gtList_arg1_4 _lh_gtList_arg2_4 =
  (let rec _lh_matchIdent_1_4 = ((compareList_lh__d1 _lh_gtList_arg1_4) _lh_gtList_arg2_4) in
...
let rec gtList_lh__d3 _lh_gtList_arg1_2 _lh_gtList_arg2_2 =
  (let rec _lh_matchIdent_8 = ((compareList_lh__d1 _lh_gtList_arg1_2) _lh_gtList_arg2_2) in
                          ...
                          | `LH_C(_lh_runsplit_LH_C_0_1, _lh_runsplit_LH_C_1_1) -> 
                            (match _lh_runsplit_arg2_0 with
                              | `LH_C(_lh_runsplit_LH_C_0_2, _lh_runsplit_LH_C_1_2) -> 
                                (let rec _lh_matchIdent_1_0 = _lh_runsplit_LH_C_1_1 in
                                  (match _lh_matchIdent_1_0 with
                                    ...
                                    | _ -> 
                                      (if ((leList_lh__d2 _lh_runsplit_LH_C_0_2) _lh_runsplit_LH_C_0_1) then
                                        ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_2, (`LH_C(_lh_runsplit_LH_C_0_1, _lh_matchIdent_1_0))))) _lh_runsplit_LH_C_1_2)
                                      else
                                        (let rec _lh_merge_lists_LH_C_1_2 = ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_2, (`LH_N)))) _lh_runsplit_LH_C_1_2) in
                                          (let rec _lh_merge_lists_LH_C_0_2 = (`LH_C(_lh_runsplit_LH_C_0_1, _lh_matchIdent_1_0)) in
                      ...
                      | `LH_C(_lh_runsplit_LH_C_0_3, _lh_runsplit_LH_C_1_3) -> 
                        (match _lh_runsplit_arg2_0 with
                          | `LH_C(_lh_runsplit_LH_C_0_4, _lh_runsplit_LH_C_1_4) -> 
                            (let rec _lh_matchIdent_1_1 = _lh_runsplit_LH_C_1_3 in
                              (match _lh_matchIdent_1_1 with
                                ...
                                | _ -> 
                                  (if ((leList_lh__d5 _lh_runsplit_LH_C_0_4) _lh_runsplit_LH_C_0_3) then
                                    ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_4, (`LH_C(_lh_runsplit_LH_C_0_3, _lh_matchIdent_1_1))))) _lh_runsplit_LH_C_1_4)
                                  else
                                    (let rec _lh_merge_lists_LH_C_1_4 = ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_4, (`LH_N)))) _lh_runsplit_LH_C_1_4) in
                                      (let rec _lh_merge_lists_LH_C_0_4 = (`LH_C(_lh_runsplit_LH_C_0_3, _lh_matchIdent_1_1)) in
                      ...
                      | `LH_C(_lh_runsplit_LH_C_0_6, _lh_runsplit_LH_C_1_6) -> 
                        (match _lh_runsplit_arg2_0 with
                          | `LH_C(_lh_runsplit_LH_C_0_7, _lh_runsplit_LH_C_1_7) -> 
                            (let rec _lh_matchIdent_1_2 = _lh_runsplit_LH_C_1_6 in
                              (match _lh_matchIdent_1_2 with
                                ...
                                | _ -> 
                                  (if ((leList_lh__d3 _lh_runsplit_LH_C_0_7) _lh_runsplit_LH_C_0_6) then
                                    ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_7, (`LH_C(_lh_runsplit_LH_C_0_6, _lh_matchIdent_1_2))))) _lh_runsplit_LH_C_1_7)
                                  else
                                    (let rec _lh_merge_lists_LH_C_1_7 = ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_7, (`LH_N)))) _lh_runsplit_LH_C_1_7) in
                                      (let rec _lh_merge_lists_LH_C_0_7 = (`LH_C(_lh_runsplit_LH_C_0_6, _lh_matchIdent_1_2)) in
                  ...
                  | `LH_C(_lh_runsplit_LH_C_0_8, _lh_runsplit_LH_C_1_8) -> 
                    (match _lh_runsplit_arg2_0 with
                      | `LH_C(_lh_runsplit_LH_C_0_9, _lh_runsplit_LH_C_1_9) -> 
                        (let rec _lh_matchIdent_1_3 = _lh_runsplit_LH_C_1_8 in
                          (match _lh_matchIdent_1_3 with
                            ...
                            | _ -> 
                              (if ((leList_lh__d6 _lh_runsplit_LH_C_0_9) _lh_runsplit_LH_C_0_8) then
                                ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_9, (`LH_C(_lh_runsplit_LH_C_0_8, _lh_matchIdent_1_3))))) _lh_runsplit_LH_C_1_9)
                              else
                                (let rec _lh_merge_lists_LH_C_1_9 = ((runsplit_0 (`LH_C(_lh_runsplit_LH_C_0_9, (`LH_N)))) _lh_runsplit_LH_C_1_9) in
                                  (let rec _lh_merge_lists_LH_C_0_9 = (`LH_C(_lh_runsplit_LH_C_0_8, _lh_matchIdent_1_3)) in
    ...
    | `LH_C(h_1_3, t_1_3) -> 
      (let rec t_1_4 = ((map_lh__d1 f_5) t_1_3) in
        (let rec h_1_4 = (f_5 h_1_3) in
          ((mappend_lh__d1_d0 h_1_4) (concat_lh__d1 t_1_4))))
    | `LH_N -> 
      (`LH_N));;
        ...
        (fun _lh_prependToAll_arg1_2 -> 
          (let rec t_1_6 = (let rec t_1_7 = ((prependToAll_lh__d1 _lh_prependToAll_arg1_2) _lh_prependToAll_LH_C_1_6) in
            (let rec h_1_6 = _lh_prependToAll_LH_C_0_0 in
              (fun f_8 i_5 -> 
                ((f_8 h_1_6) (((foldr_lh__d1 f_8) i_5) t_1_7))))) in
            (let rec h_1_7 = _lh_prependToAll_arg1_2 in
              (fun f_9 i_6 -> 
                ((f_9 h_1_7) (((foldr_lh__d1 f_9) i_6) t_1_6)))))))) in
        ...
        (fun _lh_prependToAll_arg1_3 -> 
          (let rec t_1_8 = (let rec t_1_9 = ((prependToAll_lh__d1 _lh_prependToAll_arg1_3) _lh_prependToAll_LH_C_1_5) in
            (let rec h_1_8 = _lh_prependToAll_LH_C_0_1 in
              (fun f_1_0 i_7 -> 
                ((f_1_0 h_1_8) (((foldr_lh__d1 f_1_0) i_7) t_1_9))))) in
            (let rec h_1_9 = _lh_prependToAll_arg1_3 in
              (fun f_1_1 i_8 -> 
                ((f_1_1 h_1_9) (((foldr_lh__d1 f_1_1) i_8) t_1_8)))))))) in
        ...
        (fun _lh_prependToAll_arg1_4 -> 
          (let rec t_2_0 = (let rec t_2_1 = ((prependToAll_lh__d1 _lh_prependToAll_arg1_4) _lh_prependToAll_LH_C_1_4) in
            (let rec h_2_0 = _lh_prependToAll_LH_C_0_2 in
              (fun f_1_2 i_9 -> 
                ((f_1_2 h_2_0) (((foldr_lh__d1 f_1_2) i_9) t_2_1))))) in
            (let rec h_2_1 = _lh_prependToAll_arg1_4 in
              (fun f_1_3 i_1_0 -> 
                ((f_1_3 h_2_1) (((foldr_lh__d1 f_1_3) i_1_0) t_2_0)))))))) in
        ...
        (fun _lh_prependToAll_arg1_5 -> 
          (let rec t_2_2 = (let rec t_2_3 = ((prependToAll_lh__d1 _lh_prependToAll_arg1_5) _lh_prependToAll_LH_C_1_3) in
            (let rec h_2_2 = _lh_prependToAll_LH_C_0_3 in
              (fun f_1_4 i_1_1 -> 
                ((f_1_4 h_2_2) (((foldr_lh__d1 f_1_4) i_1_1) t_2_3))))) in
            (let rec h_2_3 = _lh_prependToAll_arg1_5 in
              (fun f_1_5 i_1_2 -> 
                ((f_1_5 h_2_3) (((foldr_lh__d1 f_1_5) i_1_2) t_2_2)))))))) in
        ...
        (fun _lh_prependToAll_arg1_6 -> 
          (let rec t_2_4 = (let rec t_2_5 = ((prependToAll_lh__d1 _lh_prependToAll_arg1_6) _lh_prependToAll_LH_C_1_2) in
            (let rec h_2_4 = _lh_prependToAll_LH_C_0_4 in
              (fun f_1_6 i_1_3 -> 
                ((f_1_6 h_2_4) (((foldr_lh__d1 f_1_6) i_1_3) t_2_5))))) in
            (let rec h_2_5 = _lh_prependToAll_arg1_6 in
              (fun f_1_7 i_1_4 -> 
                ((f_1_7 h_2_5) (((foldr_lh__d1 f_1_7) i_1_4) t_2_4)))))))) in
        ...
        (fun _lh_prependToAll_arg1_7 -> 
          (let rec t_2_6 = (let rec t_2_7 = ((prependToAll_lh__d1 _lh_prependToAll_arg1_7) _lh_prependToAll_LH_C_1_1) in
            (let rec h_2_6 = _lh_prependToAll_LH_C_0_5 in
              (fun f_1_8 i_1_5 -> 
                ((f_1_8 h_2_6) (((foldr_lh__d1 f_1_8) i_1_5) t_2_7))))) in
            (let rec h_2_7 = _lh_prependToAll_arg1_7 in
              (fun f_1_9 i_1_6 -> 
                ((f_1_9 h_2_7) (((foldr_lh__d1 f_1_9) i_1_6) t_2_6)))))))) in
        ...
        (fun _lh_prependToAll_arg1_8 -> 
          (let rec t_2_8 = (let rec t_2_9 = ((prependToAll_lh__d1 _lh_prependToAll_arg1_8) _lh_prependToAll_LH_C_1_0) in
            (let rec h_2_8 = _lh_prependToAll_LH_C_0_6 in
              (fun f_2_0 i_1_7 -> 
                ((f_2_0 h_2_8) (((foldr_lh__d1 f_2_0) i_1_7) t_2_9))))) in
            (let rec h_2_9 = _lh_prependToAll_arg1_8 in
              (fun f_2_1 i_1_8 -> 
                ((f_2_1 h_2_9) (((foldr_lh__d1 f_2_1) i_1_8) t_2_8)))))))) in
        ...
        (fun _lh_intersperse_arg1_1 -> 
          (let rec t_3_0 = ((prependToAll_lh__d1 _lh_intersperse_arg1_1) _lh_intersperse_LH_C_1_0) in
            (let rec h_3_0 = _lh_intersperse_LH_C_0_0 in
              (fun f_2_2 i_1_9 -> 
                ((f_2_2 h_3_0) (((foldr_lh__d1 f_2_2) i_1_9) t_3_0)))))))))) _lh_sort_arg1_0)) in
    ((fun _lh_funcomp_x_3 -> 
      ((fun _lh_funcomp_x_4 -> 
