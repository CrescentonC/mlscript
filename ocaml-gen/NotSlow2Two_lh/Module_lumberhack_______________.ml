      ...
      (let rec _lh_listcomp_fun_ls_h_0 = a_0 in
        (fun _lh_listcomp_fun_0 -> 
          (let rec t_1 = (_lh_listcomp_fun_0 _lh_listcomp_fun_ls_t_0) in
            (let rec h_1 = (testNotSlow2Two_lh__d1 (_lh_listcomp_fun_ls_h_0 - 1)) in
              (fun _lh_dummy_0 -> 
                ((mappend_lh__d1 h_1) (concat_lh__d1 t_1))))))))
  else
    (fun _lh_listcomp_fun_1 _lh_dummy_1 -> 
      (`LH_N)))
and
testNotSlow2Two_lh__d1 _lh_testNotSlow2Two_arg1_0 =
  (if (_lh_testNotSlow2Two_arg1_0 < 0) then
    ...
    (concat_lh__d1 (let rec _lh_listcomp_fun_2 = (fun _lh_listcomp_fun_para_0 -> 
      ...
      (_lh_listcomp_fun_2 ((enumFromTo_lh__d1 0) _lh_testNotSlow2Two_arg1_0)))));;
let run () = 1 + (Obj.magic ((testNotSlow2Two_lh__d1 15)));
end;;
