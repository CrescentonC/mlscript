...
let rec enumFromTo_lh a_0 b_0 =
  (if (a_0 <= b_0) then
    ...
    (`LH_N));;
let rec testSlowManualListComp_lh _lh_testSlowManualListComp_arg1_0 =
      ...
      (let rec _lh_matchIdent_0 = x_0 in
        (match _lh_matchIdent_0 with
          ...
          | `LH_C(_lh_testSlowManualListComp_LH_C_0_0, _lh_testSlowManualListComp_LH_C_1_0) -> 
            (`LH_C((testSlowManualListComp_lh (_lh_testSlowManualListComp_arg1_0 - 1)), (lscompf_0 _lh_testSlowManualListComp_LH_C_1_0)))
          | _ -> 
            (failwith "error")))) in
      (lscompf_0 ((enumFromTo_lh 1) _lh_testSlowManualListComp_arg1_0)))));;
let run () = 1 + (Obj.magic ((testSlowManualListComp_lh 10)));
end;;
